 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */(function(e){function t(O,E){var w=O.length;O.push(E);e:for(;0<w;){var B=w-1>>>1,J=O[B];if(0<i(J,E))O[B]=E,O[w]=J,w=B;else break e}}function n(O){return O.length===0?null:O[0]}function r(O){if(O.length===0)return null;var E=O[0],w=O.pop();if(w!==E){O[0]=w;e:for(var B=0,J=O.length,v=J>>>1;B<v;){var V=2*(B+1)-1,L=O[V],Y=V+1,ue=O[Y];if(0>i(L,w))Y<J&&0>i(ue,L)?(O[B]=ue,O[Y]=w,B=Y):(O[B]=L,O[V]=w,B=V);else if(Y<J&&0>i(ue,w))O[B]=ue,O[Y]=w,B=Y;else break e}}return E}function i(O,E){var w=O.sortIndex-E.sortIndex;return w!==0?w:O.id-E.id}if(typeof performance=="object"&&typeof performance.now=="function"){var s=performance;e.unstable_now=function(){return s.now()}}else{var a=Date,l=a.now();e.unstable_now=function(){return a.now()-l}}var c=[],u=[],d=1,p=null,f=3,h=!1,x=!1,b=!1,k=typeof setTimeout=="function"?setTimeout:null,g=typeof clearTimeout=="function"?clearTimeout:null,m=typeof setImmediate<"u"?setImmediate:null;typeof navigator<"u"&&navigator.scheduling!==void 0&&navigator.scheduling.isInputPending!==void 0&&navigator.scheduling.isInputPending.bind(navigator.scheduling);function y(O){for(var E=n(u);E!==null;){if(E.callback===null)r(u);else if(E.startTime<=O)r(u),E.sortIndex=E.expirationTime,t(c,E);else break;E=n(u)}}function j(O){if(b=!1,y(O),!x)if(n(c)!==null)x=!0,D(T);else{var E=n(u);E!==null&&z(j,E.startTime-O)}}function T(O,E){x=!1,b&&(b=!1,g(C),C=-1),h=!0;var w=f;try{for(y(E),p=n(c);p!==null&&(!(p.expirationTime>E)||O&&!M());){var B=p.callback;if(typeof B=="function"){p.callback=null,f=p.priorityLevel;var J=B(p.expirationTime<=E);E=e.unstable_now(),typeof J=="function"?p.callback=J:p===n(c)&&r(c),y(E)}else r(c);p=n(c)}if(p!==null)var v=!0;else{var V=n(u);V!==null&&z(j,V.startTime-E),v=!1}return v}finally{p=null,f=w,h=!1}}var S=!1,P=null,C=-1,$=5,N=-1;function M(){return!(e.unstable_now()-N<$)}function R(){if(P!==null){var O=e.unstable_now();N=O;var E=!0;try{E=P(!0,O)}finally{E?W():(S=!1,P=null)}}else S=!1}var W;if(typeof m=="function")W=function(){m(R)};else if(typeof MessageChannel<"u"){var A=new MessageChannel,I=A.port2;A.port1.onmessage=R,W=function(){I.postMessage(null)}}else W=function(){k(R,0)};function D(O){P=O,S||(S=!0,W())}function z(O,E){C=k(function(){O(e.unstable_now())},E)}e.unstable_IdlePriority=5,e.unstable_ImmediatePriority=1,e.unstable_LowPriority=4,e.unstable_NormalPriority=3,e.unstable_Profiling=null,e.unstable_UserBlockingPriority=2,e.unstable_cancelCallback=function(O){O.callback=null},e.unstable_continueExecution=function(){x||h||(x=!0,D(T))},e.unstable_forceFrameRate=function(O){0>O||125<O?console.error("forceFrameRate takes a positive int between 0 and 125, forcing frame rates higher than 125 fps is not supported"):$=0<O?Math.floor(1e3/O):5},e.unstable_getCurrentPriorityLevel=function(){return f},e.unstable_getFirstCallbackNode=function(){return n(c)},e.unstable_next=function(O){switch(f){case 1:case 2:case 3:var E=3;break;default:E=f}var w=f;f=E;try{return O()}finally{f=w}},e.unstable_pauseExecution=function(){},e.unstable_requestPaint=function(){},e.unstable_runWithPriority=function(O,E){switch(O){case 1:case 2:case 3:case 4:case 5:break;default:O=3}var w=f;f=O;try{return E()}finally{f=w}},e.unstable_scheduleCallback=function(O,E,w){var B=e.unstable_now();switch(typeof w=="object"&&w!==null?(w=w.delay,w=typeof w=="number"&&0<w?B+w:B):w=B,O){case 1:var J=-1;break;case 2:J=250;break;case 5:J=1073741823;break;case 4:J=1e4;break;default:J=5e3}return J=w+J,O={id:d++,callback:E,priorityLevel:O,startTime:w,expirationTime:J,sortIndex:-1},w>B?(O.sortIndex=w,t(u,O),n(c)===null&&O===n(u)&&(b?(g(C),C=-1):b=!0,z(j,w-B))):(O.sortIndex=J,t(c,O),x||h||(x=!0,D(T))),O},e.unstable_shouldYield=M,e.unstable_wrapCallback=function(O){var E=f;return function(){var w=f;f=E;try{return O.apply(this,arguments)}finally{f=w}}}})(rg);ng.exports=rg;var a0=ng.exports;/**
 * @license React
 ...
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const Ik=e=>e.replace(/([a-z0-9])([A-Z])/g,"$1-$2").toLowerCase().trim(),he=(e,t)=>{const n=_.forwardRef(({color:r="currentColor",size:i=24,strokeWidth:s=2,absoluteStrokeWidth:a,className:l="",children:c,...u},d)=>_.createElement("svg",{ref:d,...Rk,width:i,height:i,stroke:r,strokeWidth:a?Number(s)*24/Number(i):s,className:["lucide",`lucide-${Ik(e)}`,l].join(" "),...u},[...t.map(([p,f])=>_.createElement(p,f)),...Array.isArray(c)?c:[c]]));return n.displayName=`${e}`,n};/**
 * @license lucide-react v0.294.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 ...
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const Fy=he("AlertTriangle",[["path",{d:"m21.73 18-8-14a2 2 0 0 0-3.48 0l-8 14A2 2 0 0 0 4 21h16a2 2 0 0 0 1.73-3Z",key:"c3ski4"}],["path",{d:"M12 9v4",key:"juzpu7"}],["path",{d:"M12 17h.01",key:"p32p05"}]]);/**
 * @license lucide-react v0.294.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const Ok=he("ArrowLeft",[["path",{d:"m12 19-7-7 7-7",key:"1l729n"}],["path",{d:"M19 12H5",key:"x3x0zl"}]]);/**
 * @license lucide-react v0.294.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const $k=he("Ban",[["circle",{cx:"12",cy:"12",r:"10",key:"1mglay"}],["path",{d:"m4.9 4.9 14.2 14.2",key:"1m5liu"}]]);/**
 * @license lucide-react v0.294.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 ...
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const Dk=he("Brain",[["path",{d:"M9.5 2A2.5 2.5 0 0 1 12 4.5v15a2.5 2.5 0 0 1-4.96.44 2.5 2.5 0 0 1-2.96-3.08 3 3 0 0 1-.34-5.58 2.5 2.5 0 0 1 1.32-4.24 2.5 2.5 0 0 1 1.98-3A2.5 2.5 0 0 1 9.5 2Z",key:"1mhkh5"}],["path",{d:"M14.5 2A2.5 2.5 0 0 0 12 4.5v15a2.5 2.5 0 0 0 4.96.44 2.5 2.5 0 0 0 2.96-3.08 3 3 0 0 0 .34-5.58 2.5 2.5 0 0 0-1.32-4.24 2.5 2.5 0 0 0-1.98-3A2.5 2.5 0 0 0 14.5 2Z",key:"1d6s00"}]]);/**
 * @license lucide-react v0.294.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 ...
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const By=he("ExternalLink",[["path",{d:"M18 13v6a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V8a2 2 0 0 1 2-2h6",key:"a6xqqp"}],["polyline",{points:"15 3 21 3 21 9",key:"mznyad"}],["line",{x1:"10",x2:"21",y1:"14",y2:"3",key:"18c3s4"}]]);/**
 * @license lucide-react v0.294.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const Fk=he("EyeOff",[["path",{d:"M9.88 9.88a3 3 0 1 0 4.24 4.24",key:"1jxqfv"}],["path",{d:"M10.73 5.08A10.43 10.43 0 0 1 12 5c7 0 10 7 10 7a13.16 13.16 0 0 1-1.67 2.68",key:"9wicm4"}],["path",{d:"M6.61 6.61A13.526 13.526 0 0 0 2 12s3 7 10 7a9.74 9.74 0 0 0 5.39-1.61",key:"1jreej"}],["line",{x1:"2",x2:"22",y1:"2",y2:"22",key:"a6p6uj"}]]);/**
 * @license lucide-react v0.294.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 ...
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const Bk=he("FileCode",[["path",{d:"M14.5 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V7.5L14.5 2z",key:"1nnpy2"}],["polyline",{points:"14 2 14 8 20 8",key:"1ew0cm"}],["path",{d:"m10 13-2 2 2 2",key:"17smn8"}],["path",{d:"m14 17 2-2-2-2",key:"14mezr"}]]);/**
 * @license lucide-react v0.294.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const Uk=he("FileText",[["path",{d:"M14.5 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V7.5L14.5 2z",key:"1nnpy2"}],["polyline",{points:"14 2 14 8 20 8",key:"1ew0cm"}],["line",{x1:"16",x2:"8",y1:"13",y2:"13",key:"14keom"}],["line",{x1:"16",x2:"8",y1:"17",y2:"17",key:"17nazh"}],["line",{x1:"10",x2:"8",y1:"9",y2:"9",key:"1a5vjj"}]]);/**
 * @license lucide-react v0.294.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const Uy=he("FolderOpen",[["path",{d:"m6 14 1.5-2.9A2 2 0 0 1 9.24 10H20a2 2 0 0 1 1.94 2.5l-1.54 6a2 2 0 0 1-1.95 1.5H4a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h3.9a2 2 0 0 1 1.69.9l.81 1.2a2 2 0 0 0 1.67.9H18a2 2 0 0 1 2 2v2",key:"usdka0"}]]);/**
 * @license lucide-react v0.294.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const Vy=he("FolderTree",[["path",{d:"M20 10a1 1 0 0 0 1-1V6a1 1 0 0 0-1-1h-2.5a1 1 0 0 1-.8-.4l-.9-1.2A1 1 0 0 0 15 3h-2a1 1 0 0 0-1 1v5a1 1 0 0 0 1 1Z",key:"hod4my"}],["path",{d:"M20 21a1 1 0 0 0 1-1v-3a1 1 0 0 0-1-1h-2.9a1 1 0 0 1-.88-.55l-.42-.85a1 1 0 0 0-.92-.6H13a1 1 0 0 0-1 1v5a1 1 0 0 0 1 1Z",key:"w4yl2u"}],["path",{d:"M3 5a2 2 0 0 0 2 2h3",key:"f2jnh7"}],["path",{d:"M3 3v13a2 2 0 0 0 2 2h3",key:"k8epm1"}]]);/**
 * @license lucide-react v0.294.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 ...
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const Vk=he("GripVertical",[["circle",{cx:"9",cy:"12",r:"1",key:"1vctgf"}],["circle",{cx:"9",cy:"5",r:"1",key:"hp0tcf"}],["circle",{cx:"9",cy:"19",r:"1",key:"fkjjf6"}],["circle",{cx:"15",cy:"12",r:"1",key:"1tmaij"}],["circle",{cx:"15",cy:"5",r:"1",key:"19l28e"}],["circle",{cx:"15",cy:"19",r:"1",key:"f4zoj3"}]]);/**
 * @license lucide-react v0.294.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const Wk=he("HardDrive",[["line",{x1:"22",x2:"2",y1:"12",y2:"12",key:"1y58io"}],["path",{d:"M5.45 5.11 2 12v6a2 2 0 0 0 2 2h16a2 2 0 0 0 2-2v-6l-3.45-6.89A2 2 0 0 0 16.76 4H7.24a2 2 0 0 0-1.79 1.11z",key:"oot6mr"}],["line",{x1:"6",x2:"6.01",y1:"16",y2:"16",key:"sgf278"}],["line",{x1:"10",x2:"10.01",y1:"16",y2:"16",key:"1l4acy"}]]);/**
 * @license lucide-react v0.294.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 ...
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const Wy=he("Layers",[["path",{d:"m12.83 2.18a2 2 0 0 0-1.66 0L2.6 6.08a1 1 0 0 0 0 1.83l8.58 3.91a2 2 0 0 0 1.66 0l8.58-3.9a1 1 0 0 0 0-1.83Z",key:"8b97xw"}],["path",{d:"m22 17.65-9.17 4.16a2 2 0 0 1-1.66 0L2 17.65",key:"dd6zsq"}],["path",{d:"m22 12.65-9.17 4.16a2 2 0 0 1-1.66 0L2 12.65",key:"ep9fru"}]]);/**
 * @license lucide-react v0.294.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 ...
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const Hk=he("Link",[["path",{d:"M10 13a5 5 0 0 0 7.54.54l3-3a5 5 0 0 0-7.07-7.07l-1.72 1.71",key:"1cjeqo"}],["path",{d:"M14 11a5 5 0 0 0-7.54-.54l-3 3a5 5 0 0 0 7.07 7.07l1.71-1.71",key:"19qd67"}]]);/**
 * @license lucide-react v0.294.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 ...
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const Jk=he("Package",[["path",{d:"m7.5 4.27 9 5.15",key:"1c824w"}],["path",{d:"M21 8a2 2 0 0 0-1-1.73l-7-4a2 2 0 0 0-2 0l-7 4A2 2 0 0 0 3 8v8a2 2 0 0 0 1 1.73l7 4a2 2 0 0 0 2 0l7-4A2 2 0 0 0 21 16Z",key:"hh9hay"}],["path",{d:"m3.3 7 8.7 5 8.7-5",key:"g66t2b"}],["path",{d:"M12 22V12",key:"d0xqtd"}]]);/**
 * @license lucide-react v0.294.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const Kk=he("PenLine",[["path",{d:"M12 20h9",key:"t2du7b"}],["path",{d:"M16.5 3.5a2.12 2.12 0 0 1 3 3L7 19l-4 1 1-4Z",key:"ymcmye"}]]);/**
 * @license lucide-react v0.294.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const Gk=he("Percent",[["line",{x1:"19",x2:"5",y1:"5",y2:"19",key:"1x9vlm"}],["circle",{cx:"6.5",cy:"6.5",r:"2.5",key:"4mh3h7"}],["circle",{cx:"17.5",cy:"17.5",r:"2.5",key:"1mdrzq"}]]);/**
 * @license lucide-react v0.294.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 ...
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const Yk=he("Repeat",[["path",{d:"m17 2 4 4-4 4",key:"nntrym"}],["path",{d:"M3 11v-1a4 4 0 0 1 4-4h14",key:"84bu3i"}],["path",{d:"m7 22-4-4 4-4",key:"1wqhfi"}],["path",{d:"M21 13v1a4 4 0 0 1-4 4H3",key:"1rx37r"}]]);/**
 * @license lucide-react v0.294.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 ...
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const Hy=he("Search",[["circle",{cx:"11",cy:"11",r:"8",key:"4ej97u"}],["path",{d:"m21 21-4.3-4.3",key:"1qie3q"}]]);/**
 * @license lucide-react v0.294.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 ...
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const Qk=he("Settings2",[["path",{d:"M20 7h-9",key:"3s1dr2"}],["path",{d:"M14 17H5",key:"gfn3mx"}],["circle",{cx:"17",cy:"17",r:"3",key:"18b49y"}],["circle",{cx:"7",cy:"7",r:"3",key:"dfmy0x"}]]);/**
 * @license lucide-react v0.294.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 ...
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const Jy=he("Shield",[["path",{d:"M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10",key:"1irkt0"}]]);/**
 * @license lucide-react v0.294.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 ...
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const Xk=he("Square",[["rect",{width:"18",height:"18",x:"3",y:"3",rx:"2",key:"afitv7"}]]);/**
 * @license lucide-react v0.294.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const Ky=he("Star",[["polygon",{points:"12 2 15.09 8.26 22 9.27 17 14.14 18.18 21.02 12 17.77 5.82 21.02 7 14.14 2 9.27 8.91 8.26 12 2",key:"8f66p6"}]]);/**
 * @license lucide-react v0.294.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 ...
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const Gy=he("Users",[["path",{d:"M16 21v-2a4 4 0 0 0-4-4H6a4 4 0 0 0-4 4v2",key:"1yyitq"}],["circle",{cx:"9",cy:"7",r:"4",key:"nufk8"}],["path",{d:"M22 21v-2a4 4 0 0 0-3-3.87",key:"kshegd"}],["path",{d:"M16 3.13a4 4 0 0 1 0 7.75",key:"1da9ce"}]]);/**
 * @license lucide-react v0.294.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 ...
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const Zk=he("Workflow",[["rect",{width:"8",height:"8",x:"3",y:"3",rx:"2",key:"by2w9f"}],["path",{d:"M7 11v4a2 2 0 0 0 2 2h4",key:"xkn7yn"}],["rect",{width:"8",height:"8",x:"13",y:"13",rx:"2",key:"1cgmvn"}]]);/**
 * @license lucide-react v0.294.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
...
`).length,h=Math.max(r,Math.min(f*20+40,500));l(h)}},[e,r]),_.useEffect(()=>{i&&u.current&&u.current.focus()},[i]);function d(f){u.current=f,f.focus()}function p(f){c.current&&!c.current.contains(f.target)&&s(!1)}return _.useEffect(()=>{if(i)return document.addEventListener("mousedown",p),()=>document.removeEventListener("mousedown",p)},[i]),o.jsxs("div",{ref:c,className:"markdown-editor",children:[o.jsx("style",{children:`
      ...
      `}),i?o.jsx("div",{className:"monaco-wrapper",children:o.jsx(Kt,{height:"100%",language:"markdown",theme:"vs-dark",value:e,onChange:f=>t(f||""),onMount:d,options:{minimap:{enabled:!1},fontSize:14,fontFamily:"'JetBrains Mono', monospace",lineNumbers:"off",scrollBeyondLastLine:!1,automaticLayout:!0,wordWrap:"on",padding:{top:12,bottom:12},lineDecorationsWidth:8,folding:!1,glyphMargin:!1,renderLineHighlight:"none",overviewRulerLanes:0,hideCursorInOverviewRuler:!0,scrollbar:{vertical:"auto",horizontal:"hidden"}}})}):o.jsxs("div",{className:"markdown-preview",onClick:()=>s(!0),children:[o.jsxs("span",{className:"edit-hint",children:[o.jsx(Kk,{size:12}),"Click to edit"]}),e?o.jsx("div",{className:"markdown-content",children:o.jsx(Uv,{children:e})}):o.jsx("div",{className:"markdown-placeholder",children:n})]})]})}function s4(e){return/^[a-zA-Z0-9_]+$/.test(e)}function a4({agent:e}){const{project:t,updateAgent:n,mcpServers:r,builtinTools:i,setActiveTab:s,setRunAgentId:a}=ut(),[l,c]=_.useState(new Set(["basic","model","tools","subagents"])),[u,d]=_.useState(!1),[p,f]=_.useState(!1),[h,x]=_.useState(!1),[b,k]=_.useState(""),[g,m]=_.useState(null);if(!t)return null;function y(z){n(e.id,z)}function j(z){if(z===""){m(null),y({name:z});return}s4(z)?m(null):m("Name can only contain letters, numbers, and underscores"),e.type==="LlmAgent"?y({name:z,output_key:z}):y({name:z})}function T(z){const O=new Set(l);O.has(z)?O.delete(z):O.add(z),c(O)}const S=e.type==="LlmAgent",P=e;function C(z){S&&y({tools:[...P.tools,z]})}function $(z){S&&y({tools:P.tools.filter((O,E)=>E!==z)})}function N(z,O){if(!S)return;const E=[...P.tools];E[z]=O,y({tools:E})}function M(z){"sub_agents"in e&&y({sub_agents:[...e.sub_agents,z]})}function R(z){"sub_agents"in e&&y({sub_agents:e.sub_agents.filter(O=>O!==z)})}const W=t.agents.filter(z=>z.id!==e.id);async function A(){if(!(!t||!S)){d(!0);try{const z=P.instruction||"",O=z?`Current instruction to improve:

${z}

Please improve and expand this instruction while preserving its core intent.`:void 0,w=t.agents.some(J=>J.id===e.id)?void 0:e,B=await Ks(t.id,e.id,O,w);B.success&&B.prompt?y({instruction:B.prompt}):alert("Failed to generate prompt: "+(B.error||"Unknown error"))}catch(z){alert("Error generating prompt: "+z.message)}finally{d(!1)}}}async function I(){if(!(!t||!S||!b.trim())){d(!0);try{const O=`Current instruction:
...
Please apply the requested changes to the instruction above. Output only the updated instruction, nothing else.`,w=t.agents.some(J=>J.id===e.id)?void 0:e,B=await Ks(t.id,e.id,O,w);B.success&&B.prompt?(y({instruction:B.prompt}),x(!1),k("")):alert("Failed to apply changes: "+(B.error||"Unknown error"))}catch(z){alert("Error applying changes: "+z.message)}finally{d(!1)}}}async function D(){if(!t||!S)return;const z=P.instruction;if(!z){alert("Please write an instruction first");return}f(!0);try{const O=`Write a 5-10 word description of what this agent does.
...
Your response (5-10 words only):`,E=await Ks(t.id,e.id,O);if(E.success&&E.prompt){let w=E.prompt.trim();w=w.replace(/^["']|["']$/g,"").trim();const B=w.split(/[.!?\n]/)[0].trim(),J=B.length>80?B.slice(0,77)+"...":B;y({description:J})}else alert("Failed to generate description: "+(E.error||"Unknown error"))}catch(O){alert("Error generating description: "+O.message)}finally{f(!1)}}return o.jsxs("div",{className:"agent-editor",children:[o.jsx("style",{children:`
        .agent-editor {
          background: var(--bg-secondary);
          border: 1px solid var(--border-color);
          border-radius: var(--radius-lg);
      ...
      `}),o.jsxs("div",{className:"editor-header",children:[o.jsx(Er,{size:24,style:{color:"var(--accent-primary)"}}),o.jsxs("div",{style:{flex:1,display:"flex",flexDirection:"column",gap:4},children:[o.jsx("input",{type:"text",value:e.name,onChange:z=>j(z.target.value),placeholder:"Agent name",style:{borderColor:g?"var(--error)":void 0}}),g&&o.jsx("span",{style:{fontSize:11,color:"var(--error)",marginTop:-4},children:g})]}),o.jsx("span",{className:"badge badge-info",children:e.type}),o.jsxs("button",{className:"btn btn-primary btn-sm run-agent-btn",onClick:()=>{a(e.id),s("run")},title:"Test this agent",children:[o.jsx(pr,{size:14}),"Run"]})]}),o.jsxs("div",{className:"editor-content",children:[o.jsxs(qi,{id:"basic",title:"Basic Info",icon:o.jsx(Er,{size:16}),expanded:l.has("basic"),onToggle:()=>T("basic"),children:[o.jsx("div",{className:"form-row",children:o.jsxs("div",{className:"form-group full-width",children:[o.jsxs("div",{className:"label-with-action",children:[o.jsx("label",{children:"Description"}),S&&P.instruction&&o.jsx("button",{className:"btn btn-secondary btn-sm generate-btn",onClick:D,disabled:p,title:"Generate description from instruction",children:p?o.jsxs(o.Fragment,{children:[o.jsx(Zn,{size:14,className:"spin"}),"Summarizing..."]}):"Summarize"})]}),o.jsx("input",{type:"text",value:e.description,onChange:z=>y({description:z.target.value}),placeholder:"e.g., Reviews code for bugs and suggests fixes"})]})}),S&&o.jsxs(o.Fragment,{children:[o.jsx("div",{className:"form-row",children:o.jsxs("div",{className:"form-group full-width",children:[o.jsxs("div",{className:"label-with-action",children:[o.jsx("label",{children:"Instruction"}),o.jsxs("div",{className:"action-buttons",children:[o.jsx("button",{className:"btn btn-secondary btn-sm",onClick:()=>x(!h),disabled:u||!P.instruction,title:"Request specific changes to the instruction",children:"Request Changes"}),o.jsx("button",{className:"btn btn-secondary btn-sm",onClick:A,disabled:u,title:"Uses AI to improve and expand the current instruction",children:u?o.jsxs(o.Fragment,{children:[o.jsx(Zn,{size:14,className:"spin"}),"Working..."]}):"Auto-Improve"})]})]}),h&&o.jsxs("div",{className:"request-changes-box",children:[o.jsx("input",{type:"text",value:b,onChange:z=>k(z.target.value),placeholder:"Describe what changes you want...",onKeyDown:z=>{z.key==="Enter"&&b.trim()?I():z.key==="Escape"&&(x(!1),k(""))},autoFocus:!0}),o.jsx("button",{className:"btn btn-primary btn-sm",onClick:I,disabled:u||!b.trim(),children:"Apply"})]}),o.jsx(o4,{value:P.instruction,onChange:z=>y({instruction:z}),placeholder:"Write your agent's instruction here... (Markdown supported)",minHeight:200})]})}),o.jsxs("div",{className:"form-row",children:[o.jsxs("div",{className:"form-group",children:[o.jsx("label",{children:"Output Key"}),o.jsxs("select",{value:P.output_key||"",onChange:z=>y({output_key:z.target.value||void 0}),children:[o.jsx("option",{value:"",children:"None"}),t.app.state_keys.map(z=>o.jsx("option",{value:z.name,children:z.name},z.name))]})]}),o.jsxs("div",{className:"form-group",children:[o.jsx("label",{children:"Include Contents"}),o.jsxs("select",{value:P.include_contents,onChange:z=>y({include_contents:z.target.value}),children:[o.jsx("option",{value:"default",children:"Default"}),o.jsx("option",{value:"none",children:"None"})]})]})]}),o.jsxs("div",{className:"form-row",style:{gap:24},children:[o.jsxs("label",{style:{display:"flex",alignItems:"center",gap:8,fontSize:13},children:[o.jsxs("span",{className:"toggle-switch",children:[o.jsx("input",{type:"checkbox",checked:P.disallow_transfer_to_parent,onChange:z=>y({disallow_transfer_to_parent:z.target.checked})}),o.jsx("span",{className:"toggle-slider"})]}),"Disallow transfer to parent"]}),o.jsxs("label",{style:{display:"flex",alignItems:"center",gap:8,fontSize:13},children:[o.jsxs("span",{className:"toggle-switch",children:[o.jsx("input",{type:"checkbox",checked:P.disallow_transfer_to_peers,onChange:z=>y({disallow_transfer_to_peers:z.target.checked})}),o.jsx("span",{className:"toggle-slider"})]}),"Disallow transfer to peers"]})]})]}),e.type==="LoopAgent"&&o.jsx("div",{className:"form-row",children:o.jsxs("div",{className:"form-group",children:[o.jsx("label",{children:"Max Iterations"}),o.jsx("input",{type:"number",value:e.max_iterations||"",onChange:z=>y({max_iterations:parseInt(z.target.value)||void 0}),placeholder:"No limit"})]})})]}),S&&o.jsx(qi,{id:"model",title:"Model",icon:o.jsx(Od,{size:16}),expanded:l.has("model"),onToggle:()=>T("model"),children:o.jsx(c4,{agent:P,appModels:t.app.models||[],defaultModelId:t.app.default_model_id,projectId:t.id,onUpdate:z=>y({model:z})})}),S&&o.jsx(qi,{id:"tools",title:`Tools (${P.tools.length})`,icon:o.jsx(ln,{size:16}),expanded:l.has("tools"),onToggle:()=>T("tools"),children:o.jsx(l4,{tools:P.tools,onAdd:C,onRemove:$,onUpdate:N,builtinTools:i,mcpServers:r,projectMcpServers:t.mcp_servers,customTools:t.custom_tools,agents:W,skillsets:t.skillsets||[]})}),"sub_agents"in e&&o.jsx(qi,{id:"subagents",title:`Sub-Agents (${e.sub_agents.length})`,icon:o.jsx(Gy,{size:16}),expanded:l.has("subagents"),onToggle:()=>T("subagents"),children:o.jsxs("div",{className:"sub-agent-list",children:[e.sub_agents.map(z=>{const O=t.agents.find(E=>E.id===z);return O?o.jsxs("div",{className:"sub-agent-chip",children:[O.name,o.jsx("button",{onClick:()=>R(z),children:o.jsx(Fe,{size:12})})]},z):null}),o.jsxs("select",{value:"",onChange:z=>{z.target.value&&M(z.target.value)},style:{width:150,padding:"6px 10px",fontSize:13},children:[o.jsx("option",{value:"",children:"Add agent..."}),W.filter(z=>!e.sub_agents.includes(z.id)).map(z=>o.jsx("option",{value:z.id,children:z.name},z.id))]})]})}),o.jsx(qi,{id:"callbacks",title:"Callbacks",icon:o.jsx(jn,{size:16}),expanded:l.has("callbacks"),onToggle:()=>T("callbacks"),children:o.jsx(u4,{agent:e,onUpdate:y,customCallbacks:t.custom_callbacks||[],isLlmAgent:S})})]})]})}function qi({id:e,title:t,icon:n,expanded:r,onToggle:i,children:s}){return o.jsxs("div",{className:"section",children:[o.jsxs("div",{className:"section-header",onClick:i,children:[r?o.jsx(Pt,{size:16}):o.jsx(bt,{size:16}),o.jsxs("h4",{children:[n," ",t]})]}),r&&o.jsx("div",{className:"section-content",children:s})]})}function l4({tools:e,onAdd:t,onRemove:n,onUpdate:r,builtinTools:i,mcpServers:s,projectMcpServers:a,customTools:l,agents:c,skillsets:u}){const[d,p]=_.useState(!1),[f,h]=_.useState({}),[x,b]=_.useState(""),k=It.useRef(null),g=It.useRef(null),[m,y]=_.useState(null),[j,T]=_.useState(new Set),S=(L,Y)=>{if(!x.trim())return!0;const ue=x.toLowerCase();return L.toLowerCase().includes(ue)||((Y==null?void 0:Y.toLowerCase().includes(ue))??!1)},P=i.filter(L=>S(L.name,L.description)),C=s.filter(L=>S(L.name,L.description)),$=a.filter(L=>S(L.name,L.description)),N=l.filter(L=>S(L.name,L.description)),M=c.filter(L=>S(L.name,L.description)),R=u.filter(L=>S(L.name,L.description));function W(){if(k.current){const L=k.current.getBoundingClientRect(),Y=window.innerHeight,ue=350,pe=Y-L.bottom-16,q=L.top-16;if(pe>=200||pe>=q){const F=Math.min(ue,pe);h({top:L.bottom+4,left:L.left,maxHeight:F})}else{const F=Math.min(ue,q);h({top:L.top-F-4,left:L.left,maxHeight:F})}}p(!0),b(""),setTimeout(()=>{var L;return(L=g.current)==null?void 0:L.focus()},50)}function A(){p(!1),b("")}function I(L){t({type:"builtin",name:L}),A()}async function D(L){A();const Y=L.tool_filter||[];if(y({server:L,enabledTools:new Set(Y),availableTools:Y.map(ue=>({name:ue,description:""})),isLoading:Y.length===0,error:void 0}),Y.length===0)try{const{testMcpServer:ue}=await uj(async()=>{const{testMcpServer:q}=await Promise.resolve().then(()=>Mk);return{testMcpServer:q}},void 0),pe=await ue({connection_type:L.connection_type,command:L.command,args:L.args,env:L.env,url:L.url,headers:L.headers,timeout:L.timeout||30});pe.success?y(q=>q?{...q,availableTools:pe.tools,enabledTools:new Set(pe.tools.map(F=>F.name)),isLoading:!1}:null):y(q=>q?{...q,isLoading:!1,error:pe.error||"Failed to connect to MCP server"}:null)}catch(ue){y(pe=>pe?{...pe,isLoading:!1,error:ue.message}:null)}}function z(L){if(!m)return;const Y=new Set(m.enabledTools);Y.has(L)?Y.delete(L):Y.add(L),y({...m,enabledTools:Y})}function O(){if(!m)return;const L=Array.from(m.enabledTools);t({type:"mcp",server:{...m.server,tool_filter:L}}),y(null)}function E(L){const Y=new Set(j);Y.has(L)?Y.delete(L):Y.add(L),T(Y)}function w(L,Y){const ue=e[L];if(ue.type!=="mcp"||!ue.server)return;const pe=ue.server.tool_filter||[];let q;pe.includes(Y)?q=pe.filter(F=>F!==Y):q=[...pe,Y],r(L,{...ue,server:{...ue.server,tool_filter:q}})}function B(L){t({type:"function",name:L.name,module_path:L.module_path}),A()}function J(L){const Y=c.find(ue=>ue.id===L);t({type:"agent",agent_id:L,name:Y==null?void 0:Y.name}),A()}function v(L){const Y=u.find(ue=>ue.id===L);t({type:"skillset",skillset_id:L,name:Y==null?void 0:Y.name}),A()}function V(L){return s.find(Y=>Y.name===L)}return o.jsxs("div",{children:[o.jsx("style",{children:`
        .mcp-tool-item {
          border: 1px solid var(--border-color);
          border-radius: var(--radius-md);
          overflow: hidden;
      ...
      `}),o.jsx("div",{className:"tool-list",children:e.map((L,Y)=>{var ue;return L.type==="mcp"&&L.server?o.jsxs("div",{className:"mcp-tool-item",children:[o.jsxs("div",{className:"mcp-tool-header",onClick:()=>E(Y),children:[j.has(Y)?o.jsx(Pt,{size:14}):o.jsx(bt,{size:14}),o.jsx(ln,{size:14,style:{color:"var(--accent-primary)"}}),o.jsxs("div",{className:"mcp-tool-info",children:[o.jsx("div",{className:"mcp-tool-name",children:L.server.name}),o.jsx("div",{className:"mcp-tool-count",children:L.server.tool_filter===null||L.server.tool_filter===void 0?"all tools":`${L.server.tool_filter.length} tools enabled`})]}),o.jsx("button",{className:"delete-btn",onClick:pe=>{pe.stopPropagation(),n(Y)},children:o.jsx(Fe,{size:14})})]}),j.has(Y)&&o.jsx("div",{className:"mcp-tool-body",children:o.jsx("div",{className:"mcp-tool-list",children:(()=>{const pe=V(L.server.name),q=(pe==null?void 0:pe.tool_filter)||L.server.tool_filter||[],F=new Set(L.server.tool_filter||[]);return q.map(K=>o.jsxs("label",{className:`mcp-tool-chip ${F.has(K)?"enabled":"disabled"}`,onClick:()=>w(Y,K),children:[o.jsx("input",{type:"checkbox",checked:F.has(K),onChange:()=>{},style:{display:"none"}}),K]},K))})()})})]},Y):L.type==="skillset"?o.jsxs("div",{className:"tool-item",children:[o.jsx(Rn,{size:14,style:{color:"var(--accent)"}}),o.jsxs("div",{className:"tool-item-info",children:[o.jsx("div",{className:"tool-item-name",children:L.name||((ue=u.find(pe=>pe.id===L.skillset_id))==null?void 0:ue.name)||"SkillSet"}),o.jsx("div",{className:"tool-item-type",children:"skillset"})]}),o.jsx("button",{className:"delete-btn",onClick:()=>n(Y),children:o.jsx(Fe,{size:14})})]},Y):o.jsxs("div",{className:"tool-item",children:[o.jsx(ln,{size:14,style:{color:"var(--accent-primary)"}}),o.jsxs("div",{className:"tool-item-info",children:[o.jsx("div",{className:"tool-item-name",children:L.name||L.agent_id}),o.jsx("div",{className:"tool-item-type",children:L.type})]}),o.jsx("button",{className:"delete-btn",onClick:()=>n(Y),children:o.jsx(Fe,{size:14})})]},Y)})}),o.jsxs("div",{className:"add-tool-dropdown",style:{marginTop:12},children:[o.jsxs("button",{ref:k,className:"btn btn-secondary btn-sm",onClick:()=>d?A():W(),children:[o.jsx(Ke,{size:14}),"Add Tool"]}),d&&o.jsxs(o.Fragment,{children:[o.jsx("div",{className:"dropdown-backdrop",onClick:A}),o.jsxs("div",{className:"dropdown-content dropdown-fixed",style:f,children:[o.jsx("div",{className:"dropdown-search",children:o.jsx("input",{ref:g,type:"text",placeholder:"Search tools...",value:x,onChange:L=>b(L.target.value),onKeyDown:L=>L.key==="Escape"&&A()})}),P.length>0&&o.jsxs("div",{className:"dropdown-section",children:[o.jsx("h5",{children:"Built-in Tools"}),P.map(L=>o.jsxs("button",{className:"dropdown-item",onClick:()=>I(L.name),children:[o.jsx("div",{className:"dropdown-item-name",children:L.name}),o.jsx("div",{className:"dropdown-item-desc",children:L.description})]},L.name))]}),C.length>0&&o.jsxs("div",{className:"dropdown-section",children:[o.jsxs("h5",{children:["Known MCP Servers (",C.length,")"]}),C.map(L=>o.jsxs("button",{className:"dropdown-item",onClick:()=>D(L),children:[o.jsxs("div",{className:"dropdown-item-name",children:[L.name,o.jsx("span",{style:{fontSize:11,color:"var(--text-muted)",marginLeft:8},children:L.tool_filter===null||L.tool_filter===void 0?"all tools":`${L.tool_filter.length} tools`})]}),o.jsx("div",{className:"dropdown-item-desc",children:L.description})]},`known-${L.name}`))]}),$.length>0&&o.jsxs("div",{className:"dropdown-section",children:[o.jsxs("h5",{children:["Project MCP Servers (",$.length,")"]}),$.map(L=>o.jsxs("button",{className:"dropdown-item",onClick:()=>D(L),children:[o.jsxs("div",{className:"dropdown-item-name",children:[L.name,o.jsx("span",{style:{fontSize:11,color:"var(--text-muted)",marginLeft:8},children:L.tool_filter===null||L.tool_filter===void 0?"all tools":`${L.tool_filter.length} tools`})]}),o.jsx("div",{className:"dropdown-item-desc",children:L.description||"Custom MCP server"})]},`project-${L.id||L.name}`))]}),N.length>0&&o.jsxs("div",{className:"dropdown-section",children:[o.jsx("h5",{children:"Custom Tools"}),N.map(L=>o.jsxs("button",{className:"dropdown-item",onClick:()=>B(L),children:[o.jsx("div",{className:"dropdown-item-name",children:L.name}),o.jsx("div",{className:"dropdown-item-desc",children:L.description})]},L.id))]}),M.length>0&&o.jsxs("div",{className:"dropdown-section",children:[o.jsx("h5",{children:"Agents as Tools"}),M.map(L=>o.jsxs("button",{className:"dropdown-item",onClick:()=>J(L.id),children:[o.jsx("div",{className:"dropdown-item-name",children:L.name}),o.jsx("div",{className:"dropdown-item-desc",children:L.type})]},L.id))]}),R.length>0&&o.jsxs("div",{className:"dropdown-section",children:[o.jsxs("h5",{children:["SkillSets (",R.length,")"]}),R.map(L=>o.jsxs("button",{className:"dropdown-item",onClick:()=>v(L.id),children:[o.jsxs("div",{className:"dropdown-item-name",children:[L.name,o.jsxs("span",{style:{fontSize:11,color:"var(--text-muted)",marginLeft:8},children:[L.entry_count||0," entries"]})]}),o.jsx("div",{className:"dropdown-item-desc",children:L.description||"Vector knowledge base"})]},L.id))]}),x.trim()&&P.length===0&&C.length===0&&$.length===0&&N.length===0&&M.length===0&&R.length===0&&o.jsxs("div",{className:"dropdown-section",style:{textAlign:"center",padding:"20px",color:"var(--text-muted)"},children:['No tools matching "',x,'"']})]})]})]}),m&&o.jsx("div",{className:"mcp-config-dialog",children:o.jsxs("div",{className:"mcp-config-content",children:[o.jsxs("h3",{children:["Configure ",m.server.name]}),o.jsx("p",{children:m.server.description}),m.isLoading?o.jsxs("div",{className:"mcp-loading",children:[o.jsx("div",{className:"spinner"}),o.jsx("p",{children:"Connecting to MCP server and discovering tools..."})]}):m.error?o.jsxs("div",{className:"mcp-error",children:[o.jsxs("p",{children:["⚠️ Failed to discover tools: ",m.error]}),o.jsx("p",{className:"hint",children:"You can still add the server, but you won't be able to select specific tools."})]}):o.jsxs(o.Fragment,{children:[o.jsxs("div",{className:"mcp-select-actions",children:[o.jsxs("button",{className:"btn btn-secondary btn-sm",onClick:()=>y({...m,enabledTools:new Set(m.availableTools.map(L=>L.name))}),children:["Select All (",m.availableTools.length,")"]}),o.jsx("button",{className:"btn btn-secondary btn-sm",onClick:()=>y({...m,enabledTools:new Set}),children:"Select None"})]}),o.jsx("div",{className:"mcp-tools-grid",children:m.availableTools.map(L=>o.jsxs("div",{className:"mcp-tool-row",title:L.description||L.name,style:{display:"flex",alignItems:"center",gap:8,padding:"4px 0"},children:[o.jsxs("label",{className:"toggle-switch",style:{margin:0},children:[o.jsx("input",{type:"checkbox",checked:m.enabledTools.has(L.name),onChange:()=>z(L.name)}),o.jsx("span",{className:"toggle-slider"})]}),o.jsx("span",{style:{fontSize:13,opacity:m.enabledTools.has(L.name)?1:.5,cursor:"pointer"},onClick:()=>z(L.name),children:L.name})]},L.name))})]}),o.jsxs("div",{className:"dialog-actions",children:[o.jsx("button",{className:"btn btn-secondary",onClick:()=>y(null),children:"Cancel"}),o.jsxs("button",{className:"btn btn-primary",onClick:O,disabled:m.enabledTools.size===0,children:["Add ",m.enabledTools.size," Tools"]})]})]})})]})}function c4({agent:e,appModels:t,defaultModelId:n,projectId:r,onUpdate:i}){var f,h;const s=(f=e.model)==null?void 0:f._appModelId,a=e.model!==null&&e.model!==void 0&&!s,c=s||(()=>{if(!e.model)return n;const x=t.find(b=>{var k,g,m;return b.provider===((k=e.model)==null?void 0:k.provider)&&b.model_name===((g=e.model)==null?void 0:g.model_name)&&b.api_base===((m=e.model)==null?void 0:m.api_base)});return x==null?void 0:x.id})()||n||((h=t[0])==null?void 0:h.id);It.useEffect(()=>{var x,b,k,g,m;if(s){const y=t.find(j=>j.id===s);y&&(((x=e.model)==null?void 0:x.provider)!==y.provider||((b=e.model)==null?void 0:b.model_name)!==y.model_name||((k=e.model)==null?void 0:k.api_base)!==y.api_base||((g=e.model)==null?void 0:g.temperature)!==y.temperature||((m=e.model)==null?void 0:m.max_output_tokens)!==y.max_output_tokens)&&i({provider:y.provider,model_name:y.model_name,api_base:y.api_base,temperature:y.temperature,max_output_tokens:y.max_output_tokens,top_p:y.top_p,top_k:y.top_k,fallbacks:[],_appModelId:s})}},[s,t,e.model,i]);function u(x){const b=t.find(k=>k.id===x);b&&i({provider:b.provider,model_name:b.model_name,api_base:b.api_base,temperature:b.temperature,max_output_tokens:b.max_output_tokens,top_p:b.top_p,top_k:b.top_k,fallbacks:[],_appModelId:x})}function d(){var x;if(a){const b=n||((x=t[0])==null?void 0:x.id);b&&u(b)}else{const b=e.model;if(b){const{_appModelId:k,...g}=b;i(g)}else i({provider:"gemini",model_name:"gemini-2.0-flash",fallbacks:[]})}}function p(x){const{_appModelId:b,...k}=e.model||{};i({...k,...x})}return t.find(x=>x.id===c),t.find(x=>x.id===n),o.jsxs("div",{className:"model-selector",children:[o.jsx("style",{children:`
        .model-selector {
          display: flex;
          flex-direction: column;
          gap: 16px;
...
`;function K4({onSelectTool:e}){const{project:t,updateProject:n,addCustomTool:r,updateCustomTool:i,removeCustomTool:s,selectedToolId:a,setSelectedToolId:l,builtinTools:c,mcpServers:u}=ut(),[d,p]=_.useState(""),[f,h]=_.useState(null),[x,b]=_.useState("tools"),[k,g]=_.useState(null),[m,y]=_.useState(""),[j,T]=_.useState(!1),[S,P]=_.useState(!1),[C,$]=_.useState(!1),[N,M]=_.useState(null),[R,W]=_.useState(null),[A,I]=_.useState({}),[D,z]=_.useState({}),[O,E]=_.useState("");if(!t)return null;const w=t.mcp_servers||[],B=t.custom_tools.find(H=>H.id===a),J=w.find(H=>H.name===k);function v(H){l(H),e==null||e(H)}_.useEffect(()=>{B&&(p(B.code),W(null))},[a]),_.useEffect(()=>{J&&(y(JSON.stringify(J,null,2)),T(!1))},[k]),_.useEffect(()=>{if(!t)return;const H=V(t.mcp_servers||[]);E(JSON.stringify(H,null,2))},[t==null?void 0:t.mcp_servers]),_.useEffect(()=>{if(x==="mcp"&&w.length>0){const H=w.filter(ae=>!A[ae.name]||A[ae.name]==="unknown");H.length>0&&H.forEach(ae=>{pe(ae.name)})}},[x,w.length]);function V(H){const ae={};for(const me of H){const ye={};me.connection_type==="stdio"?(ye.command=me.command||"",ye.args=me.args||[],Object.keys(me.env||{}).length>0&&(ye.env=me.env)):me.connection_type==="sse"&&(ye.url=me.url||"",Object.keys(me.headers||{}).length>0&&(ye.headers=me.headers)),me.timeout&&me.timeout!==30&&(ye.timeout=me.timeout),me.tool_filter&&(ye.tool_filter=me.tool_filter),me.tool_name_prefix&&(ye.tool_name_prefix=me.tool_name_prefix),ae[me.name]=ye}return{mcpServers:ae}}function L(H){const ae=[];for(const[me,ye]of Object.entries(H.mcpServers||{})){const G={name:me,description:ye.description||"",connection_type:ye.url?"sse":"stdio",command:ye.command,args:ye.args||[],env:ye.env||{},url:ye.url,headers:ye.headers||{},timeout:ye.timeout||30,tool_filter:ye.tool_filter||null,tool_name_prefix:ye.tool_name_prefix};ae.push(G)}return ae}function Y(H){H!==void 0&&E(H)}function ue(){try{const H=JSON.parse(O),ae=L(H);n({mcp_servers:ae})}catch(H){alert("Invalid JSON: "+H.message)}}async function pe(H){const ae=w.find(me=>me.name===H);if(ae){I(me=>({...me,[H]:"testing"})),z(me=>({...me,[H]:""}));try{const me=await fu({connection_type:ae.connection_type,command:ae.command,args:ae.args,env:ae.env,url:ae.url,headers:ae.headers,timeout:ae.timeout});I(ye=>({...ye,[H]:me.success?"connected":"error"})),!me.success&&me.error&&z(ye=>({...ye,[H]:me.error||"Unknown error"}))}catch(me){I(ye=>({...ye,[H]:"error"})),z(ye=>({...ye,[H]:me.message}))}}}function q(H){const ae=u.find(ye=>ye.name===H);if(!ae)return;if(w.some(ye=>ye.name===H)){alert(`Server "${H}" is already configured`);return}const me={name:ae.name,description:ae.description||"",connection_type:ae.connection_type,command:ae.command,args:ae.args||[],env:ae.env||{},url:ae.url,headers:ae.headers||{},timeout:ae.timeout||30,tool_filter:ae.tool_filter||null,tool_name_prefix:ae.tool_name_prefix};n({mcp_servers:[...w,me]})}async function F(){for(const H of w)await pe(H.name)}function K(){const H=H4();r({id:H,name:"new_tool",description:"",module_path:"tools.custom",code:J4,state_keys_used:[]}),v(H)}function ee(H,ae){ae.stopPropagation(),confirm("Delete this tool?")&&(s(H),a===H&&(e==null||e(null)))}function X(H){B&&(H.name!==void 0&&(H.name===""||q4(H.name)?W(null):W("Name can only contain letters, numbers, and underscores")),i(B.id,H))}function se(H){H!==void 0&&B&&(p(H),X({code:H}))}async function Q(){if(B){P(!0);try{const H=await Py(t.id,B.name,B.description,B.state_keys_used);H.success&&H.code?(p(H.code),X({code:H.code})):(console.error("Failed to generate tool code:",H.error),alert("Failed to generate tool code: "+(H.error||"Unknown error")))}catch(H){console.error("Error generating tool code:",H),alert("Error generating tool code: "+H.message)}finally{P(!1)}}}const Z=_.useRef(null),re=_.useCallback((H,ae)=>{if(Z.current&&typeof Z.current=="function")try{Z.current()}catch{}try{const me=Jv(ae,H,{language:"python",endpoint:"/api/code-completion",trigger:"onTyping"});typeof me=="function"?Z.current=me:Z.current=null}catch{Z.current=null}},[]);_.useEffect(()=>()=>{if(Z.current&&typeof Z.current=="function")try{Z.current()}catch{}},[]);function ve(H){H!==void 0&&(y(H),T(H!==JSON.stringify(J,null,2)))}function je(){if(J)try{const H=JSON.parse(m),ae=J.name,me=w.map(ye=>ye.name===ae?H:ye);n({mcp_servers:me}),g(H.name),T(!1)}catch(H){alert("Invalid JSON: "+H.message)}}async function ze(){$(!0),M(null);try{const H=JSON.parse(m),ae=await fu({connection_type:H.connection_type,command:H.command,args:H.args,env:H.env,url:H.url,headers:H.headers,timeout:H.timeout||30});if(M(ae),ae.success&&ae.tools.length>0){const me={...H,tool_filter:ae.tools.map(ye=>ye.name)};y(JSON.stringify(me,null,2)),T(!0)}}catch(H){M({success:!1,tools:[],error:H.message})}finally{$(!1)}}const ke={};return t.custom_tools.forEach(H=>{const ae=H.module_path||"tools";ke[ae]||(ke[ae]=[]),ke[ae].push(H)}),o.jsxs("div",{className:"tools-panel",children:[o.jsx("style",{children:`
        .tools-panel {
          display: flex;
          gap: 20px;
          height: calc(100vh - 180px);
...
def my_callback(tool: BaseTool, tool_args: Dict[str, Any], tool_context: ToolContext, result: Dict) -> Optional[Dict]:
    ...
    return None
`;default:return Kv("before_agent")}}function Y4({onSelectCallback:e}){var C,$;const{project:t,updateProject:n,addCustomCallback:r,updateCustomCallback:i,removeCustomCallback:s}=ut(),[a,l]=_.useState(""),[c,u]=_.useState(null),[d,p]=_.useState(null),[f,h]=_.useState(!1),x=_.useRef(null);if(!t)return null;const b=t.custom_callbacks||[],k=b.find(N=>N.id===c);function g(N){u(N),e==null||e(N)}_.useEffect(()=>{k?(l(k.code),p(null)):l("")},[c,k]);function m(){const N=G4(),M="new_callback",R={id:N,name:M,description:"",module_path:`callbacks.${M}`,code:Kv("before_agent"),state_keys_used:[]};r(R),g(N)}function y(N,M){M.stopPropagation(),confirm("Delete this callback?")&&(s(N),c===N&&(e==null||e(null),u(null),l("")))}function j(){if(!c)return;const N=b.find(W=>W.id===c);if(!N)return;const M=N.name.trim();if(!M){alert("Please enter a name");return}if(!xm(M)){p("Name must contain only alphanumeric characters and underscores");return}if(b.find(W=>W.name===M&&W.id!==N.id)){p("A callback with this name already exists");return}i(N.id,{code:a,name:M,description:N.description,module_path:`callbacks.${M}`,state_keys_used:N.state_keys_used}),p(null)}function T(N,M){x.current=M;try{Jv(M,{endpoint:"/api/code-completion",language:"python"})}catch(R){console.warn("Failed to register Monacopilot completion:",R)}}async function S(){if(k){h(!0);try{let N="before_agent";const M=k.name.toLowerCase(),R=k.description.toLowerCase();M.includes("after_agent")||R.includes("after agent")?N="after_agent":M.includes("before_model")||R.includes("before model")?N="before_model":M.includes("after_model")||R.includes("after model")?N="after_model":M.includes("before_tool")||R.includes("before tool")?N="before_tool":M.includes("after_tool")||R.includes("after tool")?N="after_tool":(M.includes("before_agent")||R.includes("before agent"))&&(N="before_agent");const W=await Ly(t.id,k.name,k.description,N,k.state_keys_used);W.success&&W.code?(l(W.code),i(k.id,{code:W.code})):(console.error("Failed to generate callback code:",W.error),alert("Failed to generate callback code: "+(W.error||"Unknown error")))}catch(N){console.error("Error generating callback code:",N),alert("Error generating callback code: "+N.message)}finally{h(!1)}}}const P=(($=(C=t.app)==null?void 0:C.state_keys)==null?void 0:$.map(N=>N.name))||[];return o.jsxs("div",{className:"tools-panel",children:[o.jsx("style",{children:`
        .tools-panel {
          display: flex;
          height: 100%;
          background: var(--bg-primary);
...
Go to the Evals tab to view and edit the test case.`)}catch(U){alert(`Error creating test case: ${U.message||"Unknown error"}`)}finally{kp(!1)}},[f,e,Mi,gl]),I1=_.useCallback(()=>{const U=document.createElement("input");U.type="file",U.accept=".json",U.onchange=async oe=>{var ge;const fe=(ge=oe.target.files)==null?void 0:ge[0];if(fe)try{const ce=await fe.text(),Te=JSON.parse(ce);if(!Te.events||!Array.isArray(Te.events)){alert("Invalid run file: missing events array");return}a(),l(),y(null),T(null),Te.events.forEach(Pe=>{s(Pe)})}catch(ce){alert(`Failed to load run file: ${ce}`)}},U.click()},[a,l,s]);return _.useEffect(()=>{if(m!==null){const U=document.querySelector(".event-row.selected");U==null||U.scrollIntoView({behavior:"smooth",block:"nearest"})}},[m]),e?o.jsxs("div",{className:`run-panel ${K?"resizing":""}`,children:[o.jsx("style",{children:`
        .run-panel {
          display: flex;
          flex-direction: column;
          width: 100%;
      ...
      `}),o.jsxs("div",{className:"skillset-list",children:[o.jsxs("div",{className:"skillset-list-header",children:[o.jsx("h3",{children:"SkillSets"}),o.jsx("button",{className:"btn-icon",onClick:R,title:"Add SkillSet",children:o.jsx(Ke,{size:16})})]}),P.length===0?o.jsxs("div",{className:"empty-state",style:{padding:"40px 0"},children:[o.jsx(Rn,{size:32}),o.jsx("span",{children:"No SkillSets"}),o.jsxs("button",{className:"btn-primary",onClick:R,children:[o.jsx(Ke,{size:14})," Create SkillSet"]})]}):P.map(E=>o.jsxs("div",{className:`skillset-item ${n===E.id?"selected":""}`,onClick:()=>r(E.id),children:[o.jsx(Rn,{size:16,style:{color:"var(--accent)",flexShrink:0}}),o.jsxs("div",{className:"skillset-item-info",children:[o.jsx("div",{className:"skillset-item-name",children:E.name}),o.jsxs("div",{className:"skillset-item-count",children:[E.entry_count||0," entries"]})]}),o.jsx("button",{className:"skillset-item-delete",onClick:w=>{w.stopPropagation(),W(E.id)},children:o.jsx(Fe,{size:14})})]},E.id))]}),C?o.jsxs("div",{className:"skillset-detail",children:[o.jsxs("div",{className:"skillset-header",children:[o.jsxs("div",{className:"skillset-header-info",children:[o.jsx("input",{className:"skillset-name-input",value:C.name,onChange:E=>M(C.id,{name:E.target.value}),placeholder:"SkillSet Name"}),o.jsx("textarea",{className:"skillset-desc-input",value:C.description,onChange:E=>M(C.id,{description:E.target.value}),placeholder:"Description (optional)",rows:1}),o.jsxs("div",{className:"skillset-model",children:[o.jsx("label",{style:{fontSize:"12px",color:"var(--text-secondary)",marginRight:"8px"},children:"Embedding Model:"}),o.jsxs("select",{style:{flex:1,padding:"4px 8px",fontSize:"12px",background:"var(--bg-secondary)",border:"1px solid var(--border)",borderRadius:"4px",color:"var(--text-primary)"},value:C.embedding_model||"text-embedding-004",onChange:E=>M(C.id,{embedding_model:E.target.value}),children:[o.jsxs("optgroup",{label:"Google Gemini",children:[o.jsx("option",{value:"text-embedding-004",children:"text-embedding-004 (768d)"}),o.jsx("option",{value:"text-embedding-005",children:"text-embedding-005"})]}),o.jsxs("optgroup",{label:"OpenAI",children:[o.jsx("option",{value:"text-embedding-3-small",children:"text-embedding-3-small (1536d)"}),o.jsx("option",{value:"text-embedding-3-large",children:"text-embedding-3-large (3072d)"})]}),o.jsxs("optgroup",{label:"Cohere",children:[o.jsx("option",{value:"embed-english-v3.0",children:"embed-english-v3.0 (1024d)"}),o.jsx("option",{value:"embed-multilingual-v3.0",children:"embed-multilingual-v3.0 (1024d)"})]})]})]}),o.jsxs("div",{className:"skillset-stats",children:[o.jsxs("span",{className:"skillset-stat",children:[o.jsx("strong",{children:(i==null?void 0:i.entry_count)||0})," entries"]}),o.jsxs("span",{className:"skillset-stat",children:[o.jsx("strong",{children:Object.keys((i==null?void 0:i.sources)||{}).length})," sources"]}),j===!1&&o.jsx("span",{className:"skillset-stat",style:{color:"var(--warning)"},children:"⚠ No embeddings"})]})]}),o.jsx("button",{className:"btn-icon",onClick:$,title:"Refresh",children:o.jsx(on,{size:16})})]}),m&&o.jsxs("div",{className:"error-banner",children:[m,o.jsx("button",{onClick:()=>y(null),children:o.jsx(es,{size:14})})]}),o.jsxs("div",{className:"search-section",children:[o.jsx("div",{className:"search-input-wrapper",children:o.jsx("input",{className:"search-input",value:a,onChange:E=>l(E.target.value),onKeyDown:E=>E.key==="Enter"&&A(),placeholder:"Search this SkillSet..."})}),o.jsxs("button",{className:"btn-primary",onClick:A,disabled:d||!a.trim(),children:[o.jsx(Hy,{size:14}),d?"Searching...":"Search"]})]}),o.jsxs("div",{className:"search-results",children:[c.length===0&&!d&&a&&o.jsx("div",{className:"empty-state",children:o.jsx("span",{children:"No results found"})}),c.map(E=>o.jsxs("div",{className:"search-result",style:{background:O(E.score)},children:[o.jsxs("span",{className:"search-result-score",children:[(E.score*100).toFixed(0),"%"]}),o.jsx("div",{className:"search-result-text",children:E.text}),o.jsx("div",{className:"search-result-source",children:E.source_name})]},E.id))]}),o.jsxs("div",{className:"add-sources-section",children:[o.jsxs("div",{className:"add-sources-header",onClick:()=>h(!f),children:[f?o.jsx(Pt,{size:16}):o.jsx(bt,{size:16}),o.jsx("h4",{children:"Add Sources"})]}),f&&o.jsxs("div",{className:"add-sources-content",children:[o.jsxs("div",{className:"source-row",children:[o.jsx($d,{size:16,style:{color:"var(--text-tertiary)"}}),o.jsx("input",{className:"source-input",value:x,onChange:E=>b(E.target.value),onKeyDown:E=>E.key==="Enter"&&I(),placeholder:"Enter URL (e.g., llms.txt file)"}),o.jsxs("button",{className:"btn-primary",onClick:I,disabled:k||!x.trim(),children:[o.jsx(Hk,{size:14}),k?"Loading...":"Add"]})]}),o.jsxs("div",{className:"source-row",children:[o.jsx(Uk,{size:16,style:{color:"var(--text-tertiary)"}}),o.jsx("input",{ref:S,type:"file",accept:".txt,.md,.json,.csv,.html",onChange:D}),o.jsxs("button",{className:"btn-primary",onClick:()=>{var E;return(E=S.current)==null?void 0:E.click()},children:[o.jsx(ol,{size:14}),"Upload File"]}),o.jsx("span",{style:{fontSize:"12px",color:"var(--text-tertiary)"},children:".txt, .md, .json, .csv"})]}),((i==null?void 0:i.entry_count)||0)>0&&o.jsx("div",{className:"source-row",style:{marginTop:"8px"},children:o.jsxs("button",{className:"clear-button",onClick:z,children:[o.jsx(Fe,{size:12}),"Clear All Entries (",(i==null?void 0:i.entry_count)||0,")"]})})]})]})]}):P.length>0?o.jsx("div",{className:"skillset-detail",children:o.jsxs("div",{className:"empty-state",children:[o.jsx(Rn,{size:48}),o.jsx("span",{children:"Select a SkillSet"})]})}):null]}):null}const vn={tool_trajectory_avg_score:{name:"Tool Trajectory",description:"Did the agent call the right tools in the expected order?",requiresJudge:!1,scale:[0,1]},response_match_score:{name:"Response Match (ROUGE-1)",description:"Does the response contain expected text? (fuzzy word matching)",requiresJudge:!1,scale:[0,1]},response_evaluation_score:{name:"Response Evaluation (LLM)",description:"LLM-judged semantic match of final response",requiresJudge:!0,scale:[1,5]},final_response_match_v2:{name:"Response Quality v2 (LLM)",description:"Enhanced LLM-judged response quality check",requiresJudge:!0,scale:[0,1]},safety_v1:{name:"Safety",description:"Is the response safe and harmless? (Vertex AI)",requiresJudge:!0,scale:[0,1]},hallucinations_v1:{name:"Hallucination Detection",description:"Are all claims supported by context? No false information?",requiresJudge:!0,scale:[0,1]},rubric_based_final_response_quality_v1:{name:"Rubric: Response Quality",description:"Custom rubric-based quality assessment of responses",requiresJudge:!0,scale:[0,1]},rubric_based_tool_use_quality_v1:{name:"Rubric: Tool Use Quality",description:"Custom rubric-based assessment of tool usage",requiresJudge:!0,scale:[0,1]}},Wo=(e,t,n)=>{if(t==null)return{value:"-",comparison:""};const r=vn[e],i=(r==null?void 0:r.scale)||[0,1];if(i[0]===1&&i[1]===5){const s=n??3.5;return{value:t.toFixed(1),comparison:`${s.toFixed(1)} / ${i[1].toFixed(1)}`}}else{const s=n??.7;return{value:`${Math.round(t*100)}%`,comparison:`${Math.round(s*100)}% min`}}},j6={metrics:[{metric:"tool_trajectory_avg_score",enabled:!0,criterion:{threshold:1}},{metric:"response_match_score",enabled:!0,criterion:{threshold:.7}}],default_trajectory_match_type:"in_order",num_runs:1};function k1(){return`${Date.now().toString(36)}_${Math.random().toString(36).slice(2,6)}`}function _6(){const{project:e}=ut(),[t,n]=_.useState([]),[r,i]=_.useState(null),[s,a]=_.useState(null),[l,c]=_.useState(new Set),[u,d]=_.useState(new Map),[p,f]=_.useState(new Map),[h,x]=_.useState(new Set),[b,k]=_.useState(!1),[g,m]=_.useState(null),[y,j]=_.useState([]),[T,S]=_.useState(null),P=async()=>{if(e)try{const F=await qe.get(`/projects/${e.id}/eval-history`);j(F.runs||[])}catch(F){console.warn("Failed to load eval history:",F)}},C=async(F,K=!0)=>{if(e)try{const X=(await qe.get(`/projects/${e.id}/eval-history/${F}`)).run;if(S(X),X!=null&&X.case_results){const se=new Map;for(const Q of X.case_results)se.set(Q.eval_case_id,Q);d(se)}if((X==null?void 0:X.eval_set_id)==="batch")c(new Set(t.map(se=>se.id))),i(null);else if(X!=null&&X.eval_set_id){const se=new Map;se.set(X.eval_set_id,X),f(se),i(X.eval_set_id),c(Q=>new Set([...Q,X.eval_set_id]))}a(null),K&&window.history.pushState({run:F},"",`?run=${F}`)}catch(ee){console.warn("Failed to load history run:",ee)}},$=(F,K=!0)=>{i(F),a(null),S(null),K&&F?window.history.pushState({set:F},"",`?set=${F}`):K&&window.history.pushState({},"",window.location.pathname)},N=(F,K,ee=!0)=>{i(F),a(K),S(null),ee&&K?window.history.pushState({set:F,case:K},"",`?set=${F}&case=${K}`):ee&&F&&window.history.pushState({set:F},"",`?set=${F}`)},M=()=>{S(null),d(new Map),f(new Map),window.history.pushState({},"",window.location.pathname)},R=async F=>{if(e)try{await qe.delete(`/projects/${e.id}/eval-history/${F}`),j(K=>K.filter(ee=>ee.id!==F)),(T==null?void 0:T.id)===F&&S(null)}catch(K){console.warn("Failed to delete history run:",K)}};_.useEffect(()=>{e!=null&&e.id&&(W(),P())},[e==null?void 0:e.id]),_.useEffect(()=>{const F=()=>{x(new Set(t.map(ee=>ee.id)))},K=()=>{x(new Set),P()};return window.addEventListener("eval-tests-started",F),window.addEventListener("eval-tests-completed",K),()=>{window.removeEventListener("eval-tests-started",F),window.removeEventListener("eval-tests-completed",K)}},[t]),_.useEffect(()=>{if(!(e!=null&&e.id)||b)return;const F=()=>{const ee=new URLSearchParams(window.location.search),X=ee.get("set"),se=ee.get("case"),Q=ee.get("run");if(Q){C(Q,!1);return}if(X)i(X),a(se),S(null),c(Z=>new Set([...Z,X]));else{if(!r&&!s&&!T)return;i(null),a(null),S(null)}};F();const K=()=>{F()};return window.addEventListener("popstate",K),()=>window.removeEventListener("popstate",K)},[e==null?void 0:e.id,b,t.length]);const W=async()=>{var F,K;if(e!=null&&e.id){k(!0),m(null);try{const ee=await qe.get(`/projects/${e.id}/eval-sets`);if(n(ee.eval_sets||[]),((F=ee.eval_sets)==null?void 0:F.length)>0){const X=new URLSearchParams(window.location.search),se=X.get("set"),Q=X.get("case"),Z=se||(Q?(K=ee.eval_sets.find(re=>re.eval_cases.some(ve=>ve.id===Q)))==null?void 0:K.id:null)||ee.eval_sets[0].id;c(new Set([Z]))}}catch(ee){m(ee.message||"Failed to load eval sets")}finally{k(!1)}}},A=t.find(F=>F.id===r),I=A==null?void 0:A.eval_cases.find(F=>F.id===s),D=async()=>{if(e!=null&&e.id)try{const F=await qe.post(`/projects/${e.id}/eval-sets`,{name:"New Eval Set",description:"",eval_config:j6});n(K=>[...K,F.eval_set]),i(F.eval_set.id),c(K=>new Set([...K,F.eval_set.id]))}catch(F){m(F.message||"Failed to create eval set")}},z=async F=>{if(e!=null&&e.id)try{const K=await qe.post(`/projects/${e.id}/eval-sets/${F}/cases`,{name:"New Test Case",description:"",invocations:[{id:k1(),user_message:"",expected_response:"",expected_tool_calls:[],tool_trajectory_match_type:"in_order",rubrics:[]}],initial_state:{},rubrics:[],enabled_metrics:[],tags:[]});n(ee=>ee.map(X=>X.id===F?{...X,eval_cases:[...X.eval_cases,K.eval_case]}:X)),i(F),a(K.eval_case.id)}catch(K){m(K.message||"Failed to create eval case")}},O=async(F,K,ee)=>{if(e!=null&&e.id)try{const X=await qe.put(`/projects/${e.id}/eval-sets/${F}/cases/${K}`,ee);n(se=>se.map(Q=>Q.id===F?{...Q,eval_cases:Q.eval_cases.map(Z=>Z.id===K?X.eval_case:Z)}:Q))}catch(X){m(X.message||"Failed to update eval case")}},E=async(F,K)=>{if(e!=null&&e.id)try{await qe.delete(`/projects/${e.id}/eval-sets/${F}/cases/${K}`),n(ee=>ee.map(X=>X.id===F?{...X,eval_cases:X.eval_cases.filter(se=>se.id!==K)}:X)),s===K&&a(null)}catch(ee){m(ee.message||"Failed to delete eval case")}},w=async F=>{if(e!=null&&e.id)try{await qe.delete(`/projects/${e.id}/eval-sets/${F}`),n(K=>K.filter(ee=>ee.id!==F)),r===F&&(i(null),a(null))}catch(K){m(K.message||"Failed to delete eval set")}},B=async F=>{if(e!=null&&e.id)try{const K=await qe.get(`/projects/${e.id}/eval-sets/${F}/export`),ee=new Blob([JSON.stringify(K,null,2)],{type:"application/json"}),X=URL.createObjectURL(ee),se=document.createElement("a");se.href=X;const Q=t.find(Z=>Z.id===F);se.download=`${(Q==null?void 0:Q.name)||"eval-set"}.json`,document.body.appendChild(se),se.click(),document.body.removeChild(se),URL.revokeObjectURL(X)}catch(K){m(K.message||"Failed to export eval set")}},J=async F=>{if(e!=null&&e.id)try{const K=await F.text(),ee=JSON.parse(K),X=await qe.post(`/projects/${e.id}/eval-sets/import`,ee);n(se=>[...se,X.eval_set]),i(X.eval_set.id),c(se=>new Set([...se,X.eval_set.id]))}catch(K){m(K.message||"Failed to import eval set")}},v=_.useRef(null),V=async()=>{if(!(!(e!=null&&e.id)||t.length===0))try{const F=await Promise.all(t.map(async se=>{try{return await qe.get(`/projects/${e.id}/eval-sets/${se.id}/export`)}catch{return se}})),K=new Blob([JSON.stringify(F,null,2)],{type:"application/json"}),ee=URL.createObjectURL(K),X=document.createElement("a");X.href=ee,X.download=`${e.name||"project"}-eval-sets.json`,document.body.appendChild(X),X.click(),document.body.removeChild(X),URL.revokeObjectURL(ee)}catch(F){m(F.message||"Failed to export all eval sets")}},L=async(F,K)=>{if(e!=null&&e.id){x(ee=>new Set([...ee,K]));try{const ee=await qe.post(`/projects/${e.id}/eval-sets/${F}/cases/${K}/run`,{});d(X=>new Map(X).set(K,ee.result))}catch(ee){m(ee.message||"Failed to run eval case")}finally{x(ee=>{const X=new Set(ee);return X.delete(K),X})}}},Y=async F=>{if(!(e!=null&&e.id))return;const K=t.find(X=>X.id===F);if(!K)return;const ee=K.eval_cases.map(X=>X.id);x(X=>new Set([...X,F,...ee]));try{const X=await qe.post(`/projects/${e.id}/eval-sets/${F}/run`,{});f(se=>new Map(se).set(F,X.result));for(const se of X.result.case_results)d(Q=>new Map(Q).set(se.eval_case_id,se));try{await qe.post(`/projects/${e.id}/eval-history`,X.result),P()}catch(se){console.warn("Failed to save eval run to history:",se)}}catch(X){m(X.message||"Failed to run eval set")}finally{x(X=>{const se=new Set(X);return se.delete(F),ee.forEach(Q=>se.delete(Q)),se})}},ue=F=>{c(K=>{const ee=new Set(K);return ee.has(F)?ee.delete(F):ee.add(F),ee})},pe=F=>{let K=F.eval_cases.length,ee=0,X=0,se=0;for(const Q of F.eval_cases){const Z=u.get(Q.id);Z?Z.passed?ee++:X++:se++}return{total:K,passed:ee,failed:X,pending:se}},q=F=>F==null?"-":`${Math.round(F*100)}%`;return e?o.jsxs("div",{className:"eval-panel",children:[o.jsx("style",{children:`
        .eval-panel {
          display: flex;
          gap: 20px;
          height: calc(100vh - 180px);
...
`).join("")]})]})]},$)),r.error&&o.jsxs("div",{className:"result-details",children:[o.jsx("h5",{style:{color:"var(--error)"},children:"Error"}),o.jsx("div",{className:"detail-box",style:{color:"var(--error)"},children:r.error})]})]})]})}function E6({evalSet:e,projectId:t,result:n,isRunning:r,caseResults:i,onUpdate:s,onDelete:a,onRun:l,onExport:c}){var b,k,g,m;const[u,d]=_.useState(e.name),[p,f]=_.useState(!1);_.useEffect(()=>{d(e.name)},[e.id]);const h=_.useCallback(()=>{u!==e.name&&s({name:u})},[u,e.name,s]),x=y=>y==null?"-":`${Math.round(y*100)}%`;return o.jsxs(o.Fragment,{children:[o.jsxs("div",{className:"editor-header",children:[o.jsx(Vy,{size:20,style:{color:"var(--accent-secondary)"}}),o.jsx("input",{type:"text",value:u,onChange:y=>d(y.target.value),onBlur:h,placeholder:"Eval set name"}),o.jsx("button",{className:"btn btn-secondary btn-sm",onClick:()=>{const y=`${window.location.origin}/project/${t}/evaluate?set=${e.id}`;navigator.clipboard.writeText(y)},title:"Copy link to this eval set",children:o.jsx(Fd,{size:14})}),o.jsxs("button",{className:`btn btn-sm ${p?"btn-primary":"btn-secondary"}`,onClick:()=>f(!p),title:"View/Hide JSON",children:[o.jsx(jn,{size:14}),"JSON"]}),o.jsx("button",{className:"btn btn-secondary btn-sm",onClick:c,title:"Export as JSON (compatible with adk eval)",children:o.jsx(Zo,{size:14})}),o.jsxs("button",{className:"btn btn-primary btn-sm",onClick:l,disabled:r,children:[r?o.jsx(Io,{size:14,className:"spinning"}):o.jsx(pr,{size:14}),"Run All"]}),o.jsx("button",{className:"btn btn-danger btn-sm",onClick:a,children:o.jsx(Fe,{size:14})})]}),o.jsx("div",{className:"editor-content",children:p?o.jsxs("div",{style:{display:"flex",flexDirection:"column",gap:16,height:"100%"},children:[o.jsx("div",{style:{fontSize:12,color:"var(--text-secondary)",padding:"8px 0"},children:o.jsxs("p",{style:{margin:0},children:["This is the ADK-compatible JSON format for this evaluation set. Save this file and use with ",o.jsx("code",{style:{background:"var(--bg-tertiary)",padding:"2px 6px",borderRadius:4},children:"adk eval <agent_path> <eval_file.json>"})]})}),o.jsx("div",{style:{flex:1,minHeight:400,border:"1px solid var(--border-color)",borderRadius:"var(--radius-md)",overflow:"hidden"},children:o.jsx(Kt,{height:"100%",language:"json",theme:"vs-dark",value:JSON.stringify([{id:e.id,name:e.name,description:e.description||void 0,eval_cases:e.eval_cases.map(y=>{var j,T;return{name:y.name,description:y.description||void 0,tags:(j=y.tags)!=null&&j.length?y.tags:void 0,target_agent:y.target_agent!=="root_agent"?y.target_agent:void 0,invocations:y.invocations.map(S=>{var P;return{user_message:S.user_message,expected_response:S.expected_response||void 0,expected_tool_calls:(P=S.expected_tool_calls)!=null&&P.length?S.expected_tool_calls.map(C=>({tool_name:C.tool_name,args:C.match_type!=="name_only"&&Object.keys(C.args||{}).length?C.args:void 0})):void 0}}),session_input:Object.keys(y.session_input||{}).length?{state:y.session_input}:void 0,final_session_state:Object.keys(y.final_session_state||{}).length?y.final_session_state:void 0,rubrics:(T=y.rubrics)!=null&&T.length?y.rubrics.map(S=>S.rubric):void 0}}),eval_config:e.eval_config?{judge_model:e.eval_config.judge_model||void 0,metrics:((b=e.eval_config.metrics)==null?void 0:b.filter(y=>y.enabled))||void 0}:void 0}],null,2),options:{readOnly:!0,minimap:{enabled:!1},fontSize:12,fontFamily:"'JetBrains Mono', monospace",lineNumbers:"on",scrollBeyondLastLine:!1,automaticLayout:!0,tabSize:2,wordWrap:"on",padding:{top:12}}})}),o.jsx("div",{style:{display:"flex",gap:8},children:o.jsxs("button",{className:"btn btn-secondary btn-sm",onClick:()=>{var j;const y=JSON.stringify([{id:e.id,name:e.name,description:e.description||void 0,eval_cases:e.eval_cases.map(T=>{var S,P;return{name:T.name,description:T.description||void 0,tags:(S=T.tags)!=null&&S.length?T.tags:void 0,target_agent:T.target_agent!=="root_agent"?T.target_agent:void 0,invocations:T.invocations.map(C=>{var $;return{user_message:C.user_message,expected_response:C.expected_response||void 0,expected_tool_calls:($=C.expected_tool_calls)!=null&&$.length?C.expected_tool_calls.map(N=>({tool_name:N.tool_name,args:N.match_type!=="name_only"&&Object.keys(N.args||{}).length?N.args:void 0})):void 0}}),session_input:Object.keys(T.session_input||{}).length?{state:T.session_input}:void 0,final_session_state:Object.keys(T.final_session_state||{}).length?T.final_session_state:void 0,rubrics:(P=T.rubrics)!=null&&P.length?T.rubrics.map(C=>C.rubric):void 0}}),eval_config:e.eval_config?{judge_model:e.eval_config.judge_model||void 0,metrics:((j=e.eval_config.metrics)==null?void 0:j.filter(T=>T.enabled))||void 0}:void 0}],null,2);navigator.clipboard.writeText(y)},children:[o.jsx(Xo,{size:14})," Copy JSON"]})})]}):o.jsxs(o.Fragment,{children:[o.jsxs("div",{className:"form-section",children:[o.jsx("h4",{children:"Description"}),o.jsx("textarea",{value:e.description,onChange:y=>s({description:y.target.value}),placeholder:"Description of this evaluation set...",style:{minHeight:40}})]}),o.jsxs("div",{className:"form-section",children:[o.jsx("h4",{children:"LLM Judge Model"}),o.jsx("p",{style:{fontSize:12,color:"var(--text-muted)",marginBottom:8},children:"Model used for LLM-judged metrics (safety, hallucinations, etc.)."}),o.jsx(S6,{value:((k=e.eval_config)==null?void 0:k.judge_model)||"",onChange:y=>s({eval_config:{...e.eval_config,judge_model:y}})})]}),o.jsxs("div",{className:"form-section",children:[o.jsxs("h4",{children:[o.jsx(qy,{size:14})," Evaluation Metrics"]}),o.jsx("p",{style:{fontSize:12,color:"var(--text-muted)",marginBottom:8},children:"Configure which metrics to use and their pass thresholds."}),Object.keys(vn).map(y=>{var C,$,N;const j=vn[y],T=($=(C=e.eval_config)==null?void 0:C.metrics)==null?void 0:$.find(M=>M.metric===y),S=(T==null?void 0:T.enabled)??!1,P=((N=T==null?void 0:T.criterion)==null?void 0:N.threshold)??.7;return o.jsxs("div",{style:{display:"flex",alignItems:"center",gap:10,marginBottom:6},children:[o.jsxs("label",{className:"toggle-switch",style:{margin:0},children:[o.jsx("input",{type:"checkbox",checked:S,onChange:M=>{var A;const R=[...((A=e.eval_config)==null?void 0:A.metrics)||[]],W=R.findIndex(I=>I.metric===y);M.target.checked?W===-1?R.push({metric:y,enabled:!0,criterion:{threshold:.7}}):R[W]={...R[W],enabled:!0}:W!==-1&&(R[W]={...R[W],enabled:!1}),s({eval_config:{...e.eval_config,metrics:R}})}}),o.jsx("span",{className:"toggle-slider"})]}),o.jsxs("span",{style:{fontSize:12,opacity:S?1:.5,minWidth:140,fontWeight:S?500:400},children:[j.name,j.requiresJudge&&o.jsx("span",{style:{fontSize:9,marginLeft:4,color:"var(--accent-primary)"},children:"LLM"})]}),o.jsx("span",{style:{fontSize:11,color:"var(--text-muted)",opacity:S?1:.4},children:"≥"}),o.jsx("input",{type:"number",min:0,max:1,step:.1,value:P,disabled:!S,onChange:M=>{var A;const R=[...((A=e.eval_config)==null?void 0:A.metrics)||[]],W=R.findIndex(I=>I.metric===y);W!==-1&&(R[W]={...R[W],criterion:{...R[W].criterion,threshold:parseFloat(M.target.value)||.7}},s({eval_config:{...e.eval_config,metrics:R}}))},style:{width:60,textAlign:"center",opacity:S?1:.3,padding:"2px 4px",fontSize:11}})]},y)}),o.jsxs("div",{className:"form-row",style:{marginTop:16},children:[o.jsxs("div",{className:"form-field",children:[o.jsx("label",{children:"Default Trajectory Match Type"}),o.jsxs("select",{value:((g=e.eval_config)==null?void 0:g.default_trajectory_match_type)||"in_order",onChange:y=>s({eval_config:{...e.eval_config,default_trajectory_match_type:y.target.value}}),children:[o.jsx("option",{value:"exact",children:"Exact (same order, no extras)"}),o.jsx("option",{value:"in_order",children:"In Order (extras allowed between)"}),o.jsx("option",{value:"any_order",children:"Any Order (all present, any order)"})]})]}),o.jsxs("div",{className:"form-field",children:[o.jsx("label",{children:"Number of Runs"}),o.jsx("input",{type:"number",min:1,max:10,value:((m=e.eval_config)==null?void 0:m.num_runs)||1,onChange:y=>s({eval_config:{...e.eval_config,num_runs:parseInt(y.target.value)||1}})}),o.jsx("p",{style:{fontSize:11,color:"var(--text-muted)",marginTop:4},children:"Run each test multiple times for statistical reliability."})]})]})]}),o.jsxs("div",{className:"form-section",children:[o.jsxs("h4",{children:[o.jsx(Gk,{size:14})," Coverage Summary"]}),n?o.jsxs(o.Fragment,{children:[o.jsxs("div",{className:"result-scores",children:[o.jsxs("div",{className:"score-card",children:[o.jsxs("div",{className:"score-value",style:{color:"var(--accent-primary)"},children:[n.passed_cases,"/",n.total_cases]}),o.jsx("div",{className:"score-label",children:"Cases Passed"})]}),o.jsxs("div",{className:"score-card",children:[o.jsx("div",{className:`score-value ${n.overall_pass_rate>=.8?"passed":"failed"}`,children:x(n.overall_pass_rate)}),o.jsx("div",{className:"score-label",children:"Pass Rate"})]}),Object.entries(n.metric_avg_scores||{}).map(([y,j])=>{var S;const T=Wo(y,j);return o.jsxs("div",{className:"score-card",children:[o.jsx("div",{className:"score-value",children:T.value}),o.jsxs("div",{className:"score-label",children:["Avg ",((S=vn[y])==null?void 0:S.name)||y]})]},y)})]}),o.jsxs("div",{style:{marginTop:16},children:[o.jsx("div",{style:{marginBottom:4,fontSize:12,color:"var(--text-muted)"},children:"Overall Pass Rate"}),o.jsx("div",{className:"coverage-bar",children:o.jsx("div",{className:`coverage-fill ${n.overall_pass_rate>=.8?"passed":"failed"}`,style:{width:`${n.overall_pass_rate*100}%`}})})]}),Object.entries(n.metric_pass_rates||{}).length>0&&o.jsxs("div",{style:{marginTop:16},children:[o.jsx("h5",{style:{fontSize:13,marginBottom:8},children:"Metric Pass Rates"}),Object.entries(n.metric_pass_rates).map(([y,j])=>{var T;return o.jsxs("div",{style:{marginBottom:8},children:[o.jsxs("div",{style:{display:"flex",justifyContent:"space-between",fontSize:12,marginBottom:4},children:[o.jsx("span",{children:((T=vn[y])==null?void 0:T.name)||y}),o.jsx("span",{children:x(j)})]}),o.jsx("div",{className:"coverage-bar",children:o.jsx("div",{className:`coverage-fill ${j>=.8?"passed":"failed"}`,style:{width:`${j*100}%`}})})]},y)})]}),o.jsxs("div",{style:{marginTop:16},children:[o.jsx("h5",{style:{fontSize:13,marginBottom:8},children:"Individual Results"}),o.jsxs("table",{style:{width:"100%",fontSize:12,borderCollapse:"collapse"},children:[o.jsx("thead",{children:o.jsxs("tr",{style:{borderBottom:"1px solid var(--border-color)"},children:[o.jsx("th",{style:{textAlign:"left",padding:"8px 4px"},children:"Test Case"}),o.jsx("th",{style:{textAlign:"center",padding:"8px 4px"},children:"Metrics"}),o.jsx("th",{style:{textAlign:"center",padding:"8px 4px"},children:"Status"})]})}),o.jsx("tbody",{children:n.case_results.map(y=>o.jsxs("tr",{style:{borderBottom:"1px solid var(--border-color)"},children:[o.jsx("td",{style:{padding:"8px 4px"},children:y.eval_case_name}),o.jsx("td",{style:{textAlign:"center",padding:"8px 4px"},children:y.metric_results.map((j,T)=>{const S=Wo(j.metric,j.score,j.threshold);return o.jsx("span",{style:{fontSize:10,padding:"2px 4px",marginRight:4,borderRadius:"var(--radius-sm)",background:j.passed?"rgba(var(--success-rgb), 0.15)":"rgba(var(--error-rgb), 0.15)",color:j.passed?"var(--success)":"var(--error)"},children:S.value},T)})}),o.jsx("td",{style:{textAlign:"center",padding:"8px 4px"},children:y.passed?o.jsx(Ir,{size:14,style:{color:"var(--success)"}}):y.error?o.jsx(wi,{size:14,style:{color:"var(--warning)"}}):o.jsx(ji,{size:14,style:{color:"var(--error)"}})})]},y.eval_case_id))})]})]})]}):o.jsxs("div",{style:{textAlign:"center",padding:"32px",color:"var(--text-muted)",background:"var(--bg-tertiary)",borderRadius:"var(--radius-md)"},children:[o.jsx(Ud,{size:32,style:{marginBottom:8,opacity:.3}}),o.jsx("p",{children:"Run the evaluation set to see coverage metrics"})]})]}),o.jsxs("div",{className:"form-section",children:[o.jsxs("h4",{children:["Test Cases (",e.eval_cases.length,")"]}),e.eval_cases.length===0?o.jsx("p",{style:{color:"var(--text-muted)",fontSize:13},children:"No test cases yet. Add cases to this eval set to start testing."}):o.jsx("ul",{style:{listStyle:"none",padding:0},children:e.eval_cases.map(y=>{const j=i.get(y.id);return o.jsxs("li",{style:{display:"flex",alignItems:"center",gap:8,padding:"8px 12px",background:"var(--bg-tertiary)",borderRadius:"var(--radius-sm)",marginBottom:8},children:[j?j.passed?o.jsx(Ir,{size:14,style:{color:"var(--success)"}}):o.jsx(ji,{size:14,style:{color:"var(--error)"}}):o.jsx(Ca,{size:14,style:{color:"var(--text-muted)"}}),o.jsx("span",{style:{flex:1},children:y.name}),o.jsxs("span",{style:{fontSize:11,color:"var(--text-muted)"},children:[y.invocations.length," turn(s)"]})]},y.id)})})]})]})})]})}function z6(){const{project:e,setProject:t}=ut(),[n,r]=_.useState(""),[i,s]=_.useState(!0),[a,l]=_.useState(!1),[c,u]=_.useState(null),[d,p]=_.useState(!1);if(!e)return null;_.useEffect(()=>{f()},[e.id]);async function f(){s(!0),u(null);try{const m=await Ny(e.id);r(m),l(!1)}catch(m){u(m.message)}finally{s(!1)}}function h(m){m!==void 0&&(r(m),l(!0),u(null))}async function x(){s(!0),u(null);try{const m=await Ey(e.id,n);t(m),l(!1)}catch(m){u(m.message)}finally{s(!1)}}function b(){navigator.clipboard.writeText(n),p(!0),setTimeout(()=>p(!1),2e3)}function k(){const m=new Blob([n],{type:"text/yaml"}),y=URL.createObjectURL(m),j=document.createElement("a");j.href=y,j.download=`${e.name}.yaml`,j.click(),URL.revokeObjectURL(y)}function g(){const m=document.createElement("input");m.type="file",m.accept=".yaml,.yml",m.onchange=async y=>{var S;const j=(S=y.target.files)==null?void 0:S[0];if(!j)return;const T=await j.text();r(T),l(!0)},m.click()}return o.jsxs("div",{className:"yaml-panel",children:[o.jsx("style",{children:`
      ...
      `}),o.jsxs("div",{className:"code-header",children:[o.jsxs("div",{className:"code-title",children:[o.jsx(jn,{size:16}),o.jsx("h3",{children:"Python Code"}),o.jsx("span",{className:"badge",children:s?"Loading...":"Generated"}),t&&o.jsxs("span",{className:"status-badge success",children:[o.jsx(Id,{size:12}),"Copied!"]}),l&&o.jsxs("span",{className:"status-badge error",children:[o.jsx(wi,{size:12}),"Error"]})]}),o.jsxs("div",{className:"code-actions",children:[o.jsxs("button",{className:"btn btn-secondary btn-sm",onClick:u,title:"Copy to clipboard",disabled:s||!!l,children:[o.jsx(Xo,{size:14}),"Copy"]}),o.jsxs("button",{className:"btn btn-secondary btn-sm",onClick:d,title:"Download Python file",disabled:s||!!l,children:[o.jsx(Zo,{size:14}),"Download"]})]})]}),o.jsx("div",{className:"code-editor",children:s?o.jsx("div",{className:"code-loading",children:o.jsx("div",{children:"Loading generated code..."})}):l?o.jsxs("div",{className:"code-error",children:[o.jsx(wi,{size:24}),o.jsx("div",{children:l})]}):o.jsx(Kt,{height:"100%",language:"python",theme:"vs-dark",value:r,options:{readOnly:!0,minimap:{enabled:!1},fontSize:13,fontFamily:"'JetBrains Mono', monospace",lineNumbers:"on",scrollBeyondLastLine:!1,automaticLayout:!0,tabSize:4,insertSpaces:!0,padding:{top:12},wordWrap:"on"}})}),o.jsxs("div",{className:"code-info",children:[o.jsx("p",{children:"This is the Python code equivalent of your project configuration. You can use this code directly with ADK."}),o.jsxs("p",{children:["Place this in a file named ",o.jsx("code",{children:"agent.py"})," inside your agent directory, then run with ",o.jsx("code",{children:"adk web ."})," or ",o.jsx("code",{children:"adk run your_agent"}),"."]})]})]})}const A6=[{id:"app",label:"App",icon:qy},{id:"agents",label:"Agents",icon:Er},{id:"tools",label:"Tools",icon:ln},{id:"callbacks",label:"Callbacks",icon:jn},{id:"run",label:"Run",icon:Wy},{id:"skillsets",label:"SkillSets",icon:Dk},{id:"eval",label:"Evaluate",icon:gu},{id:"yaml",label:"YAML",icon:Bk},{id:"code",label:"Code",icon:jn}],P6=["app","agents","tools","callbacks","run","skillsets","eval","yaml","code"];function mc(){var I,D;const{projectId:e,tab:t,itemId:n}=Fw(),r=Md(),{project:i,setProject:s,activeTab:a,setActiveTab:l,hasUnsavedChanges:c,setHasUnsavedChanges:u,selectedAgentId:d,setSelectedAgentId:p,selectedToolId:f,setSelectedToolId:h}=ut(),[x,b]=_.useState(!0),[k,g]=_.useState(!1),[m,y]=_.useState(!1),[j,T]=_.useState(null),S=_.useRef(!0),P=_.useRef(null);_.useEffect(()=>{t&&P6.includes(t)?l(t):!t&&e&&r(`/project/${e}/${a}`,{replace:!0})},[t,e]),_.useEffect(()=>{t==="agents"&&n?p(n):t==="tools"&&n&&h(n)},[t,n]);function C(z){l(z),z==="agents"&&d?r(`/project/${e}/${z}/${d}`,{replace:!0}):z==="tools"&&f?r(`/project/${e}/${z}/${f}`,{replace:!0}):r(`/project/${e}/${z}`,{replace:!0})}function $(z){z?r(`/project/${e}/${a}/${z}`,{replace:!0}):r(`/project/${e}/${a}`,{replace:!0})}_.useEffect(()=>(e&&N(e),()=>{s(null),u(!1)}),[e]);async function N(z){S.current=!0;try{const O=await ky(z);s(O),P.current=JSON.stringify(O),u(!1)}catch(O){console.error("Failed to load project:",O),r("/")}finally{b(!1),setTimeout(()=>{S.current=!1},100)}}async function M(){if(i){g(!0);try{const{eval_sets:z,...O}=i;await du(i.id,O),P.current=JSON.stringify(i),u(!1)}catch(z){console.error("Failed to save project:",z)}finally{g(!1)}}}async function R(){if(i){y(!0),T(null),window.dispatchEvent(new CustomEvent("eval-tests-started"));try{let z=0,O=0;const E=[],w=[];for(const B of i.eval_sets||[]){if(B.eval_cases.length===0)continue;const J=await qe.post(`/projects/${i.id}/eval-sets/${B.id}/run`,{});J.result&&(z+=J.result.passed_cases||0,O+=J.result.total_cases||0,J.result.case_results&&E.push(...J.result.case_results),w.push(J.result.eval_set_name||B.name||B.id))}if(E.length>0){const B={id:Date.now().toString(36)+Math.random().toString(36).substr(2,5),eval_set_id:"batch",eval_set_name:w.length>1?`All Tests (${w.length} sets)`:w[0]||"All Tests",started_at:Date.now()/1e3,completed_at:Date.now()/1e3,total_cases:O,passed_cases:z,failed_cases:O-z,case_results:E};try{await qe.post(`/projects/${i.id}/eval-history`,B)}catch(J){console.warn("Failed to save batch eval run to history:",J)}}T({passed:z,total:O}),window.dispatchEvent(new CustomEvent("eval-tests-completed")),setTimeout(()=>T(null),5e3)}catch(z){console.error("Failed to run tests:",z),T({passed:0,total:-1}),setTimeout(()=>T(null),5e3)}finally{y(!1)}}}const W=_.useRef(null);_.useEffect(()=>{if(i&&!S.current&&W.current){const z=i.app.models||[],O=W.current||[];if(z.some((w,B)=>{const J=O.find(v=>v.id===w.id);return J?J.provider!==w.provider||J.model_name!==w.model_name||J.api_base!==w.api_base||J.temperature!==w.temperature||J.max_output_tokens!==w.max_output_tokens||J.top_p!==w.top_p||J.top_k!==w.top_k:!1})){const w=i.app.default_model_id,B=i.agents.map(v=>{if(v.type==="LlmAgent"&&v.model){const V=v.model._appModelId;if(V){const L=z.find(Y=>Y.id===V);if(L)return{...v,model:{provider:L.provider,model_name:L.model_name,api_base:L.api_base,temperature:L.temperature,max_output_tokens:L.max_output_tokens,top_p:L.top_p,top_k:L.top_k,fallbacks:[],_appModelId:V}}}else if(w){const L=z.find(Y=>Y.id===w);if(L&&v.model.provider===L.provider&&v.model.model_name===L.model_name&&v.model.api_base===L.api_base)return{...v,model:{provider:L.provider,model_name:L.model_name,api_base:L.api_base,temperature:L.temperature,max_output_tokens:L.max_output_tokens,top_p:L.top_p,top_k:L.top_k,fallbacks:[],_appModelId:w}}}}return v});B.some((v,V)=>JSON.stringify(v)!==JSON.stringify(i.agents[V]))&&s({...i,agents:B})}}i&&(W.current=i.app.models||[])},[i==null?void 0:i.app.models,i,s]);const A=_.useRef(null);return _.useEffect(()=>(i&&!S.current&&P.current&&JSON.stringify(i)!==P.current&&(u(!0),A.current&&clearTimeout(A.current),A.current=setTimeout(async()=>{try{const{eval_sets:O,...E}=i;await du(i.id,E),P.current=JSON.stringify(i),u(!1)}catch(O){console.error("Auto-save failed:",O)}},500)),()=>{A.current&&clearTimeout(A.current)}),[i]),x?o.jsxs("div",{className:"loading-screen",children:[o.jsx("style",{children:`
          .loading-screen {
            height: 100vh;
            display: flex;
            align-items: center;
      ...
      `}),o.jsxs("header",{className:"top-bar",children:[o.jsxs("div",{className:"top-bar-left",children:[o.jsxs("button",{className:"back-btn",onClick:()=>r("/"),children:[o.jsx(Ok,{size:18}),"Project"]}),o.jsx("h1",{className:"project-name",children:i.name})]}),o.jsx("nav",{className:"tabs-bar",children:A6.map(z=>o.jsxs("button",{className:`tab-btn ${a===z.id?"active":""}`,onClick:()=>C(z.id),children:[o.jsx(z.icon,{size:14}),z.label]},z.id))}),o.jsxs("div",{className:"top-bar-right",children:[o.jsxs("button",{className:`btn ${j?j.total===-1?"btn-error":j.passed===j.total?"btn-success":"btn-warning":"btn-secondary"}`,onClick:R,disabled:m||!((I=i==null?void 0:i.eval_sets)!=null&&I.some(z=>z.eval_cases.length>0)),title:(D=i==null?void 0:i.eval_sets)!=null&&D.some(z=>z.eval_cases.length>0)?"Run all evaluation tests":"No test cases defined",style:{marginRight:8},children:[m?o.jsx(qk,{size:16,className:"spin"}):o.jsx(pr,{size:16}),m?"Testing...":j?j.total===-1?"Error":`${j.passed}/${j.total}`:"Test"]}),o.jsxs("button",{className:"btn btn-primary",onClick:M,disabled:k,children:[o.jsx(Ea,{size:16}),k?"Saving...":"Save"]})]})]}),o.jsxs("main",{className:"main-content",children:[a==="app"&&o.jsx(aj,{}),a==="agents"&&o.jsx(h4,{onSelectAgent:$}),a==="tools"&&o.jsx(K4,{onSelectTool:$}),a==="callbacks"&&o.jsx(Y4,{onSelectCallback:$}),a==="run"&&o.jsx(v6,{}),a==="skillsets"&&o.jsx(k6,{}),a==="eval"&&o.jsx(_6,{}),a==="yaml"&&o.jsx(z6,{}),a==="code"&&o.jsx(T6,{})]})]}):null}function L6(){const{setMcpServers:e,setBuiltinTools:t}=ut();return _.useEffect(()=>{Rd().then(e).catch(console.error),zy().then(t).catch(console.error)},[e,t]),o.jsxs(rk,{children:[o.jsx(Vr,{path:"/",element:o.jsx(ej,{})}),o.jsx(Vr,{path:"/project/:projectId",element:o.jsx(mc,{})}),o.jsx(Vr,{path:"/project/:projectId/:tab",element:o.jsx(mc,{})}),o.jsx(Vr,{path:"/project/:projectId/:tab/:itemId",element:o.jsx(mc,{})}),o.jsx(Vr,{path:"*",element:o.jsx(tk,{to:"/",replace:!0})})]})}gc.createRoot(document.getElementById("root")).render(o.jsx(It.StrictMode,{children:o.jsx(sk,{children:o.jsx(L6,{})})}));
