 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */(function(e){function t($,I){var k=$.length;$.push(I);e:for(;0<k;){var V=k-1>>>1,J=$[V];if(0<i(J,I))$[V]=I,$[k]=J,k=V;else break e}}function n($){return $.length===0?null:$[0]}function r($){if($.length===0)return null;var I=$[0],k=$.pop();if(k!==I){$[0]=k;e:for(var V=0,J=$.length,C=J>>>1;V<C;){var oe=2*(V+1)-1,R=$[oe],Z=oe+1,B=$[Z];if(0>i(R,k))Z<J&&0>i(B,R)?($[V]=B,$[Z]=k,V=Z):($[V]=R,$[oe]=k,V=oe);else if(Z<J&&0>i(B,k))$[V]=B,$[Z]=k,V=Z;else break e}}return I}function i($,I){var k=$.sortIndex-I.sortIndex;return k!==0?k:$.id-I.id}if(typeof performance=="object"&&typeof performance.now=="function"){var o=performance;e.unstable_now=function(){return o.now()}}else{var a=Date,l=a.now();e.unstable_now=function(){return a.now()-l}}var c=[],u=[],d=1,p=null,f=3,m=!1,y=!1,w=!1,E=typeof setTimeout=="function"?setTimeout:null,g=typeof clearTimeout=="function"?clearTimeout:null,h=typeof setImmediate<"u"?setImmediate:null;typeof navigator<"u"&&navigator.scheduling!==void 0&&navigator.scheduling.isInputPending!==void 0&&navigator.scheduling.isInputPending.bind(navigator.scheduling);function v($){for(var I=n(u);I!==null;){if(I.callback===null)r(u);else if(I.startTime<=$)r(u),I.sortIndex=I.expirationTime,t(c,I);else break;I=n(u)}}function L($){if(w=!1,v($),!y)if(n(c)!==null)y=!0,K(S);else{var I=n(u);I!==null&&P(L,I.startTime-$)}}function S($,I){y=!1,w&&(w=!1,g(z),z=-1),m=!0;var k=f;try{for(v(I),p=n(c);p!==null&&(!(p.expirationTime>I)||$&&!b());){var V=p.callback;if(typeof V=="function"){p.callback=null,f=p.priorityLevel;var J=V(p.expirationTime<=I);I=e.unstable_now(),typeof J=="function"?p.callback=J:p===n(c)&&r(c),v(I)}else r(c);p=n(c)}if(p!==null)var C=!0;else{var oe=n(u);oe!==null&&P(L,oe.startTime-I),C=!1}return C}finally{p=null,f=k,m=!1}}var j=!1,x=null,z=-1,A=5,N=-1;function b(){return!(e.unstable_now()-N<A)}function T(){if(x!==null){var $=e.unstable_now();N=$;var I=!0;try{I=x(!0,$)}finally{I?O():(j=!1,x=null)}}else j=!1}var O;if(typeof h=="function")O=function(){h(T)};else if(typeof MessageChannel<"u"){var U=new MessageChannel,D=U.port2;U.port1.onmessage=T,O=function(){D.postMessage(null)}}else O=function(){E(T,0)};function K($){x=$,j||(j=!0,O())}function P($,I){z=E(function(){$(e.unstable_now())},I)}e.unstable_IdlePriority=5,e.unstable_ImmediatePriority=1,e.unstable_LowPriority=4,e.unstable_NormalPriority=3,e.unstable_Profiling=null,e.unstable_UserBlockingPriority=2,e.unstable_cancelCallback=function($){$.callback=null},e.unstable_continueExecution=function(){y||m||(y=!0,K(S))},e.unstable_forceFrameRate=function($){0>$||125<$?console.error("forceFrameRate takes a positive int between 0 and 125, forcing frame rates higher than 125 fps is not supported"):A=0<$?Math.floor(1e3/$):5},e.unstable_getCurrentPriorityLevel=function(){return f},e.unstable_getFirstCallbackNode=function(){return n(c)},e.unstable_next=function($){switch(f){case 1:case 2:case 3:var I=3;break;default:I=f}var k=f;f=I;try{return $()}finally{f=k}},e.unstable_pauseExecution=function(){},e.unstable_requestPaint=function(){},e.unstable_runWithPriority=function($,I){switch($){case 1:case 2:case 3:case 4:case 5:break;default:$=3}var k=f;f=$;try{return I()}finally{f=k}},e.unstable_scheduleCallback=function($,I,k){var V=e.unstable_now();switch(typeof k=="object"&&k!==null?(k=k.delay,k=typeof k=="number"&&0<k?V+k:V):k=V,$){case 1:var J=-1;break;case 2:J=250;break;case 5:J=1073741823;break;case 4:J=1e4;break;default:J=5e3}return J=k+J,$={id:d++,callback:I,priorityLevel:$,startTime:k,expirationTime:J,sortIndex:-1},k>V?($.sortIndex=k,t(u,$),n(c)===null&&$===n(u)&&(w?(g(z),z=-1):w=!0,P(L,k-V))):($.sortIndex=J,t(c,$),y||m||(y=!0,K(S))),$},e.unstable_shouldYield=b,e.unstable_wrapCallback=function($){var I=f;return function(){var k=f;f=I;try{return $.apply(this,arguments)}finally{f=k}}}})(gf);hf.exports=gf;var Lx=hf.exports;/**
 * @license React
...
`).length,m=Math.max(r,Math.min(f*20+40,500));l(m)}},[e,r]),_.useEffect(()=>{i&&u.current&&u.current.focus()},[i]);function d(f){u.current=f,f.focus()}function p(f){c.current&&!c.current.contains(f.target)&&o(!1)}return _.useEffect(()=>{if(i)return document.addEventListener("mousedown",p),()=>document.removeEventListener("mousedown",p)},[i]),s.jsxs("div",{ref:c,className:"markdown-editor",children:[s.jsx("style",{children:`
      ...
      `}),i?s.jsx("div",{className:"monaco-wrapper",children:s.jsx(an,{height:"100%",language:"markdown",theme:"vs-dark",value:e,onChange:f=>t(f||""),onMount:d,options:{minimap:{enabled:!1},fontSize:14,fontFamily:"'JetBrains Mono', monospace",lineNumbers:"off",scrollBeyondLastLine:!1,automaticLayout:!0,wordWrap:"on",padding:{top:12,bottom:12},lineDecorationsWidth:8,folding:!1,glyphMargin:!1,renderLineHighlight:"none",overviewRulerLanes:0,hideCursorInOverviewRuler:!0,scrollbar:{vertical:"auto",horizontal:"hidden"}}})}):s.jsxs("div",{className:"markdown-preview",onClick:()=>o(!0),children:[s.jsxs("span",{className:"edit-hint",children:[s.jsx(x0,{size:12}),"Click to edit"]}),e?s.jsx("div",{className:"markdown-content",children:s.jsx(ex,{children:e})}):s.jsx("div",{className:"markdown-placeholder",children:n})]})]})}function S_(e){return/^[a-zA-Z0-9_]+$/.test(e)}function C_({agent:e}){const{project:t,updateAgent:n,mcpServers:r,builtinTools:i,setActiveTab:o,setRunAgentId:a}=Ze(),[l,c]=_.useState(new Set(["basic","model","tools","subagents"])),[u,d]=_.useState(!1),[p,f]=_.useState(!1),[m,y]=_.useState(!1),[w,E]=_.useState(""),[g,h]=_.useState(null);if(!t)return null;function v(P){n(e.id,P)}function L(P){if(P===""){h(null),v({name:P});return}S_(P)?h(null):h("Name can only contain letters, numbers, and underscores"),v({name:P})}function S(P){const $=new Set(l);$.has(P)?$.delete(P):$.add(P),c($)}const j=e.type==="LlmAgent",x=e;function z(P){j&&v({tools:[...x.tools,P]})}function A(P){j&&v({tools:x.tools.filter(($,I)=>I!==P)})}function N(P,$){if(!j)return;const I=[...x.tools];I[P]=$,v({tools:I})}function b(P){"sub_agents"in e&&v({sub_agents:[...e.sub_agents,P]})}function T(P){"sub_agents"in e&&v({sub_agents:e.sub_agents.filter($=>$!==P)})}const O=t.agents.filter(P=>P.id!==e.id);async function U(){if(!(!t||!j)){d(!0);try{const P=x.instruction||"",$=P?`Current instruction to improve:

${P}

Please improve and expand this instruction while preserving its core intent.`:void 0,k=t.agents.some(J=>J.id===e.id)?void 0:e,V=await Ds(t.id,e.id,$,k);V.success&&V.prompt?v({instruction:V.prompt}):alert("Failed to generate prompt: "+(V.error||"Unknown error"))}catch(P){alert("Error generating prompt: "+P.message)}finally{d(!1)}}}async function D(){if(!(!t||!j||!w.trim())){d(!0);try{const $=`Current instruction:
...
Please apply the requested changes to the instruction above. Output only the updated instruction, nothing else.`,k=t.agents.some(J=>J.id===e.id)?void 0:e,V=await Ds(t.id,e.id,$,k);V.success&&V.prompt?(v({instruction:V.prompt}),y(!1),E("")):alert("Failed to apply changes: "+(V.error||"Unknown error"))}catch(P){alert("Error applying changes: "+P.message)}finally{d(!1)}}}async function K(){if(!t||!j)return;const P=x.instruction;if(!P){alert("Please write an instruction first");return}f(!0);try{const $=`Write a 5-10 word description of what this agent does.
...
Your response (5-10 words only):`,I=await Ds(t.id,e.id,$);if(I.success&&I.prompt){let k=I.prompt.trim();k=k.replace(/^["']|["']$/g,"").trim();const V=k.split(/[.!?\n]/)[0].trim(),J=V.length>80?V.slice(0,77)+"...":V;v({description:J})}else alert("Failed to generate description: "+(I.error||"Unknown error"))}catch($){alert("Error generating description: "+$.message)}finally{f(!1)}}return s.jsxs("div",{className:"agent-editor",children:[s.jsx("style",{children:`
        .agent-editor {
          background: var(--bg-secondary);
          border: 1px solid var(--border-color);
          border-radius: var(--radius-lg);
...
`;function fS({onSelectTool:e}){var ft;const{project:t,updateProject:n,addCustomTool:r,updateCustomTool:i,removeCustomTool:o,selectedToolId:a,setSelectedToolId:l,builtinTools:c,mcpServers:u}=Ze(),[d,p]=_.useState(""),[f,m]=_.useState(null),[y,w]=_.useState("tools"),[E,g]=_.useState(null),[h,v]=_.useState(""),[L,S]=_.useState(!1),[j,x]=_.useState(null),[z,A]=_.useState(!1),[N,b]=_.useState(!1),[T,O]=_.useState(null),[U,D]=_.useState(null);if(!t)return null;const K=t.mcp_servers||[],P=t.custom_tools.find(H=>H.id===a),$=K.find(H=>H.name===E),I=new Set(K.map(H=>H.name)),k=u.filter(H=>!I.has(H.name));function V(H){l(H),e==null||e(H)}_.useEffect(()=>{P&&(p(P.code),D(null))},[a]),_.useEffect(()=>{$&&(v(JSON.stringify($,null,2)),S(!1))},[E]);function J(){const H=uS();r({id:H,name:"new_tool",description:"",module_path:"tools.custom",code:pS,state_keys_used:[]}),V(H)}function C(H,ge){ge.stopPropagation(),confirm("Delete this tool?")&&(o(H),a===H&&(e==null||e(null)))}function oe(H){P&&(H.name!==void 0&&(H.name===""||dS(H.name)?D(null):D("Name can only contain letters, numbers, and underscores")),i(P.id,H))}function R(H){H!==void 0&&P&&(p(H),oe({code:H}))}async function Z(){if(P){A(!0);try{const H=await Wh(t.id,P.name,P.description,P.state_keys_used);H.success&&H.code?(p(H.code),oe({code:H.code})):(console.error("Failed to generate tool code:",H.error),alert("Failed to generate tool code: "+(H.error||"Unknown error")))}catch(H){console.error("Error generating tool code:",H),alert("Error generating tool code: "+H.message)}finally{A(!1)}}}const B=_.useRef(null),te=_.useCallback((H,ge)=>{if(B.current&&typeof B.current=="function")try{B.current()}catch{}try{const ze=sx(ge,H,{language:"python",endpoint:"/api/code-completion",trigger:"onTyping"});typeof ze=="function"?B.current=ze:B.current=null}catch{B.current=null}},[]);_.useEffect(()=>()=>{if(B.current&&typeof B.current=="function")try{B.current()}catch{}},[]);function M(){const H={name:`mcp_server_${Date.now().toString(36)}`,description:"New MCP Server",connection_type:"stdio",command:"npx",args:["-y","@modelcontextprotocol/server-example"],env:{},headers:{},timeout:10};n({mcp_servers:[...K,H]}),g(H.name),x(null)}function W(H){const ge={...H};n({mcp_servers:[...K,ge]}),g(ge.name),x(null)}function Q(H,ge){ge.stopPropagation(),confirm("Delete this MCP server?")&&(n({mcp_servers:K.filter(ze=>ze.name!==H)}),E===H&&g(null))}function X(H){H!==void 0&&(v(H),S(H!==JSON.stringify($,null,2)))}function ae(){if($)try{const H=JSON.parse(h),ge=$.name,ze=K.map(mt=>mt.name===ge?H:mt);n({mcp_servers:ze}),g(H.name),S(!1)}catch(H){alert("Invalid JSON: "+H.message)}}async function me(){b(!0),O(null);try{const H=JSON.parse(h),ge=await qh({connection_type:H.connection_type,command:H.command,args:H.args,env:H.env,url:H.url,headers:H.headers,timeout:H.timeout||30});if(O(ge),ge.success&&ge.tools.length>0){const ze={...H,tool_filter:ge.tools.map(mt=>mt.name)};v(JSON.stringify(ze,null,2)),S(!0)}}catch(H){O({success:!1,tools:[],error:H.message})}finally{b(!1)}}const ve={};return t.custom_tools.forEach(H=>{const ge=H.module_path||"tools";ve[ge]||(ve[ge]=[]),ve[ge].push(H)}),s.jsxs("div",{className:"tools-panel",children:[s.jsx("style",{children:`
        .tools-panel {
          display: flex;
          gap: 20px;
          height: calc(100vh - 180px);
...
`+z,s.jsx("span",{className:"json-bracket",children:"}"})]})}return String(S)};return s.jsxs("div",{className:"event-detail",children:[s.jsxs("div",{className:"detail-header",children:[s.jsx("span",{className:"detail-type",children:e.event_type}),s.jsx("span",{className:"detail-agent",children:e.agent_name}),s.jsx("span",{className:"detail-time",children:new Date(e.timestamp*1e3).toISOString()})]}),s.jsxs("div",{className:"detail-section",children:[s.jsxs("div",{className:"section-header",onClick:()=>r("data"),children:[t.has("data")?s.jsx(Ct,{size:12}):s.jsx(Nt,{size:12}),s.jsx("span",{children:"Event Data"})]}),t.has("data")&&s.jsx("div",{className:"section-content json-viewer",children:i(e.data)})]}),e.event_type==="agent_start"&&((o=e.data)==null?void 0:o.instruction)&&s.jsxs("div",{className:"detail-section",children:[s.jsxs("div",{className:"section-header",onClick:()=>r("instruction"),children:[t.has("instruction")?s.jsx(Ct,{size:12}):s.jsx(Nt,{size:12}),s.jsx("span",{children:"Instruction"}),s.jsxs("span",{className:"char-count",children:[e.data.instruction.length," chars"]})]}),t.has("instruction")&&s.jsx("div",{className:"section-content",children:s.jsx("pre",{className:"instruction-text",children:e.data.instruction})})]}),e.event_type==="model_call"&&((a=e.data)==null?void 0:a.contents)&&s.jsxs("div",{className:"detail-section",children:[s.jsxs("div",{className:"section-header",onClick:()=>r("messages"),children:[t.has("messages")?s.jsx(Ct,{size:12}):s.jsx(Nt,{size:12}),s.jsxs("span",{children:["Messages (",e.data.contents.length,")"]})]}),t.has("messages")&&s.jsx("div",{className:"section-content",children:e.data.contents.map((S,j)=>{var x;return s.jsxs("div",{className:"message-item",children:[s.jsx("span",{className:`message-role ${S.role}`,children:S.role}),s.jsx("div",{className:"message-parts",children:(x=S.parts)==null?void 0:x.map((z,A)=>s.jsxs("div",{className:"message-part",children:[z.text&&s.jsx("pre",{children:z.text}),z.function_call&&s.jsxs("div",{className:"function-call",children:[s.jsx("strong",{children:z.function_call.name}),s.jsx("pre",{children:JSON.stringify(z.function_call.args,null,2)})]}),z.function_response&&s.jsxs("div",{className:"function-response",children:[s.jsx("strong",{children:z.function_response.name}),s.jsx("pre",{children:JSON.stringify(z.function_response.response,null,2)})]})]},A))})]},j)})})]}),e.event_type==="tool_result"&&s.jsxs("div",{className:"detail-section",children:[s.jsxs("div",{className:"section-header",onClick:()=>r("result"),children:[t.has("result")?s.jsx(Ct,{size:12}):s.jsx(Nt,{size:12}),s.jsx("span",{children:"Tool Result"})]}),t.has("result")&&s.jsx("div",{className:"section-content",children:s.jsx("pre",{className:"result-content",children:((d=(u=(c=(l=e.data)==null?void 0:l.result)==null?void 0:c.content)==null?void 0:u[0])==null?void 0:d.text)||(typeof((p=e.data)==null?void 0:p.result)=="string"?e.data.result:JSON.stringify((f=e.data)==null?void 0:f.result,null,2))})})]}),e.event_type==="model_response"&&((m=e.data)==null?void 0:m.parts)&&s.jsxs("div",{className:"detail-section",children:[s.jsxs("div",{className:"section-header",onClick:()=>r("response"),children:[t.has("response")?s.jsx(Ct,{size:12}):s.jsx(Nt,{size:12}),s.jsxs("span",{children:["Response (",e.data.parts.length," part",e.data.parts.length!==1?"s":"",")"]}),e.data.token_counts&&s.jsxs("span",{className:"token-badge",children:[e.data.token_counts.input,"↑ ",e.data.token_counts.output,"↓"]})]}),t.has("response")&&s.jsx("div",{className:"section-content",children:e.data.parts.map((S,j)=>s.jsxs("div",{className:"response-part",children:[S.type==="text"&&S.text&&s.jsx("pre",{className:"response-text",children:S.text}),S.type==="function_call"&&s.jsxs("div",{className:"function-call",children:[s.jsxs("strong",{children:["→ ",S.name,"()"]}),S.args&&Object.keys(S.args).length>0&&s.jsx("pre",{children:JSON.stringify(S.args,null,2)})]}),S.thought&&s.jsx("div",{className:"thought-indicator",children:"💭 Thinking"})]},j))})]}),(e.event_type==="callback_start"||e.event_type==="callback_end")&&s.jsxs("div",{className:"detail-section",children:[s.jsxs("div",{className:"section-header",onClick:()=>r("callback_info"),children:[t.has("callback_info")?s.jsx(Ct,{size:12}):s.jsx(Nt,{size:12}),s.jsx("span",{children:"Callback Information"})]}),t.has("callback_info")&&s.jsxs("div",{className:"section-content",children:[s.jsxs("div",{children:[s.jsx("strong",{children:"Name:"})," ",((y=e.data)==null?void 0:y.callback_name)||"unknown"]}),s.jsxs("div",{children:[s.jsx("strong",{children:"Type:"})," ",((w=e.data)==null?void 0:w.callback_type)||"unknown"]}),s.jsxs("div",{children:[s.jsx("strong",{children:"Module Path:"})," ",((E=e.data)==null?void 0:E.module_path)||"unknown"]}),((g=e.data)==null?void 0:g.error)&&s.jsxs("div",{style:{color:"#ef4444",marginTop:"8px"},children:[s.jsxs("div",{children:[s.jsx("strong",{children:"Error:"})," ",e.data.error]}),((h=e.data)==null?void 0:h.error_type)&&s.jsxs("div",{style:{marginTop:"4px",fontSize:"0.9em",opacity:.8},children:[s.jsx("strong",{children:"Type:"})," ",e.data.error_type]}),((v=e.data)==null?void 0:v.stack_trace)&&s.jsxs("div",{style:{marginTop:"8px"},children:[s.jsx("strong",{children:"Stack Trace:"}),s.jsx("pre",{style:{marginTop:"4px",padding:"8px",backgroundColor:"#1a1a1a",borderRadius:"4px",fontSize:"0.85em",overflow:"auto",maxHeight:"300px",whiteSpace:"pre-wrap",wordBreak:"break-word"},children:e.data.stack_trace})]})]})]})]}),e.event_type==="state_change"&&((L=e.data)==null?void 0:L.state_delta)&&s.jsxs("div",{className:"detail-section",children:[s.jsxs("div",{className:"section-header",onClick:()=>r("state_delta"),children:[t.has("state_delta")?s.jsx(Ct,{size:12}):s.jsx(Nt,{size:12}),s.jsxs("span",{children:["State Changes (",Object.keys(e.data.state_delta).length,")"]})]}),t.has("state_delta")&&s.jsx("div",{className:"section-content",children:Object.entries(e.data.state_delta).map(([S,j])=>s.jsxs("div",{className:"state-delta-item",children:[s.jsx("div",{className:"state-delta-key",children:S}),s.jsx("pre",{className:"state-delta-value",children:typeof j=="string"?j:JSON.stringify(j,null,2)})]},S))})]})]})}function bS({content:e,title:t,onClose:n}){return s.jsxs("div",{className:"modal-overlay",onClick:n,children:[s.jsxs("div",{className:"modal-content",onClick:r=>r.stopPropagation(),children:[s.jsxs("div",{className:"modal-header",children:[s.jsx("h3",{children:t}),s.jsx("button",{className:"modal-close",onClick:n,children:"×"})]}),s.jsx("div",{className:"modal-body markdown-content",children:s.jsx(ex,{children:e})})]}),s.jsx("style",{children:`
      ...
      `}),s.jsx("div",{className:"state-header",children:t!==null?`State after event #${t}`:e.length>0?"State at end of run":"Defined State Keys"}),a.length===0?s.jsx("div",{className:"state-empty",children:"No state keys defined"}):a.map(([l,{value:c,timestamp:u,defined:d,description:p,type:f}])=>s.jsxs("div",{className:`state-entry ${c===void 0?"unset":""}`,children:[s.jsxs("div",{className:"state-key",children:[l,f&&s.jsxs("span",{className:"state-type",children:["(",f,")"]})]}),s.jsx("div",{className:"state-value",onClick:()=>{if(c!==void 0){const m=typeof c=="string"?c:JSON.stringify(c,null,2);i({content:m,title:l})}},style:{cursor:c!==void 0?"pointer":"default"},title:c!==void 0?"Click to view in markdown viewer":void 0,children:c===void 0?"(not set)":typeof c=="string"?c:JSON.stringify(c,null,2)}),p&&s.jsx("div",{className:"state-desc",children:p}),u&&s.jsx("div",{className:"state-time",children:new Date(u*1e3).toLocaleTimeString()})]},l))]})]})}let rc=null,ic=null;(async()=>{try{rc=(await cg(()=>import("./jq-Dl6qUxpy.js").then(t=>t.j),[])).default}catch(e){console.warn("jq-web failed to load:",e.message),ic=e.message}})();function Ua(e){if(!e)return{text:"",isError:!1};if(e.success===!1)return{text:e.error||"Unknown error",isError:!0};let t=e.result||e;if(typeof t=="string")try{const n=t.replace(/'/g,'"').replace(/True/g,"true").replace(/False/g,"false").replace(/None/g,"null");t=JSON.parse(n)}catch{return{text:t,isError:!1}}return t.content&&Array.isArray(t.content)?{text:t.content.filter(r=>r.type==="text").map(r=>r.text).join(`
`),isError:t.isError===!0}:{text:typeof t=="string"?t:JSON.stringify(t,null,2),isError:!1}}function ef(e,t){if(!t||!t.trim())return e;const n=t.trim();let r=e;try{r=JSON.parse(e)}catch{}if(n.startsWith("js:")){const i=n.slice(3).trim();try{const a=new Function("value","data",`return ${i}`)(e,r);return typeof a=="string"?a:JSON.stringify(a,null,2)}catch(o){return`[JS error: ${o}]`}}if(rc)try{const i=rc.json(r,n);return i==null?"[No match]":typeof i=="string"?i:JSON.stringify(i,null,2)}catch(i){if(!n.startsWith("."))try{const a=new Function("value","data",`return ${n}`)(e,r);return typeof a=="string"?a:JSON.stringify(a,null,2)}catch{}return`[jq error: ${i.message||i}]`}else{if(ic){if(n.startsWith(".")&&!n.includes("|"))try{const i=n.slice(1).split(".").filter(Boolean);let o=r;for(const a of i){const l=a.match(/^(\w+)?\[(\d+)\]$/);l?(l[1]&&(o=o[l[1]]),o=o[parseInt(l[2])]):o=o[a]}return typeof o=="string"?o:JSON.stringify(o,null,2)}catch{}try{const o=new Function("value","data",`return ${n}`)(e,r);return typeof o=="string"?o:JSON.stringify(o,null,2)}catch(i){return`[jq not loaded: ${ic}. JS fallback failed: ${i.message}]`}}return"[jq loading...]"}}function jS({project:e,selectedEventIndex:t}){var Z;const{watches:n,updateWatch:r,addWatch:i,removeWatch:o,runEvents:a}=Ze(),[l,c]=_.useState(!1),[u,d]=_.useState(null),[p,f]=_.useState({}),[m,y]=_.useState(new Set),[w,E]=_.useState(""),[g,h]=_.useState(""),[v,L]=_.useState({}),[S,j]=_.useState(""),[x,z]=_.useState([]),[A,N]=_.useState(null),[b,T]=_.useState(null),[O,U]=_.useState(!1);_.useEffect(()=>{ru().then(z).catch(console.error)},[]);const D=_.useMemo(()=>{const B=e.mcp_servers||[],te=new Set(B.map(W=>W.name)),M=x.filter(W=>!te.has(W.name));return[...B,...M]},[e.mcp_servers,x]),K=_.useCallback(async B=>{if(!(p[B]||m.has(B))){y(te=>new Set([...te,B]));try{const te=await ye(`/projects/${e.id}/mcp-servers/${encodeURIComponent(B)}/test-connection`,{method:"POST"});te.success&&f(M=>({...M,[B]:te.tools}))}catch(te){console.error("Failed to load tools:",te)}finally{y(te=>{const M=new Set(te);return M.delete(B),M})}}},[e.id,p,m]);_.useEffect(()=>{var W;if(u)return;if(!w||!g){L({});return}const te=(p[w]||[]).find(Q=>Q.name===g);if(!((W=te==null?void 0:te.parameters)!=null&&W.properties)){L({});return}const M={};Object.entries(te.parameters.properties).forEach(([Q,X])=>{X.type==="string"?M[Q]=X.default||"":X.type==="number"||X.type==="integer"?M[Q]=X.default||0:X.type==="boolean"?M[Q]=X.default||!1:M[Q]=X.default||null}),L(M)},[w,g,p,u]);const P=()=>{d(null),E(""),h(""),L({}),j(""),N(null),T(null),c(!0)},$=B=>{if(d(B.id),E(B.serverName),h(B.toolName),L({...B.args}),j(B.transform||""),B.result){const{text:te}=Ua(B.result);N(te),T(null)}else N(null),T(null);p[B.serverName]||K(B.serverName),c(!0)},I=async()=>{if(!(!w||!g)){U(!0),T(null);try{const B=await ye(`/projects/${e.id}/run-mcp-tool`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({server_name:w,tool_name:g,arguments:v})}),{text:te,isError:M}=Ua(B);M?(T(te),N(null)):(N(te),T(null))}catch(B){T(String(B)),N(null)}finally{U(!1)}}},k=_.useMemo(()=>A?!S||!S.trim()?A:ef(A,S):null,[A,S]),V=()=>{if(!(!w||!g)){if(u){r(u,{serverName:w,toolName:g,args:{...v},transform:S||void 0});const B=n.find(te=>te.id===u);B&&C({...B,serverName:w,toolName:g,args:v,transform:S||void 0,history:B.history||[]})}else{const B={id:`watch-${Date.now()}`,serverName:w,toolName:g,args:{...v},transform:S||void 0,history:[]};i(B),C(B)}c(!1)}},J=B=>{o(B)},C=_.useCallback(async(B,te)=>{r(B.id,{isLoading:!0,error:void 0});const M=te??a.length-1,W=Date.now();try{const Q=await ye(`/projects/${e.id}/run-mcp-tool`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({server_name:B.serverName,tool_name:B.toolName,arguments:B.args})}),X={eventIndex:M,timestamp:W,result:Q},ae=[...B.history||[],X];r(B.id,{result:Q,isLoading:!1,lastRun:W,history:ae})}catch(Q){const X={eventIndex:M,timestamp:W,error:String(Q)},ae=[...B.history||[],X];r(B.id,{error:String(Q),isLoading:!1,lastRun:W,history:ae})}},[e.id,r,a.length]),oe=()=>{n.forEach(B=>C(B))},R=_.useMemo(()=>!w||!g?null:(p[w]||[]).find(te=>te.name===g),[w,g,p]);return s.jsxs("div",{className:"tool-watch-panel",children:[s.jsxs("div",{className:"watch-header",children:[s.jsx(Hi,{size:14}),s.jsx("span",{children:"Tool Watch"}),s.jsx("span",{className:"watch-auto-badge",title:"Watches auto-refresh on every event",children:"⚡ Auto"}),s.jsxs("div",{className:"watch-actions",children:[s.jsx("button",{className:"watch-btn",onClick:oe,title:"Refresh all",children:s.jsx(wn,{size:12})}),s.jsx("button",{className:"watch-btn",onClick:P,title:"Add watch",children:s.jsx(Me,{size:12})})]})]}),n.length===0?s.jsxs("div",{className:"watch-empty",children:[s.jsx(Hi,{size:20,style:{opacity:.3}}),s.jsx("span",{children:"No watch expressions"}),s.jsxs("button",{className:"add-watch-btn",onClick:P,children:[s.jsx(Me,{size:12})," Add Tool Watch"]})]}):s.jsx("div",{className:"watch-list",children:n.map(B=>{let te=B.result,M=B.error;if(t!==null&&B.history&&B.history.length>0){const me=B.history.filter(ve=>ve.eventIndex<=t);if(me.length>0){const ve=me[me.length-1];te=ve.result,M=ve.error}else te=void 0,M=void 0}const{text:W,isError:Q}=te?Ua(te):{text:"",isError:!1},X=te?ef(W,B.transform):"",ae=M||Q;return s.jsxs("div",{className:`watch-item ${ae?"error":""}`,children:[s.jsxs("div",{className:"watch-item-header",children:[s.jsxs("span",{className:"watch-expr",children:[s.jsx("span",{className:"watch-server",children:B.serverName}),s.jsx("span",{className:"watch-tool",children:B.toolName}),Object.keys(B.args).length>0&&s.jsxs("span",{className:"watch-args",children:["(",Object.entries(B.args).map(([me,ve])=>`${me}=${JSON.stringify(ve)}`).join(", "),")"]}),t!==null&&s.jsxs("span",{className:"watch-time-indicator",children:["@",t]})]}),s.jsxs("div",{className:"watch-item-actions",children:[s.jsx("button",{onClick:()=>$(B),title:"Edit watch",children:s.jsx(Gt,{size:10})}),s.jsx("button",{onClick:()=>C(B),title:"Refresh",children:B.isLoading?s.jsx(wn,{size:10,className:"spin"}):s.jsx(wn,{size:10})}),s.jsx("button",{onClick:()=>J(B.id),title:"Remove",children:s.jsx(Pe,{size:10})})]})]}),s.jsx("div",{className:"watch-result",children:B.isLoading?s.jsx("span",{className:"loading",children:"Loading..."}):M?s.jsx("span",{className:"error",children:M}):te?s.jsx("pre",{className:Q?"error-text":"",children:X}):s.jsx("span",{className:"no-result",children:t!==null?"No data at this event":"Not yet run"})})]},B.id)})}),l&&s.jsx("div",{className:"watch-dialog-overlay",onClick:()=>c(!1),children:s.jsxs("div",{className:"watch-dialog",onClick:B=>B.stopPropagation(),children:[s.jsxs("div",{className:"dialog-header",children:[s.jsx("span",{children:u?"Edit Watch":"Add Tool Watch"}),s.jsx("button",{onClick:()=>c(!1),children:s.jsx(ag,{size:14})})]}),s.jsxs("div",{className:"dialog-body",children:[s.jsxs("div",{className:"form-row",children:[s.jsx("label",{children:"MCP Server"}),s.jsxs("select",{value:w,onChange:B=>{E(B.target.value),u||h(""),B.target.value&&K(B.target.value)},children:[s.jsx("option",{value:"",children:"Select server..."}),D.map(B=>s.jsx("option",{value:B.name,children:B.name},B.name))]})]}),s.jsxs("div",{className:"form-row",children:[s.jsx("label",{children:"Tool"}),s.jsxs("select",{value:g,onChange:B=>h(B.target.value),disabled:!w||m.has(w),children:[s.jsx("option",{value:"",children:m.has(w)?"Loading tools...":"Select tool..."}),(p[w]||[]).map(B=>s.jsx("option",{value:B.name,children:B.name},B.name))]})]}),(R==null?void 0:R.description)&&s.jsx("div",{className:"tool-desc",children:R.description}),((Z=R==null?void 0:R.parameters)==null?void 0:Z.properties)&&Object.keys(R.parameters.properties).length>0&&s.jsxs("div",{className:"tool-args",children:[s.jsx("label",{children:"Arguments"}),Object.entries(R.parameters.properties).map(([B,te])=>{var M,W;return s.jsxs("div",{className:"arg-row",children:[s.jsxs("span",{className:"arg-name",children:[B,((M=R.parameters.required)==null?void 0:M.includes(B))&&s.jsx("span",{className:"required",children:"*"})]}),s.jsx("input",{type:te.type==="number"||te.type==="integer"?"number":"text",value:typeof v[B]=="object"?JSON.stringify(v[B]):v[B]??"",onChange:Q=>L(X=>({...X,[B]:Q.target.value})),placeholder:((W=te.description)==null?void 0:W.slice(0,40))||B})]},B)})]}),w&&g&&s.jsxs("div",{className:"test-section",children:[s.jsxs("div",{className:"test-header",children:[s.jsx("label",{children:"Test & Preview"}),s.jsxs("button",{className:"test-btn",onClick:I,disabled:O,children:[O?s.jsx(wn,{size:12,className:"spin"}):s.jsx(Mn,{size:12}),O?"Running...":"Test Run"]})]}),b&&s.jsxs("div",{className:"test-result error",children:[s.jsx("span",{className:"test-label",children:"Error:"}),s.jsx("pre",{children:b})]}),A&&s.jsxs("div",{className:"test-result",children:[s.jsx("span",{className:"test-label",children:"Raw Result:"}),s.jsx("pre",{children:A})]})]}),s.jsxs("div",{className:"form-row transform-row",children:[s.jsx("label",{children:"Transform (optional)"}),s.jsx("input",{type:"text",value:S,onChange:B=>j(B.target.value),placeholder:"e.g., .items[0].name or .content[].text"}),s.jsxs("div",{className:"transform-hints",children:[s.jsx("span",{className:"hint-title",children:"jq:"}),s.jsx("code",{onClick:()=>j(".items[0].name"),children:".items[0].name"}),s.jsx("code",{onClick:()=>j(".content[].text"),children:".content[].text"}),s.jsx("code",{onClick:()=>j(".result.content[0].text"),children:".result.content[0].text"}),s.jsx("code",{onClick:()=>j('.[] | select(.status == "active")'),children:".[] | select()"}),s.jsx("span",{className:"hint-title",children:"JS:"}),s.jsx("code",{onClick:()=>j("js:value.split('\\n')[0]"),children:"js:value.split('\\n')[0]"}),s.jsx("code",{onClick:()=>j("js:data.length"),children:"js:data.length"})]})]}),A&&S&&s.jsxs("div",{className:"transform-preview",children:[s.jsx("span",{className:"test-label",children:"Transform Preview:"}),s.jsx("pre",{className:k!=null&&k.startsWith("[Transform error")?"error":"",children:k})]})]}),s.jsxs("div",{className:"dialog-footer",children:[s.jsx("button",{className:"cancel-btn",onClick:()=>c(!1),children:"Cancel"}),s.jsx("button",{className:"add-btn",onClick:V,disabled:!w||!g,children:u?"Save Changes":"Add Watch"})]})]})})]})}function wS(){var St;const{project:e,isRunning:t,setIsRunning:n,runEvents:r,addRunEvent:i,clearRunEvents:o,clearWatchHistories:a,runAgentId:l,setRunAgentId:c,watches:u,updateWatch:d,currentSessionId:p,setCurrentSessionId:f}=Ze(),[m,y]=_.useState(""),[w,E]=_.useState(null),[g,h]=_.useState(null),[v,L]=_.useState(null),[S,j]=_.useState(""),[x,z]=_.useState(new Set(["agent_start","agent_end","tool_call","tool_result","model_call","model_response","state_change","callback_start","callback_end"])),[A,N]=_.useState(!0),[b,T]=_.useState(!0),[O,U]=_.useState(!1),[D,K]=_.useState(360),[P,$]=_.useState(!1),[I,k]=_.useState([]),[V,J]=_.useState(null),[C,oe]=_.useState(!1),R=_.useRef(0),Z=_.useCallback(async(F,re)=>{if(!e)return;d(F.id,{isLoading:!0,error:void 0});const ie=re??r.length-1,le=Date.now();try{const pe=await ye(`/projects/${e.id}/run-mcp-tool`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({server_name:F.serverName,tool_name:F.toolName,arguments:F.args})}),Ue={eventIndex:ie,timestamp:le,result:pe},Vn=[...F.history||[],Ue];d(F.id,{result:pe,isLoading:!1,lastRun:le,history:Vn})}catch(pe){const Ue={eventIndex:ie,timestamp:le,error:String(pe)},Vn=[...F.history||[],Ue];d(F.id,{error:String(pe),isLoading:!1,lastRun:le,history:Vn})}},[e==null?void 0:e.id,d,r.length]);_.useEffect(()=>{if(r.length>R.current&&u.length>0){const F=r.length-1;u.forEach(re=>{re.isLoading||Z(re,F)})}R.current=r.length},[r.length,u,Z]),_.useEffect(()=>{l!==null&&(te(l),c(null))},[l,c]);const[B,te]=_.useState(null),M=_.useRef(null),W=_.useRef(null);_.useEffect(()=>{if(!P)return;const F=ie=>{if(!W.current)return;const pe=W.current.getBoundingClientRect().right-ie.clientX;K(Math.min(600,Math.max(200,pe)))},re=()=>{$(!1)};return document.addEventListener("mousemove",F),document.addEventListener("mouseup",re),()=>{document.removeEventListener("mousemove",F),document.removeEventListener("mouseup",re)}},[P]);const Q=_.useMemo(()=>r.length===0?{min:0,max:0}:{min:r[0].timestamp,max:r[r.length-1].timestamp},[r]),X=_.useMemo(()=>r.filter((F,re)=>{var ie,le,pe;if(v&&(F.timestamp<v[0]||F.timestamp>v[1])||x.size>0&&!x.has(F.event_type))return!1;if(A&&F.event_type==="model_response"){const Ue=((le=(ie=F.data)==null?void 0:ie.response_content)==null?void 0:le.parts)||((pe=F.data)==null?void 0:pe.parts)||[],Vn=Ue.some(Yo=>Yo.type==="function_call"),lx=Ue.some(Yo=>Yo.type==="text");if(!Vn&&!lx)return!1}return!(S&&!JSON.stringify(F).toLowerCase().includes(S.toLowerCase()))}),[r,v,x,S,A]),ae=_.useMemo(()=>{var le;let F=0,re=0;const ie=g!==null?g+1:r.length;for(let pe=0;pe<ie;pe++){const Ue=r[pe];Ue.event_type==="model_response"&&((le=Ue.data)!=null&&le.token_counts)&&(F+=Ue.data.token_counts.input||0,re+=Ue.data.token_counts.output||0)}return{input:F,output:re,total:F+re}},[r,g]),me=g!==null?r[g]:null;_.useEffect(()=>{if(!e){k([]);return}(async()=>{oe(!0);try{const re=await Fl(e.id);k(re)}catch(re){console.error("Failed to load sessions:",re),k([])}finally{oe(!1)}})()},[e]);const ve=_.useCallback(async F=>{if(!e){J(null);return}if(!F){o(),a(),f(null),J(null),h(null),L(null);return}try{const re=await $h(e.id,F);o(),a(),f(re.id),J(F),h(null),L(null);for(const ie of re.events)i(ie)}catch(re){alert(`Failed to load session: ${re.message||"Unknown error"}`)}},[e,o,a,f,i]);_.useEffect(()=>{if(!e||I.length===0||C)return;const re=new URLSearchParams(window.location.search).get("session");if(re)if(I.some(le=>le.id===re)){ve(re);const le=window.location.pathname;window.history.replaceState({},"",le)}else console.warn(`Session ${re} not found in available sessions`)},[e,I,C,ve]),_.useEffect(()=>{t&&M.current&&(M.current.scrollTop=M.current.scrollHeight)},[r.length,t]);const ft=_.useCallback(()=>{if(!e||!m.trim()||t)return;w&&(w.close(),E(null)),p||(o(),a(),J(null)),n(!0),h(null),L(null);const F=Uh(e.id);E(F),F.onopen=()=>{F.send(JSON.stringify({message:m,agent_id:B||void 0,session_id:p||void 0}))},F.onmessage=re=>{var le;const ie=JSON.parse(re.data);if(ie.event_type==="agent_start"&&((le=ie.data)!=null&&le.session_id)){const pe=ie.data.session_id;ie.data.session_reused,f(pe),pe&&I.some(Ue=>Ue.id===pe)&&J(pe)}else ie.type==="session_started"?(f(ie.session_id),ie.session_id&&I.some(pe=>pe.id===ie.session_id)&&J(ie.session_id)):ie.type==="completed"?(n(!1),F.close()):ie.type==="error"?(n(!1),i({timestamp:Date.now()/1e3,event_type:"agent_end",agent_name:"system",data:{error:ie.error}})):i(ie)},F.onerror=()=>{n(!1),i({timestamp:Date.now()/1e3,event_type:"agent_end",agent_name:"system",data:{error:"WebSocket connection error"}})},F.onclose=()=>{n(!1)}},[e,m,t,w,o,n,i,B,p]),H=_.useCallback(()=>{w==null||w.close(),n(!1)},[w,n]);_.useEffect(()=>{const F=re=>{if((re.metaKey||re.ctrlKey)&&re.key==="Enter"){re.preventDefault(),ft();return}if(re.key==="ArrowDown"||re.key==="ArrowUp"){if(re.target instanceof HTMLInputElement||re.target instanceof HTMLTextAreaElement||(re.preventDefault(),X.length===0))return;if(re.key==="ArrowDown")if(g===null){const ie=r.indexOf(X[0]);h(ie)}else{const ie=X.findIndex(le=>r.indexOf(le)===g);if(ie<X.length-1){const le=r.indexOf(X[ie+1]);h(le)}}else if(re.key==="ArrowUp")if(g===null){const ie=r.indexOf(X[X.length-1]);h(ie)}else{const ie=X.findIndex(le=>r.indexOf(le)===g);if(ie>0){const le=r.indexOf(X[ie-1]);h(le)}}}};return window.addEventListener("keydown",F),()=>window.removeEventListener("keydown",F)},[ft,X,g,r]);const ge=_.useCallback(()=>{var pe;if(r.length===0)return;const F={version:1,exportedAt:new Date().toISOString(),projectId:e==null?void 0:e.id,projectName:e==null?void 0:e.name,agentId:B||((pe=e==null?void 0:e.app)==null?void 0:pe.root_agent_id),events:r},re=new Blob([JSON.stringify(F,null,2)],{type:"application/json"}),ie=URL.createObjectURL(re),le=document.createElement("a");le.href=ie,le.download=`run-${(e==null?void 0:e.name)||"export"}-${new Date().toISOString().slice(0,19).replace(/:/g,"-")}.json`,document.body.appendChild(le),le.click(),document.body.removeChild(le),URL.revokeObjectURL(ie)},[r,e,B]),ze=_.useCallback(async()=>{if(!p||!e){alert("No active session to save");return}try{const F=await Oh(p);if(F.success){alert(F.message||"Session saved to memory successfully");try{const re=await Fl(e.id);k(re)}catch{}}else alert(`Failed to save to memory: ${F.error||"Unknown error"}`)}catch(F){alert(`Error saving to memory: ${F.message||"Unknown error"}`)}},[p,e]),[mt,fn]=_.useState(!1),[Qo,Go]=_.useState([]),[Un,is]=_.useState(""),[q,ee]=_.useState("Test Case from Session"),[ue,fe]=_.useState(!1),ke=_.useCallback(async()=>{if(!p||!e){alert("No active session to create test case from");return}try{const F=await ye(`/projects/${e.id}/eval-sets`);if(Go(F.eval_sets||[]),!F.eval_sets||F.eval_sets.length===0){confirm(`No evaluation sets found. Would you like to create one first?

Go to the Evals tab to create an evaluation set.`)&&(window.location.href=`/project/${e.id}/evals`);return}is(F.eval_sets[0].id),fn(!0)}catch(F){alert(`Error loading eval sets: ${F.message||"Unknown error"}`)}},[p,e]),ht=_.useCallback(async()=>{if(!p||!e||!Un){alert("Please select an evaluation set");return}fe(!0);try{const F=await ye(`/projects/${e.id}/session-to-eval-case`,{method:"POST",body:JSON.stringify({session_id:p,eval_set_id:Un,case_name:q})});fn(!1),alert(`Test case "${F.eval_case.name}" created successfully!

Token count: ${F.session_token_count.toLocaleString()} tokens

Go to the Evals tab to view and edit the test case.`)}catch(F){alert(`Error creating test case: ${F.message||"Unknown error"}`)}finally{fe(!1)}},[p,e,Un,q]),Xt=_.useCallback(()=>{const F=document.createElement("input");F.type="file",F.accept=".json",F.onchange=async re=>{var le;const ie=(le=re.target.files)==null?void 0:le[0];if(ie)try{const pe=await ie.text(),Ue=JSON.parse(pe);if(!Ue.events||!Array.isArray(Ue.events)){alert("Invalid run file: missing events array");return}o(),a(),h(null),L(null),Ue.events.forEach(Vn=>{i(Vn)})}catch(pe){alert(`Failed to load run file: ${pe}`)}},F.click()},[o,a,i]);return _.useEffect(()=>{if(g!==null){const F=document.querySelector(".event-row.selected");F==null||F.scrollIntoView({behavior:"smooth",block:"nearest"})}},[g]),e?s.jsxs("div",{className:`run-panel ${P?"resizing":""}`,children:[s.jsx("style",{children:`
        .run-panel {
          display: flex;
          flex-direction: column;
          width: 100%;
      ...
      `}),s.jsxs("div",{className:"skillset-list",children:[s.jsxs("div",{className:"skillset-list-header",children:[s.jsx("h3",{children:"SkillSets"}),s.jsx("button",{className:"btn-icon",onClick:T,title:"Add SkillSet",children:s.jsx(Me,{size:16})})]}),x.length===0?s.jsxs("div",{className:"empty-state",style:{padding:"40px 0"},children:[s.jsx(on,{size:32}),s.jsx("span",{children:"No SkillSets"}),s.jsxs("button",{className:"btn-primary",onClick:T,children:[s.jsx(Me,{size:14})," Create SkillSet"]})]}):x.map(I=>s.jsxs("div",{className:`skillset-item ${n===I.id?"selected":""}`,onClick:()=>r(I.id),children:[s.jsx(on,{size:16,style:{color:"var(--accent)",flexShrink:0}}),s.jsxs("div",{className:"skillset-item-info",children:[s.jsx("div",{className:"skillset-item-name",children:I.name}),s.jsxs("div",{className:"skillset-item-count",children:[I.entry_count||0," entries"]})]}),s.jsx("button",{className:"skillset-item-delete",onClick:k=>{k.stopPropagation(),O(I.id)},children:s.jsx(Pe,{size:14})})]},I.id))]}),z?s.jsxs("div",{className:"skillset-detail",children:[s.jsxs("div",{className:"skillset-header",children:[s.jsxs("div",{className:"skillset-header-info",children:[s.jsx("input",{className:"skillset-name-input",value:z.name,onChange:I=>b(z.id,{name:I.target.value}),placeholder:"SkillSet Name"}),s.jsx("textarea",{className:"skillset-desc-input",value:z.description,onChange:I=>b(z.id,{description:I.target.value}),placeholder:"Description (optional)",rows:1}),s.jsxs("div",{className:"skillset-model",children:[s.jsx("label",{style:{fontSize:"12px",color:"var(--text-secondary)",marginRight:"8px"},children:"Embedding Model:"}),s.jsxs("select",{style:{flex:1,padding:"4px 8px",fontSize:"12px",background:"var(--bg-secondary)",border:"1px solid var(--border)",borderRadius:"4px",color:"var(--text-primary)"},value:z.embedding_model||"text-embedding-004",onChange:I=>b(z.id,{embedding_model:I.target.value}),children:[s.jsxs("optgroup",{label:"Google Gemini",children:[s.jsx("option",{value:"text-embedding-004",children:"text-embedding-004 (768d)"}),s.jsx("option",{value:"text-embedding-005",children:"text-embedding-005"})]}),s.jsxs("optgroup",{label:"OpenAI",children:[s.jsx("option",{value:"text-embedding-3-small",children:"text-embedding-3-small (1536d)"}),s.jsx("option",{value:"text-embedding-3-large",children:"text-embedding-3-large (3072d)"})]}),s.jsxs("optgroup",{label:"Cohere",children:[s.jsx("option",{value:"embed-english-v3.0",children:"embed-english-v3.0 (1024d)"}),s.jsx("option",{value:"embed-multilingual-v3.0",children:"embed-multilingual-v3.0 (1024d)"})]})]})]}),s.jsxs("div",{className:"skillset-stats",children:[s.jsxs("span",{className:"skillset-stat",children:[s.jsx("strong",{children:(i==null?void 0:i.entry_count)||0})," entries"]}),s.jsxs("span",{className:"skillset-stat",children:[s.jsx("strong",{children:Object.keys((i==null?void 0:i.sources)||{}).length})," sources"]}),L===!1&&s.jsx("span",{className:"skillset-stat",style:{color:"var(--warning)"},children:"⚠ No embeddings"})]})]}),s.jsx("button",{className:"btn-icon",onClick:A,title:"Refresh",children:s.jsx(wn,{size:16})})]}),h&&s.jsxs("div",{className:"error-banner",children:[h,s.jsx("button",{onClick:()=>v(null),children:s.jsx(ag,{size:14})})]}),s.jsxs("div",{className:"search-section",children:[s.jsx("div",{className:"search-input-wrapper",children:s.jsx("input",{className:"search-input",value:a,onChange:I=>l(I.target.value),onKeyDown:I=>I.key==="Enter"&&U(),placeholder:"Search this SkillSet..."})}),s.jsxs("button",{className:"btn-primary",onClick:U,disabled:d||!a.trim(),children:[s.jsx(ig,{size:14}),d?"Searching...":"Search"]})]}),s.jsxs("div",{className:"search-results",children:[c.length===0&&!d&&a&&s.jsx("div",{className:"empty-state",children:s.jsx("span",{children:"No results found"})}),c.map(I=>s.jsxs("div",{className:"search-result",style:{background:$(I.score)},children:[s.jsxs("span",{className:"search-result-score",children:[(I.score*100).toFixed(0),"%"]}),s.jsx("div",{className:"search-result-text",children:I.text}),s.jsx("div",{className:"search-result-source",children:I.source_name})]},I.id))]}),s.jsxs("div",{className:"add-sources-section",children:[s.jsxs("div",{className:"add-sources-header",onClick:()=>m(!f),children:[f?s.jsx(Ct,{size:16}):s.jsx(Nt,{size:16}),s.jsx("h4",{children:"Add Sources"})]}),f&&s.jsxs("div",{className:"add-sources-content",children:[s.jsxs("div",{className:"source-row",children:[s.jsx(Ul,{size:16,style:{color:"var(--text-tertiary)"}}),s.jsx("input",{className:"source-input",value:y,onChange:I=>w(I.target.value),onKeyDown:I=>I.key==="Enter"&&D(),placeholder:"Enter URL (e.g., llms.txt file)"}),s.jsxs("button",{className:"btn-primary",onClick:D,disabled:E||!y.trim(),children:[s.jsx(h0,{size:14}),E?"Loading...":"Add"]})]}),s.jsxs("div",{className:"source-row",children:[s.jsx(f0,{size:16,style:{color:"var(--text-tertiary)"}}),s.jsx("input",{ref:j,type:"file",accept:".txt,.md,.json,.csv,.html",onChange:K}),s.jsxs("button",{className:"btn-primary",onClick:()=>{var I;return(I=j.current)==null?void 0:I.click()},children:[s.jsx(Uo,{size:14}),"Upload File"]}),s.jsx("span",{style:{fontSize:"12px",color:"var(--text-tertiary)"},children:".txt, .md, .json, .csv"})]}),((i==null?void 0:i.entry_count)||0)>0&&s.jsx("div",{className:"source-row",style:{marginTop:"8px"},children:s.jsxs("button",{className:"clear-button",onClick:P,children:[s.jsx(Pe,{size:12}),"Clear All Entries (",(i==null?void 0:i.entry_count)||0,")"]})})]})]})]}):x.length>0?s.jsx("div",{className:"skillset-detail",children:s.jsxs("div",{className:"empty-state",children:[s.jsx(on,{size:48}),s.jsx("span",{children:"Select a SkillSet"})]})}):null]}):null}const tn={tool_trajectory_avg_score:{name:"Tool Trajectory",description:"Did the agent call the right tools in the expected order?",requiresJudge:!1},response_match_score:{name:"Response Match (ROUGE-1)",description:"Does the response contain expected text? (fuzzy word matching)",requiresJudge:!1},response_evaluation_score:{name:"Response Evaluation (LLM)",description:"LLM-judged semantic match of final response",requiresJudge:!0},final_response_match_v2:{name:"Response Quality v2 (LLM)",description:"Enhanced LLM-judged response quality check",requiresJudge:!0},safety_v1:{name:"Safety",description:"Is the response safe and harmless? (Vertex AI)",requiresJudge:!0},hallucinations_v1:{name:"Hallucination Detection",description:"Are all claims supported by context? No false information?",requiresJudge:!0},rubric_based_final_response_quality_v1:{name:"Rubric: Response Quality",description:"Custom rubric-based quality assessment of responses",requiresJudge:!0},rubric_based_tool_use_quality_v1:{name:"Rubric: Tool Use Quality",description:"Custom rubric-based assessment of tool usage",requiresJudge:!0}},NS={metrics:[{metric:"tool_trajectory_avg_score",enabled:!0,criterion:{threshold:1}},{metric:"response_match_score",enabled:!0,criterion:{threshold:.7}}],default_trajectory_match_type:"in_order",num_runs:1};function ax(){return`${Date.now().toString(36)}_${Math.random().toString(36).slice(2,6)}`}function ES(){const{project:e}=Ze(),[t,n]=_.useState([]),[r,i]=_.useState(null),[o,a]=_.useState(null),[l,c]=_.useState(new Set),[u,d]=_.useState(new Map),[p,f]=_.useState(new Map),[m,y]=_.useState(new Set),[w,E]=_.useState(!1),[g,h]=_.useState(null),[v,L]=_.useState([]),[S,j]=_.useState(null),x=async()=>{if(e)try{const M=await Ve.get(`/projects/${e.id}/eval-history`);L(M.runs||[])}catch(M){console.warn("Failed to load eval history:",M)}},z=async(M,W=!0)=>{if(e)try{const Q=await Ve.get(`/projects/${e.id}/eval-history/${M}`);j(Q.run),i(null),a(null),W&&window.history.pushState({run:M},"",`?run=${M}`)}catch(Q){console.warn("Failed to load history run:",Q)}},A=(M,W=!0)=>{i(M),a(null),j(null),W&&M?window.history.pushState({set:M},"",`?set=${M}`):W&&window.history.pushState({},"",window.location.pathname)},N=(M,W,Q=!0)=>{i(M),a(W),j(null),Q&&W?window.history.pushState({set:M,case:W},"",`?set=${M}&case=${W}`):Q&&M&&window.history.pushState({set:M},"",`?set=${M}`)},b=()=>{j(null),window.history.pushState({},"",window.location.pathname)},T=async M=>{if(e)try{await Ve.delete(`/projects/${e.id}/eval-history/${M}`),L(W=>W.filter(Q=>Q.id!==M)),(S==null?void 0:S.id)===M&&j(null)}catch(W){console.warn("Failed to delete history run:",W)}};_.useEffect(()=>{e!=null&&e.id&&(O(),x())},[e==null?void 0:e.id]),_.useEffect(()=>{if(!(e!=null&&e.id)||w)return;const M=()=>{const Q=new URLSearchParams(window.location.search),X=Q.get("set"),ae=Q.get("case"),me=Q.get("run");if(me){z(me,!1);return}if(X)i(X),a(ae),j(null),c(ve=>new Set([...ve,X]));else{if(!r&&!o&&!S)return;i(null),a(null),j(null)}};M();const W=()=>{M()};return window.addEventListener("popstate",W),()=>window.removeEventListener("popstate",W)},[e==null?void 0:e.id,w,t.length]);const O=async()=>{var M;if(e!=null&&e.id){E(!0),h(null);try{const W=await Ve.get(`/projects/${e.id}/eval-sets`);n(W.eval_sets||[]),((M=W.eval_sets)==null?void 0:M.length)>0&&c(new Set([W.eval_sets[0].id]))}catch(W){h(W.message||"Failed to load eval sets")}finally{E(!1)}}},U=t.find(M=>M.id===r),D=U==null?void 0:U.eval_cases.find(M=>M.id===o),K=async()=>{if(e!=null&&e.id)try{const M=await Ve.post(`/projects/${e.id}/eval-sets`,{name:"New Eval Set",description:"",eval_config:NS});n(W=>[...W,M.eval_set]),i(M.eval_set.id),c(W=>new Set([...W,M.eval_set.id]))}catch(M){h(M.message||"Failed to create eval set")}},P=async M=>{if(e!=null&&e.id)try{const W=await Ve.post(`/projects/${e.id}/eval-sets/${M}/cases`,{name:"New Test Case",description:"",invocations:[{id:ax(),user_message:"",expected_response:"",expected_tool_calls:[],tool_trajectory_match_type:"in_order",rubrics:[]}],initial_state:{},rubrics:[],enabled_metrics:[],tags:[]});n(Q=>Q.map(X=>X.id===M?{...X,eval_cases:[...X.eval_cases,W.eval_case]}:X)),i(M),a(W.eval_case.id)}catch(W){h(W.message||"Failed to create eval case")}},$=async(M,W,Q)=>{if(e!=null&&e.id)try{const X=await Ve.put(`/projects/${e.id}/eval-sets/${M}/cases/${W}`,Q);n(ae=>ae.map(me=>me.id===M?{...me,eval_cases:me.eval_cases.map(ve=>ve.id===W?X.eval_case:ve)}:me))}catch(X){h(X.message||"Failed to update eval case")}},I=async(M,W)=>{if(e!=null&&e.id)try{await Ve.delete(`/projects/${e.id}/eval-sets/${M}/cases/${W}`),n(Q=>Q.map(X=>X.id===M?{...X,eval_cases:X.eval_cases.filter(ae=>ae.id!==W)}:X)),o===W&&a(null)}catch(Q){h(Q.message||"Failed to delete eval case")}},k=async M=>{if(e!=null&&e.id)try{await Ve.delete(`/projects/${e.id}/eval-sets/${M}`),n(W=>W.filter(Q=>Q.id!==M)),r===M&&(i(null),a(null))}catch(W){h(W.message||"Failed to delete eval set")}},V=async M=>{if(e!=null&&e.id)try{const W=await Ve.get(`/projects/${e.id}/eval-sets/${M}/export`),Q=new Blob([JSON.stringify(W,null,2)],{type:"application/json"}),X=URL.createObjectURL(Q),ae=document.createElement("a");ae.href=X;const me=t.find(ve=>ve.id===M);ae.download=`${(me==null?void 0:me.name)||"eval-set"}.json`,document.body.appendChild(ae),ae.click(),document.body.removeChild(ae),URL.revokeObjectURL(X)}catch(W){h(W.message||"Failed to export eval set")}},J=async M=>{if(e!=null&&e.id)try{const W=await M.text(),Q=JSON.parse(W),X=await Ve.post(`/projects/${e.id}/eval-sets/import`,Q);n(ae=>[...ae,X.eval_set]),i(X.eval_set.id),c(ae=>new Set([...ae,X.eval_set.id]))}catch(W){h(W.message||"Failed to import eval set")}},C=_.useRef(null),oe=async(M,W)=>{if(e!=null&&e.id){y(Q=>new Set([...Q,W]));try{const Q=await Ve.post(`/projects/${e.id}/eval-sets/${M}/cases/${W}/run`,{});d(X=>new Map(X).set(W,Q.result))}catch(Q){h(Q.message||"Failed to run eval case")}finally{y(Q=>{const X=new Set(Q);return X.delete(W),X})}}},R=async M=>{if(!(e!=null&&e.id))return;const W=t.find(X=>X.id===M);if(!W)return;const Q=W.eval_cases.map(X=>X.id);y(X=>new Set([...X,M,...Q]));try{const X=await Ve.post(`/projects/${e.id}/eval-sets/${M}/run`,{});f(ae=>new Map(ae).set(M,X.result));for(const ae of X.result.case_results)d(me=>new Map(me).set(ae.eval_case_id,ae));try{await Ve.post(`/projects/${e.id}/eval-history`,X.result),x()}catch(ae){console.warn("Failed to save eval run to history:",ae)}}catch(X){h(X.message||"Failed to run eval set")}finally{y(X=>{const ae=new Set(X);return ae.delete(M),Q.forEach(me=>ae.delete(me)),ae})}},Z=M=>{c(W=>{const Q=new Set(W);return Q.has(M)?Q.delete(M):Q.add(M),Q})},B=M=>{let W=M.eval_cases.length,Q=0,X=0,ae=0;for(const me of M.eval_cases){const ve=u.get(me.id);ve?ve.passed?Q++:X++:ae++}return{total:W,passed:Q,failed:X,pending:ae}},te=M=>M==null?"-":`${Math.round(M*100)}%`;return e?s.jsxs("div",{className:"eval-panel",children:[s.jsx("style",{children:`
        .eval-panel {
          display: flex;
          gap: 20px;
          height: calc(100vh - 180px);
      ...
      `}),s.jsxs("aside",{className:"eval-sidebar",children:[s.jsxs("div",{className:"sidebar-header",children:[s.jsx("h3",{children:"Evaluation Tests"}),s.jsxs("div",{className:"header-actions",children:[s.jsx("input",{type:"file",ref:C,accept:".json",style:{display:"none"},onChange:M=>{var Q;const W=(Q=M.target.files)==null?void 0:Q[0];W&&(J(W),M.target.value="")}}),s.jsx("button",{className:"btn btn-secondary btn-sm",onClick:()=>{var M;return(M=C.current)==null?void 0:M.click()},title:"Import eval set from JSON",children:s.jsx(Uo,{size:14})}),s.jsx("button",{className:"btn btn-secondary btn-sm",onClick:O,title:"Refresh",children:s.jsx(wn,{size:14})}),s.jsxs("button",{className:"btn btn-primary btn-sm",onClick:K,title:"New eval set",children:[s.jsx(Me,{size:14}),"Set"]})]})]}),s.jsxs("div",{className:"eval-tree",children:[w&&s.jsx("p",{style:{color:"var(--text-muted)",padding:"16px"},children:"Loading..."}),g&&s.jsx("div",{style:{color:"var(--error)",padding:"16px",fontSize:"13px"},children:g}),!w&&t.length===0&&s.jsxs("div",{className:"empty-state",style:{padding:"32px"},children:[s.jsx(cu,{size:32}),s.jsxs("p",{children:["No evaluation sets yet.",s.jsx("br",{}),"Create one to get started."]})]}),t.map(M=>{const W=l.has(M.id),Q=B(M),X=m.has(M.id);return s.jsxs("div",{className:"tree-item",children:[s.jsxs("div",{className:`tree-set ${r===M.id&&!o?"selected":""}`,onClick:()=>A(M.id),children:[s.jsx("button",{className:"expand-btn",onClick:ae=>{ae.stopPropagation(),Z(M.id)},children:M.eval_cases.length>0?W?s.jsx(Ct,{size:14}):s.jsx(Nt,{size:14}):s.jsx("span",{style:{width:14}})}),s.jsx(ng,{size:14,style:{color:"var(--accent-secondary)"}}),s.jsx("span",{className:"set-name",children:M.name}),Q.total>0&&s.jsxs("span",{className:"set-stats",children:[Q.passed>0&&s.jsx("span",{className:"stat-passed",children:Q.passed}),Q.failed>0&&s.jsx("span",{className:"stat-failed",children:Q.failed}),Q.pending>0&&s.jsx("span",{className:"stat-pending",children:Q.pending})]}),s.jsx("button",{className:"run-btn",onClick:ae=>{ae.stopPropagation(),R(M.id)},title:"Run all tests in this set",disabled:X,children:X?s.jsx(ho,{size:12,className:"spinning"}):s.jsx(Mn,{size:12})})]}),W&&s.jsxs("div",{className:"tree-children",style:{paddingLeft:16},children:[M.eval_cases.map(ae=>{var ft;const me=u.get(ae.id),ve=m.has(ae.id);return s.jsxs("div",{className:`tree-case ${o===ae.id?"selected":""}`,onClick:()=>N(M.id,ae.id),children:[ve?s.jsx(ho,{size:14,className:"spinning",style:{color:"var(--warning)"}}):me?me.passed?s.jsx(sr,{size:14,style:{color:"var(--success)"}}):s.jsx(Vr,{size:14,style:{color:"var(--error)"}}):s.jsx(go,{size:14,style:{color:"var(--text-muted)"}}),s.jsx("span",{className:"case-name",children:ae.name}),me&&me.metric_results.length>0&&s.jsx("span",{style:{fontSize:11,color:me.passed?"var(--success)":"var(--error)"},children:te((ft=me.metric_results[0])==null?void 0:ft.score)}),s.jsx("button",{className:"run-btn",onClick:H=>{H.stopPropagation(),oe(M.id,ae.id)},disabled:ve,children:s.jsx(Mn,{size:12})})]},ae.id)}),s.jsxs("button",{className:"btn btn-secondary btn-sm",style:{marginTop:8,marginLeft:20},onClick:()=>P(M.id),children:[s.jsx(Me,{size:12}),"Add Test Case"]})]})]},M.id)})]}),s.jsxs("div",{className:"history-section",children:[s.jsx("div",{className:"history-header",style:{display:"flex",justifyContent:"space-between",alignItems:"center",padding:"10px 12px",borderTop:"1px solid var(--border-color)",background:"var(--bg-secondary)"},children:s.jsxs("span",{style:{fontWeight:500,fontSize:13},children:["Previous Runs (",v.length,")"]})}),s.jsx("div",{className:"history-list",style:{maxHeight:200,overflowY:"auto"},children:v.length===0?s.jsx("div",{style:{padding:"12px",color:"var(--text-secondary)",fontSize:12,textAlign:"center"},children:"No previous runs"}):[...v].sort((M,W)=>(W.started_at||0)-(M.started_at||0)).map(M=>{const W=M.passed_cases===M.total_cases;return s.jsx("div",{className:`history-item ${(S==null?void 0:S.id)===M.id?"selected":""}`,onClick:()=>z(M.id),style:{padding:"8px 12px",borderBottom:"1px solid var(--border-color)",cursor:"pointer",background:(S==null?void 0:S.id)===M.id?"var(--bg-tertiary)":"transparent",fontSize:12},children:s.jsxs("div",{style:{display:"flex",justifyContent:"space-between",alignItems:"center"},children:[s.jsxs("div",{style:{display:"flex",alignItems:"center",gap:8},children:[W?s.jsx(sr,{size:14,style:{color:"var(--success)",flexShrink:0}}):s.jsx(Vr,{size:14,style:{color:"var(--error)",flexShrink:0}}),s.jsxs("div",{children:[s.jsx("div",{style:{fontWeight:500},children:M.eval_set_name||"Unnamed"}),s.jsx("div",{style:{color:"var(--text-secondary)",fontSize:11},children:new Date(M.started_at*1e3).toLocaleString()})]})]}),s.jsxs("div",{style:{display:"flex",alignItems:"center",gap:8},children:[s.jsxs("span",{style:{color:W?"var(--success)":"var(--error)",fontWeight:500,fontSize:11},children:[M.passed_cases,"/",M.total_cases]}),s.jsx("button",{className:"btn btn-icon",onClick:Q=>{Q.stopPropagation(),T(M.id)},title:"Delete run",style:{padding:2},children:s.jsx(Pe,{size:12})})]})]})},M.id)})})]})]}),s.jsx("div",{className:"eval-editor",children:S?s.jsx(TS,{run:S,onClose:b}):D?s.jsx(PS,{evalCase:D,evalSetId:r,projectId:e.id,result:u.get(D.id),isRunning:m.has(D.id),onUpdate:M=>$(r,D.id,M),onDelete:()=>I(r,D.id),onRun:()=>oe(r,D.id),onClearResult:()=>d(M=>{const W=new Map(M);return W.delete(D.id),W})}):U?s.jsx(LS,{evalSet:U,projectId:e.id,result:p.get(U.id),isRunning:m.has(U.id),caseResults:u,onUpdate:async M=>{try{const W=await Ve.put(`/projects/${e.id}/eval-sets/${U.id}`,M);n(Q=>Q.map(X=>X.id===U.id?W.eval_set:X))}catch(W){h(W.message)}},onDelete:()=>k(U.id),onRun:()=>R(U.id),onExport:()=>V(U.id)}):s.jsx("div",{className:"editor-content",children:s.jsxs("div",{className:"empty-state",children:[s.jsx(go,{size:48}),s.jsxs("p",{children:["Select a test case to edit",s.jsx("br",{}),"or create a new one"]})]})})})]}):null}function zS({value:e,onChange:t}){var a,l;const{project:n}=Ze(),r=((a=n==null?void 0:n.app)==null?void 0:a.models)||[],i=(l=n==null?void 0:n.app)==null?void 0:l.default_model_id,o=r.find(c=>c.id===i);return s.jsxs("select",{value:e,onChange:c=>t(c.target.value),style:{width:"100%",maxWidth:400},children:[s.jsx("option",{value:"",children:o?`App Default (${o.model_name})`:"App Default"}),r.map(c=>s.jsx("option",{value:c.model_name,children:c.model_name},c.id)),s.jsx("option",{value:"gemini-2.0-flash",children:"gemini-2.0-flash"}),s.jsx("option",{value:"gemini-2.5-flash",children:"gemini-2.5-flash"}),s.jsx("option",{value:"gemini-2.5-pro",children:"gemini-2.5-pro"})]})}function TS({run:e,onClose:t}){var m;const{project:n}=Ze(),[r,i]=_.useState(!0),[o,a]=_.useState(new Set),l=e.case_results||[],c=l.filter(y=>y.passed).length,u=l.filter(y=>!y.passed).length,d=r?l.filter(y=>!y.passed):l,p=y=>{a(w=>{const E=new Set(w);return E.has(y)?E.delete(y):E.add(y),E})},f=y=>{y&&n&&(window.location.href=`/project/${n.id}/run?session=${y}`)};return s.jsxs("div",{className:"test-result-viewer",children:[s.jsx("style",{children:`
        .test-result-viewer {
          height: 100%;
          display: flex;
          flex-direction: column;
...
`)}function FS(){const{project:e}=Ze(),[t,n]=_.useState(!1);if(!e)return null;const r=_.useMemo(()=>DS(e),[e]);function i(){navigator.clipboard.writeText(r),n(!0),setTimeout(()=>n(!1),2e3)}function o(){const a=new Blob([r],{type:"text/x-python"}),l=URL.createObjectURL(a),c=document.createElement("a");c.href=l,c.download=`${e.name}_agent.py`,c.click(),URL.revokeObjectURL(l)}return s.jsxs("div",{className:"code-panel",children:[s.jsx("style",{children:`
      ...
      `}),s.jsxs("div",{className:"code-header",children:[s.jsxs("div",{className:"code-title",children:[s.jsx(In,{size:16}),s.jsx("h3",{children:"Python Code"}),s.jsx("span",{className:"badge",children:"Generated"}),t&&s.jsxs("span",{className:"status-badge success",children:[s.jsx(Zh,{size:12}),"Copied!"]})]}),s.jsxs("div",{className:"code-actions",children:[s.jsxs("button",{className:"btn btn-secondary btn-sm",onClick:i,title:"Copy to clipboard",children:[s.jsx(eg,{size:14}),"Copy"]}),s.jsxs("button",{className:"btn btn-secondary btn-sm",onClick:o,title:"Download Python file",children:[s.jsx(Bo,{size:14}),"Download"]})]})]}),s.jsx("div",{className:"code-editor",children:s.jsx(an,{height:"100%",language:"python",theme:"vs-dark",value:r,options:{readOnly:!0,minimap:{enabled:!1},fontSize:13,fontFamily:"'JetBrains Mono', monospace",lineNumbers:"on",scrollBeyondLastLine:!1,automaticLayout:!0,tabSize:4,insertSpaces:!0,padding:{top:12},wordWrap:"on"}})}),s.jsxs("div",{className:"code-info",children:[s.jsx("p",{children:"This is the Python code equivalent of your project configuration. You can use this code directly with ADK."}),s.jsxs("p",{children:["Place this in a file named ",s.jsx("code",{children:"agent.py"})," inside your agent directory, then run with ",s.jsx("code",{children:"adk web ."})," or ",s.jsx("code",{children:"adk run your_agent"}),"."]})]})]})}const BS=[{id:"app",label:"App",icon:sg},{id:"agents",label:"Agents",icon:Zn},{id:"tools",label:"Tools",icon:Gt},{id:"callbacks",label:"Callbacks",icon:In},{id:"run",label:"Run",icon:rg},{id:"skillsets",label:"SkillSets",icon:u0},{id:"eval",label:"Evaluate",icon:Wl},{id:"yaml",label:"YAML",icon:p0},{id:"code",label:"Code",icon:In}],US=["app","agents","tools","callbacks","run","skillsets","eval","yaml","code"];function Va(){var D,K;const{projectId:e,tab:t,itemId:n}=p1(),r=nu(),{project:i,setProject:o,activeTab:a,setActiveTab:l,hasUnsavedChanges:c,setHasUnsavedChanges:u,selectedAgentId:d,setSelectedAgentId:p,selectedToolId:f,setSelectedToolId:m}=Ze(),[y,w]=_.useState(!0),[E,g]=_.useState(!1),[h,v]=_.useState(!1),[L,S]=_.useState(null),j=_.useRef(!0),x=_.useRef(null);_.useEffect(()=>{t&&US.includes(t)?l(t):!t&&e&&r(`/project/${e}/${a}`,{replace:!0})},[t,e]),_.useEffect(()=>{t==="agents"&&n?p(n):t==="tools"&&n&&m(n)},[t,n]);function z(P){l(P),P==="agents"&&d?r(`/project/${e}/${P}/${d}`,{replace:!0}):P==="tools"&&f?r(`/project/${e}/${P}/${f}`,{replace:!0}):r(`/project/${e}/${P}`,{replace:!0})}function A(P){P?r(`/project/${e}/${a}/${P}`,{replace:!0}):r(`/project/${e}/${a}`,{replace:!0})}_.useEffect(()=>(e&&N(e),()=>{o(null),u(!1)}),[e]);async function N(P){j.current=!0;try{const $=await Rh(P);o($),x.current=JSON.stringify($),u(!1)}catch($){console.error("Failed to load project:",$),r("/")}finally{w(!1),setTimeout(()=>{j.current=!1},100)}}async function b(){if(i){g(!0);try{const{eval_sets:P,...$}=i;await Dl(i.id,$),x.current=JSON.stringify(i),u(!1)}catch(P){console.error("Failed to save project:",P)}finally{g(!1)}}}async function T(){if(i){v(!0),S(null);try{let P=0,$=0;for(const I of i.eval_sets||[]){if(I.eval_cases.length===0)continue;const k=await Ve.post(`/projects/${i.id}/eval-sets/${I.id}/run`,{});if(k.result){P+=k.result.passed_cases||0,$+=k.result.total_cases||0;try{await Ve.post(`/projects/${i.id}/eval-history`,k.result)}catch(V){console.warn("Failed to save eval run to history:",V)}}}S({passed:P,total:$}),setTimeout(()=>S(null),5e3)}catch(P){console.error("Failed to run tests:",P),S({passed:0,total:-1}),setTimeout(()=>S(null),5e3)}finally{v(!1)}}}const O=_.useRef(null);_.useEffect(()=>{if(i&&!j.current&&O.current){const P=i.app.models||[],$=O.current||[];if(P.some((k,V)=>{const J=$.find(C=>C.id===k.id);return J?J.provider!==k.provider||J.model_name!==k.model_name||J.api_base!==k.api_base||J.temperature!==k.temperature||J.max_output_tokens!==k.max_output_tokens||J.top_p!==k.top_p||J.top_k!==k.top_k:!1})){const k=i.app.default_model_id,V=i.agents.map(C=>{if(C.type==="LlmAgent"&&C.model){const oe=C.model._appModelId;if(oe){const R=P.find(Z=>Z.id===oe);if(R)return{...C,model:{provider:R.provider,model_name:R.model_name,api_base:R.api_base,temperature:R.temperature,max_output_tokens:R.max_output_tokens,top_p:R.top_p,top_k:R.top_k,fallbacks:[],_appModelId:oe}}}else if(k){const R=P.find(Z=>Z.id===k);if(R&&C.model.provider===R.provider&&C.model.model_name===R.model_name&&C.model.api_base===R.api_base)return{...C,model:{provider:R.provider,model_name:R.model_name,api_base:R.api_base,temperature:R.temperature,max_output_tokens:R.max_output_tokens,top_p:R.top_p,top_k:R.top_k,fallbacks:[],_appModelId:k}}}}return C});V.some((C,oe)=>JSON.stringify(C)!==JSON.stringify(i.agents[oe]))&&o({...i,agents:V})}}i&&(O.current=i.app.models||[])},[i==null?void 0:i.app.models,i,o]);const U=_.useRef(null);return _.useEffect(()=>(i&&!j.current&&x.current&&JSON.stringify(i)!==x.current&&(u(!0),U.current&&clearTimeout(U.current),U.current=setTimeout(async()=>{try{const{eval_sets:$,...I}=i;await Dl(i.id,I),x.current=JSON.stringify(i),u(!1)}catch($){console.error("Auto-save failed:",$)}},500)),()=>{U.current&&clearTimeout(U.current)}),[i]),y?s.jsxs("div",{className:"loading-screen",children:[s.jsx("style",{children:`
          .loading-screen {
            height: 100vh;
            display: flex;
            align-items: center;
