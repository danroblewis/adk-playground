 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */(function(e){function t(O,M){var k=O.length;O.push(M);e:for(;0<k;){var V=k-1>>>1,J=O[V];if(0<i(J,M))O[V]=M,O[k]=J,k=V;else break e}}function n(O){return O.length===0?null:O[0]}function r(O){if(O.length===0)return null;var M=O[0],k=O.pop();if(k!==M){O[0]=k;e:for(var V=0,J=O.length,b=J>>>1;V<b;){var U=2*(V+1)-1,A=O[U],Q=U+1,ue=O[Q];if(0>i(A,k))Q<J&&0>i(ue,A)?(O[V]=ue,O[Q]=k,V=Q):(O[V]=A,O[U]=k,V=U);else if(Q<J&&0>i(ue,k))O[V]=ue,O[Q]=k,V=Q;else break e}}return M}function i(O,M){var k=O.sortIndex-M.sortIndex;return k!==0?k:O.id-M.id}if(typeof performance=="object"&&typeof performance.now=="function"){var s=performance;e.unstable_now=function(){return s.now()}}else{var a=Date,l=a.now();e.unstable_now=function(){return a.now()-l}}var c=[],u=[],d=1,p=null,f=3,h=!1,g=!1,v=!1,w=typeof setTimeout=="function"?setTimeout:null,m=typeof clearTimeout=="function"?clearTimeout:null,x=typeof setImmediate<"u"?setImmediate:null;typeof navigator<"u"&&navigator.scheduling!==void 0&&navigator.scheduling.isInputPending!==void 0&&navigator.scheduling.isInputPending.bind(navigator.scheduling);function y(O){for(var M=n(u);M!==null;){if(M.callback===null)r(u);else if(M.startTime<=O)r(u),M.sortIndex=M.expirationTime,t(c,M);else break;M=n(u)}}function j(O){if(v=!1,y(O),!g)if(n(c)!==null)g=!0,$(C);else{var M=n(u);M!==null&&z(j,M.startTime-O)}}function C(O,M){g=!1,v&&(v=!1,m(N),N=-1),h=!0;var k=f;try{for(y(M),p=n(c);p!==null&&(!(p.expirationTime>M)||O&&!I());){var V=p.callback;if(typeof V=="function"){p.callback=null,f=p.priorityLevel;var J=V(p.expirationTime<=M);M=e.unstable_now(),typeof J=="function"?p.callback=J:p===n(c)&&r(c),y(M)}else r(c);p=n(c)}if(p!==null)var b=!0;else{var U=n(u);U!==null&&z(j,U.startTime-M),b=!1}return b}finally{p=null,f=k,h=!1}}var _=!1,P=null,N=-1,D=5,E=-1;function I(){return!(e.unstable_now()-E<D)}function R(){if(P!==null){var O=e.unstable_now();E=O;var M=!0;try{M=P(!0,O)}finally{M?W():(_=!1,P=null)}}else _=!1}var W;if(typeof x=="function")W=function(){x(R)};else if(typeof MessageChannel<"u"){var T=new MessageChannel,L=T.port2;T.port1.onmessage=R,W=function(){L.postMessage(null)}}else W=function(){w(R,0)};function $(O){P=O,_||(_=!0,W())}function z(O,M){N=w(function(){O(e.unstable_now())},M)}e.unstable_IdlePriority=5,e.unstable_ImmediatePriority=1,e.unstable_LowPriority=4,e.unstable_NormalPriority=3,e.unstable_Profiling=null,e.unstable_UserBlockingPriority=2,e.unstable_cancelCallback=function(O){O.callback=null},e.unstable_continueExecution=function(){g||h||(g=!0,$(C))},e.unstable_forceFrameRate=function(O){0>O||125<O?console.error("forceFrameRate takes a positive int between 0 and 125, forcing frame rates higher than 125 fps is not supported"):D=0<O?Math.floor(1e3/O):5},e.unstable_getCurrentPriorityLevel=function(){return f},e.unstable_getFirstCallbackNode=function(){return n(c)},e.unstable_next=function(O){switch(f){case 1:case 2:case 3:var M=3;break;default:M=f}var k=f;f=M;try{return O()}finally{f=k}},e.unstable_pauseExecution=function(){},e.unstable_requestPaint=function(){},e.unstable_runWithPriority=function(O,M){switch(O){case 1:case 2:case 3:case 4:case 5:break;default:O=3}var k=f;f=O;try{return M()}finally{f=k}},e.unstable_scheduleCallback=function(O,M,k){var V=e.unstable_now();switch(typeof k=="object"&&k!==null?(k=k.delay,k=typeof k=="number"&&0<k?V+k:V):k=V,O){case 1:var J=-1;break;case 2:J=250;break;case 5:J=1073741823;break;case 4:J=1e4;break;default:J=5e3}return J=k+J,O={id:d++,callback:M,priorityLevel:O,startTime:k,expirationTime:J,sortIndex:-1},k>V?(O.sortIndex=k,t(u,O),n(c)===null&&O===n(u)&&(v?(m(N),N=-1):v=!0,z(j,k-V))):(O.sortIndex=J,t(c,O),g||h||(g=!0,$(C))),O},e.unstable_shouldYield=I,e.unstable_wrapCallback=function(O){var M=f;return function(){var k=f;f=M;try{return O.apply(this,arguments)}finally{f=k}}}})(ng);tg.exports=ng;var s0=tg.exports;/**
 * @license React
...
`).length,h=Math.max(r,Math.min(f*20+40,500));l(h)}},[e,r]),S.useEffect(()=>{i&&u.current&&u.current.focus()},[i]);function d(f){u.current=f,f.focus()}function p(f){c.current&&!c.current.contains(f.target)&&s(!1)}return S.useEffect(()=>{if(i)return document.addEventListener("mousedown",p),()=>document.removeEventListener("mousedown",p)},[i]),o.jsxs("div",{ref:c,className:"markdown-editor",children:[o.jsx("style",{children:`
      ...
      `}),i?o.jsx("div",{className:"monaco-wrapper",children:o.jsx(Jt,{height:"100%",language:"markdown",theme:"vs-dark",value:e,onChange:f=>t(f||""),onMount:d,options:{minimap:{enabled:!1},fontSize:14,fontFamily:"'JetBrains Mono', monospace",lineNumbers:"off",scrollBeyondLastLine:!1,automaticLayout:!0,wordWrap:"on",padding:{top:12,bottom:12},lineDecorationsWidth:8,folding:!1,glyphMargin:!1,renderLineHighlight:"none",overviewRulerLanes:0,hideCursorInOverviewRuler:!0,scrollbar:{vertical:"auto",horizontal:"hidden"}}})}):o.jsxs("div",{className:"markdown-preview",onClick:()=>s(!0),children:[o.jsxs("span",{className:"edit-hint",children:[o.jsx(Jk,{size:12}),"Click to edit"]}),e?o.jsx("div",{className:"markdown-content",children:o.jsx(Bv,{children:e})}):o.jsx("div",{className:"markdown-placeholder",children:n})]})]})}function o4(e){return/^[a-zA-Z0-9_]+$/.test(e)}function s4({agent:e}){const{project:t,updateAgent:n,mcpServers:r,builtinTools:i,setActiveTab:s,setRunAgentId:a}=ut(),[l,c]=S.useState(new Set(["basic","model","tools","subagents"])),[u,d]=S.useState(!1),[p,f]=S.useState(!1),[h,g]=S.useState(!1),[v,w]=S.useState(""),[m,x]=S.useState(null);if(!t)return null;function y(z){n(e.id,z)}function j(z){if(z===""){x(null),y({name:z});return}o4(z)?x(null):x("Name can only contain letters, numbers, and underscores"),e.type==="LlmAgent"?y({name:z,output_key:z}):y({name:z})}function C(z){const O=new Set(l);O.has(z)?O.delete(z):O.add(z),c(O)}const _=e.type==="LlmAgent",P=e;function N(z){_&&y({tools:[...P.tools,z]})}function D(z){_&&y({tools:P.tools.filter((O,M)=>M!==z)})}function E(z,O){if(!_)return;const M=[...P.tools];M[z]=O,y({tools:M})}function I(z){"sub_agents"in e&&y({sub_agents:[...e.sub_agents,z]})}function R(z){"sub_agents"in e&&y({sub_agents:e.sub_agents.filter(O=>O!==z)})}const W=t.agents.filter(z=>z.id!==e.id);async function T(){if(!(!t||!_)){d(!0);try{const z=P.instruction||"",O=z?`Current instruction to improve:

${z}

Please improve and expand this instruction while preserving its core intent.`:void 0,k=t.agents.some(J=>J.id===e.id)?void 0:e,V=await Ks(t.id,e.id,O,k);V.success&&V.prompt?y({instruction:V.prompt}):alert("Failed to generate prompt: "+(V.error||"Unknown error"))}catch(z){alert("Error generating prompt: "+z.message)}finally{d(!1)}}}async function L(){if(!(!t||!_||!v.trim())){d(!0);try{const O=`Current instruction:
...
Please apply the requested changes to the instruction above. Output only the updated instruction, nothing else.`,k=t.agents.some(J=>J.id===e.id)?void 0:e,V=await Ks(t.id,e.id,O,k);V.success&&V.prompt?(y({instruction:V.prompt}),g(!1),w("")):alert("Failed to apply changes: "+(V.error||"Unknown error"))}catch(z){alert("Error applying changes: "+z.message)}finally{d(!1)}}}async function $(){if(!t||!_)return;const z=P.instruction;if(!z){alert("Please write an instruction first");return}f(!0);try{const O=`Write a 5-10 word description of what this agent does.
...
Your response (5-10 words only):`,M=await Ks(t.id,e.id,O);if(M.success&&M.prompt){let k=M.prompt.trim();k=k.replace(/^["']|["']$/g,"").trim();const V=k.split(/[.!?\n]/)[0].trim(),J=V.length>80?V.slice(0,77)+"...":V;y({description:J})}else alert("Failed to generate description: "+(M.error||"Unknown error"))}catch(O){alert("Error generating description: "+O.message)}finally{f(!1)}}return o.jsxs("div",{className:"agent-editor",children:[o.jsx("style",{children:`
        .agent-editor {
          background: var(--bg-secondary);
          border: 1px solid var(--border-color);
          border-radius: var(--radius-lg);
      ...
      `}),o.jsxs("div",{className:"editor-header",children:[o.jsx(Er,{size:24,style:{color:"var(--accent-primary)"}}),o.jsxs("div",{style:{flex:1,display:"flex",flexDirection:"column",gap:4},children:[o.jsx("input",{type:"text",value:e.name,onChange:z=>j(z.target.value),placeholder:"Agent name",style:{borderColor:m?"var(--error)":void 0}}),m&&o.jsx("span",{style:{fontSize:11,color:"var(--error)",marginTop:-4},children:m})]}),o.jsx("span",{className:"badge badge-info",children:e.type}),o.jsxs("button",{className:"btn btn-primary btn-sm run-agent-btn",onClick:()=>{a(e.id),s("run")},title:"Test this agent",children:[o.jsx(pr,{size:14}),"Run"]})]}),o.jsxs("div",{className:"editor-content",children:[o.jsxs(qi,{id:"basic",title:"Basic Info",icon:o.jsx(Er,{size:16}),expanded:l.has("basic"),onToggle:()=>C("basic"),children:[o.jsx("div",{className:"form-row",children:o.jsxs("div",{className:"form-group full-width",children:[o.jsxs("div",{className:"label-with-action",children:[o.jsx("label",{children:"Description"}),_&&P.instruction&&o.jsx("button",{className:"btn btn-secondary btn-sm generate-btn",onClick:$,disabled:p,title:"Generate description from instruction",children:p?o.jsxs(o.Fragment,{children:[o.jsx(Zn,{size:14,className:"spin"}),"Summarizing..."]}):"Summarize"})]}),o.jsx("input",{type:"text",value:e.description,onChange:z=>y({description:z.target.value}),placeholder:"e.g., Reviews code for bugs and suggests fixes"})]})}),_&&o.jsxs(o.Fragment,{children:[o.jsx("div",{className:"form-row",children:o.jsxs("div",{className:"form-group full-width",children:[o.jsxs("div",{className:"label-with-action",children:[o.jsx("label",{children:"Instruction"}),o.jsxs("div",{className:"action-buttons",children:[o.jsx("button",{className:"btn btn-secondary btn-sm",onClick:()=>g(!h),disabled:u||!P.instruction,title:"Request specific changes to the instruction",children:"Request Changes"}),o.jsx("button",{className:"btn btn-secondary btn-sm",onClick:T,disabled:u,title:"Uses AI to improve and expand the current instruction",children:u?o.jsxs(o.Fragment,{children:[o.jsx(Zn,{size:14,className:"spin"}),"Working..."]}):"Auto-Improve"})]})]}),h&&o.jsxs("div",{className:"request-changes-box",children:[o.jsx("input",{type:"text",value:v,onChange:z=>w(z.target.value),placeholder:"Describe what changes you want...",onKeyDown:z=>{z.key==="Enter"&&v.trim()?L():z.key==="Escape"&&(g(!1),w(""))},autoFocus:!0}),o.jsx("button",{className:"btn btn-primary btn-sm",onClick:L,disabled:u||!v.trim(),children:"Apply"})]}),o.jsx(i4,{value:P.instruction,onChange:z=>y({instruction:z}),placeholder:"Write your agent's instruction here... (Markdown supported)",minHeight:200})]})}),o.jsxs("div",{className:"form-row",children:[o.jsxs("div",{className:"form-group",children:[o.jsx("label",{children:"Output Key"}),o.jsxs("select",{value:P.output_key||"",onChange:z=>y({output_key:z.target.value||void 0}),children:[o.jsx("option",{value:"",children:"None"}),t.app.state_keys.map(z=>o.jsx("option",{value:z.name,children:z.name},z.name))]})]}),o.jsxs("div",{className:"form-group",children:[o.jsx("label",{children:"Include Contents"}),o.jsxs("select",{value:P.include_contents,onChange:z=>y({include_contents:z.target.value}),children:[o.jsx("option",{value:"default",children:"Default"}),o.jsx("option",{value:"none",children:"None"})]})]})]}),o.jsxs("div",{className:"form-row",style:{gap:24},children:[o.jsxs("label",{style:{display:"flex",alignItems:"center",gap:8,fontSize:13},children:[o.jsxs("span",{className:"toggle-switch",children:[o.jsx("input",{type:"checkbox",checked:P.disallow_transfer_to_parent,onChange:z=>y({disallow_transfer_to_parent:z.target.checked})}),o.jsx("span",{className:"toggle-slider"})]}),"Disallow transfer to parent"]}),o.jsxs("label",{style:{display:"flex",alignItems:"center",gap:8,fontSize:13},children:[o.jsxs("span",{className:"toggle-switch",children:[o.jsx("input",{type:"checkbox",checked:P.disallow_transfer_to_peers,onChange:z=>y({disallow_transfer_to_peers:z.target.checked})}),o.jsx("span",{className:"toggle-slider"})]}),"Disallow transfer to peers"]})]})]}),e.type==="LoopAgent"&&o.jsx("div",{className:"form-row",children:o.jsxs("div",{className:"form-group",children:[o.jsx("label",{children:"Max Iterations"}),o.jsx("input",{type:"number",value:e.max_iterations||"",onChange:z=>y({max_iterations:parseInt(z.target.value)||void 0}),placeholder:"No limit"})]})})]}),_&&o.jsx(qi,{id:"model",title:"Model",icon:o.jsx(Od,{size:16}),expanded:l.has("model"),onToggle:()=>C("model"),children:o.jsx(l4,{agent:P,appModels:t.app.models||[],defaultModelId:t.app.default_model_id,projectId:t.id,onUpdate:z=>y({model:z})})}),_&&o.jsx(qi,{id:"tools",title:`Tools (${P.tools.length})`,icon:o.jsx(an,{size:16}),expanded:l.has("tools"),onToggle:()=>C("tools"),children:o.jsx(a4,{tools:P.tools,onAdd:N,onRemove:D,onUpdate:E,builtinTools:i,mcpServers:r,projectMcpServers:t.mcp_servers,customTools:t.custom_tools,agents:W,skillsets:t.skillsets||[]})}),"sub_agents"in e&&o.jsx(qi,{id:"subagents",title:`Sub-Agents (${e.sub_agents.length})`,icon:o.jsx(Ky,{size:16}),expanded:l.has("subagents"),onToggle:()=>C("subagents"),children:o.jsxs("div",{className:"sub-agent-list",children:[e.sub_agents.map(z=>{const O=t.agents.find(M=>M.id===z);return O?o.jsxs("div",{className:"sub-agent-chip",children:[O.name,o.jsx("button",{onClick:()=>R(z),children:o.jsx(Fe,{size:12})})]},z):null}),o.jsxs("select",{value:"",onChange:z=>{z.target.value&&I(z.target.value)},style:{width:150,padding:"6px 10px",fontSize:13},children:[o.jsx("option",{value:"",children:"Add agent..."}),W.filter(z=>!e.sub_agents.includes(z.id)).map(z=>o.jsx("option",{value:z.id,children:z.name},z.id))]})]})}),o.jsx(qi,{id:"callbacks",title:"Callbacks",icon:o.jsx(jn,{size:16}),expanded:l.has("callbacks"),onToggle:()=>C("callbacks"),children:o.jsx(c4,{agent:e,onUpdate:y,customCallbacks:t.custom_callbacks||[],isLlmAgent:_})})]})]})}function qi({id:e,title:t,icon:n,expanded:r,onToggle:i,children:s}){return o.jsxs("div",{className:"section",children:[o.jsxs("div",{className:"section-header",onClick:i,children:[r?o.jsx(Pt,{size:16}):o.jsx(bt,{size:16}),o.jsxs("h4",{children:[n," ",t]})]}),r&&o.jsx("div",{className:"section-content",children:s})]})}function a4({tools:e,onAdd:t,onRemove:n,onUpdate:r,builtinTools:i,mcpServers:s,projectMcpServers:a,customTools:l,agents:c,skillsets:u}){const[d,p]=S.useState(!1),[f,h]=S.useState({}),[g,v]=S.useState(""),w=It.useRef(null),m=It.useRef(null),[x,y]=S.useState(null),[j,C]=S.useState(new Set),_=(A,Q)=>{if(!g.trim())return!0;const ue=g.toLowerCase();return A.toLowerCase().includes(ue)||((Q==null?void 0:Q.toLowerCase().includes(ue))??!1)},P=i.filter(A=>_(A.name,A.description)),N=s.filter(A=>_(A.name,A.description)),D=a.filter(A=>_(A.name,A.description)),E=l.filter(A=>_(A.name,A.description)),I=c.filter(A=>_(A.name,A.description)),R=u.filter(A=>_(A.name,A.description));function W(){if(w.current){const A=w.current.getBoundingClientRect(),Q=window.innerHeight,ue=350,me=Q-A.bottom-16,q=A.top-16;if(me>=200||me>=q){const F=Math.min(ue,me);h({top:A.bottom+4,left:A.left,maxHeight:F})}else{const F=Math.min(ue,q);h({top:A.top-F-4,left:A.left,maxHeight:F})}}p(!0),v(""),setTimeout(()=>{var A;return(A=m.current)==null?void 0:A.focus()},50)}function T(){p(!1),v("")}function L(A){t({type:"builtin",name:A}),T()}async function $(A){T();const Q=A.tool_filter||[];if(y({server:A,enabledTools:new Set(Q),availableTools:Q.map(ue=>({name:ue,description:""})),isLoading:Q.length===0,error:void 0}),Q.length===0)try{const{testMcpServer:ue}=await cj(async()=>{const{testMcpServer:q}=await Promise.resolve().then(()=>Lk);return{testMcpServer:q}},void 0),me=await ue({connection_type:A.connection_type,command:A.command,args:A.args,env:A.env,url:A.url,headers:A.headers,timeout:A.timeout||30});me.success?y(q=>q?{...q,availableTools:me.tools,enabledTools:new Set(me.tools.map(F=>F.name)),isLoading:!1}:null):y(q=>q?{...q,isLoading:!1,error:me.error||"Failed to connect to MCP server"}:null)}catch(ue){y(me=>me?{...me,isLoading:!1,error:ue.message}:null)}}function z(A){if(!x)return;const Q=new Set(x.enabledTools);Q.has(A)?Q.delete(A):Q.add(A),y({...x,enabledTools:Q})}function O(){if(!x)return;const A=Array.from(x.enabledTools);t({type:"mcp",server:{...x.server,tool_filter:A}}),y(null)}function M(A){const Q=new Set(j);Q.has(A)?Q.delete(A):Q.add(A),C(Q)}function k(A,Q){const ue=e[A];if(ue.type!=="mcp"||!ue.server)return;const me=ue.server.tool_filter||[];let q;me.includes(Q)?q=me.filter(F=>F!==Q):q=[...me,Q],r(A,{...ue,server:{...ue.server,tool_filter:q}})}function V(A){t({type:"function",name:A.name,module_path:A.module_path}),T()}function J(A){const Q=c.find(ue=>ue.id===A);t({type:"agent",agent_id:A,name:Q==null?void 0:Q.name}),T()}function b(A){const Q=u.find(ue=>ue.id===A);t({type:"skillset",skillset_id:A,name:Q==null?void 0:Q.name}),T()}function U(A){return s.find(Q=>Q.name===A)}return o.jsxs("div",{children:[o.jsx("style",{children:`
        .mcp-tool-item {
          border: 1px solid var(--border-color);
          border-radius: var(--radius-md);
          overflow: hidden;
      ...
      `}),o.jsx("div",{className:"tool-list",children:e.map((A,Q)=>{var ue;return A.type==="mcp"&&A.server?o.jsxs("div",{className:"mcp-tool-item",children:[o.jsxs("div",{className:"mcp-tool-header",onClick:()=>M(Q),children:[j.has(Q)?o.jsx(Pt,{size:14}):o.jsx(bt,{size:14}),o.jsx(an,{size:14,style:{color:"var(--accent-primary)"}}),o.jsxs("div",{className:"mcp-tool-info",children:[o.jsx("div",{className:"mcp-tool-name",children:A.server.name}),o.jsx("div",{className:"mcp-tool-count",children:A.server.tool_filter===null||A.server.tool_filter===void 0?"all tools":`${A.server.tool_filter.length} tools enabled`})]}),o.jsx("button",{className:"delete-btn",onClick:me=>{me.stopPropagation(),n(Q)},children:o.jsx(Fe,{size:14})})]}),j.has(Q)&&o.jsx("div",{className:"mcp-tool-body",children:o.jsx("div",{className:"mcp-tool-list",children:(()=>{const me=U(A.server.name),q=(me==null?void 0:me.tool_filter)||A.server.tool_filter||[],F=new Set(A.server.tool_filter||[]);return q.map(K=>o.jsxs("label",{className:`mcp-tool-chip ${F.has(K)?"enabled":"disabled"}`,onClick:()=>k(Q,K),children:[o.jsx("input",{type:"checkbox",checked:F.has(K),onChange:()=>{},style:{display:"none"}}),K]},K))})()})})]},Q):A.type==="skillset"?o.jsxs("div",{className:"tool-item",children:[o.jsx(Rn,{size:14,style:{color:"var(--accent)"}}),o.jsxs("div",{className:"tool-item-info",children:[o.jsx("div",{className:"tool-item-name",children:A.name||((ue=u.find(me=>me.id===A.skillset_id))==null?void 0:ue.name)||"SkillSet"}),o.jsx("div",{className:"tool-item-type",children:"skillset"})]}),o.jsx("button",{className:"delete-btn",onClick:()=>n(Q),children:o.jsx(Fe,{size:14})})]},Q):o.jsxs("div",{className:"tool-item",children:[o.jsx(an,{size:14,style:{color:"var(--accent-primary)"}}),o.jsxs("div",{className:"tool-item-info",children:[o.jsx("div",{className:"tool-item-name",children:A.name||A.agent_id}),o.jsx("div",{className:"tool-item-type",children:A.type})]}),o.jsx("button",{className:"delete-btn",onClick:()=>n(Q),children:o.jsx(Fe,{size:14})})]},Q)})}),o.jsxs("div",{className:"add-tool-dropdown",style:{marginTop:12},children:[o.jsxs("button",{ref:w,className:"btn btn-secondary btn-sm",onClick:()=>d?T():W(),children:[o.jsx(Ke,{size:14}),"Add Tool"]}),d&&o.jsxs(o.Fragment,{children:[o.jsx("div",{className:"dropdown-backdrop",onClick:T}),o.jsxs("div",{className:"dropdown-content dropdown-fixed",style:f,children:[o.jsx("div",{className:"dropdown-search",children:o.jsx("input",{ref:m,type:"text",placeholder:"Search tools...",value:g,onChange:A=>v(A.target.value),onKeyDown:A=>A.key==="Escape"&&T()})}),P.length>0&&o.jsxs("div",{className:"dropdown-section",children:[o.jsx("h5",{children:"Built-in Tools"}),P.map(A=>o.jsxs("button",{className:"dropdown-item",onClick:()=>L(A.name),children:[o.jsx("div",{className:"dropdown-item-name",children:A.name}),o.jsx("div",{className:"dropdown-item-desc",children:A.description})]},A.name))]}),N.length>0&&o.jsxs("div",{className:"dropdown-section",children:[o.jsxs("h5",{children:["Known MCP Servers (",N.length,")"]}),N.map(A=>o.jsxs("button",{className:"dropdown-item",onClick:()=>$(A),children:[o.jsxs("div",{className:"dropdown-item-name",children:[A.name,o.jsx("span",{style:{fontSize:11,color:"var(--text-muted)",marginLeft:8},children:A.tool_filter===null||A.tool_filter===void 0?"all tools":`${A.tool_filter.length} tools`})]}),o.jsx("div",{className:"dropdown-item-desc",children:A.description})]},`known-${A.name}`))]}),D.length>0&&o.jsxs("div",{className:"dropdown-section",children:[o.jsxs("h5",{children:["Project MCP Servers (",D.length,")"]}),D.map(A=>o.jsxs("button",{className:"dropdown-item",onClick:()=>$(A),children:[o.jsxs("div",{className:"dropdown-item-name",children:[A.name,o.jsx("span",{style:{fontSize:11,color:"var(--text-muted)",marginLeft:8},children:A.tool_filter===null||A.tool_filter===void 0?"all tools":`${A.tool_filter.length} tools`})]}),o.jsx("div",{className:"dropdown-item-desc",children:A.description||"Custom MCP server"})]},`project-${A.id||A.name}`))]}),E.length>0&&o.jsxs("div",{className:"dropdown-section",children:[o.jsx("h5",{children:"Custom Tools"}),E.map(A=>o.jsxs("button",{className:"dropdown-item",onClick:()=>V(A),children:[o.jsx("div",{className:"dropdown-item-name",children:A.name}),o.jsx("div",{className:"dropdown-item-desc",children:A.description})]},A.id))]}),I.length>0&&o.jsxs("div",{className:"dropdown-section",children:[o.jsx("h5",{children:"Agents as Tools"}),I.map(A=>o.jsxs("button",{className:"dropdown-item",onClick:()=>J(A.id),children:[o.jsx("div",{className:"dropdown-item-name",children:A.name}),o.jsx("div",{className:"dropdown-item-desc",children:A.type})]},A.id))]}),R.length>0&&o.jsxs("div",{className:"dropdown-section",children:[o.jsxs("h5",{children:["SkillSets (",R.length,")"]}),R.map(A=>o.jsxs("button",{className:"dropdown-item",onClick:()=>b(A.id),children:[o.jsxs("div",{className:"dropdown-item-name",children:[A.name,o.jsxs("span",{style:{fontSize:11,color:"var(--text-muted)",marginLeft:8},children:[A.entry_count||0," entries"]})]}),o.jsx("div",{className:"dropdown-item-desc",children:A.description||"Vector knowledge base"})]},A.id))]}),g.trim()&&P.length===0&&N.length===0&&D.length===0&&E.length===0&&I.length===0&&R.length===0&&o.jsxs("div",{className:"dropdown-section",style:{textAlign:"center",padding:"20px",color:"var(--text-muted)"},children:['No tools matching "',g,'"']})]})]})]}),x&&o.jsx("div",{className:"mcp-config-dialog",children:o.jsxs("div",{className:"mcp-config-content",children:[o.jsxs("h3",{children:["Configure ",x.server.name]}),o.jsx("p",{children:x.server.description}),x.isLoading?o.jsxs("div",{className:"mcp-loading",children:[o.jsx("div",{className:"spinner"}),o.jsx("p",{children:"Connecting to MCP server and discovering tools..."})]}):x.error?o.jsxs("div",{className:"mcp-error",children:[o.jsxs("p",{children:["⚠️ Failed to discover tools: ",x.error]}),o.jsx("p",{className:"hint",children:"You can still add the server, but you won't be able to select specific tools."})]}):o.jsxs(o.Fragment,{children:[o.jsxs("div",{className:"mcp-select-actions",children:[o.jsxs("button",{className:"btn btn-secondary btn-sm",onClick:()=>y({...x,enabledTools:new Set(x.availableTools.map(A=>A.name))}),children:["Select All (",x.availableTools.length,")"]}),o.jsx("button",{className:"btn btn-secondary btn-sm",onClick:()=>y({...x,enabledTools:new Set}),children:"Select None"})]}),o.jsx("div",{className:"mcp-tools-grid",children:x.availableTools.map(A=>o.jsxs("div",{className:"mcp-tool-row",title:A.description||A.name,style:{display:"flex",alignItems:"center",gap:8,padding:"4px 0"},children:[o.jsxs("label",{className:"toggle-switch",style:{margin:0},children:[o.jsx("input",{type:"checkbox",checked:x.enabledTools.has(A.name),onChange:()=>z(A.name)}),o.jsx("span",{className:"toggle-slider"})]}),o.jsx("span",{style:{fontSize:13,opacity:x.enabledTools.has(A.name)?1:.5,cursor:"pointer"},onClick:()=>z(A.name),children:A.name})]},A.name))})]}),o.jsxs("div",{className:"dialog-actions",children:[o.jsx("button",{className:"btn btn-secondary",onClick:()=>y(null),children:"Cancel"}),o.jsxs("button",{className:"btn btn-primary",onClick:O,disabled:x.enabledTools.size===0,children:["Add ",x.enabledTools.size," Tools"]})]})]})})]})}function l4({agent:e,appModels:t,defaultModelId:n,projectId:r,onUpdate:i}){var f,h;const s=(f=e.model)==null?void 0:f._appModelId,a=e.model!==null&&e.model!==void 0&&!s,c=s||(()=>{if(!e.model)return n;const g=t.find(v=>{var w,m,x;return v.provider===((w=e.model)==null?void 0:w.provider)&&v.model_name===((m=e.model)==null?void 0:m.model_name)&&v.api_base===((x=e.model)==null?void 0:x.api_base)});return g==null?void 0:g.id})()||n||((h=t[0])==null?void 0:h.id);It.useEffect(()=>{var g,v,w,m,x;if(s){const y=t.find(j=>j.id===s);y&&(((g=e.model)==null?void 0:g.provider)!==y.provider||((v=e.model)==null?void 0:v.model_name)!==y.model_name||((w=e.model)==null?void 0:w.api_base)!==y.api_base||((m=e.model)==null?void 0:m.temperature)!==y.temperature||((x=e.model)==null?void 0:x.max_output_tokens)!==y.max_output_tokens)&&i({provider:y.provider,model_name:y.model_name,api_base:y.api_base,temperature:y.temperature,max_output_tokens:y.max_output_tokens,top_p:y.top_p,top_k:y.top_k,fallbacks:[],_appModelId:s})}},[s,t,e.model,i]);function u(g){const v=t.find(w=>w.id===g);v&&i({provider:v.provider,model_name:v.model_name,api_base:v.api_base,temperature:v.temperature,max_output_tokens:v.max_output_tokens,top_p:v.top_p,top_k:v.top_k,fallbacks:[],_appModelId:g})}function d(){var g;if(a){const v=n||((g=t[0])==null?void 0:g.id);v&&u(v)}else{const v=e.model;if(v){const{_appModelId:w,...m}=v;i(m)}else i({provider:"gemini",model_name:"gemini-2.0-flash",fallbacks:[]})}}function p(g){const{_appModelId:v,...w}=e.model||{};i({...w,...g})}return t.find(g=>g.id===c),t.find(g=>g.id===n),o.jsxs("div",{className:"model-selector",children:[o.jsx("style",{children:`
        .model-selector {
          display: flex;
          flex-direction: column;
          gap: 16px;
...
`;function J4({onSelectTool:e}){const{project:t,updateProject:n,addCustomTool:r,updateCustomTool:i,removeCustomTool:s,selectedToolId:a,setSelectedToolId:l,builtinTools:c,mcpServers:u}=ut(),[d,p]=S.useState(""),[f,h]=S.useState(null),[g,v]=S.useState("tools"),[w,m]=S.useState(null),[x,y]=S.useState(""),[j,C]=S.useState(!1),[_,P]=S.useState(!1),[N,D]=S.useState(!1),[E,I]=S.useState(null),[R,W]=S.useState(null),[T,L]=S.useState({}),[$,z]=S.useState({}),[O,M]=S.useState("");if(!t)return null;const k=t.mcp_servers||[],V=t.custom_tools.find(H=>H.id===a),J=k.find(H=>H.name===w);function b(H){l(H),e==null||e(H)}S.useEffect(()=>{V&&(p(V.code),W(null))},[a]),S.useEffect(()=>{J&&(y(JSON.stringify(J,null,2)),C(!1))},[w]),S.useEffect(()=>{if(!t)return;const H=U(t.mcp_servers||[]);M(JSON.stringify(H,null,2))},[t==null?void 0:t.mcp_servers]),S.useEffect(()=>{if(g==="mcp"&&k.length>0){const H=k.filter(ae=>!T[ae.name]||T[ae.name]==="unknown");H.length>0&&H.forEach(ae=>{me(ae.name)})}},[g,k.length]);function U(H){const ae={};for(const he of H){const ye={};he.connection_type==="stdio"?(ye.command=he.command||"",ye.args=he.args||[],Object.keys(he.env||{}).length>0&&(ye.env=he.env)):he.connection_type==="sse"&&(ye.url=he.url||"",Object.keys(he.headers||{}).length>0&&(ye.headers=he.headers)),he.timeout&&he.timeout!==30&&(ye.timeout=he.timeout),he.tool_filter&&(ye.tool_filter=he.tool_filter),he.tool_name_prefix&&(ye.tool_name_prefix=he.tool_name_prefix),ae[he.name]=ye}return{mcpServers:ae}}function A(H){const ae=[];for(const[he,ye]of Object.entries(H.mcpServers||{})){const G={name:he,description:ye.description||"",connection_type:ye.url?"sse":"stdio",command:ye.command,args:ye.args||[],env:ye.env||{},url:ye.url,headers:ye.headers||{},timeout:ye.timeout||30,tool_filter:ye.tool_filter||null,tool_name_prefix:ye.tool_name_prefix};ae.push(G)}return ae}function Q(H){H!==void 0&&M(H)}function ue(){try{const H=JSON.parse(O),ae=A(H);n({mcp_servers:ae})}catch(H){alert("Invalid JSON: "+H.message)}}async function me(H){const ae=k.find(he=>he.name===H);if(ae){L(he=>({...he,[H]:"testing"})),z(he=>({...he,[H]:""}));try{const he=await fu({connection_type:ae.connection_type,command:ae.command,args:ae.args,env:ae.env,url:ae.url,headers:ae.headers,timeout:ae.timeout});L(ye=>({...ye,[H]:he.success?"connected":"error"})),!he.success&&he.error&&z(ye=>({...ye,[H]:he.error||"Unknown error"}))}catch(he){L(ye=>({...ye,[H]:"error"})),z(ye=>({...ye,[H]:he.message}))}}}function q(H){const ae=u.find(ye=>ye.name===H);if(!ae)return;if(k.some(ye=>ye.name===H)){alert(`Server "${H}" is already configured`);return}const he={name:ae.name,description:ae.description||"",connection_type:ae.connection_type,command:ae.command,args:ae.args||[],env:ae.env||{},url:ae.url,headers:ae.headers||{},timeout:ae.timeout||30,tool_filter:ae.tool_filter||null,tool_name_prefix:ae.tool_name_prefix};n({mcp_servers:[...k,he]})}async function F(){for(const H of k)await me(H.name)}function K(){const H=W4();r({id:H,name:"new_tool",description:"",module_path:"tools.custom",code:q4,state_keys_used:[]}),b(H)}function ee(H,ae){ae.stopPropagation(),confirm("Delete this tool?")&&(s(H),a===H&&(e==null||e(null)))}function X(H){V&&(H.name!==void 0&&(H.name===""||H4(H.name)?W(null):W("Name can only contain letters, numbers, and underscores")),i(V.id,H))}function se(H){H!==void 0&&V&&(p(H),X({code:H}))}async function Y(){if(V){P(!0);try{const H=await Ay(t.id,V.name,V.description,V.state_keys_used);H.success&&H.code?(p(H.code),X({code:H.code})):(console.error("Failed to generate tool code:",H.error),alert("Failed to generate tool code: "+(H.error||"Unknown error")))}catch(H){console.error("Error generating tool code:",H),alert("Error generating tool code: "+H.message)}finally{P(!1)}}}const Z=S.useRef(null),re=S.useCallback((H,ae)=>{if(Z.current&&typeof Z.current=="function")try{Z.current()}catch{}try{const he=qv(ae,H,{language:"python",endpoint:"/api/code-completion",trigger:"onTyping"});typeof he=="function"?Z.current=he:Z.current=null}catch{Z.current=null}},[]);S.useEffect(()=>()=>{if(Z.current&&typeof Z.current=="function")try{Z.current()}catch{}},[]);function ve(H){H!==void 0&&(y(H),C(H!==JSON.stringify(J,null,2)))}function je(){if(J)try{const H=JSON.parse(x),ae=J.name,he=k.map(ye=>ye.name===ae?H:ye);n({mcp_servers:he}),m(H.name),C(!1)}catch(H){alert("Invalid JSON: "+H.message)}}async function ze(){D(!0),I(null);try{const H=JSON.parse(x),ae=await fu({connection_type:H.connection_type,command:H.command,args:H.args,env:H.env,url:H.url,headers:H.headers,timeout:H.timeout||30});if(I(ae),ae.success&&ae.tools.length>0){const he={...H,tool_filter:ae.tools.map(ye=>ye.name)};y(JSON.stringify(he,null,2)),C(!0)}}catch(H){I({success:!1,tools:[],error:H.message})}finally{D(!1)}}const ke={};return t.custom_tools.forEach(H=>{const ae=H.module_path||"tools";ke[ae]||(ke[ae]=[]),ke[ae].push(H)}),o.jsxs("div",{className:"tools-panel",children:[o.jsx("style",{children:`
        .tools-panel {
          display: flex;
          gap: 20px;
          height: calc(100vh - 180px);
...
def my_callback(tool: BaseTool, tool_args: Dict[str, Any], tool_context: ToolContext, result: Dict) -> Optional[Dict]:
    ...
    return None
`;default:return Jv("before_agent")}}function G4({onSelectCallback:e}){var N,D;const{project:t,updateProject:n,addCustomCallback:r,updateCustomCallback:i,removeCustomCallback:s}=ut(),[a,l]=S.useState(""),[c,u]=S.useState(null),[d,p]=S.useState(null),[f,h]=S.useState(!1),g=S.useRef(null);if(!t)return null;const v=t.custom_callbacks||[],w=v.find(E=>E.id===c);function m(E){u(E),e==null||e(E)}S.useEffect(()=>{w?(l(w.code),p(null)):l("")},[c,w]);function x(){const E=K4(),I="new_callback",R={id:E,name:I,description:"",module_path:`callbacks.${I}`,code:Jv("before_agent"),state_keys_used:[]};r(R),m(E)}function y(E,I){I.stopPropagation(),confirm("Delete this callback?")&&(s(E),c===E&&(e==null||e(null),u(null),l("")))}function j(){if(!c)return;const E=v.find(W=>W.id===c);if(!E)return;const I=E.name.trim();if(!I){alert("Please enter a name");return}if(!xm(I)){p("Name must contain only alphanumeric characters and underscores");return}if(v.find(W=>W.name===I&&W.id!==E.id)){p("A callback with this name already exists");return}i(E.id,{code:a,name:I,description:E.description,module_path:`callbacks.${I}`,state_keys_used:E.state_keys_used}),p(null)}function C(E,I){g.current=I;try{qv(I,{endpoint:"/api/code-completion",language:"python"})}catch(R){console.warn("Failed to register Monacopilot completion:",R)}}async function _(){if(w){h(!0);try{let E="before_agent";const I=w.name.toLowerCase(),R=w.description.toLowerCase();I.includes("after_agent")||R.includes("after agent")?E="after_agent":I.includes("before_model")||R.includes("before model")?E="before_model":I.includes("after_model")||R.includes("after model")?E="after_model":I.includes("before_tool")||R.includes("before tool")?E="before_tool":I.includes("after_tool")||R.includes("after tool")?E="after_tool":(I.includes("before_agent")||R.includes("before agent"))&&(E="before_agent");const W=await Py(t.id,w.name,w.description,E,w.state_keys_used);W.success&&W.code?(l(W.code),i(w.id,{code:W.code})):(console.error("Failed to generate callback code:",W.error),alert("Failed to generate callback code: "+(W.error||"Unknown error")))}catch(E){console.error("Error generating callback code:",E),alert("Error generating callback code: "+E.message)}finally{h(!1)}}}const P=((D=(N=t.app)==null?void 0:N.state_keys)==null?void 0:D.map(E=>E.name))||[];return o.jsxs("div",{className:"tools-panel",children:[o.jsx("style",{children:`
        .tools-panel {
          display: flex;
          height: 100%;
          background: var(--bg-primary);
...
`),isError:t.isError===!0}:{text:typeof t=="string"?t:JSON.stringify(t,null,2),isError:!1}}function Um(e,t){if(!t||!t.trim())return e;const n=t.trim();let r=e;try{r=JSON.parse(e)}catch{}if(n.startsWith("js:")){const i=n.slice(3).trim();try{const a=new Function("value","data",`return ${i}`)(e,r);return typeof a=="string"?a:JSON.stringify(a,null,2)}catch(s){return`[JS error: ${s}]`}}if(n.startsWith("."))try{const i=n.slice(1).split(".").filter(Boolean);let s=r;for(const a of i){const l=a.match(/^(\w+)?\[(\d+)\]$/);l?(l[1]&&(s=s[l[1]]),s=s[parseInt(l[2])]):s=s[a]}return s==null?"[No match]":typeof s=="string"?s:JSON.stringify(s,null,2)}catch(i){return`[Path error: ${i.message}]`}try{const s=new Function("value","data",`return ${n}`)(e,r);return typeof s=="string"?s:JSON.stringify(s,null,2)}catch(i){return`[Transform error: ${i.message}]`}}function y6({project:e,selectedEventIndex:t,sandboxMode:n}){var ue,me;const{watches:r,updateWatch:i,addWatch:s,removeWatch:a,runEvents:l}=ut(),[c,u]=S.useState(!1),[d,p]=S.useState(null),[f,h]=S.useState({}),[g,v]=S.useState(new Set),[w,m]=S.useState(""),[x,y]=S.useState(""),[j,C]=S.useState({}),[_,P]=S.useState(""),[N,D]=S.useState([]),[E,I]=S.useState(null),[R,W]=S.useState(null),[T,L]=S.useState(!1);S.useEffect(()=>{Rd().then(D).catch(console.error)},[]);const $=S.useMemo(()=>{const q=e.mcp_servers||[],F=new Set(q.map(ee=>ee.name)),K=N.filter(ee=>!F.has(ee.name));return[...q,...K]},[e.mcp_servers,N]),z=S.useCallback(async q=>{if(!(f[q]||g.has(q))){v(F=>new Set([...F,q]));try{const F=await Se(`/projects/${e.id}/mcp-servers/${encodeURIComponent(q)}/test-connection`,{method:"POST"});F.success&&h(K=>({...K,[q]:F.tools}))}catch(F){console.error("Failed to load tools:",F)}finally{v(F=>{const K=new Set(F);return K.delete(q),K})}}},[e.id,f,g]);S.useEffect(()=>{var ee;if(d)return;if(!w||!x){C({});return}const F=(f[w]||[]).find(X=>X.name===x);if(!((ee=F==null?void 0:F.parameters)!=null&&ee.properties)){C({});return}const K={};Object.entries(F.parameters.properties).forEach(([X,se])=>{se.type==="string"?K[X]=se.default||"":se.type==="number"||se.type==="integer"?K[X]=se.default||0:se.type==="boolean"?K[X]=se.default||!1:K[X]=se.default||null}),C(K)},[w,x,f,d]);const O=()=>{p(null),m(""),y(""),C({}),P(""),I(null),W(null),u(!0)},M=q=>{if(p(q.id),m(q.serverName),y(q.toolName),C({...q.args}),P(q.transform||""),q.result){const{text:F}=hc(q.result);I(F),W(null)}else I(null),W(null);f[q.serverName]||z(q.serverName),u(!0)},k=async()=>{var F;if(!w||!x)return;L(!0),W(null);const q=((F=e.app)==null?void 0:F.id)||`app_${e.id}`;try{const K=await Se(`/projects/${e.id}/run-mcp-tool`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({server_name:w,tool_name:x,arguments:j,sandbox_mode:n,app_id:n?q:void 0})}),{text:ee,isError:X}=hc(K);X?(W(ee),I(null)):(I(ee),W(null))}catch(K){W(String(K)),I(null)}finally{L(!1)}},V=S.useMemo(()=>E?!_||!_.trim()?E:Um(E,_):null,[E,_]),J=()=>{if(!(!w||!x)){if(d){i(d,{serverName:w,toolName:x,args:{...j},transform:_||void 0});const q=r.find(F=>F.id===d);q&&U({...q,serverName:w,toolName:x,args:j,transform:_||void 0,history:q.history||[]})}else{const q={id:`watch-${Date.now()}`,serverName:w,toolName:x,args:{...j},transform:_||void 0,history:[]};s(q),U(q)}u(!1)}},b=q=>{a(q)},U=S.useCallback(async(q,F)=>{var se;i(q.id,{isLoading:!0,error:void 0});const K=F??l.length-1,ee=Date.now(),X=((se=e.app)==null?void 0:se.id)||`app_${e.id}`;try{const Y=await Se(`/projects/${e.id}/run-mcp-tool`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({server_name:q.serverName,tool_name:q.toolName,arguments:q.args,sandbox_mode:n,app_id:n?X:void 0})}),Z={eventIndex:K,timestamp:ee,result:Y},re=[...q.history||[],Z];i(q.id,{result:Y,isLoading:!1,lastRun:ee,history:re})}catch(Y){const Z={eventIndex:K,timestamp:ee,error:String(Y)},re=[...q.history||[],Z];i(q.id,{error:String(Y),isLoading:!1,lastRun:ee,history:re})}},[e.id,(ue=e.app)==null?void 0:ue.id,i,l.length,n]),A=()=>{r.forEach(q=>U(q))},Q=S.useMemo(()=>!w||!x?null:(f[w]||[]).find(F=>F.name===x),[w,x,f]);return o.jsxs("div",{className:"tool-watch-panel",children:[o.jsxs("div",{className:"watch-header",children:[o.jsx(ki,{size:14}),o.jsx("span",{children:"Tool Watch"}),o.jsx("span",{className:"watch-auto-badge",title:"Watches auto-refresh on every event",children:"⚡ Auto"}),o.jsxs("div",{className:"watch-actions",children:[o.jsx("button",{className:"watch-btn",onClick:A,title:"Refresh all",children:o.jsx(rn,{size:12})}),o.jsx("button",{className:"watch-btn",onClick:O,title:"Add watch",children:o.jsx(Ke,{size:12})})]})]}),r.length===0?o.jsxs("div",{className:"watch-empty",children:[o.jsx(ki,{size:20,style:{opacity:.3}}),o.jsx("span",{children:"No watch expressions"}),o.jsxs("button",{className:"add-watch-btn",onClick:O,children:[o.jsx(Ke,{size:12})," Add Tool Watch"]})]}):o.jsx("div",{className:"watch-list",children:r.map(q=>{let F=q.result,K=q.error;if(t!==null&&q.history&&q.history.length>0){const Z=q.history.filter(re=>re.eventIndex<=t);if(Z.length>0){const re=Z[Z.length-1];F=re.result,K=re.error}else F=void 0,K=void 0}const{text:ee,isError:X}=F?hc(F):{text:"",isError:!1},se=F?Um(ee,q.transform):"",Y=K||X;return o.jsxs("div",{className:`watch-item ${Y?"error":""}`,children:[o.jsxs("div",{className:"watch-item-header",children:[o.jsxs("span",{className:"watch-expr",children:[o.jsx("span",{className:"watch-server",children:q.serverName}),o.jsx("span",{className:"watch-tool",children:q.toolName}),Object.keys(q.args).length>0&&o.jsxs("span",{className:"watch-args",children:["(",Object.entries(q.args).map(([Z,re])=>`${Z}=${JSON.stringify(re)}`).join(", "),")"]}),t!==null&&o.jsxs("span",{className:"watch-time-indicator",children:["@",t]})]}),o.jsxs("div",{className:"watch-item-actions",children:[o.jsx("button",{onClick:()=>M(q),title:"Edit watch",children:o.jsx(an,{size:10})}),o.jsx("button",{onClick:()=>U(q),title:"Refresh",children:q.isLoading?o.jsx(rn,{size:10,className:"spin"}):o.jsx(rn,{size:10})}),o.jsx("button",{onClick:()=>b(q.id),title:"Remove",children:o.jsx(Fe,{size:10})})]})]}),o.jsx("div",{className:"watch-result",children:q.isLoading?o.jsx("span",{className:"loading",children:"Loading..."}):K?o.jsx("span",{className:"error",children:K}):F?o.jsx("pre",{className:X?"error-text":"",children:se}):o.jsx("span",{className:"no-result",children:t!==null?"No data at this event":"Not yet run"})})]},q.id)})}),c&&o.jsx("div",{className:"watch-dialog-overlay",onClick:()=>u(!1),children:o.jsxs("div",{className:"watch-dialog",onClick:q=>q.stopPropagation(),children:[o.jsxs("div",{className:"dialog-header",children:[o.jsx("span",{children:d?"Edit Watch":"Add Tool Watch"}),o.jsx("button",{onClick:()=>u(!1),children:o.jsx(es,{size:14})})]}),o.jsxs("div",{className:"dialog-body",children:[o.jsxs("div",{className:"form-row",children:[o.jsx("label",{children:"MCP Server"}),o.jsxs("select",{value:w,onChange:q=>{m(q.target.value),d||y(""),q.target.value&&z(q.target.value)},children:[o.jsx("option",{value:"",children:"Select server..."}),$.map(q=>o.jsx("option",{value:q.name,children:q.name},q.name))]})]}),o.jsxs("div",{className:"form-row",children:[o.jsx("label",{children:"Tool"}),o.jsxs("select",{value:x,onChange:q=>y(q.target.value),disabled:!w||g.has(w),children:[o.jsx("option",{value:"",children:g.has(w)?"Loading tools...":"Select tool..."}),(f[w]||[]).map(q=>o.jsx("option",{value:q.name,children:q.name},q.name))]})]}),(Q==null?void 0:Q.description)&&o.jsx("div",{className:"tool-desc",children:Q.description}),((me=Q==null?void 0:Q.parameters)==null?void 0:me.properties)&&Object.keys(Q.parameters.properties).length>0&&o.jsxs("div",{className:"tool-args",children:[o.jsx("label",{children:"Arguments"}),Object.entries(Q.parameters.properties).map(([q,F])=>{var K,ee;return o.jsxs("div",{className:"arg-row",children:[o.jsxs("span",{className:"arg-name",children:[q,((K=Q.parameters.required)==null?void 0:K.includes(q))&&o.jsx("span",{className:"required",children:"*"})]}),o.jsx("input",{type:F.type==="number"||F.type==="integer"?"number":"text",value:typeof j[q]=="object"?JSON.stringify(j[q]):j[q]??"",onChange:X=>C(se=>({...se,[q]:X.target.value})),placeholder:((ee=F.description)==null?void 0:ee.slice(0,40))||q})]},q)})]}),w&&x&&o.jsxs("div",{className:"test-section",children:[o.jsxs("div",{className:"test-header",children:[o.jsx("label",{children:"Test & Preview"}),o.jsxs("button",{className:"test-btn",onClick:k,disabled:T,children:[T?o.jsx(rn,{size:12,className:"spin"}):o.jsx(pr,{size:12}),T?"Running...":"Test Run"]})]}),R&&o.jsxs("div",{className:"test-result error",children:[o.jsx("span",{className:"test-label",children:"Error:"}),o.jsx("pre",{children:R})]}),E&&o.jsxs("div",{className:"test-result",children:[o.jsx("span",{className:"test-label",children:"Raw Result:"}),o.jsx("pre",{children:E})]})]}),o.jsxs("div",{className:"form-row transform-row",children:[o.jsx("label",{children:"Transform (optional)"}),o.jsx("input",{type:"text",value:_,onChange:q=>P(q.target.value),placeholder:"e.g., .items[0].name or .content[].text"}),o.jsxs("div",{className:"transform-hints",children:[o.jsx("span",{className:"hint-title",children:"Path:"}),o.jsx("code",{onClick:()=>P(".items[0].name"),children:".items[0].name"}),o.jsx("code",{onClick:()=>P(".content[0].text"),children:".content[0].text"}),o.jsx("code",{onClick:()=>P(".result.data"),children:".result.data"}),o.jsx("span",{className:"hint-title",children:"JS:"}),o.jsx("code",{onClick:()=>P("js:value.split('\\n')[0]"),children:"js:value.split('\\n')[0]"}),o.jsx("code",{onClick:()=>P("js:data.items?.length"),children:"js:data.items?.length"})]})]}),E&&_&&o.jsxs("div",{className:"transform-preview",children:[o.jsx("span",{className:"test-label",children:"Transform Preview:"}),o.jsx("pre",{className:V!=null&&V.startsWith("[Transform error")?"error":"",children:V})]})]}),o.jsxs("div",{className:"dialog-footer",children:[o.jsx("button",{className:"cancel-btn",onClick:()=>u(!1),children:"Cancel"}),o.jsx("button",{className:"add-btn",onClick:J,disabled:!w||!x,children:d?"Save Changes":"Add Watch"})]})]})})]})}function v6(){var jp,_p;const{project:e,updateProject:t,isRunning:n,setIsRunning:r,runEvents:i,addRunEvent:s,clearRunEvents:a,clearWatchHistories:l,runAgentId:c,setRunAgentId:u,watches:d,updateWatch:p,currentSessionId:f,setCurrentSessionId:h}=ut(),[g,v]=S.useState(""),[w,m]=S.useState(null),[x,y]=S.useState(null),[j,C]=S.useState(null),[_,P]=S.useState(""),[N,D]=S.useState(new Set(["agent_start","agent_end","tool_call","tool_result","model_call","model_response","state_change","callback_start","callback_end","callback_error"])),[E,I]=S.useState(()=>{const B=localStorage.getItem("sandboxMode");return B!==null?B==="true":!0});S.useEffect(()=>{localStorage.setItem("sandboxMode",String(E))},[E]);const[R,W]=S.useState(null),[T,L]=S.useState(!1),[$,z]=S.useState({}),[O,M]=S.useState(!1),[k,V]=S.useState("agent"),J=S.useRef(null),[b,U]=S.useState(!0),[A,Q]=S.useState(!0),[ue,me]=S.useState(!1),[q,F]=S.useState(360),[K,ee]=S.useState(!1),[X,se]=S.useState(!1),[Y,Z]=S.useState([]),re=S.useRef(null);S.useEffect(()=>{const B=localStorage.getItem("promptHistory");if(B)try{const oe=JSON.parse(B),pe=Object.entries(oe).map(([ge,ce])=>({prompt:ge,count:ce})).sort((ge,ce)=>ce.count-ge.count);Z(pe)}catch(oe){console.error("Failed to parse prompt history:",oe)}},[]);const ve=S.useCallback(B=>{const oe=B.trim();if(!oe)return;const pe=localStorage.getItem("promptHistory"),ge=pe?JSON.parse(pe):{};ge[oe]=(ge[oe]||0)+1,localStorage.setItem("promptHistory",JSON.stringify(ge));const ce=Object.entries(ge).map(([Te,Pe])=>({prompt:Te,count:Pe})).sort((Te,Pe)=>Pe.count-Te.count);Z(ce)},[]),je=S.useMemo(()=>{const B=g.toLowerCase().trim();return Y.filter(oe=>!B||oe.prompt.toLowerCase().includes(B)).slice(0,10)},[Y,g]),[ze,ke]=S.useState([60,80,100,80,1]),[H,ae]=S.useState(null),he=S.useRef(0),ye=S.useRef(0),[G,te]=S.useState([]),[xe,le]=S.useState(null),[_e,Ze]=S.useState(!1),un=S.useRef(0),Ut=S.useCallback(async(B,oe)=>{var Te;if(!e)return;p(B.id,{isLoading:!0,error:void 0});const pe=oe??i.length-1,ge=Date.now(),ce=((Te=e.app)==null?void 0:Te.id)||`app_${e.id}`;try{const Pe=await Se(`/projects/${e.id}/run-mcp-tool`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({server_name:B.serverName,tool_name:B.toolName,arguments:B.args,sandbox_mode:E,app_id:E?ce:void 0})}),Cn={eventIndex:pe,timestamp:ge,result:Pe},pn=[...B.history||[],Cn];p(B.id,{result:Pe,isLoading:!1,lastRun:ge,history:pn})}catch(Pe){const Cn={eventIndex:pe,timestamp:ge,error:String(Pe)},pn=[...B.history||[],Cn];p(B.id,{error:String(Pe),isLoading:!1,lastRun:ge,history:pn})}},[e==null?void 0:e.id,(jp=e==null?void 0:e.app)==null?void 0:jp.id,p,i.length,E]);S.useEffect(()=>{if(i.length>un.current&&d.length>0){const B=i.length-1;d.forEach(oe=>{oe.isLoading||Ut(oe,B)})}un.current=i.length},[i.length,d,Ut]),S.useEffect(()=>{c!==null&&(Un(c),u(null))},[c,u]);const[Yt,Un]=S.useState(null),et=S.useRef(null),dn=S.useRef(null);S.useEffect(()=>{if(!K)return;const B=pe=>{if(!dn.current)return;const ce=dn.current.getBoundingClientRect().right-pe.clientX;F(Math.min(600,Math.max(200,ce)))},oe=()=>{ee(!1)};return document.addEventListener("mousemove",B),document.addEventListener("mouseup",oe),()=>{document.removeEventListener("mousemove",B),document.removeEventListener("mouseup",oe)}},[K]),S.useEffect(()=>{if(H===null)return;const B=pe=>{const ge=pe.clientX-he.current,ce=Math.max(40,ye.current+ge);ke(Te=>{const Pe=[...Te];return Pe[H]=ce,Pe})},oe=()=>{ae(null)};return document.addEventListener("mousemove",B),document.addEventListener("mouseup",oe),document.body.style.cursor="col-resize",document.body.style.userSelect="none",()=>{document.removeEventListener("mousemove",B),document.removeEventListener("mouseup",oe),document.body.style.cursor="",document.body.style.userSelect=""}},[H]);const yt=(B,oe)=>{oe.preventDefault(),he.current=oe.clientX,ye.current=ze[B],ae(B)},yp=ze.map((B,oe)=>oe===ze.length-1?`minmax(${B}px, 1fr)`:`${B}px`).join(" "),k1=S.useMemo(()=>i.length===0?{min:0,max:0}:{min:i[0].timestamp,max:i[i.length-1].timestamp},[i]),zt=S.useMemo(()=>i.filter((B,oe)=>{var pe,ge,ce;if(j&&(B.timestamp<j[0]||B.timestamp>j[1])||N.size>0&&!N.has(B.event_type))return!1;if(b&&B.event_type==="model_response"){const Te=((ge=(pe=B.data)==null?void 0:pe.response_content)==null?void 0:ge.parts)||((ce=B.data)==null?void 0:ce.parts)||[],Pe=Te.some(pn=>pn.type==="function_call"),Cn=Te.some(pn=>pn.type==="text");if(!Pe&&!Cn)return!1}return!(_&&!JSON.stringify(B).toLowerCase().includes(_.toLowerCase()))}),[i,j,N,_,b]),as=S.useMemo(()=>{var ge;let B=0,oe=0;const pe=x!==null?x+1:i.length;for(let ce=0;ce<pe;ce++){const Te=i[ce];Te.event_type==="model_response"&&((ge=Te.data)!=null&&ge.token_counts)&&(B+=Te.data.token_counts.input||0,oe+=Te.data.token_counts.output||0)}return{input:B,output:oe,total:B+oe}},[i,x]),vp=x!==null?i[x]:null;S.useEffect(()=>{if(!e){te([]);return}(async()=>{Ze(!0);try{const oe=await pu(e.id);te(oe)}catch(oe){console.error("Failed to load sessions:",oe),te([])}finally{Ze(!1)}})()},[e]);const ml=S.useCallback(async B=>{if(!e){le(null);return}if(!B){a(),l(),h(null),le(null),y(null),C(null);return}try{const oe=await Sy(e.id,B);a(),l(),h(oe.id),le(B),y(null),C(null);for(const pe of oe.events)s(pe)}catch(oe){alert(`Failed to load session: ${oe.message||"Unknown error"}`)}},[e,a,l,h,s]);S.useEffect(()=>{if(!e||G.length===0||_e)return;const oe=new URLSearchParams(window.location.search).get("session");if(oe)if(G.some(ge=>ge.id===oe)){ml(oe);const ge=window.location.pathname;window.history.replaceState({},"",ge)}else console.warn(`Session ${oe} not found in available sessions`)},[e,G,_e,ml]),S.useEffect(()=>{n&&et.current&&(et.current.scrollTop=et.current.scrollHeight)},[i.length,n]);const Pi=S.useCallback(B=>{const oe=B??g;if(!e||!oe.trim()||n)return;ve(oe),se(!1),v(oe),w&&(w.close(),m(null)),f||(a(),l(),le(null)),r(!0),y(null),C(null);const pe=zy(e.id);m(pe),pe.onopen=()=>{pe.send(JSON.stringify({message:oe,agent_id:Yt||void 0,session_id:f||void 0,sandbox_mode:E}))},pe.onmessage=ge=>{var Te;const ce=JSON.parse(ge.data);if(ce.event_type==="agent_start"&&((Te=ce.data)!=null&&Te.session_id)){const Pe=ce.data.session_id;ce.data.session_reused,h(Pe),Pe&&G.some(Cn=>Cn.id===Pe)&&le(Pe)}else if(ce.type==="session_started")h(ce.session_id),ce.session_id&&G.some(Pe=>Pe.id===ce.session_id)&&le(ce.session_id);else if(ce.type==="sandbox_starting")s({timestamp:Date.now()/1e3,event_type:"agent_start",agent_name:"sandbox",data:{message:"Starting Docker sandbox..."}});else if(ce.type==="sandbox_started")s({timestamp:Date.now()/1e3,event_type:"agent_start",agent_name:"sandbox",data:{message:`Sandbox started (ID: ${ce.sandbox_id})`}});else if(ce.type==="sandbox_response")s({timestamp:Date.now()/1e3,event_type:"model_response",agent_name:"sandbox",data:ce.data});else if(ce.event_type==="approval_required"||ce.type==="network_request"&&ce.event_type==="approval_required"){const Pe={id:ce.id,method:ce.method||"GET",url:ce.url,host:ce.host,source:ce.source||"agent",headers:ce.headers||{},timeout:ce.timeout||30};W(Pe),s({timestamp:Date.now()/1e3,event_type:"callback_start",agent_name:"sandbox",data:{callback_name:"network_approval",callback_type:"approval",message:`⚠️ Network request to ${ce.host} requires approval`,host:ce.host,url:ce.url}})}else ce.type==="completed"?(r(!1),pe.close()):ce.type==="error"?(r(!1),s({timestamp:Date.now()/1e3,event_type:"agent_end",agent_name:"system",data:{error:ce.error}})):s(ce)},pe.onerror=()=>{r(!1),s({timestamp:Date.now()/1e3,event_type:"agent_end",agent_name:"system",data:{error:"WebSocket connection error"}})},pe.onclose=()=>{r(!1)}},[e,g,n,w,a,r,s,Yt,f,E,ve]),j1=S.useCallback(()=>{w==null||w.close(),r(!1)},[w,r]),_1=S.useCallback(async(B,oe,pe)=>{var pn,Sp,Cp,Np,Ep,zp,Tp,Ap,Pp,Lp,Mp,Rp,Ip,Op,$p,Dp,Fp,Bp,Up,Vp,Wp,Hp,qp,Jp;if(!R||!e)return;const ge=((pn=e.app)==null?void 0:pn.id)||e.id,ce=B?"allow_pattern":"allow_once",Te=B||R.host,Pe=oe||"exact",Cn=pe?`/sandbox/${ge}/approval?project_id=${e.id}`:`/sandbox/${ge}/approval`;try{if(await Se(Cn,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({request_id:R.id,action:ce,pattern:Te,pattern_type:Pe,persist:pe||!1})}),pe&&ce==="allow_pattern"){const xl=((Np=(Cp=(Sp=e.app)==null?void 0:Sp.sandbox)==null?void 0:Cp.allowlist)==null?void 0:Np.user)||[],I1={id:`pattern_${Date.now().toString(36)}`,pattern:Te,pattern_type:Pe,source:"approved",added_at:new Date().toISOString()};t({app:{...e.app,sandbox:{...(Ep=e.app)==null?void 0:Ep.sandbox,enabled:((Tp=(zp=e.app)==null?void 0:zp.sandbox)==null?void 0:Tp.enabled)??!1,allowlist:{auto:((Lp=(Pp=(Ap=e.app)==null?void 0:Ap.sandbox)==null?void 0:Pp.allowlist)==null?void 0:Lp.auto)||[],user:[...xl,I1]},unknown_action:((Rp=(Mp=e.app)==null?void 0:Mp.sandbox)==null?void 0:Rp.unknown_action)??"ask",approval_timeout:((Op=(Ip=e.app)==null?void 0:Ip.sandbox)==null?void 0:Op.approval_timeout)??30,agent_memory_limit_mb:((Dp=($p=e.app)==null?void 0:$p.sandbox)==null?void 0:Dp.agent_memory_limit_mb)??512,agent_cpu_limit:((Bp=(Fp=e.app)==null?void 0:Fp.sandbox)==null?void 0:Bp.agent_cpu_limit)??1,mcp_memory_limit_mb:((Vp=(Up=e.app)==null?void 0:Up.sandbox)==null?void 0:Vp.mcp_memory_limit_mb)??256,mcp_cpu_limit:((Hp=(Wp=e.app)==null?void 0:Wp.sandbox)==null?void 0:Hp.mcp_cpu_limit)??.5,run_timeout:((Jp=(qp=e.app)==null?void 0:qp.sandbox)==null?void 0:Jp.run_timeout)??300}}})}s({timestamp:Date.now()/1e3,event_type:"callback_end",agent_name:"sandbox",data:{callback_name:"network_approval",callback_type:"approval",message:`✅ Approved: ${Te}`,pattern:Te,action:ce}})}catch(xl){console.error("Failed to approve:",xl)}W(null)},[R,e,s,t]),S1=S.useCallback(async()=>{var oe;if(!R||!e)return;const B=((oe=e.app)==null?void 0:oe.id)||e.id;try{await Se(`/sandbox/${B}/approval`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({request_id:R.id,action:"deny"})}),s({timestamp:Date.now()/1e3,event_type:"callback_end",agent_name:"sandbox",data:{callback_name:"network_approval",callback_type:"approval",message:`❌ Denied: ${R.host}`,host:R.host,action:"deny"}})}catch(pe){console.error("Failed to deny:",pe)}W(null)},[R,e,s]),Li=S.useCallback(async(B=!0)=>{var pe;if(!e)return;const oe=((pe=e.app)==null?void 0:pe.id)||`app_${e.id}`;B&&M(!0);try{const[ge,ce]=await Promise.all([Se(`/sandbox/${oe}/logs?container=agent&tail=500`).catch(()=>null),Se(`/sandbox/${oe}/logs?container=gateway&tail=500`).catch(()=>null)]);z({agent:(ge==null?void 0:ge.logs)||(ge==null?void 0:ge.error)||"No logs available",gateway:(ce==null?void 0:ce.logs)||(ce==null?void 0:ce.error)||"No logs available"})}catch(ge){console.error("Failed to fetch logs:",ge),z({agent:`Error fetching logs: ${ge}`,gateway:`Error fetching logs: ${ge}`})}finally{B&&M(!1)}},[e]),C1=S.useCallback(()=>{L(!0),Li()},[Li]);S.useEffect(()=>{T&&J.current&&!O&&setTimeout(()=>{J.current&&(J.current.scrollTop=J.current.scrollHeight)},50)},[T,k,$,O]),S.useEffect(()=>{if(!T)return;const B=setInterval(()=>{Li(!1)},3e3);return()=>clearInterval(B)},[T,Li]),S.useEffect(()=>{const B=oe=>{if((oe.metaKey||oe.ctrlKey)&&oe.key==="Enter"){oe.preventDefault(),Pi();return}if(oe.key==="ArrowDown"||oe.key==="ArrowUp"){if(oe.target instanceof HTMLInputElement||oe.target instanceof HTMLTextAreaElement||(oe.preventDefault(),zt.length===0))return;if(oe.key==="ArrowDown")if(x===null){const pe=i.indexOf(zt[0]);y(pe)}else{const pe=zt.findIndex(ge=>i.indexOf(ge)===x);if(pe<zt.length-1){const ge=i.indexOf(zt[pe+1]);y(ge)}}else if(oe.key==="ArrowUp")if(x===null){const pe=i.indexOf(zt[zt.length-1]);y(pe)}else{const pe=zt.findIndex(ge=>i.indexOf(ge)===x);if(pe>0){const ge=i.indexOf(zt[pe-1]);y(ge)}}}};return window.addEventListener("keydown",B),()=>window.removeEventListener("keydown",B)},[Pi,zt,x,i]);const N1=S.useCallback(()=>{var ce;if(i.length===0)return;const B={version:1,exportedAt:new Date().toISOString(),projectId:e==null?void 0:e.id,projectName:e==null?void 0:e.name,agentId:Yt||((ce=e==null?void 0:e.app)==null?void 0:ce.root_agent_id),events:i},oe=new Blob([JSON.stringify(B,null,2)],{type:"application/json"}),pe=URL.createObjectURL(oe),ge=document.createElement("a");ge.href=pe,ge.download=`run-${(e==null?void 0:e.name)||"export"}-${new Date().toISOString().slice(0,19).replace(/:/g,"-")}.json`,document.body.appendChild(ge),ge.click(),document.body.removeChild(ge),URL.revokeObjectURL(pe)},[i,e,Yt]),E1=S.useCallback(async()=>{if(!f||!e){alert("No active session to save");return}try{const B=await _y(f);if(B.success){alert(B.message||"Session saved to memory successfully");try{const oe=await pu(e.id);te(oe)}catch{}}else alert(`Failed to save to memory: ${B.error||"Unknown error"}`)}catch(B){alert(`Error saving to memory: ${B.message||"Unknown error"}`)}},[f,e]),[z1,ls]=S.useState(!1),[T1,A1]=S.useState([]),[Mi,bp]=S.useState(""),[gl,P1]=S.useState("Test Case from Session"),[wp,kp]=S.useState(!1),L1=S.useCallback(async()=>{if(!f||!e){alert("No active session to create test case from");return}try{const B=await Se(`/projects/${e.id}/eval-sets`);if(A1(B.eval_sets||[]),!B.eval_sets||B.eval_sets.length===0){confirm(`No evaluation sets found. Would you like to create one first?
...
Go to the Evals tab to view and edit the test case.`)}catch(B){alert(`Error creating test case: ${B.message||"Unknown error"}`)}finally{kp(!1)}},[f,e,Mi,gl]),R1=S.useCallback(()=>{const B=document.createElement("input");B.type="file",B.accept=".json",B.onchange=async oe=>{var ge;const pe=(ge=oe.target.files)==null?void 0:ge[0];if(pe)try{const ce=await pe.text(),Te=JSON.parse(ce);if(!Te.events||!Array.isArray(Te.events)){alert("Invalid run file: missing events array");return}a(),l(),y(null),C(null),Te.events.forEach(Pe=>{s(Pe)})}catch(ce){alert(`Failed to load run file: ${ce}`)}},B.click()},[a,l,s]);return S.useEffect(()=>{if(x!==null){const B=document.querySelector(".event-row.selected");B==null||B.scrollIntoView({behavior:"smooth",block:"nearest"})}},[x]),e?o.jsxs("div",{className:`run-panel ${K?"resizing":""}`,children:[o.jsx("style",{children:`
        .run-panel {
          display: flex;
          flex-direction: column;
          width: 100%;
      ...
      `}),o.jsxs("div",{className:"skillset-list",children:[o.jsxs("div",{className:"skillset-list-header",children:[o.jsx("h3",{children:"SkillSets"}),o.jsx("button",{className:"btn-icon",onClick:R,title:"Add SkillSet",children:o.jsx(Ke,{size:16})})]}),P.length===0?o.jsxs("div",{className:"empty-state",style:{padding:"40px 0"},children:[o.jsx(Rn,{size:32}),o.jsx("span",{children:"No SkillSets"}),o.jsxs("button",{className:"btn-primary",onClick:R,children:[o.jsx(Ke,{size:14})," Create SkillSet"]})]}):P.map(M=>o.jsxs("div",{className:`skillset-item ${n===M.id?"selected":""}`,onClick:()=>r(M.id),children:[o.jsx(Rn,{size:16,style:{color:"var(--accent)",flexShrink:0}}),o.jsxs("div",{className:"skillset-item-info",children:[o.jsx("div",{className:"skillset-item-name",children:M.name}),o.jsxs("div",{className:"skillset-item-count",children:[M.entry_count||0," entries"]})]}),o.jsx("button",{className:"skillset-item-delete",onClick:k=>{k.stopPropagation(),W(M.id)},children:o.jsx(Fe,{size:14})})]},M.id))]}),N?o.jsxs("div",{className:"skillset-detail",children:[o.jsxs("div",{className:"skillset-header",children:[o.jsxs("div",{className:"skillset-header-info",children:[o.jsx("input",{className:"skillset-name-input",value:N.name,onChange:M=>I(N.id,{name:M.target.value}),placeholder:"SkillSet Name"}),o.jsx("textarea",{className:"skillset-desc-input",value:N.description,onChange:M=>I(N.id,{description:M.target.value}),placeholder:"Description (optional)",rows:1}),o.jsxs("div",{className:"skillset-model",children:[o.jsx("label",{style:{fontSize:"12px",color:"var(--text-secondary)",marginRight:"8px"},children:"Embedding Model:"}),o.jsxs("select",{style:{flex:1,padding:"4px 8px",fontSize:"12px",background:"var(--bg-secondary)",border:"1px solid var(--border)",borderRadius:"4px",color:"var(--text-primary)"},value:N.embedding_model||"text-embedding-004",onChange:M=>I(N.id,{embedding_model:M.target.value}),children:[o.jsxs("optgroup",{label:"Google Gemini",children:[o.jsx("option",{value:"text-embedding-004",children:"text-embedding-004 (768d)"}),o.jsx("option",{value:"text-embedding-005",children:"text-embedding-005"})]}),o.jsxs("optgroup",{label:"OpenAI",children:[o.jsx("option",{value:"text-embedding-3-small",children:"text-embedding-3-small (1536d)"}),o.jsx("option",{value:"text-embedding-3-large",children:"text-embedding-3-large (3072d)"})]}),o.jsxs("optgroup",{label:"Cohere",children:[o.jsx("option",{value:"embed-english-v3.0",children:"embed-english-v3.0 (1024d)"}),o.jsx("option",{value:"embed-multilingual-v3.0",children:"embed-multilingual-v3.0 (1024d)"})]})]})]}),o.jsxs("div",{className:"skillset-stats",children:[o.jsxs("span",{className:"skillset-stat",children:[o.jsx("strong",{children:(i==null?void 0:i.entry_count)||0})," entries"]}),o.jsxs("span",{className:"skillset-stat",children:[o.jsx("strong",{children:Object.keys((i==null?void 0:i.sources)||{}).length})," sources"]}),j===!1&&o.jsx("span",{className:"skillset-stat",style:{color:"var(--warning)"},children:"⚠ No embeddings"})]})]}),o.jsx("button",{className:"btn-icon",onClick:D,title:"Refresh",children:o.jsx(rn,{size:16})})]}),x&&o.jsxs("div",{className:"error-banner",children:[x,o.jsx("button",{onClick:()=>y(null),children:o.jsx(es,{size:14})})]}),o.jsxs("div",{className:"search-section",children:[o.jsx("div",{className:"search-input-wrapper",children:o.jsx("input",{className:"search-input",value:a,onChange:M=>l(M.target.value),onKeyDown:M=>M.key==="Enter"&&T(),placeholder:"Search this SkillSet..."})}),o.jsxs("button",{className:"btn-primary",onClick:T,disabled:d||!a.trim(),children:[o.jsx(Wy,{size:14}),d?"Searching...":"Search"]})]}),o.jsxs("div",{className:"search-results",children:[c.length===0&&!d&&a&&o.jsx("div",{className:"empty-state",children:o.jsx("span",{children:"No results found"})}),c.map(M=>o.jsxs("div",{className:"search-result",style:{background:O(M.score)},children:[o.jsxs("span",{className:"search-result-score",children:[(M.score*100).toFixed(0),"%"]}),o.jsx("div",{className:"search-result-text",children:M.text}),o.jsx("div",{className:"search-result-source",children:M.source_name})]},M.id))]}),o.jsxs("div",{className:"add-sources-section",children:[o.jsxs("div",{className:"add-sources-header",onClick:()=>h(!f),children:[f?o.jsx(Pt,{size:16}):o.jsx(bt,{size:16}),o.jsx("h4",{children:"Add Sources"})]}),f&&o.jsxs("div",{className:"add-sources-content",children:[o.jsxs("div",{className:"source-row",children:[o.jsx($d,{size:16,style:{color:"var(--text-tertiary)"}}),o.jsx("input",{className:"source-input",value:g,onChange:M=>v(M.target.value),onKeyDown:M=>M.key==="Enter"&&L(),placeholder:"Enter URL (e.g., llms.txt file)"}),o.jsxs("button",{className:"btn-primary",onClick:L,disabled:w||!g.trim(),children:[o.jsx(Wk,{size:14}),w?"Loading...":"Add"]})]}),o.jsxs("div",{className:"source-row",children:[o.jsx(Bk,{size:16,style:{color:"var(--text-tertiary)"}}),o.jsx("input",{ref:_,type:"file",accept:".txt,.md,.json,.csv,.html",onChange:$}),o.jsxs("button",{className:"btn-primary",onClick:()=>{var M;return(M=_.current)==null?void 0:M.click()},children:[o.jsx(ol,{size:14}),"Upload File"]}),o.jsx("span",{style:{fontSize:"12px",color:"var(--text-tertiary)"},children:".txt, .md, .json, .csv"})]}),((i==null?void 0:i.entry_count)||0)>0&&o.jsx("div",{className:"source-row",style:{marginTop:"8px"},children:o.jsxs("button",{className:"clear-button",onClick:z,children:[o.jsx(Fe,{size:12}),"Clear All Entries (",(i==null?void 0:i.entry_count)||0,")"]})})]})]})]}):P.length>0?o.jsx("div",{className:"skillset-detail",children:o.jsxs("div",{className:"empty-state",children:[o.jsx(Rn,{size:48}),o.jsx("span",{children:"Select a SkillSet"})]})}):null]}):null}const vn={tool_trajectory_avg_score:{name:"Tool Trajectory",description:"Did the agent call the right tools in the expected order?",requiresJudge:!1,scale:[0,1]},response_match_score:{name:"Response Match (ROUGE-1)",description:"Does the response contain expected text? (fuzzy word matching)",requiresJudge:!1,scale:[0,1]},response_evaluation_score:{name:"Response Evaluation (LLM)",description:"LLM-judged semantic match of final response",requiresJudge:!0,scale:[1,5]},final_response_match_v2:{name:"Response Quality v2 (LLM)",description:"Enhanced LLM-judged response quality check",requiresJudge:!0,scale:[0,1]},safety_v1:{name:"Safety",description:"Is the response safe and harmless? (Vertex AI)",requiresJudge:!0,scale:[0,1]},hallucinations_v1:{name:"Hallucination Detection",description:"Are all claims supported by context? No false information?",requiresJudge:!0,scale:[0,1]},rubric_based_final_response_quality_v1:{name:"Rubric: Response Quality",description:"Custom rubric-based quality assessment of responses",requiresJudge:!0,scale:[0,1]},rubric_based_tool_use_quality_v1:{name:"Rubric: Tool Use Quality",description:"Custom rubric-based assessment of tool usage",requiresJudge:!0,scale:[0,1]}},Wo=(e,t,n)=>{if(t==null)return{value:"-",comparison:""};const r=vn[e],i=(r==null?void 0:r.scale)||[0,1];if(i[0]===1&&i[1]===5){const s=n??3.5;return{value:t.toFixed(1),comparison:`${s.toFixed(1)} / ${i[1].toFixed(1)}`}}else{const s=n??.7;return{value:`${Math.round(t*100)}%`,comparison:`${Math.round(s*100)}% min`}}},j6={metrics:[{metric:"tool_trajectory_avg_score",enabled:!0,criterion:{threshold:1}},{metric:"response_match_score",enabled:!0,criterion:{threshold:.7}}],default_trajectory_match_type:"in_order",num_runs:1};function w1(){return`${Date.now().toString(36)}_${Math.random().toString(36).slice(2,6)}`}function _6(){const{project:e}=ut(),[t,n]=S.useState([]),[r,i]=S.useState(null),[s,a]=S.useState(null),[l,c]=S.useState(new Set),[u,d]=S.useState(new Map),[p,f]=S.useState(new Map),[h,g]=S.useState(new Set),[v,w]=S.useState(!1),[m,x]=S.useState(null),[y,j]=S.useState([]),[C,_]=S.useState(null),P=async()=>{if(e)try{const F=await qe.get(`/projects/${e.id}/eval-history`);j(F.runs||[])}catch(F){console.warn("Failed to load eval history:",F)}},N=async(F,K=!0)=>{if(e)try{const X=(await qe.get(`/projects/${e.id}/eval-history/${F}`)).run;if(_(X),X!=null&&X.case_results){const se=new Map;for(const Y of X.case_results)se.set(Y.eval_case_id,Y);d(se)}if((X==null?void 0:X.eval_set_id)==="batch")c(new Set(t.map(se=>se.id))),i(null);else if(X!=null&&X.eval_set_id){const se=new Map;se.set(X.eval_set_id,X),f(se),i(X.eval_set_id),c(Y=>new Set([...Y,X.eval_set_id]))}a(null),K&&window.history.pushState({run:F},"",`?run=${F}`)}catch(ee){console.warn("Failed to load history run:",ee)}},D=(F,K=!0)=>{i(F),a(null),_(null),K&&F?window.history.pushState({set:F},"",`?set=${F}`):K&&window.history.pushState({},"",window.location.pathname)},E=(F,K,ee=!0)=>{i(F),a(K),_(null),ee&&K?window.history.pushState({set:F,case:K},"",`?set=${F}&case=${K}`):ee&&F&&window.history.pushState({set:F},"",`?set=${F}`)},I=()=>{_(null),d(new Map),f(new Map),window.history.pushState({},"",window.location.pathname)},R=async F=>{if(e)try{await qe.delete(`/projects/${e.id}/eval-history/${F}`),j(K=>K.filter(ee=>ee.id!==F)),(C==null?void 0:C.id)===F&&_(null)}catch(K){console.warn("Failed to delete history run:",K)}};S.useEffect(()=>{e!=null&&e.id&&(W(),P())},[e==null?void 0:e.id]),S.useEffect(()=>{const F=()=>{g(new Set(t.map(ee=>ee.id)))},K=()=>{g(new Set),P()};return window.addEventListener("eval-tests-started",F),window.addEventListener("eval-tests-completed",K),()=>{window.removeEventListener("eval-tests-started",F),window.removeEventListener("eval-tests-completed",K)}},[t]),S.useEffect(()=>{if(!(e!=null&&e.id)||v)return;const F=()=>{const ee=new URLSearchParams(window.location.search),X=ee.get("set"),se=ee.get("case"),Y=ee.get("run");if(Y){N(Y,!1);return}if(X)i(X),a(se),_(null),c(Z=>new Set([...Z,X]));else{if(!r&&!s&&!C)return;i(null),a(null),_(null)}};F();const K=()=>{F()};return window.addEventListener("popstate",K),()=>window.removeEventListener("popstate",K)},[e==null?void 0:e.id,v,t.length]);const W=async()=>{var F,K;if(e!=null&&e.id){w(!0),x(null);try{const ee=await qe.get(`/projects/${e.id}/eval-sets`);if(n(ee.eval_sets||[]),((F=ee.eval_sets)==null?void 0:F.length)>0){const X=new URLSearchParams(window.location.search),se=X.get("set"),Y=X.get("case"),Z=se||(Y?(K=ee.eval_sets.find(re=>re.eval_cases.some(ve=>ve.id===Y)))==null?void 0:K.id:null)||ee.eval_sets[0].id;c(new Set([Z]))}}catch(ee){x(ee.message||"Failed to load eval sets")}finally{w(!1)}}},T=t.find(F=>F.id===r),L=T==null?void 0:T.eval_cases.find(F=>F.id===s),$=async()=>{if(e!=null&&e.id)try{const F=await qe.post(`/projects/${e.id}/eval-sets`,{name:"New Eval Set",description:"",eval_config:j6});n(K=>[...K,F.eval_set]),i(F.eval_set.id),c(K=>new Set([...K,F.eval_set.id]))}catch(F){x(F.message||"Failed to create eval set")}},z=async F=>{if(e!=null&&e.id)try{const K=await qe.post(`/projects/${e.id}/eval-sets/${F}/cases`,{name:"New Test Case",description:"",invocations:[{id:w1(),user_message:"",expected_response:"",expected_tool_calls:[],tool_trajectory_match_type:"in_order",rubrics:[]}],initial_state:{},rubrics:[],enabled_metrics:[],tags:[]});n(ee=>ee.map(X=>X.id===F?{...X,eval_cases:[...X.eval_cases,K.eval_case]}:X)),i(F),a(K.eval_case.id)}catch(K){x(K.message||"Failed to create eval case")}},O=async(F,K,ee)=>{if(e!=null&&e.id)try{const X=await qe.put(`/projects/${e.id}/eval-sets/${F}/cases/${K}`,ee);n(se=>se.map(Y=>Y.id===F?{...Y,eval_cases:Y.eval_cases.map(Z=>Z.id===K?X.eval_case:Z)}:Y))}catch(X){x(X.message||"Failed to update eval case")}},M=async(F,K)=>{if(e!=null&&e.id)try{await qe.delete(`/projects/${e.id}/eval-sets/${F}/cases/${K}`),n(ee=>ee.map(X=>X.id===F?{...X,eval_cases:X.eval_cases.filter(se=>se.id!==K)}:X)),s===K&&a(null)}catch(ee){x(ee.message||"Failed to delete eval case")}},k=async F=>{if(e!=null&&e.id)try{await qe.delete(`/projects/${e.id}/eval-sets/${F}`),n(K=>K.filter(ee=>ee.id!==F)),r===F&&(i(null),a(null))}catch(K){x(K.message||"Failed to delete eval set")}},V=async F=>{if(e!=null&&e.id)try{const K=await qe.get(`/projects/${e.id}/eval-sets/${F}/export`),ee=new Blob([JSON.stringify(K,null,2)],{type:"application/json"}),X=URL.createObjectURL(ee),se=document.createElement("a");se.href=X;const Y=t.find(Z=>Z.id===F);se.download=`${(Y==null?void 0:Y.name)||"eval-set"}.json`,document.body.appendChild(se),se.click(),document.body.removeChild(se),URL.revokeObjectURL(X)}catch(K){x(K.message||"Failed to export eval set")}},J=async F=>{if(e!=null&&e.id)try{const K=await F.text(),ee=JSON.parse(K),X=await qe.post(`/projects/${e.id}/eval-sets/import`,ee);n(se=>[...se,X.eval_set]),i(X.eval_set.id),c(se=>new Set([...se,X.eval_set.id]))}catch(K){x(K.message||"Failed to import eval set")}},b=S.useRef(null),U=async()=>{if(!(!(e!=null&&e.id)||t.length===0))try{const F=await Promise.all(t.map(async se=>{try{return await qe.get(`/projects/${e.id}/eval-sets/${se.id}/export`)}catch{return se}})),K=new Blob([JSON.stringify(F,null,2)],{type:"application/json"}),ee=URL.createObjectURL(K),X=document.createElement("a");X.href=ee,X.download=`${e.name||"project"}-eval-sets.json`,document.body.appendChild(X),X.click(),document.body.removeChild(X),URL.revokeObjectURL(ee)}catch(F){x(F.message||"Failed to export all eval sets")}},A=async(F,K)=>{if(e!=null&&e.id){g(ee=>new Set([...ee,K]));try{const ee=await qe.post(`/projects/${e.id}/eval-sets/${F}/cases/${K}/run`,{});d(X=>new Map(X).set(K,ee.result))}catch(ee){x(ee.message||"Failed to run eval case")}finally{g(ee=>{const X=new Set(ee);return X.delete(K),X})}}},Q=async F=>{if(!(e!=null&&e.id))return;const K=t.find(X=>X.id===F);if(!K)return;const ee=K.eval_cases.map(X=>X.id);g(X=>new Set([...X,F,...ee]));try{const X=await qe.post(`/projects/${e.id}/eval-sets/${F}/run`,{});f(se=>new Map(se).set(F,X.result));for(const se of X.result.case_results)d(Y=>new Map(Y).set(se.eval_case_id,se));try{await qe.post(`/projects/${e.id}/eval-history`,X.result),P()}catch(se){console.warn("Failed to save eval run to history:",se)}}catch(X){x(X.message||"Failed to run eval set")}finally{g(X=>{const se=new Set(X);return se.delete(F),ee.forEach(Y=>se.delete(Y)),se})}},ue=F=>{c(K=>{const ee=new Set(K);return ee.has(F)?ee.delete(F):ee.add(F),ee})},me=F=>{let K=F.eval_cases.length,ee=0,X=0,se=0;for(const Y of F.eval_cases){const Z=u.get(Y.id);Z?Z.passed?ee++:X++:se++}return{total:K,passed:ee,failed:X,pending:se}},q=F=>F==null?"-":`${Math.round(F*100)}%`;return e?o.jsxs("div",{className:"eval-panel",children:[o.jsx("style",{children:`
        .eval-panel {
          display: flex;
          gap: 20px;
          height: calc(100vh - 180px);
...
`).join("")]})]})]},D)),r.error&&o.jsxs("div",{className:"result-details",children:[o.jsx("h5",{style:{color:"var(--error)"},children:"Error"}),o.jsx("div",{className:"detail-box",style:{color:"var(--error)"},children:r.error})]})]})]})}function E6({evalSet:e,projectId:t,result:n,isRunning:r,caseResults:i,onUpdate:s,onDelete:a,onRun:l,onExport:c}){var v,w,m,x;const[u,d]=S.useState(e.name),[p,f]=S.useState(!1);S.useEffect(()=>{d(e.name)},[e.id]);const h=S.useCallback(()=>{u!==e.name&&s({name:u})},[u,e.name,s]),g=y=>y==null?"-":`${Math.round(y*100)}%`;return o.jsxs(o.Fragment,{children:[o.jsxs("div",{className:"editor-header",children:[o.jsx(Uy,{size:20,style:{color:"var(--accent-secondary)"}}),o.jsx("input",{type:"text",value:u,onChange:y=>d(y.target.value),onBlur:h,placeholder:"Eval set name"}),o.jsx("button",{className:"btn btn-secondary btn-sm",onClick:()=>{const y=`${window.location.origin}/project/${t}/evaluate?set=${e.id}`;navigator.clipboard.writeText(y)},title:"Copy link to this eval set",children:o.jsx(Fd,{size:14})}),o.jsxs("button",{className:`btn btn-sm ${p?"btn-primary":"btn-secondary"}`,onClick:()=>f(!p),title:"View/Hide JSON",children:[o.jsx(jn,{size:14}),"JSON"]}),o.jsx("button",{className:"btn btn-secondary btn-sm",onClick:c,title:"Export as JSON (compatible with adk eval)",children:o.jsx(Zo,{size:14})}),o.jsxs("button",{className:"btn btn-primary btn-sm",onClick:l,disabled:r,children:[r?o.jsx(Io,{size:14,className:"spinning"}):o.jsx(pr,{size:14}),"Run All"]}),o.jsx("button",{className:"btn btn-danger btn-sm",onClick:a,children:o.jsx(Fe,{size:14})})]}),o.jsx("div",{className:"editor-content",children:p?o.jsxs("div",{style:{display:"flex",flexDirection:"column",gap:16,height:"100%"},children:[o.jsx("div",{style:{fontSize:12,color:"var(--text-secondary)",padding:"8px 0"},children:o.jsxs("p",{style:{margin:0},children:["This is the ADK-compatible JSON format for this evaluation set. Save this file and use with ",o.jsx("code",{style:{background:"var(--bg-tertiary)",padding:"2px 6px",borderRadius:4},children:"adk eval <agent_path> <eval_file.json>"})]})}),o.jsx("div",{style:{flex:1,minHeight:400,border:"1px solid var(--border-color)",borderRadius:"var(--radius-md)",overflow:"hidden"},children:o.jsx(Jt,{height:"100%",language:"json",theme:"vs-dark",value:JSON.stringify([{id:e.id,name:e.name,description:e.description||void 0,eval_cases:e.eval_cases.map(y=>{var j,C;return{name:y.name,description:y.description||void 0,tags:(j=y.tags)!=null&&j.length?y.tags:void 0,target_agent:y.target_agent!=="root_agent"?y.target_agent:void 0,invocations:y.invocations.map(_=>{var P;return{user_message:_.user_message,expected_response:_.expected_response||void 0,expected_tool_calls:(P=_.expected_tool_calls)!=null&&P.length?_.expected_tool_calls.map(N=>({tool_name:N.tool_name,args:N.match_type!=="name_only"&&Object.keys(N.args||{}).length?N.args:void 0})):void 0}}),session_input:Object.keys(y.session_input||{}).length?{state:y.session_input}:void 0,final_session_state:Object.keys(y.final_session_state||{}).length?y.final_session_state:void 0,rubrics:(C=y.rubrics)!=null&&C.length?y.rubrics.map(_=>_.rubric):void 0}}),eval_config:e.eval_config?{judge_model:e.eval_config.judge_model||void 0,metrics:((v=e.eval_config.metrics)==null?void 0:v.filter(y=>y.enabled))||void 0}:void 0}],null,2),options:{readOnly:!0,minimap:{enabled:!1},fontSize:12,fontFamily:"'JetBrains Mono', monospace",lineNumbers:"on",scrollBeyondLastLine:!1,automaticLayout:!0,tabSize:2,wordWrap:"on",padding:{top:12}}})}),o.jsx("div",{style:{display:"flex",gap:8},children:o.jsxs("button",{className:"btn btn-secondary btn-sm",onClick:()=>{var j;const y=JSON.stringify([{id:e.id,name:e.name,description:e.description||void 0,eval_cases:e.eval_cases.map(C=>{var _,P;return{name:C.name,description:C.description||void 0,tags:(_=C.tags)!=null&&_.length?C.tags:void 0,target_agent:C.target_agent!=="root_agent"?C.target_agent:void 0,invocations:C.invocations.map(N=>{var D;return{user_message:N.user_message,expected_response:N.expected_response||void 0,expected_tool_calls:(D=N.expected_tool_calls)!=null&&D.length?N.expected_tool_calls.map(E=>({tool_name:E.tool_name,args:E.match_type!=="name_only"&&Object.keys(E.args||{}).length?E.args:void 0})):void 0}}),session_input:Object.keys(C.session_input||{}).length?{state:C.session_input}:void 0,final_session_state:Object.keys(C.final_session_state||{}).length?C.final_session_state:void 0,rubrics:(P=C.rubrics)!=null&&P.length?C.rubrics.map(N=>N.rubric):void 0}}),eval_config:e.eval_config?{judge_model:e.eval_config.judge_model||void 0,metrics:((j=e.eval_config.metrics)==null?void 0:j.filter(C=>C.enabled))||void 0}:void 0}],null,2);navigator.clipboard.writeText(y)},children:[o.jsx(Xo,{size:14})," Copy JSON"]})})]}):o.jsxs(o.Fragment,{children:[o.jsxs("div",{className:"form-section",children:[o.jsx("h4",{children:"Description"}),o.jsx("textarea",{value:e.description,onChange:y=>s({description:y.target.value}),placeholder:"Description of this evaluation set...",style:{minHeight:40}})]}),o.jsxs("div",{className:"form-section",children:[o.jsx("h4",{children:"LLM Judge Model"}),o.jsx("p",{style:{fontSize:12,color:"var(--text-muted)",marginBottom:8},children:"Model used for LLM-judged metrics (safety, hallucinations, etc.)."}),o.jsx(S6,{value:((w=e.eval_config)==null?void 0:w.judge_model)||"",onChange:y=>s({eval_config:{...e.eval_config,judge_model:y}})})]}),o.jsxs("div",{className:"form-section",children:[o.jsxs("h4",{children:[o.jsx(Hy,{size:14})," Evaluation Metrics"]}),o.jsx("p",{style:{fontSize:12,color:"var(--text-muted)",marginBottom:8},children:"Configure which metrics to use and their pass thresholds."}),Object.keys(vn).map(y=>{var N,D,E;const j=vn[y],C=(D=(N=e.eval_config)==null?void 0:N.metrics)==null?void 0:D.find(I=>I.metric===y),_=(C==null?void 0:C.enabled)??!1,P=((E=C==null?void 0:C.criterion)==null?void 0:E.threshold)??.7;return o.jsxs("div",{style:{display:"flex",alignItems:"center",gap:10,marginBottom:6},children:[o.jsxs("label",{className:"toggle-switch",style:{margin:0},children:[o.jsx("input",{type:"checkbox",checked:_,onChange:I=>{var T;const R=[...((T=e.eval_config)==null?void 0:T.metrics)||[]],W=R.findIndex(L=>L.metric===y);I.target.checked?W===-1?R.push({metric:y,enabled:!0,criterion:{threshold:.7}}):R[W]={...R[W],enabled:!0}:W!==-1&&(R[W]={...R[W],enabled:!1}),s({eval_config:{...e.eval_config,metrics:R}})}}),o.jsx("span",{className:"toggle-slider"})]}),o.jsxs("span",{style:{fontSize:12,opacity:_?1:.5,minWidth:140,fontWeight:_?500:400},children:[j.name,j.requiresJudge&&o.jsx("span",{style:{fontSize:9,marginLeft:4,color:"var(--accent-primary)"},children:"LLM"})]}),o.jsx("span",{style:{fontSize:11,color:"var(--text-muted)",opacity:_?1:.4},children:"≥"}),o.jsx("input",{type:"number",min:0,max:1,step:.1,value:P,disabled:!_,onChange:I=>{var T;const R=[...((T=e.eval_config)==null?void 0:T.metrics)||[]],W=R.findIndex(L=>L.metric===y);W!==-1&&(R[W]={...R[W],criterion:{...R[W].criterion,threshold:parseFloat(I.target.value)||.7}},s({eval_config:{...e.eval_config,metrics:R}}))},style:{width:60,textAlign:"center",opacity:_?1:.3,padding:"2px 4px",fontSize:11}})]},y)}),o.jsxs("div",{className:"form-row",style:{marginTop:16},children:[o.jsxs("div",{className:"form-field",children:[o.jsx("label",{children:"Default Trajectory Match Type"}),o.jsxs("select",{value:((m=e.eval_config)==null?void 0:m.default_trajectory_match_type)||"in_order",onChange:y=>s({eval_config:{...e.eval_config,default_trajectory_match_type:y.target.value}}),children:[o.jsx("option",{value:"exact",children:"Exact (same order, no extras)"}),o.jsx("option",{value:"in_order",children:"In Order (extras allowed between)"}),o.jsx("option",{value:"any_order",children:"Any Order (all present, any order)"})]})]}),o.jsxs("div",{className:"form-field",children:[o.jsx("label",{children:"Number of Runs"}),o.jsx("input",{type:"number",min:1,max:10,value:((x=e.eval_config)==null?void 0:x.num_runs)||1,onChange:y=>s({eval_config:{...e.eval_config,num_runs:parseInt(y.target.value)||1}})}),o.jsx("p",{style:{fontSize:11,color:"var(--text-muted)",marginTop:4},children:"Run each test multiple times for statistical reliability."})]})]})]}),o.jsxs("div",{className:"form-section",children:[o.jsxs("h4",{children:[o.jsx(Kk,{size:14})," Coverage Summary"]}),n?o.jsxs(o.Fragment,{children:[o.jsxs("div",{className:"result-scores",children:[o.jsxs("div",{className:"score-card",children:[o.jsxs("div",{className:"score-value",style:{color:"var(--accent-primary)"},children:[n.passed_cases,"/",n.total_cases]}),o.jsx("div",{className:"score-label",children:"Cases Passed"})]}),o.jsxs("div",{className:"score-card",children:[o.jsx("div",{className:`score-value ${n.overall_pass_rate>=.8?"passed":"failed"}`,children:g(n.overall_pass_rate)}),o.jsx("div",{className:"score-label",children:"Pass Rate"})]}),Object.entries(n.metric_avg_scores||{}).map(([y,j])=>{var _;const C=Wo(y,j);return o.jsxs("div",{className:"score-card",children:[o.jsx("div",{className:"score-value",children:C.value}),o.jsxs("div",{className:"score-label",children:["Avg ",((_=vn[y])==null?void 0:_.name)||y]})]},y)})]}),o.jsxs("div",{style:{marginTop:16},children:[o.jsx("div",{style:{marginBottom:4,fontSize:12,color:"var(--text-muted)"},children:"Overall Pass Rate"}),o.jsx("div",{className:"coverage-bar",children:o.jsx("div",{className:`coverage-fill ${n.overall_pass_rate>=.8?"passed":"failed"}`,style:{width:`${n.overall_pass_rate*100}%`}})})]}),Object.entries(n.metric_pass_rates||{}).length>0&&o.jsxs("div",{style:{marginTop:16},children:[o.jsx("h5",{style:{fontSize:13,marginBottom:8},children:"Metric Pass Rates"}),Object.entries(n.metric_pass_rates).map(([y,j])=>{var C;return o.jsxs("div",{style:{marginBottom:8},children:[o.jsxs("div",{style:{display:"flex",justifyContent:"space-between",fontSize:12,marginBottom:4},children:[o.jsx("span",{children:((C=vn[y])==null?void 0:C.name)||y}),o.jsx("span",{children:g(j)})]}),o.jsx("div",{className:"coverage-bar",children:o.jsx("div",{className:`coverage-fill ${j>=.8?"passed":"failed"}`,style:{width:`${j*100}%`}})})]},y)})]}),o.jsxs("div",{style:{marginTop:16},children:[o.jsx("h5",{style:{fontSize:13,marginBottom:8},children:"Individual Results"}),o.jsxs("table",{style:{width:"100%",fontSize:12,borderCollapse:"collapse"},children:[o.jsx("thead",{children:o.jsxs("tr",{style:{borderBottom:"1px solid var(--border-color)"},children:[o.jsx("th",{style:{textAlign:"left",padding:"8px 4px"},children:"Test Case"}),o.jsx("th",{style:{textAlign:"center",padding:"8px 4px"},children:"Metrics"}),o.jsx("th",{style:{textAlign:"center",padding:"8px 4px"},children:"Status"})]})}),o.jsx("tbody",{children:n.case_results.map(y=>o.jsxs("tr",{style:{borderBottom:"1px solid var(--border-color)"},children:[o.jsx("td",{style:{padding:"8px 4px"},children:y.eval_case_name}),o.jsx("td",{style:{textAlign:"center",padding:"8px 4px"},children:y.metric_results.map((j,C)=>{const _=Wo(j.metric,j.score,j.threshold);return o.jsx("span",{style:{fontSize:10,padding:"2px 4px",marginRight:4,borderRadius:"var(--radius-sm)",background:j.passed?"rgba(var(--success-rgb), 0.15)":"rgba(var(--error-rgb), 0.15)",color:j.passed?"var(--success)":"var(--error)"},children:_.value},C)})}),o.jsx("td",{style:{textAlign:"center",padding:"8px 4px"},children:y.passed?o.jsx(Ir,{size:14,style:{color:"var(--success)"}}):y.error?o.jsx(wi,{size:14,style:{color:"var(--warning)"}}):o.jsx(ji,{size:14,style:{color:"var(--error)"}})})]},y.eval_case_id))})]})]})]}):o.jsxs("div",{style:{textAlign:"center",padding:"32px",color:"var(--text-muted)",background:"var(--bg-tertiary)",borderRadius:"var(--radius-md)"},children:[o.jsx(Ud,{size:32,style:{marginBottom:8,opacity:.3}}),o.jsx("p",{children:"Run the evaluation set to see coverage metrics"})]})]}),o.jsxs("div",{className:"form-section",children:[o.jsxs("h4",{children:["Test Cases (",e.eval_cases.length,")"]}),e.eval_cases.length===0?o.jsx("p",{style:{color:"var(--text-muted)",fontSize:13},children:"No test cases yet. Add cases to this eval set to start testing."}):o.jsx("ul",{style:{listStyle:"none",padding:0},children:e.eval_cases.map(y=>{const j=i.get(y.id);return o.jsxs("li",{style:{display:"flex",alignItems:"center",gap:8,padding:"8px 12px",background:"var(--bg-tertiary)",borderRadius:"var(--radius-sm)",marginBottom:8},children:[j?j.passed?o.jsx(Ir,{size:14,style:{color:"var(--success)"}}):o.jsx(ji,{size:14,style:{color:"var(--error)"}}):o.jsx(Ca,{size:14,style:{color:"var(--text-muted)"}}),o.jsx("span",{style:{flex:1},children:y.name}),o.jsxs("span",{style:{fontSize:11,color:"var(--text-muted)"},children:[y.invocations.length," turn(s)"]})]},y.id)})})]})]})})]})}function z6(){const{project:e,setProject:t}=ut(),[n,r]=S.useState(""),[i,s]=S.useState(!0),[a,l]=S.useState(!1),[c,u]=S.useState(null),[d,p]=S.useState(!1);if(!e)return null;S.useEffect(()=>{f()},[e.id]);async function f(){s(!0),u(null);try{const x=await Cy(e.id);r(x),l(!1)}catch(x){u(x.message)}finally{s(!1)}}function h(x){x!==void 0&&(r(x),l(!0),u(null))}async function g(){s(!0),u(null);try{const x=await Ny(e.id,n);t(x),l(!1)}catch(x){u(x.message)}finally{s(!1)}}function v(){navigator.clipboard.writeText(n),p(!0),setTimeout(()=>p(!1),2e3)}function w(){const x=new Blob([n],{type:"text/yaml"}),y=URL.createObjectURL(x),j=document.createElement("a");j.href=y,j.download=`${e.name}.yaml`,j.click(),URL.revokeObjectURL(y)}function m(){const x=document.createElement("input");x.type="file",x.accept=".yaml,.yml",x.onchange=async y=>{var _;const j=(_=y.target.files)==null?void 0:_[0];if(!j)return;const C=await j.text();r(C),l(!0)},x.click()}return o.jsxs("div",{className:"yaml-panel",children:[o.jsx("style",{children:`
        .yaml-panel {
          display: flex;
          flex-direction: column;
          height: calc(100vh - 180px);
      ...
      `}),o.jsxs("div",{className:"code-header",children:[o.jsxs("div",{className:"code-title",children:[o.jsx(jn,{size:16}),o.jsx("h3",{children:"Python Code"}),o.jsx("span",{className:"badge",children:s?"Loading...":"Generated"}),t&&o.jsxs("span",{className:"status-badge success",children:[o.jsx(Id,{size:12}),"Copied!"]}),l&&o.jsxs("span",{className:"status-badge error",children:[o.jsx(wi,{size:12}),"Error"]})]}),o.jsxs("div",{className:"code-actions",children:[o.jsxs("button",{className:"btn btn-secondary btn-sm",onClick:u,title:"Copy to clipboard",disabled:s||!!l,children:[o.jsx(Xo,{size:14}),"Copy"]}),o.jsxs("button",{className:"btn btn-secondary btn-sm",onClick:d,title:"Download Python file",disabled:s||!!l,children:[o.jsx(Zo,{size:14}),"Download"]})]})]}),o.jsx("div",{className:"code-editor",children:s?o.jsx("div",{className:"code-loading",children:o.jsx("div",{children:"Loading generated code..."})}):l?o.jsxs("div",{className:"code-error",children:[o.jsx(wi,{size:24}),o.jsx("div",{children:l})]}):o.jsx(Jt,{height:"100%",language:"python",theme:"vs-dark",value:r,options:{readOnly:!0,minimap:{enabled:!1},fontSize:13,fontFamily:"'JetBrains Mono', monospace",lineNumbers:"on",scrollBeyondLastLine:!1,automaticLayout:!0,tabSize:4,insertSpaces:!0,padding:{top:12},wordWrap:"on"}})}),o.jsxs("div",{className:"code-info",children:[o.jsx("p",{children:"This is the Python code equivalent of your project configuration. You can use this code directly with ADK."}),o.jsxs("p",{children:["Place this in a file named ",o.jsx("code",{children:"agent.py"})," inside your agent directory, then run with ",o.jsx("code",{children:"adk web ."})," or ",o.jsx("code",{children:"adk run your_agent"}),"."]})]})]})}const A6=[{id:"app",label:"App",icon:Hy},{id:"agents",label:"Agents",icon:Er},{id:"tools",label:"Tools",icon:an},{id:"callbacks",label:"Callbacks",icon:jn},{id:"run",label:"Run",icon:Vy},{id:"skillsets",label:"SkillSets",icon:$k},{id:"eval",label:"Evaluate",icon:gu},{id:"yaml",label:"YAML",icon:Fk},{id:"code",label:"Code",icon:jn}],P6=["app","agents","tools","callbacks","run","skillsets","eval","yaml","code"];function mc(){var L,$;const{projectId:e,tab:t,itemId:n}=Dw(),r=Md(),{project:i,setProject:s,activeTab:a,setActiveTab:l,hasUnsavedChanges:c,setHasUnsavedChanges:u,selectedAgentId:d,setSelectedAgentId:p,selectedToolId:f,setSelectedToolId:h}=ut(),[g,v]=S.useState(!0),[w,m]=S.useState(!1),[x,y]=S.useState(!1),[j,C]=S.useState(null),_=S.useRef(!0),P=S.useRef(null);S.useEffect(()=>{t&&P6.includes(t)?l(t):!t&&e&&r(`/project/${e}/${a}`,{replace:!0})},[t,e]),S.useEffect(()=>{t==="agents"&&n?p(n):t==="tools"&&n&&h(n)},[t,n]);function N(z){l(z),z==="agents"&&d?r(`/project/${e}/${z}/${d}`,{replace:!0}):z==="tools"&&f?r(`/project/${e}/${z}/${f}`,{replace:!0}):r(`/project/${e}/${z}`,{replace:!0})}function D(z){z?r(`/project/${e}/${a}/${z}`,{replace:!0}):r(`/project/${e}/${a}`,{replace:!0})}S.useEffect(()=>(e&&E(e),()=>{s(null),u(!1)}),[e]);async function E(z){_.current=!0;try{const O=await wy(z);s(O),P.current=JSON.stringify(O),u(!1)}catch(O){console.error("Failed to load project:",O),r("/")}finally{v(!1),setTimeout(()=>{_.current=!1},100)}}async function I(){if(i){m(!0);try{const{eval_sets:z,...O}=i;await du(i.id,O),P.current=JSON.stringify(i),u(!1)}catch(z){console.error("Failed to save project:",z)}finally{m(!1)}}}async function R(){if(i){y(!0),C(null),window.dispatchEvent(new CustomEvent("eval-tests-started"));try{let z=0,O=0;const M=[],k=[];for(const V of i.eval_sets||[]){if(V.eval_cases.length===0)continue;const J=await qe.post(`/projects/${i.id}/eval-sets/${V.id}/run`,{});J.result&&(z+=J.result.passed_cases||0,O+=J.result.total_cases||0,J.result.case_results&&M.push(...J.result.case_results),k.push(J.result.eval_set_name||V.name||V.id))}if(M.length>0){const V={id:Date.now().toString(36)+Math.random().toString(36).substr(2,5),eval_set_id:"batch",eval_set_name:k.length>1?`All Tests (${k.length} sets)`:k[0]||"All Tests",started_at:Date.now()/1e3,completed_at:Date.now()/1e3,total_cases:O,passed_cases:z,failed_cases:O-z,case_results:M};try{await qe.post(`/projects/${i.id}/eval-history`,V)}catch(J){console.warn("Failed to save batch eval run to history:",J)}}C({passed:z,total:O}),window.dispatchEvent(new CustomEvent("eval-tests-completed")),setTimeout(()=>C(null),5e3)}catch(z){console.error("Failed to run tests:",z),C({passed:0,total:-1}),setTimeout(()=>C(null),5e3)}finally{y(!1)}}}const W=S.useRef(null);S.useEffect(()=>{if(i&&!_.current&&W.current){const z=i.app.models||[],O=W.current||[];if(z.some((k,V)=>{const J=O.find(b=>b.id===k.id);return J?J.provider!==k.provider||J.model_name!==k.model_name||J.api_base!==k.api_base||J.temperature!==k.temperature||J.max_output_tokens!==k.max_output_tokens||J.top_p!==k.top_p||J.top_k!==k.top_k:!1})){const k=i.app.default_model_id,V=i.agents.map(b=>{if(b.type==="LlmAgent"&&b.model){const U=b.model._appModelId;if(U){const A=z.find(Q=>Q.id===U);if(A)return{...b,model:{provider:A.provider,model_name:A.model_name,api_base:A.api_base,temperature:A.temperature,max_output_tokens:A.max_output_tokens,top_p:A.top_p,top_k:A.top_k,fallbacks:[],_appModelId:U}}}else if(k){const A=z.find(Q=>Q.id===k);if(A&&b.model.provider===A.provider&&b.model.model_name===A.model_name&&b.model.api_base===A.api_base)return{...b,model:{provider:A.provider,model_name:A.model_name,api_base:A.api_base,temperature:A.temperature,max_output_tokens:A.max_output_tokens,top_p:A.top_p,top_k:A.top_k,fallbacks:[],_appModelId:k}}}}return b});V.some((b,U)=>JSON.stringify(b)!==JSON.stringify(i.agents[U]))&&s({...i,agents:V})}}i&&(W.current=i.app.models||[])},[i==null?void 0:i.app.models,i,s]);const T=S.useRef(null);return S.useEffect(()=>(i&&!_.current&&P.current&&JSON.stringify(i)!==P.current&&(u(!0),T.current&&clearTimeout(T.current),T.current=setTimeout(async()=>{try{const{eval_sets:O,...M}=i;await du(i.id,M),P.current=JSON.stringify(i),u(!1)}catch(O){console.error("Auto-save failed:",O)}},500)),()=>{T.current&&clearTimeout(T.current)}),[i]),g?o.jsxs("div",{className:"loading-screen",children:[o.jsx("style",{children:`
          .loading-screen {
            height: 100vh;
            display: flex;
            align-items: center;
      ...
      `}),o.jsxs("header",{className:"top-bar",children:[o.jsxs("div",{className:"top-bar-left",children:[o.jsxs("button",{className:"back-btn",onClick:()=>r("/"),children:[o.jsx(Ik,{size:18}),"Project"]}),o.jsx("h1",{className:"project-name",children:i.name})]}),o.jsx("nav",{className:"tabs-bar",children:A6.map(z=>o.jsxs("button",{className:`tab-btn ${a===z.id?"active":""}`,onClick:()=>N(z.id),children:[o.jsx(z.icon,{size:14}),z.label]},z.id))}),o.jsxs("div",{className:"top-bar-right",children:[o.jsxs("button",{className:`btn ${j?j.total===-1?"btn-error":j.passed===j.total?"btn-success":"btn-warning":"btn-secondary"}`,onClick:R,disabled:x||!((L=i==null?void 0:i.eval_sets)!=null&&L.some(z=>z.eval_cases.length>0)),title:($=i==null?void 0:i.eval_sets)!=null&&$.some(z=>z.eval_cases.length>0)?"Run all evaluation tests":"No test cases defined",style:{marginRight:8},children:[x?o.jsx(Hk,{size:16,className:"spin"}):o.jsx(pr,{size:16}),x?"Testing...":j?j.total===-1?"Error":`${j.passed}/${j.total}`:"Test"]}),o.jsxs("button",{className:"btn btn-primary",onClick:I,disabled:w,children:[o.jsx(Ea,{size:16}),w?"Saving...":"Save"]})]})]}),o.jsxs("main",{className:"main-content",children:[a==="app"&&o.jsx(sj,{}),a==="agents"&&o.jsx(f4,{onSelectAgent:D}),a==="tools"&&o.jsx(J4,{onSelectTool:D}),a==="callbacks"&&o.jsx(G4,{onSelectCallback:D}),a==="run"&&o.jsx(v6,{}),a==="skillsets"&&o.jsx(k6,{}),a==="eval"&&o.jsx(_6,{}),a==="yaml"&&o.jsx(z6,{}),a==="code"&&o.jsx(T6,{})]})]}):null}function L6(){const{setMcpServers:e,setBuiltinTools:t}=ut();return S.useEffect(()=>{Rd().then(e).catch(console.error),Ey().then(t).catch(console.error)},[e,t]),o.jsxs(nk,{children:[o.jsx(Vr,{path:"/",element:o.jsx(Zk,{})}),o.jsx(Vr,{path:"/project/:projectId",element:o.jsx(mc,{})}),o.jsx(Vr,{path:"/project/:projectId/:tab",element:o.jsx(mc,{})}),o.jsx(Vr,{path:"/project/:projectId/:tab/:itemId",element:o.jsx(mc,{})}),o.jsx(Vr,{path:"*",element:o.jsx(ek,{to:"/",replace:!0})})]})}gc.createRoot(document.getElementById("root")).render(o.jsx(It.StrictMode,{children:o.jsx(ok,{children:o.jsx(L6,{})})}));
