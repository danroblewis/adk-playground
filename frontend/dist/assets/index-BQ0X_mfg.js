 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */(function(e){function t(O,R){var w=O.length;O.push(R);e:for(;0<w;){var V=w-1>>>1,Y=O[V];if(0<i(Y,R))O[V]=R,O[w]=Y,w=V;else break e}}function n(O){return O.length===0?null:O[0]}function r(O){if(O.length===0)return null;var R=O[0],w=O.pop();if(w!==R){O[0]=w;e:for(var V=0,Y=O.length,b=Y>>>1;V<b;){var E=2*(V+1)-1,B=O[E],ie=E+1,pe=O[ie];if(0>i(B,w))ie<Y&&0>i(pe,B)?(O[V]=pe,O[ie]=w,V=ie):(O[V]=B,O[E]=w,V=E);else if(ie<Y&&0>i(pe,w))O[V]=pe,O[ie]=w,V=ie;else break e}}return R}function i(O,R){var w=O.sortIndex-R.sortIndex;return w!==0?w:O.id-R.id}if(typeof performance=="object"&&typeof performance.now=="function"){var s=performance;e.unstable_now=function(){return s.now()}}else{var a=Date,l=a.now();e.unstable_now=function(){return a.now()-l}}var c=[],u=[],d=1,p=null,f=3,h=!1,g=!1,v=!1,_=typeof setTimeout=="function"?setTimeout:null,m=typeof clearTimeout=="function"?clearTimeout:null,x=typeof setImmediate<"u"?setImmediate:null;typeof navigator<"u"&&navigator.scheduling!==void 0&&navigator.scheduling.isInputPending!==void 0&&navigator.scheduling.isInputPending.bind(navigator.scheduling);function y(O){for(var R=n(u);R!==null;){if(R.callback===null)r(u);else if(R.startTime<=O)r(u),R.sortIndex=R.expirationTime,t(c,R);else break;R=n(u)}}function j(O){if(v=!1,y(O),!g)if(n(c)!==null)g=!0,D(P);else{var R=n(u);R!==null&&S(j,R.startTime-O)}}function P(O,R){g=!1,v&&(v=!1,m(N),N=-1),h=!0;var w=f;try{for(y(R),p=n(c);p!==null&&(!(p.expirationTime>R)||O&&!L());){var V=p.callback;if(typeof V=="function"){p.callback=null,f=p.priorityLevel;var Y=V(p.expirationTime<=R);R=e.unstable_now(),typeof Y=="function"?p.callback=Y:p===n(c)&&r(c),y(R)}else r(c);p=n(c)}if(p!==null)var b=!0;else{var E=n(u);E!==null&&S(j,E.startTime-R),b=!1}return b}finally{p=null,f=w,h=!1}}var C=!1,M=null,N=-1,F=5,z=-1;function L(){return!(e.unstable_now()-z<F)}function I(){if(M!==null){var O=e.unstable_now();z=O;var R=!0;try{R=M(!0,O)}finally{R?W():(C=!1,M=null)}}else C=!1}var W;if(typeof x=="function")W=function(){x(I)};else if(typeof MessageChannel<"u"){var A=new MessageChannel,$=A.port2;A.port1.onmessage=I,W=function(){$.postMessage(null)}}else W=function(){_(I,0)};function D(O){M=O,C||(C=!0,W())}function S(O,R){N=_(function(){O(e.unstable_now())},R)}e.unstable_IdlePriority=5,e.unstable_ImmediatePriority=1,e.unstable_LowPriority=4,e.unstable_NormalPriority=3,e.unstable_Profiling=null,e.unstable_UserBlockingPriority=2,e.unstable_cancelCallback=function(O){O.callback=null},e.unstable_continueExecution=function(){g||h||(g=!0,D(P))},e.unstable_forceFrameRate=function(O){0>O||125<O?console.error("forceFrameRate takes a positive int between 0 and 125, forcing frame rates higher than 125 fps is not supported"):F=0<O?Math.floor(1e3/O):5},e.unstable_getCurrentPriorityLevel=function(){return f},e.unstable_getFirstCallbackNode=function(){return n(c)},e.unstable_next=function(O){switch(f){case 1:case 2:case 3:var R=3;break;default:R=f}var w=f;f=R;try{return O()}finally{f=w}},e.unstable_pauseExecution=function(){},e.unstable_requestPaint=function(){},e.unstable_runWithPriority=function(O,R){switch(O){case 1:case 2:case 3:case 4:case 5:break;default:O=3}var w=f;f=O;try{return R()}finally{f=w}},e.unstable_scheduleCallback=function(O,R,w){var V=e.unstable_now();switch(typeof w=="object"&&w!==null?(w=w.delay,w=typeof w=="number"&&0<w?V+w:V):w=V,O){case 1:var Y=-1;break;case 2:Y=250;break;case 5:Y=1073741823;break;case 4:Y=1e4;break;default:Y=5e3}return Y=w+Y,O={id:d++,callback:R,priorityLevel:O,startTime:w,expirationTime:Y,sortIndex:-1},w>V?(O.sortIndex=w,t(u,O),n(c)===null&&O===n(u)&&(v?(m(N),N=-1):v=!0,S(j,w-V))):(O.sortIndex=Y,t(c,O),g||h||(g=!0,D(P))),O},e.unstable_shouldYield=L,e.unstable_wrapCallback=function(O){var R=f;return function(){var w=f;f=R;try{return O.apply(this,arguments)}finally{f=w}}}})(Sg);jg.exports=Sg;var A0=jg.exports;/**
 * @license React
 ...
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const s_=e=>e.replace(/([a-z0-9])([A-Z])/g,"$1-$2").toLowerCase().trim(),xe=(e,t)=>{const n=k.forwardRef(({color:r="currentColor",size:i=24,strokeWidth:s=2,absoluteStrokeWidth:a,className:l="",children:c,...u},d)=>k.createElement("svg",{ref:d,...o_,width:i,height:i,stroke:r,strokeWidth:a?Number(s)*24/Number(i):s,className:["lucide",`lucide-${s_(e)}`,l].join(" "),...u},[...t.map(([p,f])=>k.createElement(p,f)),...Array.isArray(c)?c:[c]]));return n.displayName=`${e}`,n};/**
 * @license lucide-react v0.294.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 ...
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const cv=xe("AlertTriangle",[["path",{d:"m21.73 18-8-14a2 2 0 0 0-3.48 0l-8 14A2 2 0 0 0 4 21h16a2 2 0 0 0 1.73-3Z",key:"c3ski4"}],["path",{d:"M12 9v4",key:"juzpu7"}],["path",{d:"M12 17h.01",key:"p32p05"}]]);/**
 * @license lucide-react v0.294.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const a_=xe("ArrowLeft",[["path",{d:"m12 19-7-7 7-7",key:"1l729n"}],["path",{d:"M19 12H5",key:"x3x0zl"}]]);/**
 * @license lucide-react v0.294.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const l_=xe("Ban",[["circle",{cx:"12",cy:"12",r:"10",key:"1mglay"}],["path",{d:"m4.9 4.9 14.2 14.2",key:"1m5liu"}]]);/**
 * @license lucide-react v0.294.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 ...
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const c_=xe("Brain",[["path",{d:"M9.5 2A2.5 2.5 0 0 1 12 4.5v15a2.5 2.5 0 0 1-4.96.44 2.5 2.5 0 0 1-2.96-3.08 3 3 0 0 1-.34-5.58 2.5 2.5 0 0 1 1.32-4.24 2.5 2.5 0 0 1 1.98-3A2.5 2.5 0 0 1 9.5 2Z",key:"1mhkh5"}],["path",{d:"M14.5 2A2.5 2.5 0 0 0 12 4.5v15a2.5 2.5 0 0 0 4.96.44 2.5 2.5 0 0 0 2.96-3.08 3 3 0 0 0 .34-5.58 2.5 2.5 0 0 0-1.32-4.24 2.5 2.5 0 0 0-1.98-3A2.5 2.5 0 0 0 14.5 2Z",key:"1d6s00"}]]);/**
 * @license lucide-react v0.294.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 ...
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const _t=xe("ChevronRight",[["path",{d:"m9 18 6-6-6-6",key:"mthhwq"}]]);/**
 * @license lucide-react v0.294.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 ...
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const jn=xe("Code",[["polyline",{points:"16 18 22 12 16 6",key:"z7tu5w"}],["polyline",{points:"8 6 2 12 8 18",key:"1eg1df"}]]);/**
 * @license lucide-react v0.294.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 ...
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const uv=xe("ExternalLink",[["path",{d:"M18 13v6a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V8a2 2 0 0 1 2-2h6",key:"a6xqqp"}],["polyline",{points:"15 3 21 3 21 9",key:"mznyad"}],["line",{x1:"10",x2:"21",y1:"14",y2:"3",key:"18c3s4"}]]);/**
 * @license lucide-react v0.294.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const u_=xe("EyeOff",[["path",{d:"M9.88 9.88a3 3 0 1 0 4.24 4.24",key:"1jxqfv"}],["path",{d:"M10.73 5.08A10.43 10.43 0 0 1 12 5c7 0 10 7 10 7a13.16 13.16 0 0 1-1.67 2.68",key:"9wicm4"}],["path",{d:"M6.61 6.61A13.526 13.526 0 0 0 2 12s3 7 10 7a9.74 9.74 0 0 0 5.39-1.61",key:"1jreej"}],["line",{x1:"2",x2:"22",y1:"2",y2:"22",key:"a6p6uj"}]]);/**
 * @license lucide-react v0.294.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 ...
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const d_=xe("FileCode",[["path",{d:"M14.5 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V7.5L14.5 2z",key:"1nnpy2"}],["polyline",{points:"14 2 14 8 20 8",key:"1ew0cm"}],["path",{d:"m10 13-2 2 2 2",key:"17smn8"}],["path",{d:"m14 17 2-2-2-2",key:"14mezr"}]]);/**
 * @license lucide-react v0.294.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const p_=xe("FileText",[["path",{d:"M14.5 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V7.5L14.5 2z",key:"1nnpy2"}],["polyline",{points:"14 2 14 8 20 8",key:"1ew0cm"}],["line",{x1:"16",x2:"8",y1:"13",y2:"13",key:"14keom"}],["line",{x1:"16",x2:"8",y1:"17",y2:"17",key:"17nazh"}],["line",{x1:"10",x2:"8",y1:"9",y2:"9",key:"1a5vjj"}]]);/**
 * @license lucide-react v0.294.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const f_=xe("File",[["path",{d:"M14.5 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V7.5L14.5 2z",key:"1nnpy2"}],["polyline",{points:"14 2 14 8 20 8",key:"1ew0cm"}]]);/**
 * @license lucide-react v0.294.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const dv=xe("FolderOpen",[["path",{d:"m6 14 1.5-2.9A2 2 0 0 1 9.24 10H20a2 2 0 0 1 1.94 2.5l-1.54 6a2 2 0 0 1-1.95 1.5H4a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h3.9a2 2 0 0 1 1.69.9l.81 1.2a2 2 0 0 0 1.67.9H18a2 2 0 0 1 2 2v2",key:"usdka0"}]]);/**
 * @license lucide-react v0.294.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const pv=xe("FolderTree",[["path",{d:"M20 10a1 1 0 0 0 1-1V6a1 1 0 0 0-1-1h-2.5a1 1 0 0 1-.8-.4l-.9-1.2A1 1 0 0 0 15 3h-2a1 1 0 0 0-1 1v5a1 1 0 0 0 1 1Z",key:"hod4my"}],["path",{d:"M20 21a1 1 0 0 0 1-1v-3a1 1 0 0 0-1-1h-2.9a1 1 0 0 1-.88-.55l-.42-.85a1 1 0 0 0-.92-.6H13a1 1 0 0 0-1 1v5a1 1 0 0 0 1 1Z",key:"w4yl2u"}],["path",{d:"M3 5a2 2 0 0 0 2 2h3",key:"f2jnh7"}],["path",{d:"M3 3v13a2 2 0 0 0 2 2h3",key:"k8epm1"}]]);/**
 * @license lucide-react v0.294.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const Th=xe("Folder",[["path",{d:"M20 20a2 2 0 0 0 2-2V8a2 2 0 0 0-2-2h-7.9a2 2 0 0 1-1.69-.9L9.6 3.9A2 2 0 0 0 7.93 3H4a2 2 0 0 0-2 2v13a2 2 0 0 0 2 2Z",key:"1kt360"}]]);/**
 * @license lucide-react v0.294.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 ...
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const h_=xe("GripVertical",[["circle",{cx:"9",cy:"12",r:"1",key:"1vctgf"}],["circle",{cx:"9",cy:"5",r:"1",key:"hp0tcf"}],["circle",{cx:"9",cy:"19",r:"1",key:"fkjjf6"}],["circle",{cx:"15",cy:"12",r:"1",key:"1tmaij"}],["circle",{cx:"15",cy:"5",r:"1",key:"19l28e"}],["circle",{cx:"15",cy:"19",r:"1",key:"f4zoj3"}]]);/**
 * @license lucide-react v0.294.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const m_=xe("HardDrive",[["line",{x1:"22",x2:"2",y1:"12",y2:"12",key:"1y58io"}],["path",{d:"M5.45 5.11 2 12v6a2 2 0 0 0 2 2h16a2 2 0 0 0 2-2v-6l-3.45-6.89A2 2 0 0 0 16.76 4H7.24a2 2 0 0 0-1.79 1.11z",key:"oot6mr"}],["line",{x1:"6",x2:"6.01",y1:"16",y2:"16",key:"sgf278"}],["line",{x1:"10",x2:"10.01",y1:"16",y2:"16",key:"1l4acy"}]]);/**
 * @license lucide-react v0.294.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const g_=xe("Image",[["rect",{width:"18",height:"18",x:"3",y:"3",rx:"2",ry:"2",key:"1m3agn"}],["circle",{cx:"9",cy:"9",r:"2",key:"af1f0g"}],["path",{d:"m21 15-3.086-3.086a2 2 0 0 0-2.828 0L6 21",key:"1xmnt7"}]]);/**
 * @license lucide-react v0.294.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 ...
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const fv=xe("Layers",[["path",{d:"m12.83 2.18a2 2 0 0 0-1.66 0L2.6 6.08a1 1 0 0 0 0 1.83l8.58 3.91a2 2 0 0 0 1.66 0l8.58-3.9a1 1 0 0 0 0-1.83Z",key:"8b97xw"}],["path",{d:"m22 17.65-9.17 4.16a2 2 0 0 1-1.66 0L2 17.65",key:"dd6zsq"}],["path",{d:"m22 12.65-9.17 4.16a2 2 0 0 1-1.66 0L2 12.65",key:"ep9fru"}]]);/**
 * @license lucide-react v0.294.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 ...
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const x_=xe("Link",[["path",{d:"M10 13a5 5 0 0 0 7.54.54l3-3a5 5 0 0 0-7.07-7.07l-1.72 1.71",key:"1cjeqo"}],["path",{d:"M14 11a5 5 0 0 0-7.54-.54l-3 3a5 5 0 0 0 7.07 7.07l1.71-1.71",key:"19qd67"}]]);/**
 * @license lucide-react v0.294.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const hv=xe("Loader2",[["path",{d:"M21 12a9 9 0 1 1-6.219-8.56",key:"13zald"}]]);/**
 * @license lucide-react v0.294.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 ...
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const y_=xe("Package",[["path",{d:"m7.5 4.27 9 5.15",key:"1c824w"}],["path",{d:"M21 8a2 2 0 0 0-1-1.73l-7-4a2 2 0 0 0-2 0l-7 4A2 2 0 0 0 3 8v8a2 2 0 0 0 1 1.73l7 4a2 2 0 0 0 2 0l7-4A2 2 0 0 0 21 16Z",key:"hh9hay"}],["path",{d:"m3.3 7 8.7 5 8.7-5",key:"g66t2b"}],["path",{d:"M12 22V12",key:"d0xqtd"}]]);/**
 * @license lucide-react v0.294.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const v_=xe("PenLine",[["path",{d:"M12 20h9",key:"t2du7b"}],["path",{d:"M16.5 3.5a2.12 2.12 0 0 1 3 3L7 19l-4 1 1-4Z",key:"ymcmye"}]]);/**
 * @license lucide-react v0.294.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const b_=xe("Percent",[["line",{x1:"19",x2:"5",y1:"5",y2:"19",key:"1x9vlm"}],["circle",{cx:"6.5",cy:"6.5",r:"2.5",key:"4mh3h7"}],["circle",{cx:"17.5",cy:"17.5",r:"2.5",key:"1mdrzq"}]]);/**
 * @license lucide-react v0.294.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 ...
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const w_=xe("Repeat",[["path",{d:"m17 2 4 4-4 4",key:"nntrym"}],["path",{d:"M3 11v-1a4 4 0 0 1 4-4h14",key:"84bu3i"}],["path",{d:"m7 22-4-4 4-4",key:"1wqhfi"}],["path",{d:"M21 13v1a4 4 0 0 1-4 4H3",key:"1rx37r"}]]);/**
 * @license lucide-react v0.294.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 ...
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const mv=xe("Search",[["circle",{cx:"11",cy:"11",r:"8",key:"4ej97u"}],["path",{d:"m21 21-4.3-4.3",key:"1qie3q"}]]);/**
 * @license lucide-react v0.294.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 ...
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const k_=xe("Settings2",[["path",{d:"M20 7h-9",key:"3s1dr2"}],["path",{d:"M14 17H5",key:"gfn3mx"}],["circle",{cx:"17",cy:"17",r:"3",key:"18b49y"}],["circle",{cx:"7",cy:"7",r:"3",key:"dfmy0x"}]]);/**
 * @license lucide-react v0.294.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const gv=xe("Settings",[["path",{d:"M12.22 2h-.44a2 2 0 0 0-2 2v.18a2 2 0 0 1-1 1.73l-.43.25a2 2 0 0 1-2 0l-.15-.08a2 2 0 0 0-2.73.73l-.22.38a2 2 0 0 0 .73 2.73l.15.1a2 2 0 0 1 1 1.72v.51a2 2 0 0 1-1 1.74l-.15.09a2 2 0 0 0-.73 2.73l.22.38a2 2 0 0 0 2.73.73l.15-.08a2 2 0 0 1 2 0l.43.25a2 2 0 0 1 1 1.73V20a2 2 0 0 0 2 2h.44a2 2 0 0 0 2-2v-.18a2 2 0 0 1 1-1.73l.43-.25a2 2 0 0 1 2 0l.15.08a2 2 0 0 0 2.73-.73l.22-.39a2 2 0 0 0-.73-2.73l-.15-.08a2 2 0 0 1-1-1.74v-.5a2 2 0 0 1 1-1.74l.15-.09a2 2 0 0 0 .73-2.73l-.22-.38a2 2 0 0 0-2.73-.73l-.15.08a2 2 0 0 1-2 0l-.43-.25a2 2 0 0 1-1-1.73V4a2 2 0 0 0-2-2z",key:"1qme2f"}],["circle",{cx:"12",cy:"12",r:"3",key:"1v7zrd"}]]);/**
 * @license lucide-react v0.294.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const xv=xe("Shield",[["path",{d:"M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10",key:"1irkt0"}]]);/**
 * @license lucide-react v0.294.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 ...
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const __=xe("Square",[["rect",{width:"18",height:"18",x:"3",y:"3",rx:"2",key:"afitv7"}]]);/**
 * @license lucide-react v0.294.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const yv=xe("Star",[["polygon",{points:"12 2 15.09 8.26 22 9.27 17 14.14 18.18 21.02 12 17.77 5.82 21.02 7 14.14 2 9.27 8.91 8.26 12 2",key:"8f66p6"}]]);/**
 * @license lucide-react v0.294.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 ...
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const Ue=xe("Trash2",[["path",{d:"M3 6h18",key:"d0wm0j"}],["path",{d:"M19 6v14c0 1-1 2-2 2H7c-1 0-2-1-2-2V6",key:"4alrt4"}],["path",{d:"M8 6V4c0-1 1-2 2-2h4c1 0 2 1 2 2v2",key:"v07s0e"}],["line",{x1:"10",x2:"10",y1:"11",y2:"17",key:"1uufr5"}],["line",{x1:"14",x2:"14",y1:"11",y2:"17",key:"xtxkd"}]]);/**
 * @license lucide-react v0.294.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 ...
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const vv=xe("Users",[["path",{d:"M16 21v-2a4 4 0 0 0-4-4H6a4 4 0 0 0-4 4v2",key:"1yyitq"}],["circle",{cx:"9",cy:"7",r:"4",key:"nufk8"}],["path",{d:"M22 21v-2a4 4 0 0 0-3-3.87",key:"kshegd"}],["path",{d:"M16 3.13a4 4 0 0 1 0 7.75",key:"1da9ce"}]]);/**
 * @license lucide-react v0.294.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 ...
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const j_=xe("Workflow",[["rect",{width:"8",height:"8",x:"3",y:"3",rx:"2",key:"by2w9f"}],["path",{d:"M7 11v4a2 2 0 0 0 2 2h4",key:"xkn7yn"}],["rect",{width:"8",height:"8",x:"13",y:"13",rx:"2",key:"1cgmvn"}]]);/**
 * @license lucide-react v0.294.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const dn=xe("Wrench",[["path",{d:"M14.7 6.3a1 1 0 0 0 0 1.4l1.6 1.6a1 1 0 0 0 1.4 0l3.77-3.77a6 6 0 0 1-7.94 7.94l-6.91 6.91a2.12 2.12 0 0 1-3-3l6.91-6.91a6 6 0 0 1 7.94-7.94l-3.76 3.76z",key:"cbrjhi"}]]);/**
 * @license lucide-react v0.294.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
...
`).length,h=Math.max(r,Math.min(f*20+40,500));l(h)}},[e,r]),k.useEffect(()=>{i&&u.current&&u.current.focus()},[i]);function d(f){u.current=f,f.focus()}function p(f){c.current&&!c.current.contains(f.target)&&s(!1)}return k.useEffect(()=>{if(i)return document.addEventListener("mousedown",p),()=>document.removeEventListener("mousedown",p)},[i]),o.jsxs("div",{ref:c,className:"markdown-editor",children:[o.jsx("style",{children:`
      ...
      `}),i?o.jsx("div",{className:"monaco-wrapper",children:o.jsx(Zt,{height:"100%",language:"markdown",theme:"vs-dark",value:e,onChange:f=>t(f||""),onMount:d,options:{minimap:{enabled:!1},fontSize:14,fontFamily:"'JetBrains Mono', monospace",lineNumbers:"off",scrollBeyondLastLine:!1,automaticLayout:!0,wordWrap:"on",padding:{top:12,bottom:12},lineDecorationsWidth:8,folding:!1,glyphMargin:!1,renderLineHighlight:"none",overviewRulerLanes:0,hideCursorInOverviewRuler:!0,scrollbar:{vertical:"auto",horizontal:"hidden"}}})}):o.jsxs("div",{className:"markdown-preview",onClick:()=>s(!0),children:[o.jsxs("span",{className:"edit-hint",children:[o.jsx(v_,{size:12}),"Click to edit"]}),e?o.jsx("div",{className:"markdown-content",children:o.jsx(d1,{children:e})}):o.jsx("div",{className:"markdown-placeholder",children:n})]})]})}function A4(e){return/^[a-zA-Z0-9_]+$/.test(e)}function P4({agent:e}){const{project:t,updateAgent:n,mcpServers:r,builtinTools:i,setActiveTab:s,setRunAgentId:a}=ht(),[l,c]=k.useState(new Set(["basic","model","tools","subagents","callbacks"])),[u,d]=k.useState(!1),[p,f]=k.useState(!1),[h,g]=k.useState(!1),[v,_]=k.useState(""),[m,x]=k.useState(null);if(!t)return null;function y(S){n(e.id,S)}function j(S){if(S===""){x(null),y({name:S});return}A4(S)?x(null):x("Name can only contain letters, numbers, and underscores"),e.type==="LlmAgent"?y({name:S,output_key:S}):y({name:S})}function P(S){const O=new Set(l);O.has(S)?O.delete(S):O.add(S),c(O)}const C=e.type==="LlmAgent",M=e;function N(S){C&&y({tools:[...M.tools,S]})}function F(S){C&&y({tools:M.tools.filter((O,R)=>R!==S)})}function z(S,O){if(!C)return;const R=[...M.tools];R[S]=O,y({tools:R})}function L(S){"sub_agents"in e&&y({sub_agents:[...e.sub_agents,S]})}function I(S){"sub_agents"in e&&y({sub_agents:e.sub_agents.filter(O=>O!==S)})}const W=t.agents.filter(S=>S.id!==e.id);async function A(){if(!(!t||!C)){d(!0);try{const S=M.instruction||"",O=S?`Current instruction to improve:

${S}

Please improve and expand this instruction while preserving its core intent.`:void 0,w=t.agents.some(Y=>Y.id===e.id)?void 0:e,V=await Zs(t.id,e.id,O,w);V.success&&V.prompt?y({instruction:V.prompt}):alert("Failed to generate prompt: "+(V.error||"Unknown error"))}catch(S){alert("Error generating prompt: "+S.message)}finally{d(!1)}}}async function $(){if(!(!t||!C||!v.trim())){d(!0);try{const O=`Current instruction:
...
Please apply the requested changes to the instruction above. Output only the updated instruction, nothing else.`,w=t.agents.some(Y=>Y.id===e.id)?void 0:e,V=await Zs(t.id,e.id,O,w);V.success&&V.prompt?(y({instruction:V.prompt}),g(!1),_("")):alert("Failed to apply changes: "+(V.error||"Unknown error"))}catch(S){alert("Error applying changes: "+S.message)}finally{d(!1)}}}async function D(){if(!t||!C)return;const S=M.instruction;if(!S){alert("Please write an instruction first");return}f(!0);try{const O=`Write a 5-10 word description of what this agent does.
...
Your response (5-10 words only):`,R=await Zs(t.id,e.id,O);if(R.success&&R.prompt){let w=R.prompt.trim();w=w.replace(/^["']|["']$/g,"").trim();const V=w.split(/[.!?\n]/)[0].trim(),Y=V.length>80?V.slice(0,77)+"...":V;y({description:Y})}else alert("Failed to generate description: "+(R.error||"Unknown error"))}catch(O){alert("Error generating description: "+O.message)}finally{f(!1)}}return o.jsxs("div",{className:"agent-editor",children:[o.jsx("style",{children:`
        .agent-editor {
          background: var(--bg-secondary);
          border: 1px solid var(--border-color);
          border-radius: var(--radius-lg);
      ...
      `}),o.jsxs("div",{className:"editor-header",children:[o.jsx(zr,{size:24,style:{color:"var(--accent-primary)"}}),o.jsxs("div",{style:{flex:1,display:"flex",flexDirection:"column",gap:4},children:[o.jsx("input",{type:"text",value:e.name,onChange:S=>j(S.target.value),placeholder:"Agent name",style:{borderColor:m?"var(--error)":void 0}}),m&&o.jsx("span",{style:{fontSize:11,color:"var(--error)",marginTop:-4},children:m})]}),o.jsx("span",{className:"badge badge-info",children:e.type}),o.jsxs("button",{className:"btn btn-primary btn-sm run-agent-btn",onClick:()=>{a(e.id),s("run")},title:"Test this agent",children:[o.jsx(fr,{size:14}),"Run"]})]}),o.jsxs("div",{className:"editor-content",children:[o.jsxs(Gi,{id:"basic",title:"Basic Info",icon:o.jsx(zr,{size:16}),expanded:l.has("basic"),onToggle:()=>P("basic"),children:[o.jsx("div",{className:"form-row",children:o.jsxs("div",{className:"form-group full-width",children:[o.jsxs("div",{className:"label-with-action",children:[o.jsx("label",{children:"Description"}),C&&M.instruction&&o.jsx("button",{className:"btn btn-secondary btn-sm generate-btn",onClick:D,disabled:p,title:"Generate description from instruction",children:p?o.jsxs(o.Fragment,{children:[o.jsx(Zn,{size:14,className:"spin"}),"Summarizing..."]}):"Summarize"})]}),o.jsx("input",{type:"text",value:e.description,onChange:S=>y({description:S.target.value}),placeholder:"e.g., Reviews code for bugs and suggests fixes"})]})}),C&&o.jsxs(o.Fragment,{children:[o.jsx("div",{className:"form-row",children:o.jsxs("div",{className:"form-group full-width",children:[o.jsxs("div",{className:"label-with-action",children:[o.jsx("label",{children:"Instruction"}),o.jsxs("div",{className:"action-buttons",children:[o.jsx("button",{className:"btn btn-secondary btn-sm",onClick:()=>g(!h),disabled:u||!M.instruction,title:"Request specific changes to the instruction",children:"Request Changes"}),o.jsx("button",{className:"btn btn-secondary btn-sm",onClick:A,disabled:u,title:"Uses AI to improve and expand the current instruction",children:u?o.jsxs(o.Fragment,{children:[o.jsx(Zn,{size:14,className:"spin"}),"Working..."]}):"Auto-Improve"})]})]}),h&&o.jsxs("div",{className:"request-changes-box",children:[o.jsx("input",{type:"text",value:v,onChange:S=>_(S.target.value),placeholder:"Describe what changes you want...",onKeyDown:S=>{S.key==="Enter"&&v.trim()?$():S.key==="Escape"&&(g(!1),_(""))},autoFocus:!0}),o.jsx("button",{className:"btn btn-primary btn-sm",onClick:$,disabled:u||!v.trim(),children:"Apply"})]}),o.jsx(T4,{value:M.instruction,onChange:S=>y({instruction:S}),placeholder:"Write your agent's instruction here... (Markdown supported)",minHeight:200})]})}),o.jsxs("div",{className:"form-row",children:[o.jsxs("div",{className:"form-group",children:[o.jsx("label",{children:"Output Key"}),o.jsxs("select",{value:M.output_key||"",onChange:S=>y({output_key:S.target.value||void 0}),children:[o.jsx("option",{value:"",children:"None"}),t.app.state_keys.map(S=>o.jsx("option",{value:S.name,children:S.name},S.name))]})]}),o.jsxs("div",{className:"form-group",children:[o.jsx("label",{children:"Include Contents"}),o.jsxs("select",{value:M.include_contents,onChange:S=>y({include_contents:S.target.value}),children:[o.jsx("option",{value:"default",children:"Default"}),o.jsx("option",{value:"none",children:"None"})]})]})]}),o.jsxs("div",{className:"form-row",style:{gap:24},children:[o.jsxs("label",{style:{display:"flex",alignItems:"center",gap:8,fontSize:13},children:[o.jsxs("span",{className:"toggle-switch",children:[o.jsx("input",{type:"checkbox",checked:M.disallow_transfer_to_parent,onChange:S=>y({disallow_transfer_to_parent:S.target.checked})}),o.jsx("span",{className:"toggle-slider"})]}),"Disallow transfer to parent"]}),o.jsxs("label",{style:{display:"flex",alignItems:"center",gap:8,fontSize:13},children:[o.jsxs("span",{className:"toggle-switch",children:[o.jsx("input",{type:"checkbox",checked:M.disallow_transfer_to_peers,onChange:S=>y({disallow_transfer_to_peers:S.target.checked})}),o.jsx("span",{className:"toggle-slider"})]}),"Disallow transfer to peers"]})]})]}),e.type==="LoopAgent"&&o.jsx("div",{className:"form-row",children:o.jsxs("div",{className:"form-group",children:[o.jsx("label",{children:"Max Iterations"}),o.jsx("input",{type:"number",value:e.max_iterations||"",onChange:S=>y({max_iterations:parseInt(S.target.value)||void 0}),placeholder:"No limit"})]})})]}),C&&o.jsx(Gi,{id:"model",title:"Model",icon:o.jsx(Jd,{size:16}),expanded:l.has("model"),onToggle:()=>P("model"),children:o.jsx(L4,{agent:M,appModels:t.app.models||[],defaultModelId:t.app.default_model_id,projectId:t.id,onUpdate:S=>y({model:S})})}),C&&o.jsx(Gi,{id:"tools",title:`Tools (${M.tools.length})`,icon:o.jsx(dn,{size:16}),expanded:l.has("tools"),onToggle:()=>P("tools"),children:o.jsx(M4,{tools:M.tools,onAdd:N,onRemove:F,onUpdate:z,builtinTools:i,mcpServers:r,projectMcpServers:t.mcp_servers,customTools:t.custom_tools,agents:W,skillsets:t.skillsets||[]})}),"sub_agents"in e&&o.jsx(Gi,{id:"subagents",title:`Sub-Agents (${e.sub_agents.length})`,icon:o.jsx(vv,{size:16}),expanded:l.has("subagents"),onToggle:()=>P("subagents"),children:o.jsxs("div",{className:"sub-agent-list",children:[e.sub_agents.map(S=>{const O=t.agents.find(R=>R.id===S);return O?o.jsxs("div",{className:"sub-agent-chip",children:[O.name,o.jsx("button",{onClick:()=>I(S),children:o.jsx(Ue,{size:12})})]},S):null}),o.jsxs("select",{value:"",onChange:S=>{S.target.value&&L(S.target.value)},style:{width:150,padding:"6px 10px",fontSize:13},children:[o.jsx("option",{value:"",children:"Add agent..."}),W.filter(S=>!e.sub_agents.includes(S.id)).map(S=>o.jsx("option",{value:S.id,children:S.name},S.id))]})]})}),o.jsx(Gi,{id:"callbacks",title:"Callbacks",icon:o.jsx(jn,{size:16}),expanded:l.has("callbacks"),onToggle:()=>P("callbacks"),children:o.jsx(R4,{agent:e,onUpdate:y,customCallbacks:t.custom_callbacks||[],isLlmAgent:C})})]})]})}function Gi({id:e,title:t,icon:n,expanded:r,onToggle:i,children:s}){return o.jsxs("div",{className:"section",children:[o.jsxs("div",{className:"section-header",onClick:i,children:[r?o.jsx(It,{size:16}):o.jsx(_t,{size:16}),o.jsxs("h4",{children:[n," ",t]})]}),r&&o.jsx("div",{className:"section-content",children:s})]})}function M4({tools:e,onAdd:t,onRemove:n,onUpdate:r,builtinTools:i,mcpServers:s,projectMcpServers:a,customTools:l,agents:c,skillsets:u}){const[d,p]=k.useState(!1),[f,h]=k.useState({}),[g,v]=k.useState(""),_=Bt.useRef(null),m=Bt.useRef(null),[x,y]=k.useState(null),[j,P]=k.useState(new Set),C=(E,B)=>{if(!g.trim())return!0;const ie=g.toLowerCase();return E.toLowerCase().includes(ie)||((B==null?void 0:B.toLowerCase().includes(ie))??!1)},M=i.filter(E=>C(E.name,E.description)),N=a.filter(E=>C(E.name,E.description)),F=l.filter(E=>C(E.name,E.description)),z=c.filter(E=>C(E.name,E.description)),L=u.filter(E=>C(E.name,E.description));function I(){if(_.current){const E=_.current.getBoundingClientRect(),B=window.innerHeight,ie=350,pe=B-E.bottom-16,fe=E.top-16;if(pe>=200||pe>=fe){const X=Math.min(ie,pe);h({top:E.bottom+4,left:E.left,maxHeight:X})}else{const X=Math.min(ie,fe);h({top:E.top-X-4,left:E.left,maxHeight:X})}}p(!0),v(""),setTimeout(()=>{var E;return(E=m.current)==null?void 0:E.focus()},50)}function W(){p(!1),v("")}function A(E){t({type:"builtin",name:E}),W()}async function $(E){W();const B=E.tool_filter||[];if(y({server:E,enabledTools:new Set(B),availableTools:B.map(ie=>({name:ie,description:""})),isLoading:B.length===0,error:void 0}),B.length===0)try{const{testMcpServer:ie}=await R_(async()=>{const{testMcpServer:fe}=await Promise.resolve().then(()=>i_);return{testMcpServer:fe}},void 0),pe=await ie({connection_type:E.connection_type,command:E.command,args:E.args,env:E.env,url:E.url,headers:E.headers,timeout:E.timeout||30});pe.success?y(fe=>fe?{...fe,availableTools:pe.tools,enabledTools:new Set(pe.tools.map(X=>X.name)),isLoading:!1}:null):y(fe=>fe?{...fe,isLoading:!1,error:pe.error||"Failed to connect to MCP server"}:null)}catch(ie){y(pe=>pe?{...pe,isLoading:!1,error:ie.message}:null)}}function D(E){if(!x)return;const B=new Set(x.enabledTools);B.has(E)?B.delete(E):B.add(E),y({...x,enabledTools:B})}function S(){if(!x)return;const E=Array.from(x.enabledTools);t({type:"mcp",server:{...x.server,tool_filter:E}}),y(null)}function O(E){const B=new Set(j);B.has(E)?B.delete(E):B.add(E),P(B)}function R(E,B){const ie=e[E];if(ie.type!=="mcp"||!ie.server)return;const pe=ie.server.tool_filter||[];let fe;pe.includes(B)?fe=pe.filter(X=>X!==B):fe=[...pe,B],r(E,{...ie,server:{...ie.server,tool_filter:fe}})}function w(E){t({type:"function",name:E.name,module_path:E.module_path}),W()}function V(E){const B=c.find(ie=>ie.id===E);t({type:"agent",agent_id:E,name:B==null?void 0:B.name}),W()}function Y(E){const B=u.find(ie=>ie.id===E);t({type:"skillset",skillset_id:E,name:B==null?void 0:B.name}),W()}function b(E){return s.find(B=>B.name===E)}return o.jsxs("div",{children:[o.jsx("style",{children:`
        .mcp-tool-item {
          border: 1px solid var(--border-color);
          border-radius: var(--radius-md);
          overflow: hidden;
      ...
      `}),o.jsx("div",{className:"tool-list",children:e.map((E,B)=>{var ie;return E.type==="mcp"&&E.server?o.jsxs("div",{className:"mcp-tool-item",children:[o.jsxs("div",{className:"mcp-tool-header",onClick:()=>O(B),children:[j.has(B)?o.jsx(It,{size:14}):o.jsx(_t,{size:14}),o.jsx(dn,{size:14,style:{color:"var(--accent-primary)"}}),o.jsxs("div",{className:"mcp-tool-info",children:[o.jsx("div",{className:"mcp-tool-name",children:E.server.name}),o.jsx("div",{className:"mcp-tool-count",children:E.server.tool_filter===null||E.server.tool_filter===void 0?"all tools":`${E.server.tool_filter.length} tools enabled`})]}),o.jsx("button",{className:"delete-btn",onClick:pe=>{pe.stopPropagation(),n(B)},children:o.jsx(Ue,{size:14})})]}),j.has(B)&&o.jsx("div",{className:"mcp-tool-body",children:o.jsx("div",{className:"mcp-tool-list",children:(()=>{const pe=b(E.server.name),fe=(pe==null?void 0:pe.tool_filter)||E.server.tool_filter||[],X=new Set(E.server.tool_filter||[]);return fe.map(T=>o.jsxs("label",{className:`mcp-tool-chip ${X.has(T)?"enabled":"disabled"}`,onClick:()=>R(B,T),children:[o.jsx("input",{type:"checkbox",checked:X.has(T),onChange:()=>{},style:{display:"none"}}),T]},T))})()})})]},B):E.type==="skillset"?o.jsxs("div",{className:"tool-item",children:[o.jsx(In,{size:14,style:{color:"var(--accent)"}}),o.jsxs("div",{className:"tool-item-info",children:[o.jsx("div",{className:"tool-item-name",children:E.name||((ie=u.find(pe=>pe.id===E.skillset_id))==null?void 0:ie.name)||"SkillSet"}),o.jsx("div",{className:"tool-item-type",children:"skillset"})]}),o.jsx("button",{className:"delete-btn",onClick:()=>n(B),children:o.jsx(Ue,{size:14})})]},B):o.jsxs("div",{className:"tool-item",children:[o.jsx(dn,{size:14,style:{color:"var(--accent-primary)"}}),o.jsxs("div",{className:"tool-item-info",children:[o.jsx("div",{className:"tool-item-name",children:E.name||E.agent_id}),o.jsx("div",{className:"tool-item-type",children:E.type})]}),o.jsx("button",{className:"delete-btn",onClick:()=>n(B),children:o.jsx(Ue,{size:14})})]},B)})}),o.jsxs("div",{className:"add-tool-dropdown",style:{marginTop:12},children:[o.jsxs("button",{ref:_,className:"btn btn-secondary btn-sm",onClick:()=>d?W():I(),children:[o.jsx(Xe,{size:14}),"Add Tool"]}),d&&o.jsxs(o.Fragment,{children:[o.jsx("div",{className:"dropdown-backdrop",onClick:W}),o.jsxs("div",{className:"dropdown-content dropdown-fixed",style:f,children:[o.jsx("div",{className:"dropdown-search",children:o.jsx("input",{ref:m,type:"text",placeholder:"Search tools...",value:g,onChange:E=>v(E.target.value),onKeyDown:E=>E.key==="Escape"&&W()})}),M.length>0&&o.jsxs("div",{className:"dropdown-section",children:[o.jsx("h5",{children:"Built-in Tools"}),M.map(E=>o.jsxs("button",{className:"dropdown-item",onClick:()=>A(E.name),children:[o.jsx("div",{className:"dropdown-item-name",children:E.name}),o.jsx("div",{className:"dropdown-item-desc",children:E.description})]},E.name))]}),N.length>0&&o.jsxs("div",{className:"dropdown-section",children:[o.jsxs("h5",{children:["Project MCP Servers (",N.length,")"]}),N.map(E=>o.jsxs("button",{className:"dropdown-item",onClick:()=>$(E),children:[o.jsxs("div",{className:"dropdown-item-name",children:[E.name,o.jsx("span",{style:{fontSize:11,color:"var(--text-muted)",marginLeft:8},children:E.tool_filter===null||E.tool_filter===void 0?"all tools":`${E.tool_filter.length} tools`})]}),o.jsx("div",{className:"dropdown-item-desc",children:E.description||"Custom MCP server"})]},`project-${E.id||E.name}`))]}),F.length>0&&o.jsxs("div",{className:"dropdown-section",children:[o.jsx("h5",{children:"Custom Tools"}),F.map(E=>o.jsxs("button",{className:"dropdown-item",onClick:()=>w(E),children:[o.jsx("div",{className:"dropdown-item-name",children:E.name}),o.jsx("div",{className:"dropdown-item-desc",children:E.description})]},E.id))]}),z.length>0&&o.jsxs("div",{className:"dropdown-section",children:[o.jsx("h5",{children:"Agents as Tools"}),z.map(E=>o.jsxs("button",{className:"dropdown-item",onClick:()=>V(E.id),children:[o.jsx("div",{className:"dropdown-item-name",children:E.name}),o.jsx("div",{className:"dropdown-item-desc",children:E.type})]},E.id))]}),L.length>0&&o.jsxs("div",{className:"dropdown-section",children:[o.jsxs("h5",{children:["SkillSets (",L.length,")"]}),L.map(E=>o.jsxs("button",{className:"dropdown-item",onClick:()=>Y(E.id),children:[o.jsxs("div",{className:"dropdown-item-name",children:[E.name,o.jsxs("span",{style:{fontSize:11,color:"var(--text-muted)",marginLeft:8},children:[E.entry_count||0," entries"]})]}),o.jsx("div",{className:"dropdown-item-desc",children:E.description||"Vector knowledge base"})]},E.id))]}),g.trim()&&M.length===0&&N.length===0&&F.length===0&&z.length===0&&L.length===0&&o.jsxs("div",{className:"dropdown-section",style:{textAlign:"center",padding:"20px",color:"var(--text-muted)"},children:['No tools matching "',g,'"']})]})]})]}),x&&o.jsx("div",{className:"mcp-config-dialog",children:o.jsxs("div",{className:"mcp-config-content",children:[o.jsxs("h3",{children:["Configure ",x.server.name]}),o.jsx("p",{children:x.server.description}),x.isLoading?o.jsxs("div",{className:"mcp-loading",children:[o.jsx("div",{className:"spinner"}),o.jsx("p",{children:"Connecting to MCP server and discovering tools..."})]}):x.error?o.jsxs("div",{className:"mcp-error",children:[o.jsxs("p",{children:["⚠️ Failed to discover tools: ",x.error]}),o.jsx("p",{className:"hint",children:"You can still add the server, but you won't be able to select specific tools."})]}):o.jsxs(o.Fragment,{children:[o.jsxs("div",{className:"mcp-select-actions",children:[o.jsxs("button",{className:"btn btn-secondary btn-sm",onClick:()=>y({...x,enabledTools:new Set(x.availableTools.map(E=>E.name))}),children:["Select All (",x.availableTools.length,")"]}),o.jsx("button",{className:"btn btn-secondary btn-sm",onClick:()=>y({...x,enabledTools:new Set}),children:"Select None"})]}),o.jsx("div",{className:"mcp-tools-grid",children:x.availableTools.map(E=>o.jsxs("div",{className:"mcp-tool-row",title:E.description||E.name,style:{display:"flex",alignItems:"center",gap:8,padding:"4px 0"},children:[o.jsxs("label",{className:"toggle-switch",style:{margin:0},children:[o.jsx("input",{type:"checkbox",checked:x.enabledTools.has(E.name),onChange:()=>D(E.name)}),o.jsx("span",{className:"toggle-slider"})]}),o.jsx("span",{style:{fontSize:13,opacity:x.enabledTools.has(E.name)?1:.5,cursor:"pointer"},onClick:()=>D(E.name),children:E.name})]},E.name))})]}),o.jsxs("div",{className:"dialog-actions",children:[o.jsx("button",{className:"btn btn-secondary",onClick:()=>y(null),children:"Cancel"}),o.jsxs("button",{className:"btn btn-primary",onClick:S,disabled:x.enabledTools.size===0,children:["Add ",x.enabledTools.size," Tools"]})]})]})})]})}function L4({agent:e,appModels:t,defaultModelId:n,projectId:r,onUpdate:i}){var f,h;const s=(f=e.model)==null?void 0:f._appModelId,a=e.model!==null&&e.model!==void 0&&!s,c=s||(()=>{if(!e.model)return n;const g=t.find(v=>{var _,m,x;return v.provider===((_=e.model)==null?void 0:_.provider)&&v.model_name===((m=e.model)==null?void 0:m.model_name)&&v.api_base===((x=e.model)==null?void 0:x.api_base)});return g==null?void 0:g.id})()||n||((h=t[0])==null?void 0:h.id);Bt.useEffect(()=>{var g,v,_,m,x;if(s){const y=t.find(j=>j.id===s);y&&(((g=e.model)==null?void 0:g.provider)!==y.provider||((v=e.model)==null?void 0:v.model_name)!==y.model_name||((_=e.model)==null?void 0:_.api_base)!==y.api_base||((m=e.model)==null?void 0:m.temperature)!==y.temperature||((x=e.model)==null?void 0:x.max_output_tokens)!==y.max_output_tokens)&&i({provider:y.provider,model_name:y.model_name,api_base:y.api_base,temperature:y.temperature,max_output_tokens:y.max_output_tokens,top_p:y.top_p,top_k:y.top_k,fallbacks:[],_appModelId:s})}},[s,t,e.model,i]);function u(g){const v=t.find(_=>_.id===g);v&&i({provider:v.provider,model_name:v.model_name,api_base:v.api_base,temperature:v.temperature,max_output_tokens:v.max_output_tokens,top_p:v.top_p,top_k:v.top_k,fallbacks:[],_appModelId:g})}function d(){var g;if(a){const v=n||((g=t[0])==null?void 0:g.id);v&&u(v)}else{const v=e.model;if(v){const{_appModelId:_,...m}=v;i(m)}else i({provider:"gemini",model_name:"gemini-2.0-flash",fallbacks:[]})}}function p(g){const{_appModelId:v,..._}=e.model||{};i({..._,...g})}return t.find(g=>g.id===c),t.find(g=>g.id===n),o.jsxs("div",{className:"model-selector",children:[o.jsx("style",{children:`
        .model-selector {
          display: flex;
          flex-direction: column;
          gap: 16px;
      ...
      `}),t.length>0&&o.jsxs("div",{className:"model-choice",children:[o.jsxs("div",{className:`model-option ${a?"":"selected"}`,onClick:()=>!a||d(),children:[o.jsx("div",{className:"model-option-label",children:"Use App Model"}),o.jsx("div",{className:"model-option-desc",children:"Select from configured models"})]}),o.jsxs("div",{className:`model-option ${a?"selected":""}`,onClick:()=>a||d(),children:[o.jsx("div",{className:"model-option-label",children:"Custom"}),o.jsx("div",{className:"model-option-desc",children:"Configure model manually"})]})]}),!a&&t.length>0?o.jsx("div",{className:"app-model-select",children:t.map(g=>o.jsx("div",{className:`app-model-item ${c===g.id?"selected":""}`,onClick:()=>u(g.id),children:o.jsxs("div",{className:"app-model-item-info",children:[o.jsxs("div",{className:"app-model-item-name",children:[g.name,g.id===n&&o.jsxs("span",{className:"default-badge",children:[o.jsx(yv,{size:10,fill:"currentColor"}),"Default"]})]}),o.jsxs("div",{className:"app-model-item-details",children:[g.provider," / ",g.model_name,g.api_base&&` • ${g.api_base}`]})]})},g.id))}):t.length===0?o.jsx("div",{className:"no-models-message",children:"No models configured in App Config. Configure models there first, or use custom settings below."}):null,(a||t.length===0)&&o.jsx("div",{className:"custom-model-form",children:o.jsx(bv,{projectId:r,values:e.model||{},onChange:p})})]})}const mc=[{id:"builtin_exit_loop",name:"exit_on_EXIT_LOOP_NOW",description:'Exits LoopAgent when model says "EXIT LOOP NOW". Use as after_model_callback.',module_path:"exit_on_EXIT_LOOP_NOW",code:"",state_keys_used:[]}];function R4({agent:e,onUpdate:t,customCallbacks:n,isLlmAgent:r}){const i=[...mc,...n],s=[{key:"before_agent_callbacks",label:"Before Agent"},{key:"after_agent_callbacks",label:"After Agent"}],a=[{key:"before_model_callbacks",label:"Before Model"},{key:"after_model_callbacks",label:"After Model"},{key:"before_tool_callbacks",label:"Before Tool"},{key:"after_tool_callbacks",label:"After Tool"}],l=r?[...s,...a]:s;function c(d,p){const f=e[d]||[],h=i.find(g=>g.id===p);h&&t({[d]:[...f,{module_path:h.module_path}]})}function u(d,p){const f=e[d]||[];t({[d]:f.filter((h,g)=>g!==p)})}return o.jsx("div",{className:"callbacks-editor",children:l.map(({key:d,label:p})=>{const f=e[d]||[],h=i;return o.jsxs("div",{className:"callback-type-group",style:{marginBottom:"20px"},children:[o.jsxs("div",{style:{display:"flex",alignItems:"center",justifyContent:"space-between",marginBottom:"8px"},children:[o.jsx("label",{style:{fontWeight:500,fontSize:"13px"},children:p}),h.length>0&&o.jsxs("select",{value:"",onChange:g=>{g.target.value&&(c(d,g.target.value),g.target.value="")},style:{padding:"4px 8px",fontSize:"12px",width:"200px"},children:[o.jsx("option",{value:"",children:"Add callback..."}),o.jsx("optgroup",{label:"Built-in",children:mc.filter(g=>!f.some(v=>v.module_path===g.module_path)).map(g=>o.jsx("option",{value:g.id,children:g.name},g.id))}),o.jsx("optgroup",{label:"Custom",children:n.filter(g=>!f.some(v=>v.module_path===g.module_path)).map(g=>o.jsx("option",{value:g.id,children:g.name},g.id))})]})]}),f.length===0?o.jsx("div",{style:{fontSize:"12px",color:"var(--text-secondary)",fontStyle:"italic",padding:"8px"},children:"No callbacks"}):o.jsx("div",{className:"callback-list",children:f.map((g,v)=>{const _=i.find(x=>x.module_path===g.module_path),m=mc.some(x=>x.module_path===g.module_path);return o.jsxs("div",{className:"callback-chip",style:{display:"flex",alignItems:"center",justifyContent:"space-between",padding:"6px 10px",background:m?"var(--accent-bg, #1a365d)":"var(--bg-secondary)",borderRadius:"4px",marginBottom:"4px"},title:(_==null?void 0:_.description)||"",children:[o.jsxs("span",{style:{fontSize:"12px",display:"flex",alignItems:"center",gap:"6px"},children:[m&&o.jsx("span",{style:{fontSize:"9px",padding:"1px 4px",background:"var(--accent-color, #3182ce)",borderRadius:"3px",textTransform:"uppercase",fontWeight:600},children:"built-in"}),(_==null?void 0:_.name)||g.module_path]}),o.jsx("button",{onClick:()=>u(d,v),style:{background:"none",border:"none",cursor:"pointer",padding:"2px",display:"flex",alignItems:"center"},title:"Remove callback",children:o.jsx(Ue,{size:12})})]},v)})})]},d)})})}const gc=[{type:"LlmAgent",label:"LLM Agent",icon:zr,color:"#00f5d4",description:"AI-powered agent with model reasoning"},{type:"SequentialAgent",label:"Sequential",icon:j_,color:"#7b2cbf",description:"Run sub-agents in order"},{type:"LoopAgent",label:"Loop",icon:w_,color:"#ffd93d",description:"Repeat sub-agents until exit"},{type:"ParallelAgent",label:"Parallel",icon:_u,color:"#ff6b6b",description:"Run sub-agents simultaneously"}];function I4(){return`agent_${Date.now().toString(36)}`}function O4(e){return{provider:e.provider,model_name:e.model_name,api_base:e.api_base,temperature:e.temperature,max_output_tokens:e.max_output_tokens,top_p:e.top_p,top_k:e.top_k,fallbacks:[]}}function $4(e,t){const n=I4(),r={LlmAgent:"new_agent",SequentialAgent:"new_sequence",LoopAgent:"new_loop",ParallelAgent:"new_parallel"},i={id:n,name:r[e]||"new_agent",description:""},s=t?O4(t):{provider:"gemini",model_name:"gemini-2.0-flash",fallbacks:[]};switch(e){case"LlmAgent":return{...i,type:"LlmAgent",model:s,instruction:"",include_contents:"default",disallow_transfer_to_parent:!1,disallow_transfer_to_peers:!1,tools:[],sub_agents:[],output_key:r[e]||"new_agent",before_agent_callbacks:[],after_agent_callbacks:[],before_model_callbacks:[],after_model_callbacks:[],before_tool_callbacks:[],after_tool_callbacks:[]};case"SequentialAgent":return{...i,type:"SequentialAgent",sub_agents:[],before_agent_callbacks:[],after_agent_callbacks:[]};case"LoopAgent":return{...i,type:"LoopAgent",sub_agents:[],max_iterations:10,before_agent_callbacks:[],after_agent_callbacks:[]};case"ParallelAgent":return{...i,type:"ParallelAgent",sub_agents:[],before_agent_callbacks:[],after_agent_callbacks:[]};default:throw new Error(`Unknown agent type: ${e}`)}}function D4({onSelectAgent:e}){const{project:t,addAgent:n,removeAgent:r,updateAgent:i,selectedAgentId:s,setSelectedAgentId:a,mcpServers:l}=ht(),[c,u]=k.useState(new Set),[d,p]=k.useState(!1),[f,h]=k.useState(""),[g,v]=k.useState(new Map),[_,m]=k.useState(380),[x,y]=k.useState(!1),j=k.useRef(null),[P,C]=k.useState(null),M=k.useRef(null),[N,F]=k.useState(null),[z,L]=k.useState(null),I=k.useRef(null),W=k.useRef(null),A=k.useCallback(G=>{G.preventDefault(),y(!0)},[]);if(k.useEffect(()=>{const G=oe=>{if(!x)return;const te=Math.min(Math.max(200,oe.clientX),600);m(te)},q=()=>{y(!1)};return x&&(document.addEventListener("mousemove",G),document.addEventListener("mouseup",q),document.body.style.cursor="col-resize",document.body.style.userSelect="none"),()=>{document.removeEventListener("mousemove",G),document.removeEventListener("mouseup",q),document.body.style.cursor="",document.body.style.userSelect=""}},[x]),k.useEffect(()=>{if(t){const G=t.agents.filter(q=>"sub_agents"in q&&q.sub_agents.length>0).map(q=>q.id);u(new Set(G))}},[t==null?void 0:t.id,t==null?void 0:t.agents.length]),!t)return null;const $=k.useMemo(()=>new Map(t.agents.map(G=>[G.id,G])),[t.agents]);function D(){if(!f.trim()||!t)return;const G=`generating_${Date.now()}`,q=f;v(oe=>new Map(oe).set(G,q)),p(!1),h(""),Zy(t.id,q).then(oe=>{var te,ye,H,re;if(oe.success&&oe.config){const se=oe.config,ge=[];if((te=se.tools)!=null&&te.builtin)for(const _e of se.tools.builtin)ge.push({type:"builtin",name:_e});if((ye=se.tools)!=null&&ye.mcp)for(const _e of se.tools.mcp){const Re=l.find(qe=>qe.name===_e.server);Re&&ge.push({type:"mcp",server:{...Re,tool_filter:_e.tools}})}if((H=se.tools)!=null&&H.custom)for(const _e of se.tools.custom){const Re=t.custom_tools.find(qe=>qe.name===_e);Re&&ge.push({type:"function",name:_e,module_path:Re.module_path})}if((re=se.tools)!=null&&re.agents)for(const _e of se.tools.agents){const Re=t.agents.find(qe=>qe.id===_e);Re&&ge.push({type:"agent",agent_id:_e,name:Re.name})}const ee=t.app.models||[],ce=ee.find(_e=>_e.id===t.app.default_model_id)||ee[0],we=se.name||"new_agent",je={id:`agent_${Date.now().toString(36)}`,type:"LlmAgent",name:we,description:se.description||"",instruction:se.instruction||"",output_key:se.output_key||we,model:ce?{provider:ce.provider,model_name:ce.model_name,api_base:ce.api_base,temperature:ce.temperature,max_output_tokens:ce.max_output_tokens,top_p:ce.top_p,top_k:ce.top_k,fallbacks:[]}:{provider:"gemini",model_name:"gemini-2.0-flash",fallbacks:[]},include_contents:"default",disallow_transfer_to_parent:!1,disallow_transfer_to_peers:!1,tools:ge,sub_agents:se.sub_agents||[],before_agent_callbacks:[],after_agent_callbacks:[],before_model_callbacks:[],after_model_callbacks:[],before_tool_callbacks:[],after_tool_callbacks:[]};n(je),a(je.id),e==null||e(je.id)}else console.error("Failed to generate agent:",oe.error)}).catch(oe=>{console.error("Error generating agent:",oe)}).finally(()=>{v(oe=>{const te=new Map(oe);return te.delete(G),te})})}const S=t.agents.find(G=>G.id===s);function O(G){a(G),e==null||e(G)}function R(G){if(!t)return;const q=t.app.models||[],oe=q.find(ye=>ye.id===t.app.default_model_id)||q[0],te=$4(G,oe);n(te),O(te.id)}function w(G,q){q.stopPropagation(),confirm("Delete this agent?")&&(r(G),s===G&&(e==null||e(null)))}function V(G){const q=new Set(c);q.has(G)?q.delete(G):q.add(G),u(q)}function Y(G){if(!I.current||!M.current)return;const q=I.current.getBoundingClientRect(),oe=G.clientY-q.top,te=60,ye=8;if(oe<te){const H=Math.max(1,ye*(1-oe/te));I.current.scrollTop-=H}else if(oe>q.height-te){const H=Math.max(1,ye*(1-(q.height-oe)/te));I.current.scrollTop+=H}}function b(G,q){G.dataTransfer.setData("text/plain",q),G.dataTransfer.effectAllowed="move",M.current=q,requestAnimationFrame(()=>C(q))}function E(){M.current=null,C(null),F(null),L(null),W.current&&(cancelAnimationFrame(W.current),W.current=null)}function B(G,q,oe){if(!t)return;G.preventDefault(),G.stopPropagation();const te=M.current;if(!te)return;const ye=t.agents.find(H=>H.id===q);!ye||!("sub_agents"in ye)||T(te,q)||(G.dataTransfer.dropEffect="move",L({parentId:q,index:oe}),F(null))}function ie(G,q,oe){if(!t)return;G.preventDefault(),G.stopPropagation();const te=G.dataTransfer.getData("text/plain");if(!te)return;if(te===q||T(te,q)){L(null);return}const ye=t.agents.find(re=>re.id===q);if(!ye||!("sub_agents"in ye))return;t.agents.forEach(re=>{"sub_agents"in re&&re.sub_agents.includes(te)&&i(re.id,{sub_agents:re.sub_agents.filter(se=>se!==te)})});const H=[...ye.sub_agents.filter(re=>re!==te)];H.splice(oe,0,te),i(q,{sub_agents:H}),u(re=>new Set([...re,q])),C(null),L(null)}function pe(G,q,oe){if(!t)return;const te=M.current;G.preventDefault(),G.stopPropagation(),te!==q&&(te&&T(te,q)||(G.dataTransfer.dropEffect="move",F({agentId:q,type:oe}),L(null)))}function fe(G){const q=G.relatedTarget;(!q||!G.currentTarget.contains(q))&&F(null)}function X(G,q,oe){if(!t)return;G.preventDefault(),G.stopPropagation();const te=G.dataTransfer.getData("text/plain");if(!te||te===q)return;if(oe==="sub_agent"&&T(te,q)){C(null),F(null),L(null);return}const ye=t.agents.find(re=>re.id===q),H=t.agents.find(re=>re.id===te);if(!(!ye||!H)){if(oe==="sub_agent")"sub_agents"in ye&&(t.agents.forEach(re=>{"sub_agents"in re&&re.sub_agents.includes(te)&&i(re.id,{sub_agents:re.sub_agents.filter(se=>se!==te)})}),ye.sub_agents.includes(te)||(i(q,{sub_agents:[...ye.sub_agents,te]}),u(re=>new Set([...re,q]))));else if(oe==="tool"&&"tools"in ye){const re=ye;re.tools.some(ge=>ge.type==="agent"&&ge.agent_id===te)||i(q,{tools:[...re.tools,{type:"agent",agent_id:te,name:H.name}]})}C(null),F(null)}}function T(G,q){if(G===q)return!0;const oe=[G],te=new Set;for(;oe.length;){const ye=oe.pop();if(te.has(ye))continue;te.add(ye);const H=$.get(ye);if(!(!H||!("sub_agents"in H)))for(const re of H.sub_agents){if(re===q)return!0;oe.push(re)}}return!1}function K(G){const q=gc.find(oe=>oe.type===G);return q?q.icon:zr}function Z(G){const q=gc.find(oe=>oe.type===G);return q?q.color:"#888"}function ne(G,q=0,oe=new Set){return G.map(te=>{const ye=K(te.type),H=Z(te.type),re="sub_agents"in te&&te.sub_agents.length>0,se="sub_agents"in te,ge=te.type==="LlmAgent",ee=c.has(te.id),ce=P===te.id,we=(N==null?void 0:N.agentId)===te.id&&(N==null?void 0:N.type)==="sub_agent",je=(N==null?void 0:N.agentId)===te.id&&(N==null?void 0:N.type)==="tool",_e=oe.has(te.id),Re=re&&ee&&!_e,qe=Re&&t?te.sub_agents.map(Ee=>t.agents.find(it=>it.id===Ee)).filter(Ee=>Ee!==void 0):[],rt=P&&P!==te.id&&(se||ge);return o.jsxs("div",{className:"agent-tree-item",children:[o.jsxs("div",{className:`agent-item ${s===te.id?"selected":""} ${ce?"dragging":""} ${rt?"drop-target":""}`,onClick:()=>O(te.id),style:{paddingLeft:12+q*20},draggable:!0,onDragStart:Ee=>b(Ee,te.id),onDragEnd:E,onDragOver:Ee=>{rt&&(Ee.preventDefault(),Ee.stopPropagation())},children:[o.jsx("div",{className:"drag-handle",children:o.jsx(h_,{size:12})}),re?o.jsx("button",{className:"expand-btn",onClick:Ee=>{Ee.stopPropagation(),V(te.id)},children:ee?o.jsx(It,{size:16}):o.jsx(_t,{size:16})}):o.jsx("span",{style:{width:20}}),o.jsx("div",{className:"agent-icon",style:{background:H},children:o.jsx(ye,{size:14})}),o.jsx("span",{className:"agent-name",children:te.name}),o.jsx("button",{className:"delete-btn",onClick:Ee=>w(te.id,Ee),children:o.jsx(Ue,{size:14})}),rt&&o.jsxs("div",{className:"drop-overlay",children:[se&&o.jsxs("div",{className:`drop-zone-overlay ${we?"active":""}`,onDragOver:Ee=>pe(Ee,te.id,"sub_agent"),onDragLeave:fe,onDrop:Ee=>X(Ee,te.id,"sub_agent"),children:[o.jsx(vv,{size:12}),o.jsx("span",{children:"Sub-agent"})]}),ge&&o.jsxs("div",{className:`drop-zone-overlay ${je?"active":""}`,onDragOver:Ee=>pe(Ee,te.id,"tool"),onDragLeave:fe,onDrop:Ee=>X(Ee,te.id,"tool"),children:[o.jsx(dn,{size:12}),o.jsx("span",{children:"Tool"})]})]})]}),Re&&o.jsxs("div",{className:"sub-agents",children:[P&&P!==te.id&&o.jsx("div",{className:`insert-indicator ${(z==null?void 0:z.parentId)===te.id&&(z==null?void 0:z.index)===0?"active":""}`,style:{marginLeft:12+(q+1)*20},onDragOver:Ee=>B(Ee,te.id,0),onDragLeave:()=>L(null),onDrop:Ee=>ie(Ee,te.id,0)}),qe.map((Ee,it)=>o.jsxs(Bt.Fragment,{children:[ne([Ee],q+1,new Set([...oe,te.id])),P&&P!==te.id&&P!==Ee.id&&o.jsx("div",{className:`insert-indicator ${(z==null?void 0:z.parentId)===te.id&&(z==null?void 0:z.index)===it+1?"active":""}`,style:{marginLeft:12+(q+1)*20},onDragOver:Je=>B(Je,te.id,it+1),onDragLeave:()=>L(null),onDrop:Je=>ie(Je,te.id,it+1)})]},Ee.id))]})]},te.id)})}const de=new Set(t.agents.flatMap(G=>"sub_agents"in G?G.sub_agents:[])),Q=t.agents.filter(G=>!de.has(G.id)),J=Q.length>0?Q:t.agents;return o.jsxs("div",{className:"agents-panel",children:[o.jsx("style",{children:`
        .agents-panel {
          display: flex;
          gap: 20px;
      ...
      `}),o.jsxs("aside",{className:"agents-sidebar",style:{width:_},children:[o.jsxs("div",{className:"sidebar-header",children:[o.jsxs("h3",{children:["Agents (",t.agents.length,")",g.size>0&&o.jsxs("span",{className:"generating-badge",children:[o.jsx(Zn,{size:12,className:"spin"})," ",g.size]})]}),o.jsxs("div",{className:"header-buttons",children:[gc.map(({type:G,icon:q,color:oe})=>o.jsx("button",{className:"quick-add-btn",style:{background:oe},onClick:()=>R(G),title:`Add ${G}`,children:o.jsx(q,{size:14})},G)),o.jsx("button",{className:"btn btn-secondary btn-sm",onClick:()=>p(!0),title:"AI-powered agent setup",children:o.jsx(ec,{size:14})})]})]}),o.jsx("div",{className:"agents-list",ref:I,onDragOver:Y,children:t.agents.length===0?o.jsxs("div",{className:"empty-state",children:[o.jsx(zr,{size:32}),o.jsx("p",{children:"No agents yet"})]}):ne(J)})]}),o.jsx("div",{ref:j,className:`sidebar-resizer ${x?"resizing":""}`,onMouseDown:A}),o.jsx("div",{className:"agent-editor-area",children:S?o.jsx(P4,{agent:S}):o.jsxs("div",{className:"empty-state card",children:[o.jsx(zr,{size:48}),o.jsxs("p",{children:["Select an agent to edit",o.jsx("br",{}),"or create a new one"]})]})}),d&&o.jsx("div",{className:"type-selector",onClick:()=>p(!1),children:o.jsxs("div",{className:"quick-setup-content",onClick:G=>G.stopPropagation(),children:[o.jsxs("h2",{children:[o.jsx(ec,{size:20})," Quick Agent Setup"]}),o.jsx("p",{className:"quick-setup-desc",children:"Describe what you want this agent to do. Runs in the background - you can start multiple!"}),o.jsxs("div",{className:"quick-setup-form",children:[o.jsx("textarea",{value:f,onChange:G=>h(G.target.value),placeholder:"Example: An agent that searches the web for information and summarizes the results. It should be able to search Google and handle multiple queries in parallel.",rows:5,autoFocus:!0,onKeyDown:G=>{G.key==="Enter"&&(G.metaKey||G.ctrlKey)&&f.trim()&&D()}}),o.jsxs("div",{className:"quick-setup-info",children:[o.jsx("strong",{children:"Available resources:"}),o.jsxs("ul",{children:[o.jsxs("li",{children:[t.app.state_keys.length," state keys"]}),o.jsxs("li",{children:[l.length," MCP servers"]}),o.jsxs("li",{children:[t.custom_tools.length," custom tools"]}),o.jsxs("li",{children:[t.agents.length," existing agents"]})]})]}),o.jsxs("div",{className:"quick-setup-actions",children:[o.jsx("button",{className:"btn btn-secondary",onClick:()=>p(!1),children:"Cancel"}),o.jsxs("button",{className:"btn btn-primary",onClick:D,disabled:!f.trim(),children:[o.jsx(ec,{size:14}),"Generate (⌘↵)"]})]})]})]})})]})}var mp="\x1B[0m",gp="\x1B[1m",p1=e=>e instanceof Error?e.message:typeof e=="string"?e:"An unknown error occurred",F4=e=>{let t=p1(e),n=`${gp}[MONACOPILOT ERROR] ${t}${mp}`;return console.error(n),{message:t}},B4=(e,t)=>{console.warn(`${gp}[MONACOPILOT WARN] ${e}${t?`
...
`;function vE({onSelectTool:e}){const{project:t,updateProject:n,addCustomTool:r,updateCustomTool:i,removeCustomTool:s,selectedToolId:a,setSelectedToolId:l,builtinTools:c,mcpServers:u}=ht(),[d,p]=k.useState(""),[f,h]=k.useState(null),[g,v]=k.useState("tools"),[_,m]=k.useState(null),[x,y]=k.useState(""),[j,P]=k.useState(!1),[C,M]=k.useState(!1),[N,F]=k.useState(!1),[z,L]=k.useState(null),[I,W]=k.useState(null),[A,$]=k.useState({}),[D,S]=k.useState({}),[O,R]=k.useState("");if(!t)return null;const w=t.mcp_servers||[],V=t.custom_tools.find(H=>H.id===a),Y=w.find(H=>H.name===_);function b(H){l(H),e==null||e(H)}k.useEffect(()=>{V&&(p(V.code),W(null))},[a]),k.useEffect(()=>{Y&&(y(JSON.stringify(Y,null,2)),P(!1))},[_]),k.useEffect(()=>{if(!t)return;const H=E(t.mcp_servers||[]);R(JSON.stringify(H,null,2))},[t==null?void 0:t.mcp_servers]),k.useEffect(()=>{if(g==="mcp"&&w.length>0){const H=w.filter(re=>!A[re.name]||A[re.name]==="unknown");H.length>0&&H.forEach(re=>{fe(re.name)})}},[g,w.length]);function E(H){const re={};for(const se of H){const ge={};se.connection_type==="stdio"?(ge.command=se.command||"",ge.args=se.args||[],Object.keys(se.env||{}).length>0&&(ge.env=se.env)):se.connection_type==="sse"&&(ge.url=se.url||"",Object.keys(se.headers||{}).length>0&&(ge.headers=se.headers)),se.timeout&&se.timeout!==30&&(ge.timeout=se.timeout),se.tool_filter&&(ge.tool_filter=se.tool_filter),se.tool_name_prefix&&(ge.tool_name_prefix=se.tool_name_prefix),re[se.name]=ge}return{mcpServers:re}}function B(H){const re=[];for(const[se,ge]of Object.entries(H.mcpServers||{})){const ee={name:se,description:ge.description||"",connection_type:ge.url?"sse":"stdio",command:ge.command,args:ge.args||[],env:ge.env||{},url:ge.url,headers:ge.headers||{},timeout:ge.timeout||30,tool_filter:ge.tool_filter||null,tool_name_prefix:ge.tool_name_prefix};re.push(ee)}return re}function ie(H){H!==void 0&&R(H)}function pe(){try{const H=JSON.parse(O),re=B(H);n({mcp_servers:re})}catch(H){alert("Invalid JSON: "+H.message)}}async function fe(H){const re=w.find(se=>se.name===H);if(re){$(se=>({...se,[H]:"testing"})),S(se=>({...se,[H]:""}));try{const se=await ku({connection_type:re.connection_type,command:re.command,args:re.args,env:re.env,url:re.url,headers:re.headers,timeout:re.timeout});$(ge=>({...ge,[H]:se.success?"connected":"error"})),!se.success&&se.error&&S(ge=>({...ge,[H]:se.error||"Unknown error"}))}catch(se){$(ge=>({...ge,[H]:"error"})),S(ge=>({...ge,[H]:se.message}))}}}function X(H){const re=u.find(ge=>ge.name===H);if(!re)return;if(w.some(ge=>ge.name===H)){alert(`Server "${H}" is already configured`);return}const se={name:re.name,description:re.description||"",connection_type:re.connection_type,command:re.command,args:re.args||[],env:re.env||{},url:re.url,headers:re.headers||{},timeout:re.timeout||30,tool_filter:re.tool_filter||null,tool_name_prefix:re.tool_name_prefix};n({mcp_servers:[...w,se]})}async function T(){for(const H of w)await fe(H.name)}function K(){const H=gE();r({id:H,name:"new_tool",description:"",module_path:"tools.custom",code:yE,state_keys_used:[]}),b(H)}function Z(H,re){re.stopPropagation(),confirm("Delete this tool?")&&(s(H),a===H&&(e==null||e(null)))}function ne(H){V&&(H.name!==void 0&&(H.name===""||xE(H.name)?W(null):W("Name can only contain letters, numbers, and underscores")),i(V.id,H))}function de(H){H!==void 0&&V&&(p(H),ne({code:H}))}async function Q(){if(V){M(!0);try{const H=await ev(t.id,V.name,V.description,V.state_keys_used);H.success&&H.code?(p(H.code),ne({code:H.code})):(console.error("Failed to generate tool code:",H.error),alert("Failed to generate tool code: "+(H.error||"Unknown error")))}catch(H){console.error("Error generating tool code:",H),alert("Error generating tool code: "+H.message)}finally{M(!1)}}}const J=k.useRef(null),G=k.useCallback((H,re)=>{if(J.current&&typeof J.current=="function")try{J.current()}catch{}try{const se=g1(re,H,{language:"python",endpoint:"/api/code-completion",trigger:"onTyping"});typeof se=="function"?J.current=se:J.current=null}catch{J.current=null}},[]);k.useEffect(()=>()=>{if(J.current&&typeof J.current=="function")try{J.current()}catch{}},[]);function q(H){H!==void 0&&(y(H),P(H!==JSON.stringify(Y,null,2)))}function oe(){if(Y)try{const H=JSON.parse(x),re=Y.name,se=w.map(ge=>ge.name===re?H:ge);n({mcp_servers:se}),m(H.name),P(!1)}catch(H){alert("Invalid JSON: "+H.message)}}async function te(){F(!0),L(null);try{const H=JSON.parse(x),re=await ku({connection_type:H.connection_type,command:H.command,args:H.args,env:H.env,url:H.url,headers:H.headers,timeout:H.timeout||30});if(L(re),re.success&&re.tools.length>0){const se={...H,tool_filter:re.tools.map(ge=>ge.name)};y(JSON.stringify(se,null,2)),P(!0)}}catch(H){L({success:!1,tools:[],error:H.message})}finally{F(!1)}}const ye={};return t.custom_tools.forEach(H=>{const re=H.module_path||"tools";ye[re]||(ye[re]=[]),ye[re].push(H)}),o.jsxs("div",{className:"tools-panel",children:[o.jsx("style",{children:`
        .tools-panel {
          display: flex;
          gap: 20px;
          height: calc(100vh - 180px);
      ...
      `}),o.jsxs("aside",{className:"tools-sidebar",children:[o.jsxs("div",{className:"sidebar-tabs",children:[o.jsxs("button",{className:`sidebar-tab ${g==="tools"?"active":""}`,onClick:()=>{v("tools"),m(null)},children:[o.jsx(dn,{size:14}),"Tools"]}),o.jsxs("button",{className:`sidebar-tab ${g==="mcp"?"active":""}`,onClick:()=>{v("mcp"),l(null),h(null),m(null)},children:[o.jsx(qi,{size:14}),"MCP"]})]}),g==="tools"?o.jsxs(o.Fragment,{children:[o.jsxs("div",{className:"sidebar-header",children:[o.jsxs("h3",{children:["Custom Tools (",t.custom_tools.length,")"]}),o.jsxs("button",{className:"btn btn-primary btn-sm",onClick:K,children:[o.jsx(Xe,{size:14}),"New"]})]}),o.jsxs("div",{className:"tools-tree",children:[c.length>0&&o.jsxs("div",{className:"module-group",children:[o.jsxs("div",{className:"module-header",children:[o.jsx(y_,{size:14}),"Built-in Tools"]}),c.map(H=>o.jsxs("div",{className:`tool-item builtin ${(f==null?void 0:f.name)===H.name?"selected":""}`,onClick:()=>{h(H),b(null),m(null)},children:[o.jsx(ju,{size:14}),o.jsx("span",{className:"tool-name",children:H.name})]},H.name))]}),t.custom_tools.length===0&&c.length===0?o.jsxs("div",{className:"empty-state",children:[o.jsx(jn,{size:32}),o.jsx("p",{children:"No tools defined yet"})]}):t.custom_tools.length>0&&Object.entries(ye).map(([H,re])=>o.jsxs("div",{className:"module-group",children:[o.jsxs("div",{className:"module-header",children:[o.jsx(dv,{size:14}),H]}),re.map(se=>o.jsxs("div",{className:`tool-item ${a===se.id?"selected":""}`,onClick:()=>{b(se.id),h(null),m(null)},children:[o.jsx(dn,{size:14}),o.jsx("span",{className:"tool-name",children:se.name}),o.jsx("button",{className:"delete-btn",onClick:ge=>Z(se.id,ge),children:o.jsx(Ue,{size:14})})]},se.id))]},H))]})]}):o.jsxs(o.Fragment,{children:[o.jsxs("div",{className:"sidebar-header",children:[o.jsxs("h3",{children:["MCP Servers (",w.length,")"]}),o.jsx("button",{className:"btn btn-secondary btn-sm",onClick:T,title:"Test all server connections",children:o.jsx(Xt,{size:14})})]}),o.jsx("div",{className:"mcp-servers-list",children:w.length===0?o.jsxs("div",{className:"empty-state",children:[o.jsx(qi,{size:32}),o.jsx("p",{children:"No MCP servers configured"}),o.jsx("p",{style:{fontSize:"12px",color:"var(--text-muted)"},children:"Edit the JSON to add servers"})]}):w.map(H=>{const re=A[H.name]||"unknown",se=D[H.name];return o.jsxs("div",{className:"mcp-server-item-wrapper",children:[o.jsxs("div",{className:"mcp-server-item",children:[o.jsxs("div",{className:"mcp-server-info",children:[o.jsx(qi,{size:14}),o.jsx("span",{className:"mcp-server-name",children:H.name}),o.jsxs("span",{className:`mcp-status-badge ${re}`,children:[re==="testing"?o.jsx(Zn,{size:10,className:"spin"}):null,re==="unknown"&&"●",re==="connected"&&"●",re==="error"&&"●"]})]}),o.jsxs("div",{className:"mcp-server-actions",children:[o.jsx("span",{className:"mcp-server-type",children:H.connection_type}),o.jsxs("button",{className:"btn btn-sm",onClick:()=>fe(H.name),disabled:re==="testing",title:"Test server connection",style:{display:"flex",alignItems:"center",gap:4},children:[re==="testing"?o.jsx(Zn,{size:12,className:"spin"}):o.jsx(Xt,{size:12}),o.jsx("span",{style:{fontSize:11},children:"Test"})]})]})]}),re==="error"&&se&&o.jsxs("div",{className:"mcp-server-error",children:[o.jsx("span",{style:{fontWeight:500,color:"var(--error)"},children:"Error:"})," ",se]})]},H.name)})})]})]}),o.jsx("div",{className:"tool-editor",children:f?o.jsxs(o.Fragment,{children:[o.jsxs("div",{className:"editor-header",children:[o.jsx(ju,{size:20,style:{color:"var(--accent-secondary)"}}),o.jsx("span",{style:{fontSize:"1.1rem",fontWeight:600},children:f.name}),o.jsx("span",{className:"badge badge-muted",children:"Built-in"})]}),o.jsxs("div",{className:"builtin-tool-info",children:[o.jsxs("div",{className:"info-section",children:[o.jsx("h4",{children:"Description"}),o.jsx("p",{children:f.description||"No description available."})]}),o.jsxs("div",{className:"info-section",children:[o.jsx("h4",{children:"Usage"}),o.jsx("p",{children:"This is a built-in tool provided by ADK. Add it to any LLM agent's tools list to enable it."}),o.jsxs("code",{children:['tools: ["',f.name,'"]']})]}),o.jsxs("div",{className:"info-section",children:[o.jsx("h4",{children:"Note"}),o.jsx("p",{children:"Built-in tools are read-only and cannot be modified. Create a custom tool if you need different behavior."})]})]})]}):V?o.jsxs(o.Fragment,{children:[o.jsxs("div",{className:"editor-header",children:[o.jsx(dn,{size:20,style:{color:"var(--accent-primary)"}}),o.jsxs("div",{style:{flex:1,display:"flex",flexDirection:"column",gap:4},children:[o.jsx("input",{type:"text",value:V.name,onChange:H=>ne({name:H.target.value}),placeholder:"Tool name",style:{borderColor:I?"var(--error)":void 0}}),I&&o.jsx("span",{style:{fontSize:11,color:"var(--error)",marginTop:-4},children:I})]})]}),o.jsxs("div",{className:"editor-meta",children:[o.jsxs("div",{className:"meta-field grow",children:[o.jsx("label",{children:"Description"}),o.jsx("input",{type:"text",value:V.description,onChange:H=>ne({description:H.target.value}),placeholder:"What does this tool do?"})]}),o.jsxs("div",{className:"meta-field",children:[o.jsx("label",{children:"Module Path"}),o.jsx("input",{type:"text",value:V.module_path,onChange:H=>ne({module_path:H.target.value}),placeholder:"tools.custom",style:{width:180}})]})]}),o.jsxs("div",{className:"code-actions",children:[o.jsx("button",{className:"btn btn-secondary btn-sm",onClick:Q,disabled:C||!V.name||!V.description,title:!V.name||!V.description?"Add a name and description first":"Generate code using AI",children:C?o.jsxs(o.Fragment,{children:[o.jsx(Zn,{size:14,className:"spinning"}),"Generating..."]}):o.jsxs(o.Fragment,{children:[o.jsx(Qd,{size:14}),"Write Tool"]})}),o.jsx("span",{className:"action-hint",children:"AI will generate code based on the tool name, description, and selected state keys"})]}),o.jsx("div",{className:"code-editor",children:o.jsx(Zt,{height:"100%",language:"python",theme:"vs-dark",value:d,onChange:de,onMount:G,options:{minimap:{enabled:!1},fontSize:13,fontFamily:"'JetBrains Mono', monospace",lineNumbers:"on",scrollBeyondLastLine:!1,automaticLayout:!0,tabSize:4,insertSpaces:!0,padding:{top:12}}})}),o.jsxs("div",{className:"state-keys-panel",children:[o.jsxs("h4",{children:[o.jsx(Gd,{size:14})," State Keys Used"]}),o.jsx("div",{className:"state-key-chips",children:t.app.state_keys.length===0?o.jsx("span",{style:{fontSize:12,color:"var(--text-muted)"},children:"No state keys defined. Add them in App Config."}):t.app.state_keys.map(H=>{const re=V.state_keys_used.includes(H.name);return o.jsxs("label",{className:`state-key-chip ${re?"selected":""}`,title:H.description,children:[o.jsx("input",{type:"checkbox",checked:re,onChange:se=>{const ge=se.target.checked?[...V.state_keys_used,H.name]:V.state_keys_used.filter(ee=>ee!==H.name);ne({state_keys_used:ge})}}),H.name,o.jsxs("span",{style:{color:"var(--text-muted)",fontSize:11},children:["(",H.type,")"]})]},H.name)})})]})]}):Y?o.jsxs(o.Fragment,{children:[o.jsxs("div",{className:"editor-header",children:[o.jsx(qi,{size:20,style:{color:"var(--accent-primary)"}}),o.jsx("span",{style:{fontSize:"1.1rem",fontWeight:600},children:Y.name}),o.jsx("span",{className:"badge badge-info",children:Y.connection_type}),j&&o.jsx("span",{className:"unsaved-badge",children:"Unsaved"}),o.jsxs("button",{className:"btn btn-secondary btn-sm",onClick:te,disabled:N,title:"Test connection and discover available tools",children:[N?o.jsx(Zn,{size:14,className:"spin"}):o.jsx(Kd,{size:14}),N?"Testing...":"Test Connection"]}),o.jsxs("button",{className:"btn btn-primary btn-sm",onClick:oe,disabled:!j,children:[o.jsx(La,{size:14}),"Save"]})]}),z&&o.jsx("div",{className:`mcp-test-result ${z.success?"success":"error"}`,children:z.success?o.jsxs(o.Fragment,{children:[o.jsxs("div",{className:"test-result-header",children:["✓ Connected! Found ",z.tools.length," tools"]}),z.tools.length>0&&o.jsxs("div",{className:"test-result-tools",children:[o.jsx("strong",{children:"Available tools:"}),o.jsx("ul",{children:z.tools.map(H=>o.jsxs("li",{children:[o.jsx("code",{children:H.name}),H.description&&o.jsxs("span",{children:[" — ",H.description]})]},H.name))}),o.jsx("p",{className:"hint",children:'The tool_filter has been updated with these tools. Click "Save" to apply.'})]})]}):o.jsxs(o.Fragment,{children:[o.jsx("div",{className:"test-result-header",children:"✗ Connection failed"}),o.jsx("div",{className:"test-result-error",children:z.error})]})}),o.jsx("div",{className:"mcp-info",children:o.jsx("p",{children:'Configure your MCP server using JSON. Click "Test Connection" to verify and discover available tools.'})}),o.jsx("div",{className:"code-editor",children:o.jsx(Zt,{height:"100%",language:"json",theme:"vs-dark",value:x,onChange:q,options:{minimap:{enabled:!1},fontSize:13,fontFamily:"'JetBrains Mono', monospace",lineNumbers:"on",scrollBeyondLastLine:!1,automaticLayout:!0,tabSize:2,insertSpaces:!0,padding:{top:12},formatOnPaste:!0}})}),o.jsxs("div",{className:"mcp-help",children:[o.jsx("h4",{children:"Schema Reference"}),o.jsxs("div",{className:"schema-fields",children:[o.jsxs("div",{className:"schema-field",children:[o.jsx("code",{children:"name"}),o.jsx("span",{children:"Unique identifier for this server"})]}),o.jsxs("div",{className:"schema-field",children:[o.jsx("code",{children:"description"}),o.jsx("span",{children:"Human-readable description"})]}),o.jsxs("div",{className:"schema-field",children:[o.jsx("code",{children:"connection_type"}),o.jsx("span",{children:'"stdio" | "sse" | "http"'})]}),o.jsxs("div",{className:"schema-field",children:[o.jsx("code",{children:"command"}),o.jsx("span",{children:"Command to run (for stdio)"})]}),o.jsxs("div",{className:"schema-field",children:[o.jsx("code",{children:"args"}),o.jsx("span",{children:"Array of command arguments"})]}),o.jsxs("div",{className:"schema-field",children:[o.jsx("code",{children:"env"}),o.jsx("span",{children:"Environment variables object"})]}),o.jsxs("div",{className:"schema-field",children:[o.jsx("code",{children:"url"}),o.jsx("span",{children:"Server URL (for sse/http)"})]}),o.jsxs("div",{className:"schema-field",children:[o.jsx("code",{children:"tool_filter"}),o.jsx("span",{children:"Array of tool names to include (null/omit = all tools, [] = no tools)"})]})]})]})]}):g==="mcp"?o.jsxs("div",{className:"mcp-json-editor",children:[o.jsxs("div",{className:"editor-header",children:[o.jsx(qi,{size:20,style:{color:"var(--accent-primary)"}}),o.jsx("span",{style:{fontSize:"1.1rem",fontWeight:600},children:"mcp.json"}),o.jsx("span",{className:"badge badge-muted",children:"Model Context Protocol"}),o.jsxs("select",{value:"",onChange:H=>{H.target.value&&X(H.target.value)},style:{padding:"6px 10px",fontSize:"12px",borderRadius:"6px",background:"var(--bg-tertiary)",border:"1px solid var(--border-color)",color:"var(--text-primary)"},children:[o.jsx("option",{value:"",children:"+ Add known server..."}),u.filter(H=>!w.some(re=>re.name===H.name)).map(H=>o.jsxs("option",{value:H.name,children:[H.name," - ",H.description||"No description"]},H.name))]}),o.jsxs("button",{className:"btn btn-primary btn-sm",onClick:pe,children:[o.jsx(La,{size:14}),"Apply Changes"]})]}),o.jsx("div",{className:"mcp-json-info",children:o.jsxs("p",{children:["Configure your MCP servers using the standard ",o.jsx("code",{children:"mcp.json"})," format. Select a known server from the dropdown to add its configuration."]})}),o.jsx("div",{className:"editor-content",style:{flex:1},children:o.jsx(Zt,{height:"100%",defaultLanguage:"json",value:O,onChange:ie,theme:"vs-dark",options:{minimap:{enabled:!1},fontSize:14,lineNumbers:"on",scrollBeyondLastLine:!1,wordWrap:"on",tabSize:2,formatOnPaste:!0,formatOnType:!0}})})]}):o.jsxs("div",{className:"empty-state",children:[o.jsx(jn,{size:48}),o.jsxs("p",{children:["Select a tool to view",o.jsx("br",{}),"or create a new custom tool"]})]})})]})}function bE(){return`callback_${Date.now().toString(36)}`}function Am(e){return/^[a-zA-Z0-9_]+$/.test(e)}function x1(e){switch(e){case"before_agent":case"after_agent":return`from google.adk.agents.callback_context import CallbackContext
...
def my_callback(tool: BaseTool, tool_args: Dict[str, Any], tool_context: ToolContext, result: Dict) -> Optional[Dict]:
    ...
    return None
`;default:return x1("before_agent")}}function wE({onSelectCallback:e}){var N,F;const{project:t,updateProject:n,addCustomCallback:r,updateCustomCallback:i,removeCustomCallback:s}=ht(),[a,l]=k.useState(""),[c,u]=k.useState(null),[d,p]=k.useState(null),[f,h]=k.useState(!1),g=k.useRef(null);if(!t)return null;const v=t.custom_callbacks||[],_=v.find(z=>z.id===c);function m(z){u(z),e==null||e(z)}k.useEffect(()=>{_?(l(_.code),p(null)):l("")},[c,_]);function x(){const z=bE(),L="new_callback",I={id:z,name:L,description:"",module_path:`callbacks.${L}`,code:x1("before_agent"),state_keys_used:[]};r(I),m(z)}function y(z,L){L.stopPropagation(),confirm("Delete this callback?")&&(s(z),c===z&&(e==null||e(null),u(null),l("")))}function j(){if(!c)return;const z=v.find(W=>W.id===c);if(!z)return;const L=z.name.trim();if(!L){alert("Please enter a name");return}if(!Am(L)){p("Name must contain only alphanumeric characters and underscores");return}if(v.find(W=>W.name===L&&W.id!==z.id)){p("A callback with this name already exists");return}i(z.id,{code:a,name:L,description:z.description,module_path:`callbacks.${L}`,state_keys_used:z.state_keys_used}),p(null)}function P(z,L){g.current=L;try{g1(L,{endpoint:"/api/code-completion",language:"python"})}catch(I){console.warn("Failed to register Monacopilot completion:",I)}}async function C(){if(_){h(!0);try{let z="before_agent";const L=_.name.toLowerCase(),I=_.description.toLowerCase();L.includes("after_agent")||I.includes("after agent")?z="after_agent":L.includes("before_model")||I.includes("before model")?z="before_model":L.includes("after_model")||I.includes("after model")?z="after_model":L.includes("before_tool")||I.includes("before tool")?z="before_tool":L.includes("after_tool")||I.includes("after tool")?z="after_tool":(L.includes("before_agent")||I.includes("before agent"))&&(z="before_agent");const W=await tv(t.id,_.name,_.description,z,_.state_keys_used);W.success&&W.code?(l(W.code),i(_.id,{code:W.code})):(console.error("Failed to generate callback code:",W.error),alert("Failed to generate callback code: "+(W.error||"Unknown error")))}catch(z){console.error("Error generating callback code:",z),alert("Error generating callback code: "+z.message)}finally{h(!1)}}}const M=((F=(N=t.app)==null?void 0:N.state_keys)==null?void 0:F.map(z=>z.name))||[];return o.jsxs("div",{className:"tools-panel",children:[o.jsx("style",{children:`
        .tools-panel {
          display: flex;
          height: 100%;
          background: var(--bg-primary);
...
`),isError:t.isError===!0}:{text:typeof t=="string"?t:JSON.stringify(t,null,2),isError:!1}}function dg(e,t){if(!t||!t.trim())return e;const n=t.trim();let r=e;try{r=JSON.parse(e)}catch{}if(n.startsWith("js:")){const i=n.slice(3).trim();try{const a=new Function("value","data",`return ${i}`)(e,r);return typeof a=="string"?a:JSON.stringify(a,null,2)}catch(s){return`[JS error: ${s}]`}}if(n.startsWith("."))try{const i=n.slice(1).split(".").filter(Boolean);let s=r;for(const a of i){const l=a.match(/^(\w+)?\[(\d+)\]$/);l?(l[1]&&(s=s[l[1]]),s=s[parseInt(l[2])]):s=s[a]}return s==null?"[No match]":typeof s=="string"?s:JSON.stringify(s,null,2)}catch(i){return`[Path error: ${i.message}]`}try{const s=new Function("value","data",`return ${n}`)(e,r);return typeof s=="string"?s:JSON.stringify(s,null,2)}catch(i){return`[Transform error: ${i.message}]`}}function O5({project:e,selectedEventIndex:t,sandboxMode:n}){var pe,fe;const{watches:r,updateWatch:i,addWatch:s,removeWatch:a,runEvents:l}=ht(),[c,u]=k.useState(!1),[d,p]=k.useState(null),[f,h]=k.useState({}),[g,v]=k.useState(new Set),[_,m]=k.useState(""),[x,y]=k.useState(""),[j,P]=k.useState({}),[C,M]=k.useState(""),[N,F]=k.useState([]),[z,L]=k.useState(null),[I,W]=k.useState(null),[A,$]=k.useState(!1);k.useEffect(()=>{Hd().then(F).catch(console.error)},[]);const D=k.useMemo(()=>{const X=e.mcp_servers||[],T=new Set(X.map(Z=>Z.name)),K=N.filter(Z=>!T.has(Z.name));return[...X,...K]},[e.mcp_servers,N]),S=k.useCallback(async X=>{if(!(f[X]||g.has(X))){v(T=>new Set([...T,X]));try{const T=await Ce(`/projects/${e.id}/mcp-servers/${encodeURIComponent(X)}/test-connection`,{method:"POST"});T.success&&h(K=>({...K,[X]:T.tools}))}catch(T){console.error("Failed to load tools:",T)}finally{v(T=>{const K=new Set(T);return K.delete(X),K})}}},[e.id,f,g]);k.useEffect(()=>{var Z;if(d)return;if(!_||!x){P({});return}const T=(f[_]||[]).find(ne=>ne.name===x);if(!((Z=T==null?void 0:T.parameters)!=null&&Z.properties)){P({});return}const K={};Object.entries(T.parameters.properties).forEach(([ne,de])=>{de.type==="string"?K[ne]=de.default||"":de.type==="number"||de.type==="integer"?K[ne]=de.default||0:de.type==="boolean"?K[ne]=de.default||!1:K[ne]=de.default||null}),P(K)},[_,x,f,d]);const O=()=>{p(null),m(""),y(""),P({}),M(""),L(null),W(null),u(!0)},R=X=>{if(p(X.id),m(X.serverName),y(X.toolName),P({...X.args}),M(X.transform||""),X.result){const{text:T}=_c(X.result);L(T),W(null)}else L(null),W(null);f[X.serverName]||S(X.serverName),u(!0)},w=async()=>{var T;if(!_||!x)return;$(!0),W(null);const X=((T=e.app)==null?void 0:T.id)||`app_${e.id}`;try{const K=await Ce(`/projects/${e.id}/run-mcp-tool`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({server_name:_,tool_name:x,arguments:j,sandbox_mode:n,app_id:n?X:void 0})}),{text:Z,isError:ne}=_c(K);ne?(W(Z),L(null)):(L(Z),W(null))}catch(K){W(String(K)),L(null)}finally{$(!1)}},V=k.useMemo(()=>z?!C||!C.trim()?z:dg(z,C):null,[z,C]),Y=()=>{if(!(!_||!x)){if(d){i(d,{serverName:_,toolName:x,args:{...j},transform:C||void 0});const X=r.find(T=>T.id===d);X&&E({...X,serverName:_,toolName:x,args:j,transform:C||void 0,history:X.history||[]})}else{const X={id:`watch-${Date.now()}`,serverName:_,toolName:x,args:{...j},transform:C||void 0,history:[]};s(X),E(X)}u(!1)}},b=X=>{a(X)},E=k.useCallback(async(X,T)=>{var de;i(X.id,{isLoading:!0,error:void 0});const K=T??l.length-1,Z=Date.now(),ne=((de=e.app)==null?void 0:de.id)||`app_${e.id}`;try{const Q=await Ce(`/projects/${e.id}/run-mcp-tool`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({server_name:X.serverName,tool_name:X.toolName,arguments:X.args,sandbox_mode:n,app_id:n?ne:void 0})}),J={eventIndex:K,timestamp:Z,result:Q},G=[...X.history||[],J];i(X.id,{result:Q,isLoading:!1,lastRun:Z,history:G})}catch(Q){const J={eventIndex:K,timestamp:Z,error:String(Q)},G=[...X.history||[],J];i(X.id,{error:String(Q),isLoading:!1,lastRun:Z,history:G})}},[e.id,(pe=e.app)==null?void 0:pe.id,i,l.length,n]),B=()=>{r.forEach(X=>E(X))},ie=k.useMemo(()=>!_||!x?null:(f[_]||[]).find(T=>T.name===x),[_,x,f]);return o.jsxs("div",{className:"tool-watch-panel",children:[o.jsxs("div",{className:"watch-header",children:[o.jsx(Or,{size:14}),o.jsx("span",{children:"Tool Watch"}),o.jsx("span",{className:"watch-auto-badge",title:"Watches auto-refresh on every event",children:"⚡ Auto"}),o.jsxs("div",{className:"watch-actions",children:[o.jsx("button",{className:"watch-btn",onClick:B,title:"Refresh all",children:o.jsx(Xt,{size:12})}),o.jsx("button",{className:"watch-btn",onClick:O,title:"Add watch",children:o.jsx(Xe,{size:12})})]})]}),r.length===0?o.jsxs("div",{className:"watch-empty",children:[o.jsx(Or,{size:20,style:{opacity:.3}}),o.jsx("span",{children:"No watch expressions"}),o.jsxs("button",{className:"add-watch-btn",onClick:O,children:[o.jsx(Xe,{size:12})," Add Tool Watch"]})]}):o.jsx("div",{className:"watch-list",children:r.map(X=>{let T=X.result,K=X.error;if(t!==null&&X.history&&X.history.length>0){const J=X.history.filter(G=>G.eventIndex<=t);if(J.length>0){const G=J[J.length-1];T=G.result,K=G.error}else T=void 0,K=void 0}const{text:Z,isError:ne}=T?_c(T):{text:"",isError:!1},de=T?dg(Z,X.transform):"",Q=K||ne;return o.jsxs("div",{className:`watch-item ${Q?"error":""}`,children:[o.jsxs("div",{className:"watch-item-header",children:[o.jsxs("span",{className:"watch-expr",children:[o.jsx("span",{className:"watch-server",children:X.serverName}),o.jsx("span",{className:"watch-tool",children:X.toolName}),Object.keys(X.args).length>0&&o.jsxs("span",{className:"watch-args",children:["(",Object.entries(X.args).map(([J,G])=>`${J}=${JSON.stringify(G)}`).join(", "),")"]}),t!==null&&o.jsxs("span",{className:"watch-time-indicator",children:["@",t]})]}),o.jsxs("div",{className:"watch-item-actions",children:[o.jsx("button",{onClick:()=>R(X),title:"Edit watch",children:o.jsx(dn,{size:10})}),o.jsx("button",{onClick:()=>E(X),title:"Refresh",children:X.isLoading?o.jsx(Xt,{size:10,className:"spin"}):o.jsx(Xt,{size:10})}),o.jsx("button",{onClick:()=>b(X.id),title:"Remove",children:o.jsx(Ue,{size:10})})]})]}),o.jsx("div",{className:"watch-result",children:X.isLoading?o.jsx("span",{className:"loading",children:"Loading..."}):K?o.jsx("span",{className:"error",children:K}):T?o.jsx("pre",{className:ne?"error-text":"",children:de}):o.jsx("span",{className:"no-result",children:t!==null?"No data at this event":"Not yet run"})})]},X.id)})}),c&&o.jsx("div",{className:"watch-dialog-overlay",onClick:()=>u(!1),children:o.jsxs("div",{className:"watch-dialog",onClick:X=>X.stopPropagation(),children:[o.jsxs("div",{className:"dialog-header",children:[o.jsx("span",{children:d?"Edit Watch":"Add Tool Watch"}),o.jsx("button",{onClick:()=>u(!1),children:o.jsx(Ur,{size:14})})]}),o.jsxs("div",{className:"dialog-body",children:[o.jsxs("div",{className:"form-row",children:[o.jsx("label",{children:"MCP Server"}),o.jsxs("select",{value:_,onChange:X=>{m(X.target.value),d||y(""),X.target.value&&S(X.target.value)},children:[o.jsx("option",{value:"",children:"Select server..."}),D.map(X=>o.jsx("option",{value:X.name,children:X.name},X.name))]})]}),o.jsxs("div",{className:"form-row",children:[o.jsx("label",{children:"Tool"}),o.jsxs("select",{value:x,onChange:X=>y(X.target.value),disabled:!_||g.has(_),children:[o.jsx("option",{value:"",children:g.has(_)?"Loading tools...":"Select tool..."}),(f[_]||[]).map(X=>o.jsx("option",{value:X.name,children:X.name},X.name))]})]}),(ie==null?void 0:ie.description)&&o.jsx("div",{className:"tool-desc",children:ie.description}),((fe=ie==null?void 0:ie.parameters)==null?void 0:fe.properties)&&Object.keys(ie.parameters.properties).length>0&&o.jsxs("div",{className:"tool-args",children:[o.jsx("label",{children:"Arguments"}),Object.entries(ie.parameters.properties).map(([X,T])=>{var K,Z;return o.jsxs("div",{className:"arg-row",children:[o.jsxs("span",{className:"arg-name",children:[X,((K=ie.parameters.required)==null?void 0:K.includes(X))&&o.jsx("span",{className:"required",children:"*"})]}),o.jsx("input",{type:T.type==="number"||T.type==="integer"?"number":"text",value:typeof j[X]=="object"?JSON.stringify(j[X]):j[X]??"",onChange:ne=>P(de=>({...de,[X]:ne.target.value})),placeholder:((Z=T.description)==null?void 0:Z.slice(0,40))||X})]},X)})]}),_&&x&&o.jsxs("div",{className:"test-section",children:[o.jsxs("div",{className:"test-header",children:[o.jsx("label",{children:"Test & Preview"}),o.jsxs("button",{className:"test-btn",onClick:w,disabled:A,children:[A?o.jsx(Xt,{size:12,className:"spin"}):o.jsx(fr,{size:12}),A?"Running...":"Test Run"]})]}),I&&o.jsxs("div",{className:"test-result error",children:[o.jsx("span",{className:"test-label",children:"Error:"}),o.jsx("pre",{children:I})]}),z&&o.jsxs("div",{className:"test-result",children:[o.jsx("span",{className:"test-label",children:"Raw Result:"}),o.jsx("pre",{children:z})]})]}),o.jsxs("div",{className:"form-row transform-row",children:[o.jsx("label",{children:"Transform (optional)"}),o.jsx("input",{type:"text",value:C,onChange:X=>M(X.target.value),placeholder:"e.g., .items[0].name or .content[].text"}),o.jsxs("div",{className:"transform-hints",children:[o.jsx("span",{className:"hint-title",children:"Path:"}),o.jsx("code",{onClick:()=>M(".items[0].name"),children:".items[0].name"}),o.jsx("code",{onClick:()=>M(".content[0].text"),children:".content[0].text"}),o.jsx("code",{onClick:()=>M(".result.data"),children:".result.data"}),o.jsx("span",{className:"hint-title",children:"JS:"}),o.jsx("code",{onClick:()=>M("js:value.split('\\n')[0]"),children:"js:value.split('\\n')[0]"}),o.jsx("code",{onClick:()=>M("js:data.items?.length"),children:"js:data.items?.length"})]})]}),z&&C&&o.jsxs("div",{className:"transform-preview",children:[o.jsx("span",{className:"test-label",children:"Transform Preview:"}),o.jsx("pre",{className:V!=null&&V.startsWith("[Transform error")?"error":"",children:V})]})]}),o.jsxs("div",{className:"dialog-footer",children:[o.jsx("button",{className:"cancel-btn",onClick:()=>u(!1),children:"Cancel"}),o.jsx("button",{className:"add-btn",onClick:Y,disabled:!_||!x,children:d?"Save Changes":"Add Watch"})]})]})})]})}function $5(){var Rp,Ip;const{project:e,updateProject:t,isRunning:n,setIsRunning:r,runEvents:i,addRunEvent:s,clearRunEvents:a,clearWatchHistories:l,runAgentId:c,setRunAgentId:u,watches:d,updateWatch:p,currentSessionId:f,setCurrentSessionId:h}=ht(),[g,v]=k.useState(""),[_,m]=k.useState(null),[x,y]=k.useState(null),[j,P]=k.useState(null),[C,M]=k.useState(""),[N,F]=k.useState(new Set(["agent_start","agent_end","tool_call","tool_result","model_call","model_response","state_change","callback_start","callback_end","callback_error"])),[z,L]=k.useState(()=>{const U=localStorage.getItem("sandboxMode");return U!==null?U==="true":!0});k.useEffect(()=>{localStorage.setItem("sandboxMode",String(z))},[z]);const[I,W]=k.useState(null),[A,$]=k.useState(!1),[D,S]=k.useState({}),[O,R]=k.useState(!1),[w,V]=k.useState("agent"),Y=k.useRef(null),b=k.useRef(!0),E=k.useRef(0),[B,ie]=k.useState(!0),[pe,fe]=k.useState(!0),[X,T]=k.useState(!1),[K,Z]=k.useState(!1),[ne,de]=k.useState(360),[Q,J]=k.useState(!1),[G,q]=k.useState(!1),[oe,te]=k.useState(!1),[ye,H]=k.useState([]),re=k.useRef(null);k.useEffect(()=>{if(!e)return;const U=`promptHistory_${e.id}`,ae=localStorage.getItem(U);if(ae)try{const me=JSON.parse(ae),be=Object.entries(me).map(([he,Te])=>({prompt:he,count:Te})).sort((he,Te)=>Te.count-he.count);H(be)}catch(me){console.error("Failed to parse prompt history:",me)}else H([])},[e==null?void 0:e.id]);const se=k.useCallback(U=>{const ae=U.trim();if(!ae||!e)return;const me=`promptHistory_${e.id}`,be=localStorage.getItem(me),he=be?JSON.parse(be):{};he[ae]=(he[ae]||0)+1,localStorage.setItem(me,JSON.stringify(he));const Te=Object.entries(he).map(([Me,Mt])=>({prompt:Me,count:Mt})).sort((Me,Mt)=>Mt.count-Me.count);H(Te)},[e]),ge=k.useMemo(()=>{const U=g.toLowerCase().trim();return ye.filter(ae=>!U||ae.prompt.toLowerCase().includes(U)).slice(0,10)},[ye,g]),[ee,ce]=k.useState([60,80,100,80,1]),[we,je]=k.useState(null),_e=k.useRef(0),Re=k.useRef(0),[qe,rt]=k.useState([]),[Ee,it]=k.useState(null),[Je,Nn]=k.useState(!1),Jt=k.useRef(0),Ep=k.useCallback(async(U,ae)=>{var Te;if(!e)return;p(U.id,{isLoading:!0,error:void 0});const me=ae??i.length-1,be=Date.now(),he=((Te=e.app)==null?void 0:Te.id)||`app_${e.id}`;try{const Me=await Ce(`/projects/${e.id}/run-mcp-tool`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({server_name:U.serverName,tool_name:U.toolName,arguments:U.args,sandbox_mode:z,app_id:z?he:void 0})}),Mt={eventIndex:me,timestamp:be,result:Me},hn=[...U.history||[],Mt];p(U.id,{result:Me,isLoading:!1,lastRun:be,history:hn})}catch(Me){const Mt={eventIndex:me,timestamp:be,error:String(Me)},hn=[...U.history||[],Mt];p(U.id,{error:String(Me),isLoading:!1,lastRun:be,history:hn})}},[e==null?void 0:e.id,(Rp=e==null?void 0:e.app)==null?void 0:Rp.id,p,i.length,z]);k.useEffect(()=>{if(i.length>Jt.current&&d.length>0){const U=i.length-1;d.forEach(ae=>{ae.isLoading||Ep(ae,U)})}Jt.current=i.length},[i.length,d,Ep]),k.useEffect(()=>{c!==null&&(zp(c),u(null))},[c,u]);const[Li,zp]=k.useState(null),cs=k.useRef(null),wl=k.useRef(null);k.useEffect(()=>{if(!Q)return;const U=me=>{if(!wl.current)return;const he=wl.current.getBoundingClientRect().right-me.clientX;de(Math.min(600,Math.max(200,he)))},ae=()=>{J(!1)};return document.addEventListener("mousemove",U),document.addEventListener("mouseup",ae),()=>{document.removeEventListener("mousemove",U),document.removeEventListener("mouseup",ae)}},[Q]),k.useEffect(()=>{if(we===null)return;const U=me=>{const be=me.clientX-_e.current,he=Math.max(40,Re.current+be);ce(Te=>{const Me=[...Te];return Me[we]=he,Me})},ae=()=>{je(null)};return document.addEventListener("mousemove",U),document.addEventListener("mouseup",ae),document.body.style.cursor="col-resize",document.body.style.userSelect="none",()=>{document.removeEventListener("mousemove",U),document.removeEventListener("mouseup",ae),document.body.style.cursor="",document.body.style.userSelect=""}},[we]);const us=(U,ae)=>{ae.preventDefault(),_e.current=ae.clientX,Re.current=ee[U],je(U)},Tp=ee.map((U,ae)=>ae===ee.length-1?`minmax(${U}px, 1fr)`:`${U}px`).join(" "),q1=k.useMemo(()=>i.length===0?{min:0,max:0}:{min:i[0].timestamp,max:i[i.length-1].timestamp},[i]),Pt=k.useMemo(()=>i.filter((U,ae)=>{var me,be,he;if(j&&(U.timestamp<j[0]||U.timestamp>j[1])||N.size>0&&!N.has(U.event_type))return!1;if(B&&U.event_type==="model_response"){const Te=((be=(me=U.data)==null?void 0:me.response_content)==null?void 0:be.parts)||((he=U.data)==null?void 0:he.parts)||[],Me=Te.some(hn=>hn.type==="function_call"),Mt=Te.some(hn=>hn.type==="text");if(!Me&&!Mt)return!1}return!(C&&!JSON.stringify(U).toLowerCase().includes(C.toLowerCase()))}),[i,j,N,C,B]),ds=k.useMemo(()=>{var be;let U=0,ae=0;const me=x!==null?x+1:i.length;for(let he=0;he<me;he++){const Te=i[he];Te.event_type==="model_response"&&((be=Te.data)!=null&&be.token_counts)&&(U+=Te.data.token_counts.input||0,ae+=Te.data.token_counts.output||0)}return{input:U,output:ae,total:U+ae}},[i,x]),Ap=x!==null?i[x]:null;k.useEffect(()=>{if(!e){rt([]);return}(async()=>{Nn(!0);try{const ae=await wu(e.id);rt(ae)}catch(ae){console.error("Failed to load sessions:",ae),rt([])}finally{Nn(!1)}})()},[e]);const kl=k.useCallback(async U=>{if(!e){it(null);return}if(!U){a(),l(),h(null),it(null),y(null),P(null);return}try{const ae=await Jy(e.id,U);a(),l(),h(ae.id),it(U),y(null),P(null);for(const me of ae.events)s(me)}catch(ae){alert(`Failed to load session: ${ae.message||"Unknown error"}`)}},[e,a,l,h,s]);k.useEffect(()=>{if(!e||qe.length===0||Je)return;const ae=new URLSearchParams(window.location.search).get("session");if(ae)if(qe.some(be=>be.id===ae)){kl(ae);const be=window.location.pathname;window.history.replaceState({},"",be)}else console.warn(`Session ${ae} not found in available sessions`)},[e,qe,Je,kl]),k.useEffect(()=>{n&&cs.current&&(cs.current.scrollTop=cs.current.scrollHeight)},[i.length,n]);const Ri=k.useCallback(U=>{const ae=U??g;if(!e||!ae.trim()||n)return;q(!0),se(ae),te(!1),v(ae),_&&(_.close(),m(null)),a(),l(),it(null),h(null),r(!0),y(null),P(null);const me=Xy(e.id);m(me),me.onopen=()=>{me.send(JSON.stringify({message:ae,agent_id:Li||void 0,sandbox_mode:z}))},me.onmessage=be=>{var Te;const he=JSON.parse(be.data);if(he.event_type==="agent_start"&&((Te=he.data)!=null&&Te.session_id)){const Me=he.data.session_id;he.data.session_reused,h(Me),Me&&qe.some(Mt=>Mt.id===Me)&&it(Me)}else if(he.type==="session_started")h(he.session_id),he.session_id&&qe.some(Me=>Me.id===he.session_id)&&it(he.session_id);else if(he.type==="sandbox_starting")s({timestamp:Date.now()/1e3,event_type:"agent_start",agent_name:"sandbox",data:{message:"Starting Docker sandbox..."}});else if(he.type==="sandbox_started")s({timestamp:Date.now()/1e3,event_type:"agent_start",agent_name:"sandbox",data:{message:`Sandbox started (ID: ${he.sandbox_id})`}});else if(he.type==="sandbox_response")s({timestamp:Date.now()/1e3,event_type:"model_response",agent_name:"sandbox",data:he.data});else if(he.event_type==="approval_required"||he.type==="network_request"&&he.event_type==="approval_required"){const Me={id:he.id,method:he.method||"GET",url:he.url,host:he.host,source:he.source||"agent",headers:he.headers||{},timeout:he.timeout||30};W(Me),s({timestamp:Date.now()/1e3,event_type:"callback_start",agent_name:"sandbox",data:{callback_name:"network_approval",callback_type:"approval",message:`⚠️ Network request to ${he.host} requires approval`,host:he.host,url:he.url}})}else he.type==="completed"?(r(!1),me.close()):he.type==="error"?(r(!1),s({timestamp:Date.now()/1e3,event_type:"agent_end",agent_name:"system",data:{error:he.error}})):s(he)},me.onerror=()=>{r(!1),s({timestamp:Date.now()/1e3,event_type:"agent_end",agent_name:"system",data:{error:"WebSocket connection error"}})},me.onclose=()=>{r(!1)}},[e,g,n,_,a,l,r,s,Li,h,z,se]),J1=k.useCallback(()=>{_==null||_.close(),r(!1)},[_,r]),K1=k.useCallback(async(U,ae,me)=>{var hn,Op,$p,Dp,Fp,Bp,Up,Vp,Wp,Hp,qp,Jp,Kp,Gp,Yp,Qp,Xp,Zp,ef,tf,nf,rf,of,sf,af,lf;if(!I||!e)return;const be=((hn=e.app)==null?void 0:hn.id)||e.id,he=U?"allow_pattern":"allow_once",Te=U||I.host,Me=ae||"exact",Mt=me?`/sandbox/${be}/approval?project_id=${e.id}`:`/sandbox/${be}/approval`;try{if(await Ce(Mt,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({request_id:I.id,action:he,pattern:Te,pattern_type:Me,persist:me||!1})}),me&&he==="allow_pattern"){const jl=((Dp=($p=(Op=e.app)==null?void 0:Op.sandbox)==null?void 0:$p.allowlist)==null?void 0:Dp.user)||[],a0={id:`pattern_${Date.now().toString(36)}`,pattern:Te,pattern_type:Me,source:"approved",added_at:new Date().toISOString()};t({app:{...e.app,sandbox:{...(Fp=e.app)==null?void 0:Fp.sandbox,enabled:((Up=(Bp=e.app)==null?void 0:Bp.sandbox)==null?void 0:Up.enabled)??!1,allow_all_network:((Wp=(Vp=e.app)==null?void 0:Vp.sandbox)==null?void 0:Wp.allow_all_network)??!1,allowlist:{auto:((Jp=(qp=(Hp=e.app)==null?void 0:Hp.sandbox)==null?void 0:qp.allowlist)==null?void 0:Jp.auto)||[],user:[...jl,a0]},unknown_action:((Gp=(Kp=e.app)==null?void 0:Kp.sandbox)==null?void 0:Gp.unknown_action)??"ask",approval_timeout:((Qp=(Yp=e.app)==null?void 0:Yp.sandbox)==null?void 0:Qp.approval_timeout)??30,agent_memory_limit_mb:((Zp=(Xp=e.app)==null?void 0:Xp.sandbox)==null?void 0:Zp.agent_memory_limit_mb)??512,agent_cpu_limit:((tf=(ef=e.app)==null?void 0:ef.sandbox)==null?void 0:tf.agent_cpu_limit)??1,mcp_memory_limit_mb:((rf=(nf=e.app)==null?void 0:nf.sandbox)==null?void 0:rf.mcp_memory_limit_mb)??256,mcp_cpu_limit:((sf=(of=e.app)==null?void 0:of.sandbox)==null?void 0:sf.mcp_cpu_limit)??.5,run_timeout:((lf=(af=e.app)==null?void 0:af.sandbox)==null?void 0:lf.run_timeout)??300}}})}s({timestamp:Date.now()/1e3,event_type:"callback_end",agent_name:"sandbox",data:{callback_name:"network_approval",callback_type:"approval",message:`✅ Approved: ${Te}`,pattern:Te,action:he}})}catch(jl){console.error("Failed to approve:",jl)}W(null)},[I,e,s,t]),G1=k.useCallback(async()=>{var ae;if(!I||!e)return;const U=((ae=e.app)==null?void 0:ae.id)||e.id;try{await Ce(`/sandbox/${U}/approval`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({request_id:I.id,action:"deny"})}),s({timestamp:Date.now()/1e3,event_type:"callback_end",agent_name:"sandbox",data:{callback_name:"network_approval",callback_type:"approval",message:`❌ Denied: ${I.host}`,host:I.host,action:"deny"}})}catch(me){console.error("Failed to deny:",me)}W(null)},[I,e,s]),Ii=k.useCallback(async(U=!0)=>{var me;if(!e)return;const ae=((me=e.app)==null?void 0:me.id)||`app_${e.id}`;U&&R(!0);try{const[be,he]=await Promise.all([Ce(`/sandbox/${ae}/logs?container=agent&tail=500`).catch(()=>null),Ce(`/sandbox/${ae}/logs?container=gateway&tail=500`).catch(()=>null)]);S({agent:(be==null?void 0:be.logs)||(be==null?void 0:be.error)||"No logs available",gateway:(he==null?void 0:he.logs)||(he==null?void 0:he.error)||"No logs available"})}catch(be){console.error("Failed to fetch logs:",be),S({agent:`Error fetching logs: ${be}`,gateway:`Error fetching logs: ${be}`})}finally{U&&R(!1)}},[e]),Y1=k.useCallback(()=>{$(!0),Ii()},[Ii]);k.useEffect(()=>{if(!A||!Y.current||O)return;const U=Y.current,ae=E.current,me=U.scrollHeight;setTimeout(()=>{if(Y.current){if(b.current)Y.current.scrollTop=Y.current.scrollHeight;else if(ae>0&&me>ae){const be=me-ae;Y.current.scrollTop+=be}E.current=Y.current.scrollHeight}},50)},[A,w,D,O]),k.useEffect(()=>{A&&(b.current=!0,E.current=0)},[A,w]);const Q1=k.useCallback(()=>{if(!Y.current)return;const U=Y.current,me=U.scrollHeight-U.scrollTop-U.clientHeight<50;b.current=me},[]);k.useEffect(()=>{if(!A)return;const U=setInterval(()=>{Ii(!1)},3e3);return()=>clearInterval(U)},[A,Ii]),k.useEffect(()=>{const U=ae=>{if((ae.metaKey||ae.ctrlKey)&&ae.key==="Enter"){ae.preventDefault(),Ri();return}if(ae.key==="ArrowDown"||ae.key==="ArrowUp"){if(ae.target instanceof HTMLInputElement||ae.target instanceof HTMLTextAreaElement||(ae.preventDefault(),Pt.length===0))return;if(ae.key==="ArrowDown")if(x===null){const me=i.indexOf(Pt[0]);y(me)}else{const me=Pt.findIndex(be=>i.indexOf(be)===x);if(me<Pt.length-1){const be=i.indexOf(Pt[me+1]);y(be)}}else if(ae.key==="ArrowUp")if(x===null){const me=i.indexOf(Pt[Pt.length-1]);y(me)}else{const me=Pt.findIndex(be=>i.indexOf(be)===x);if(me>0){const be=i.indexOf(Pt[me-1]);y(be)}}}};return window.addEventListener("keydown",U),()=>window.removeEventListener("keydown",U)},[Ri,Pt,x,i]);const X1=k.useCallback(()=>{var he;if(i.length===0)return;const U={version:1,exportedAt:new Date().toISOString(),projectId:e==null?void 0:e.id,projectName:e==null?void 0:e.name,agentId:Li||((he=e==null?void 0:e.app)==null?void 0:he.root_agent_id),events:i},ae=new Blob([JSON.stringify(U,null,2)],{type:"application/json"}),me=URL.createObjectURL(ae),be=document.createElement("a");be.href=me,be.download=`run-${(e==null?void 0:e.name)||"export"}-${new Date().toISOString().slice(0,19).replace(/:/g,"-")}.json`,document.body.appendChild(be),be.click(),document.body.removeChild(be),URL.revokeObjectURL(me)},[i,e,Li]),Z1=k.useCallback(async()=>{if(!f||!e){alert("No active session to save");return}try{const U=await qy(f);if(U.success){alert(U.message||"Session saved to memory successfully");try{const ae=await wu(e.id);rt(ae)}catch{}}else alert(`Failed to save to memory: ${U.error||"Unknown error"}`)}catch(U){alert(`Error saving to memory: ${U.message||"Unknown error"}`)}},[f,e]),[e0,ps]=k.useState(!1),[t0,n0]=k.useState([]),[Oi,Pp]=k.useState(""),[_l,r0]=k.useState("Test Case from Session"),[Mp,Lp]=k.useState(!1),i0=k.useCallback(async()=>{if(!f||!e){alert("No active session to create test case from");return}try{const U=await Ce(`/projects/${e.id}/eval-sets`);if(n0(U.eval_sets||[]),!U.eval_sets||U.eval_sets.length===0){confirm(`No evaluation sets found. Would you like to create one first?

Go to the Evals tab to create an evaluation set.`)&&(window.location.href=`/project/${e.id}/evals`);return}Pp(U.eval_sets[0].id),ps(!0)}catch(U){alert(`Error loading eval sets: ${U.message||"Unknown error"}`)}},[f,e]),o0=k.useCallback(async()=>{if(!f||!e||!Oi){alert("Please select an evaluation set");return}Lp(!0);try{const U=await Ce(`/projects/${e.id}/session-to-eval-case`,{method:"POST",body:JSON.stringify({session_id:f,eval_set_id:Oi,case_name:_l})});ps(!1),alert(`Test case "${U.eval_case.name}" created successfully!

Token count: ${U.session_token_count.toLocaleString()} tokens

Go to the Evals tab to view and edit the test case.`)}catch(U){alert(`Error creating test case: ${U.message||"Unknown error"}`)}finally{Lp(!1)}},[f,e,Oi,_l]),s0=k.useCallback(()=>{const U=document.createElement("input");U.type="file",U.accept=".json",U.onchange=async ae=>{var be;const me=(be=ae.target.files)==null?void 0:be[0];if(me)try{const he=await me.text(),Te=JSON.parse(he);if(!Te.events||!Array.isArray(Te.events)){alert("Invalid run file: missing events array");return}a(),l(),y(null),P(null),Te.events.forEach(Me=>{s(Me)})}catch(he){alert(`Failed to load run file: ${he}`)}},U.click()},[a,l,s]);return k.useEffect(()=>{if(x!==null){const U=document.querySelector(".event-row.selected");U==null||U.scrollIntoView({behavior:"smooth",block:"nearest"})}},[x]),e?o.jsxs("div",{className:`run-panel ${Q?"resizing":""}`,children:[o.jsx("style",{children:`
        .run-panel {
          display: flex;
          flex-direction: column;
          width: 100%;
      ...
      `}),o.jsx(C5,{agents:e.agents,events:i,selectedEventIndex:x,isOpen:G,onOpenChange:q}),o.jsxs("div",{className:"input-area",children:[o.jsxs("select",{className:"agent-selector",value:Li||"",onChange:U=>zp(U.target.value||null),disabled:n,title:"Select which agent to run",children:[o.jsx("option",{value:"",children:e.app.root_agent_id?`Root: ${((Ip=e.agents.find(U=>U.id===e.app.root_agent_id))==null?void 0:Ip.name)||e.app.root_agent_id}`:"No root agent"}),e.agents.filter(U=>U.id!==e.app.root_agent_id).map(U=>o.jsxs("option",{value:U.id,children:[U.name," (",U.type.replace("Agent",""),")"]},U.id))]}),o.jsxs("select",{className:"agent-selector",value:Ee||"",onChange:U=>kl(U.target.value||null),disabled:n||Je,style:{minWidth:180},title:"Load a saved session",children:[o.jsx("option",{value:"",children:Je?"Loading...":"Load Session..."}),qe.map(U=>{const ae=new Date(U.started_at*1e3),me=U.duration?`${U.duration.toFixed(1)}s`:"?";return o.jsxs("option",{value:U.id,children:[ae.toLocaleString()," (",U.event_count," events, ",me,")"]},U.id)})]}),o.jsxs("div",{style:{position:"relative",flex:1,display:"flex"},children:[o.jsx("input",{ref:re,type:"text",placeholder:"Enter your query...",value:g,onChange:U=>v(U.target.value),onFocus:()=>te(!0),onBlur:()=>setTimeout(()=>te(!1),150),onKeyDown:U=>{U.key==="Enter"&&!U.shiftKey?Ri():U.key==="Escape"&&te(!1)},disabled:n,style:{flex:1}}),oe&&ge.length>0&&o.jsx("div",{style:{position:"absolute",top:"100%",left:0,right:0,background:"#18181b",border:"1px solid #3f3f46",borderRadius:"6px",marginTop:"4px",maxHeight:"240px",overflowY:"auto",zIndex:100,boxShadow:"0 4px 12px rgba(0,0,0,0.4)"},children:ge.map((U,ae)=>o.jsxs("div",{style:{padding:"8px 12px",fontSize:"12px",color:"#e4e4e7",cursor:"pointer",borderBottom:ae<ge.length-1?"1px solid #27272a":"none",display:"flex",justifyContent:"space-between",alignItems:"center"},onMouseDown:me=>{me.preventDefault(),Ri(U.prompt)},onMouseEnter:me=>{me.currentTarget.style.background="#27272a"},onMouseLeave:me=>{me.currentTarget.style.background="transparent"},children:[o.jsx("span",{style:{overflow:"hidden",textOverflow:"ellipsis",whiteSpace:"nowrap",flex:1,marginRight:"8px"},children:U.prompt}),o.jsxs("span",{style:{fontSize:"10px",color:"#71717a",flexShrink:0},children:["×",U.count]})]},ae))})]}),n?o.jsxs("button",{className:"stop",onClick:J1,children:[o.jsx(__,{size:14}),"Stop"]}):o.jsxs("button",{onClick:()=>Ri(),disabled:!g.trim(),children:[o.jsx(fr,{size:14}),"Run"]}),o.jsxs("label",{style:{display:"flex",alignItems:"center",gap:"4px",marginLeft:"12px",fontSize:"11px",color:z?"#22d3ee":"#71717a",cursor:"pointer"},title:"Run in isolated Docker container",children:[o.jsx("input",{type:"checkbox",checked:z,onChange:U=>L(U.target.checked),disabled:n,style:{accentColor:"#22d3ee"}}),"🐳 Sandbox"]}),z&&o.jsx("button",{onClick:Y1,style:{background:"transparent",border:"1px solid #3f3f46",borderRadius:"4px",padding:"2px 8px",marginLeft:"8px",fontSize:"11px",color:"#a1a1aa",cursor:"pointer",display:"flex",alignItems:"center",gap:"4px"},title:"View container logs",children:"📋 Logs"})]}),o.jsxs("div",{className:"toolbar",children:[o.jsxs("div",{className:"toolbar-section",children:[o.jsx(mv,{size:12,style:{color:"#71717a"}}),o.jsx("input",{type:"text",placeholder:"Filter events...",value:C,onChange:U=>M(U.target.value)})]}),o.jsx("div",{className:"toolbar-divider"}),o.jsxs("div",{className:"toolbar-section",children:[["agent_start","agent_end","tool_call","tool_result","model_call","model_response","state_change","callback_error"].map(U=>o.jsx("button",{className:`filter-chip ${N.has(U)?"active":""}`,onClick:()=>{const ae=new Set(N);ae.has(U)?ae.delete(U):ae.add(U),F(ae)},children:U.replace("_"," ")},U)),o.jsx("button",{className:`filter-chip ${N.has("callback_start")&&N.has("callback_end")?"active":""}`,onClick:()=>{const U=new Set(N);U.has("callback_start")&&U.has("callback_end")?(U.delete("callback_start"),U.delete("callback_end")):(U.add("callback_start"),U.add("callback_end")),F(U)},title:"Show/hide callback events",children:"callback"}),o.jsx("button",{className:`filter-chip ${B?"active":""}`,onClick:()=>ie(!B),title:"Hide LLM_RESP (complete) events",children:"hide (complete)"})]}),o.jsx("div",{className:"toolbar-divider"}),o.jsxs("div",{className:"toolbar-section",children:[o.jsxs("button",{className:`toolbar-btn ${pe?"active":""}`,onClick:()=>{fe(!pe),T(!1),Z(!1)},children:[o.jsx(In,{size:12}),"State"]}),o.jsxs("button",{className:`toolbar-btn ${K?"active":""}`,onClick:()=>{Z(!K),fe(!1),T(!1)},children:[o.jsx(Aa,{size:12}),"Artifacts"]}),o.jsxs("button",{className:`toolbar-btn ${X?"active":""}`,onClick:()=>{T(!X),fe(!1),Z(!1)},children:[o.jsx(Zl,{size:12}),"Tools"]})]}),o.jsxs("div",{style:{marginLeft:"auto",display:"flex",alignItems:"center",gap:8},children:[o.jsxs("span",{style:{fontSize:10,color:"#71717a"},children:[Pt.length," / ",i.length," events"]}),j&&o.jsx("button",{className:"toolbar-btn",onClick:()=>P(null),children:"Clear Range"})]})]}),o.jsxs("div",{className:"main-content",ref:wl,children:[o.jsxs("div",{className:"event-list-container",children:[o.jsxs("div",{className:"event-list-header",style:{gridTemplateColumns:Tp},children:[o.jsxs("div",{className:"header-cell",children:[o.jsx("span",{children:"#"}),o.jsx("div",{className:`column-resize-handle ${we===0?"active":""}`,onMouseDown:U=>us(0,U)})]}),o.jsxs("div",{className:"header-cell",children:[o.jsx("span",{children:"Time"}),o.jsx("div",{className:`column-resize-handle ${we===1?"active":""}`,onMouseDown:U=>us(1,U)})]}),o.jsxs("div",{className:"header-cell",children:[o.jsx("span",{children:"Agent"}),o.jsx("div",{className:`column-resize-handle ${we===2?"active":""}`,onMouseDown:U=>us(2,U)})]}),o.jsxs("div",{className:"header-cell",children:[o.jsx("span",{children:"Type"}),o.jsx("div",{className:`column-resize-handle ${we===3?"active":""}`,onMouseDown:U=>us(3,U)})]}),o.jsx("div",{className:"header-cell",children:o.jsx("span",{children:"Info"})})]}),o.jsx("div",{className:"event-list",ref:cs,children:Pt.length===0?o.jsxs("div",{className:"empty-state",children:[o.jsx(fv,{size:24}),o.jsx("span",{children:i.length===0?"No events yet":"No matching events"})]}):Pt.map((U,ae)=>{const me=i.indexOf(U),be=lg[U.event_type]||lg.error,he=N5[U.event_type]||Ma;return o.jsxs("div",{className:`event-row ${x===me?"selected":""}`,style:{background:be.bg,gridTemplateColumns:Tp},onClick:()=>y(me),onDoubleClick:()=>{fe(!1),T(!1),Z(!1)},children:[o.jsx("div",{className:"index",children:me}),o.jsx("div",{className:"time",style:{color:be.fg},children:z5(U.timestamp,q1.min)}),o.jsx("div",{className:"agent",children:o.jsx("span",{className:"agent-badge",style:{backgroundColor:Ha(U.agent_name).bg,color:Ha(U.agent_name).fg},children:U.agent_name})}),o.jsxs("div",{className:"type",style:{color:be.fg},children:[o.jsx(he,{size:10}),U.event_type.split("_")[0]]}),o.jsx("div",{className:"summary",children:E5(U)})]},me)})})]}),o.jsxs("div",{className:"side-panel-container",style:{width:ne},children:[o.jsx("div",{className:`resize-handle ${Q?"active":""}`,onMouseDown:()=>J(!0)}),o.jsxs("div",{className:"side-panel",style:{width:ne-4},children:[o.jsxs("div",{className:"side-panel-tabs",children:[o.jsxs("button",{className:`side-panel-tab ${!pe&&!X&&!K?"active":""}`,onClick:()=>{fe(!1),T(!1),Z(!1)},children:[o.jsx(Or,{size:12,style:{marginRight:4}}),"Details"]}),o.jsxs("button",{className:`side-panel-tab ${pe?"active":""}`,onClick:()=>{fe(!0),T(!1),Z(!1)},children:[o.jsx(In,{size:12,style:{marginRight:4}}),"State"]}),o.jsxs("button",{className:`side-panel-tab ${K?"active":""}`,onClick:()=>{Z(!0),fe(!1),T(!1)},children:[o.jsx(Aa,{size:12,style:{marginRight:4}}),"Artifacts"]}),o.jsxs("button",{className:`side-panel-tab ${X?"active":""}`,onClick:()=>{T(!0),fe(!1),Z(!1)},children:[o.jsx(Zl,{size:12,style:{marginRight:4}}),"Tools"]})]}),o.jsx("div",{className:"side-panel-content",children:X?o.jsx(O5,{project:e,selectedEventIndex:x,sandboxMode:z}):K?o.jsx(I5,{project:e,sessionId:f}):pe?o.jsx(R5,{events:i,selectedEventIndex:x,project:e}):Ap?o.jsx(P5,{event:Ap}):o.jsxs("div",{className:"empty-state",children:[o.jsx(Or,{size:24}),o.jsx("span",{children:"Select an event to view details"})]})})]})]})]}),o.jsxs("div",{className:"stats-bar",children:[o.jsxs("div",{className:"stat-item",children:[o.jsx("span",{children:"Events:"}),o.jsx("span",{className:"stat-value",children:i.length})]}),o.jsxs("div",{className:"stat-item",children:[o.jsx("span",{children:"Tool Calls:"}),o.jsx("span",{className:"stat-value",children:i.filter(U=>U.event_type==="tool_call").length})]}),o.jsxs("div",{className:"stat-item",children:[o.jsx("span",{children:"Model Calls:"}),o.jsx("span",{className:"stat-value",children:i.filter(U=>U.event_type==="model_call").length})]}),o.jsxs("div",{className:"stat-item",children:[o.jsx("span",{children:"Callbacks:"}),o.jsx("span",{className:"stat-value",children:i.filter(U=>U.event_type==="callback_start").length})]}),o.jsxs("div",{className:"stat-item",children:[o.jsx("span",{children:"State Changes:"}),o.jsx("span",{className:"stat-value",children:i.filter(U=>U.event_type==="state_change").length})]}),i.length>0&&o.jsxs("div",{className:"stat-item",children:[o.jsx("span",{children:"Duration:"}),o.jsxs("span",{className:"stat-value",children:[((i[i.length-1].timestamp-i[0].timestamp)*1e3).toFixed(0),"ms"]})]}),ds.total>0&&o.jsx("div",{className:"stat-item token-stats",children:o.jsxs("span",{className:"stat-value token-value",children:[o.jsxs("span",{className:"token-in",title:"Input tokens",children:[ds.input.toLocaleString(),"↑"]}),o.jsxs("span",{className:"token-out",title:"Output tokens",children:[ds.output.toLocaleString(),"↓"]}),o.jsx("span",{className:"token-total",title:"Total tokens",children:ds.total.toLocaleString()})]})}),o.jsx("div",{className:"stats-bar-spacer"}),o.jsxs("button",{className:"stats-bar-btn",onClick:s0,title:"Load a saved run",children:[o.jsx(dl,{size:12}),"Load"]}),o.jsxs("button",{className:"stats-bar-btn",onClick:X1,disabled:i.length===0,title:"Save current run to file",children:[o.jsx(Ai,{size:12}),"Save"]}),o.jsxs("button",{className:"stats-bar-btn",onClick:Z1,disabled:!f||i.length===0,title:"Save current session to memory",children:[o.jsx(In,{size:12}),"Save to Memory"]}),o.jsxs("button",{className:"stats-bar-btn",onClick:i0,disabled:!f||i.length===0,title:"Create evaluation test case from this session",style:{background:"rgba(var(--accent-primary-rgb), 0.15)"},children:[o.jsx(Su,{size:12}),"Create Test Case"]})]}),e0&&o.jsx("div",{className:"dialog-overlay",style:{position:"fixed",top:0,left:0,right:0,bottom:0,background:"rgba(0,0,0,0.5)",display:"flex",alignItems:"center",justifyContent:"center",zIndex:1e3},onClick:()=>ps(!1),children:o.jsxs("div",{className:"dialog-content",style:{background:"var(--bg-secondary)",borderRadius:"var(--radius-md)",padding:24,width:400,maxWidth:"90vw",border:"1px solid var(--border-color)"},onClick:U=>U.stopPropagation(),children:[o.jsxs("h3",{style:{marginBottom:16,display:"flex",alignItems:"center",gap:8},children:[o.jsx(Su,{size:18}),"Create Test Case from Session"]}),o.jsxs("div",{style:{marginBottom:16},children:[o.jsx("label",{style:{display:"block",marginBottom:4,fontSize:12,color:"var(--text-muted)"},children:"Test Case Name"}),o.jsx("input",{type:"text",value:_l,onChange:U=>r0(U.target.value),placeholder:"Enter test case name",style:{width:"100%",padding:"8px 12px",background:"var(--bg-tertiary)",border:"1px solid var(--border-color)",borderRadius:"var(--radius-sm)",color:"var(--text-primary)"}})]}),o.jsxs("div",{style:{marginBottom:20},children:[o.jsx("label",{style:{display:"block",marginBottom:4,fontSize:12,color:"var(--text-muted)"},children:"Add to Evaluation Set"}),o.jsx("select",{value:Oi,onChange:U=>Pp(U.target.value),style:{width:"100%",padding:"8px 12px",background:"var(--bg-tertiary)",border:"1px solid var(--border-color)",borderRadius:"var(--radius-sm)",color:"var(--text-primary)"},children:t0.map(U=>o.jsx("option",{value:U.id,children:U.name},U.id))})]}),o.jsx("p",{style:{fontSize:12,color:"var(--text-muted)",marginBottom:16},children:"This will extract user messages and tool calls from the current session to create a replayable test case. You can edit the expected responses and tool calls in the Evals tab after creation."}),o.jsxs("div",{style:{display:"flex",gap:8,justifyContent:"flex-end"},children:[o.jsx("button",{className:"btn btn-secondary",onClick:()=>ps(!1),children:"Cancel"}),o.jsx("button",{className:"btn btn-primary",onClick:o0,disabled:Mp||!Oi,children:Mp?"Creating...":"Create Test Case"})]})]})}),I&&o.jsx(_E,{request:I,timeout:I.timeout||30,onApprove:K1,onDeny:G1,onClose:()=>W(null)}),A&&o.jsx("div",{style:{position:"fixed",top:0,left:0,right:0,bottom:0,backgroundColor:"rgba(0, 0, 0, 0.7)",display:"flex",alignItems:"center",justifyContent:"center",zIndex:1e3},onClick:()=>$(!1),children:o.jsxs("div",{style:{backgroundColor:"#18181b",borderRadius:"8px",border:"1px solid #3f3f46",width:"90%",maxWidth:"1400px",height:"80%",display:"flex",flexDirection:"column",overflow:"hidden"},onClick:U=>U.stopPropagation(),children:[o.jsxs("div",{style:{display:"flex",alignItems:"center",justifyContent:"space-between",padding:"12px 16px",borderBottom:"1px solid #3f3f46",backgroundColor:"#27272a"},children:[o.jsxs("div",{style:{display:"flex",alignItems:"center",gap:"8px"},children:[o.jsx(Zl,{size:16}),o.jsx("span",{style:{fontWeight:600},children:"Container Logs"})]}),o.jsxs("div",{style:{display:"flex",alignItems:"center",gap:"8px"},children:[o.jsxs("button",{onClick:Ii,disabled:O,style:{background:"#3f3f46",border:"none",borderRadius:"4px",padding:"4px 8px",color:"#e4e4e7",cursor:O?"wait":"pointer",display:"flex",alignItems:"center",gap:"4px",fontSize:"12px"},children:[o.jsx(Xt,{size:12,className:O?"animate-spin":""}),"Refresh"]}),o.jsx("button",{onClick:()=>$(!1),style:{background:"transparent",border:"none",color:"#71717a",cursor:"pointer",padding:"4px"},children:o.jsx(Ur,{size:16})})]})]}),o.jsxs("div",{style:{display:"flex",gap:"0",borderBottom:"1px solid #3f3f46",backgroundColor:"#27272a"},children:[o.jsx("button",{onClick:()=>V("agent"),style:{padding:"8px 16px",background:w==="agent"?"#18181b":"transparent",border:"none",borderBottom:w==="agent"?"2px solid #22d3ee":"2px solid transparent",color:w==="agent"?"#22d3ee":"#a1a1aa",cursor:"pointer",fontSize:"13px"},children:"🤖 Agent"}),o.jsx("button",{onClick:()=>V("gateway"),style:{padding:"8px 16px",background:w==="gateway"?"#18181b":"transparent",border:"none",borderBottom:w==="gateway"?"2px solid #22d3ee":"2px solid transparent",color:w==="gateway"?"#22d3ee":"#a1a1aa",cursor:"pointer",fontSize:"13px"},children:"🌐 Gateway"})]}),o.jsx("div",{ref:Y,onScroll:Q1,style:{flex:1,overflow:"auto",padding:"12px",fontFamily:"ui-monospace, monospace",fontSize:"11px",lineHeight:"1.5",whiteSpace:"pre-wrap",wordBreak:"break-all",color:"#d4d4d8",backgroundColor:"#09090b"},children:O?o.jsx("div",{style:{color:"#71717a",textAlign:"center",padding:"20px"},children:"Loading logs..."}):D[w]?o.jsx(A5,{content:D[w]}):o.jsx("div",{style:{color:"#71717a"},children:"No logs available"})})]})})]}):o.jsx("div",{className:"run-panel empty",children:"No project loaded"})}const D5=()=>Math.random().toString(36).substring(2,10),F5=()=>({id:D5(),name:"New SkillSet",description:"",embedding_model:void 0,app_model_id:void 0,external_store_type:void 0,external_store_config:{},search_enabled:!0,preload_enabled:!0,preload_top_k:3,preload_min_score:.4,sources:[],entry_count:0});function B5(){const{project:e,setProject:t}=ht(),[n,r]=k.useState(null),[i,s]=k.useState(null),[a,l]=k.useState(""),[c,u]=k.useState([]),[d,p]=k.useState(!1),[f,h]=k.useState(!1),[g,v]=k.useState(""),[_,m]=k.useState(!1),[x,y]=k.useState(null),[j,P]=k.useState(null),C=k.useRef(null),M=(e==null?void 0:e.skillsets)||[],N=M.find(R=>R.id===n);k.useEffect(()=>{lv().then(R=>P(R.available)).catch(()=>P(!1))},[]),k.useEffect(()=>{M.length>0&&!n&&r(M[0].id)},[M,n]),k.useEffect(()=>{!e||!n||F()},[e==null?void 0:e.id,n]);const F=k.useCallback(async()=>{if(!(!e||!n))try{const R=await rv(e.id,n);s(R),L(n,{entry_count:R.entry_count})}catch(R){console.error("Failed to load stats:",R)}},[e==null?void 0:e.id,n]),z=R=>{e&&t({...e,...R})},L=(R,w)=>{e&&t({...e,skillsets:e.skillsets.map(V=>V.id===R?{...V,...w}:V)})},I=()=>{if(!e)return;const R=F5();z({skillsets:[...M,R]}),r(R.id)},W=R=>{e&&confirm("Delete this SkillSet and all its data?")&&(z({skillsets:M.filter(w=>w.id!==R)}),n===R&&r(M.length>1?M[0].id:null),s(null),u([]))},A=async()=>{if(!(!e||!n||!a.trim())){p(!0),y(null);try{const R=await sv(e.id,n,a.trim(),10,0);u(R.results)}catch(R){y("Search failed"),console.error(R)}finally{p(!1)}}},$=async()=>{if(!(!e||!n||!g.trim())){m(!0),y(null);try{const R=await iv(e.id,n,g.trim());v(""),await F(),alert(`Added ${R.chunks_added} chunks from ${R.source_name}`)}catch(R){y(R.message||"Failed to fetch URL")}finally{m(!1)}}},D=async R=>{var V;const w=(V=R.target.files)==null?void 0:V[0];if(!(!w||!e||!n)){y(null);try{const Y=await ov(e.id,n,w);await F(),alert(`Added ${Y.chunks_added} chunks from ${Y.source_name}`)}catch(Y){y(Y.message||"Upload failed")}C.current&&(C.current.value="")}},S=async()=>{if(!(!e||!n)&&confirm("Delete all entries in this SkillSet?"))try{await av(e.id,n),await F(),u([])}catch{y("Clear failed")}},O=R=>{const w=Math.round(R*100),V=160,Y=70,b=20+(1-R)*15,E=.15+R*.25;return`linear-gradient(90deg, hsla(${V}, ${Y}%, ${b}%, ${E}) 0%, transparent ${w}%)`};return e?o.jsxs("div",{className:"skillsets-panel",children:[o.jsx("style",{children:`
        .skillsets-panel {
          display: flex;
          height: 100%;
          gap: 16px;
      ...
      `}),o.jsxs("div",{className:"skillset-list",children:[o.jsxs("div",{className:"skillset-list-header",children:[o.jsx("h3",{children:"SkillSets"}),o.jsx("button",{className:"btn-icon",onClick:I,title:"Add SkillSet",children:o.jsx(Xe,{size:16})})]}),M.length===0?o.jsxs("div",{className:"empty-state",style:{padding:"40px 0"},children:[o.jsx(In,{size:32}),o.jsx("span",{children:"No SkillSets"}),o.jsxs("button",{className:"btn-primary",onClick:I,children:[o.jsx(Xe,{size:14})," Create SkillSet"]})]}):M.map(R=>o.jsxs("div",{className:`skillset-item ${n===R.id?"selected":""}`,onClick:()=>r(R.id),children:[o.jsx(In,{size:16,style:{color:"var(--accent)",flexShrink:0}}),o.jsxs("div",{className:"skillset-item-info",children:[o.jsx("div",{className:"skillset-item-name",children:R.name}),o.jsxs("div",{className:"skillset-item-count",children:[R.entry_count||0," entries"]})]}),o.jsx("button",{className:"skillset-item-delete",onClick:w=>{w.stopPropagation(),W(R.id)},children:o.jsx(Ue,{size:14})})]},R.id))]}),N?o.jsxs("div",{className:"skillset-detail",children:[o.jsxs("div",{className:"skillset-header",children:[o.jsxs("div",{className:"skillset-header-info",children:[o.jsx("input",{className:"skillset-name-input",value:N.name,onChange:R=>L(N.id,{name:R.target.value}),placeholder:"SkillSet Name"}),o.jsx("textarea",{className:"skillset-desc-input",value:N.description,onChange:R=>L(N.id,{description:R.target.value}),placeholder:"Description (optional)",rows:1}),o.jsxs("div",{className:"skillset-model",children:[o.jsx("label",{style:{fontSize:"12px",color:"var(--text-secondary)",marginRight:"8px"},children:"Embedding Model:"}),o.jsxs("select",{style:{flex:1,padding:"4px 8px",fontSize:"12px",background:"var(--bg-secondary)",border:"1px solid var(--border)",borderRadius:"4px",color:"var(--text-primary)"},value:N.embedding_model||"text-embedding-004",onChange:R=>L(N.id,{embedding_model:R.target.value}),children:[o.jsxs("optgroup",{label:"Google Gemini",children:[o.jsx("option",{value:"text-embedding-004",children:"text-embedding-004 (768d)"}),o.jsx("option",{value:"text-embedding-005",children:"text-embedding-005"})]}),o.jsxs("optgroup",{label:"OpenAI",children:[o.jsx("option",{value:"text-embedding-3-small",children:"text-embedding-3-small (1536d)"}),o.jsx("option",{value:"text-embedding-3-large",children:"text-embedding-3-large (3072d)"})]}),o.jsxs("optgroup",{label:"Cohere",children:[o.jsx("option",{value:"embed-english-v3.0",children:"embed-english-v3.0 (1024d)"}),o.jsx("option",{value:"embed-multilingual-v3.0",children:"embed-multilingual-v3.0 (1024d)"})]})]})]}),o.jsxs("div",{className:"skillset-stats",children:[o.jsxs("span",{className:"skillset-stat",children:[o.jsx("strong",{children:(i==null?void 0:i.entry_count)||0})," entries"]}),o.jsxs("span",{className:"skillset-stat",children:[o.jsx("strong",{children:Object.keys((i==null?void 0:i.sources)||{}).length})," sources"]}),j===!1&&o.jsx("span",{className:"skillset-stat",style:{color:"var(--warning)"},children:"⚠ No embeddings"})]})]}),o.jsx("button",{className:"btn-icon",onClick:F,title:"Refresh",children:o.jsx(Xt,{size:16})})]}),x&&o.jsxs("div",{className:"error-banner",children:[x,o.jsx("button",{onClick:()=>y(null),children:o.jsx(Ur,{size:14})})]}),o.jsxs("div",{className:"search-section",children:[o.jsx("div",{className:"search-input-wrapper",children:o.jsx("input",{className:"search-input",value:a,onChange:R=>l(R.target.value),onKeyDown:R=>R.key==="Enter"&&A(),placeholder:"Search this SkillSet..."})}),o.jsxs("button",{className:"btn-primary",onClick:A,disabled:d||!a.trim(),children:[o.jsx(mv,{size:14}),d?"Searching...":"Search"]})]}),o.jsxs("div",{className:"search-results",children:[c.length===0&&!d&&a&&o.jsx("div",{className:"empty-state",children:o.jsx("span",{children:"No results found"})}),c.map(R=>o.jsxs("div",{className:"search-result",style:{background:O(R.score)},children:[o.jsxs("span",{className:"search-result-score",children:[(R.score*100).toFixed(0),"%"]}),o.jsx("div",{className:"search-result-text",children:R.text}),o.jsx("div",{className:"search-result-source",children:R.source_name})]},R.id))]}),o.jsxs("div",{className:"add-sources-section",children:[o.jsxs("div",{className:"add-sources-header",onClick:()=>h(!f),children:[f?o.jsx(It,{size:16}):o.jsx(_t,{size:16}),o.jsx("h4",{children:"Add Sources"})]}),f&&o.jsxs("div",{className:"add-sources-content",children:[o.jsxs("div",{className:"source-row",children:[o.jsx(Kd,{size:16,style:{color:"var(--text-tertiary)"}}),o.jsx("input",{className:"source-input",value:g,onChange:R=>v(R.target.value),onKeyDown:R=>R.key==="Enter"&&$(),placeholder:"Enter URL (e.g., llms.txt file)"}),o.jsxs("button",{className:"btn-primary",onClick:$,disabled:_||!g.trim(),children:[o.jsx(x_,{size:14}),_?"Loading...":"Add"]})]}),o.jsxs("div",{className:"source-row",children:[o.jsx(p_,{size:16,style:{color:"var(--text-tertiary)"}}),o.jsx("input",{ref:C,type:"file",accept:".txt,.md,.json,.csv,.html",onChange:D}),o.jsxs("button",{className:"btn-primary",onClick:()=>{var R;return(R=C.current)==null?void 0:R.click()},children:[o.jsx(dl,{size:14}),"Upload File"]}),o.jsx("span",{style:{fontSize:"12px",color:"var(--text-tertiary)"},children:".txt, .md, .json, .csv"})]}),((i==null?void 0:i.entry_count)||0)>0&&o.jsx("div",{className:"source-row",style:{marginTop:"8px"},children:o.jsxs("button",{className:"clear-button",onClick:S,children:[o.jsx(Ue,{size:12}),"Clear All Entries (",(i==null?void 0:i.entry_count)||0,")"]})})]})]})]}):M.length>0?o.jsx("div",{className:"skillset-detail",children:o.jsxs("div",{className:"empty-state",children:[o.jsx(In,{size:48}),o.jsx("span",{children:"Select a SkillSet"})]})}):null]}):null}const bn={tool_trajectory_avg_score:{name:"Tool Trajectory",description:"Did the agent call the right tools in the expected order?",requiresJudge:!1,scale:[0,1]},response_match_score:{name:"Response Match (ROUGE-1)",description:"Does the response contain expected text? (fuzzy word matching)",requiresJudge:!1,scale:[0,1]},response_evaluation_score:{name:"Response Evaluation (LLM)",description:"LLM-judged semantic match of final response",requiresJudge:!0,scale:[1,5]},final_response_match_v2:{name:"Response Quality v2 (LLM)",description:"Enhanced LLM-judged response quality check",requiresJudge:!0,scale:[0,1]},safety_v1:{name:"Safety",description:"Is the response safe and harmless? (Vertex AI)",requiresJudge:!0,scale:[0,1]},hallucinations_v1:{name:"Hallucination Detection",description:"Are all claims supported by context? No false information?",requiresJudge:!0,scale:[0,1]},rubric_based_final_response_quality_v1:{name:"Rubric: Response Quality",description:"Custom rubric-based quality assessment of responses",requiresJudge:!0,scale:[0,1]},rubric_based_tool_use_quality_v1:{name:"Rubric: Tool Use Quality",description:"Custom rubric-based assessment of tool usage",requiresJudge:!0,scale:[0,1]}},Ko=(e,t,n)=>{if(t==null)return{value:"-",comparison:""};const r=bn[e],i=(r==null?void 0:r.scale)||[0,1];if(i[0]===1&&i[1]===5){const s=n??3.5;return{value:t.toFixed(1),comparison:`${s.toFixed(1)} / ${i[1].toFixed(1)}`}}else{const s=n??.7;return{value:`${Math.round(t*100)}%`,comparison:`${Math.round(s*100)}% min`}}},U5={metrics:[{metric:"tool_trajectory_avg_score",enabled:!0,criterion:{threshold:1}},{metric:"response_match_score",enabled:!0,criterion:{threshold:.7}}],default_trajectory_match_type:"in_order",num_runs:1};function H1(){return`${Date.now().toString(36)}_${Math.random().toString(36).slice(2,6)}`}function V5(){const{project:e}=ht(),[t,n]=k.useState([]),[r,i]=k.useState(null),[s,a]=k.useState(null),[l,c]=k.useState(new Set),[u,d]=k.useState(new Map),[p,f]=k.useState(new Map),[h,g]=k.useState(new Set),[v,_]=k.useState(!1),[m,x]=k.useState(null),[y,j]=k.useState([]),[P,C]=k.useState(null),M=async()=>{if(e)try{const T=await Ye.get(`/projects/${e.id}/eval-history`);j(T.runs||[])}catch(T){console.warn("Failed to load eval history:",T)}},N=async(T,K=!0)=>{if(e)try{const ne=(await Ye.get(`/projects/${e.id}/eval-history/${T}`)).run;if(C(ne),ne!=null&&ne.case_results){const de=new Map;for(const Q of ne.case_results)de.set(Q.eval_case_id,Q);d(de)}if((ne==null?void 0:ne.eval_set_id)==="batch")c(new Set(t.map(de=>de.id))),i(null);else if(ne!=null&&ne.eval_set_id){const de=new Map;de.set(ne.eval_set_id,ne),f(de),i(ne.eval_set_id),c(Q=>new Set([...Q,ne.eval_set_id]))}a(null),K&&window.history.pushState({run:T},"",`?run=${T}`)}catch(Z){console.warn("Failed to load history run:",Z)}},F=(T,K=!0)=>{i(T),a(null),C(null),K&&T?window.history.pushState({set:T},"",`?set=${T}`):K&&window.history.pushState({},"",window.location.pathname)},z=(T,K,Z=!0)=>{i(T),a(K),C(null),Z&&K?window.history.pushState({set:T,case:K},"",`?set=${T}&case=${K}`):Z&&T&&window.history.pushState({set:T},"",`?set=${T}`)},L=()=>{C(null),d(new Map),f(new Map),window.history.pushState({},"",window.location.pathname)},I=async T=>{if(e)try{await Ye.delete(`/projects/${e.id}/eval-history/${T}`),j(K=>K.filter(Z=>Z.id!==T)),(P==null?void 0:P.id)===T&&C(null)}catch(K){console.warn("Failed to delete history run:",K)}};k.useEffect(()=>{e!=null&&e.id&&(W(),M())},[e==null?void 0:e.id]),k.useEffect(()=>{const T=()=>{g(new Set(t.map(Z=>Z.id)))},K=()=>{g(new Set),M()};return window.addEventListener("eval-tests-started",T),window.addEventListener("eval-tests-completed",K),()=>{window.removeEventListener("eval-tests-started",T),window.removeEventListener("eval-tests-completed",K)}},[t]),k.useEffect(()=>{if(!(e!=null&&e.id)||v)return;const T=()=>{const Z=new URLSearchParams(window.location.search),ne=Z.get("set"),de=Z.get("case"),Q=Z.get("run");if(Q){N(Q,!1);return}if(ne)i(ne),a(de),C(null),c(J=>new Set([...J,ne]));else{if(!r&&!s&&!P)return;i(null),a(null),C(null)}};T();const K=()=>{T()};return window.addEventListener("popstate",K),()=>window.removeEventListener("popstate",K)},[e==null?void 0:e.id,v,t.length]);const W=async()=>{var T,K;if(e!=null&&e.id){_(!0),x(null);try{const Z=await Ye.get(`/projects/${e.id}/eval-sets`);if(n(Z.eval_sets||[]),((T=Z.eval_sets)==null?void 0:T.length)>0){const ne=new URLSearchParams(window.location.search),de=ne.get("set"),Q=ne.get("case"),J=de||(Q?(K=Z.eval_sets.find(G=>G.eval_cases.some(q=>q.id===Q)))==null?void 0:K.id:null)||Z.eval_sets[0].id;c(new Set([J]))}}catch(Z){x(Z.message||"Failed to load eval sets")}finally{_(!1)}}},A=t.find(T=>T.id===r),$=A==null?void 0:A.eval_cases.find(T=>T.id===s),D=async()=>{if(e!=null&&e.id)try{const T=await Ye.post(`/projects/${e.id}/eval-sets`,{name:"New Eval Set",description:"",eval_config:U5});n(K=>[...K,T.eval_set]),i(T.eval_set.id),c(K=>new Set([...K,T.eval_set.id]))}catch(T){x(T.message||"Failed to create eval set")}},S=async T=>{if(e!=null&&e.id)try{const K=await Ye.post(`/projects/${e.id}/eval-sets/${T}/cases`,{name:"New Test Case",description:"",invocations:[{id:H1(),user_message:"",expected_response:"",expected_tool_calls:[],tool_trajectory_match_type:"in_order",rubrics:[]}],initial_state:{},rubrics:[],enabled_metrics:[],tags:[]});n(Z=>Z.map(ne=>ne.id===T?{...ne,eval_cases:[...ne.eval_cases,K.eval_case]}:ne)),i(T),a(K.eval_case.id)}catch(K){x(K.message||"Failed to create eval case")}},O=async(T,K,Z)=>{if(e!=null&&e.id)try{const ne=await Ye.put(`/projects/${e.id}/eval-sets/${T}/cases/${K}`,Z);n(de=>de.map(Q=>Q.id===T?{...Q,eval_cases:Q.eval_cases.map(J=>J.id===K?ne.eval_case:J)}:Q))}catch(ne){x(ne.message||"Failed to update eval case")}},R=async(T,K)=>{if(e!=null&&e.id)try{await Ye.delete(`/projects/${e.id}/eval-sets/${T}/cases/${K}`),n(Z=>Z.map(ne=>ne.id===T?{...ne,eval_cases:ne.eval_cases.filter(de=>de.id!==K)}:ne)),s===K&&a(null)}catch(Z){x(Z.message||"Failed to delete eval case")}},w=async T=>{if(e!=null&&e.id)try{await Ye.delete(`/projects/${e.id}/eval-sets/${T}`),n(K=>K.filter(Z=>Z.id!==T)),r===T&&(i(null),a(null))}catch(K){x(K.message||"Failed to delete eval set")}},V=async T=>{if(e!=null&&e.id)try{const K=await Ye.get(`/projects/${e.id}/eval-sets/${T}/export`),Z=new Blob([JSON.stringify(K,null,2)],{type:"application/json"}),ne=URL.createObjectURL(Z),de=document.createElement("a");de.href=ne;const Q=t.find(J=>J.id===T);de.download=`${(Q==null?void 0:Q.name)||"eval-set"}.json`,document.body.appendChild(de),de.click(),document.body.removeChild(de),URL.revokeObjectURL(ne)}catch(K){x(K.message||"Failed to export eval set")}},Y=async T=>{if(e!=null&&e.id)try{const K=await T.text(),Z=JSON.parse(K),ne=await Ye.post(`/projects/${e.id}/eval-sets/import`,Z);n(de=>[...de,ne.eval_set]),i(ne.eval_set.id),c(de=>new Set([...de,ne.eval_set.id]))}catch(K){x(K.message||"Failed to import eval set")}},b=k.useRef(null),E=async()=>{if(!(!(e!=null&&e.id)||t.length===0))try{const T=await Promise.all(t.map(async de=>{try{return await Ye.get(`/projects/${e.id}/eval-sets/${de.id}/export`)}catch{return de}})),K=new Blob([JSON.stringify(T,null,2)],{type:"application/json"}),Z=URL.createObjectURL(K),ne=document.createElement("a");ne.href=Z,ne.download=`${e.name||"project"}-eval-sets.json`,document.body.appendChild(ne),ne.click(),document.body.removeChild(ne),URL.revokeObjectURL(Z)}catch(T){x(T.message||"Failed to export all eval sets")}},B=async(T,K)=>{if(e!=null&&e.id){g(Z=>new Set([...Z,K]));try{const Z=await Ye.post(`/projects/${e.id}/eval-sets/${T}/cases/${K}/run`,{});d(ne=>new Map(ne).set(K,Z.result))}catch(Z){x(Z.message||"Failed to run eval case")}finally{g(Z=>{const ne=new Set(Z);return ne.delete(K),ne})}}},ie=async T=>{if(!(e!=null&&e.id))return;const K=t.find(ne=>ne.id===T);if(!K)return;const Z=K.eval_cases.map(ne=>ne.id);g(ne=>new Set([...ne,T,...Z]));try{const ne=await Ye.post(`/projects/${e.id}/eval-sets/${T}/run`,{});f(de=>new Map(de).set(T,ne.result));for(const de of ne.result.case_results)d(Q=>new Map(Q).set(de.eval_case_id,de));try{await Ye.post(`/projects/${e.id}/eval-history`,ne.result),M()}catch(de){console.warn("Failed to save eval run to history:",de)}}catch(ne){x(ne.message||"Failed to run eval set")}finally{g(ne=>{const de=new Set(ne);return de.delete(T),Z.forEach(Q=>de.delete(Q)),de})}},pe=T=>{c(K=>{const Z=new Set(K);return Z.has(T)?Z.delete(T):Z.add(T),Z})},fe=T=>{let K=T.eval_cases.length,Z=0,ne=0,de=0;for(const Q of T.eval_cases){const J=u.get(Q.id);J?J.passed?Z++:ne++:de++}return{total:K,passed:Z,failed:ne,pending:de}},X=T=>T==null?"-":`${Math.round(T*100)}%`;return e?o.jsxs("div",{className:"eval-panel",children:[o.jsx("style",{children:`
        .eval-panel {
          display: flex;
          gap: 20px;
          height: calc(100vh - 180px);
      ...
      `}),o.jsxs("aside",{className:"eval-sidebar",children:[o.jsxs("div",{className:"sidebar-header",children:[o.jsx("h3",{children:"Evaluation Tests"}),o.jsxs("div",{className:"header-actions",children:[o.jsx("input",{type:"file",ref:b,accept:".json",style:{display:"none"},onChange:T=>{var Z;const K=(Z=T.target.files)==null?void 0:Z[0];K&&(Y(K),T.target.value="")}}),o.jsx("button",{className:"btn btn-secondary btn-sm",onClick:()=>{var T;return(T=b.current)==null?void 0:T.click()},title:"Import eval set from JSON",children:o.jsx(dl,{size:14})}),t.length>0&&o.jsx("button",{className:"btn btn-secondary btn-sm",onClick:E,title:"Download all eval sets as JSON",children:o.jsx(Ai,{size:14})}),o.jsx("button",{className:"btn btn-secondary btn-sm",onClick:W,title:"Refresh",children:o.jsx(Xt,{size:14})}),o.jsxs("button",{className:"btn btn-primary btn-sm",onClick:D,title:"New eval set",children:[o.jsx(Xe,{size:14}),"Set"]})]})]}),o.jsxs("div",{className:"eval-tree",children:[v&&o.jsx("p",{style:{color:"var(--text-muted)",padding:"16px"},children:"Loading..."}),m&&o.jsx("div",{style:{color:"var(--error)",padding:"16px",fontSize:"13px"},children:m}),!v&&t.length===0&&o.jsxs("div",{className:"empty-state",style:{padding:"32px"},children:[o.jsx(Xd,{size:32}),o.jsxs("p",{children:["No evaluation sets yet.",o.jsx("br",{}),"Create one to get started."]})]}),t.map(T=>{const K=l.has(T.id),Z=fe(T),ne=h.has(T.id);return o.jsxs("div",{className:"tree-item",children:[o.jsxs("div",{className:`tree-set ${r===T.id&&!s?"selected":""}`,onClick:()=>F(T.id),children:[o.jsx("button",{className:"expand-btn",onClick:de=>{de.stopPropagation(),pe(T.id)},children:T.eval_cases.length>0?K?o.jsx(It,{size:14}):o.jsx(_t,{size:14}):o.jsx("span",{style:{width:14}})}),o.jsx(pv,{size:14,style:{color:"var(--accent-secondary)"}}),o.jsx("span",{className:"set-name",children:T.name}),o.jsx("button",{className:"add-case-btn",onClick:de=>{de.stopPropagation(),S(T.id)},title:"Add test case",style:{padding:"2px 4px",marginLeft:4,background:"transparent",border:"none",cursor:"pointer",opacity:.6,display:"flex",alignItems:"center"},children:o.jsx(Xe,{size:12})}),Z.total>0&&o.jsxs("span",{className:"set-stats",children:[Z.passed>0&&o.jsx("span",{className:"stat-passed",children:Z.passed}),Z.failed>0&&o.jsx("span",{className:"stat-failed",children:Z.failed}),Z.pending>0&&o.jsx("span",{className:"stat-pending",children:Z.pending})]}),o.jsx("button",{className:"run-btn",onClick:de=>{de.stopPropagation(),ie(T.id)},title:"Run all tests in this set",disabled:ne,children:ne?o.jsx(Fo,{size:12,className:"spinning"}):o.jsx(fr,{size:12})})]}),K&&o.jsx("div",{className:"tree-children",style:{paddingLeft:16},children:T.eval_cases.map(de=>{var G;const Q=u.get(de.id),J=h.has(de.id);return o.jsxs("div",{className:`tree-case ${s===de.id?"selected":""}`,onClick:()=>z(T.id,de.id),children:[J?o.jsx(Fo,{size:14,className:"spinning",style:{color:"var(--warning)"}}):Q?Q.passed?o.jsx(pr,{size:14,style:{color:"var(--success)"}}):o.jsx($r,{size:14,style:{color:"var(--error)"}}):o.jsx(Pa,{size:14,style:{color:"var(--text-muted)"}}),o.jsx("span",{className:"case-name",children:de.name}),Q&&Q.metric_results.length>0&&o.jsx("span",{style:{fontSize:11,color:Q.passed?"var(--success)":"var(--error)"},children:X((G=Q.metric_results[0])==null?void 0:G.score)}),o.jsx("button",{className:"run-btn",onClick:q=>{q.stopPropagation(),B(T.id,de.id)},disabled:J,children:o.jsx(fr,{size:12})})]},de.id)})})]},T.id)})]}),o.jsxs("div",{className:"history-section",children:[o.jsx("div",{className:"history-header",style:{display:"flex",justifyContent:"space-between",alignItems:"center",padding:"10px 12px",borderTop:"1px solid var(--border-color)",background:"var(--bg-secondary)"},children:o.jsxs("span",{style:{fontWeight:500,fontSize:13},children:["Previous Runs (",y.length,")"]})}),o.jsx("div",{className:"history-list",style:{maxHeight:200,overflowY:"auto"},children:y.length===0?o.jsx("div",{style:{padding:"12px",color:"var(--text-secondary)",fontSize:12,textAlign:"center"},children:"No previous runs"}):[...y].sort((T,K)=>(K.started_at||0)-(T.started_at||0)).map(T=>{const K=T.passed_cases===T.total_cases;return o.jsx("div",{className:`history-item ${(P==null?void 0:P.id)===T.id?"selected":""}`,onClick:()=>N(T.id),style:{padding:"8px 12px",borderBottom:"1px solid var(--border-color)",cursor:"pointer",background:(P==null?void 0:P.id)===T.id?"var(--bg-tertiary)":"transparent",fontSize:12},children:o.jsxs("div",{style:{display:"flex",justifyContent:"space-between",alignItems:"center"},children:[o.jsxs("div",{style:{display:"flex",alignItems:"center",gap:8},children:[K?o.jsx(pr,{size:14,style:{color:"var(--success)",flexShrink:0}}):o.jsx($r,{size:14,style:{color:"var(--error)",flexShrink:0}}),o.jsxs("div",{children:[o.jsx("div",{style:{fontWeight:500},children:T.eval_set_name||"Unnamed"}),o.jsx("div",{style:{color:"var(--text-secondary)",fontSize:11},children:new Date(T.started_at*1e3).toLocaleString()})]})]}),o.jsxs("div",{style:{display:"flex",alignItems:"center",gap:8},children:[o.jsxs("span",{style:{color:K?"var(--success)":"var(--error)",fontWeight:500,fontSize:11},children:[T.passed_cases,"/",T.total_cases]}),o.jsx("button",{className:"btn btn-icon",onClick:Z=>{Z.stopPropagation(),I(T.id)},title:"Delete run",style:{padding:2},children:o.jsx(Ue,{size:12})})]})]})},T.id)})})]})]}),o.jsx("div",{className:"eval-editor",children:P?o.jsx(H5,{run:P,onClose:L}):$?o.jsx(q5,{evalCase:$,evalSetId:r,projectId:e.id,result:u.get($.id),isRunning:h.has($.id),onUpdate:T=>O(r,$.id,T),onDelete:()=>R(r,$.id),onRun:()=>B(r,$.id),onClearResult:()=>d(T=>{const K=new Map(T);return K.delete($.id),K})}):A?o.jsx(J5,{evalSet:A,projectId:e.id,result:p.get(A.id),isRunning:h.has(A.id),caseResults:u,onUpdate:async T=>{try{const K=await Ye.put(`/projects/${e.id}/eval-sets/${A.id}`,T);n(Z=>Z.map(ne=>ne.id===A.id?K.eval_set:ne))}catch(K){x(K.message)}},onDelete:()=>w(A.id),onRun:()=>ie(A.id),onExport:()=>V(A.id)}):o.jsx("div",{className:"editor-content",children:o.jsxs("div",{className:"empty-state",children:[o.jsx(Pa,{size:48}),o.jsxs("p",{children:["Select a test case to edit",o.jsx("br",{}),"or create a new one"]})]})})})]}):null}function W5({value:e,onChange:t}){var a,l;const{project:n}=ht(),r=((a=n==null?void 0:n.app)==null?void 0:a.models)||[],i=(l=n==null?void 0:n.app)==null?void 0:l.default_model_id,s=r.find(c=>c.id===i);return o.jsxs("select",{value:e,onChange:c=>t(c.target.value),style:{width:"100%",maxWidth:400},children:[o.jsx("option",{value:"",children:s?`App Default (${s.model_name})`:"App Default"}),r.map(c=>o.jsx("option",{value:c.model_name,children:c.model_name},c.id)),o.jsx("option",{value:"gemini-2.0-flash",children:"gemini-2.0-flash"}),o.jsx("option",{value:"gemini-2.5-flash",children:"gemini-2.5-flash"}),o.jsx("option",{value:"gemini-2.5-pro",children:"gemini-2.5-pro"})]})}function H5({run:e,onClose:t}){var h;const{project:n}=ht(),[r,i]=k.useState(!0),[s,a]=k.useState(new Set),l=e.case_results||[],c=l.filter(g=>g.passed).length,u=l.filter(g=>!g.passed).length,d=r?l.filter(g=>!g.passed):l,p=g=>{a(v=>{const _=new Set(v);return _.has(g)?_.delete(g):_.add(g),_})},f=g=>{g&&n&&(window.location.href=`/project/${n.id}/run?session=${g}`)};return o.jsxs("div",{className:"test-result-viewer",children:[o.jsx("style",{children:`
        .test-result-viewer {
          height: 100%;
          display: flex;
          flex-direction: column;
      ...
      `}),o.jsxs("div",{className:"result-header",children:[o.jsx("h2",{children:e.eval_set_name||"Test Run Results"}),o.jsx("div",{style:{display:"flex",gap:8},children:o.jsx("button",{className:"btn btn-secondary btn-sm",onClick:()=>{if(n){const g=`${window.location.origin}/project/${n.id}/evaluate?run=${e.id}`;navigator.clipboard.writeText(g)}},title:"Copy link to this run",children:o.jsx(Yd,{size:14})})})]}),o.jsxs("div",{className:"result-summary",children:[o.jsxs("div",{className:"summary-stat",children:[o.jsx("span",{className:"label",children:"Status"}),o.jsx("span",{className:`value ${c===l.length?"passed":"failed"}`,children:c===l.length?"PASSED":"FAILED"})]}),o.jsxs("div",{className:"summary-stat",children:[o.jsx("span",{className:"label",children:"Passed"}),o.jsx("span",{className:"value passed",children:c})]}),o.jsxs("div",{className:"summary-stat",children:[o.jsx("span",{className:"label",children:"Failed"}),o.jsx("span",{className:"value failed",children:u})]}),o.jsxs("div",{className:"summary-stat",children:[o.jsx("span",{className:"label",children:"Total Cases"}),o.jsx("span",{className:"value",children:l.length})]}),o.jsxs("div",{className:"summary-stat",children:[o.jsx("span",{className:"label",children:"Duration"}),o.jsx("span",{className:"value",children:e.duration_ms?`${(e.duration_ms/1e3).toFixed(1)}s`:"-"})]}),o.jsxs("div",{className:"summary-stat",children:[o.jsx("span",{className:"label",children:"Tokens"}),o.jsx("span",{className:"value",children:((h=e.total_tokens)==null?void 0:h.toLocaleString())||"-"})]}),o.jsxs("div",{className:"summary-stat",children:[o.jsx("span",{className:"label",children:"Run Time"}),o.jsx("span",{className:"value",style:{fontSize:13},children:e.started_at?new Date(e.started_at*1e3).toLocaleString():"-"})]})]}),o.jsxs("div",{style:{padding:"8px 20px",borderBottom:"1px solid var(--border-color)",display:"flex",alignItems:"center",gap:10,background:"var(--bg-secondary)"},children:[o.jsxs("label",{className:"toggle-switch",style:{transform:"scale(0.85)"},children:[o.jsx("input",{type:"checkbox",checked:r,onChange:g=>i(g.target.checked)}),o.jsx("span",{className:"toggle-slider"})]}),o.jsx("span",{style:{fontSize:12,color:"var(--text-secondary)"},children:"Hide passing results"})]}),o.jsxs("div",{className:"result-cases",children:[d.map((g,v)=>{var L,I,W,A,$,D;const _=g.case_id||`case-${v}`,m=s.has(_),x=((L=g.metric_results)==null?void 0:L.filter(S=>!S.passed||S.error))||[],y=((I=g.metric_results)==null?void 0:I.filter(S=>S.passed&&!S.error))||[],j=((W=g.rubric_results)==null?void 0:W.filter(S=>!S.passed||S.error))||[],P=((A=g.rubric_results)==null?void 0:A.filter(S=>S.passed&&!S.error))||[],C=m?g.metric_results:x,M=m?g.rubric_results:j,N=m?g.invocation_results:($=g.invocation_results)==null?void 0:$.filter(S=>{var O;return((O=S.metric_results)==null?void 0:O.some(R=>!R.passed))||S.error}),F=y.length+P.length,z=x.length+j.length;return o.jsxs("div",{className:"result-case",children:[o.jsxs("div",{className:"result-case-header",onClick:()=>p(_),style:{cursor:"pointer"},children:[o.jsxs("div",{className:"result-case-name",children:[o.jsx("span",{style:{marginRight:6,fontSize:12,color:"var(--text-muted)"},children:m?"▼":"▶"}),g.passed?o.jsx(pr,{size:16,style:{color:"var(--success)"}}):o.jsx($r,{size:16,style:{color:"var(--error)"}}),g.eval_set_name&&(e==null?void 0:e.eval_set_id)==="batch"&&o.jsx("span",{style:{fontSize:10,color:"var(--text-muted)",background:"var(--bg-tertiary)",padding:"2px 6px",borderRadius:4,marginRight:6},children:g.eval_set_name}),g.case_name||`Case ${v+1}`,o.jsxs("span",{style:{marginLeft:10,fontSize:11,color:"var(--text-muted)",fontWeight:400},children:[z>0&&o.jsxs("span",{style:{color:"var(--error)"},children:[z," failed"]}),z>0&&F>0&&" · ",F>0&&o.jsxs("span",{style:{color:"var(--success)"},children:[F," passed"]})]})]}),o.jsxs("div",{style:{display:"flex",gap:8,alignItems:"center"},children:[g.session_id&&o.jsxs("button",{className:"btn btn-secondary btn-sm",onClick:S=>{S.stopPropagation(),f(g.session_id)},title:"View session in Run panel",children:[o.jsx(uv,{size:12})," View Session"]}),o.jsx("span",{style:{fontSize:12,color:"var(--text-secondary)"},children:g.duration_ms?`${(g.duration_ms/1e3).toFixed(2)}s`:""})]})]}),o.jsxs("div",{className:"result-case-details",children:[(C==null?void 0:C.length)>0&&o.jsxs("div",{style:{display:"flex",flexWrap:"wrap",gap:8,marginBottom:8},children:[C.map((S,O)=>{const R=Ko(S.metric,S.score,S.threshold);return o.jsxs("div",{style:{padding:"6px 10px",borderRadius:"var(--radius-sm)",background:S.error?"rgba(255, 193, 7, 0.1)":S.passed?"rgba(var(--success-rgb), 0.05)":"rgba(var(--error-rgb), 0.1)",border:`1px solid ${S.error?"var(--warning)":S.passed?"var(--border-color)":"var(--error)"}`,display:"flex",flexDirection:"column",alignItems:"center",minWidth:80},children:[o.jsx("span",{style:{fontSize:10,color:"var(--text-secondary)",textAlign:"center",marginBottom:2},children:S.metric.replace(/_/g," ").replace("v1","").replace("v2","").trim()}),S.error?o.jsx("span",{style:{fontSize:10,color:"var(--warning)"},children:"Error"}):o.jsxs(o.Fragment,{children:[o.jsx("span",{style:{fontSize:14,fontWeight:600,color:S.passed?"var(--success)":"var(--error)"},children:R.value}),o.jsx("span",{style:{fontSize:9,color:"var(--text-muted)"},children:R.comparison})]})]},O)}),!m&&y.length>0&&o.jsxs("div",{style:{padding:"6px 10px",borderRadius:"var(--radius-sm)",background:"var(--bg-tertiary)",border:"1px dashed var(--border-color)",display:"flex",alignItems:"center",fontSize:11,color:"var(--text-muted)"},children:["+",y.length," passed"]})]}),C==null?void 0:C.filter(S=>!S.passed&&S.rationale).map((S,O)=>o.jsxs("div",{style:{marginTop:8,padding:"8px 12px",borderRadius:"var(--radius-sm)",background:"rgba(var(--error-rgb), 0.05)",border:"1px solid rgba(var(--error-rgb), 0.2)",fontSize:12},children:[o.jsxs("div",{style:{fontWeight:500,marginBottom:4,color:"var(--error)",fontSize:11},children:[S.metric.replace(/_/g," ")," - Why it failed:"]}),o.jsx("div",{style:{whiteSpace:"pre-wrap",color:"var(--text-secondary)",lineHeight:1.4},children:S.rationale})]},`rationale-${O}`)),(M==null?void 0:M.length)>0&&o.jsxs("div",{style:{marginTop:8},children:[o.jsx("div",{style:{fontSize:11,color:"var(--text-secondary)",marginBottom:4},children:"Custom Rubrics"}),M.map((S,O)=>o.jsxs("div",{style:{marginBottom:S.rationale&&!S.passed?8:4},children:[o.jsxs("div",{className:"metric-row",children:[o.jsx("span",{className:"metric-name",style:{flex:1},children:S.rubric}),o.jsx("span",{className:`metric-value ${S.passed?"passed":"failed"}`,children:S.passed?"✓ Pass":"✗ Fail"})]}),!S.passed&&S.rationale&&o.jsxs("div",{style:{marginTop:4,marginLeft:8,padding:"6px 10px",borderRadius:"var(--radius-sm)",background:"rgba(var(--error-rgb), 0.05)",border:"1px solid rgba(var(--error-rgb), 0.2)",fontSize:11,color:"var(--text-secondary)"},children:[o.jsx("strong",{style:{color:"var(--error)"},children:"Why:"})," ",S.rationale]}),S.error&&o.jsxs("div",{style:{marginTop:4,marginLeft:8,fontSize:11,color:"var(--warning)"},children:["Error: ",S.error]})]},O)),!m&&P.length>0&&o.jsxs("div",{style:{fontSize:11,color:"var(--text-muted)",marginTop:4},children:["+",P.length," passed rubric",P.length>1?"s":""]})]}),(N==null?void 0:N.length)>0&&o.jsxs("div",{className:"invocation-summary",children:[o.jsxs("div",{style:{fontSize:11,color:"var(--text-secondary)",marginBottom:8},children:["Invocations (",N.length,!m&&((D=g.invocation_results)==null?void 0:D.length)>N.length?` of ${g.invocation_results.length}`:"",")"]}),N.map((S,O)=>o.jsxs("div",{className:"invocation-item",children:[o.jsxs("div",{className:"invocation-query",children:["Turn ",S.invocation_id||O+1,": ",S.user_message||"(no message)"]}),S.actual_response&&o.jsxs("div",{className:"invocation-response",children:["Response: ",S.actual_response.substring(0,200),S.actual_response.length>200?"...":""]})]},O))]}),g.error&&o.jsx("div",{style:{marginTop:12,padding:12,background:"rgba(255, 107, 107, 0.1)",borderRadius:"var(--radius-sm)",color:"var(--error)",fontSize:12,whiteSpace:"pre-wrap"},children:g.error})]})]},_)}),l.length===0&&o.jsx("div",{style:{textAlign:"center",padding:32,color:"var(--text-secondary)"},children:"No test cases in this run"})]})]})}function q5({evalCase:e,evalSetId:t,projectId:n,result:r,isRunning:i,onUpdate:s,onDelete:a,onRun:l,onClearResult:c}){var P,C,M;const{project:u}=ht(),[d,p]=k.useState(e),[f,h]=k.useState("assertions");k.useEffect(()=>{p(e)},[e.id]);const g=k.useCallback(N=>{p(F=>({...F,...N})),s(N)},[s]),v=()=>{const N={id:H1(),user_message:"",expected_response:"",expected_tool_calls:[],tool_trajectory_match_type:"in_order",rubrics:[]};g({invocations:[...d.invocations,N]})},_=(N,F)=>{const z=[...d.invocations];z[N]={...z[N],...F},g({invocations:z})},m=N=>{g({invocations:d.invocations.filter((F,z)=>z!==N)})},x=N=>{const F=[...d.invocations];F[N]={...F[N],expected_tool_calls:[...F[N].expected_tool_calls,{name:"",args:{},args_match_mode:"subset"}]},g({invocations:F})},y=(N,F,z)=>{const L=[...d.invocations],I=[...L[N].expected_tool_calls];I[F]={...I[F],...z},L[N]={...L[N],expected_tool_calls:I},g({invocations:L})},j=(N,F)=>{const z=[...d.invocations];z[N]={...z[N],expected_tool_calls:z[N].expected_tool_calls.filter((L,I)=>I!==F)},g({invocations:z})};return o.jsxs(o.Fragment,{children:[o.jsxs("div",{className:"editor-header",children:[o.jsx(Pa,{size:20,style:{color:"var(--accent-primary)"}}),o.jsx("input",{type:"text",value:d.name,onChange:N=>g({name:N.target.value}),placeholder:"Test case name"}),o.jsx("button",{className:"btn btn-secondary btn-sm",onClick:()=>{const N=`${window.location.origin}/project/${n}/evaluate?set=${t}&case=${e.id}`;navigator.clipboard.writeText(N)},title:"Copy link to this test case",children:o.jsx(Yd,{size:14})}),o.jsxs("button",{className:"btn btn-primary btn-sm",onClick:l,disabled:i,children:[i?o.jsx(Fo,{size:14,className:"spinning"}):o.jsx(fr,{size:14}),"Run"]}),o.jsx("button",{className:"btn btn-danger btn-sm",onClick:a,children:o.jsx(Ue,{size:14})})]}),o.jsxs("div",{className:"tabs",children:[o.jsxs("div",{className:`tab ${f==="assertions"?"active":""}`,onClick:()=>h("assertions"),children:[o.jsx(Ma,{size:14,style:{marginRight:6}}),"Assertions (",d.invocations.length,")"]}),o.jsxs("div",{className:`tab ${f==="rubrics"?"active":""}`,onClick:()=>h("rubrics"),children:[o.jsx(Xd,{size:14,style:{marginRight:6}}),"LLM Judges"]}),o.jsxs("div",{className:`tab ${f==="docs"?"active":""}`,onClick:()=>h("docs"),children:[o.jsx(ji,{size:14,style:{marginRight:6}}),"Docs"]}),o.jsxs("div",{className:`tab ${f==="json"?"active":""}`,onClick:()=>h("json"),children:[o.jsx(jn,{size:14,style:{marginRight:6}}),"JSON"]})]}),o.jsxs("div",{className:"editor-content",children:[f==="assertions"&&o.jsxs(o.Fragment,{children:[o.jsxs("div",{style:{display:"flex",gap:12,marginBottom:12},children:[o.jsxs("div",{style:{flex:1},children:[o.jsx("label",{style:{fontSize:11,color:"var(--text-muted)",marginBottom:4,display:"block"},children:"target_agent"}),o.jsxs("select",{value:d.target_agent||"",onChange:N=>g({target_agent:N.target.value||void 0}),style:{width:"100%"},children:[o.jsx("option",{value:"",children:"root_agent"}),(P=u==null?void 0:u.agents)==null?void 0:P.map(N=>o.jsx("option",{value:N.name,children:N.name},N.name))]})]}),o.jsxs("div",{style:{flex:1},children:[o.jsx("label",{style:{fontSize:11,color:"var(--text-muted)",marginBottom:4,display:"block"},children:"tags"}),o.jsx("input",{type:"text",value:d.tags.join(", "),onChange:N=>g({tags:N.target.value.split(",").map(F=>F.trim()).filter(Boolean)}),placeholder:"smoke, regression",style:{width:"100%"}})]})]}),o.jsxs("div",{className:"form-section",children:[o.jsx("h4",{children:"Description"}),o.jsx("textarea",{value:d.description,onChange:N=>g({description:N.target.value}),placeholder:"What does this test verify?",style:{minHeight:40}})]}),o.jsxs("div",{className:"form-section",children:[o.jsxs("h4",{children:["session_input ",o.jsx("span",{style:{fontWeight:400,color:"var(--text-muted)"},children:"(initial state)"})]}),o.jsx("div",{style:{height:80,borderRadius:"var(--radius-sm)",overflow:"hidden",border:"1px solid var(--border-color)"},children:o.jsx(Zt,{height:"100%",defaultLanguage:"json",value:(()=>{var F;if((!d.initial_state||Object.keys(d.initial_state).length===0)&&((F=u==null?void 0:u.app)!=null&&F.state_keys)&&u.app.state_keys.length>0){const z={};return u.app.state_keys.forEach(L=>{L.default_value!==void 0?z[L.name]=L.default_value:z[L.name]=L.type==="string"?"":L.type==="number"?0:L.type==="boolean"?!1:L.type==="array"?[]:{}}),JSON.stringify(z,null,2)}return JSON.stringify(d.initial_state,null,2)})(),onChange:N=>{try{N&&g({initial_state:JSON.parse(N)})}catch{}},theme:"vs-dark",options:{minimap:{enabled:!1},scrollBeyondLastLine:!1,lineNumbers:"off",glyphMargin:!1,folding:!1,lineDecorationsWidth:0,lineNumbersMinChars:0,fontSize:12,automaticLayout:!0,scrollbar:{verticalScrollbarSize:6}}})})]}),o.jsxs("div",{className:"form-section",children:[o.jsxs("h4",{children:[o.jsx(Ma,{size:14}),"Conversation Turns"]}),d.invocations.map((N,F)=>o.jsxs("div",{className:"invocation-card",children:[o.jsxs("div",{className:"invocation-number",children:[o.jsx("span",{children:F+1}),d.invocations.length>1&&o.jsx("button",{className:"btn btn-danger btn-sm",onClick:()=>m(F),style:{padding:4},children:o.jsx(Ue,{size:10})})]}),o.jsxs("div",{className:"invocation-content",children:[o.jsxs("div",{className:"invocation-row",children:[o.jsxs("div",{className:"form-section",children:[o.jsx("label",{children:"User Query"}),o.jsx("textarea",{value:N.user_message,onChange:z=>_(F,{user_message:z.target.value}),placeholder:"The message to send to the agent..."})]}),o.jsxs("div",{className:"form-section",children:[o.jsxs("label",{children:["Expected Response ",o.jsx("span",{style:{color:"var(--text-muted)",fontWeight:400},children:"(ROUGE-1)"})]}),o.jsx("textarea",{value:N.expected_response||"",onChange:z=>_(F,{expected_response:z.target.value||void 0}),placeholder:"Expected text (partial match)..."})]})]}),N.expected_tool_calls.map((z,L)=>o.jsxs("div",{className:"tool-call-compact",children:[o.jsx("input",{type:"text",value:z.name,onChange:I=>y(F,L,{name:I.target.value}),placeholder:"tool_name",className:"tool-name-input"}),o.jsxs("div",{className:"pillbox-toggle",children:[o.jsx("button",{className:`pill ${z.args_match_mode==="subset"?"active":""}`,onClick:()=>y(F,L,{args_match_mode:"subset"}),children:"Partial"}),o.jsx("button",{className:`pill ${z.args_match_mode==="exact"?"active":""}`,onClick:()=>y(F,L,{args_match_mode:"exact"}),children:"Exact"})]}),o.jsx("div",{className:"tool-args-editor",children:o.jsx(Zt,{height:"22px",defaultLanguage:"json",value:JSON.stringify(z.args||{}),onChange:I=>{try{I&&y(F,L,{args:JSON.parse(I)})}catch{}},theme:"vs-dark",options:{minimap:{enabled:!1},scrollBeyondLastLine:!1,lineNumbers:"off",glyphMargin:!1,folding:!1,lineDecorationsWidth:0,lineNumbersMinChars:0,wordWrap:"off",scrollbar:{vertical:"hidden",horizontal:"hidden"},overviewRulerLanes:0,hideCursorInOverviewRuler:!0,overviewRulerBorder:!1,renderLineHighlight:"none",fontSize:11,padding:{top:3,bottom:3},automaticLayout:!0}})}),o.jsx("button",{className:"btn btn-danger btn-sm",onClick:()=>j(F,L),style:{padding:"4px 6px"},children:o.jsx(Ue,{size:10})})]},L)),o.jsxs("button",{className:"btn btn-secondary btn-sm",onClick:()=>x(F),style:{marginTop:4},children:[o.jsx(Xe,{size:12})," Assert Tool Call"]})]})]},N.id)),o.jsxs("button",{className:"btn btn-secondary",onClick:v,children:[o.jsx(Xe,{size:14})," Add Turn"]})]}),o.jsxs("div",{className:"form-section",children:[o.jsxs("h4",{children:[o.jsx(pr,{size:14,style:{marginRight:6}}),"final_session_state ",o.jsx("span",{style:{fontWeight:400,color:"var(--text-muted)"},children:"(optional)"})]}),o.jsx("p",{style:{fontSize:12,color:"var(--text-muted)",marginBottom:8},children:"Assert that session state contains these key-value pairs after all turns complete."}),o.jsx("div",{style:{height:80,borderRadius:"var(--radius-sm)",overflow:"hidden",border:"1px solid var(--border-color)"},children:o.jsx(Zt,{height:"100%",defaultLanguage:"json",value:d.expected_final_state?JSON.stringify(d.expected_final_state,null,2):"{}",onChange:N=>{if(!N||N==="{}")g({expected_final_state:void 0});else try{g({expected_final_state:JSON.parse(N)})}catch{}},theme:"vs-dark",options:{minimap:{enabled:!1},scrollBeyondLastLine:!1,lineNumbers:"off",glyphMargin:!1,folding:!1,lineDecorationsWidth:0,lineNumbersMinChars:0,fontSize:12,automaticLayout:!0,scrollbar:{verticalScrollbarSize:6}}})})]})]}),f==="rubrics"&&o.jsxs(o.Fragment,{children:[o.jsx("div",{className:"form-section",style:{marginBottom:16},children:[{metric:"safety_v1",label:"safety_v1",default:.8,max:1},{metric:"hallucinations_v1",label:"hallucinations_v1",default:.8,max:1},{metric:"response_evaluation_score",label:"response_evaluation_score",default:3.5,max:5},{metric:"final_response_match_v2",label:"final_response_match_v2",default:.7,max:1}].map(({metric:N,label:F,default:z,max:L})=>{const I=(d.enabled_metrics||[]).find(A=>A.metric===N),W=(I==null?void 0:I.threshold)??z;return o.jsxs("div",{style:{display:"flex",alignItems:"center",gap:10,marginBottom:6},children:[o.jsxs("label",{className:"toggle-switch",style:{margin:0},children:[o.jsx("input",{type:"checkbox",checked:!!I,onChange:A=>{const $=[...d.enabled_metrics||[]];if(A.target.checked)$.push({metric:N,threshold:z});else{const D=$.findIndex(S=>S.metric===N);D!==-1&&$.splice(D,1)}g({enabled_metrics:$})}}),o.jsx("span",{className:"toggle-slider"})]}),o.jsx("span",{style:{fontSize:12,opacity:I?1:.5,minWidth:100},children:F}),o.jsx("span",{style:{fontSize:11,color:"var(--text-muted)",opacity:I?1:.4},children:"≥"}),o.jsx("input",{type:"number",min:L===5?1:0,max:L,step:.1,value:W,disabled:!I,onChange:A=>{const $=[...d.enabled_metrics||[]],D=$.findIndex(S=>S.metric===N);D!==-1&&($[D]={...$[D],threshold:parseFloat(A.target.value)||0},g({enabled_metrics:$}))},style:{width:60,textAlign:"center",opacity:I?1:.3,padding:"2px 4px",fontSize:11}})]},N)})}),o.jsx("hr",{style:{border:"none",borderTop:"1px solid var(--border-color)",margin:"16px 0"}}),o.jsxs("div",{className:"form-section",children:[o.jsx("h4",{children:"Custom Rubrics"}),o.jsx("p",{style:{fontSize:12,color:"var(--text-muted)",marginBottom:8},children:"Natural language criteria evaluated by an LLM judge. Returns pass/fail per rubric."}),d.rubrics.map((N,F)=>o.jsxs("div",{className:"tool-call-row",style:{marginBottom:8},children:[o.jsx("input",{type:"text",value:N.rubric,onChange:z=>{const L=[...d.rubrics];L[F]={rubric:z.target.value},g({rubrics:L})},placeholder:"e.g., The response mentions the return policy",style:{flex:1}}),o.jsx("button",{className:"btn btn-danger btn-sm",onClick:()=>g({rubrics:d.rubrics.filter((z,L)=>L!==F)}),children:o.jsx(Ue,{size:12})})]},F)),o.jsxs("button",{className:"btn btn-secondary btn-sm",onClick:()=>g({rubrics:[...d.rubrics,{rubric:""}]}),children:[o.jsx(Xe,{size:12})," Add Rubric"]})]})]}),f==="docs"&&o.jsxs("div",{style:{fontSize:13,lineHeight:1.6,color:"var(--text-secondary)",overflowY:"auto",maxHeight:"100%"},children:[o.jsx("h3",{style:{marginBottom:16,color:"var(--text-primary)"},children:"Evaluation Test Case Guide"}),o.jsxs("section",{style:{marginBottom:24,padding:12,background:"rgba(var(--accent-primary-rgb), 0.1)",borderRadius:"var(--radius-md)",border:"1px solid var(--accent-primary)"},children:[o.jsx("h4",{style:{color:"var(--accent-primary)",marginBottom:8},children:"🎯 Quick Overview"}),o.jsxs("p",{children:["Each test case simulates a ",o.jsx("strong",{children:"multi-turn conversation"})," with an agent. For each turn (invocation), you provide a user message and define what you expect the agent to do."]}),o.jsxs("ul",{style:{marginLeft:20,marginTop:8},children:[o.jsxs("li",{children:[o.jsx("strong",{children:"Invocations"})," = conversation turns (user messages)"]}),o.jsxs("li",{children:[o.jsx("strong",{children:"Expected Response"})," = the agent's ",o.jsx("em",{children:"final text reply"})," for that turn"]}),o.jsxs("li",{children:[o.jsx("strong",{children:"Expected Tool Calls"})," = tools the agent should invoke during that turn"]}),o.jsxs("li",{children:[o.jsx("strong",{children:"Session State"})," = test the ",o.jsx("em",{children:"final state"})," after ALL turns complete"]})]})]}),o.jsxs("section",{style:{marginBottom:24},children:[o.jsx("h4",{style:{color:"var(--accent-primary)",marginBottom:8},children:'📝 What is "Expected Response"?'}),o.jsxs("p",{children:["The ",o.jsx("strong",{children:"Expected Response"})," is matched against the agent's ",o.jsx("strong",{children:"final response"})," for that specific turn — NOT every message."]}),o.jsxs("div",{style:{background:"var(--bg-secondary)",padding:12,borderRadius:"var(--radius-sm)",marginTop:8},children:[o.jsx("p",{style:{marginBottom:8},children:o.jsx("strong",{children:"During one turn, an agent may:"})}),o.jsxs("ul",{style:{marginLeft:20,marginBottom:12},children:[o.jsx("li",{children:"Send intermediate thinking/reasoning messages"}),o.jsx("li",{children:"Call multiple tools"}),o.jsx("li",{children:"Transfer to sub-agents (who may respond)"}),o.jsxs("li",{children:["Finally send a ",o.jsx("em",{children:"concluding response"})]})]}),o.jsxs("p",{children:["Only the ",o.jsx("strong",{children:"last text response"})," from the agent for that turn is compared against your Expected Response."]})]}),o.jsx("p",{style:{marginTop:8,fontStyle:"italic",color:"var(--text-muted)"},children:"Tip: If you need to verify intermediate steps, use Tool Trajectory matching or custom Rubrics."})]}),o.jsxs("section",{style:{marginBottom:24},children:[o.jsx("h4",{style:{color:"var(--accent-primary)",marginBottom:8},children:"🔄 Response Matching (ROUGE-1)"}),o.jsxs("p",{children:["The ",o.jsx("code",{children:"response_match_score"})," uses ",o.jsx("strong",{children:"ROUGE-1 F1 scoring"})," — fuzzy word-level matching:"]}),o.jsxs("ul",{style:{marginLeft:20,marginTop:8},children:[o.jsx("li",{children:"Tokenizes both expected and actual responses into words"}),o.jsx("li",{children:"Calculates word overlap (not exact string match)"}),o.jsx("li",{children:"Returns a score from 0.0 to 1.0"})]}),o.jsxs("div",{style:{background:"var(--bg-secondary)",padding:12,borderRadius:"var(--radius-sm)",marginTop:8},children:[o.jsx("p",{children:o.jsx("strong",{children:"Example:"})}),o.jsxs("p",{children:["Expected: ",o.jsx("code",{children:'"The weather in Paris is sunny today"'})]}),o.jsxs("p",{children:["Actual: ",o.jsx("code",{children:'"Today in Paris, expect sunny weather"'})]}),o.jsx("p",{style:{marginTop:8,color:"var(--success)"},children:"✓ High ROUGE-1 score (same words, different order)"})]}),o.jsxs("p",{style:{marginTop:8},children:["A threshold of ",o.jsx("strong",{children:"0.7"})," means 70% word overlap is required to pass."]})]}),o.jsxs("section",{style:{marginBottom:24},children:[o.jsx("h4",{style:{color:"var(--accent-primary)",marginBottom:8},children:"🛠️ Tool Trajectory Matching"}),o.jsxs("p",{children:["The ",o.jsx("code",{children:"tool_trajectory_avg_score"})," verifies the agent called expected tools. Match types:"]}),o.jsxs("ul",{style:{marginLeft:20,marginTop:8},children:[o.jsxs("li",{children:[o.jsx("strong",{children:"Exact"})," — Same tools in same order, no extras allowed"]}),o.jsxs("li",{children:[o.jsx("strong",{children:"In Order"})," — Expected tools appear in order, extras allowed between"]}),o.jsxs("li",{children:[o.jsx("strong",{children:"Any Order"})," — All expected tools present, any order, extras allowed"]})]}),o.jsx("p",{style:{marginTop:8},children:"For each tool, you can match by:"}),o.jsxs("ul",{style:{marginLeft:20,marginTop:4},children:[o.jsxs("li",{children:[o.jsx("strong",{children:"Name Only"})," — Just check the tool was called"]}),o.jsxs("li",{children:[o.jsx("strong",{children:"Exact Args"})," — Arguments must match exactly (provide JSON)"]}),o.jsxs("li",{children:[o.jsx("strong",{children:"Args Subset"})," — Your expected args must be present in actual args"]})]})]}),o.jsxs("section",{style:{marginBottom:24},children:[o.jsx("h4",{style:{color:"var(--accent-primary)",marginBottom:8},children:"💾 Session State Testing"}),o.jsxs("p",{children:[o.jsx("strong",{children:"Initial State"})," (Settings tab) — Pre-populate session state before running the test:"]}),o.jsxs("ul",{style:{marginLeft:20,marginTop:8},children:[o.jsx("li",{children:"Set user preferences or context"}),o.jsx("li",{children:"Simulate a specific scenario"}),o.jsx("li",{children:"Test state-dependent behavior"})]}),o.jsxs("p",{style:{marginTop:12},children:[o.jsx("strong",{children:"Expected Final State"})," — Verified at the ",o.jsx("em",{children:"very end"})," of the test case, ",o.jsx("strong",{children:"after ALL invocations complete"}),"."]}),o.jsx("div",{style:{background:"var(--bg-secondary)",padding:12,borderRadius:"var(--radius-sm)",marginTop:8,borderLeft:"3px solid var(--warning)"},children:o.jsxs("p",{style:{margin:0},children:[o.jsx("strong",{children:"Important:"})," State is tested once after the entire conversation, NOT after each turn. To test state changes per-turn, use separate test cases."]})})]}),o.jsxs("section",{style:{marginBottom:24},children:[o.jsx("h4",{style:{color:"var(--accent-primary)",marginBottom:8},children:"🎯 Target Agent (Settings tab)"}),o.jsxs("p",{children:["By default, tests run against the ",o.jsx("strong",{children:"root_agent"})," of your App. You can select a specific sub-agent to test in isolation:"]}),o.jsxs("ul",{style:{marginLeft:20,marginTop:8},children:[o.jsxs("li",{children:[o.jsx("strong",{children:"root_agent"})," — Test the full agent hierarchy (default)"]}),o.jsxs("li",{children:[o.jsx("strong",{children:"Specific agent"})," — Unit test individual agents"]})]}),o.jsx("p",{style:{marginTop:8,fontStyle:"italic",color:"var(--text-muted)"},children:"Useful for testing sub-agents independently before integrating into the full system."})]}),o.jsxs("section",{style:{marginBottom:24},children:[o.jsx("h4",{style:{color:"var(--accent-primary)",marginBottom:8},children:"📋 Custom Rubrics"}),o.jsx("p",{children:"Rubrics are custom yes/no criteria evaluated by an LLM judge. Examples:"}),o.jsxs("ul",{style:{marginLeft:20,marginTop:8},children:[o.jsx("li",{children:'"Does the response mention the product price?"'}),o.jsx("li",{children:'"Is the tone professional and helpful?"'}),o.jsx("li",{children:'"Does the response avoid mentioning competitors?"'})]}),o.jsx("p",{style:{marginTop:8,fontStyle:"italic",color:"var(--text-muted)"},children:"Note: Rubric evaluation requires LLM-judged metrics to be enabled in the Eval Set."})]}),o.jsxs("section",{style:{marginBottom:24},children:[o.jsx("h4",{style:{color:"var(--accent-primary)",marginBottom:8},children:"📊 Available Metrics"}),o.jsxs("table",{style:{width:"100%",borderCollapse:"collapse",fontSize:12},children:[o.jsx("thead",{children:o.jsxs("tr",{style:{borderBottom:"1px solid var(--border-color)"},children:[o.jsx("th",{style:{textAlign:"left",padding:"8px 4px"},children:"Metric"}),o.jsx("th",{style:{textAlign:"left",padding:"8px 4px"},children:"Type"}),o.jsx("th",{style:{textAlign:"left",padding:"8px 4px"},children:"Description"})]})}),o.jsx("tbody",{children:Object.keys(bn).map(N=>o.jsxs("tr",{style:{borderBottom:"1px solid var(--border-color)"},children:[o.jsx("td",{style:{padding:"8px 4px",fontFamily:"var(--font-mono)",fontSize:11},children:N}),o.jsx("td",{style:{padding:"8px 4px"},children:bn[N].requiresJudge?o.jsx("span",{style:{fontSize:10,padding:"2px 6px",background:"var(--accent-primary)",color:"white",borderRadius:4},children:"LLM Judge"}):o.jsx("span",{style:{fontSize:10,padding:"2px 6px",background:"var(--bg-tertiary)",borderRadius:4},children:"Built-in"})}),o.jsx("td",{style:{padding:"8px 4px",color:"var(--text-muted)"},children:bn[N].description})]},N))})]})]}),o.jsxs("section",{children:[o.jsx("h4",{style:{color:"var(--accent-primary)",marginBottom:8},children:"💡 Tips"}),o.jsxs("ul",{style:{marginLeft:20},children:[o.jsx("li",{children:"Start with simple single-turn tests, then add complexity"}),o.jsx("li",{children:'Use "In Order" matching for most tool trajectory tests'}),o.jsx("li",{children:"Lower ROUGE thresholds (0.5-0.6) for creative/varied responses"}),o.jsx("li",{children:"Higher thresholds (0.8-0.9) for factual/precise responses"}),o.jsx("li",{children:"Use tags to organize tests by feature or priority"}),o.jsx("li",{children:"Test sub-agents individually using Target Agent selector"})]})]})]}),f==="json"&&o.jsxs("div",{style:{display:"flex",flexDirection:"column",gap:16,height:"100%"},children:[o.jsx("div",{style:{fontSize:12,color:"var(--text-secondary)",padding:"8px 0"},children:o.jsxs("p",{style:{margin:0},children:["This is the ADK-compatible JSON format for this test case. You can use this with ",o.jsx("code",{style:{background:"var(--bg-tertiary)",padding:"2px 6px",borderRadius:4},children:"adk eval"}),"."]})}),o.jsx("div",{style:{flex:1,minHeight:300,border:"1px solid var(--border-color)",borderRadius:"var(--radius-md)",overflow:"hidden"},children:o.jsx(Zt,{height:"100%",language:"json",theme:"vs-dark",value:JSON.stringify({name:d.name,description:d.description||void 0,tags:(C=d.tags)!=null&&C.length?d.tags:void 0,target_agent:d.target_agent!=="root_agent"?d.target_agent:void 0,invocations:d.invocations.map(N=>{var F;return{user_message:N.user_message,expected_response:N.expected_response||void 0,expected_tool_calls:(F=N.expected_tool_calls)!=null&&F.length?N.expected_tool_calls.map(z=>({tool_name:z.tool_name,args:z.match_type!=="name_only"&&Object.keys(z.args||{}).length?z.args:void 0})):void 0}}),session_input:Object.keys(d.session_input||{}).length?{state:d.session_input}:void 0,final_session_state:Object.keys(d.final_session_state||{}).length?d.final_session_state:void 0,rubrics:(M=d.rubrics)!=null&&M.length?d.rubrics.map(N=>N.rubric):void 0},null,2),options:{readOnly:!0,minimap:{enabled:!1},fontSize:12,fontFamily:"'JetBrains Mono', monospace",lineNumbers:"on",scrollBeyondLastLine:!1,automaticLayout:!0,tabSize:2,wordWrap:"on",padding:{top:12}}})}),o.jsx("div",{style:{display:"flex",gap:8},children:o.jsxs("button",{className:"btn btn-secondary btn-sm",onClick:()=>{var F,z;const N=JSON.stringify({name:d.name,description:d.description||void 0,tags:(F=d.tags)!=null&&F.length?d.tags:void 0,target_agent:d.target_agent!=="root_agent"?d.target_agent:void 0,invocations:d.invocations.map(L=>{var I;return{user_message:L.user_message,expected_response:L.expected_response||void 0,expected_tool_calls:(I=L.expected_tool_calls)!=null&&I.length?L.expected_tool_calls.map(W=>({tool_name:W.tool_name,args:W.match_type!=="name_only"&&Object.keys(W.args||{}).length?W.args:void 0})):void 0}}),session_input:Object.keys(d.session_input||{}).length?{state:d.session_input}:void 0,final_session_state:Object.keys(d.final_session_state||{}).length?d.final_session_state:void 0,rubrics:(z=d.rubrics)!=null&&z.length?d.rubrics.map(L=>L.rubric):void 0},null,2);navigator.clipboard.writeText(N)},children:[o.jsx(ns,{size:14})," Copy JSON"]})})]})]}),r&&o.jsxs("div",{className:"result-panel",children:[o.jsxs("div",{className:`result-header ${r.passed?"passed":"failed"}`,children:[r.passed?o.jsxs(o.Fragment,{children:[o.jsx(pr,{size:18})," ",o.jsx("strong",{children:"Passed"})]}):o.jsxs(o.Fragment,{children:[o.jsx($r,{size:18})," ",o.jsx("strong",{children:"Failed"})]}),o.jsxs("div",{style:{marginLeft:"auto",display:"flex",alignItems:"center",gap:12},children:[r.total_tokens?o.jsxs("span",{style:{fontSize:11,color:"var(--text-muted)"},title:"Total tokens used",children:[r.total_tokens.toLocaleString()," tokens"]}):null,o.jsxs("span",{style:{color:"var(--text-muted)",fontSize:12},children:[r.duration_ms.toFixed(0),"ms"]}),r.session_id&&o.jsxs("button",{className:"btn btn-secondary btn-sm",onClick:()=>{window.location.href=`/project/${u==null?void 0:u.id}/run?session=${r.session_id}`},title:"View this session in the Run panel",style:{fontSize:11},children:[o.jsx(uv,{size:12}),"View Session"]}),c&&o.jsx("button",{className:"btn btn-secondary btn-sm",onClick:c,title:"Close test results",style:{fontSize:11,padding:"4px 8px"},children:"✕"})]})]}),o.jsx("div",{className:"result-scores",children:r.metric_results.map((N,F)=>{var L;const z=Ko(N.metric,N.score,N.threshold);return o.jsxs("div",{className:"score-card",children:[o.jsx("div",{className:`score-value ${N.passed?"passed":"failed"}`,children:z.value}),o.jsx("div",{className:"score-label",children:((L=bn[N.metric])==null?void 0:L.name)||N.metric}),o.jsx("div",{style:{fontSize:10,color:"var(--text-muted)",marginTop:2},children:z.comparison}),N.error&&o.jsx("div",{style:{fontSize:10,color:"var(--error)",marginTop:4},children:N.error})]},F)})}),r.rubric_results&&r.rubric_results.length>0&&o.jsxs("div",{style:{marginTop:16},children:[o.jsx("h5",{style:{fontSize:13,marginBottom:8},children:"Custom Rubrics"}),o.jsx("div",{style:{display:"flex",flexDirection:"column",gap:8},children:r.rubric_results.map((N,F)=>o.jsxs("div",{style:{padding:"8px 12px",borderRadius:"var(--radius-sm)",background:N.passed?"rgba(var(--success-rgb), 0.1)":"rgba(var(--error-rgb), 0.1)",border:`1px solid ${N.passed?"var(--success)":"var(--error)"}`,display:"flex",alignItems:"center",gap:10},children:[o.jsx("span",{style:{fontSize:16,color:N.passed?"var(--success)":"var(--error)",fontWeight:"bold"},children:N.passed?"✓":"✗"}),o.jsxs("div",{style:{flex:1},children:[o.jsx("div",{style:{fontSize:12,color:"var(--text-primary)"},children:N.rubric}),N.error&&o.jsxs("div",{style:{fontSize:10,color:"var(--error)",marginTop:2},children:["Error: ",N.error]})]})]},F))})]}),r.invocation_results.map((N,F)=>o.jsxs("div",{className:"result-details",children:[o.jsxs("h5",{children:["Turn ",F+1,": ",N.user_message.length>50?N.user_message.slice(0,50)+"…":N.user_message]}),N.metric_results.length>0&&o.jsx("div",{style:{display:"flex",gap:8,marginBottom:8,flexWrap:"wrap"},children:N.metric_results.map((z,L)=>{var W;const I=Ko(z.metric,z.score,z.threshold);return o.jsxs("span",{style:{fontSize:11,padding:"2px 6px",borderRadius:"var(--radius-sm)",background:z.passed?"rgba(var(--success-rgb), 0.15)":"rgba(var(--error-rgb), 0.15)",color:z.passed?"var(--success)":"var(--error)"},children:[((W=bn[z.metric])==null?void 0:W.name)||z.metric,": ",I.value]},L)})}),o.jsxs("div",{className:"detail-box",children:[o.jsx("strong",{children:"Actual Response:"}),`
`,N.actual_response||"(no response)",`

`,N.actual_tool_calls.length>0&&o.jsxs(o.Fragment,{children:[o.jsx("strong",{children:"Tool Calls:"}),`
`,N.actual_tool_calls.map((z,L)=>`  ${L+1}. ${z.name}(${JSON.stringify(z.args)})
`).join("")]})]})]},F)),r.error&&o.jsxs("div",{className:"result-details",children:[o.jsx("h5",{style:{color:"var(--error)"},children:"Error"}),o.jsx("div",{className:"detail-box",style:{color:"var(--error)"},children:r.error})]})]})]})}function J5({evalSet:e,projectId:t,result:n,isRunning:r,caseResults:i,onUpdate:s,onDelete:a,onRun:l,onExport:c}){var v,_,m,x;const[u,d]=k.useState(e.name),[p,f]=k.useState(!1);k.useEffect(()=>{d(e.name)},[e.id]);const h=k.useCallback(()=>{u!==e.name&&s({name:u})},[u,e.name,s]),g=y=>y==null?"-":`${Math.round(y*100)}%`;return o.jsxs(o.Fragment,{children:[o.jsxs("div",{className:"editor-header",children:[o.jsx(pv,{size:20,style:{color:"var(--accent-secondary)"}}),o.jsx("input",{type:"text",value:u,onChange:y=>d(y.target.value),onBlur:h,placeholder:"Eval set name"}),o.jsx("button",{className:"btn btn-secondary btn-sm",onClick:()=>{const y=`${window.location.origin}/project/${t}/evaluate?set=${e.id}`;navigator.clipboard.writeText(y)},title:"Copy link to this eval set",children:o.jsx(Yd,{size:14})}),o.jsxs("button",{className:`btn btn-sm ${p?"btn-primary":"btn-secondary"}`,onClick:()=>f(!p),title:"View/Hide JSON",children:[o.jsx(jn,{size:14}),"JSON"]}),o.jsx("button",{className:"btn btn-secondary btn-sm",onClick:c,title:"Export as JSON (compatible with adk eval)",children:o.jsx(Ai,{size:14})}),o.jsxs("button",{className:"btn btn-primary btn-sm",onClick:l,disabled:r,children:[r?o.jsx(Fo,{size:14,className:"spinning"}):o.jsx(fr,{size:14}),"Run All"]}),o.jsx("button",{className:"btn btn-danger btn-sm",onClick:a,children:o.jsx(Ue,{size:14})})]}),o.jsx("div",{className:"editor-content",children:p?o.jsxs("div",{style:{display:"flex",flexDirection:"column",gap:16,height:"100%"},children:[o.jsx("div",{style:{fontSize:12,color:"var(--text-secondary)",padding:"8px 0"},children:o.jsxs("p",{style:{margin:0},children:["This is the ADK-compatible JSON format for this evaluation set. Save this file and use with ",o.jsx("code",{style:{background:"var(--bg-tertiary)",padding:"2px 6px",borderRadius:4},children:"adk eval <agent_path> <eval_file.json>"})]})}),o.jsx("div",{style:{flex:1,minHeight:400,border:"1px solid var(--border-color)",borderRadius:"var(--radius-md)",overflow:"hidden"},children:o.jsx(Zt,{height:"100%",language:"json",theme:"vs-dark",value:JSON.stringify([{id:e.id,name:e.name,description:e.description||void 0,eval_cases:e.eval_cases.map(y=>{var j,P;return{name:y.name,description:y.description||void 0,tags:(j=y.tags)!=null&&j.length?y.tags:void 0,target_agent:y.target_agent!=="root_agent"?y.target_agent:void 0,invocations:y.invocations.map(C=>{var M;return{user_message:C.user_message,expected_response:C.expected_response||void 0,expected_tool_calls:(M=C.expected_tool_calls)!=null&&M.length?C.expected_tool_calls.map(N=>({tool_name:N.tool_name,args:N.match_type!=="name_only"&&Object.keys(N.args||{}).length?N.args:void 0})):void 0}}),session_input:Object.keys(y.session_input||{}).length?{state:y.session_input}:void 0,final_session_state:Object.keys(y.final_session_state||{}).length?y.final_session_state:void 0,rubrics:(P=y.rubrics)!=null&&P.length?y.rubrics.map(C=>C.rubric):void 0}}),eval_config:e.eval_config?{judge_model:e.eval_config.judge_model||void 0,metrics:((v=e.eval_config.metrics)==null?void 0:v.filter(y=>y.enabled))||void 0}:void 0}],null,2),options:{readOnly:!0,minimap:{enabled:!1},fontSize:12,fontFamily:"'JetBrains Mono', monospace",lineNumbers:"on",scrollBeyondLastLine:!1,automaticLayout:!0,tabSize:2,wordWrap:"on",padding:{top:12}}})}),o.jsx("div",{style:{display:"flex",gap:8},children:o.jsxs("button",{className:"btn btn-secondary btn-sm",onClick:()=>{var j;const y=JSON.stringify([{id:e.id,name:e.name,description:e.description||void 0,eval_cases:e.eval_cases.map(P=>{var C,M;return{name:P.name,description:P.description||void 0,tags:(C=P.tags)!=null&&C.length?P.tags:void 0,target_agent:P.target_agent!=="root_agent"?P.target_agent:void 0,invocations:P.invocations.map(N=>{var F;return{user_message:N.user_message,expected_response:N.expected_response||void 0,expected_tool_calls:(F=N.expected_tool_calls)!=null&&F.length?N.expected_tool_calls.map(z=>({tool_name:z.tool_name,args:z.match_type!=="name_only"&&Object.keys(z.args||{}).length?z.args:void 0})):void 0}}),session_input:Object.keys(P.session_input||{}).length?{state:P.session_input}:void 0,final_session_state:Object.keys(P.final_session_state||{}).length?P.final_session_state:void 0,rubrics:(M=P.rubrics)!=null&&M.length?P.rubrics.map(N=>N.rubric):void 0}}),eval_config:e.eval_config?{judge_model:e.eval_config.judge_model||void 0,metrics:((j=e.eval_config.metrics)==null?void 0:j.filter(P=>P.enabled))||void 0}:void 0}],null,2);navigator.clipboard.writeText(y)},children:[o.jsx(ns,{size:14})," Copy JSON"]})})]}):o.jsxs(o.Fragment,{children:[o.jsxs("div",{className:"form-section",children:[o.jsx("h4",{children:"Description"}),o.jsx("textarea",{value:e.description,onChange:y=>s({description:y.target.value}),placeholder:"Description of this evaluation set...",style:{minHeight:40}})]}),o.jsxs("div",{className:"form-section",children:[o.jsx("h4",{children:"LLM Judge Model"}),o.jsx("p",{style:{fontSize:12,color:"var(--text-muted)",marginBottom:8},children:"Model used for LLM-judged metrics (safety, hallucinations, etc.)."}),o.jsx(W5,{value:((_=e.eval_config)==null?void 0:_.judge_model)||"",onChange:y=>s({eval_config:{...e.eval_config,judge_model:y}})})]}),o.jsxs("div",{className:"form-section",children:[o.jsxs("h4",{children:[o.jsx(gv,{size:14})," Evaluation Metrics"]}),o.jsx("p",{style:{fontSize:12,color:"var(--text-muted)",marginBottom:8},children:"Configure which metrics to use and their pass thresholds."}),Object.keys(bn).map(y=>{var N,F,z;const j=bn[y],P=(F=(N=e.eval_config)==null?void 0:N.metrics)==null?void 0:F.find(L=>L.metric===y),C=(P==null?void 0:P.enabled)??!1,M=((z=P==null?void 0:P.criterion)==null?void 0:z.threshold)??.7;return o.jsxs("div",{style:{display:"flex",alignItems:"center",gap:10,marginBottom:6},children:[o.jsxs("label",{className:"toggle-switch",style:{margin:0},children:[o.jsx("input",{type:"checkbox",checked:C,onChange:L=>{var A;const I=[...((A=e.eval_config)==null?void 0:A.metrics)||[]],W=I.findIndex($=>$.metric===y);L.target.checked?W===-1?I.push({metric:y,enabled:!0,criterion:{threshold:.7}}):I[W]={...I[W],enabled:!0}:W!==-1&&(I[W]={...I[W],enabled:!1}),s({eval_config:{...e.eval_config,metrics:I}})}}),o.jsx("span",{className:"toggle-slider"})]}),o.jsxs("span",{style:{fontSize:12,opacity:C?1:.5,minWidth:140,fontWeight:C?500:400},children:[j.name,j.requiresJudge&&o.jsx("span",{style:{fontSize:9,marginLeft:4,color:"var(--accent-primary)"},children:"LLM"})]}),o.jsx("span",{style:{fontSize:11,color:"var(--text-muted)",opacity:C?1:.4},children:"≥"}),o.jsx("input",{type:"number",min:0,max:1,step:.1,value:M,disabled:!C,onChange:L=>{var A;const I=[...((A=e.eval_config)==null?void 0:A.metrics)||[]],W=I.findIndex($=>$.metric===y);W!==-1&&(I[W]={...I[W],criterion:{...I[W].criterion,threshold:parseFloat(L.target.value)||.7}},s({eval_config:{...e.eval_config,metrics:I}}))},style:{width:60,textAlign:"center",opacity:C?1:.3,padding:"2px 4px",fontSize:11}})]},y)}),o.jsxs("div",{className:"form-row",style:{marginTop:16},children:[o.jsxs("div",{className:"form-field",children:[o.jsx("label",{children:"Default Trajectory Match Type"}),o.jsxs("select",{value:((m=e.eval_config)==null?void 0:m.default_trajectory_match_type)||"in_order",onChange:y=>s({eval_config:{...e.eval_config,default_trajectory_match_type:y.target.value}}),children:[o.jsx("option",{value:"exact",children:"Exact (same order, no extras)"}),o.jsx("option",{value:"in_order",children:"In Order (extras allowed between)"}),o.jsx("option",{value:"any_order",children:"Any Order (all present, any order)"})]})]}),o.jsxs("div",{className:"form-field",children:[o.jsx("label",{children:"Number of Runs"}),o.jsx("input",{type:"number",min:1,max:10,value:((x=e.eval_config)==null?void 0:x.num_runs)||1,onChange:y=>s({eval_config:{...e.eval_config,num_runs:parseInt(y.target.value)||1}})}),o.jsx("p",{style:{fontSize:11,color:"var(--text-muted)",marginTop:4},children:"Run each test multiple times for statistical reliability."})]})]})]}),o.jsxs("div",{className:"form-section",children:[o.jsxs("h4",{children:[o.jsx(b_,{size:14})," Coverage Summary"]}),n?o.jsxs(o.Fragment,{children:[o.jsxs("div",{className:"result-scores",children:[o.jsxs("div",{className:"score-card",children:[o.jsxs("div",{className:"score-value",style:{color:"var(--accent-primary)"},children:[n.passed_cases,"/",n.total_cases]}),o.jsx("div",{className:"score-label",children:"Cases Passed"})]}),o.jsxs("div",{className:"score-card",children:[o.jsx("div",{className:`score-value ${n.overall_pass_rate>=.8?"passed":"failed"}`,children:g(n.overall_pass_rate)}),o.jsx("div",{className:"score-label",children:"Pass Rate"})]}),Object.entries(n.metric_avg_scores||{}).map(([y,j])=>{var C;const P=Ko(y,j);return o.jsxs("div",{className:"score-card",children:[o.jsx("div",{className:"score-value",children:P.value}),o.jsxs("div",{className:"score-label",children:["Avg ",((C=bn[y])==null?void 0:C.name)||y]})]},y)})]}),o.jsxs("div",{style:{marginTop:16},children:[o.jsx("div",{style:{marginBottom:4,fontSize:12,color:"var(--text-muted)"},children:"Overall Pass Rate"}),o.jsx("div",{className:"coverage-bar",children:o.jsx("div",{className:`coverage-fill ${n.overall_pass_rate>=.8?"passed":"failed"}`,style:{width:`${n.overall_pass_rate*100}%`}})})]}),Object.entries(n.metric_pass_rates||{}).length>0&&o.jsxs("div",{style:{marginTop:16},children:[o.jsx("h5",{style:{fontSize:13,marginBottom:8},children:"Metric Pass Rates"}),Object.entries(n.metric_pass_rates).map(([y,j])=>{var P;return o.jsxs("div",{style:{marginBottom:8},children:[o.jsxs("div",{style:{display:"flex",justifyContent:"space-between",fontSize:12,marginBottom:4},children:[o.jsx("span",{children:((P=bn[y])==null?void 0:P.name)||y}),o.jsx("span",{children:g(j)})]}),o.jsx("div",{className:"coverage-bar",children:o.jsx("div",{className:`coverage-fill ${j>=.8?"passed":"failed"}`,style:{width:`${j*100}%`}})})]},y)})]}),o.jsxs("div",{style:{marginTop:16},children:[o.jsx("h5",{style:{fontSize:13,marginBottom:8},children:"Individual Results"}),o.jsxs("table",{style:{width:"100%",fontSize:12,borderCollapse:"collapse"},children:[o.jsx("thead",{children:o.jsxs("tr",{style:{borderBottom:"1px solid var(--border-color)"},children:[o.jsx("th",{style:{textAlign:"left",padding:"8px 4px"},children:"Test Case"}),o.jsx("th",{style:{textAlign:"center",padding:"8px 4px"},children:"Metrics"}),o.jsx("th",{style:{textAlign:"center",padding:"8px 4px"},children:"Status"})]})}),o.jsx("tbody",{children:n.case_results.map(y=>o.jsxs("tr",{style:{borderBottom:"1px solid var(--border-color)"},children:[o.jsx("td",{style:{padding:"8px 4px"},children:y.eval_case_name}),o.jsx("td",{style:{textAlign:"center",padding:"8px 4px"},children:y.metric_results.map((j,P)=>{const C=Ko(j.metric,j.score,j.threshold);return o.jsx("span",{style:{fontSize:10,padding:"2px 4px",marginRight:4,borderRadius:"var(--radius-sm)",background:j.passed?"rgba(var(--success-rgb), 0.15)":"rgba(var(--error-rgb), 0.15)",color:j.passed?"var(--success)":"var(--error)"},children:C.value},P)})}),o.jsx("td",{style:{textAlign:"center",padding:"8px 4px"},children:y.passed?o.jsx(pr,{size:14,style:{color:"var(--success)"}}):y.error?o.jsx(ji,{size:14,style:{color:"var(--warning)"}}):o.jsx($r,{size:14,style:{color:"var(--error)"}})})]},y.eval_case_id))})]})]})]}):o.jsxs("div",{style:{textAlign:"center",padding:"32px",color:"var(--text-muted)",background:"var(--bg-tertiary)",borderRadius:"var(--radius-md)"},children:[o.jsx(Xd,{size:32,style:{marginBottom:8,opacity:.3}}),o.jsx("p",{children:"Run the evaluation set to see coverage metrics"})]})]}),o.jsxs("div",{className:"form-section",children:[o.jsxs("h4",{children:["Test Cases (",e.eval_cases.length,")"]}),e.eval_cases.length===0?o.jsx("p",{style:{color:"var(--text-muted)",fontSize:13},children:"No test cases yet. Add cases to this eval set to start testing."}):o.jsx("ul",{style:{listStyle:"none",padding:0},children:e.eval_cases.map(y=>{const j=i.get(y.id);return o.jsxs("li",{style:{display:"flex",alignItems:"center",gap:8,padding:"8px 12px",background:"var(--bg-tertiary)",borderRadius:"var(--radius-sm)",marginBottom:8},children:[j?j.passed?o.jsx(pr,{size:14,style:{color:"var(--success)"}}):o.jsx($r,{size:14,style:{color:"var(--error)"}}):o.jsx(Pa,{size:14,style:{color:"var(--text-muted)"}}),o.jsx("span",{style:{flex:1},children:y.name}),o.jsxs("span",{style:{fontSize:11,color:"var(--text-muted)"},children:[y.invocations.length," turn(s)"]})]},y.id)})})]})]})})]})}function K5(){const{project:e,setProject:t}=ht(),[n,r]=k.useState(""),[i,s]=k.useState(!0),[a,l]=k.useState(!1),[c,u]=k.useState(null),[d,p]=k.useState(!1);if(!e)return null;k.useEffect(()=>{f()},[e.id]);async function f(){s(!0),u(null);try{const x=await Gy(e.id);r(x),l(!1)}catch(x){u(x.message)}finally{s(!1)}}function h(x){x!==void 0&&(r(x),l(!0),u(null))}async function g(){s(!0),u(null);try{const x=await Yy(e.id,n);t(x),l(!1)}catch(x){u(x.message)}finally{s(!1)}}function v(){navigator.clipboard.writeText(n),p(!0),setTimeout(()=>p(!1),2e3)}function _(){const x=new Blob([n],{type:"text/yaml"}),y=URL.createObjectURL(x),j=document.createElement("a");j.href=y,j.download=`${e.name}.yaml`,j.click(),URL.revokeObjectURL(y)}function m(){const x=document.createElement("input");x.type="file",x.accept=".yaml,.yml",x.onchange=async y=>{var C;const j=(C=y.target.files)==null?void 0:C[0];if(!j)return;const P=await j.text();r(P),l(!0)},x.click()}return o.jsxs("div",{className:"yaml-panel",children:[o.jsx("style",{children:`
        .yaml-panel {
          display: flex;
          flex-direction: column;
          height: calc(100vh - 180px);
      ...
      `}),o.jsxs("div",{className:"code-header",children:[o.jsxs("div",{className:"code-title",children:[o.jsx(jn,{size:16}),o.jsx("h3",{children:"Python Code"}),o.jsx("span",{className:"badge",children:s?"Loading...":"Generated"}),t&&o.jsxs("span",{className:"status-badge success",children:[o.jsx(qd,{size:12}),"Copied!"]}),l&&o.jsxs("span",{className:"status-badge error",children:[o.jsx(ji,{size:12}),"Error"]})]}),o.jsxs("div",{className:"code-actions",children:[o.jsxs("button",{className:"btn btn-secondary btn-sm",onClick:u,title:"Copy to clipboard",disabled:s||!!l,children:[o.jsx(ns,{size:14}),"Copy"]}),o.jsxs("button",{className:"btn btn-secondary btn-sm",onClick:d,title:"Download Python file",disabled:s||!!l,children:[o.jsx(Ai,{size:14}),"Download"]})]})]}),o.jsx("div",{className:"code-editor",children:s?o.jsx("div",{className:"code-loading",children:o.jsx("div",{children:"Loading generated code..."})}):l?o.jsxs("div",{className:"code-error",children:[o.jsx(ji,{size:24}),o.jsx("div",{children:l})]}):o.jsx(Zt,{height:"100%",language:"python",theme:"vs-dark",value:r,options:{readOnly:!0,minimap:{enabled:!1},fontSize:13,fontFamily:"'JetBrains Mono', monospace",lineNumbers:"on",scrollBeyondLastLine:!1,automaticLayout:!0,tabSize:4,insertSpaces:!0,padding:{top:12},wordWrap:"on"}})}),o.jsxs("div",{className:"code-info",children:[o.jsx("p",{children:"This is the Python code equivalent of your project configuration. You can use this code directly with ADK."}),o.jsxs("p",{children:["Place this in a file named ",o.jsx("code",{children:"agent.py"})," inside your agent directory, then run with ",o.jsx("code",{children:"adk web ."})," or ",o.jsx("code",{children:"adk run your_agent"}),"."]})]})]})}const Y5=[{id:"app",label:"App",icon:gv},{id:"agents",label:"Agents",icon:zr},{id:"tools",label:"Tools",icon:dn},{id:"callbacks",label:"Callbacks",icon:jn},{id:"run",label:"Run",icon:fv},{id:"skillsets",label:"SkillSets",icon:c_},{id:"eval",label:"Evaluate",icon:Su},{id:"yaml",label:"YAML",icon:d_},{id:"code",label:"Code",icon:jn}],Q5=["app","agents","tools","callbacks","run","skillsets","eval","yaml","code"];function jc(){var $,D;const{projectId:e,tab:t,itemId:n}=uk(),r=Vd(),{project:i,setProject:s,activeTab:a,setActiveTab:l,hasUnsavedChanges:c,setHasUnsavedChanges:u,selectedAgentId:d,setSelectedAgentId:p,selectedToolId:f,setSelectedToolId:h}=ht(),[g,v]=k.useState(!0),[_,m]=k.useState(!1),[x,y]=k.useState(!1),[j,P]=k.useState(null),C=k.useRef(!0),M=k.useRef(null);k.useEffect(()=>{t&&Q5.includes(t)?l(t):!t&&e&&r(`/project/${e}/${a}`,{replace:!0})},[t,e]),k.useEffect(()=>{t==="agents"&&n?p(n):t==="tools"&&n&&h(n)},[t,n]);function N(S){l(S),S==="agents"&&d?r(`/project/${e}/${S}/${d}`,{replace:!0}):S==="tools"&&f?r(`/project/${e}/${S}/${f}`,{replace:!0}):r(`/project/${e}/${S}`,{replace:!0})}function F(S){S?r(`/project/${e}/${a}/${S}`,{replace:!0}):r(`/project/${e}/${a}`,{replace:!0})}k.useEffect(()=>(e&&z(e),()=>{s(null),u(!1)}),[e]);async function z(S){C.current=!0;try{const O=await Vy(S);s(O),M.current=JSON.stringify(O),u(!1)}catch(O){console.error("Failed to load project:",O),r("/")}finally{v(!1),setTimeout(()=>{C.current=!1},100)}}async function L(){if(i){m(!0);try{const{eval_sets:S,...O}=i;await bu(i.id,O),M.current=JSON.stringify(i),u(!1)}catch(S){console.error("Failed to save project:",S)}finally{m(!1)}}}async function I(){if(i){y(!0),P(null),window.dispatchEvent(new CustomEvent("eval-tests-started"));try{let S=0,O=0;const R=[],w=[];for(const V of i.eval_sets||[]){if(V.eval_cases.length===0)continue;const Y=await Ye.post(`/projects/${i.id}/eval-sets/${V.id}/run`,{});Y.result&&(S+=Y.result.passed_cases||0,O+=Y.result.total_cases||0,Y.result.case_results&&R.push(...Y.result.case_results),w.push(Y.result.eval_set_name||V.name||V.id))}if(R.length>0){const V={id:Date.now().toString(36)+Math.random().toString(36).substr(2,5),eval_set_id:"batch",eval_set_name:w.length>1?`All Tests (${w.length} sets)`:w[0]||"All Tests",started_at:Date.now()/1e3,completed_at:Date.now()/1e3,total_cases:O,passed_cases:S,failed_cases:O-S,case_results:R};try{await Ye.post(`/projects/${i.id}/eval-history`,V)}catch(Y){console.warn("Failed to save batch eval run to history:",Y)}}P({passed:S,total:O}),window.dispatchEvent(new CustomEvent("eval-tests-completed")),setTimeout(()=>P(null),5e3)}catch(S){console.error("Failed to run tests:",S),P({passed:0,total:-1}),setTimeout(()=>P(null),5e3)}finally{y(!1)}}}const W=k.useRef(null);k.useEffect(()=>{if(i&&!C.current&&W.current){const S=i.app.models||[],O=W.current||[];if(S.some((w,V)=>{const Y=O.find(b=>b.id===w.id);return Y?Y.provider!==w.provider||Y.model_name!==w.model_name||Y.api_base!==w.api_base||Y.temperature!==w.temperature||Y.max_output_tokens!==w.max_output_tokens||Y.top_p!==w.top_p||Y.top_k!==w.top_k:!1})){const w=i.app.default_model_id,V=i.agents.map(b=>{if(b.type==="LlmAgent"&&b.model){const E=b.model._appModelId;if(E){const B=S.find(ie=>ie.id===E);if(B)return{...b,model:{provider:B.provider,model_name:B.model_name,api_base:B.api_base,temperature:B.temperature,max_output_tokens:B.max_output_tokens,top_p:B.top_p,top_k:B.top_k,fallbacks:[],_appModelId:E}}}else if(w){const B=S.find(ie=>ie.id===w);if(B&&b.model.provider===B.provider&&b.model.model_name===B.model_name&&b.model.api_base===B.api_base)return{...b,model:{provider:B.provider,model_name:B.model_name,api_base:B.api_base,temperature:B.temperature,max_output_tokens:B.max_output_tokens,top_p:B.top_p,top_k:B.top_k,fallbacks:[],_appModelId:w}}}}return b});V.some((b,E)=>JSON.stringify(b)!==JSON.stringify(i.agents[E]))&&s({...i,agents:V})}}i&&(W.current=i.app.models||[])},[i==null?void 0:i.app.models,i,s]);const A=k.useRef(null);return k.useEffect(()=>(i&&!C.current&&M.current&&JSON.stringify(i)!==M.current&&(u(!0),A.current&&clearTimeout(A.current),A.current=setTimeout(async()=>{try{const{eval_sets:O,...R}=i;await bu(i.id,R),M.current=JSON.stringify(i),u(!1)}catch(O){console.error("Auto-save failed:",O)}},500)),()=>{A.current&&clearTimeout(A.current)}),[i]),g?o.jsxs("div",{className:"loading-screen",children:[o.jsx("style",{children:`
          .loading-screen {
            height: 100vh;
            display: flex;
            align-items: center;
      ...
      `}),o.jsxs("header",{className:"top-bar",children:[o.jsxs("div",{className:"top-bar-left",children:[o.jsxs("button",{className:"back-btn",onClick:()=>r("/"),children:[o.jsx(a_,{size:18}),"Project"]}),o.jsx("h1",{className:"project-name",children:i.name})]}),o.jsx("nav",{className:"tabs-bar",children:Y5.map(S=>o.jsxs("button",{className:`tab-btn ${a===S.id?"active":""}`,onClick:()=>N(S.id),children:[o.jsx(S.icon,{size:14}),S.label]},S.id))}),o.jsxs("div",{className:"top-bar-right",children:[o.jsxs("button",{className:`btn ${j?j.total===-1?"btn-error":j.passed===j.total?"btn-success":"btn-warning":"btn-secondary"}`,onClick:I,disabled:x||!(($=i==null?void 0:i.eval_sets)!=null&&$.some(S=>S.eval_cases.length>0)),title:(D=i==null?void 0:i.eval_sets)!=null&&D.some(S=>S.eval_cases.length>0)?"Run all evaluation tests":"No test cases defined",style:{marginRight:8},children:[x?o.jsx(hv,{size:16,className:"spin"}):o.jsx(fr,{size:16}),x?"Testing...":j?j.total===-1?"Error":`${j.passed}/${j.total}`:"Test"]}),o.jsxs("button",{className:"btn btn-primary",onClick:L,disabled:_,children:[o.jsx(La,{size:16}),_?"Saving...":"Save"]})]})]}),o.jsxs("main",{className:"main-content",children:[a==="app"&&o.jsx(P_,{}),a==="agents"&&o.jsx(D4,{onSelectAgent:F}),a==="tools"&&o.jsx(vE,{onSelectTool:F}),a==="callbacks"&&o.jsx(wE,{onSelectCallback:F}),a==="run"&&o.jsx($5,{}),a==="skillsets"&&o.jsx(B5,{}),a==="eval"&&o.jsx(V5,{}),a==="yaml"&&o.jsx(K5,{}),a==="code"&&o.jsx(G5,{})]})]}):null}function X5(){const{setMcpServers:e,setBuiltinTools:t}=ht();return k.useEffect(()=>{Hd().then(e).catch(console.error),Qy().then(t).catch(console.error)},[e,t]),o.jsxs(Nk,{children:[o.jsx(qr,{path:"/",element:o.jsx(S_,{})}),o.jsx(qr,{path:"/project/:projectId",element:o.jsx(jc,{})}),o.jsx(qr,{path:"/project/:projectId/:tab",element:o.jsx(jc,{})}),o.jsx(qr,{path:"/project/:projectId/:tab/:itemId",element:o.jsx(jc,{})}),o.jsx(qr,{path:"*",element:o.jsx(Sk,{to:"/",replace:!0})})]})}Sc.createRoot(document.getElementById("root")).render(o.jsx(Bt.StrictMode,{children:o.jsx(Tk,{children:o.jsx(X5,{})})}));
