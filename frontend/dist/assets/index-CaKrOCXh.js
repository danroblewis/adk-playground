 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */(function(e){function t(M,I){var j=M.length;M.push(I);e:for(;0<j;){var U=j-1>>>1,K=M[U];if(0<i(K,I))M[U]=I,M[j]=K,j=U;else break e}}function n(M){return M.length===0?null:M[0]}function r(M){if(M.length===0)return null;var I=M[0],j=M.pop();if(j!==I){M[0]=j;e:for(var U=0,K=M.length,C=K>>>1;U<C;){var le=2*(U+1)-1,R=M[le],Z=le+1,B=M[Z];if(0>i(R,j))Z<K&&0>i(B,R)?(M[U]=B,M[Z]=j,U=Z):(M[U]=R,M[le]=j,U=le);else if(Z<K&&0>i(B,j))M[U]=B,M[Z]=j,U=Z;else break e}}return I}function i(M,I){var j=M.sortIndex-I.sortIndex;return j!==0?j:M.id-I.id}if(typeof performance=="object"&&typeof performance.now=="function"){var o=performance;e.unstable_now=function(){return o.now()}}else{var a=Date,l=a.now();e.unstable_now=function(){return a.now()-l}}var c=[],u=[],d=1,p=null,f=3,m=!1,y=!1,w=!1,E=typeof setTimeout=="function"?setTimeout:null,g=typeof clearTimeout=="function"?clearTimeout:null,h=typeof setImmediate<"u"?setImmediate:null;typeof navigator<"u"&&navigator.scheduling!==void 0&&navigator.scheduling.isInputPending!==void 0&&navigator.scheduling.isInputPending.bind(navigator.scheduling);function v(M){for(var I=n(u);I!==null;){if(I.callback===null)r(u);else if(I.startTime<=M)r(u),I.sortIndex=I.expirationTime,t(c,I);else break;I=n(u)}}function L(M){if(w=!1,v(M),!y)if(n(c)!==null)y=!0,Q(S);else{var I=n(u);I!==null&&z(L,I.startTime-M)}}function S(M,I){y=!1,w&&(w=!1,g(T),T=-1),m=!0;var j=f;try{for(v(I),p=n(c);p!==null&&(!(p.expirationTime>I)||M&&!b());){var U=p.callback;if(typeof U=="function"){p.callback=null,f=p.priorityLevel;var K=U(p.expirationTime<=I);I=e.unstable_now(),typeof K=="function"?p.callback=K:p===n(c)&&r(c),v(I)}else r(c);p=n(c)}if(p!==null)var C=!0;else{var le=n(u);le!==null&&z(L,le.startTime-I),C=!1}return C}finally{p=null,f=j,m=!1}}var k=!1,x=null,T=-1,A=5,N=-1;function b(){return!(e.unstable_now()-N<A)}function P(){if(x!==null){var M=e.unstable_now();N=M;var I=!0;try{I=x(!0,M)}finally{I?O():(k=!1,x=null)}}else k=!1}var O;if(typeof h=="function")O=function(){h(P)};else if(typeof MessageChannel<"u"){var V=new MessageChannel,D=V.port2;V.port1.onmessage=P,O=function(){D.postMessage(null)}}else O=function(){E(P,0)};function Q(M){x=M,k||(k=!0,O())}function z(M,I){T=E(function(){M(e.unstable_now())},I)}e.unstable_IdlePriority=5,e.unstable_ImmediatePriority=1,e.unstable_LowPriority=4,e.unstable_NormalPriority=3,e.unstable_Profiling=null,e.unstable_UserBlockingPriority=2,e.unstable_cancelCallback=function(M){M.callback=null},e.unstable_continueExecution=function(){y||m||(y=!0,Q(S))},e.unstable_forceFrameRate=function(M){0>M||125<M?console.error("forceFrameRate takes a positive int between 0 and 125, forcing frame rates higher than 125 fps is not supported"):A=0<M?Math.floor(1e3/M):5},e.unstable_getCurrentPriorityLevel=function(){return f},e.unstable_getFirstCallbackNode=function(){return n(c)},e.unstable_next=function(M){switch(f){case 1:case 2:case 3:var I=3;break;default:I=f}var j=f;f=I;try{return M()}finally{f=j}},e.unstable_pauseExecution=function(){},e.unstable_requestPaint=function(){},e.unstable_runWithPriority=function(M,I){switch(M){case 1:case 2:case 3:case 4:case 5:break;default:M=3}var j=f;f=M;try{return I()}finally{f=j}},e.unstable_scheduleCallback=function(M,I,j){var U=e.unstable_now();switch(typeof j=="object"&&j!==null?(j=j.delay,j=typeof j=="number"&&0<j?U+j:U):j=U,M){case 1:var K=-1;break;case 2:K=250;break;case 5:K=1073741823;break;case 4:K=1e4;break;default:K=5e3}return K=j+K,M={id:d++,callback:I,priorityLevel:M,startTime:j,expirationTime:K,sortIndex:-1},j>U?(M.sortIndex=j,t(u,M),n(c)===null&&M===n(u)&&(w?(g(T),T=-1):w=!0,z(L,j-U))):(M.sortIndex=K,t(c,M),y||m||(y=!0,Q(S))),M},e.unstable_shouldYield=b,e.unstable_wrapCallback=function(M){var I=f;return function(){var j=f;f=I;try{return M.apply(this,arguments)}finally{f=j}}}})(gf);hf.exports=gf;var Lx=hf.exports;/**
 * @license React
...
`).length,m=Math.max(r,Math.min(f*20+40,500));l(m)}},[e,r]),_.useEffect(()=>{i&&u.current&&u.current.focus()},[i]);function d(f){u.current=f,f.focus()}function p(f){c.current&&!c.current.contains(f.target)&&o(!1)}return _.useEffect(()=>{if(i)return document.addEventListener("mousedown",p),()=>document.removeEventListener("mousedown",p)},[i]),s.jsxs("div",{ref:c,className:"markdown-editor",children:[s.jsx("style",{children:`
      ...
      `}),i?s.jsx("div",{className:"monaco-wrapper",children:s.jsx(an,{height:"100%",language:"markdown",theme:"vs-dark",value:e,onChange:f=>t(f||""),onMount:d,options:{minimap:{enabled:!1},fontSize:14,fontFamily:"'JetBrains Mono', monospace",lineNumbers:"off",scrollBeyondLastLine:!1,automaticLayout:!0,wordWrap:"on",padding:{top:12,bottom:12},lineDecorationsWidth:8,folding:!1,glyphMargin:!1,renderLineHighlight:"none",overviewRulerLanes:0,hideCursorInOverviewRuler:!0,scrollbar:{vertical:"auto",horizontal:"hidden"}}})}):s.jsxs("div",{className:"markdown-preview",onClick:()=>o(!0),children:[s.jsxs("span",{className:"edit-hint",children:[s.jsx(x0,{size:12}),"Click to edit"]}),e?s.jsx("div",{className:"markdown-content",children:s.jsx(ex,{children:e})}):s.jsx("div",{className:"markdown-placeholder",children:n})]})]})}function S_(e){return/^[a-zA-Z0-9_]+$/.test(e)}function C_({agent:e}){const{project:t,updateAgent:n,mcpServers:r,builtinTools:i,setActiveTab:o,setRunAgentId:a}=et(),[l,c]=_.useState(new Set(["basic","model","tools","subagents"])),[u,d]=_.useState(!1),[p,f]=_.useState(!1),[m,y]=_.useState(!1),[w,E]=_.useState(""),[g,h]=_.useState(null);if(!t)return null;function v(z){n(e.id,z)}function L(z){if(z===""){h(null),v({name:z});return}S_(z)?h(null):h("Name can only contain letters, numbers, and underscores"),v({name:z})}function S(z){const M=new Set(l);M.has(z)?M.delete(z):M.add(z),c(M)}const k=e.type==="LlmAgent",x=e;function T(z){k&&v({tools:[...x.tools,z]})}function A(z){k&&v({tools:x.tools.filter((M,I)=>I!==z)})}function N(z,M){if(!k)return;const I=[...x.tools];I[z]=M,v({tools:I})}function b(z){"sub_agents"in e&&v({sub_agents:[...e.sub_agents,z]})}function P(z){"sub_agents"in e&&v({sub_agents:e.sub_agents.filter(M=>M!==z)})}const O=t.agents.filter(z=>z.id!==e.id);async function V(){if(!(!t||!k)){d(!0);try{const z=x.instruction||"",M=z?`Current instruction to improve:

${z}

Please improve and expand this instruction while preserving its core intent.`:void 0,j=t.agents.some(K=>K.id===e.id)?void 0:e,U=await Fs(t.id,e.id,M,j);U.success&&U.prompt?v({instruction:U.prompt}):alert("Failed to generate prompt: "+(U.error||"Unknown error"))}catch(z){alert("Error generating prompt: "+z.message)}finally{d(!1)}}}async function D(){if(!(!t||!k||!w.trim())){d(!0);try{const M=`Current instruction:
...
Please apply the requested changes to the instruction above. Output only the updated instruction, nothing else.`,j=t.agents.some(K=>K.id===e.id)?void 0:e,U=await Fs(t.id,e.id,M,j);U.success&&U.prompt?(v({instruction:U.prompt}),y(!1),E("")):alert("Failed to apply changes: "+(U.error||"Unknown error"))}catch(z){alert("Error applying changes: "+z.message)}finally{d(!1)}}}async function Q(){if(!t||!k)return;const z=x.instruction;if(!z){alert("Please write an instruction first");return}f(!0);try{const M=`Write a 5-10 word description of what this agent does.
...
Your response (5-10 words only):`,I=await Fs(t.id,e.id,M);if(I.success&&I.prompt){let j=I.prompt.trim();j=j.replace(/^["']|["']$/g,"").trim();const U=j.split(/[.!?\n]/)[0].trim(),K=U.length>80?U.slice(0,77)+"...":U;v({description:K})}else alert("Failed to generate description: "+(I.error||"Unknown error"))}catch(M){alert("Error generating description: "+M.message)}finally{f(!1)}}return s.jsxs("div",{className:"agent-editor",children:[s.jsx("style",{children:`
      ...
      `}),s.jsxs("div",{className:"editor-header",children:[s.jsx(Zn,{size:24,style:{color:"var(--accent-primary)"}}),s.jsxs("div",{style:{flex:1,display:"flex",flexDirection:"column",gap:4},children:[s.jsx("input",{type:"text",value:e.name,onChange:z=>L(z.target.value),placeholder:"Agent name",style:{borderColor:g?"var(--error)":void 0}}),g&&s.jsx("span",{style:{fontSize:11,color:"var(--error)",marginTop:-4},children:g})]}),s.jsx("span",{className:"badge badge-info",children:e.type}),s.jsxs("button",{className:"btn btn-primary btn-sm run-agent-btn",onClick:()=>{a(e.id),o("run")},title:"Test this agent",children:[s.jsx(Mn,{size:14}),"Run"]})]}),s.jsxs("div",{className:"editor-content",children:[s.jsxs(oi,{id:"basic",title:"Basic Info",icon:s.jsx(Zn,{size:16}),expanded:l.has("basic"),onToggle:()=>S("basic"),children:[s.jsx("div",{className:"form-row",children:s.jsxs("div",{className:"form-group full-width",children:[s.jsxs("div",{className:"label-with-action",children:[s.jsx("label",{children:"Description"}),k&&x.instruction&&s.jsx("button",{className:"btn btn-secondary btn-sm generate-btn",onClick:Q,disabled:p,title:"Generate description from instruction",children:p?s.jsxs(s.Fragment,{children:[s.jsx(Ur,{size:14,className:"spin"}),"Summarizing..."]}):"Summarize"})]}),s.jsx("input",{type:"text",value:e.description,onChange:z=>v({description:z.target.value}),placeholder:"e.g., Reviews code for bugs and suggests fixes"})]})}),k&&s.jsxs(s.Fragment,{children:[s.jsx("div",{className:"form-row",children:s.jsxs("div",{className:"form-group full-width",children:[s.jsxs("div",{className:"label-with-action",children:[s.jsx("label",{children:"Instruction"}),s.jsxs("div",{className:"action-buttons",children:[s.jsx("button",{className:"btn btn-secondary btn-sm",onClick:()=>y(!m),disabled:u||!x.instruction,title:"Request specific changes to the instruction",children:"Request Changes"}),s.jsx("button",{className:"btn btn-secondary btn-sm",onClick:V,disabled:u,title:"Uses AI to improve and expand the current instruction",children:u?s.jsxs(s.Fragment,{children:[s.jsx(Ur,{size:14,className:"spin"}),"Working..."]}):"Auto-Improve"})]})]}),m&&s.jsxs("div",{className:"request-changes-box",children:[s.jsx("input",{type:"text",value:w,onChange:z=>E(z.target.value),placeholder:"Describe what changes you want...",onKeyDown:z=>{z.key==="Enter"&&w.trim()?D():z.key==="Escape"&&(y(!1),E(""))},autoFocus:!0}),s.jsx("button",{className:"btn btn-primary btn-sm",onClick:D,disabled:u||!w.trim(),children:"Apply"})]}),s.jsx(__,{value:x.instruction,onChange:z=>v({instruction:z}),placeholder:"Write your agent's instruction here... (Markdown supported)",minHeight:200})]})}),s.jsxs("div",{className:"form-row",children:[s.jsxs("div",{className:"form-group",children:[s.jsx("label",{children:"Output Key"}),s.jsxs("select",{value:x.output_key||"",onChange:z=>v({output_key:z.target.value||void 0}),children:[s.jsx("option",{value:"",children:"None"}),t.app.state_keys.map(z=>s.jsx("option",{value:z.name,children:z.name},z.name))]})]}),s.jsxs("div",{className:"form-group",children:[s.jsx("label",{children:"Include Contents"}),s.jsxs("select",{value:x.include_contents,onChange:z=>v({include_contents:z.target.value}),children:[s.jsx("option",{value:"default",children:"Default"}),s.jsx("option",{value:"none",children:"None"})]})]})]}),s.jsxs("div",{className:"form-row",style:{gap:24},children:[s.jsxs("label",{style:{display:"flex",alignItems:"center",gap:8,fontSize:13},children:[s.jsxs("span",{className:"toggle-switch",children:[s.jsx("input",{type:"checkbox",checked:x.disallow_transfer_to_parent,onChange:z=>v({disallow_transfer_to_parent:z.target.checked})}),s.jsx("span",{className:"toggle-slider"})]}),"Disallow transfer to parent"]}),s.jsxs("label",{style:{display:"flex",alignItems:"center",gap:8,fontSize:13},children:[s.jsxs("span",{className:"toggle-switch",children:[s.jsx("input",{type:"checkbox",checked:x.disallow_transfer_to_peers,onChange:z=>v({disallow_transfer_to_peers:z.target.checked})}),s.jsx("span",{className:"toggle-slider"})]}),"Disallow transfer to peers"]})]})]}),e.type==="LoopAgent"&&s.jsx("div",{className:"form-row",children:s.jsxs("div",{className:"form-group",children:[s.jsx("label",{children:"Max Iterations"}),s.jsx("input",{type:"number",value:e.max_iterations||"",onChange:z=>v({max_iterations:parseInt(z.target.value)||void 0}),placeholder:"No limit"})]})})]}),k&&s.jsx(oi,{id:"model",title:"Model",icon:s.jsx(iu,{size:16}),expanded:l.has("model"),onToggle:()=>S("model"),children:s.jsx(E_,{agent:x,appModels:t.app.models||[],defaultModelId:t.app.default_model_id,onUpdate:z=>v({model:z})})}),k&&s.jsx(oi,{id:"tools",title:`Tools (${x.tools.length})`,icon:s.jsx(Gt,{size:16}),expanded:l.has("tools"),onToggle:()=>S("tools"),children:s.jsx(N_,{tools:x.tools,onAdd:T,onRemove:A,onUpdate:N,builtinTools:i,mcpServers:r,projectMcpServers:t.mcp_servers,customTools:t.custom_tools,agents:O,skillsets:t.skillsets||[]})}),"sub_agents"in e&&s.jsx(oi,{id:"subagents",title:`Sub-Agents (${e.sub_agents.length})`,icon:s.jsx(j0,{size:16}),expanded:l.has("subagents"),onToggle:()=>S("subagents"),children:s.jsxs("div",{className:"sub-agent-list",children:[e.sub_agents.map(z=>{const M=t.agents.find(I=>I.id===z);return M?s.jsxs("div",{className:"sub-agent-chip",children:[M.name,s.jsx("button",{onClick:()=>P(z),children:s.jsx(Le,{size:12})})]},z):null}),s.jsxs("select",{value:"",onChange:z=>{z.target.value&&b(z.target.value)},style:{width:150,padding:"6px 10px",fontSize:13},children:[s.jsx("option",{value:"",children:"Add agent..."}),O.filter(z=>!e.sub_agents.includes(z.id)).map(z=>s.jsx("option",{value:z.id,children:z.name},z.id))]})]})}),k&&s.jsx(oi,{id:"callbacks",title:"Callbacks",icon:s.jsx(In,{size:16}),expanded:l.has("callbacks"),onToggle:()=>S("callbacks"),children:s.jsx(z_,{agent:x,onUpdate:v,customCallbacks:t.custom_callbacks||[]})})]})]})}function oi({id:e,title:t,icon:n,expanded:r,onToggle:i,children:o}){return s.jsxs("div",{className:"section",children:[s.jsxs("div",{className:"section-header",onClick:i,children:[r?s.jsx(Ct,{size:16}):s.jsx(Nt,{size:16}),s.jsxs("h4",{children:[n," ",t]})]}),r&&s.jsx("div",{className:"section-content",children:o})]})}function N_({tools:e,onAdd:t,onRemove:n,onUpdate:r,builtinTools:i,mcpServers:o,projectMcpServers:a,customTools:l,agents:c,skillsets:u}){const[d,p]=_.useState(!1),[f,m]=_.useState({}),[y,w]=_.useState(""),E=Lt.useRef(null),g=Lt.useRef(null),[h,v]=_.useState(null),[L,S]=_.useState(new Set),k=(R,Z)=>{if(!y.trim())return!0;const B=y.toLowerCase();return R.toLowerCase().includes(B)||((Z==null?void 0:Z.toLowerCase().includes(B))??!1)},x=i.filter(R=>k(R.name,R.description)),T=o.filter(R=>k(R.name,R.description)),A=a.filter(R=>k(R.name,R.description)),N=l.filter(R=>k(R.name,R.description)),b=c.filter(R=>k(R.name,R.description)),P=u.filter(R=>k(R.name,R.description));function O(){if(E.current){const R=E.current.getBoundingClientRect(),Z=window.innerHeight,B=350,te=Z-R.bottom-16,ae=R.top-16;if(te>=200||te>=ae){const $=Math.min(B,te);m({top:R.bottom+4,left:R.left,maxHeight:$})}else{const $=Math.min(B,ae);m({top:R.top-$-4,left:R.left,maxHeight:$})}}p(!0),w(""),setTimeout(()=>{var R;return(R=g.current)==null?void 0:R.focus()},50)}function V(){p(!1),w("")}function D(R){t({type:"builtin",name:R}),V()}async function Q(R){V();const Z=R.tool_filter||[];if(v({server:R,enabledTools:new Set(Z),availableTools:Z.map(B=>({name:B,description:""})),isLoading:Z.length===0,error:void 0}),Z.length===0)try{const{testMcpServer:B}=await cg(async()=>{const{testMcpServer:ae}=await Promise.resolve().then(()=>o0);return{testMcpServer:ae}},void 0),te=await B({connection_type:R.connection_type,command:R.command,args:R.args,env:R.env,url:R.url,headers:R.headers,timeout:R.timeout||30});te.success?v(ae=>ae?{...ae,availableTools:te.tools,enabledTools:new Set(te.tools.map($=>$.name)),isLoading:!1}:null):v(ae=>ae?{...ae,isLoading:!1,error:te.error||"Failed to connect to MCP server"}:null)}catch(B){v(te=>te?{...te,isLoading:!1,error:B.message}:null)}}function z(R){if(!h)return;const Z=new Set(h.enabledTools);Z.has(R)?Z.delete(R):Z.add(R),v({...h,enabledTools:Z})}function M(){if(!h)return;const R=Array.from(h.enabledTools);t({type:"mcp",server:{...h.server,tool_filter:R}}),v(null)}function I(R){const Z=new Set(L);Z.has(R)?Z.delete(R):Z.add(R),S(Z)}function j(R,Z){const B=e[R];if(B.type!=="mcp"||!B.server)return;const te=B.server.tool_filter||[];let ae;te.includes(Z)?ae=te.filter($=>$!==Z):ae=[...te,Z],r(R,{...B,server:{...B.server,tool_filter:ae}})}function U(R){t({type:"function",name:R.name,module_path:R.module_path}),V()}function K(R){const Z=c.find(B=>B.id===R);t({type:"agent",agent_id:R,name:Z==null?void 0:Z.name}),V()}function C(R){const Z=u.find(B=>B.id===R);t({type:"skillset",skillset_id:R,name:Z==null?void 0:Z.name}),V()}function le(R){return o.find(Z=>Z.name===R)}return s.jsxs("div",{children:[s.jsx("style",{children:`
        .mcp-tool-item {
          border: 1px solid var(--border-color);
          border-radius: var(--radius-md);
          overflow: hidden;
...
`)}function FS(){const{project:e}=et(),[t,n]=_.useState(!1);if(!e)return null;const r=_.useMemo(()=>DS(e),[e]);function i(){navigator.clipboard.writeText(r),n(!0),setTimeout(()=>n(!1),2e3)}function o(){const a=new Blob([r],{type:"text/x-python"}),l=URL.createObjectURL(a),c=document.createElement("a");c.href=l,c.download=`${e.name}_agent.py`,c.click(),URL.revokeObjectURL(l)}return s.jsxs("div",{className:"code-panel",children:[s.jsx("style",{children:`
      ...
      `}),s.jsxs("div",{className:"code-header",children:[s.jsxs("div",{className:"code-title",children:[s.jsx(In,{size:16}),s.jsx("h3",{children:"Python Code"}),s.jsx("span",{className:"badge",children:"Generated"}),t&&s.jsxs("span",{className:"status-badge success",children:[s.jsx(Zh,{size:12}),"Copied!"]})]}),s.jsxs("div",{className:"code-actions",children:[s.jsxs("button",{className:"btn btn-secondary btn-sm",onClick:i,title:"Copy to clipboard",children:[s.jsx(eg,{size:14}),"Copy"]}),s.jsxs("button",{className:"btn btn-secondary btn-sm",onClick:o,title:"Download Python file",children:[s.jsx(ts,{size:14}),"Download"]})]})]}),s.jsx("div",{className:"code-editor",children:s.jsx(an,{height:"100%",language:"python",theme:"vs-dark",value:r,options:{readOnly:!0,minimap:{enabled:!1},fontSize:13,fontFamily:"'JetBrains Mono', monospace",lineNumbers:"on",scrollBeyondLastLine:!1,automaticLayout:!0,tabSize:4,insertSpaces:!0,padding:{top:12},wordWrap:"on"}})}),s.jsxs("div",{className:"code-info",children:[s.jsx("p",{children:"This is the Python code equivalent of your project configuration. You can use this code directly with ADK."}),s.jsxs("p",{children:["Place this in a file named ",s.jsx("code",{children:"agent.py"})," inside your agent directory, then run with ",s.jsx("code",{children:"adk web ."})," or ",s.jsx("code",{children:"adk run your_agent"}),"."]})]})]})}const BS=[{id:"app",label:"App",icon:sg},{id:"agents",label:"Agents",icon:Zn},{id:"tools",label:"Tools",icon:Gt},{id:"callbacks",label:"Callbacks",icon:In},{id:"run",label:"Run",icon:rg},{id:"skillsets",label:"SkillSets",icon:u0},{id:"eval",label:"Evaluate",icon:Wl},{id:"yaml",label:"YAML",icon:p0},{id:"code",label:"Code",icon:In}],US=["app","agents","tools","callbacks","run","skillsets","eval","yaml","code"];function Va(){var D,Q;const{projectId:e,tab:t,itemId:n}=p1(),r=nu(),{project:i,setProject:o,activeTab:a,setActiveTab:l,hasUnsavedChanges:c,setHasUnsavedChanges:u,selectedAgentId:d,setSelectedAgentId:p,selectedToolId:f,setSelectedToolId:m}=et(),[y,w]=_.useState(!0),[E,g]=_.useState(!1),[h,v]=_.useState(!1),[L,S]=_.useState(null),k=_.useRef(!0),x=_.useRef(null);_.useEffect(()=>{t&&US.includes(t)?l(t):!t&&e&&r(`/project/${e}/${a}`,{replace:!0})},[t,e]),_.useEffect(()=>{t==="agents"&&n?p(n):t==="tools"&&n&&m(n)},[t,n]);function T(z){l(z),z==="agents"&&d?r(`/project/${e}/${z}/${d}`,{replace:!0}):z==="tools"&&f?r(`/project/${e}/${z}/${f}`,{replace:!0}):r(`/project/${e}/${z}`,{replace:!0})}function A(z){z?r(`/project/${e}/${a}/${z}`,{replace:!0}):r(`/project/${e}/${a}`,{replace:!0})}_.useEffect(()=>(e&&N(e),()=>{o(null),u(!1)}),[e]);async function N(z){k.current=!0;try{const M=await Rh(z);o(M),x.current=JSON.stringify(M),u(!1)}catch(M){console.error("Failed to load project:",M),r("/")}finally{w(!1),setTimeout(()=>{k.current=!1},100)}}async function b(){if(i){g(!0);try{const{eval_sets:z,...M}=i;await Dl(i.id,M),x.current=JSON.stringify(i),u(!1)}catch(z){console.error("Failed to save project:",z)}finally{g(!1)}}}async function P(){if(i){v(!0),S(null),window.dispatchEvent(new CustomEvent("eval-tests-started"));try{let z=0,M=0;const I=[],j=[];for(const U of i.eval_sets||[]){if(U.eval_cases.length===0)continue;const K=await Be.post(`/projects/${i.id}/eval-sets/${U.id}/run`,{});K.result&&(z+=K.result.passed_cases||0,M+=K.result.total_cases||0,K.result.case_results&&I.push(...K.result.case_results),j.push(K.result.eval_set_name||U.name||U.id))}if(I.length>0){const U={id:Date.now().toString(36)+Math.random().toString(36).substr(2,5),eval_set_id:"batch",eval_set_name:j.length>1?`All Tests (${j.length} sets)`:j[0]||"All Tests",started_at:Date.now()/1e3,completed_at:Date.now()/1e3,total_cases:M,passed_cases:z,failed_cases:M-z,case_results:I};try{await Be.post(`/projects/${i.id}/eval-history`,U)}catch(K){console.warn("Failed to save batch eval run to history:",K)}}S({passed:z,total:M}),window.dispatchEvent(new CustomEvent("eval-tests-completed")),setTimeout(()=>S(null),5e3)}catch(z){console.error("Failed to run tests:",z),S({passed:0,total:-1}),setTimeout(()=>S(null),5e3)}finally{v(!1)}}}const O=_.useRef(null);_.useEffect(()=>{if(i&&!k.current&&O.current){const z=i.app.models||[],M=O.current||[];if(z.some((j,U)=>{const K=M.find(C=>C.id===j.id);return K?K.provider!==j.provider||K.model_name!==j.model_name||K.api_base!==j.api_base||K.temperature!==j.temperature||K.max_output_tokens!==j.max_output_tokens||K.top_p!==j.top_p||K.top_k!==j.top_k:!1})){const j=i.app.default_model_id,U=i.agents.map(C=>{if(C.type==="LlmAgent"&&C.model){const le=C.model._appModelId;if(le){const R=z.find(Z=>Z.id===le);if(R)return{...C,model:{provider:R.provider,model_name:R.model_name,api_base:R.api_base,temperature:R.temperature,max_output_tokens:R.max_output_tokens,top_p:R.top_p,top_k:R.top_k,fallbacks:[],_appModelId:le}}}else if(j){const R=z.find(Z=>Z.id===j);if(R&&C.model.provider===R.provider&&C.model.model_name===R.model_name&&C.model.api_base===R.api_base)return{...C,model:{provider:R.provider,model_name:R.model_name,api_base:R.api_base,temperature:R.temperature,max_output_tokens:R.max_output_tokens,top_p:R.top_p,top_k:R.top_k,fallbacks:[],_appModelId:j}}}}return C});U.some((C,le)=>JSON.stringify(C)!==JSON.stringify(i.agents[le]))&&o({...i,agents:U})}}i&&(O.current=i.app.models||[])},[i==null?void 0:i.app.models,i,o]);const V=_.useRef(null);return _.useEffect(()=>(i&&!k.current&&x.current&&JSON.stringify(i)!==x.current&&(u(!0),V.current&&clearTimeout(V.current),V.current=setTimeout(async()=>{try{const{eval_sets:M,...I}=i;await Dl(i.id,I),x.current=JSON.stringify(i),u(!1)}catch(M){console.error("Auto-save failed:",M)}},500)),()=>{V.current&&clearTimeout(V.current)}),[i]),y?s.jsxs("div",{className:"loading-screen",children:[s.jsx("style",{children:`
          .loading-screen {
            height: 100vh;
            display: flex;
            align-items: center;
