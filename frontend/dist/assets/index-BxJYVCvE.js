 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */(function(e){function t(O,R){var j=O.length;O.push(R);e:for(;0<j;){var W=j-1>>>1,J=O[W];if(0<i(J,R))O[W]=R,O[j]=J,j=W;else break e}}function n(O){return O.length===0?null:O[0]}function r(O){if(O.length===0)return null;var R=O[0],j=O.pop();if(j!==R){O[0]=j;e:for(var W=0,J=O.length,v=J>>>1;W<v;){var V=2*(W+1)-1,A=O[V],Y=V+1,ue=O[Y];if(0>i(A,j))Y<J&&0>i(ue,A)?(O[W]=ue,O[Y]=j,W=Y):(O[W]=A,O[V]=j,W=V);else if(Y<J&&0>i(ue,j))O[W]=ue,O[Y]=j,W=Y;else break e}}return R}function i(O,R){var j=O.sortIndex-R.sortIndex;return j!==0?j:O.id-R.id}if(typeof performance=="object"&&typeof performance.now=="function"){var s=performance;e.unstable_now=function(){return s.now()}}else{var a=Date,l=a.now();e.unstable_now=function(){return a.now()-l}}var c=[],u=[],d=1,p=null,f=3,h=!1,x=!1,b=!1,w=typeof setTimeout=="function"?setTimeout:null,g=typeof clearTimeout=="function"?clearTimeout:null,m=typeof setImmediate<"u"?setImmediate:null;typeof navigator<"u"&&navigator.scheduling!==void 0&&navigator.scheduling.isInputPending!==void 0&&navigator.scheduling.isInputPending.bind(navigator.scheduling);function y(O){for(var R=n(u);R!==null;){if(R.callback===null)r(u);else if(R.startTime<=O)r(u),R.sortIndex=R.expirationTime,t(c,R);else break;R=n(u)}}function k(O){if(b=!1,y(O),!x)if(n(c)!==null)x=!0,F(T);else{var R=n(u);R!==null&&E(k,R.startTime-O)}}function T(O,R){x=!1,b&&(b=!1,g(C),C=-1),h=!0;var j=f;try{for(y(R),p=n(c);p!==null&&(!(p.expirationTime>R)||O&&!$());){var W=p.callback;if(typeof W=="function"){p.callback=null,f=p.priorityLevel;var J=W(p.expirationTime<=R);R=e.unstable_now(),typeof J=="function"?p.callback=J:p===n(c)&&r(c),y(R)}else r(c);p=n(c)}if(p!==null)var v=!0;else{var V=n(u);V!==null&&E(k,V.startTime-R),v=!1}return v}finally{p=null,f=j,h=!1}}var S=!1,P=null,C=-1,D=5,N=-1;function $(){return!(e.unstable_now()-N<D)}function I(){if(P!==null){var O=e.unstable_now();N=O;var R=!0;try{R=P(!0,O)}finally{R?L():(S=!1,P=null)}}else S=!1}var L;if(typeof m=="function")L=function(){m(I)};else if(typeof MessageChannel<"u"){var z=new MessageChannel,M=z.port2;z.port1.onmessage=I,L=function(){M.postMessage(null)}}else L=function(){w(I,0)};function F(O){P=O,S||(S=!0,L())}function E(O,R){C=w(function(){O(e.unstable_now())},R)}e.unstable_IdlePriority=5,e.unstable_ImmediatePriority=1,e.unstable_LowPriority=4,e.unstable_NormalPriority=3,e.unstable_Profiling=null,e.unstable_UserBlockingPriority=2,e.unstable_cancelCallback=function(O){O.callback=null},e.unstable_continueExecution=function(){x||h||(x=!0,F(T))},e.unstable_forceFrameRate=function(O){0>O||125<O?console.error("forceFrameRate takes a positive int between 0 and 125, forcing frame rates higher than 125 fps is not supported"):D=0<O?Math.floor(1e3/O):5},e.unstable_getCurrentPriorityLevel=function(){return f},e.unstable_getFirstCallbackNode=function(){return n(c)},e.unstable_next=function(O){switch(f){case 1:case 2:case 3:var R=3;break;default:R=f}var j=f;f=R;try{return O()}finally{f=j}},e.unstable_pauseExecution=function(){},e.unstable_requestPaint=function(){},e.unstable_runWithPriority=function(O,R){switch(O){case 1:case 2:case 3:case 4:case 5:break;default:O=3}var j=f;f=O;try{return R()}finally{f=j}},e.unstable_scheduleCallback=function(O,R,j){var W=e.unstable_now();switch(typeof j=="object"&&j!==null?(j=j.delay,j=typeof j=="number"&&0<j?W+j:W):j=W,O){case 1:var J=-1;break;case 2:J=250;break;case 5:J=1073741823;break;case 4:J=1e4;break;default:J=5e3}return J=j+J,O={id:d++,callback:R,priorityLevel:O,startTime:j,expirationTime:J,sortIndex:-1},j>W?(O.sortIndex=j,t(u,O),n(c)===null&&O===n(u)&&(b?(g(C),C=-1):b=!0,E(k,j-W))):(O.sortIndex=J,t(c,O),x||h||(x=!0,F(T))),O},e.unstable_shouldYield=$,e.unstable_wrapCallback=function(O){var R=f;return function(){var j=f;f=R;try{return O.apply(this,arguments)}finally{f=j}}}})(rg);ng.exports=rg;var a0=ng.exports;/**
 * @license React
 ...
 *
 * @license MIT
 */function Ro(){return Ro=Object.assign?Object.assign.bind():function(e){for(var t=1;t<arguments.length;t++){var n=arguments[t];for(var r in n)Object.prototype.hasOwnProperty.call(n,r)&&(e[r]=n[r])}return e},Ro.apply(this,arguments)}const Pd=_.createContext(null),$w=_.createContext(null),Yo=_.createContext(null),rl=_.createContext(null),gr=_.createContext({outlet:null,matches:[],isDataRoute:!1}),uy=_.createContext(null);function Qo(){return _.useContext(rl)!=null}function Ld(){return Qo()||Ye(!1),_.useContext(rl).location}function dy(e){_.useContext(Yo).static||_.useLayoutEffect(e)}function Md(){let{isDataRoute:e}=_.useContext(gr);return e?Xw():Dw()}function Dw(){Qo()||Ye(!1);let e=_.useContext(Pd),{basename:t,future:n,navigator:r}=_.useContext(Yo),{matches:i}=_.useContext(gr),{pathname:s}=Ld(),a=JSON.stringify(ay(i,n.v7_relativeSplatPath)),l=_.useRef(!1);return dy(()=>{l.current=!0}),_.useCallback(function(u,d){if(d===void 0&&(d={}),!l.current)return;if(typeof u=="number"){r.go(u);return}let p=ly(u,JSON.parse(a),s,d.relative==="path");e==null&&t!=="/"&&(p.pathname=p.pathname==="/"?t:Nr([t,p.pathname])),(d.replace?r.replace:r.push)(p,d.state,d)},[t,r,a,s,e])}function Fw(){let{matches:e}=_.useContext(gr),t=e[e.length-1];return t?t.params:{}}function Bw(e,t){return Uw(e,t)}function Uw(e,t,n,r){Qo()||Ye(!1);let{navigator:i}=_.useContext(Yo),{matches:s}=_.useContext(gr),a=s[s.length-1],l=a?a.params:{};a&&a.pathname;let c=a?a.pathnameBase:"/";a&&a.route;let u=Ld(),d;if(t){var p;let w=typeof t=="string"?zi(t):t;c==="/"||(p=w.pathname)!=null&&p.startsWith(c)||Ye(!1),d=w}else d=u;let f=d.pathname||"/",h=f;if(c!=="/"){let w=c.replace(/^\//,"").split("/");h="/"+f.replace(/^\//,"").split("/").slice(w.length).join("/")}let x=hw(e,{pathname:h}),b=Jw(x&&x.map(w=>Object.assign({},w,{params:Object.assign({},l,w.params),pathname:Nr([c,i.encodeLocation?i.encodeLocation(w.pathname).pathname:w.pathname]),pathnameBase:w.pathnameBase==="/"?c:Nr([c,i.encodeLocation?i.encodeLocation(w.pathnameBase).pathname:w.pathnameBase])})),s,n,r);return t&&b?_.createElement(rl.Provider,{value:{location:Ro({pathname:"/",search:"",hash:"",state:null,key:"default"},d),navigationType:Xn.Pop}},b):b}function Vw(){let e=Qw(),t=Iw(e)?e.status+" "+e.statusText:e instanceof Error?e.message:JSON.stringify(e),n=e instanceof Error?e.stack:null,i={padding:"0.5rem",backgroundColor:"rgba(200,200,200, 0.5)"};return _.createElement(_.Fragment,null,_.createElement("h2",null,"Unexpected Application Error!"),_.createElement("h3",{style:{fontStyle:"italic"}},t),n?_.createElement("pre",{style:i},n):null,null)}const Ww=_.createElement(Vw,null);class Hw extends _.Component{constructor(t){super(t),this.state={location:t.location,revalidation:t.revalidation,error:t.error}}static getDerivedStateFromError(t){return{error:t}}static getDerivedStateFromProps(t,n){return n.location!==t.location||n.revalidation!=="idle"&&t.revalidation==="idle"?{error:t.error,location:t.location,revalidation:t.revalidation}:{error:t.error!==void 0?t.error:n.error,location:n.location,revalidation:t.revalidation||n.revalidation}}componentDidCatch(t,n){console.error("React Router caught the following error during render",t,n)}render(){return this.state.error!==void 0?_.createElement(gr.Provider,{value:this.props.routeContext},_.createElement(uy.Provider,{value:this.state.error,children:this.props.component})):this.props.children}}function qw(e){let{routeContext:t,match:n,children:r}=e,i=_.useContext(Pd);return i&&i.static&&i.staticContext&&(n.route.errorElement||n.route.ErrorBoundary)&&(i.staticContext._deepestRenderedBoundaryId=n.route.id),_.createElement(gr.Provider,{value:t},r)}function Jw(e,t,n,r){var i;if(t===void 0&&(t=[]),n===void 0&&(n=null),r===void 0&&(r=null),e==null){var s;if(!n)return null;if(n.errors)e=n.matches;else if((s=r)!=null&&s.v7_partialHydration&&t.length===0&&!n.initialized&&n.matches.length>0)e=n.matches;else return null}let a=e,l=(i=n)==null?void 0:i.errors;if(l!=null){let d=a.findIndex(p=>p.route.id&&(l==null?void 0:l[p.route.id])!==void 0);d>=0||Ye(!1),a=a.slice(0,Math.min(a.length,d+1))}let c=!1,u=-1;if(n&&r&&r.v7_partialHydration)for(let d=0;d<a.length;d++){let p=a[d];if((p.route.HydrateFallback||p.route.hydrateFallbackElement)&&(u=d),p.route.id){let{loaderData:f,errors:h}=n,x=p.route.loader&&f[p.route.id]===void 0&&(!h||h[p.route.id]===void 0);if(p.route.lazy||x){c=!0,u>=0?a=a.slice(0,u+1):a=[a[0]];break}}}return a.reduceRight((d,p,f)=>{let h,x=!1,b=null,w=null;n&&(h=l&&p.route.id?l[p.route.id]:void 0,b=p.route.errorElement||Ww,c&&(u<0&&f===0?(Zw("route-fallback"),x=!0,w=null):u===f&&(x=!0,w=p.route.hydrateFallbackElement||null)));let g=t.concat(a.slice(0,f+1)),m=()=>{let y;return h?y=b:x?y=w:p.route.Component?y=_.createElement(p.route.Component,null):p.route.element?y=p.route.element:y=d,_.createElement(qw,{match:p,routeContext:{outlet:d,matches:g,isDataRoute:n!=null},children:y})};return n&&(p.route.ErrorBoundary||p.route.errorElement||f===0)?_.createElement(Hw,{location:n.location,revalidation:n.revalidation,component:b,error:h,children:m(),routeContext:{outlet:null,matches:g,isDataRoute:!0}}):m()},null)}var py=function(e){return e.UseBlocker="useBlocker",e.UseRevalidator="useRevalidator",e.UseNavigateStable="useNavigate",e}(py||{}),fy=function(e){return e.UseBlocker="useBlocker",e.UseLoaderData="useLoaderData",e.UseActionData="useActionData",e.UseRouteError="useRouteError",e.UseNavigation="useNavigation",e.UseRouteLoaderData="useRouteLoaderData",e.UseMatches="useMatches",e.UseRevalidator="useRevalidator",e.UseNavigateStable="useNavigate",e.UseRouteId="useRouteId",e}(fy||{});function Kw(e){let t=_.useContext(Pd);return t||Ye(!1),t}function Gw(e){let t=_.useContext($w);return t||Ye(!1),t}function Yw(e){let t=_.useContext(gr);return t||Ye(!1),t}function hy(e){let t=Yw(),n=t.matches[t.matches.length-1];return n.route.id||Ye(!1),n.route.id}function Qw(){var e;let t=_.useContext(uy),n=Gw(),r=hy();return t!==void 0?t:(e=n.errors)==null?void 0:e[r]}function Xw(){let{router:e}=Kw(py.UseNavigateStable),t=hy(fy.UseNavigateStable),n=_.useRef(!1);return dy(()=>{n.current=!0}),_.useCallback(function(i,s){s===void 0&&(s={}),n.current&&(typeof i=="number"?e.navigate(i):e.navigate(i,Ro({fromRouteId:t},s)))},[e,t])}const ch={};function Zw(e,t,n){ch[e]||(ch[e]=!0)}function ek(e,t){e==null||e.v7_startTransition,e==null||e.v7_relativeSplatPath}function tk(e){let{to:t,replace:n,state:r,relative:i}=e;Qo()||Ye(!1);let{future:s,static:a}=_.useContext(Yo),{matches:l}=_.useContext(gr),{pathname:c}=Ld(),u=Md(),d=ly(t,ay(l,s.v7_relativeSplatPath),c,i==="path"),p=JSON.stringify(d);return _.useEffect(()=>u(JSON.parse(p),{replace:n,state:r,relative:i}),[u,p,i,n,r]),null}function Vr(e){Ye(!1)}function nk(e){let{basename:t="/",children:n=null,location:r,navigationType:i=Xn.Pop,navigator:s,static:a=!1,future:l}=e;Qo()&&Ye(!1);let c=t.replace(/^\/*/,"/"),u=_.useMemo(()=>({basename:c,navigator:s,static:a,future:Ro({v7_relativeSplatPath:!1},l)}),[c,l,s,a]);typeof r=="string"&&(r=zi(r));let{pathname:d="/",search:p="",hash:f="",state:h=null,key:x="default"}=r,b=_.useMemo(()=>{let w=sy(d,c);return w==null?null:{location:{pathname:w,search:p,hash:f,state:h,key:x},navigationType:i}},[c,d,p,f,h,x,i]);return b==null?null:_.createElement(Yo.Provider,{value:u},_.createElement(rl.Provider,{children:n,value:b}))}function rk(e){let{children:t,location:n}=e;return Bw(uu(t),n)}new Promise(()=>{});function uu(e,t){t===void 0&&(t=[]);let n=[];return _.Children.forEach(e,(r,i)=>{if(!_.isValidElement(r))return;let s=[...t,i];if(r.type===_.Fragment){n.push.apply(n,uu(r.props.children,s));return}r.type!==Vr&&Ye(!1),!r.props.index||!r.props.children||Ye(!1);let a={id:r.props.id||s.join("-"),caseSensitive:r.props.caseSensitive,element:r.props.element,Component:r.props.Component,index:r.props.index,path:r.props.path,loader:r.props.loader,action:r.props.action,errorElement:r.props.errorElement,ErrorBoundary:r.props.ErrorBoundary,hasErrorBoundary:r.props.ErrorBoundary!=null||r.props.errorElement!=null,shouldRevalidate:r.props.shouldRevalidate,handle:r.props.handle,lazy:r.props.lazy};r.props.children&&(a.children=uu(r.props.children,s)),n.push(a)}),n}/**
 ...
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const Ik=e=>e.replace(/([a-z0-9])([A-Z])/g,"$1-$2").toLowerCase().trim(),fe=(e,t)=>{const n=_.forwardRef(({color:r="currentColor",size:i=24,strokeWidth:s=2,absoluteStrokeWidth:a,className:l="",children:c,...u},d)=>_.createElement("svg",{ref:d,...Rk,width:i,height:i,stroke:r,strokeWidth:a?Number(s)*24/Number(i):s,className:["lucide",`lucide-${Ik(e)}`,l].join(" "),...u},[...t.map(([p,f])=>_.createElement(p,f)),...Array.isArray(c)?c:[c]]));return n.displayName=`${e}`,n};/**
 * @license lucide-react v0.294.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
...
`).length,h=Math.max(r,Math.min(f*20+40,500));l(h)}},[e,r]),_.useEffect(()=>{i&&u.current&&u.current.focus()},[i]);function d(f){u.current=f,f.focus()}function p(f){c.current&&!c.current.contains(f.target)&&s(!1)}return _.useEffect(()=>{if(i)return document.addEventListener("mousedown",p),()=>document.removeEventListener("mousedown",p)},[i]),o.jsxs("div",{ref:c,className:"markdown-editor",children:[o.jsx("style",{children:`
      ...
      `}),i?o.jsx("div",{className:"monaco-wrapper",children:o.jsx(Kt,{height:"100%",language:"markdown",theme:"vs-dark",value:e,onChange:f=>t(f||""),onMount:d,options:{minimap:{enabled:!1},fontSize:14,fontFamily:"'JetBrains Mono', monospace",lineNumbers:"off",scrollBeyondLastLine:!1,automaticLayout:!0,wordWrap:"on",padding:{top:12,bottom:12},lineDecorationsWidth:8,folding:!1,glyphMargin:!1,renderLineHighlight:"none",overviewRulerLanes:0,hideCursorInOverviewRuler:!0,scrollbar:{vertical:"auto",horizontal:"hidden"}}})}):o.jsxs("div",{className:"markdown-preview",onClick:()=>s(!0),children:[o.jsxs("span",{className:"edit-hint",children:[o.jsx(Kk,{size:12}),"Click to edit"]}),e?o.jsx("div",{className:"markdown-content",children:o.jsx(Uv,{children:e})}):o.jsx("div",{className:"markdown-placeholder",children:n})]})]})}function s4(e){return/^[a-zA-Z0-9_]+$/.test(e)}function a4({agent:e}){const{project:t,updateAgent:n,mcpServers:r,builtinTools:i,setActiveTab:s,setRunAgentId:a}=ut(),[l,c]=_.useState(new Set(["basic","model","tools","subagents"])),[u,d]=_.useState(!1),[p,f]=_.useState(!1),[h,x]=_.useState(!1),[b,w]=_.useState(""),[g,m]=_.useState(null);if(!t)return null;function y(E){n(e.id,E)}function k(E){if(E===""){m(null),y({name:E});return}s4(E)?m(null):m("Name can only contain letters, numbers, and underscores"),e.type==="LlmAgent"?y({name:E,output_key:E}):y({name:E})}function T(E){const O=new Set(l);O.has(E)?O.delete(E):O.add(E),c(O)}const S=e.type==="LlmAgent",P=e;function C(E){S&&y({tools:[...P.tools,E]})}function D(E){S&&y({tools:P.tools.filter((O,R)=>R!==E)})}function N(E,O){if(!S)return;const R=[...P.tools];R[E]=O,y({tools:R})}function $(E){"sub_agents"in e&&y({sub_agents:[...e.sub_agents,E]})}function I(E){"sub_agents"in e&&y({sub_agents:e.sub_agents.filter(O=>O!==E)})}const L=t.agents.filter(E=>E.id!==e.id);async function z(){if(!(!t||!S)){d(!0);try{const E=P.instruction||"",O=E?`Current instruction to improve:

${E}

Please improve and expand this instruction while preserving its core intent.`:void 0,j=t.agents.some(J=>J.id===e.id)?void 0:e,W=await Ks(t.id,e.id,O,j);W.success&&W.prompt?y({instruction:W.prompt}):alert("Failed to generate prompt: "+(W.error||"Unknown error"))}catch(E){alert("Error generating prompt: "+E.message)}finally{d(!1)}}}async function M(){if(!(!t||!S||!b.trim())){d(!0);try{const O=`Current instruction:
...
Your response (5-10 words only):`,R=await Ks(t.id,e.id,O);if(R.success&&R.prompt){let j=R.prompt.trim();j=j.replace(/^["']|["']$/g,"").trim();const W=j.split(/[.!?\n]/)[0].trim(),J=W.length>80?W.slice(0,77)+"...":W;y({description:J})}else alert("Failed to generate description: "+(R.error||"Unknown error"))}catch(O){alert("Error generating description: "+O.message)}finally{f(!1)}}return o.jsxs("div",{className:"agent-editor",children:[o.jsx("style",{children:`
        .agent-editor {
          background: var(--bg-secondary);
          border: 1px solid var(--border-color);
          border-radius: var(--radius-lg);
      ...
      `}),o.jsxs("div",{className:"editor-header",children:[o.jsx(Er,{size:24,style:{color:"var(--accent-primary)"}}),o.jsxs("div",{style:{flex:1,display:"flex",flexDirection:"column",gap:4},children:[o.jsx("input",{type:"text",value:e.name,onChange:E=>k(E.target.value),placeholder:"Agent name",style:{borderColor:g?"var(--error)":void 0}}),g&&o.jsx("span",{style:{fontSize:11,color:"var(--error)",marginTop:-4},children:g})]}),o.jsx("span",{className:"badge badge-info",children:e.type}),o.jsxs("button",{className:"btn btn-primary btn-sm run-agent-btn",onClick:()=>{a(e.id),s("run")},title:"Test this agent",children:[o.jsx(pr,{size:14}),"Run"]})]}),o.jsxs("div",{className:"editor-content",children:[o.jsxs(qi,{id:"basic",title:"Basic Info",icon:o.jsx(Er,{size:16}),expanded:l.has("basic"),onToggle:()=>T("basic"),children:[o.jsx("div",{className:"form-row",children:o.jsxs("div",{className:"form-group full-width",children:[o.jsxs("div",{className:"label-with-action",children:[o.jsx("label",{children:"Description"}),S&&P.instruction&&o.jsx("button",{className:"btn btn-secondary btn-sm generate-btn",onClick:F,disabled:p,title:"Generate description from instruction",children:p?o.jsxs(o.Fragment,{children:[o.jsx(Zn,{size:14,className:"spin"}),"Summarizing..."]}):"Summarize"})]}),o.jsx("input",{type:"text",value:e.description,onChange:E=>y({description:E.target.value}),placeholder:"e.g., Reviews code for bugs and suggests fixes"})]})}),S&&o.jsxs(o.Fragment,{children:[o.jsx("div",{className:"form-row",children:o.jsxs("div",{className:"form-group full-width",children:[o.jsxs("div",{className:"label-with-action",children:[o.jsx("label",{children:"Instruction"}),o.jsxs("div",{className:"action-buttons",children:[o.jsx("button",{className:"btn btn-secondary btn-sm",onClick:()=>x(!h),disabled:u||!P.instruction,title:"Request specific changes to the instruction",children:"Request Changes"}),o.jsx("button",{className:"btn btn-secondary btn-sm",onClick:z,disabled:u,title:"Uses AI to improve and expand the current instruction",children:u?o.jsxs(o.Fragment,{children:[o.jsx(Zn,{size:14,className:"spin"}),"Working..."]}):"Auto-Improve"})]})]}),h&&o.jsxs("div",{className:"request-changes-box",children:[o.jsx("input",{type:"text",value:b,onChange:E=>w(E.target.value),placeholder:"Describe what changes you want...",onKeyDown:E=>{E.key==="Enter"&&b.trim()?M():E.key==="Escape"&&(x(!1),w(""))},autoFocus:!0}),o.jsx("button",{className:"btn btn-primary btn-sm",onClick:M,disabled:u||!b.trim(),children:"Apply"})]}),o.jsx(o4,{value:P.instruction,onChange:E=>y({instruction:E}),placeholder:"Write your agent's instruction here... (Markdown supported)",minHeight:200})]})}),o.jsxs("div",{className:"form-row",children:[o.jsxs("div",{className:"form-group",children:[o.jsx("label",{children:"Output Key"}),o.jsxs("select",{value:P.output_key||"",onChange:E=>y({output_key:E.target.value||void 0}),children:[o.jsx("option",{value:"",children:"None"}),t.app.state_keys.map(E=>o.jsx("option",{value:E.name,children:E.name},E.name))]})]}),o.jsxs("div",{className:"form-group",children:[o.jsx("label",{children:"Include Contents"}),o.jsxs("select",{value:P.include_contents,onChange:E=>y({include_contents:E.target.value}),children:[o.jsx("option",{value:"default",children:"Default"}),o.jsx("option",{value:"none",children:"None"})]})]})]}),o.jsxs("div",{className:"form-row",style:{gap:24},children:[o.jsxs("label",{style:{display:"flex",alignItems:"center",gap:8,fontSize:13},children:[o.jsxs("span",{className:"toggle-switch",children:[o.jsx("input",{type:"checkbox",checked:P.disallow_transfer_to_parent,onChange:E=>y({disallow_transfer_to_parent:E.target.checked})}),o.jsx("span",{className:"toggle-slider"})]}),"Disallow transfer to parent"]}),o.jsxs("label",{style:{display:"flex",alignItems:"center",gap:8,fontSize:13},children:[o.jsxs("span",{className:"toggle-switch",children:[o.jsx("input",{type:"checkbox",checked:P.disallow_transfer_to_peers,onChange:E=>y({disallow_transfer_to_peers:E.target.checked})}),o.jsx("span",{className:"toggle-slider"})]}),"Disallow transfer to peers"]})]})]}),e.type==="LoopAgent"&&o.jsx("div",{className:"form-row",children:o.jsxs("div",{className:"form-group",children:[o.jsx("label",{children:"Max Iterations"}),o.jsx("input",{type:"number",value:e.max_iterations||"",onChange:E=>y({max_iterations:parseInt(E.target.value)||void 0}),placeholder:"No limit"})]})})]}),S&&o.jsx(qi,{id:"model",title:"Model",icon:o.jsx(Od,{size:16}),expanded:l.has("model"),onToggle:()=>T("model"),children:o.jsx(c4,{agent:P,appModels:t.app.models||[],defaultModelId:t.app.default_model_id,projectId:t.id,onUpdate:E=>y({model:E})})}),S&&o.jsx(qi,{id:"tools",title:`Tools (${P.tools.length})`,icon:o.jsx(ln,{size:16}),expanded:l.has("tools"),onToggle:()=>T("tools"),children:o.jsx(l4,{tools:P.tools,onAdd:C,onRemove:D,onUpdate:N,builtinTools:i,mcpServers:r,projectMcpServers:t.mcp_servers,customTools:t.custom_tools,agents:L,skillsets:t.skillsets||[]})}),"sub_agents"in e&&o.jsx(qi,{id:"subagents",title:`Sub-Agents (${e.sub_agents.length})`,icon:o.jsx(Gy,{size:16}),expanded:l.has("subagents"),onToggle:()=>T("subagents"),children:o.jsxs("div",{className:"sub-agent-list",children:[e.sub_agents.map(E=>{const O=t.agents.find(R=>R.id===E);return O?o.jsxs("div",{className:"sub-agent-chip",children:[O.name,o.jsx("button",{onClick:()=>I(E),children:o.jsx(Fe,{size:12})})]},E):null}),o.jsxs("select",{value:"",onChange:E=>{E.target.value&&$(E.target.value)},style:{width:150,padding:"6px 10px",fontSize:13},children:[o.jsx("option",{value:"",children:"Add agent..."}),L.filter(E=>!e.sub_agents.includes(E.id)).map(E=>o.jsx("option",{value:E.id,children:E.name},E.id))]})]})}),o.jsx(qi,{id:"callbacks",title:"Callbacks",icon:o.jsx(jn,{size:16}),expanded:l.has("callbacks"),onToggle:()=>T("callbacks"),children:o.jsx(u4,{agent:e,onUpdate:y,customCallbacks:t.custom_callbacks||[],isLlmAgent:S})})]})]})}function qi({id:e,title:t,icon:n,expanded:r,onToggle:i,children:s}){return o.jsxs("div",{className:"section",children:[o.jsxs("div",{className:"section-header",onClick:i,children:[r?o.jsx(Pt,{size:16}):o.jsx(bt,{size:16}),o.jsxs("h4",{children:[n," ",t]})]}),r&&o.jsx("div",{className:"section-content",children:s})]})}function l4({tools:e,onAdd:t,onRemove:n,onUpdate:r,builtinTools:i,mcpServers:s,projectMcpServers:a,customTools:l,agents:c,skillsets:u}){const[d,p]=_.useState(!1),[f,h]=_.useState({}),[x,b]=_.useState(""),w=It.useRef(null),g=It.useRef(null),[m,y]=_.useState(null),[k,T]=_.useState(new Set),S=(A,Y)=>{if(!x.trim())return!0;const ue=x.toLowerCase();return A.toLowerCase().includes(ue)||((Y==null?void 0:Y.toLowerCase().includes(ue))??!1)},P=i.filter(A=>S(A.name,A.description)),C=s.filter(A=>S(A.name,A.description)),D=a.filter(A=>S(A.name,A.description)),N=l.filter(A=>S(A.name,A.description)),$=c.filter(A=>S(A.name,A.description)),I=u.filter(A=>S(A.name,A.description));function L(){if(w.current){const A=w.current.getBoundingClientRect(),Y=window.innerHeight,ue=350,me=Y-A.bottom-16,q=A.top-16;if(me>=200||me>=q){const B=Math.min(ue,me);h({top:A.bottom+4,left:A.left,maxHeight:B})}else{const B=Math.min(ue,q);h({top:A.top-B-4,left:A.left,maxHeight:B})}}p(!0),b(""),setTimeout(()=>{var A;return(A=g.current)==null?void 0:A.focus()},50)}function z(){p(!1),b("")}function M(A){t({type:"builtin",name:A}),z()}async function F(A){z();const Y=A.tool_filter||[];if(y({server:A,enabledTools:new Set(Y),availableTools:Y.map(ue=>({name:ue,description:""})),isLoading:Y.length===0,error:void 0}),Y.length===0)try{const{testMcpServer:ue}=await uj(async()=>{const{testMcpServer:q}=await Promise.resolve().then(()=>Mk);return{testMcpServer:q}},void 0),me=await ue({connection_type:A.connection_type,command:A.command,args:A.args,env:A.env,url:A.url,headers:A.headers,timeout:A.timeout||30});me.success?y(q=>q?{...q,availableTools:me.tools,enabledTools:new Set(me.tools.map(B=>B.name)),isLoading:!1}:null):y(q=>q?{...q,isLoading:!1,error:me.error||"Failed to connect to MCP server"}:null)}catch(ue){y(me=>me?{...me,isLoading:!1,error:ue.message}:null)}}function E(A){if(!m)return;const Y=new Set(m.enabledTools);Y.has(A)?Y.delete(A):Y.add(A),y({...m,enabledTools:Y})}function O(){if(!m)return;const A=Array.from(m.enabledTools);t({type:"mcp",server:{...m.server,tool_filter:A}}),y(null)}function R(A){const Y=new Set(k);Y.has(A)?Y.delete(A):Y.add(A),T(Y)}function j(A,Y){const ue=e[A];if(ue.type!=="mcp"||!ue.server)return;const me=ue.server.tool_filter||[];let q;me.includes(Y)?q=me.filter(B=>B!==Y):q=[...me,Y],r(A,{...ue,server:{...ue.server,tool_filter:q}})}function W(A){t({type:"function",name:A.name,module_path:A.module_path}),z()}function J(A){const Y=c.find(ue=>ue.id===A);t({type:"agent",agent_id:A,name:Y==null?void 0:Y.name}),z()}function v(A){const Y=u.find(ue=>ue.id===A);t({type:"skillset",skillset_id:A,name:Y==null?void 0:Y.name}),z()}function V(A){return s.find(Y=>Y.name===A)}return o.jsxs("div",{children:[o.jsx("style",{children:`
        .mcp-tool-item {
          border: 1px solid var(--border-color);
          border-radius: var(--radius-md);
          overflow: hidden;
      ...
      `}),o.jsx("div",{className:"tool-list",children:e.map((A,Y)=>{var ue;return A.type==="mcp"&&A.server?o.jsxs("div",{className:"mcp-tool-item",children:[o.jsxs("div",{className:"mcp-tool-header",onClick:()=>R(Y),children:[k.has(Y)?o.jsx(Pt,{size:14}):o.jsx(bt,{size:14}),o.jsx(ln,{size:14,style:{color:"var(--accent-primary)"}}),o.jsxs("div",{className:"mcp-tool-info",children:[o.jsx("div",{className:"mcp-tool-name",children:A.server.name}),o.jsx("div",{className:"mcp-tool-count",children:A.server.tool_filter===null||A.server.tool_filter===void 0?"all tools":`${A.server.tool_filter.length} tools enabled`})]}),o.jsx("button",{className:"delete-btn",onClick:me=>{me.stopPropagation(),n(Y)},children:o.jsx(Fe,{size:14})})]}),k.has(Y)&&o.jsx("div",{className:"mcp-tool-body",children:o.jsx("div",{className:"mcp-tool-list",children:(()=>{const me=V(A.server.name),q=(me==null?void 0:me.tool_filter)||A.server.tool_filter||[],B=new Set(A.server.tool_filter||[]);return q.map(K=>o.jsxs("label",{className:`mcp-tool-chip ${B.has(K)?"enabled":"disabled"}`,onClick:()=>j(Y,K),children:[o.jsx("input",{type:"checkbox",checked:B.has(K),onChange:()=>{},style:{display:"none"}}),K]},K))})()})})]},Y):A.type==="skillset"?o.jsxs("div",{className:"tool-item",children:[o.jsx(Rn,{size:14,style:{color:"var(--accent)"}}),o.jsxs("div",{className:"tool-item-info",children:[o.jsx("div",{className:"tool-item-name",children:A.name||((ue=u.find(me=>me.id===A.skillset_id))==null?void 0:ue.name)||"SkillSet"}),o.jsx("div",{className:"tool-item-type",children:"skillset"})]}),o.jsx("button",{className:"delete-btn",onClick:()=>n(Y),children:o.jsx(Fe,{size:14})})]},Y):o.jsxs("div",{className:"tool-item",children:[o.jsx(ln,{size:14,style:{color:"var(--accent-primary)"}}),o.jsxs("div",{className:"tool-item-info",children:[o.jsx("div",{className:"tool-item-name",children:A.name||A.agent_id}),o.jsx("div",{className:"tool-item-type",children:A.type})]}),o.jsx("button",{className:"delete-btn",onClick:()=>n(Y),children:o.jsx(Fe,{size:14})})]},Y)})}),o.jsxs("div",{className:"add-tool-dropdown",style:{marginTop:12},children:[o.jsxs("button",{ref:w,className:"btn btn-secondary btn-sm",onClick:()=>d?z():L(),children:[o.jsx(Ke,{size:14}),"Add Tool"]}),d&&o.jsxs(o.Fragment,{children:[o.jsx("div",{className:"dropdown-backdrop",onClick:z}),o.jsxs("div",{className:"dropdown-content dropdown-fixed",style:f,children:[o.jsx("div",{className:"dropdown-search",children:o.jsx("input",{ref:g,type:"text",placeholder:"Search tools...",value:x,onChange:A=>b(A.target.value),onKeyDown:A=>A.key==="Escape"&&z()})}),P.length>0&&o.jsxs("div",{className:"dropdown-section",children:[o.jsx("h5",{children:"Built-in Tools"}),P.map(A=>o.jsxs("button",{className:"dropdown-item",onClick:()=>M(A.name),children:[o.jsx("div",{className:"dropdown-item-name",children:A.name}),o.jsx("div",{className:"dropdown-item-desc",children:A.description})]},A.name))]}),C.length>0&&o.jsxs("div",{className:"dropdown-section",children:[o.jsxs("h5",{children:["Known MCP Servers (",C.length,")"]}),C.map(A=>o.jsxs("button",{className:"dropdown-item",onClick:()=>F(A),children:[o.jsxs("div",{className:"dropdown-item-name",children:[A.name,o.jsx("span",{style:{fontSize:11,color:"var(--text-muted)",marginLeft:8},children:A.tool_filter===null||A.tool_filter===void 0?"all tools":`${A.tool_filter.length} tools`})]}),o.jsx("div",{className:"dropdown-item-desc",children:A.description})]},`known-${A.name}`))]}),D.length>0&&o.jsxs("div",{className:"dropdown-section",children:[o.jsxs("h5",{children:["Project MCP Servers (",D.length,")"]}),D.map(A=>o.jsxs("button",{className:"dropdown-item",onClick:()=>F(A),children:[o.jsxs("div",{className:"dropdown-item-name",children:[A.name,o.jsx("span",{style:{fontSize:11,color:"var(--text-muted)",marginLeft:8},children:A.tool_filter===null||A.tool_filter===void 0?"all tools":`${A.tool_filter.length} tools`})]}),o.jsx("div",{className:"dropdown-item-desc",children:A.description||"Custom MCP server"})]},`project-${A.id||A.name}`))]}),N.length>0&&o.jsxs("div",{className:"dropdown-section",children:[o.jsx("h5",{children:"Custom Tools"}),N.map(A=>o.jsxs("button",{className:"dropdown-item",onClick:()=>W(A),children:[o.jsx("div",{className:"dropdown-item-name",children:A.name}),o.jsx("div",{className:"dropdown-item-desc",children:A.description})]},A.id))]}),$.length>0&&o.jsxs("div",{className:"dropdown-section",children:[o.jsx("h5",{children:"Agents as Tools"}),$.map(A=>o.jsxs("button",{className:"dropdown-item",onClick:()=>J(A.id),children:[o.jsx("div",{className:"dropdown-item-name",children:A.name}),o.jsx("div",{className:"dropdown-item-desc",children:A.type})]},A.id))]}),I.length>0&&o.jsxs("div",{className:"dropdown-section",children:[o.jsxs("h5",{children:["SkillSets (",I.length,")"]}),I.map(A=>o.jsxs("button",{className:"dropdown-item",onClick:()=>v(A.id),children:[o.jsxs("div",{className:"dropdown-item-name",children:[A.name,o.jsxs("span",{style:{fontSize:11,color:"var(--text-muted)",marginLeft:8},children:[A.entry_count||0," entries"]})]}),o.jsx("div",{className:"dropdown-item-desc",children:A.description||"Vector knowledge base"})]},A.id))]}),x.trim()&&P.length===0&&C.length===0&&D.length===0&&N.length===0&&$.length===0&&I.length===0&&o.jsxs("div",{className:"dropdown-section",style:{textAlign:"center",padding:"20px",color:"var(--text-muted)"},children:['No tools matching "',x,'"']})]})]})]}),m&&o.jsx("div",{className:"mcp-config-dialog",children:o.jsxs("div",{className:"mcp-config-content",children:[o.jsxs("h3",{children:["Configure ",m.server.name]}),o.jsx("p",{children:m.server.description}),m.isLoading?o.jsxs("div",{className:"mcp-loading",children:[o.jsx("div",{className:"spinner"}),o.jsx("p",{children:"Connecting to MCP server and discovering tools..."})]}):m.error?o.jsxs("div",{className:"mcp-error",children:[o.jsxs("p",{children:["⚠️ Failed to discover tools: ",m.error]}),o.jsx("p",{className:"hint",children:"You can still add the server, but you won't be able to select specific tools."})]}):o.jsxs(o.Fragment,{children:[o.jsxs("div",{className:"mcp-select-actions",children:[o.jsxs("button",{className:"btn btn-secondary btn-sm",onClick:()=>y({...m,enabledTools:new Set(m.availableTools.map(A=>A.name))}),children:["Select All (",m.availableTools.length,")"]}),o.jsx("button",{className:"btn btn-secondary btn-sm",onClick:()=>y({...m,enabledTools:new Set}),children:"Select None"})]}),o.jsx("div",{className:"mcp-tools-grid",children:m.availableTools.map(A=>o.jsxs("div",{className:"mcp-tool-row",title:A.description||A.name,style:{display:"flex",alignItems:"center",gap:8,padding:"4px 0"},children:[o.jsxs("label",{className:"toggle-switch",style:{margin:0},children:[o.jsx("input",{type:"checkbox",checked:m.enabledTools.has(A.name),onChange:()=>E(A.name)}),o.jsx("span",{className:"toggle-slider"})]}),o.jsx("span",{style:{fontSize:13,opacity:m.enabledTools.has(A.name)?1:.5,cursor:"pointer"},onClick:()=>E(A.name),children:A.name})]},A.name))})]}),o.jsxs("div",{className:"dialog-actions",children:[o.jsx("button",{className:"btn btn-secondary",onClick:()=>y(null),children:"Cancel"}),o.jsxs("button",{className:"btn btn-primary",onClick:O,disabled:m.enabledTools.size===0,children:["Add ",m.enabledTools.size," Tools"]})]})]})})]})}function c4({agent:e,appModels:t,defaultModelId:n,projectId:r,onUpdate:i}){var f,h;const s=(f=e.model)==null?void 0:f._appModelId,a=e.model!==null&&e.model!==void 0&&!s,c=s||(()=>{if(!e.model)return n;const x=t.find(b=>{var w,g,m;return b.provider===((w=e.model)==null?void 0:w.provider)&&b.model_name===((g=e.model)==null?void 0:g.model_name)&&b.api_base===((m=e.model)==null?void 0:m.api_base)});return x==null?void 0:x.id})()||n||((h=t[0])==null?void 0:h.id);It.useEffect(()=>{var x,b,w,g,m;if(s){const y=t.find(k=>k.id===s);y&&(((x=e.model)==null?void 0:x.provider)!==y.provider||((b=e.model)==null?void 0:b.model_name)!==y.model_name||((w=e.model)==null?void 0:w.api_base)!==y.api_base||((g=e.model)==null?void 0:g.temperature)!==y.temperature||((m=e.model)==null?void 0:m.max_output_tokens)!==y.max_output_tokens)&&i({provider:y.provider,model_name:y.model_name,api_base:y.api_base,temperature:y.temperature,max_output_tokens:y.max_output_tokens,top_p:y.top_p,top_k:y.top_k,fallbacks:[],_appModelId:s})}},[s,t,e.model,i]);function u(x){const b=t.find(w=>w.id===x);b&&i({provider:b.provider,model_name:b.model_name,api_base:b.api_base,temperature:b.temperature,max_output_tokens:b.max_output_tokens,top_p:b.top_p,top_k:b.top_k,fallbacks:[],_appModelId:x})}function d(){var x;if(a){const b=n||((x=t[0])==null?void 0:x.id);b&&u(b)}else{const b=e.model;if(b){const{_appModelId:w,...g}=b;i(g)}else i({provider:"gemini",model_name:"gemini-2.0-flash",fallbacks:[]})}}function p(x){const{_appModelId:b,...w}=e.model||{};i({...w,...x})}return t.find(x=>x.id===c),t.find(x=>x.id===n),o.jsxs("div",{className:"model-selector",children:[o.jsx("style",{children:`
        .model-selector {
          display: flex;
          flex-direction: column;
          gap: 16px;
...
`;function K4({onSelectTool:e}){const{project:t,updateProject:n,addCustomTool:r,updateCustomTool:i,removeCustomTool:s,selectedToolId:a,setSelectedToolId:l,builtinTools:c,mcpServers:u}=ut(),[d,p]=_.useState(""),[f,h]=_.useState(null),[x,b]=_.useState("tools"),[w,g]=_.useState(null),[m,y]=_.useState(""),[k,T]=_.useState(!1),[S,P]=_.useState(!1),[C,D]=_.useState(!1),[N,$]=_.useState(null),[I,L]=_.useState(null),[z,M]=_.useState({}),[F,E]=_.useState({}),[O,R]=_.useState("");if(!t)return null;const j=t.mcp_servers||[],W=t.custom_tools.find(H=>H.id===a),J=j.find(H=>H.name===w);function v(H){l(H),e==null||e(H)}_.useEffect(()=>{W&&(p(W.code),L(null))},[a]),_.useEffect(()=>{J&&(y(JSON.stringify(J,null,2)),T(!1))},[w]),_.useEffect(()=>{if(!t)return;const H=V(t.mcp_servers||[]);R(JSON.stringify(H,null,2))},[t==null?void 0:t.mcp_servers]),_.useEffect(()=>{if(x==="mcp"&&j.length>0){const H=j.filter(ae=>!z[ae.name]||z[ae.name]==="unknown");H.length>0&&H.forEach(ae=>{me(ae.name)})}},[x,j.length]);function V(H){const ae={};for(const he of H){const ye={};he.connection_type==="stdio"?(ye.command=he.command||"",ye.args=he.args||[],Object.keys(he.env||{}).length>0&&(ye.env=he.env)):he.connection_type==="sse"&&(ye.url=he.url||"",Object.keys(he.headers||{}).length>0&&(ye.headers=he.headers)),he.timeout&&he.timeout!==30&&(ye.timeout=he.timeout),he.tool_filter&&(ye.tool_filter=he.tool_filter),he.tool_name_prefix&&(ye.tool_name_prefix=he.tool_name_prefix),ae[he.name]=ye}return{mcpServers:ae}}function A(H){const ae=[];for(const[he,ye]of Object.entries(H.mcpServers||{})){const G={name:he,description:ye.description||"",connection_type:ye.url?"sse":"stdio",command:ye.command,args:ye.args||[],env:ye.env||{},url:ye.url,headers:ye.headers||{},timeout:ye.timeout||30,tool_filter:ye.tool_filter||null,tool_name_prefix:ye.tool_name_prefix};ae.push(G)}return ae}function Y(H){H!==void 0&&R(H)}function ue(){try{const H=JSON.parse(O),ae=A(H);n({mcp_servers:ae})}catch(H){alert("Invalid JSON: "+H.message)}}async function me(H){const ae=j.find(he=>he.name===H);if(ae){M(he=>({...he,[H]:"testing"})),E(he=>({...he,[H]:""}));try{const he=await fu({connection_type:ae.connection_type,command:ae.command,args:ae.args,env:ae.env,url:ae.url,headers:ae.headers,timeout:ae.timeout});M(ye=>({...ye,[H]:he.success?"connected":"error"})),!he.success&&he.error&&E(ye=>({...ye,[H]:he.error||"Unknown error"}))}catch(he){M(ye=>({...ye,[H]:"error"})),E(ye=>({...ye,[H]:he.message}))}}}function q(H){const ae=u.find(ye=>ye.name===H);if(!ae)return;if(j.some(ye=>ye.name===H)){alert(`Server "${H}" is already configured`);return}const he={name:ae.name,description:ae.description||"",connection_type:ae.connection_type,command:ae.command,args:ae.args||[],env:ae.env||{},url:ae.url,headers:ae.headers||{},timeout:ae.timeout||30,tool_filter:ae.tool_filter||null,tool_name_prefix:ae.tool_name_prefix};n({mcp_servers:[...j,he]})}async function B(){for(const H of j)await me(H.name)}function K(){const H=H4();r({id:H,name:"new_tool",description:"",module_path:"tools.custom",code:J4,state_keys_used:[]}),v(H)}function ee(H,ae){ae.stopPropagation(),confirm("Delete this tool?")&&(s(H),a===H&&(e==null||e(null)))}function X(H){W&&(H.name!==void 0&&(H.name===""||q4(H.name)?L(null):L("Name can only contain letters, numbers, and underscores")),i(W.id,H))}function se(H){H!==void 0&&W&&(p(H),X({code:H}))}async function Q(){if(W){P(!0);try{const H=await Py(t.id,W.name,W.description,W.state_keys_used);H.success&&H.code?(p(H.code),X({code:H.code})):(console.error("Failed to generate tool code:",H.error),alert("Failed to generate tool code: "+(H.error||"Unknown error")))}catch(H){console.error("Error generating tool code:",H),alert("Error generating tool code: "+H.message)}finally{P(!1)}}}const Z=_.useRef(null),re=_.useCallback((H,ae)=>{if(Z.current&&typeof Z.current=="function")try{Z.current()}catch{}try{const he=Jv(ae,H,{language:"python",endpoint:"/api/code-completion",trigger:"onTyping"});typeof he=="function"?Z.current=he:Z.current=null}catch{Z.current=null}},[]);_.useEffect(()=>()=>{if(Z.current&&typeof Z.current=="function")try{Z.current()}catch{}},[]);function ve(H){H!==void 0&&(y(H),T(H!==JSON.stringify(J,null,2)))}function je(){if(J)try{const H=JSON.parse(m),ae=J.name,he=j.map(ye=>ye.name===ae?H:ye);n({mcp_servers:he}),g(H.name),T(!1)}catch(H){alert("Invalid JSON: "+H.message)}}async function ze(){D(!0),$(null);try{const H=JSON.parse(m),ae=await fu({connection_type:H.connection_type,command:H.command,args:H.args,env:H.env,url:H.url,headers:H.headers,timeout:H.timeout||30});if($(ae),ae.success&&ae.tools.length>0){const he={...H,tool_filter:ae.tools.map(ye=>ye.name)};y(JSON.stringify(he,null,2)),T(!0)}}catch(H){$({success:!1,tools:[],error:H.message})}finally{D(!1)}}const ke={};return t.custom_tools.forEach(H=>{const ae=H.module_path||"tools";ke[ae]||(ke[ae]=[]),ke[ae].push(H)}),o.jsxs("div",{className:"tools-panel",children:[o.jsx("style",{children:`
        .tools-panel {
          display: flex;
          gap: 20px;
          height: calc(100vh - 180px);
...
def my_callback(tool: BaseTool, tool_args: Dict[str, Any], tool_context: ToolContext, result: Dict) -> Optional[Dict]:
    ...
    return None
`;default:return Kv("before_agent")}}function Y4({onSelectCallback:e}){var C,D;const{project:t,updateProject:n,addCustomCallback:r,updateCustomCallback:i,removeCustomCallback:s}=ut(),[a,l]=_.useState(""),[c,u]=_.useState(null),[d,p]=_.useState(null),[f,h]=_.useState(!1),x=_.useRef(null);if(!t)return null;const b=t.custom_callbacks||[],w=b.find(N=>N.id===c);function g(N){u(N),e==null||e(N)}_.useEffect(()=>{w?(l(w.code),p(null)):l("")},[c,w]);function m(){const N=G4(),$="new_callback",I={id:N,name:$,description:"",module_path:`callbacks.${$}`,code:Kv("before_agent"),state_keys_used:[]};r(I),g(N)}function y(N,$){$.stopPropagation(),confirm("Delete this callback?")&&(s(N),c===N&&(e==null||e(null),u(null),l("")))}function k(){if(!c)return;const N=b.find(L=>L.id===c);if(!N)return;const $=N.name.trim();if(!$){alert("Please enter a name");return}if(!xm($)){p("Name must contain only alphanumeric characters and underscores");return}if(b.find(L=>L.name===$&&L.id!==N.id)){p("A callback with this name already exists");return}i(N.id,{code:a,name:$,description:N.description,module_path:`callbacks.${$}`,state_keys_used:N.state_keys_used}),p(null)}function T(N,$){x.current=$;try{Jv($,{endpoint:"/api/code-completion",language:"python"})}catch(I){console.warn("Failed to register Monacopilot completion:",I)}}async function S(){if(w){h(!0);try{let N="before_agent";const $=w.name.toLowerCase(),I=w.description.toLowerCase();$.includes("after_agent")||I.includes("after agent")?N="after_agent":$.includes("before_model")||I.includes("before model")?N="before_model":$.includes("after_model")||I.includes("after model")?N="after_model":$.includes("before_tool")||I.includes("before tool")?N="before_tool":$.includes("after_tool")||I.includes("after tool")?N="after_tool":($.includes("before_agent")||I.includes("before agent"))&&(N="before_agent");const L=await Ly(t.id,w.name,w.description,N,w.state_keys_used);L.success&&L.code?(l(L.code),i(w.id,{code:L.code})):(console.error("Failed to generate callback code:",L.error),alert("Failed to generate callback code: "+(L.error||"Unknown error")))}catch(N){console.error("Error generating callback code:",N),alert("Error generating callback code: "+N.message)}finally{h(!1)}}}const P=((D=(C=t.app)==null?void 0:C.state_keys)==null?void 0:D.map(N=>N.name))||[];return o.jsxs("div",{className:"tools-panel",children:[o.jsx("style",{children:`
        .tools-panel {
          display: flex;
          height: 100%;
          background: var(--bg-primary);
...
`),isError:t.isError===!0}:{text:typeof t=="string"?t:JSON.stringify(t,null,2),isError:!1}}function Vm(e,t){if(!t||!t.trim())return e;const n=t.trim();let r=e;try{r=JSON.parse(e)}catch{}if(n.startsWith("js:")){const i=n.slice(3).trim();try{const a=new Function("value","data",`return ${i}`)(e,r);return typeof a=="string"?a:JSON.stringify(a,null,2)}catch(s){return`[JS error: ${s}]`}}if(n.startsWith("."))try{const i=n.slice(1).split(".").filter(Boolean);let s=r;for(const a of i){const l=a.match(/^(\w+)?\[(\d+)\]$/);l?(l[1]&&(s=s[l[1]]),s=s[parseInt(l[2])]):s=s[a]}return s==null?"[No match]":typeof s=="string"?s:JSON.stringify(s,null,2)}catch(i){return`[Path error: ${i.message}]`}try{const s=new Function("value","data",`return ${n}`)(e,r);return typeof s=="string"?s:JSON.stringify(s,null,2)}catch(i){return`[Transform error: ${i.message}]`}}function y6({project:e,selectedEventIndex:t,sandboxMode:n}){var ue,me;const{watches:r,updateWatch:i,addWatch:s,removeWatch:a,runEvents:l}=ut(),[c,u]=_.useState(!1),[d,p]=_.useState(null),[f,h]=_.useState({}),[x,b]=_.useState(new Set),[w,g]=_.useState(""),[m,y]=_.useState(""),[k,T]=_.useState({}),[S,P]=_.useState(""),[C,D]=_.useState([]),[N,$]=_.useState(null),[I,L]=_.useState(null),[z,M]=_.useState(!1);_.useEffect(()=>{Rd().then(D).catch(console.error)},[]);const F=_.useMemo(()=>{const q=e.mcp_servers||[],B=new Set(q.map(ee=>ee.name)),K=C.filter(ee=>!B.has(ee.name));return[...q,...K]},[e.mcp_servers,C]),E=_.useCallback(async q=>{if(!(f[q]||x.has(q))){b(B=>new Set([...B,q]));try{const B=await Se(`/projects/${e.id}/mcp-servers/${encodeURIComponent(q)}/test-connection`,{method:"POST"});B.success&&h(K=>({...K,[q]:B.tools}))}catch(B){console.error("Failed to load tools:",B)}finally{b(B=>{const K=new Set(B);return K.delete(q),K})}}},[e.id,f,x]);_.useEffect(()=>{var ee;if(d)return;if(!w||!m){T({});return}const B=(f[w]||[]).find(X=>X.name===m);if(!((ee=B==null?void 0:B.parameters)!=null&&ee.properties)){T({});return}const K={};Object.entries(B.parameters.properties).forEach(([X,se])=>{se.type==="string"?K[X]=se.default||"":se.type==="number"||se.type==="integer"?K[X]=se.default||0:se.type==="boolean"?K[X]=se.default||!1:K[X]=se.default||null}),T(K)},[w,m,f,d]);const O=()=>{p(null),g(""),y(""),T({}),P(""),$(null),L(null),u(!0)},R=q=>{if(p(q.id),g(q.serverName),y(q.toolName),T({...q.args}),P(q.transform||""),q.result){const{text:B}=hc(q.result);$(B),L(null)}else $(null),L(null);f[q.serverName]||E(q.serverName),u(!0)},j=async()=>{var B;if(!w||!m)return;M(!0),L(null);const q=((B=e.app)==null?void 0:B.id)||`app_${e.id}`;try{const K=await Se(`/projects/${e.id}/run-mcp-tool`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({server_name:w,tool_name:m,arguments:k,sandbox_mode:n,app_id:n?q:void 0})}),{text:ee,isError:X}=hc(K);X?(L(ee),$(null)):($(ee),L(null))}catch(K){L(String(K)),$(null)}finally{M(!1)}},W=_.useMemo(()=>N?!S||!S.trim()?N:Vm(N,S):null,[N,S]),J=()=>{if(!(!w||!m)){if(d){i(d,{serverName:w,toolName:m,args:{...k},transform:S||void 0});const q=r.find(B=>B.id===d);q&&V({...q,serverName:w,toolName:m,args:k,transform:S||void 0,history:q.history||[]})}else{const q={id:`watch-${Date.now()}`,serverName:w,toolName:m,args:{...k},transform:S||void 0,history:[]};s(q),V(q)}u(!1)}},v=q=>{a(q)},V=_.useCallback(async(q,B)=>{var se;i(q.id,{isLoading:!0,error:void 0});const K=B??l.length-1,ee=Date.now(),X=((se=e.app)==null?void 0:se.id)||`app_${e.id}`;try{const Q=await Se(`/projects/${e.id}/run-mcp-tool`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({server_name:q.serverName,tool_name:q.toolName,arguments:q.args,sandbox_mode:n,app_id:n?X:void 0})}),Z={eventIndex:K,timestamp:ee,result:Q},re=[...q.history||[],Z];i(q.id,{result:Q,isLoading:!1,lastRun:ee,history:re})}catch(Q){const Z={eventIndex:K,timestamp:ee,error:String(Q)},re=[...q.history||[],Z];i(q.id,{error:String(Q),isLoading:!1,lastRun:ee,history:re})}},[e.id,(ue=e.app)==null?void 0:ue.id,i,l.length,n]),A=()=>{r.forEach(q=>V(q))},Y=_.useMemo(()=>!w||!m?null:(f[w]||[]).find(B=>B.name===m),[w,m,f]);return o.jsxs("div",{className:"tool-watch-panel",children:[o.jsxs("div",{className:"watch-header",children:[o.jsx(ki,{size:14}),o.jsx("span",{children:"Tool Watch"}),o.jsx("span",{className:"watch-auto-badge",title:"Watches auto-refresh on every event",children:"⚡ Auto"}),o.jsxs("div",{className:"watch-actions",children:[o.jsx("button",{className:"watch-btn",onClick:A,title:"Refresh all",children:o.jsx(on,{size:12})}),o.jsx("button",{className:"watch-btn",onClick:O,title:"Add watch",children:o.jsx(Ke,{size:12})})]})]}),r.length===0?o.jsxs("div",{className:"watch-empty",children:[o.jsx(ki,{size:20,style:{opacity:.3}}),o.jsx("span",{children:"No watch expressions"}),o.jsxs("button",{className:"add-watch-btn",onClick:O,children:[o.jsx(Ke,{size:12})," Add Tool Watch"]})]}):o.jsx("div",{className:"watch-list",children:r.map(q=>{let B=q.result,K=q.error;if(t!==null&&q.history&&q.history.length>0){const Z=q.history.filter(re=>re.eventIndex<=t);if(Z.length>0){const re=Z[Z.length-1];B=re.result,K=re.error}else B=void 0,K=void 0}const{text:ee,isError:X}=B?hc(B):{text:"",isError:!1},se=B?Vm(ee,q.transform):"",Q=K||X;return o.jsxs("div",{className:`watch-item ${Q?"error":""}`,children:[o.jsxs("div",{className:"watch-item-header",children:[o.jsxs("span",{className:"watch-expr",children:[o.jsx("span",{className:"watch-server",children:q.serverName}),o.jsx("span",{className:"watch-tool",children:q.toolName}),Object.keys(q.args).length>0&&o.jsxs("span",{className:"watch-args",children:["(",Object.entries(q.args).map(([Z,re])=>`${Z}=${JSON.stringify(re)}`).join(", "),")"]}),t!==null&&o.jsxs("span",{className:"watch-time-indicator",children:["@",t]})]}),o.jsxs("div",{className:"watch-item-actions",children:[o.jsx("button",{onClick:()=>R(q),title:"Edit watch",children:o.jsx(ln,{size:10})}),o.jsx("button",{onClick:()=>V(q),title:"Refresh",children:q.isLoading?o.jsx(on,{size:10,className:"spin"}):o.jsx(on,{size:10})}),o.jsx("button",{onClick:()=>v(q.id),title:"Remove",children:o.jsx(Fe,{size:10})})]})]}),o.jsx("div",{className:"watch-result",children:q.isLoading?o.jsx("span",{className:"loading",children:"Loading..."}):K?o.jsx("span",{className:"error",children:K}):B?o.jsx("pre",{className:X?"error-text":"",children:se}):o.jsx("span",{className:"no-result",children:t!==null?"No data at this event":"Not yet run"})})]},q.id)})}),c&&o.jsx("div",{className:"watch-dialog-overlay",onClick:()=>u(!1),children:o.jsxs("div",{className:"watch-dialog",onClick:q=>q.stopPropagation(),children:[o.jsxs("div",{className:"dialog-header",children:[o.jsx("span",{children:d?"Edit Watch":"Add Tool Watch"}),o.jsx("button",{onClick:()=>u(!1),children:o.jsx(es,{size:14})})]}),o.jsxs("div",{className:"dialog-body",children:[o.jsxs("div",{className:"form-row",children:[o.jsx("label",{children:"MCP Server"}),o.jsxs("select",{value:w,onChange:q=>{g(q.target.value),d||y(""),q.target.value&&E(q.target.value)},children:[o.jsx("option",{value:"",children:"Select server..."}),F.map(q=>o.jsx("option",{value:q.name,children:q.name},q.name))]})]}),o.jsxs("div",{className:"form-row",children:[o.jsx("label",{children:"Tool"}),o.jsxs("select",{value:m,onChange:q=>y(q.target.value),disabled:!w||x.has(w),children:[o.jsx("option",{value:"",children:x.has(w)?"Loading tools...":"Select tool..."}),(f[w]||[]).map(q=>o.jsx("option",{value:q.name,children:q.name},q.name))]})]}),(Y==null?void 0:Y.description)&&o.jsx("div",{className:"tool-desc",children:Y.description}),((me=Y==null?void 0:Y.parameters)==null?void 0:me.properties)&&Object.keys(Y.parameters.properties).length>0&&o.jsxs("div",{className:"tool-args",children:[o.jsx("label",{children:"Arguments"}),Object.entries(Y.parameters.properties).map(([q,B])=>{var K,ee;return o.jsxs("div",{className:"arg-row",children:[o.jsxs("span",{className:"arg-name",children:[q,((K=Y.parameters.required)==null?void 0:K.includes(q))&&o.jsx("span",{className:"required",children:"*"})]}),o.jsx("input",{type:B.type==="number"||B.type==="integer"?"number":"text",value:typeof k[q]=="object"?JSON.stringify(k[q]):k[q]??"",onChange:X=>T(se=>({...se,[q]:X.target.value})),placeholder:((ee=B.description)==null?void 0:ee.slice(0,40))||q})]},q)})]}),w&&m&&o.jsxs("div",{className:"test-section",children:[o.jsxs("div",{className:"test-header",children:[o.jsx("label",{children:"Test & Preview"}),o.jsxs("button",{className:"test-btn",onClick:j,disabled:z,children:[z?o.jsx(on,{size:12,className:"spin"}):o.jsx(pr,{size:12}),z?"Running...":"Test Run"]})]}),I&&o.jsxs("div",{className:"test-result error",children:[o.jsx("span",{className:"test-label",children:"Error:"}),o.jsx("pre",{children:I})]}),N&&o.jsxs("div",{className:"test-result",children:[o.jsx("span",{className:"test-label",children:"Raw Result:"}),o.jsx("pre",{children:N})]})]}),o.jsxs("div",{className:"form-row transform-row",children:[o.jsx("label",{children:"Transform (optional)"}),o.jsx("input",{type:"text",value:S,onChange:q=>P(q.target.value),placeholder:"e.g., .items[0].name or .content[].text"}),o.jsxs("div",{className:"transform-hints",children:[o.jsx("span",{className:"hint-title",children:"Path:"}),o.jsx("code",{onClick:()=>P(".items[0].name"),children:".items[0].name"}),o.jsx("code",{onClick:()=>P(".content[0].text"),children:".content[0].text"}),o.jsx("code",{onClick:()=>P(".result.data"),children:".result.data"}),o.jsx("span",{className:"hint-title",children:"JS:"}),o.jsx("code",{onClick:()=>P("js:value.split('\\n')[0]"),children:"js:value.split('\\n')[0]"}),o.jsx("code",{onClick:()=>P("js:data.items?.length"),children:"js:data.items?.length"})]})]}),N&&S&&o.jsxs("div",{className:"transform-preview",children:[o.jsx("span",{className:"test-label",children:"Transform Preview:"}),o.jsx("pre",{className:W!=null&&W.startsWith("[Transform error")?"error":"",children:W})]})]}),o.jsxs("div",{className:"dialog-footer",children:[o.jsx("button",{className:"cancel-btn",onClick:()=>u(!1),children:"Cancel"}),o.jsx("button",{className:"add-btn",onClick:J,disabled:!w||!m,children:d?"Save Changes":"Add Watch"})]})]})})]})}function v6(){var jp,_p;const{project:e,updateProject:t,isRunning:n,setIsRunning:r,runEvents:i,addRunEvent:s,clearRunEvents:a,clearWatchHistories:l,runAgentId:c,setRunAgentId:u,watches:d,updateWatch:p,currentSessionId:f,setCurrentSessionId:h}=ut(),[x,b]=_.useState(""),[w,g]=_.useState(null),[m,y]=_.useState(null),[k,T]=_.useState(null),[S,P]=_.useState(""),[C,D]=_.useState(new Set(["agent_start","agent_end","tool_call","tool_result","model_call","model_response","state_change","callback_start","callback_end","callback_error"])),[N,$]=_.useState(()=>{const U=localStorage.getItem("sandboxMode");return U!==null?U==="true":!0});_.useEffect(()=>{localStorage.setItem("sandboxMode",String(N))},[N]);const[I,L]=_.useState(null),[z,M]=_.useState(!1),[F,E]=_.useState({}),[O,R]=_.useState(!1),[j,W]=_.useState("agent"),J=_.useRef(null),[v,V]=_.useState(!0),[A,Y]=_.useState(!0),[ue,me]=_.useState(!1),[q,B]=_.useState(360),[K,ee]=_.useState(!1),[X,se]=_.useState(!1),[Q,Z]=_.useState([]),re=_.useRef(null);_.useEffect(()=>{const U=localStorage.getItem("promptHistory");if(U)try{const oe=JSON.parse(U),pe=Object.entries(oe).map(([ge,ce])=>({prompt:ge,count:ce})).sort((ge,ce)=>ce.count-ge.count);Z(pe)}catch(oe){console.error("Failed to parse prompt history:",oe)}},[]);const ve=_.useCallback(U=>{const oe=U.trim();if(!oe)return;const pe=localStorage.getItem("promptHistory"),ge=pe?JSON.parse(pe):{};ge[oe]=(ge[oe]||0)+1,localStorage.setItem("promptHistory",JSON.stringify(ge));const ce=Object.entries(ge).map(([Te,Pe])=>({prompt:Te,count:Pe})).sort((Te,Pe)=>Pe.count-Te.count);Z(ce)},[]),je=_.useMemo(()=>{const U=x.toLowerCase().trim();return Q.filter(oe=>!U||oe.prompt.toLowerCase().includes(U)).slice(0,10)},[Q,x]),[ze,ke]=_.useState([60,80,100,80,1]),[H,ae]=_.useState(null),he=_.useRef(0),ye=_.useRef(0),[G,te]=_.useState([]),[xe,le]=_.useState(null),[_e,Ze]=_.useState(!1),dn=_.useRef(0),Ut=_.useCallback(async(U,oe)=>{var Te;if(!e)return;p(U.id,{isLoading:!0,error:void 0});const pe=oe??i.length-1,ge=Date.now(),ce=((Te=e.app)==null?void 0:Te.id)||`app_${e.id}`;try{const Pe=await Se(`/projects/${e.id}/run-mcp-tool`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({server_name:U.serverName,tool_name:U.toolName,arguments:U.args,sandbox_mode:N,app_id:N?ce:void 0})}),Cn={eventIndex:pe,timestamp:ge,result:Pe},fn=[...U.history||[],Cn];p(U.id,{result:Pe,isLoading:!1,lastRun:ge,history:fn})}catch(Pe){const Cn={eventIndex:pe,timestamp:ge,error:String(Pe)},fn=[...U.history||[],Cn];p(U.id,{error:String(Pe),isLoading:!1,lastRun:ge,history:fn})}},[e==null?void 0:e.id,(jp=e==null?void 0:e.app)==null?void 0:jp.id,p,i.length,N]);_.useEffect(()=>{if(i.length>dn.current&&d.length>0){const U=i.length-1;d.forEach(oe=>{oe.isLoading||Ut(oe,U)})}dn.current=i.length},[i.length,d,Ut]),_.useEffect(()=>{c!==null&&(Un(c),u(null))},[c,u]);const[Xt,Un]=_.useState(null),et=_.useRef(null),pn=_.useRef(null);_.useEffect(()=>{if(!K)return;const U=pe=>{if(!pn.current)return;const ce=pn.current.getBoundingClientRect().right-pe.clientX;B(Math.min(600,Math.max(200,ce)))},oe=()=>{ee(!1)};return document.addEventListener("mousemove",U),document.addEventListener("mouseup",oe),()=>{document.removeEventListener("mousemove",U),document.removeEventListener("mouseup",oe)}},[K]),_.useEffect(()=>{if(H===null)return;const U=pe=>{const ge=pe.clientX-he.current,ce=Math.max(40,ye.current+ge);ke(Te=>{const Pe=[...Te];return Pe[H]=ce,Pe})},oe=()=>{ae(null)};return document.addEventListener("mousemove",U),document.addEventListener("mouseup",oe),document.body.style.cursor="col-resize",document.body.style.userSelect="none",()=>{document.removeEventListener("mousemove",U),document.removeEventListener("mouseup",oe),document.body.style.cursor="",document.body.style.userSelect=""}},[H]);const yt=(U,oe)=>{oe.preventDefault(),he.current=oe.clientX,ye.current=ze[U],ae(U)},yp=ze.map((U,oe)=>oe===ze.length-1?`minmax(${U}px, 1fr)`:`${U}px`).join(" "),j1=_.useMemo(()=>i.length===0?{min:0,max:0}:{min:i[0].timestamp,max:i[i.length-1].timestamp},[i]),zt=_.useMemo(()=>i.filter((U,oe)=>{var pe,ge,ce;if(k&&(U.timestamp<k[0]||U.timestamp>k[1])||C.size>0&&!C.has(U.event_type))return!1;if(v&&U.event_type==="model_response"){const Te=((ge=(pe=U.data)==null?void 0:pe.response_content)==null?void 0:ge.parts)||((ce=U.data)==null?void 0:ce.parts)||[],Pe=Te.some(fn=>fn.type==="function_call"),Cn=Te.some(fn=>fn.type==="text");if(!Pe&&!Cn)return!1}return!(S&&!JSON.stringify(U).toLowerCase().includes(S.toLowerCase()))}),[i,k,C,S,v]),as=_.useMemo(()=>{var ge;let U=0,oe=0;const pe=m!==null?m+1:i.length;for(let ce=0;ce<pe;ce++){const Te=i[ce];Te.event_type==="model_response"&&((ge=Te.data)!=null&&ge.token_counts)&&(U+=Te.data.token_counts.input||0,oe+=Te.data.token_counts.output||0)}return{input:U,output:oe,total:U+oe}},[i,m]),vp=m!==null?i[m]:null;_.useEffect(()=>{if(!e){te([]);return}(async()=>{Ze(!0);try{const oe=await pu(e.id);te(oe)}catch(oe){console.error("Failed to load sessions:",oe),te([])}finally{Ze(!1)}})()},[e]);const ml=_.useCallback(async U=>{if(!e){le(null);return}if(!U){a(),l(),h(null),le(null),y(null),T(null);return}try{const oe=await Cy(e.id,U);a(),l(),h(oe.id),le(U),y(null),T(null);for(const pe of oe.events)s(pe)}catch(oe){alert(`Failed to load session: ${oe.message||"Unknown error"}`)}},[e,a,l,h,s]);_.useEffect(()=>{if(!e||G.length===0||_e)return;const oe=new URLSearchParams(window.location.search).get("session");if(oe)if(G.some(ge=>ge.id===oe)){ml(oe);const ge=window.location.pathname;window.history.replaceState({},"",ge)}else console.warn(`Session ${oe} not found in available sessions`)},[e,G,_e,ml]),_.useEffect(()=>{n&&et.current&&(et.current.scrollTop=et.current.scrollHeight)},[i.length,n]);const Pi=_.useCallback(U=>{const oe=U??x;if(!e||!oe.trim()||n)return;ve(oe),se(!1),b(oe),w&&(w.close(),g(null)),f||(a(),l(),le(null)),r(!0),y(null),T(null);const pe=Ty(e.id);g(pe),pe.onopen=()=>{pe.send(JSON.stringify({message:oe,agent_id:Xt||void 0,session_id:f||void 0,sandbox_mode:N}))},pe.onmessage=ge=>{var Te;const ce=JSON.parse(ge.data);if(ce.event_type==="agent_start"&&((Te=ce.data)!=null&&Te.session_id)){const Pe=ce.data.session_id;ce.data.session_reused,h(Pe),Pe&&G.some(Cn=>Cn.id===Pe)&&le(Pe)}else if(ce.type==="session_started")h(ce.session_id),ce.session_id&&G.some(Pe=>Pe.id===ce.session_id)&&le(ce.session_id);else if(ce.type==="sandbox_starting")s({timestamp:Date.now()/1e3,event_type:"agent_start",agent_name:"sandbox",data:{message:"Starting Docker sandbox..."}});else if(ce.type==="sandbox_started")s({timestamp:Date.now()/1e3,event_type:"agent_start",agent_name:"sandbox",data:{message:`Sandbox started (ID: ${ce.sandbox_id})`}});else if(ce.type==="sandbox_response")s({timestamp:Date.now()/1e3,event_type:"model_response",agent_name:"sandbox",data:ce.data});else if(ce.event_type==="approval_required"||ce.type==="network_request"&&ce.event_type==="approval_required"){const Pe={id:ce.id,method:ce.method||"GET",url:ce.url,host:ce.host,source:ce.source||"agent",headers:ce.headers||{},timeout:ce.timeout||30};L(Pe),s({timestamp:Date.now()/1e3,event_type:"callback_start",agent_name:"sandbox",data:{callback_name:"network_approval",callback_type:"approval",message:`⚠️ Network request to ${ce.host} requires approval`,host:ce.host,url:ce.url}})}else ce.type==="completed"?(r(!1),pe.close()):ce.type==="error"?(r(!1),s({timestamp:Date.now()/1e3,event_type:"agent_end",agent_name:"system",data:{error:ce.error}})):s(ce)},pe.onerror=()=>{r(!1),s({timestamp:Date.now()/1e3,event_type:"agent_end",agent_name:"system",data:{error:"WebSocket connection error"}})},pe.onclose=()=>{r(!1)}},[e,x,n,w,a,r,s,Xt,f,N,ve]),_1=_.useCallback(()=>{w==null||w.close(),r(!1)},[w,r]),S1=_.useCallback(async(U,oe,pe)=>{var fn,Sp,Cp,Np,Ep,zp,Tp,Ap,Pp,Lp,Mp,Rp,Ip,Op,$p,Dp,Fp,Bp,Up,Vp,Wp,Hp,qp,Jp;if(!I||!e)return;const ge=((fn=e.app)==null?void 0:fn.id)||e.id,ce=U?"allow_pattern":"allow_once",Te=U||I.host,Pe=oe||"exact",Cn=pe?`/sandbox/${ge}/approval?project_id=${e.id}`:`/sandbox/${ge}/approval`;try{if(await Se(Cn,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({request_id:I.id,action:ce,pattern:Te,pattern_type:Pe,persist:pe||!1})}),pe&&ce==="allow_pattern"){const xl=((Np=(Cp=(Sp=e.app)==null?void 0:Sp.sandbox)==null?void 0:Cp.allowlist)==null?void 0:Np.user)||[],O1={id:`pattern_${Date.now().toString(36)}`,pattern:Te,pattern_type:Pe,source:"approved",added_at:new Date().toISOString()};t({app:{...e.app,sandbox:{...(Ep=e.app)==null?void 0:Ep.sandbox,enabled:((Tp=(zp=e.app)==null?void 0:zp.sandbox)==null?void 0:Tp.enabled)??!1,allowlist:{auto:((Lp=(Pp=(Ap=e.app)==null?void 0:Ap.sandbox)==null?void 0:Pp.allowlist)==null?void 0:Lp.auto)||[],user:[...xl,O1]},unknown_action:((Rp=(Mp=e.app)==null?void 0:Mp.sandbox)==null?void 0:Rp.unknown_action)??"ask",approval_timeout:((Op=(Ip=e.app)==null?void 0:Ip.sandbox)==null?void 0:Op.approval_timeout)??30,agent_memory_limit_mb:((Dp=($p=e.app)==null?void 0:$p.sandbox)==null?void 0:Dp.agent_memory_limit_mb)??512,agent_cpu_limit:((Bp=(Fp=e.app)==null?void 0:Fp.sandbox)==null?void 0:Bp.agent_cpu_limit)??1,mcp_memory_limit_mb:((Vp=(Up=e.app)==null?void 0:Up.sandbox)==null?void 0:Vp.mcp_memory_limit_mb)??256,mcp_cpu_limit:((Hp=(Wp=e.app)==null?void 0:Wp.sandbox)==null?void 0:Hp.mcp_cpu_limit)??.5,run_timeout:((Jp=(qp=e.app)==null?void 0:qp.sandbox)==null?void 0:Jp.run_timeout)??300}}})}s({timestamp:Date.now()/1e3,event_type:"callback_end",agent_name:"sandbox",data:{callback_name:"network_approval",callback_type:"approval",message:`✅ Approved: ${Te}`,pattern:Te,action:ce}})}catch(xl){console.error("Failed to approve:",xl)}L(null)},[I,e,s,t]),C1=_.useCallback(async()=>{var oe;if(!I||!e)return;const U=((oe=e.app)==null?void 0:oe.id)||e.id;try{await Se(`/sandbox/${U}/approval`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({request_id:I.id,action:"deny"})}),s({timestamp:Date.now()/1e3,event_type:"callback_end",agent_name:"sandbox",data:{callback_name:"network_approval",callback_type:"approval",message:`❌ Denied: ${I.host}`,host:I.host,action:"deny"}})}catch(pe){console.error("Failed to deny:",pe)}L(null)},[I,e,s]),Li=_.useCallback(async(U=!0)=>{var pe;if(!e)return;const oe=((pe=e.app)==null?void 0:pe.id)||`app_${e.id}`;U&&R(!0);try{const[ge,ce]=await Promise.all([Se(`/sandbox/${oe}/logs?container=agent&tail=500`).catch(()=>null),Se(`/sandbox/${oe}/logs?container=gateway&tail=500`).catch(()=>null)]);E({agent:(ge==null?void 0:ge.logs)||(ge==null?void 0:ge.error)||"No logs available",gateway:(ce==null?void 0:ce.logs)||(ce==null?void 0:ce.error)||"No logs available"})}catch(ge){console.error("Failed to fetch logs:",ge),E({agent:`Error fetching logs: ${ge}`,gateway:`Error fetching logs: ${ge}`})}finally{U&&R(!1)}},[e]),N1=_.useCallback(()=>{M(!0),Li()},[Li]);_.useEffect(()=>{z&&J.current&&!O&&setTimeout(()=>{J.current&&(J.current.scrollTop=J.current.scrollHeight)},50)},[z,j,F,O]),_.useEffect(()=>{if(!z)return;const U=setInterval(()=>{Li(!1)},3e3);return()=>clearInterval(U)},[z,Li]),_.useEffect(()=>{const U=oe=>{if((oe.metaKey||oe.ctrlKey)&&oe.key==="Enter"){oe.preventDefault(),Pi();return}if(oe.key==="ArrowDown"||oe.key==="ArrowUp"){if(oe.target instanceof HTMLInputElement||oe.target instanceof HTMLTextAreaElement||(oe.preventDefault(),zt.length===0))return;if(oe.key==="ArrowDown")if(m===null){const pe=i.indexOf(zt[0]);y(pe)}else{const pe=zt.findIndex(ge=>i.indexOf(ge)===m);if(pe<zt.length-1){const ge=i.indexOf(zt[pe+1]);y(ge)}}else if(oe.key==="ArrowUp")if(m===null){const pe=i.indexOf(zt[zt.length-1]);y(pe)}else{const pe=zt.findIndex(ge=>i.indexOf(ge)===m);if(pe>0){const ge=i.indexOf(zt[pe-1]);y(ge)}}}};return window.addEventListener("keydown",U),()=>window.removeEventListener("keydown",U)},[Pi,zt,m,i]);const E1=_.useCallback(()=>{var ce;if(i.length===0)return;const U={version:1,exportedAt:new Date().toISOString(),projectId:e==null?void 0:e.id,projectName:e==null?void 0:e.name,agentId:Xt||((ce=e==null?void 0:e.app)==null?void 0:ce.root_agent_id),events:i},oe=new Blob([JSON.stringify(U,null,2)],{type:"application/json"}),pe=URL.createObjectURL(oe),ge=document.createElement("a");ge.href=pe,ge.download=`run-${(e==null?void 0:e.name)||"export"}-${new Date().toISOString().slice(0,19).replace(/:/g,"-")}.json`,document.body.appendChild(ge),ge.click(),document.body.removeChild(ge),URL.revokeObjectURL(pe)},[i,e,Xt]),z1=_.useCallback(async()=>{if(!f||!e){alert("No active session to save");return}try{const U=await Sy(f);if(U.success){alert(U.message||"Session saved to memory successfully");try{const oe=await pu(e.id);te(oe)}catch{}}else alert(`Failed to save to memory: ${U.error||"Unknown error"}`)}catch(U){alert(`Error saving to memory: ${U.message||"Unknown error"}`)}},[f,e]),[T1,ls]=_.useState(!1),[A1,P1]=_.useState([]),[Mi,bp]=_.useState(""),[gl,L1]=_.useState("Test Case from Session"),[wp,kp]=_.useState(!1),M1=_.useCallback(async()=>{if(!f||!e){alert("No active session to create test case from");return}try{const U=await Se(`/projects/${e.id}/eval-sets`);if(P1(U.eval_sets||[]),!U.eval_sets||U.eval_sets.length===0){confirm(`No evaluation sets found. Would you like to create one first?

Go to the Evals tab to create an evaluation set.`)&&(window.location.href=`/project/${e.id}/evals`);return}bp(U.eval_sets[0].id),ls(!0)}catch(U){alert(`Error loading eval sets: ${U.message||"Unknown error"}`)}},[f,e]),R1=_.useCallback(async()=>{if(!f||!e||!Mi){alert("Please select an evaluation set");return}kp(!0);try{const U=await Se(`/projects/${e.id}/session-to-eval-case`,{method:"POST",body:JSON.stringify({session_id:f,eval_set_id:Mi,case_name:gl})});ls(!1),alert(`Test case "${U.eval_case.name}" created successfully!

Token count: ${U.session_token_count.toLocaleString()} tokens

Go to the Evals tab to view and edit the test case.`)}catch(U){alert(`Error creating test case: ${U.message||"Unknown error"}`)}finally{kp(!1)}},[f,e,Mi,gl]),I1=_.useCallback(()=>{const U=document.createElement("input");U.type="file",U.accept=".json",U.onchange=async oe=>{var ge;const pe=(ge=oe.target.files)==null?void 0:ge[0];if(pe)try{const ce=await pe.text(),Te=JSON.parse(ce);if(!Te.events||!Array.isArray(Te.events)){alert("Invalid run file: missing events array");return}a(),l(),y(null),T(null),Te.events.forEach(Pe=>{s(Pe)})}catch(ce){alert(`Failed to load run file: ${ce}`)}},U.click()},[a,l,s]);return _.useEffect(()=>{if(m!==null){const U=document.querySelector(".event-row.selected");U==null||U.scrollIntoView({behavior:"smooth",block:"nearest"})}},[m]),e?o.jsxs("div",{className:`run-panel ${K?"resizing":""}`,children:[o.jsx("style",{children:`
        .run-panel {
          display: flex;
          flex-direction: column;
          width: 100%;
      ...
      `}),o.jsxs("div",{className:"skillset-list",children:[o.jsxs("div",{className:"skillset-list-header",children:[o.jsx("h3",{children:"SkillSets"}),o.jsx("button",{className:"btn-icon",onClick:I,title:"Add SkillSet",children:o.jsx(Ke,{size:16})})]}),P.length===0?o.jsxs("div",{className:"empty-state",style:{padding:"40px 0"},children:[o.jsx(Rn,{size:32}),o.jsx("span",{children:"No SkillSets"}),o.jsxs("button",{className:"btn-primary",onClick:I,children:[o.jsx(Ke,{size:14})," Create SkillSet"]})]}):P.map(R=>o.jsxs("div",{className:`skillset-item ${n===R.id?"selected":""}`,onClick:()=>r(R.id),children:[o.jsx(Rn,{size:16,style:{color:"var(--accent)",flexShrink:0}}),o.jsxs("div",{className:"skillset-item-info",children:[o.jsx("div",{className:"skillset-item-name",children:R.name}),o.jsxs("div",{className:"skillset-item-count",children:[R.entry_count||0," entries"]})]}),o.jsx("button",{className:"skillset-item-delete",onClick:j=>{j.stopPropagation(),L(R.id)},children:o.jsx(Fe,{size:14})})]},R.id))]}),C?o.jsxs("div",{className:"skillset-detail",children:[o.jsxs("div",{className:"skillset-header",children:[o.jsxs("div",{className:"skillset-header-info",children:[o.jsx("input",{className:"skillset-name-input",value:C.name,onChange:R=>$(C.id,{name:R.target.value}),placeholder:"SkillSet Name"}),o.jsx("textarea",{className:"skillset-desc-input",value:C.description,onChange:R=>$(C.id,{description:R.target.value}),placeholder:"Description (optional)",rows:1}),o.jsxs("div",{className:"skillset-model",children:[o.jsx("label",{style:{fontSize:"12px",color:"var(--text-secondary)",marginRight:"8px"},children:"Embedding Model:"}),o.jsxs("select",{style:{flex:1,padding:"4px 8px",fontSize:"12px",background:"var(--bg-secondary)",border:"1px solid var(--border)",borderRadius:"4px",color:"var(--text-primary)"},value:C.embedding_model||"text-embedding-004",onChange:R=>$(C.id,{embedding_model:R.target.value}),children:[o.jsxs("optgroup",{label:"Google Gemini",children:[o.jsx("option",{value:"text-embedding-004",children:"text-embedding-004 (768d)"}),o.jsx("option",{value:"text-embedding-005",children:"text-embedding-005"})]}),o.jsxs("optgroup",{label:"OpenAI",children:[o.jsx("option",{value:"text-embedding-3-small",children:"text-embedding-3-small (1536d)"}),o.jsx("option",{value:"text-embedding-3-large",children:"text-embedding-3-large (3072d)"})]}),o.jsxs("optgroup",{label:"Cohere",children:[o.jsx("option",{value:"embed-english-v3.0",children:"embed-english-v3.0 (1024d)"}),o.jsx("option",{value:"embed-multilingual-v3.0",children:"embed-multilingual-v3.0 (1024d)"})]})]})]}),o.jsxs("div",{className:"skillset-stats",children:[o.jsxs("span",{className:"skillset-stat",children:[o.jsx("strong",{children:(i==null?void 0:i.entry_count)||0})," entries"]}),o.jsxs("span",{className:"skillset-stat",children:[o.jsx("strong",{children:Object.keys((i==null?void 0:i.sources)||{}).length})," sources"]}),k===!1&&o.jsx("span",{className:"skillset-stat",style:{color:"var(--warning)"},children:"⚠ No embeddings"})]})]}),o.jsx("button",{className:"btn-icon",onClick:D,title:"Refresh",children:o.jsx(on,{size:16})})]}),m&&o.jsxs("div",{className:"error-banner",children:[m,o.jsx("button",{onClick:()=>y(null),children:o.jsx(es,{size:14})})]}),o.jsxs("div",{className:"search-section",children:[o.jsx("div",{className:"search-input-wrapper",children:o.jsx("input",{className:"search-input",value:a,onChange:R=>l(R.target.value),onKeyDown:R=>R.key==="Enter"&&z(),placeholder:"Search this SkillSet..."})}),o.jsxs("button",{className:"btn-primary",onClick:z,disabled:d||!a.trim(),children:[o.jsx(Hy,{size:14}),d?"Searching...":"Search"]})]}),o.jsxs("div",{className:"search-results",children:[c.length===0&&!d&&a&&o.jsx("div",{className:"empty-state",children:o.jsx("span",{children:"No results found"})}),c.map(R=>o.jsxs("div",{className:"search-result",style:{background:O(R.score)},children:[o.jsxs("span",{className:"search-result-score",children:[(R.score*100).toFixed(0),"%"]}),o.jsx("div",{className:"search-result-text",children:R.text}),o.jsx("div",{className:"search-result-source",children:R.source_name})]},R.id))]}),o.jsxs("div",{className:"add-sources-section",children:[o.jsxs("div",{className:"add-sources-header",onClick:()=>h(!f),children:[f?o.jsx(Pt,{size:16}):o.jsx(bt,{size:16}),o.jsx("h4",{children:"Add Sources"})]}),f&&o.jsxs("div",{className:"add-sources-content",children:[o.jsxs("div",{className:"source-row",children:[o.jsx($d,{size:16,style:{color:"var(--text-tertiary)"}}),o.jsx("input",{className:"source-input",value:x,onChange:R=>b(R.target.value),onKeyDown:R=>R.key==="Enter"&&M(),placeholder:"Enter URL (e.g., llms.txt file)"}),o.jsxs("button",{className:"btn-primary",onClick:M,disabled:w||!x.trim(),children:[o.jsx(Hk,{size:14}),w?"Loading...":"Add"]})]}),o.jsxs("div",{className:"source-row",children:[o.jsx(Uk,{size:16,style:{color:"var(--text-tertiary)"}}),o.jsx("input",{ref:S,type:"file",accept:".txt,.md,.json,.csv,.html",onChange:F}),o.jsxs("button",{className:"btn-primary",onClick:()=>{var R;return(R=S.current)==null?void 0:R.click()},children:[o.jsx(ol,{size:14}),"Upload File"]}),o.jsx("span",{style:{fontSize:"12px",color:"var(--text-tertiary)"},children:".txt, .md, .json, .csv"})]}),((i==null?void 0:i.entry_count)||0)>0&&o.jsx("div",{className:"source-row",style:{marginTop:"8px"},children:o.jsxs("button",{className:"clear-button",onClick:E,children:[o.jsx(Fe,{size:12}),"Clear All Entries (",(i==null?void 0:i.entry_count)||0,")"]})})]})]})]}):P.length>0?o.jsx("div",{className:"skillset-detail",children:o.jsxs("div",{className:"empty-state",children:[o.jsx(Rn,{size:48}),o.jsx("span",{children:"Select a SkillSet"})]})}):null]}):null}const vn={tool_trajectory_avg_score:{name:"Tool Trajectory",description:"Did the agent call the right tools in the expected order?",requiresJudge:!1,scale:[0,1]},response_match_score:{name:"Response Match (ROUGE-1)",description:"Does the response contain expected text? (fuzzy word matching)",requiresJudge:!1,scale:[0,1]},response_evaluation_score:{name:"Response Evaluation (LLM)",description:"LLM-judged semantic match of final response",requiresJudge:!0,scale:[1,5]},final_response_match_v2:{name:"Response Quality v2 (LLM)",description:"Enhanced LLM-judged response quality check",requiresJudge:!0,scale:[0,1]},safety_v1:{name:"Safety",description:"Is the response safe and harmless? (Vertex AI)",requiresJudge:!0,scale:[0,1]},hallucinations_v1:{name:"Hallucination Detection",description:"Are all claims supported by context? No false information?",requiresJudge:!0,scale:[0,1]},rubric_based_final_response_quality_v1:{name:"Rubric: Response Quality",description:"Custom rubric-based quality assessment of responses",requiresJudge:!0,scale:[0,1]},rubric_based_tool_use_quality_v1:{name:"Rubric: Tool Use Quality",description:"Custom rubric-based assessment of tool usage",requiresJudge:!0,scale:[0,1]}},Wo=(e,t,n)=>{if(t==null)return{value:"-",comparison:""};const r=vn[e],i=(r==null?void 0:r.scale)||[0,1];if(i[0]===1&&i[1]===5){const s=n??3.5;return{value:t.toFixed(1),comparison:`${s.toFixed(1)} / ${i[1].toFixed(1)}`}}else{const s=n??.7;return{value:`${Math.round(t*100)}%`,comparison:`${Math.round(s*100)}% min`}}},j6={metrics:[{metric:"tool_trajectory_avg_score",enabled:!0,criterion:{threshold:1}},{metric:"response_match_score",enabled:!0,criterion:{threshold:.7}}],default_trajectory_match_type:"in_order",num_runs:1};function k1(){return`${Date.now().toString(36)}_${Math.random().toString(36).slice(2,6)}`}function _6(){const{project:e}=ut(),[t,n]=_.useState([]),[r,i]=_.useState(null),[s,a]=_.useState(null),[l,c]=_.useState(new Set),[u,d]=_.useState(new Map),[p,f]=_.useState(new Map),[h,x]=_.useState(new Set),[b,w]=_.useState(!1),[g,m]=_.useState(null),[y,k]=_.useState([]),[T,S]=_.useState(null),P=async()=>{if(e)try{const B=await qe.get(`/projects/${e.id}/eval-history`);k(B.runs||[])}catch(B){console.warn("Failed to load eval history:",B)}},C=async(B,K=!0)=>{if(e)try{const X=(await qe.get(`/projects/${e.id}/eval-history/${B}`)).run;if(S(X),X!=null&&X.case_results){const se=new Map;for(const Q of X.case_results)se.set(Q.eval_case_id,Q);d(se)}if((X==null?void 0:X.eval_set_id)==="batch")c(new Set(t.map(se=>se.id))),i(null);else if(X!=null&&X.eval_set_id){const se=new Map;se.set(X.eval_set_id,X),f(se),i(X.eval_set_id),c(Q=>new Set([...Q,X.eval_set_id]))}a(null),K&&window.history.pushState({run:B},"",`?run=${B}`)}catch(ee){console.warn("Failed to load history run:",ee)}},D=(B,K=!0)=>{i(B),a(null),S(null),K&&B?window.history.pushState({set:B},"",`?set=${B}`):K&&window.history.pushState({},"",window.location.pathname)},N=(B,K,ee=!0)=>{i(B),a(K),S(null),ee&&K?window.history.pushState({set:B,case:K},"",`?set=${B}&case=${K}`):ee&&B&&window.history.pushState({set:B},"",`?set=${B}`)},$=()=>{S(null),d(new Map),f(new Map),window.history.pushState({},"",window.location.pathname)},I=async B=>{if(e)try{await qe.delete(`/projects/${e.id}/eval-history/${B}`),k(K=>K.filter(ee=>ee.id!==B)),(T==null?void 0:T.id)===B&&S(null)}catch(K){console.warn("Failed to delete history run:",K)}};_.useEffect(()=>{e!=null&&e.id&&(L(),P())},[e==null?void 0:e.id]),_.useEffect(()=>{const B=()=>{x(new Set(t.map(ee=>ee.id)))},K=()=>{x(new Set),P()};return window.addEventListener("eval-tests-started",B),window.addEventListener("eval-tests-completed",K),()=>{window.removeEventListener("eval-tests-started",B),window.removeEventListener("eval-tests-completed",K)}},[t]),_.useEffect(()=>{if(!(e!=null&&e.id)||b)return;const B=()=>{const ee=new URLSearchParams(window.location.search),X=ee.get("set"),se=ee.get("case"),Q=ee.get("run");if(Q){C(Q,!1);return}if(X)i(X),a(se),S(null),c(Z=>new Set([...Z,X]));else{if(!r&&!s&&!T)return;i(null),a(null),S(null)}};B();const K=()=>{B()};return window.addEventListener("popstate",K),()=>window.removeEventListener("popstate",K)},[e==null?void 0:e.id,b,t.length]);const L=async()=>{var B,K;if(e!=null&&e.id){w(!0),m(null);try{const ee=await qe.get(`/projects/${e.id}/eval-sets`);if(n(ee.eval_sets||[]),((B=ee.eval_sets)==null?void 0:B.length)>0){const X=new URLSearchParams(window.location.search),se=X.get("set"),Q=X.get("case"),Z=se||(Q?(K=ee.eval_sets.find(re=>re.eval_cases.some(ve=>ve.id===Q)))==null?void 0:K.id:null)||ee.eval_sets[0].id;c(new Set([Z]))}}catch(ee){m(ee.message||"Failed to load eval sets")}finally{w(!1)}}},z=t.find(B=>B.id===r),M=z==null?void 0:z.eval_cases.find(B=>B.id===s),F=async()=>{if(e!=null&&e.id)try{const B=await qe.post(`/projects/${e.id}/eval-sets`,{name:"New Eval Set",description:"",eval_config:j6});n(K=>[...K,B.eval_set]),i(B.eval_set.id),c(K=>new Set([...K,B.eval_set.id]))}catch(B){m(B.message||"Failed to create eval set")}},E=async B=>{if(e!=null&&e.id)try{const K=await qe.post(`/projects/${e.id}/eval-sets/${B}/cases`,{name:"New Test Case",description:"",invocations:[{id:k1(),user_message:"",expected_response:"",expected_tool_calls:[],tool_trajectory_match_type:"in_order",rubrics:[]}],initial_state:{},rubrics:[],enabled_metrics:[],tags:[]});n(ee=>ee.map(X=>X.id===B?{...X,eval_cases:[...X.eval_cases,K.eval_case]}:X)),i(B),a(K.eval_case.id)}catch(K){m(K.message||"Failed to create eval case")}},O=async(B,K,ee)=>{if(e!=null&&e.id)try{const X=await qe.put(`/projects/${e.id}/eval-sets/${B}/cases/${K}`,ee);n(se=>se.map(Q=>Q.id===B?{...Q,eval_cases:Q.eval_cases.map(Z=>Z.id===K?X.eval_case:Z)}:Q))}catch(X){m(X.message||"Failed to update eval case")}},R=async(B,K)=>{if(e!=null&&e.id)try{await qe.delete(`/projects/${e.id}/eval-sets/${B}/cases/${K}`),n(ee=>ee.map(X=>X.id===B?{...X,eval_cases:X.eval_cases.filter(se=>se.id!==K)}:X)),s===K&&a(null)}catch(ee){m(ee.message||"Failed to delete eval case")}},j=async B=>{if(e!=null&&e.id)try{await qe.delete(`/projects/${e.id}/eval-sets/${B}`),n(K=>K.filter(ee=>ee.id!==B)),r===B&&(i(null),a(null))}catch(K){m(K.message||"Failed to delete eval set")}},W=async B=>{if(e!=null&&e.id)try{const K=await qe.get(`/projects/${e.id}/eval-sets/${B}/export`),ee=new Blob([JSON.stringify(K,null,2)],{type:"application/json"}),X=URL.createObjectURL(ee),se=document.createElement("a");se.href=X;const Q=t.find(Z=>Z.id===B);se.download=`${(Q==null?void 0:Q.name)||"eval-set"}.json`,document.body.appendChild(se),se.click(),document.body.removeChild(se),URL.revokeObjectURL(X)}catch(K){m(K.message||"Failed to export eval set")}},J=async B=>{if(e!=null&&e.id)try{const K=await B.text(),ee=JSON.parse(K),X=await qe.post(`/projects/${e.id}/eval-sets/import`,ee);n(se=>[...se,X.eval_set]),i(X.eval_set.id),c(se=>new Set([...se,X.eval_set.id]))}catch(K){m(K.message||"Failed to import eval set")}},v=_.useRef(null),V=async()=>{if(!(!(e!=null&&e.id)||t.length===0))try{const B=await Promise.all(t.map(async se=>{try{return await qe.get(`/projects/${e.id}/eval-sets/${se.id}/export`)}catch{return se}})),K=new Blob([JSON.stringify(B,null,2)],{type:"application/json"}),ee=URL.createObjectURL(K),X=document.createElement("a");X.href=ee,X.download=`${e.name||"project"}-eval-sets.json`,document.body.appendChild(X),X.click(),document.body.removeChild(X),URL.revokeObjectURL(ee)}catch(B){m(B.message||"Failed to export all eval sets")}},A=async(B,K)=>{if(e!=null&&e.id){x(ee=>new Set([...ee,K]));try{const ee=await qe.post(`/projects/${e.id}/eval-sets/${B}/cases/${K}/run`,{});d(X=>new Map(X).set(K,ee.result))}catch(ee){m(ee.message||"Failed to run eval case")}finally{x(ee=>{const X=new Set(ee);return X.delete(K),X})}}},Y=async B=>{if(!(e!=null&&e.id))return;const K=t.find(X=>X.id===B);if(!K)return;const ee=K.eval_cases.map(X=>X.id);x(X=>new Set([...X,B,...ee]));try{const X=await qe.post(`/projects/${e.id}/eval-sets/${B}/run`,{});f(se=>new Map(se).set(B,X.result));for(const se of X.result.case_results)d(Q=>new Map(Q).set(se.eval_case_id,se));try{await qe.post(`/projects/${e.id}/eval-history`,X.result),P()}catch(se){console.warn("Failed to save eval run to history:",se)}}catch(X){m(X.message||"Failed to run eval set")}finally{x(X=>{const se=new Set(X);return se.delete(B),ee.forEach(Q=>se.delete(Q)),se})}},ue=B=>{c(K=>{const ee=new Set(K);return ee.has(B)?ee.delete(B):ee.add(B),ee})},me=B=>{let K=B.eval_cases.length,ee=0,X=0,se=0;for(const Q of B.eval_cases){const Z=u.get(Q.id);Z?Z.passed?ee++:X++:se++}return{total:K,passed:ee,failed:X,pending:se}},q=B=>B==null?"-":`${Math.round(B*100)}%`;return e?o.jsxs("div",{className:"eval-panel",children:[o.jsx("style",{children:`
        .eval-panel {
          display: flex;
          gap: 20px;
          height: calc(100vh - 180px);
      ...
      `}),o.jsxs("aside",{className:"eval-sidebar",children:[o.jsxs("div",{className:"sidebar-header",children:[o.jsx("h3",{children:"Evaluation Tests"}),o.jsxs("div",{className:"header-actions",children:[o.jsx("input",{type:"file",ref:v,accept:".json",style:{display:"none"},onChange:B=>{var ee;const K=(ee=B.target.files)==null?void 0:ee[0];K&&(J(K),B.target.value="")}}),o.jsx("button",{className:"btn btn-secondary btn-sm",onClick:()=>{var B;return(B=v.current)==null?void 0:B.click()},title:"Import eval set from JSON",children:o.jsx(ol,{size:14})}),t.length>0&&o.jsx("button",{className:"btn btn-secondary btn-sm",onClick:V,title:"Download all eval sets as JSON",children:o.jsx(Zo,{size:14})}),o.jsx("button",{className:"btn btn-secondary btn-sm",onClick:L,title:"Refresh",children:o.jsx(on,{size:14})}),o.jsxs("button",{className:"btn btn-primary btn-sm",onClick:F,title:"New eval set",children:[o.jsx(Ke,{size:14}),"Set"]})]})]}),o.jsxs("div",{className:"eval-tree",children:[b&&o.jsx("p",{style:{color:"var(--text-muted)",padding:"16px"},children:"Loading..."}),g&&o.jsx("div",{style:{color:"var(--error)",padding:"16px",fontSize:"13px"},children:g}),!b&&t.length===0&&o.jsxs("div",{className:"empty-state",style:{padding:"32px"},children:[o.jsx(Ud,{size:32}),o.jsxs("p",{children:["No evaluation sets yet.",o.jsx("br",{}),"Create one to get started."]})]}),t.map(B=>{const K=l.has(B.id),ee=me(B),X=h.has(B.id);return o.jsxs("div",{className:"tree-item",children:[o.jsxs("div",{className:`tree-set ${r===B.id&&!s?"selected":""}`,onClick:()=>D(B.id),children:[o.jsx("button",{className:"expand-btn",onClick:se=>{se.stopPropagation(),ue(B.id)},children:B.eval_cases.length>0?K?o.jsx(Pt,{size:14}):o.jsx(bt,{size:14}):o.jsx("span",{style:{width:14}})}),o.jsx(Vy,{size:14,style:{color:"var(--accent-secondary)"}}),o.jsx("span",{className:"set-name",children:B.name}),o.jsx("button",{className:"add-case-btn",onClick:se=>{se.stopPropagation(),E(B.id)},title:"Add test case",style:{padding:"2px 4px",marginLeft:4,background:"transparent",border:"none",cursor:"pointer",opacity:.6,display:"flex",alignItems:"center"},children:o.jsx(Ke,{size:12})}),ee.total>0&&o.jsxs("span",{className:"set-stats",children:[ee.passed>0&&o.jsx("span",{className:"stat-passed",children:ee.passed}),ee.failed>0&&o.jsx("span",{className:"stat-failed",children:ee.failed}),ee.pending>0&&o.jsx("span",{className:"stat-pending",children:ee.pending})]}),o.jsx("button",{className:"run-btn",onClick:se=>{se.stopPropagation(),Y(B.id)},title:"Run all tests in this set",disabled:X,children:X?o.jsx(Io,{size:12,className:"spinning"}):o.jsx(pr,{size:12})})]}),K&&o.jsx("div",{className:"tree-children",style:{paddingLeft:16},children:B.eval_cases.map(se=>{var re;const Q=u.get(se.id),Z=h.has(se.id);return o.jsxs("div",{className:`tree-case ${s===se.id?"selected":""}`,onClick:()=>N(B.id,se.id),children:[Z?o.jsx(Io,{size:14,className:"spinning",style:{color:"var(--warning)"}}):Q?Q.passed?o.jsx(Ir,{size:14,style:{color:"var(--success)"}}):o.jsx(ji,{size:14,style:{color:"var(--error)"}}):o.jsx(Ca,{size:14,style:{color:"var(--text-muted)"}}),o.jsx("span",{className:"case-name",children:se.name}),Q&&Q.metric_results.length>0&&o.jsx("span",{style:{fontSize:11,color:Q.passed?"var(--success)":"var(--error)"},children:q((re=Q.metric_results[0])==null?void 0:re.score)}),o.jsx("button",{className:"run-btn",onClick:ve=>{ve.stopPropagation(),A(B.id,se.id)},disabled:Z,children:o.jsx(pr,{size:12})})]},se.id)})})]},B.id)})]}),o.jsxs("div",{className:"history-section",children:[o.jsx("div",{className:"history-header",style:{display:"flex",justifyContent:"space-between",alignItems:"center",padding:"10px 12px",borderTop:"1px solid var(--border-color)",background:"var(--bg-secondary)"},children:o.jsxs("span",{style:{fontWeight:500,fontSize:13},children:["Previous Runs (",y.length,")"]})}),o.jsx("div",{className:"history-list",style:{maxHeight:200,overflowY:"auto"},children:y.length===0?o.jsx("div",{style:{padding:"12px",color:"var(--text-secondary)",fontSize:12,textAlign:"center"},children:"No previous runs"}):[...y].sort((B,K)=>(K.started_at||0)-(B.started_at||0)).map(B=>{const K=B.passed_cases===B.total_cases;return o.jsx("div",{className:`history-item ${(T==null?void 0:T.id)===B.id?"selected":""}`,onClick:()=>C(B.id),style:{padding:"8px 12px",borderBottom:"1px solid var(--border-color)",cursor:"pointer",background:(T==null?void 0:T.id)===B.id?"var(--bg-tertiary)":"transparent",fontSize:12},children:o.jsxs("div",{style:{display:"flex",justifyContent:"space-between",alignItems:"center"},children:[o.jsxs("div",{style:{display:"flex",alignItems:"center",gap:8},children:[K?o.jsx(Ir,{size:14,style:{color:"var(--success)",flexShrink:0}}):o.jsx(ji,{size:14,style:{color:"var(--error)",flexShrink:0}}),o.jsxs("div",{children:[o.jsx("div",{style:{fontWeight:500},children:B.eval_set_name||"Unnamed"}),o.jsx("div",{style:{color:"var(--text-secondary)",fontSize:11},children:new Date(B.started_at*1e3).toLocaleString()})]})]}),o.jsxs("div",{style:{display:"flex",alignItems:"center",gap:8},children:[o.jsxs("span",{style:{color:K?"var(--success)":"var(--error)",fontWeight:500,fontSize:11},children:[B.passed_cases,"/",B.total_cases]}),o.jsx("button",{className:"btn btn-icon",onClick:ee=>{ee.stopPropagation(),I(B.id)},title:"Delete run",style:{padding:2},children:o.jsx(Fe,{size:12})})]})]})},B.id)})})]})]}),o.jsx("div",{className:"eval-editor",children:T?o.jsx(C6,{run:T,onClose:$}):M?o.jsx(N6,{evalCase:M,evalSetId:r,projectId:e.id,result:u.get(M.id),isRunning:h.has(M.id),onUpdate:B=>O(r,M.id,B),onDelete:()=>R(r,M.id),onRun:()=>A(r,M.id),onClearResult:()=>d(B=>{const K=new Map(B);return K.delete(M.id),K})}):z?o.jsx(E6,{evalSet:z,projectId:e.id,result:p.get(z.id),isRunning:h.has(z.id),caseResults:u,onUpdate:async B=>{try{const K=await qe.put(`/projects/${e.id}/eval-sets/${z.id}`,B);n(ee=>ee.map(X=>X.id===z.id?K.eval_set:X))}catch(K){m(K.message)}},onDelete:()=>j(z.id),onRun:()=>Y(z.id),onExport:()=>W(z.id)}):o.jsx("div",{className:"editor-content",children:o.jsxs("div",{className:"empty-state",children:[o.jsx(Ca,{size:48}),o.jsxs("p",{children:["Select a test case to edit",o.jsx("br",{}),"or create a new one"]})]})})})]}):null}function S6({value:e,onChange:t}){var a,l;const{project:n}=ut(),r=((a=n==null?void 0:n.app)==null?void 0:a.models)||[],i=(l=n==null?void 0:n.app)==null?void 0:l.default_model_id,s=r.find(c=>c.id===i);return o.jsxs("select",{value:e,onChange:c=>t(c.target.value),style:{width:"100%",maxWidth:400},children:[o.jsx("option",{value:"",children:s?`App Default (${s.model_name})`:"App Default"}),r.map(c=>o.jsx("option",{value:c.model_name,children:c.model_name},c.id)),o.jsx("option",{value:"gemini-2.0-flash",children:"gemini-2.0-flash"}),o.jsx("option",{value:"gemini-2.5-flash",children:"gemini-2.5-flash"}),o.jsx("option",{value:"gemini-2.5-pro",children:"gemini-2.5-pro"})]})}function C6({run:e,onClose:t}){var h;const{project:n}=ut(),[r,i]=_.useState(!0),[s,a]=_.useState(new Set),l=e.case_results||[],c=l.filter(x=>x.passed).length,u=l.filter(x=>!x.passed).length,d=r?l.filter(x=>!x.passed):l,p=x=>{a(b=>{const w=new Set(b);return w.has(x)?w.delete(x):w.add(x),w})},f=x=>{x&&n&&(window.location.href=`/project/${n.id}/run?session=${x}`)};return o.jsxs("div",{className:"test-result-viewer",children:[o.jsx("style",{children:`
        .test-result-viewer {
          height: 100%;
          display: flex;
          flex-direction: column;
...
`).join("")]})]})]},D)),r.error&&o.jsxs("div",{className:"result-details",children:[o.jsx("h5",{style:{color:"var(--error)"},children:"Error"}),o.jsx("div",{className:"detail-box",style:{color:"var(--error)"},children:r.error})]})]})]})}function E6({evalSet:e,projectId:t,result:n,isRunning:r,caseResults:i,onUpdate:s,onDelete:a,onRun:l,onExport:c}){var b,w,g,m;const[u,d]=_.useState(e.name),[p,f]=_.useState(!1);_.useEffect(()=>{d(e.name)},[e.id]);const h=_.useCallback(()=>{u!==e.name&&s({name:u})},[u,e.name,s]),x=y=>y==null?"-":`${Math.round(y*100)}%`;return o.jsxs(o.Fragment,{children:[o.jsxs("div",{className:"editor-header",children:[o.jsx(Vy,{size:20,style:{color:"var(--accent-secondary)"}}),o.jsx("input",{type:"text",value:u,onChange:y=>d(y.target.value),onBlur:h,placeholder:"Eval set name"}),o.jsx("button",{className:"btn btn-secondary btn-sm",onClick:()=>{const y=`${window.location.origin}/project/${t}/evaluate?set=${e.id}`;navigator.clipboard.writeText(y)},title:"Copy link to this eval set",children:o.jsx(Fd,{size:14})}),o.jsxs("button",{className:`btn btn-sm ${p?"btn-primary":"btn-secondary"}`,onClick:()=>f(!p),title:"View/Hide JSON",children:[o.jsx(jn,{size:14}),"JSON"]}),o.jsx("button",{className:"btn btn-secondary btn-sm",onClick:c,title:"Export as JSON (compatible with adk eval)",children:o.jsx(Zo,{size:14})}),o.jsxs("button",{className:"btn btn-primary btn-sm",onClick:l,disabled:r,children:[r?o.jsx(Io,{size:14,className:"spinning"}):o.jsx(pr,{size:14}),"Run All"]}),o.jsx("button",{className:"btn btn-danger btn-sm",onClick:a,children:o.jsx(Fe,{size:14})})]}),o.jsx("div",{className:"editor-content",children:p?o.jsxs("div",{style:{display:"flex",flexDirection:"column",gap:16,height:"100%"},children:[o.jsx("div",{style:{fontSize:12,color:"var(--text-secondary)",padding:"8px 0"},children:o.jsxs("p",{style:{margin:0},children:["This is the ADK-compatible JSON format for this evaluation set. Save this file and use with ",o.jsx("code",{style:{background:"var(--bg-tertiary)",padding:"2px 6px",borderRadius:4},children:"adk eval <agent_path> <eval_file.json>"})]})}),o.jsx("div",{style:{flex:1,minHeight:400,border:"1px solid var(--border-color)",borderRadius:"var(--radius-md)",overflow:"hidden"},children:o.jsx(Kt,{height:"100%",language:"json",theme:"vs-dark",value:JSON.stringify([{id:e.id,name:e.name,description:e.description||void 0,eval_cases:e.eval_cases.map(y=>{var k,T;return{name:y.name,description:y.description||void 0,tags:(k=y.tags)!=null&&k.length?y.tags:void 0,target_agent:y.target_agent!=="root_agent"?y.target_agent:void 0,invocations:y.invocations.map(S=>{var P;return{user_message:S.user_message,expected_response:S.expected_response||void 0,expected_tool_calls:(P=S.expected_tool_calls)!=null&&P.length?S.expected_tool_calls.map(C=>({tool_name:C.tool_name,args:C.match_type!=="name_only"&&Object.keys(C.args||{}).length?C.args:void 0})):void 0}}),session_input:Object.keys(y.session_input||{}).length?{state:y.session_input}:void 0,final_session_state:Object.keys(y.final_session_state||{}).length?y.final_session_state:void 0,rubrics:(T=y.rubrics)!=null&&T.length?y.rubrics.map(S=>S.rubric):void 0}}),eval_config:e.eval_config?{judge_model:e.eval_config.judge_model||void 0,metrics:((b=e.eval_config.metrics)==null?void 0:b.filter(y=>y.enabled))||void 0}:void 0}],null,2),options:{readOnly:!0,minimap:{enabled:!1},fontSize:12,fontFamily:"'JetBrains Mono', monospace",lineNumbers:"on",scrollBeyondLastLine:!1,automaticLayout:!0,tabSize:2,wordWrap:"on",padding:{top:12}}})}),o.jsx("div",{style:{display:"flex",gap:8},children:o.jsxs("button",{className:"btn btn-secondary btn-sm",onClick:()=>{var k;const y=JSON.stringify([{id:e.id,name:e.name,description:e.description||void 0,eval_cases:e.eval_cases.map(T=>{var S,P;return{name:T.name,description:T.description||void 0,tags:(S=T.tags)!=null&&S.length?T.tags:void 0,target_agent:T.target_agent!=="root_agent"?T.target_agent:void 0,invocations:T.invocations.map(C=>{var D;return{user_message:C.user_message,expected_response:C.expected_response||void 0,expected_tool_calls:(D=C.expected_tool_calls)!=null&&D.length?C.expected_tool_calls.map(N=>({tool_name:N.tool_name,args:N.match_type!=="name_only"&&Object.keys(N.args||{}).length?N.args:void 0})):void 0}}),session_input:Object.keys(T.session_input||{}).length?{state:T.session_input}:void 0,final_session_state:Object.keys(T.final_session_state||{}).length?T.final_session_state:void 0,rubrics:(P=T.rubrics)!=null&&P.length?T.rubrics.map(C=>C.rubric):void 0}}),eval_config:e.eval_config?{judge_model:e.eval_config.judge_model||void 0,metrics:((k=e.eval_config.metrics)==null?void 0:k.filter(T=>T.enabled))||void 0}:void 0}],null,2);navigator.clipboard.writeText(y)},children:[o.jsx(Xo,{size:14})," Copy JSON"]})})]}):o.jsxs(o.Fragment,{children:[o.jsxs("div",{className:"form-section",children:[o.jsx("h4",{children:"Description"}),o.jsx("textarea",{value:e.description,onChange:y=>s({description:y.target.value}),placeholder:"Description of this evaluation set...",style:{minHeight:40}})]}),o.jsxs("div",{className:"form-section",children:[o.jsx("h4",{children:"LLM Judge Model"}),o.jsx("p",{style:{fontSize:12,color:"var(--text-muted)",marginBottom:8},children:"Model used for LLM-judged metrics (safety, hallucinations, etc.)."}),o.jsx(S6,{value:((w=e.eval_config)==null?void 0:w.judge_model)||"",onChange:y=>s({eval_config:{...e.eval_config,judge_model:y}})})]}),o.jsxs("div",{className:"form-section",children:[o.jsxs("h4",{children:[o.jsx(qy,{size:14})," Evaluation Metrics"]}),o.jsx("p",{style:{fontSize:12,color:"var(--text-muted)",marginBottom:8},children:"Configure which metrics to use and their pass thresholds."}),Object.keys(vn).map(y=>{var C,D,N;const k=vn[y],T=(D=(C=e.eval_config)==null?void 0:C.metrics)==null?void 0:D.find($=>$.metric===y),S=(T==null?void 0:T.enabled)??!1,P=((N=T==null?void 0:T.criterion)==null?void 0:N.threshold)??.7;return o.jsxs("div",{style:{display:"flex",alignItems:"center",gap:10,marginBottom:6},children:[o.jsxs("label",{className:"toggle-switch",style:{margin:0},children:[o.jsx("input",{type:"checkbox",checked:S,onChange:$=>{var z;const I=[...((z=e.eval_config)==null?void 0:z.metrics)||[]],L=I.findIndex(M=>M.metric===y);$.target.checked?L===-1?I.push({metric:y,enabled:!0,criterion:{threshold:.7}}):I[L]={...I[L],enabled:!0}:L!==-1&&(I[L]={...I[L],enabled:!1}),s({eval_config:{...e.eval_config,metrics:I}})}}),o.jsx("span",{className:"toggle-slider"})]}),o.jsxs("span",{style:{fontSize:12,opacity:S?1:.5,minWidth:140,fontWeight:S?500:400},children:[k.name,k.requiresJudge&&o.jsx("span",{style:{fontSize:9,marginLeft:4,color:"var(--accent-primary)"},children:"LLM"})]}),o.jsx("span",{style:{fontSize:11,color:"var(--text-muted)",opacity:S?1:.4},children:"≥"}),o.jsx("input",{type:"number",min:0,max:1,step:.1,value:P,disabled:!S,onChange:$=>{var z;const I=[...((z=e.eval_config)==null?void 0:z.metrics)||[]],L=I.findIndex(M=>M.metric===y);L!==-1&&(I[L]={...I[L],criterion:{...I[L].criterion,threshold:parseFloat($.target.value)||.7}},s({eval_config:{...e.eval_config,metrics:I}}))},style:{width:60,textAlign:"center",opacity:S?1:.3,padding:"2px 4px",fontSize:11}})]},y)}),o.jsxs("div",{className:"form-row",style:{marginTop:16},children:[o.jsxs("div",{className:"form-field",children:[o.jsx("label",{children:"Default Trajectory Match Type"}),o.jsxs("select",{value:((g=e.eval_config)==null?void 0:g.default_trajectory_match_type)||"in_order",onChange:y=>s({eval_config:{...e.eval_config,default_trajectory_match_type:y.target.value}}),children:[o.jsx("option",{value:"exact",children:"Exact (same order, no extras)"}),o.jsx("option",{value:"in_order",children:"In Order (extras allowed between)"}),o.jsx("option",{value:"any_order",children:"Any Order (all present, any order)"})]})]}),o.jsxs("div",{className:"form-field",children:[o.jsx("label",{children:"Number of Runs"}),o.jsx("input",{type:"number",min:1,max:10,value:((m=e.eval_config)==null?void 0:m.num_runs)||1,onChange:y=>s({eval_config:{...e.eval_config,num_runs:parseInt(y.target.value)||1}})}),o.jsx("p",{style:{fontSize:11,color:"var(--text-muted)",marginTop:4},children:"Run each test multiple times for statistical reliability."})]})]})]}),o.jsxs("div",{className:"form-section",children:[o.jsxs("h4",{children:[o.jsx(Gk,{size:14})," Coverage Summary"]}),n?o.jsxs(o.Fragment,{children:[o.jsxs("div",{className:"result-scores",children:[o.jsxs("div",{className:"score-card",children:[o.jsxs("div",{className:"score-value",style:{color:"var(--accent-primary)"},children:[n.passed_cases,"/",n.total_cases]}),o.jsx("div",{className:"score-label",children:"Cases Passed"})]}),o.jsxs("div",{className:"score-card",children:[o.jsx("div",{className:`score-value ${n.overall_pass_rate>=.8?"passed":"failed"}`,children:x(n.overall_pass_rate)}),o.jsx("div",{className:"score-label",children:"Pass Rate"})]}),Object.entries(n.metric_avg_scores||{}).map(([y,k])=>{var S;const T=Wo(y,k);return o.jsxs("div",{className:"score-card",children:[o.jsx("div",{className:"score-value",children:T.value}),o.jsxs("div",{className:"score-label",children:["Avg ",((S=vn[y])==null?void 0:S.name)||y]})]},y)})]}),o.jsxs("div",{style:{marginTop:16},children:[o.jsx("div",{style:{marginBottom:4,fontSize:12,color:"var(--text-muted)"},children:"Overall Pass Rate"}),o.jsx("div",{className:"coverage-bar",children:o.jsx("div",{className:`coverage-fill ${n.overall_pass_rate>=.8?"passed":"failed"}`,style:{width:`${n.overall_pass_rate*100}%`}})})]}),Object.entries(n.metric_pass_rates||{}).length>0&&o.jsxs("div",{style:{marginTop:16},children:[o.jsx("h5",{style:{fontSize:13,marginBottom:8},children:"Metric Pass Rates"}),Object.entries(n.metric_pass_rates).map(([y,k])=>{var T;return o.jsxs("div",{style:{marginBottom:8},children:[o.jsxs("div",{style:{display:"flex",justifyContent:"space-between",fontSize:12,marginBottom:4},children:[o.jsx("span",{children:((T=vn[y])==null?void 0:T.name)||y}),o.jsx("span",{children:x(k)})]}),o.jsx("div",{className:"coverage-bar",children:o.jsx("div",{className:`coverage-fill ${k>=.8?"passed":"failed"}`,style:{width:`${k*100}%`}})})]},y)})]}),o.jsxs("div",{style:{marginTop:16},children:[o.jsx("h5",{style:{fontSize:13,marginBottom:8},children:"Individual Results"}),o.jsxs("table",{style:{width:"100%",fontSize:12,borderCollapse:"collapse"},children:[o.jsx("thead",{children:o.jsxs("tr",{style:{borderBottom:"1px solid var(--border-color)"},children:[o.jsx("th",{style:{textAlign:"left",padding:"8px 4px"},children:"Test Case"}),o.jsx("th",{style:{textAlign:"center",padding:"8px 4px"},children:"Metrics"}),o.jsx("th",{style:{textAlign:"center",padding:"8px 4px"},children:"Status"})]})}),o.jsx("tbody",{children:n.case_results.map(y=>o.jsxs("tr",{style:{borderBottom:"1px solid var(--border-color)"},children:[o.jsx("td",{style:{padding:"8px 4px"},children:y.eval_case_name}),o.jsx("td",{style:{textAlign:"center",padding:"8px 4px"},children:y.metric_results.map((k,T)=>{const S=Wo(k.metric,k.score,k.threshold);return o.jsx("span",{style:{fontSize:10,padding:"2px 4px",marginRight:4,borderRadius:"var(--radius-sm)",background:k.passed?"rgba(var(--success-rgb), 0.15)":"rgba(var(--error-rgb), 0.15)",color:k.passed?"var(--success)":"var(--error)"},children:S.value},T)})}),o.jsx("td",{style:{textAlign:"center",padding:"8px 4px"},children:y.passed?o.jsx(Ir,{size:14,style:{color:"var(--success)"}}):y.error?o.jsx(wi,{size:14,style:{color:"var(--warning)"}}):o.jsx(ji,{size:14,style:{color:"var(--error)"}})})]},y.eval_case_id))})]})]})]}):o.jsxs("div",{style:{textAlign:"center",padding:"32px",color:"var(--text-muted)",background:"var(--bg-tertiary)",borderRadius:"var(--radius-md)"},children:[o.jsx(Ud,{size:32,style:{marginBottom:8,opacity:.3}}),o.jsx("p",{children:"Run the evaluation set to see coverage metrics"})]})]}),o.jsxs("div",{className:"form-section",children:[o.jsxs("h4",{children:["Test Cases (",e.eval_cases.length,")"]}),e.eval_cases.length===0?o.jsx("p",{style:{color:"var(--text-muted)",fontSize:13},children:"No test cases yet. Add cases to this eval set to start testing."}):o.jsx("ul",{style:{listStyle:"none",padding:0},children:e.eval_cases.map(y=>{const k=i.get(y.id);return o.jsxs("li",{style:{display:"flex",alignItems:"center",gap:8,padding:"8px 12px",background:"var(--bg-tertiary)",borderRadius:"var(--radius-sm)",marginBottom:8},children:[k?k.passed?o.jsx(Ir,{size:14,style:{color:"var(--success)"}}):o.jsx(ji,{size:14,style:{color:"var(--error)"}}):o.jsx(Ca,{size:14,style:{color:"var(--text-muted)"}}),o.jsx("span",{style:{flex:1},children:y.name}),o.jsxs("span",{style:{fontSize:11,color:"var(--text-muted)"},children:[y.invocations.length," turn(s)"]})]},y.id)})})]})]})})]})}function z6(){const{project:e,setProject:t}=ut(),[n,r]=_.useState(""),[i,s]=_.useState(!0),[a,l]=_.useState(!1),[c,u]=_.useState(null),[d,p]=_.useState(!1);if(!e)return null;_.useEffect(()=>{f()},[e.id]);async function f(){s(!0),u(null);try{const m=await Ny(e.id);r(m),l(!1)}catch(m){u(m.message)}finally{s(!1)}}function h(m){m!==void 0&&(r(m),l(!0),u(null))}async function x(){s(!0),u(null);try{const m=await Ey(e.id,n);t(m),l(!1)}catch(m){u(m.message)}finally{s(!1)}}function b(){navigator.clipboard.writeText(n),p(!0),setTimeout(()=>p(!1),2e3)}function w(){const m=new Blob([n],{type:"text/yaml"}),y=URL.createObjectURL(m),k=document.createElement("a");k.href=y,k.download=`${e.name}.yaml`,k.click(),URL.revokeObjectURL(y)}function g(){const m=document.createElement("input");m.type="file",m.accept=".yaml,.yml",m.onchange=async y=>{var S;const k=(S=y.target.files)==null?void 0:S[0];if(!k)return;const T=await k.text();r(T),l(!0)},m.click()}return o.jsxs("div",{className:"yaml-panel",children:[o.jsx("style",{children:`
      ...
      `}),o.jsxs("div",{className:"code-header",children:[o.jsxs("div",{className:"code-title",children:[o.jsx(jn,{size:16}),o.jsx("h3",{children:"Python Code"}),o.jsx("span",{className:"badge",children:s?"Loading...":"Generated"}),t&&o.jsxs("span",{className:"status-badge success",children:[o.jsx(Id,{size:12}),"Copied!"]}),l&&o.jsxs("span",{className:"status-badge error",children:[o.jsx(wi,{size:12}),"Error"]})]}),o.jsxs("div",{className:"code-actions",children:[o.jsxs("button",{className:"btn btn-secondary btn-sm",onClick:u,title:"Copy to clipboard",disabled:s||!!l,children:[o.jsx(Xo,{size:14}),"Copy"]}),o.jsxs("button",{className:"btn btn-secondary btn-sm",onClick:d,title:"Download Python file",disabled:s||!!l,children:[o.jsx(Zo,{size:14}),"Download"]})]})]}),o.jsx("div",{className:"code-editor",children:s?o.jsx("div",{className:"code-loading",children:o.jsx("div",{children:"Loading generated code..."})}):l?o.jsxs("div",{className:"code-error",children:[o.jsx(wi,{size:24}),o.jsx("div",{children:l})]}):o.jsx(Kt,{height:"100%",language:"python",theme:"vs-dark",value:r,options:{readOnly:!0,minimap:{enabled:!1},fontSize:13,fontFamily:"'JetBrains Mono', monospace",lineNumbers:"on",scrollBeyondLastLine:!1,automaticLayout:!0,tabSize:4,insertSpaces:!0,padding:{top:12},wordWrap:"on"}})}),o.jsxs("div",{className:"code-info",children:[o.jsx("p",{children:"This is the Python code equivalent of your project configuration. You can use this code directly with ADK."}),o.jsxs("p",{children:["Place this in a file named ",o.jsx("code",{children:"agent.py"})," inside your agent directory, then run with ",o.jsx("code",{children:"adk web ."})," or ",o.jsx("code",{children:"adk run your_agent"}),"."]})]})]})}const A6=[{id:"app",label:"App",icon:qy},{id:"agents",label:"Agents",icon:Er},{id:"tools",label:"Tools",icon:ln},{id:"callbacks",label:"Callbacks",icon:jn},{id:"run",label:"Run",icon:Wy},{id:"skillsets",label:"SkillSets",icon:Dk},{id:"eval",label:"Evaluate",icon:gu},{id:"yaml",label:"YAML",icon:Bk},{id:"code",label:"Code",icon:jn}],P6=["app","agents","tools","callbacks","run","skillsets","eval","yaml","code"];function mc(){var M,F;const{projectId:e,tab:t,itemId:n}=Fw(),r=Md(),{project:i,setProject:s,activeTab:a,setActiveTab:l,hasUnsavedChanges:c,setHasUnsavedChanges:u,selectedAgentId:d,setSelectedAgentId:p,selectedToolId:f,setSelectedToolId:h}=ut(),[x,b]=_.useState(!0),[w,g]=_.useState(!1),[m,y]=_.useState(!1),[k,T]=_.useState(null),S=_.useRef(!0),P=_.useRef(null);_.useEffect(()=>{t&&P6.includes(t)?l(t):!t&&e&&r(`/project/${e}/${a}`,{replace:!0})},[t,e]),_.useEffect(()=>{t==="agents"&&n?p(n):t==="tools"&&n&&h(n)},[t,n]);function C(E){l(E),E==="agents"&&d?r(`/project/${e}/${E}/${d}`,{replace:!0}):E==="tools"&&f?r(`/project/${e}/${E}/${f}`,{replace:!0}):r(`/project/${e}/${E}`,{replace:!0})}function D(E){E?r(`/project/${e}/${a}/${E}`,{replace:!0}):r(`/project/${e}/${a}`,{replace:!0})}_.useEffect(()=>(e&&N(e),()=>{s(null),u(!1)}),[e]);async function N(E){S.current=!0;try{const O=await ky(E);s(O),P.current=JSON.stringify(O),u(!1)}catch(O){console.error("Failed to load project:",O),r("/")}finally{b(!1),setTimeout(()=>{S.current=!1},100)}}async function $(){if(i){g(!0);try{const{eval_sets:E,...O}=i;await du(i.id,O),P.current=JSON.stringify(i),u(!1)}catch(E){console.error("Failed to save project:",E)}finally{g(!1)}}}async function I(){if(i){y(!0),T(null),window.dispatchEvent(new CustomEvent("eval-tests-started"));try{let E=0,O=0;const R=[],j=[];for(const W of i.eval_sets||[]){if(W.eval_cases.length===0)continue;const J=await qe.post(`/projects/${i.id}/eval-sets/${W.id}/run`,{});J.result&&(E+=J.result.passed_cases||0,O+=J.result.total_cases||0,J.result.case_results&&R.push(...J.result.case_results),j.push(J.result.eval_set_name||W.name||W.id))}if(R.length>0){const W={id:Date.now().toString(36)+Math.random().toString(36).substr(2,5),eval_set_id:"batch",eval_set_name:j.length>1?`All Tests (${j.length} sets)`:j[0]||"All Tests",started_at:Date.now()/1e3,completed_at:Date.now()/1e3,total_cases:O,passed_cases:E,failed_cases:O-E,case_results:R};try{await qe.post(`/projects/${i.id}/eval-history`,W)}catch(J){console.warn("Failed to save batch eval run to history:",J)}}T({passed:E,total:O}),window.dispatchEvent(new CustomEvent("eval-tests-completed")),setTimeout(()=>T(null),5e3)}catch(E){console.error("Failed to run tests:",E),T({passed:0,total:-1}),setTimeout(()=>T(null),5e3)}finally{y(!1)}}}const L=_.useRef(null);_.useEffect(()=>{if(i&&!S.current&&L.current){const E=i.app.models||[],O=L.current||[];if(E.some((j,W)=>{const J=O.find(v=>v.id===j.id);return J?J.provider!==j.provider||J.model_name!==j.model_name||J.api_base!==j.api_base||J.temperature!==j.temperature||J.max_output_tokens!==j.max_output_tokens||J.top_p!==j.top_p||J.top_k!==j.top_k:!1})){const j=i.app.default_model_id,W=i.agents.map(v=>{if(v.type==="LlmAgent"&&v.model){const V=v.model._appModelId;if(V){const A=E.find(Y=>Y.id===V);if(A)return{...v,model:{provider:A.provider,model_name:A.model_name,api_base:A.api_base,temperature:A.temperature,max_output_tokens:A.max_output_tokens,top_p:A.top_p,top_k:A.top_k,fallbacks:[],_appModelId:V}}}else if(j){const A=E.find(Y=>Y.id===j);if(A&&v.model.provider===A.provider&&v.model.model_name===A.model_name&&v.model.api_base===A.api_base)return{...v,model:{provider:A.provider,model_name:A.model_name,api_base:A.api_base,temperature:A.temperature,max_output_tokens:A.max_output_tokens,top_p:A.top_p,top_k:A.top_k,fallbacks:[],_appModelId:j}}}}return v});W.some((v,V)=>JSON.stringify(v)!==JSON.stringify(i.agents[V]))&&s({...i,agents:W})}}i&&(L.current=i.app.models||[])},[i==null?void 0:i.app.models,i,s]);const z=_.useRef(null);return _.useEffect(()=>(i&&!S.current&&P.current&&JSON.stringify(i)!==P.current&&(u(!0),z.current&&clearTimeout(z.current),z.current=setTimeout(async()=>{try{const{eval_sets:O,...R}=i;await du(i.id,R),P.current=JSON.stringify(i),u(!1)}catch(O){console.error("Auto-save failed:",O)}},500)),()=>{z.current&&clearTimeout(z.current)}),[i]),x?o.jsxs("div",{className:"loading-screen",children:[o.jsx("style",{children:`
          .loading-screen {
            height: 100vh;
            display: flex;
            align-items: center;
      ...
      `}),o.jsxs("header",{className:"top-bar",children:[o.jsxs("div",{className:"top-bar-left",children:[o.jsxs("button",{className:"back-btn",onClick:()=>r("/"),children:[o.jsx(Ok,{size:18}),"Project"]}),o.jsx("h1",{className:"project-name",children:i.name})]}),o.jsx("nav",{className:"tabs-bar",children:A6.map(E=>o.jsxs("button",{className:`tab-btn ${a===E.id?"active":""}`,onClick:()=>C(E.id),children:[o.jsx(E.icon,{size:14}),E.label]},E.id))}),o.jsxs("div",{className:"top-bar-right",children:[o.jsxs("button",{className:`btn ${k?k.total===-1?"btn-error":k.passed===k.total?"btn-success":"btn-warning":"btn-secondary"}`,onClick:I,disabled:m||!((M=i==null?void 0:i.eval_sets)!=null&&M.some(E=>E.eval_cases.length>0)),title:(F=i==null?void 0:i.eval_sets)!=null&&F.some(E=>E.eval_cases.length>0)?"Run all evaluation tests":"No test cases defined",style:{marginRight:8},children:[m?o.jsx(qk,{size:16,className:"spin"}):o.jsx(pr,{size:16}),m?"Testing...":k?k.total===-1?"Error":`${k.passed}/${k.total}`:"Test"]}),o.jsxs("button",{className:"btn btn-primary",onClick:$,disabled:w,children:[o.jsx(Ea,{size:16}),w?"Saving...":"Save"]})]})]}),o.jsxs("main",{className:"main-content",children:[a==="app"&&o.jsx(aj,{}),a==="agents"&&o.jsx(h4,{onSelectAgent:D}),a==="tools"&&o.jsx(K4,{onSelectTool:D}),a==="callbacks"&&o.jsx(Y4,{onSelectCallback:D}),a==="run"&&o.jsx(v6,{}),a==="skillsets"&&o.jsx(k6,{}),a==="eval"&&o.jsx(_6,{}),a==="yaml"&&o.jsx(z6,{}),a==="code"&&o.jsx(T6,{})]})]}):null}function L6(){const{setMcpServers:e,setBuiltinTools:t}=ut();return _.useEffect(()=>{Rd().then(e).catch(console.error),zy().then(t).catch(console.error)},[e,t]),o.jsxs(rk,{children:[o.jsx(Vr,{path:"/",element:o.jsx(ej,{})}),o.jsx(Vr,{path:"/project/:projectId",element:o.jsx(mc,{})}),o.jsx(Vr,{path:"/project/:projectId/:tab",element:o.jsx(mc,{})}),o.jsx(Vr,{path:"/project/:projectId/:tab/:itemId",element:o.jsx(mc,{})}),o.jsx(Vr,{path:"*",element:o.jsx(tk,{to:"/",replace:!0})})]})}gc.createRoot(document.getElementById("root")).render(o.jsx(It.StrictMode,{children:o.jsx(sk,{children:o.jsx(L6,{})})}));
