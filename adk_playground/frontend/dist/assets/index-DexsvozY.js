...
`+R,o.jsx("span",{className:"json-bracket",children:"]"})]});if(typeof L=="object"){const z=Object.entries(L);return z.length===0?o.jsx("span",{className:"json-bracket",children:"{}"}):z.length<=2&&z.every(([,I])=>I===null||typeof I!="object")&&T?o.jsxs("span",{className:"json-inline",children:[o.jsx("span",{className:"json-bracket",children:"{"}),z.map(([I,_],H)=>o.jsxs("span",{children:[o.jsxs("span",{className:"json-key",children:['"',I,'"']}),o.jsx("span",{className:"json-colon",children:": "}),a(_,V+1,!0),H<z.length-1&&o.jsx("span",{className:"json-comma",children:", "})]},I)),o.jsx("span",{className:"json-bracket",children:"}"})]}):o.jsxs("span",{className:"json-block",children:[o.jsx("span",{className:"json-bracket",children:"{"}),z.map(([I,_],H)=>o.jsxs("span",{children:[`
`+$,o.jsxs("span",{className:"json-key",children:['"',I,'"']}),o.jsx("span",{className:"json-colon",children:": "}),a(_,V+1),H<z.length-1&&o.jsx("span",{className:"json-comma",children:","})]},I)),`
