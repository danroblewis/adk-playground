 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */(function(e){function t(D,M){var w=D.length;D.push(M);e:for(;0<w;){var V=w-1>>>1,Q=D[V];if(0<i(Q,M))D[V]=M,D[w]=Q,w=V;else break e}}function n(D){return D.length===0?null:D[0]}function r(D){if(D.length===0)return null;var M=D[0],w=D.pop();if(w!==M){D[0]=w;e:for(var V=0,Q=D.length,h=Q>>>1;V<h;){var F=2*(V+1)-1,N=D[F],G=F+1,ge=D[G];if(0>i(N,w))G<Q&&0>i(ge,N)?(D[V]=ge,D[G]=w,V=G):(D[V]=N,D[F]=w,V=F);else if(G<Q&&0>i(ge,w))D[V]=ge,D[G]=w,V=G;else break e}}return M}function i(D,M){var w=D.sortIndex-M.sortIndex;return w!==0?w:D.id-M.id}if(typeof performance=="object"&&typeof performance.now=="function"){var o=performance;e.unstable_now=function(){return o.now()}}else{var a=Date,l=a.now();e.unstable_now=function(){return a.now()-l}}var c=[],u=[],d=1,p=null,f=3,m=!1,y=!1,_=!1,E=typeof setTimeout=="function"?setTimeout:null,v=typeof clearTimeout=="function"?clearTimeout:null,x=typeof setImmediate<"u"?setImmediate:null;typeof navigator<"u"&&navigator.scheduling!==void 0&&navigator.scheduling.isInputPending!==void 0&&navigator.scheduling.isInputPending.bind(navigator.scheduling);function g(D){for(var M=n(u);M!==null;){if(M.callback===null)r(u);else if(M.startTime<=D)r(u),M.sortIndex=M.expirationTime,t(c,M);else break;M=n(u)}}function P(D){if(_=!1,g(D),!y)if(n(c)!==null)y=!0,te(T);else{var M=n(u);M!==null&&z(P,M.startTime-D)}}function T(D,M){y=!1,_&&(_=!1,v(j),j=-1),m=!0;var w=f;try{for(g(M),p=n(c);p!==null&&(!(p.expirationTime>M)||D&&!L());){var V=p.callback;if(typeof V=="function"){p.callback=null,f=p.priorityLevel;var Q=V(p.expirationTime<=M);M=e.unstable_now(),typeof Q=="function"?p.callback=Q:p===n(c)&&r(c),g(M)}else r(c);p=n(c)}if(p!==null)var h=!0;else{var F=n(u);F!==null&&z(P,F.startTime-M),h=!1}return h}finally{p=null,f=w,m=!1}}var S=!1,C=null,j=-1,R=5,k=-1;function L(){return!(e.unstable_now()-k<R)}function O(){if(C!==null){var D=e.unstable_now();k=D;var M=!0;try{M=C(!0,D)}finally{M?W():(S=!1,C=null)}}else S=!1}var W;if(typeof x=="function")W=function(){x(O)};else if(typeof MessageChannel<"u"){var U=new MessageChannel,$=U.port2;U.port1.onmessage=O,W=function(){$.postMessage(null)}}else W=function(){E(O,0)};function te(D){C=D,S||(S=!0,W())}function z(D,M){j=E(function(){D(e.unstable_now())},M)}e.unstable_IdlePriority=5,e.unstable_ImmediatePriority=1,e.unstable_LowPriority=4,e.unstable_NormalPriority=3,e.unstable_Profiling=null,e.unstable_UserBlockingPriority=2,e.unstable_cancelCallback=function(D){D.callback=null},e.unstable_continueExecution=function(){y||m||(y=!0,te(T))},e.unstable_forceFrameRate=function(D){0>D||125<D?console.error("forceFrameRate takes a positive int between 0 and 125, forcing frame rates higher than 125 fps is not supported"):R=0<D?Math.floor(1e3/D):5},e.unstable_getCurrentPriorityLevel=function(){return f},e.unstable_getFirstCallbackNode=function(){return n(c)},e.unstable_next=function(D){switch(f){case 1:case 2:case 3:var M=3;break;default:M=f}var w=f;f=M;try{return D()}finally{f=w}},e.unstable_pauseExecution=function(){},e.unstable_requestPaint=function(){},e.unstable_runWithPriority=function(D,M){switch(D){case 1:case 2:case 3:case 4:case 5:break;default:D=3}var w=f;f=D;try{return M()}finally{f=w}},e.unstable_scheduleCallback=function(D,M,w){var V=e.unstable_now();switch(typeof w=="object"&&w!==null?(w=w.delay,w=typeof w=="number"&&0<w?V+w:V):w=V,D){case 1:var Q=-1;break;case 2:Q=250;break;case 5:Q=1073741823;break;case 4:Q=1e4;break;default:Q=5e3}return Q=w+Q,D={id:d++,callback:M,priorityLevel:D,startTime:w,expirationTime:Q,sortIndex:-1},w>V?(D.sortIndex=w,t(u,D),n(c)===null&&D===n(u)&&(_?(v(j),j=-1):_=!0,z(P,w-V))):(D.sortIndex=Q,t(c,D),y||m||(y=!0,te(T))),D},e.unstable_shouldYield=L,e.unstable_wrapCallback=function(D){var M=f;return function(){var w=f;f=M;try{return D.apply(this,arguments)}finally{f=w}}}})(im);sm.exports=im;var Ry=sm.exports;/**
 * @license React
 ...
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const Wg=de("FolderOpen",[["path",{d:"m6 14 1.5-2.9A2 2 0 0 1 9.24 10H20a2 2 0 0 1 1.94 2.5l-1.54 6a2 2 0 0 1-1.95 1.5H4a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h3.9a2 2 0 0 1 1.69.9l.81 1.2a2 2 0 0 0 1.67.9H18a2 2 0 0 1 2 2v2",key:"usdka0"}]]);/**
 * @license lucide-react v0.294.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
...
Your response (5-10 words only):`,M=await eo(t.id,e.id,D);if(M.success&&M.prompt){let w=M.prompt.trim();w=w.replace(/^["']|["']$/g,"").trim();const V=w.split(/[.!?\n]/)[0].trim(),Q=V.length>80?V.slice(0,77)+"...":V;g({description:Q})}else alert("Failed to generate description: "+(M.error||"Unknown error"))}catch(D){alert("Error generating description: "+D.message)}finally{f(!1)}}return s.jsxs("div",{className:"agent-editor",children:[s.jsx("style",{children:`
        .agent-editor {
          background: var(--bg-secondary);
          border: 1px solid var(--border-color);
          border-radius: var(--radius-lg);
...
def my_callback(tool: BaseTool, tool_args: Dict[str, Any], tool_context: ToolContext, result: Dict) -> Optional[Dict]:
    ...
    return None
`;default:return Qx("before_agent")}}function jC({onSelectCallback:e}){var j,R;const{project:t,updateProject:n,addCustomCallback:r,updateCustomCallback:i,removeCustomCallback:o}=ut(),[a,l]=b.useState(""),[c,u]=b.useState(null),[d,p]=b.useState(null),[f,m]=b.useState(!1),y=b.useRef(null);if(!t)return null;const _=t.custom_callbacks||[],E=_.find(k=>k.id===c);function v(k){u(k),e==null||e(k)}b.useEffect(()=>{E?(l(E.code),p(null)):l("")},[c,E]);function x(){const k=wC(),L={id:k,name:"new_callback",description:"",module_path:"callbacks.custom",code:Qx("before_agent"),state_keys_used:[]};r(L),v(k)}function g(k,L){L.stopPropagation(),confirm("Delete this callback?")&&(o(k),c===k&&(e==null||e(null),u(null),l("")))}function P(){if(!c)return;const k=_.find(W=>W.id===c);if(!k)return;const L=k.name.trim();if(!L){alert("Please enter a name");return}if(!Uf(L)){p("Name must contain only alphanumeric characters and underscores");return}if(_.find(W=>W.name===L&&W.id!==k.id)){p("A callback with this name already exists");return}i(k.id,{code:a,name:L,description:k.description,module_path:k.module_path,state_keys_used:k.state_keys_used}),p(null)}function T(k,L){y.current=L;try{Gx(L,{endpoint:"/api/code-completion",language:"python"})}catch(O){console.warn("Failed to register Monacopilot completion:",O)}}async function S(){if(E){m(!0);try{let k="before_agent";const L=E.name.toLowerCase(),O=E.description.toLowerCase();L.includes("after_agent")||O.includes("after agent")?k="after_agent":L.includes("before_model")||O.includes("before model")?k="before_model":L.includes("after_model")||O.includes("after model")?k="after_model":L.includes("before_tool")||O.includes("before tool")?k="before_tool":L.includes("after_tool")||O.includes("after tool")?k="after_tool":(L.includes("before_agent")||O.includes("before agent"))&&(k="before_agent");const W=await Mg(t.id,E.name,E.description,k,E.state_keys_used);W.success&&W.code?(l(W.code),i(E.id,{code:W.code})):(console.error("Failed to generate callback code:",W.error),alert("Failed to generate callback code: "+(W.error||"Unknown error")))}catch(k){console.error("Error generating callback code:",k),alert("Error generating callback code: "+k.message)}finally{m(!1)}}}const C=((R=(j=t.app)==null?void 0:j.state_keys)==null?void 0:R.map(k=>k.name))||[];return s.jsxs("div",{className:"tools-panel",children:[s.jsx("style",{children:`
        .tools-panel {
          display: flex;
          height: 100%;
          background: var(--bg-primary);
