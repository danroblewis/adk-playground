 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */(function(e){function t($,M){var j=$.length;$.push(M);e:for(;0<j;){var G=j-1>>>1,Q=$[G];if(0<i(Q,M))$[G]=M,$[j]=Q,j=G;else break e}}function n($){return $.length===0?null:$[0]}function r($){if($.length===0)return null;var M=$[0],j=$.pop();if(j!==M){$[0]=j;e:for(var G=0,Q=$.length,z=Q>>>1;G<z;){var ue=2*(G+1)-1,R=$[ue],ee=ue+1,H=$[ee];if(0>i(R,j))ee<Q&&0>i(H,R)?($[G]=H,$[ee]=j,G=ee):($[G]=R,$[ue]=j,G=ue);else if(ee<Q&&0>i(H,j))$[G]=H,$[ee]=j,G=ee;else break e}}return M}function i($,M){var j=$.sortIndex-M.sortIndex;return j!==0?j:$.id-M.id}if(typeof performance=="object"&&typeof performance.now=="function"){var o=performance;e.unstable_now=function(){return o.now()}}else{var a=Date,l=a.now();e.unstable_now=function(){return a.now()-l}}var c=[],u=[],d=1,p=null,f=3,m=!1,y=!1,b=!1,P=typeof setTimeout=="function"?setTimeout:null,x=typeof clearTimeout=="function"?clearTimeout:null,g=typeof setImmediate<"u"?setImmediate:null;typeof navigator<"u"&&navigator.scheduling!==void 0&&navigator.scheduling.isInputPending!==void 0&&navigator.scheduling.isInputPending.bind(navigator.scheduling);function h($){for(var M=n(u);M!==null;){if(M.callback===null)r(u);else if(M.startTime<=$)r(u),M.sortIndex=M.expirationTime,t(c,M);else break;M=n(u)}}function L($){if(b=!1,h($),!y)if(n(c)!==null)y=!0,X(C);else{var M=n(u);M!==null&&T(L,M.startTime-$)}}function C($,M){y=!1,b&&(b=!1,x(k),k=-1),m=!0;var j=f;try{for(h(M),p=n(c);p!==null&&(!(p.expirationTime>M)||$&&!v());){var G=p.callback;if(typeof G=="function"){p.callback=null,f=p.priorityLevel;var Q=G(p.expirationTime<=M);M=e.unstable_now(),typeof Q=="function"?p.callback=Q:p===n(c)&&r(c),h(M)}else r(c);p=n(c)}if(p!==null)var z=!0;else{var ue=n(u);ue!==null&&T(L,ue.startTime-M),z=!1}return z}finally{p=null,f=j,m=!1}}var w=!1,S=null,k=-1,A=5,N=-1;function v(){return!(e.unstable_now()-N<A)}function E(){if(S!==null){var $=e.unstable_now();N=$;var M=!0;try{M=S(!0,$)}finally{M?U():(w=!1,S=null)}}else w=!1}var U;if(typeof g=="function")U=function(){g(E)};else if(typeof MessageChannel<"u"){var V=new MessageChannel,B=V.port2;V.port1.onmessage=E,U=function(){B.postMessage(null)}}else U=function(){P(E,0)};function X($){S=$,w||(w=!0,U())}function T($,M){k=P(function(){$(e.unstable_now())},M)}e.unstable_IdlePriority=5,e.unstable_ImmediatePriority=1,e.unstable_LowPriority=4,e.unstable_NormalPriority=3,e.unstable_Profiling=null,e.unstable_UserBlockingPriority=2,e.unstable_cancelCallback=function($){$.callback=null},e.unstable_continueExecution=function(){y||m||(y=!0,X(C))},e.unstable_forceFrameRate=function($){0>$||125<$?console.error("forceFrameRate takes a positive int between 0 and 125, forcing frame rates higher than 125 fps is not supported"):A=0<$?Math.floor(1e3/$):5},e.unstable_getCurrentPriorityLevel=function(){return f},e.unstable_getFirstCallbackNode=function(){return n(c)},e.unstable_next=function($){switch(f){case 1:case 2:case 3:var M=3;break;default:M=f}var j=f;f=M;try{return $()}finally{f=j}},e.unstable_pauseExecution=function(){},e.unstable_requestPaint=function(){},e.unstable_runWithPriority=function($,M){switch($){case 1:case 2:case 3:case 4:case 5:break;default:$=3}var j=f;f=$;try{return M()}finally{f=j}},e.unstable_scheduleCallback=function($,M,j){var G=e.unstable_now();switch(typeof j=="object"&&j!==null?(j=j.delay,j=typeof j=="number"&&0<j?G+j:G):j=G,$){case 1:var Q=-1;break;case 2:Q=250;break;case 5:Q=1073741823;break;case 4:Q=1e4;break;default:Q=5e3}return Q=j+Q,$={id:d++,callback:M,priorityLevel:$,startTime:j,expirationTime:Q,sortIndex:-1},j>G?($.sortIndex=j,t(u,$),n(c)===null&&$===n(u)&&(b?(x(k),k=-1):b=!0,T(L,j-G))):($.sortIndex=Q,t(c,$),y||m||(y=!0,X(C))),$},e.unstable_shouldYield=v,e.unstable_wrapCallback=function($){var M=f;return function(){var j=f;f=M;try{return $.apply(this,arguments)}finally{f=j}}}})(xf);gf.exports=xf;var Rx=gf.exports;/**
 * @license React
 ...
 *
 * @license MIT
 */function qi(){return qi=Object.assign?Object.assign.bind():function(e){for(var t=1;t<arguments.length;t++){var n=arguments[t];for(var r in n)Object.prototype.hasOwnProperty.call(n,r)&&(e[r]=n[r])}return e},qi.apply(this,arguments)}var Nn;(function(e){e.Pop="POP",e.Push="PUSH",e.Replace="REPLACE"})(Nn||(Nn={}));const Dd="popstate";function Dv(e){e===void 0&&(e={});function t(r,i){let{pathname:o,search:a,hash:l}=r.location;return $l("",{pathname:o,search:a,hash:l},i.state&&i.state.usr||null,i.state&&i.state.key||"default")}function n(r,i){return typeof i=="string"?i:xh(i)}return Fv(t,n,null,e)}function Ve(e,t){if(e===!1||e===null||typeof e>"u")throw new Error(t)}function Zc(e,t){if(!e){typeof console<"u"&&console.warn(t);try{throw new Error(t)}catch{}}}function $v(){return Math.random().toString(36).substr(2,8)}function $d(e,t){return{usr:e.state,key:e.key,idx:t}}function $l(e,t,n,r){return n===void 0&&(n=null),qi({pathname:typeof e=="string"?e:e.pathname,search:"",hash:""},typeof t=="string"?Qr(t):t,{state:n,key:t&&t.key||r||$v()})}function xh(e){let{pathname:t="/",search:n="",hash:r=""}=e;return n&&n!=="?"&&(t+=n.charAt(0)==="?"?n:"?"+n),r&&r!=="#"&&(t+=r.charAt(0)==="#"?r:"#"+r),t}function Qr(e){let t={};if(e){let n=e.indexOf("#");n>=0&&(t.hash=e.substr(n),e=e.substr(0,n));let r=e.indexOf("?");r>=0&&(t.search=e.substr(r),e=e.substr(0,r)),e&&(t.pathname=e)}return t}function Fv(e,t,n,r){r===void 0&&(r={});let{window:i=document.defaultView,v5Compat:o=!1}=r,a=i.history,l=Nn.Pop,c=null,u=d();u==null&&(u=0,a.replaceState(qi({},a.state,{idx:u}),""));function d(){return(a.state||{idx:null}).idx}function p(){l=Nn.Pop;let P=d(),x=P==null?null:P-u;u=P,c&&c({action:l,location:b.location,delta:x})}function f(P,x){l=Nn.Push;let g=$l(b.location,P,x);u=d()+1;let h=$d(g,u),L=b.createHref(g);try{a.pushState(h,"",L)}catch(C){if(C instanceof DOMException&&C.name==="DataCloneError")throw C;i.location.assign(L)}o&&c&&c({action:l,location:b.location,delta:1})}function m(P,x){l=Nn.Replace;let g=$l(b.location,P,x);u=d();let h=$d(g,u),L=b.createHref(g);a.replaceState(h,"",L),o&&c&&c({action:l,location:b.location,delta:0})}function y(P){let x=i.location.origin!=="null"?i.location.origin:i.location.href,g=typeof P=="string"?P:xh(P);return g=g.replace(/ $/,"%20"),Ve(x,"No window.location.(origin|href) available to create URL for href: "+g),new URL(g,x)}let b={get action(){return l},get location(){return e(i,a)},listen(P){if(c)throw new Error("A history only accepts one active listener");return i.addEventListener(Dd,p),c=P,()=>{i.removeEventListener(Dd,p),c=null}},createHref(P){return t(i,P)},createURL:y,encodeLocation(P){let x=y(P);return{pathname:x.pathname,search:x.search,hash:x.hash}},push:f,replace:m,go(P){return a.go(P)}};return b}var Fd;(function(e){e.data="data",e.deferred="deferred",e.redirect="redirect",e.error="error"})(Fd||(Fd={}));function Bv(e,t,n){return n===void 0&&(n="/"),Uv(e,t,n)}function Uv(e,t,n,r){let i=typeof t=="string"?Qr(t):t,o=bh(i.pathname||"/",n);if(o==null)return null;let a=yh(e);Vv(a);let l=null;for(let c=0;l==null&&c<a.length;++c){let u=t1(o);l=Xv(a[c],u)}return l}function yh(e,t,n,r){t===void 0&&(t=[]),n===void 0&&(n=[]),r===void 0&&(r="");let i=(o,a,l)=>{let c={relativePath:l===void 0?o.path||"":l,caseSensitive:o.caseSensitive===!0,childrenIndex:a,route:o};c.relativePath.startsWith("/")&&(Ve(c.relativePath.startsWith(r),'Absolute route path "'+c.relativePath+'" nested under path '+('"'+r+'" is not valid. An absolute child route path ')+"must start with the combined path of all its parent routes."),c.relativePath=c.relativePath.slice(r.length));let u=tr([r,c.relativePath]),d=n.concat(c);o.children&&o.children.length>0&&(Ve(o.index!==!0,"Index routes must not have child routes. Please remove "+('all child routes from route path "'+u+'".')),yh(o.children,t,d,u)),!(o.path==null&&!o.index)&&t.push({path:u,score:Qv(u,o.index),routesMeta:d})};return e.forEach((o,a)=>{var l;if(o.path===""||!((l=o.path)!=null&&l.includes("?")))i(o,a);else for(let c of vh(o.path))i(o,a,c)}),t}function vh(e){let t=e.split("/");if(t.length===0)return[];let[n,...r]=t,i=n.endsWith("?"),o=n.replace(/\?$/,"");if(r.length===0)return i?[o,""]:[o];let a=vh(r.join("/")),l=[];return l.push(...a.map(c=>c===""?o:[o,c].join("/"))),i&&l.push(...a),l.map(c=>e.startsWith("/")&&c===""?"/":c)}function Vv(e){e.sort((t,n)=>t.score!==n.score?n.score-t.score:Yv(t.routesMeta.map(r=>r.childrenIndex),n.routesMeta.map(r=>r.childrenIndex)))}const Wv=/^:[\w-]+$/,Hv=3,qv=2,Jv=1,Gv=10,Kv=-2,Bd=e=>e==="*";function Qv(e,t){let n=e.split("/"),r=n.length;return n.some(Bd)&&(r+=Kv),t&&(r+=qv),n.filter(i=>!Bd(i)).reduce((i,o)=>i+(Wv.test(o)?Hv:o===""?Jv:Gv),r)}function Yv(e,t){return e.length===t.length&&e.slice(0,-1).every((r,i)=>r===t[i])?e[e.length-1]-t[t.length-1]:0}function Xv(e,t,n){let{routesMeta:r}=e,i={},o="/",a=[];for(let l=0;l<r.length;++l){let c=r[l],u=l===r.length-1,d=o==="/"?t:t.slice(o.length)||"/",p=Zv({path:c.relativePath,caseSensitive:c.caseSensitive,end:u},d),f=c.route;if(!p)return null;Object.assign(i,p.params),a.push({params:i,pathname:tr([o,p.pathname]),pathnameBase:o1(tr([o,p.pathnameBase])),route:f}),p.pathnameBase!=="/"&&(o=tr([o,p.pathnameBase]))}return a}function Zv(e,t){typeof e=="string"&&(e={path:e,caseSensitive:!1,end:!0});let[n,r]=e1(e.path,e.caseSensitive,e.end),i=t.match(n);if(!i)return null;let o=i[0],a=o.replace(/(.)\/+$/,"$1"),l=i.slice(1);return{params:r.reduce((u,d,p)=>{let{paramName:f,isOptional:m}=d;if(f==="*"){let b=l[p]||"";a=o.slice(0,o.length-b.length).replace(/(.)\/+$/,"$1")}const y=l[p];return m&&!y?u[f]=void 0:u[f]=(y||"").replace(/%2F/g,"/"),u},{}),pathname:o,pathnameBase:a,pattern:e}}function e1(e,t,n){t===void 0&&(t=!1),n===void 0&&(n=!0),Zc(e==="*"||!e.endsWith("*")||e.endsWith("/*"),'Route path "'+e+'" will be treated as if it were '+('"'+e.replace(/\*$/,"/*")+'" because the `*` character must ')+"always follow a `/` in the pattern. To get rid of this warning, "+('please change the route path to "'+e.replace(/\*$/,"/*")+'".'));let r=[],i="^"+e.replace(/\/*\*?$/,"").replace(/^\/*/,"/").replace(/[\\.*+^${}|()[\]]/g,"\\$&").replace(/\/:([\w-]+)(\?)?/g,(a,l,c)=>(r.push({paramName:l,isOptional:c!=null}),c?"/?([^\\/]+)?":"/([^\\/]+)"));return e.endsWith("*")?(r.push({paramName:"*"}),i+=e==="*"||e==="/*"?"(.*)$":"(?:\\/(.+)|\\/*)$"):n?i+="\\/*$":e!==""&&e!=="/"&&(i+="(?:(?=\\/|$))"),[new RegExp(i,t?void 0:"i"),r]}function t1(e){try{return e.split("/").map(t=>decodeURIComponent(t).replace(/\//g,"%2F")).join("/")}catch(t){return Zc(!1,'The URL path "'+e+'" could not be decoded because it is is a malformed URL segment. This is probably due to a bad percent '+("encoding ("+t+").")),e}}function bh(e,t){if(t==="/")return e;if(!e.toLowerCase().startsWith(t.toLowerCase()))return null;let n=t.endsWith("/")?t.length-1:t.length,r=e.charAt(n);return r&&r!=="/"?null:e.slice(n)||"/"}const n1=/^(?:[a-z][a-z0-9+.-]*:|\/\/)/i,r1=e=>n1.test(e);function i1(e,t){t===void 0&&(t="/");let{pathname:n,search:r="",hash:i=""}=typeof e=="string"?Qr(e):e,o;if(n)if(r1(n))o=n;else{if(n.includes("//")){let a=n;n=n.replace(/\/\/+/g,"/"),Zc(!1,"Pathnames cannot have embedded double slashes - normalizing "+(a+" -> "+n))}n.startsWith("/")?o=Ud(n.substring(1),"/"):o=Ud(n,t)}else o=t;return{pathname:o,search:a1(r),hash:l1(i)}}function Ud(e,t){let n=t.replace(/\/+$/,"").split("/");return e.split("/").forEach(i=>{i===".."?n.length>1&&n.pop():i!=="."&&n.push(i)}),n.length>1?n.join("/"):"/"}function Ca(e,t,n,r){return"Cannot include a '"+e+"' character in a manually specified "+("`to."+t+"` field ["+JSON.stringify(r)+"].  Please separate it out to the ")+("`to."+n+"` field. Alternatively you may provide the full path as ")+'a string in <Link to="..."> and the router will parse it for you.'}function s1(e){return e.filter((t,n)=>n===0||t.route.path&&t.route.path.length>0)}function kh(e,t){let n=s1(e);return t?n.map((r,i)=>i===n.length-1?r.pathname:r.pathnameBase):n.map(r=>r.pathnameBase)}function wh(e,t,n,r){r===void 0&&(r=!1);let i;typeof e=="string"?i=Qr(e):(i=qi({},e),Ve(!i.pathname||!i.pathname.includes("?"),Ca("?","pathname","search",i)),Ve(!i.pathname||!i.pathname.includes("#"),Ca("#","pathname","hash",i)),Ve(!i.search||!i.search.includes("#"),Ca("#","search","hash",i)));let o=e===""||i.pathname==="",a=o?"/":i.pathname,l;if(a==null)l=n;else{let p=t.length-1;if(!r&&a.startsWith("..")){let f=a.split("/");for(;f[0]==="..";)f.shift(),p-=1;i.pathname=f.join("/")}l=p>=0?t[p]:"/"}let c=i1(i,l),u=a&&a!=="/"&&a.endsWith("/"),d=(o||a===".")&&n.endsWith("/");return!c.pathname.endsWith("/")&&(u||d)&&(c.pathname+="/"),c}const tr=e=>e.join("/").replace(/\/\/+/g,"/"),o1=e=>e.replace(/\/+$/,"").replace(/^\/*/,"/"),a1=e=>!e||e==="?"?"":e.startsWith("?")?e:"?"+e,l1=e=>!e||e==="#"?"":e.startsWith("#")?e:"#"+e;function c1(e){return e!=null&&typeof e.status=="number"&&typeof e.statusText=="string"&&typeof e.internal=="boolean"&&"data"in e}const jh=["post","put","patch","delete"];new Set(jh);const u1=["get",...jh];new Set(u1);/**
 ...
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const Gi=le("Eye",[["path",{d:"M2 12s3-7 10-7 10 7 10 7-3 7-10 7-10-7-10-7Z",key:"rwhkz3"}],["circle",{cx:"12",cy:"12",r:"3",key:"1v7zrd"}]]);/**
 * @license lucide-react v0.294.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 ...
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const Qd=le("Folder",[["path",{d:"M20 20a2 2 0 0 0 2-2V8a2 2 0 0 0-2-2h-7.9a2 2 0 0 1-1.69-.9L9.6 3.9A2 2 0 0 0 7.93 3H4a2 2 0 0 0-2 2v13a2 2 0 0 0 2 2Z",key:"1kt360"}]]);/**
 * @license lucide-react v0.294.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
...
`).length,m=Math.max(r,Math.min(f*20+40,500));l(m)}},[e,r]),_.useEffect(()=>{i&&u.current&&u.current.focus()},[i]);function d(f){u.current=f,f.focus()}function p(f){c.current&&!c.current.contains(f.target)&&o(!1)}return _.useEffect(()=>{if(i)return document.addEventListener("mousedown",p),()=>document.removeEventListener("mousedown",p)},[i]),s.jsxs("div",{ref:c,className:"markdown-editor",children:[s.jsx("style",{children:`
      ...
      `}),i?s.jsx("div",{className:"monaco-wrapper",children:s.jsx(Wt,{height:"100%",language:"markdown",theme:"vs-dark",value:e,onChange:f=>t(f||""),onMount:d,options:{minimap:{enabled:!1},fontSize:14,fontFamily:"'JetBrains Mono', monospace",lineNumbers:"off",scrollBeyondLastLine:!1,automaticLayout:!0,wordWrap:"on",padding:{top:12,bottom:12},lineDecorationsWidth:8,folding:!1,glyphMargin:!1,renderLineHighlight:"none",overviewRulerLanes:0,hideCursorInOverviewRuler:!0,scrollbar:{vertical:"auto",horizontal:"hidden"}}})}):s.jsxs("div",{className:"markdown-preview",onClick:()=>o(!0),children:[s.jsxs("span",{className:"edit-hint",children:[s.jsx(v0,{size:12}),"Click to edit"]}),e?s.jsx("div",{className:"markdown-content",children:s.jsx(nx,{children:e})}):s.jsx("div",{className:"markdown-placeholder",children:n})]})]})}function P2(e){return/^[a-zA-Z0-9_]+$/.test(e)}function L2({agent:e}){const{project:t,updateAgent:n,mcpServers:r,builtinTools:i,setActiveTab:o,setRunAgentId:a}=st(),[l,c]=_.useState(new Set(["basic","model","tools","subagents"])),[u,d]=_.useState(!1),[p,f]=_.useState(!1),[m,y]=_.useState(!1),[b,P]=_.useState(""),[x,g]=_.useState(null);if(!t)return null;function h(T){n(e.id,T)}function L(T){if(T===""){g(null),h({name:T});return}P2(T)?g(null):g("Name can only contain letters, numbers, and underscores"),h({name:T})}function C(T){const $=new Set(l);$.has(T)?$.delete(T):$.add(T),c($)}const w=e.type==="LlmAgent",S=e;function k(T){w&&h({tools:[...S.tools,T]})}function A(T){w&&h({tools:S.tools.filter(($,M)=>M!==T)})}function N(T,$){if(!w)return;const M=[...S.tools];M[T]=$,h({tools:M})}function v(T){"sub_agents"in e&&h({sub_agents:[...e.sub_agents,T]})}function E(T){"sub_agents"in e&&h({sub_agents:e.sub_agents.filter($=>$!==T)})}const U=t.agents.filter(T=>T.id!==e.id);async function V(){if(!(!t||!w)){d(!0);try{const T=S.instruction||"",$=T?`Current instruction to improve:

${T}

Please improve and expand this instruction while preserving its core intent.`:void 0,j=t.agents.some(Q=>Q.id===e.id)?void 0:e,G=await Vs(t.id,e.id,$,j);G.success&&G.prompt?h({instruction:G.prompt}):alert("Failed to generate prompt: "+(G.error||"Unknown error"))}catch(T){alert("Error generating prompt: "+T.message)}finally{d(!1)}}}async function B(){if(!(!t||!w||!b.trim())){d(!0);try{const $=`Current instruction:
...
Please apply the requested changes to the instruction above. Output only the updated instruction, nothing else.`,j=t.agents.some(Q=>Q.id===e.id)?void 0:e,G=await Vs(t.id,e.id,$,j);G.success&&G.prompt?(h({instruction:G.prompt}),y(!1),P("")):alert("Failed to apply changes: "+(G.error||"Unknown error"))}catch(T){alert("Error applying changes: "+T.message)}finally{d(!1)}}}async function X(){if(!t||!w)return;const T=S.instruction;if(!T){alert("Please write an instruction first");return}f(!0);try{const $=`Write a 5-10 word description of what this agent does.
...
Your response (5-10 words only):`,M=await Vs(t.id,e.id,$);if(M.success&&M.prompt){let j=M.prompt.trim();j=j.replace(/^["']|["']$/g,"").trim();const G=j.split(/[.!?\n]/)[0].trim(),Q=G.length>80?G.slice(0,77)+"...":G;h({description:Q})}else alert("Failed to generate description: "+(M.error||"Unknown error"))}catch($){alert("Error generating description: "+$.message)}finally{f(!1)}}return s.jsxs("div",{className:"agent-editor",children:[s.jsx("style",{children:`
        .agent-editor {
          background: var(--bg-secondary);
          border: 1px solid var(--border-color);
          border-radius: var(--radius-lg);
      ...
      `}),s.jsxs("div",{className:"editor-header",children:[s.jsx(nr,{size:24,style:{color:"var(--accent-primary)"}}),s.jsxs("div",{style:{flex:1,display:"flex",flexDirection:"column",gap:4},children:[s.jsx("input",{type:"text",value:e.name,onChange:T=>L(T.target.value),placeholder:"Agent name",style:{borderColor:x?"var(--error)":void 0}}),x&&s.jsx("span",{style:{fontSize:11,color:"var(--error)",marginTop:-4},children:x})]}),s.jsx("span",{className:"badge badge-info",children:e.type}),s.jsxs("button",{className:"btn btn-primary btn-sm run-agent-btn",onClick:()=>{a(e.id),o("run")},title:"Test this agent",children:[s.jsx(Fn,{size:14}),"Run"]})]}),s.jsxs("div",{className:"editor-content",children:[s.jsxs(ci,{id:"basic",title:"Basic Info",icon:s.jsx(nr,{size:16}),expanded:l.has("basic"),onToggle:()=>C("basic"),children:[s.jsx("div",{className:"form-row",children:s.jsxs("div",{className:"form-group full-width",children:[s.jsxs("div",{className:"label-with-action",children:[s.jsx("label",{children:"Description"}),w&&S.instruction&&s.jsx("button",{className:"btn btn-secondary btn-sm generate-btn",onClick:X,disabled:p,title:"Generate description from instruction",children:p?s.jsxs(s.Fragment,{children:[s.jsx(Hr,{size:14,className:"spin"}),"Summarizing..."]}):"Summarize"})]}),s.jsx("input",{type:"text",value:e.description,onChange:T=>h({description:T.target.value}),placeholder:"e.g., Reviews code for bugs and suggests fixes"})]})}),w&&s.jsxs(s.Fragment,{children:[s.jsx("div",{className:"form-row",children:s.jsxs("div",{className:"form-group full-width",children:[s.jsxs("div",{className:"label-with-action",children:[s.jsx("label",{children:"Instruction"}),s.jsxs("div",{className:"action-buttons",children:[s.jsx("button",{className:"btn btn-secondary btn-sm",onClick:()=>y(!m),disabled:u||!S.instruction,title:"Request specific changes to the instruction",children:"Request Changes"}),s.jsx("button",{className:"btn btn-secondary btn-sm",onClick:V,disabled:u,title:"Uses AI to improve and expand the current instruction",children:u?s.jsxs(s.Fragment,{children:[s.jsx(Hr,{size:14,className:"spin"}),"Working..."]}):"Auto-Improve"})]})]}),m&&s.jsxs("div",{className:"request-changes-box",children:[s.jsx("input",{type:"text",value:b,onChange:T=>P(T.target.value),placeholder:"Describe what changes you want...",onKeyDown:T=>{T.key==="Enter"&&b.trim()?B():T.key==="Escape"&&(y(!1),P(""))},autoFocus:!0}),s.jsx("button",{className:"btn btn-primary btn-sm",onClick:B,disabled:u||!b.trim(),children:"Apply"})]}),s.jsx(T2,{value:S.instruction,onChange:T=>h({instruction:T}),placeholder:"Write your agent's instruction here... (Markdown supported)",minHeight:200})]})}),s.jsxs("div",{className:"form-row",children:[s.jsxs("div",{className:"form-group",children:[s.jsx("label",{children:"Output Key"}),s.jsxs("select",{value:S.output_key||"",onChange:T=>h({output_key:T.target.value||void 0}),children:[s.jsx("option",{value:"",children:"None"}),t.app.state_keys.map(T=>s.jsx("option",{value:T.name,children:T.name},T.name))]})]}),s.jsxs("div",{className:"form-group",children:[s.jsx("label",{children:"Include Contents"}),s.jsxs("select",{value:S.include_contents,onChange:T=>h({include_contents:T.target.value}),children:[s.jsx("option",{value:"default",children:"Default"}),s.jsx("option",{value:"none",children:"None"})]})]})]}),s.jsxs("div",{className:"form-row",style:{gap:24},children:[s.jsxs("label",{style:{display:"flex",alignItems:"center",gap:8,fontSize:13},children:[s.jsxs("span",{className:"toggle-switch",children:[s.jsx("input",{type:"checkbox",checked:S.disallow_transfer_to_parent,onChange:T=>h({disallow_transfer_to_parent:T.target.checked})}),s.jsx("span",{className:"toggle-slider"})]}),"Disallow transfer to parent"]}),s.jsxs("label",{style:{display:"flex",alignItems:"center",gap:8,fontSize:13},children:[s.jsxs("span",{className:"toggle-switch",children:[s.jsx("input",{type:"checkbox",checked:S.disallow_transfer_to_peers,onChange:T=>h({disallow_transfer_to_peers:T.target.checked})}),s.jsx("span",{className:"toggle-slider"})]}),"Disallow transfer to peers"]})]})]}),e.type==="LoopAgent"&&s.jsx("div",{className:"form-row",children:s.jsxs("div",{className:"form-group",children:[s.jsx("label",{children:"Max Iterations"}),s.jsx("input",{type:"number",value:e.max_iterations||"",onChange:T=>h({max_iterations:parseInt(T.target.value)||void 0}),placeholder:"No limit"})]})})]}),w&&s.jsx(ci,{id:"model",title:"Model",icon:s.jsx(iu,{size:16}),expanded:l.has("model"),onToggle:()=>C("model"),children:s.jsx(R2,{agent:S,appModels:t.app.models||[],defaultModelId:t.app.default_model_id,projectId:t.id,onUpdate:T=>h({model:T})})}),w&&s.jsx(ci,{id:"tools",title:`Tools (${S.tools.length})`,icon:s.jsx(Jt,{size:16}),expanded:l.has("tools"),onToggle:()=>C("tools"),children:s.jsx(A2,{tools:S.tools,onAdd:k,onRemove:A,onUpdate:N,builtinTools:i,mcpServers:r,projectMcpServers:t.mcp_servers,customTools:t.custom_tools,agents:U,skillsets:t.skillsets||[]})}),"sub_agents"in e&&s.jsx(ci,{id:"subagents",title:`Sub-Agents (${e.sub_agents.length})`,icon:s.jsx(lg,{size:16}),expanded:l.has("subagents"),onToggle:()=>C("subagents"),children:s.jsxs("div",{className:"sub-agent-list",children:[e.sub_agents.map(T=>{const $=t.agents.find(M=>M.id===T);return $?s.jsxs("div",{className:"sub-agent-chip",children:[$.name,s.jsx("button",{onClick:()=>E(T),children:s.jsx(Ae,{size:12})})]},T):null}),s.jsxs("select",{value:"",onChange:T=>{T.target.value&&v(T.target.value)},style:{width:150,padding:"6px 10px",fontSize:13},children:[s.jsx("option",{value:"",children:"Add agent..."}),U.filter(T=>!e.sub_agents.includes(T.id)).map(T=>s.jsx("option",{value:T.id,children:T.name},T.id))]})]})}),w&&s.jsx(ci,{id:"callbacks",title:"Callbacks",icon:s.jsx(rn,{size:16}),expanded:l.has("callbacks"),onToggle:()=>C("callbacks"),children:s.jsx(M2,{agent:S,onUpdate:h,customCallbacks:t.custom_callbacks||[]})})]})]})}function ci({id:e,title:t,icon:n,expanded:r,onToggle:i,children:o}){return s.jsxs("div",{className:"section",children:[s.jsxs("div",{className:"section-header",onClick:i,children:[r?s.jsx(Tt,{size:16}):s.jsx(Pt,{size:16}),s.jsxs("h4",{children:[n," ",t]})]}),r&&s.jsx("div",{className:"section-content",children:o})]})}function A2({tools:e,onAdd:t,onRemove:n,onUpdate:r,builtinTools:i,mcpServers:o,projectMcpServers:a,customTools:l,agents:c,skillsets:u}){const[d,p]=_.useState(!1),[f,m]=_.useState({}),[y,b]=_.useState(""),P=Ot.useRef(null),x=Ot.useRef(null),[g,h]=_.useState(null),[L,C]=_.useState(new Set),w=(R,ee)=>{if(!y.trim())return!0;const H=y.toLowerCase();return R.toLowerCase().includes(H)||((ee==null?void 0:ee.toLowerCase().includes(H))??!1)},S=i.filter(R=>w(R.name,R.description)),k=o.filter(R=>w(R.name,R.description)),A=a.filter(R=>w(R.name,R.description)),N=l.filter(R=>w(R.name,R.description)),v=c.filter(R=>w(R.name,R.description)),E=u.filter(R=>w(R.name,R.description));function U(){if(P.current){const R=P.current.getBoundingClientRect(),ee=window.innerHeight,H=350,ne=ee-R.bottom-16,ae=R.top-16;if(ne>=200||ne>=ae){const I=Math.min(H,ne);m({top:R.bottom+4,left:R.left,maxHeight:I})}else{const I=Math.min(H,ae);m({top:R.top-I-4,left:R.left,maxHeight:I})}}p(!0),b(""),setTimeout(()=>{var R;return(R=x.current)==null?void 0:R.focus()},50)}function V(){p(!1),b("")}function B(R){t({type:"builtin",name:R}),V()}async function X(R){V();const ee=R.tool_filter||[];if(h({server:R,enabledTools:new Set(ee),availableTools:ee.map(H=>({name:H,description:""})),isLoading:ee.length===0,error:void 0}),ee.length===0)try{const{testMcpServer:H}=await M0(async()=>{const{testMcpServer:ae}=await Promise.resolve().then(()=>a0);return{testMcpServer:ae}},void 0),ne=await H({connection_type:R.connection_type,command:R.command,args:R.args,env:R.env,url:R.url,headers:R.headers,timeout:R.timeout||30});ne.success?h(ae=>ae?{...ae,availableTools:ne.tools,enabledTools:new Set(ne.tools.map(I=>I.name)),isLoading:!1}:null):h(ae=>ae?{...ae,isLoading:!1,error:ne.error||"Failed to connect to MCP server"}:null)}catch(H){h(ne=>ne?{...ne,isLoading:!1,error:H.message}:null)}}function T(R){if(!g)return;const ee=new Set(g.enabledTools);ee.has(R)?ee.delete(R):ee.add(R),h({...g,enabledTools:ee})}function $(){if(!g)return;const R=Array.from(g.enabledTools);t({type:"mcp",server:{...g.server,tool_filter:R}}),h(null)}function M(R){const ee=new Set(L);ee.has(R)?ee.delete(R):ee.add(R),C(ee)}function j(R,ee){const H=e[R];if(H.type!=="mcp"||!H.server)return;const ne=H.server.tool_filter||[];let ae;ne.includes(ee)?ae=ne.filter(I=>I!==ee):ae=[...ne,ee],r(R,{...H,server:{...H.server,tool_filter:ae}})}function G(R){t({type:"function",name:R.name,module_path:R.module_path}),V()}function Q(R){const ee=c.find(H=>H.id===R);t({type:"agent",agent_id:R,name:ee==null?void 0:ee.name}),V()}function z(R){const ee=u.find(H=>H.id===R);t({type:"skillset",skillset_id:R,name:ee==null?void 0:ee.name}),V()}function ue(R){return o.find(ee=>ee.name===R)}return s.jsxs("div",{children:[s.jsx("style",{children:`
        .mcp-tool-item {
          border: 1px solid var(--border-color);
          border-radius: var(--radius-md);
          overflow: hidden;
      ...
      `}),t.length>0&&s.jsxs("div",{className:"model-choice",children:[s.jsxs("div",{className:`model-option ${a?"":"selected"}`,onClick:()=>!a||d(),children:[s.jsx("div",{className:"model-option-label",children:"Use App Model"}),s.jsx("div",{className:"model-option-desc",children:"Select from configured models"})]}),s.jsxs("div",{className:`model-option ${a?"selected":""}`,onClick:()=>a||d(),children:[s.jsx("div",{className:"model-option-label",children:"Custom"}),s.jsx("div",{className:"model-option-desc",children:"Configure model manually"})]})]}),!a&&t.length>0?s.jsx("div",{className:"app-model-select",children:t.map(y=>s.jsx("div",{className:`app-model-item ${c===y.id?"selected":""}`,onClick:()=>u(y.id),children:s.jsxs("div",{className:"app-model-item-info",children:[s.jsxs("div",{className:"app-model-item-name",children:[y.name,y.id===n&&s.jsxs("span",{className:"default-badge",children:[s.jsx(ag,{size:10,fill:"currentColor"}),"Default"]})]}),s.jsxs("div",{className:"app-model-item-details",children:[y.provider," / ",y.model_name,y.api_base&&` • ${y.api_base}`]})]})},y.id))}):t.length===0?s.jsx("div",{className:"no-models-message",children:"No models configured in App Config. Configure models there first, or use custom settings below."}):null,(a||t.length===0)&&s.jsx("div",{className:"custom-model-form",children:s.jsx(dg,{projectId:r,values:e.model||{},onChange:p})})]})}function M2({agent:e,onUpdate:t,customCallbacks:n}){const r=[{key:"before_agent_callbacks",label:"Before Agent"},{key:"after_agent_callbacks",label:"After Agent"},{key:"before_model_callbacks",label:"Before Model"},{key:"after_model_callbacks",label:"After Model"},{key:"before_tool_callbacks",label:"Before Tool"},{key:"after_tool_callbacks",label:"After Tool"}];function i(a,l){const c=e[a]||[],u=n.find(d=>d.id===l);u&&t({[a]:[...c,{module_path:u.module_path}]})}function o(a,l){const c=e[a]||[];t({[a]:c.filter((u,d)=>d!==l)})}return s.jsx("div",{className:"callbacks-editor",children:r.map(({key:a,label:l})=>{const c=e[a]||[],u=n;return s.jsxs("div",{className:"callback-type-group",style:{marginBottom:"20px"},children:[s.jsxs("div",{style:{display:"flex",alignItems:"center",justifyContent:"space-between",marginBottom:"8px"},children:[s.jsx("label",{style:{fontWeight:500,fontSize:"13px"},children:l}),u.length>0&&s.jsxs("select",{value:"",onChange:d=>{d.target.value&&(i(a,d.target.value),d.target.value="")},style:{padding:"4px 8px",fontSize:"12px",width:"200px"},children:[s.jsx("option",{value:"",children:"Add callback..."}),u.filter(d=>{const p=d.module_path;return!c.some(f=>f.module_path===p)}).map(d=>s.jsx("option",{value:d.id,children:d.name},d.id))]})]}),c.length===0?s.jsx("div",{style:{fontSize:"12px",color:"var(--text-secondary)",fontStyle:"italic",padding:"8px"},children:"No callbacks"}):s.jsx("div",{className:"callback-list",children:c.map((d,p)=>{const f=n.find(m=>m.module_path===d.module_path);return s.jsxs("div",{className:"callback-chip",style:{display:"flex",alignItems:"center",justifyContent:"space-between",padding:"6px 10px",background:"var(--bg-secondary)",borderRadius:"4px",marginBottom:"4px"},children:[s.jsx("span",{style:{fontSize:"12px"},children:(f==null?void 0:f.name)||d.module_path}),s.jsx("button",{onClick:()=>o(a,p),style:{background:"none",border:"none",cursor:"pointer",padding:"2px",display:"flex",alignItems:"center"},title:"Remove callback",children:s.jsx(Ae,{size:12})})]},p)})})]},a)})})}const Va=[{type:"LlmAgent",label:"LLM Agent",icon:nr,color:"#00f5d4",description:"AI-powered agent with model reasoning"},{type:"SequentialAgent",label:"Sequential",icon:_0,color:"#7b2cbf",description:"Run sub-agents in order"},{type:"LoopAgent",label:"Loop",icon:k0,color:"#ffd93d",description:"Repeat sub-agents until exit"},{type:"ParallelAgent",label:"Parallel",icon:Vl,color:"#ff6b6b",description:"Run sub-agents simultaneously"}];function O2(){return`agent_${Date.now().toString(36)}`}function I2(e){return{provider:e.provider,model_name:e.model_name,api_base:e.api_base,temperature:e.temperature,max_output_tokens:e.max_output_tokens,top_p:e.top_p,top_k:e.top_k,fallbacks:[]}}function D2(e,t){const r={id:O2(),name:`New ${e}`,description:""},i=t?I2(t):{provider:"gemini",model_name:"gemini-2.0-flash",fallbacks:[]};switch(e){case"LlmAgent":return{...r,type:"LlmAgent",model:i,instruction:"",include_contents:"default",disallow_transfer_to_parent:!1,disallow_transfer_to_peers:!1,tools:[],sub_agents:[],before_agent_callbacks:[],after_agent_callbacks:[],before_model_callbacks:[],after_model_callbacks:[],before_tool_callbacks:[],after_tool_callbacks:[]};case"SequentialAgent":return{...r,type:"SequentialAgent",sub_agents:[]};case"LoopAgent":return{...r,type:"LoopAgent",sub_agents:[],max_iterations:10};case"ParallelAgent":return{...r,type:"ParallelAgent",sub_agents:[]};default:throw new Error(`Unknown agent type: ${e}`)}}function $2({onSelectAgent:e}){const{project:t,addAgent:n,removeAgent:r,updateAgent:i,selectedAgentId:o,setSelectedAgentId:a,mcpServers:l}=st(),[c,u]=_.useState(new Set),[d,p]=_.useState(!1),[f,m]=_.useState(""),[y,b]=_.useState(new Map),[P,x]=_.useState(320),[g,h]=_.useState(!1),L=_.useRef(null),[C,w]=_.useState(null),S=_.useRef(null),[k,A]=_.useState(null),N=_.useRef(null),v=_.useRef(null),E=_.useCallback(O=>{O.preventDefault(),h(!0)},[]);if(_.useEffect(()=>{const O=F=>{if(!g)return;const K=Math.min(Math.max(200,F.clientX),600);x(K)},D=()=>{h(!1)};return g&&(document.addEventListener("mousemove",O),document.addEventListener("mouseup",D),document.body.style.cursor="col-resize",document.body.style.userSelect="none"),()=>{document.removeEventListener("mousemove",O),document.removeEventListener("mouseup",D),document.body.style.cursor="",document.body.style.userSelect=""}},[g]),_.useEffect(()=>{if(t){const O=t.agents.filter(D=>"sub_agents"in D&&D.sub_agents.length>0).map(D=>D.id);u(new Set(O))}},[t==null?void 0:t.id,t==null?void 0:t.agents.length]),!t)return null;function U(){if(!f.trim()||!t)return;const O=`generating_${Date.now()}`,D=f;b(F=>new Map(F).set(O,D)),p(!1),m(""),Hh(t.id,D).then(F=>{var K,re,me,W;if(F.success&&F.config){const ce=F.config,ve=[];if((K=ce.tools)!=null&&K.builtin)for(const Ge of ce.tools.builtin)ve.push({type:"builtin",name:Ge});if((re=ce.tools)!=null&&re.mcp)for(const Ge of ce.tools.mcp){const Ie=l.find(we=>we.name===Ge.server);Ie&&ve.push({type:"mcp",server:{...Ie,tool_filter:Ge.tools}})}if((me=ce.tools)!=null&&me.custom)for(const Ge of ce.tools.custom){const Ie=t.custom_tools.find(we=>we.name===Ge);Ie&&ve.push({type:"function",name:Ge,module_path:Ie.module_path})}if((W=ce.tools)!=null&&W.agents)for(const Ge of ce.tools.agents){const Ie=t.agents.find(we=>we.id===Ge);Ie&&ve.push({type:"agent",agent_id:Ge,name:Ie.name})}const Je=t.app.models||[],We=Je.find(Ge=>Ge.id===t.app.default_model_id)||Je[0],on={id:`agent_${Date.now().toString(36)}`,type:"LlmAgent",name:ce.name||"new_agent",description:ce.description||"",instruction:ce.instruction||"",model:We?{provider:We.provider,model_name:We.model_name,api_base:We.api_base,temperature:We.temperature,max_output_tokens:We.max_output_tokens,top_p:We.top_p,top_k:We.top_k,fallbacks:[]}:{provider:"gemini",model_name:"gemini-2.0-flash",fallbacks:[]},include_contents:"default",disallow_transfer_to_parent:!1,disallow_transfer_to_peers:!1,tools:ve,sub_agents:ce.sub_agents||[],before_agent_callbacks:[],after_agent_callbacks:[],before_model_callbacks:[],after_model_callbacks:[],before_tool_callbacks:[],after_tool_callbacks:[]};n(on),a(on.id),e==null||e(on.id)}else console.error("Failed to generate agent:",F.error)}).catch(F=>{console.error("Error generating agent:",F)}).finally(()=>{b(F=>{const K=new Map(F);return K.delete(O),K})})}const V=t.agents.find(O=>O.id===o);function B(O){a(O),e==null||e(O)}function X(O){const D=t.app.models||[],F=D.find(re=>re.id===t.app.default_model_id)||D[0],K=D2(O,F);n(K),B(K.id),setShowTypeSelector(!1)}function T(O,D){D.stopPropagation(),confirm("Delete this agent?")&&(r(O),o===O&&(e==null||e(null)))}function $(O){const D=new Set(c);D.has(O)?D.delete(O):D.add(O),u(D)}function M(O){if(console.log("[DRAG] handleListDragOver called, draggedAgentIdRef:",S.current),!N.current){console.log("[DRAG] No agentsListRef");return}if(!S.current){console.log("[DRAG] No draggedAgentIdRef.current");return}const D=N.current.getBoundingClientRect(),F=O.clientY-D.top,K=60,re=8;if(console.log("[DRAG] y position:",F,"rect.height:",D.height,"scrollTop:",N.current.scrollTop),F<K){const me=Math.max(1,re*(1-F/K));console.log("[DRAG] Scrolling UP, speed:",me),N.current.scrollTop-=me}else if(F>D.height-K){const me=Math.max(1,re*(1-(D.height-F)/K));console.log("[DRAG] Scrolling DOWN, speed:",me),N.current.scrollTop+=me}}function j(O,D){console.log("[DRAG] handleDragStart called for agent:",D),O.dataTransfer.setData("text/plain",D),O.dataTransfer.effectAllowed="move",S.current=D,requestAnimationFrame(()=>{console.log("[DRAG] Setting draggedAgentId state (deferred):",D),w(D)})}function G(){console.log("[DRAG] handleDragEnd called"),S.current=null,w(null),A(null),v.current&&(cancelAnimationFrame(v.current),v.current=null)}function Q(O,D,F){const K=S.current;if(console.log("[DRAG] handleDragOver called for target:",D,"type:",F,"dragging:",K),O.preventDefault(),O.stopPropagation(),K===D){console.log("[DRAG] Rejecting: cannot drop on self");return}const re=t.agents.find(me=>me.id===K);if(re&&"sub_agents"in re&&R(re,D)){console.log("[DRAG] Rejecting: would create circular reference");return}O.dataTransfer.dropEffect="move",A({agentId:D,type:F}),console.log("[DRAG] dropTarget set to:",D,F)}function z(O){console.log("[DRAG] handleDragLeave called");const D=O.relatedTarget;(!D||!O.currentTarget.contains(D))&&A(null)}function ue(O,D,F){console.log("[DRAG] handleDrop called for target:",D,"type:",F),O.preventDefault(),O.stopPropagation();const K=O.dataTransfer.getData("text/plain");if(console.log("[DRAG] sourceAgentId from dataTransfer:",K),!K||K===D){console.log("[DRAG] Rejecting drop: no source or same target");return}const re=t.agents.find(W=>W.id===D),me=t.agents.find(W=>W.id===K);if(!re||!me){console.log("[DRAG] Rejecting: target or source agent not found");return}if(console.log("[DRAG] Processing drop - source:",me.name,"target:",re.name,"type:",F),F==="sub_agent")"sub_agents"in re?(t.agents.forEach(W=>{"sub_agents"in W&&W.sub_agents.includes(K)&&(console.log("[DRAG] Removing from existing parent:",W.name),i(W.id,{sub_agents:W.sub_agents.filter(ce=>ce!==K)}))}),re.sub_agents.includes(K)||(console.log("[DRAG] Adding as sub_agent to:",re.name),i(D,{sub_agents:[...re.sub_agents,K]}),u(W=>new Set([...W,D])))):console.log("[DRAG] Target does not support sub_agents");else if(F==="tool")if("tools"in re){const W=re;W.tools.some(ve=>ve.type==="agent"&&ve.agent_id===K)?console.log("[DRAG] Already added as tool"):(console.log("[DRAG] Adding as tool to:",re.name),i(D,{tools:[...W.tools,{type:"agent",agent_id:K,name:me.name}]}))}else console.log("[DRAG] Target does not support tools");console.log("[DRAG] Drop complete, clearing state"),w(null),A(null)}function R(O,D){if(!("sub_agents"in O))return!1;if(O.sub_agents.includes(D))return!0;for(const F of O.sub_agents){const K=t.agents.find(re=>re.id===F);if(K&&R(K,D))return!0}return!1}function ee(O){const D=Va.find(F=>F.type===O);return D?D.icon:nr}function H(O){const D=Va.find(F=>F.type===O);return D?D.color:"#888"}function ne(O,D=0){return O.map(F=>{const K=ee(F.type),re=H(F.type),me="sub_agents"in F&&F.sub_agents.length>0,W="sub_agents"in F,ce=F.type==="LlmAgent",ve=c.has(F.id),Je=C===F.id,We=(k==null?void 0:k.agentId)===F.id&&(k==null?void 0:k.type)==="sub_agent",on=(k==null?void 0:k.agentId)===F.id&&(k==null?void 0:k.type)==="tool",Ge=me?F.sub_agents.map(we=>t.agents.find(J=>J.id===we)).filter(we=>we!==void 0):[],Ie=C&&C!==F.id&&(W||ce);return C&&console.log("[DRAG] Rendering agent:",F.name,"draggedAgentId:",C,"showDropOverlay:",Ie,"canHaveSubAgents:",W,"canHaveTools:",ce),s.jsxs("div",{className:"agent-tree-item",children:[s.jsxs("div",{className:`agent-item ${o===F.id?"selected":""} ${Je?"dragging":""} ${Ie?"drop-target":""}`,onClick:()=>B(F.id),style:{paddingLeft:12+D*20},draggable:!0,onDragStart:we=>j(we,F.id),onDragEnd:G,onDragOver:we=>{Ie&&(we.preventDefault(),we.stopPropagation())},children:[s.jsx("div",{className:"drag-handle",children:s.jsx(g0,{size:12})}),me?s.jsx("button",{className:"expand-btn",onClick:we=>{we.stopPropagation(),$(F.id)},children:ve?s.jsx(Tt,{size:16}):s.jsx(Pt,{size:16})}):s.jsx("span",{style:{width:20}}),s.jsx("div",{className:"agent-icon",style:{background:re},children:s.jsx(K,{size:14})}),s.jsx("span",{className:"agent-name",children:F.name}),s.jsx("span",{className:"agent-type",children:F.type}),s.jsx("button",{className:"delete-btn",onClick:we=>T(F.id,we),children:s.jsx(Ae,{size:14})}),Ie&&s.jsxs("div",{className:"drop-overlay",children:[W&&s.jsxs("div",{className:`drop-zone-overlay ${We?"active":""}`,onDragOver:we=>Q(we,F.id,"sub_agent"),onDragLeave:z,onDrop:we=>ue(we,F.id,"sub_agent"),children:[s.jsx(lg,{size:12}),s.jsx("span",{children:"Sub-agent"})]}),ce&&s.jsxs("div",{className:`drop-zone-overlay ${on?"active":""}`,onDragOver:we=>Q(we,F.id,"tool"),onDragLeave:z,onDrop:we=>ue(we,F.id,"tool"),children:[s.jsx(Jt,{size:12}),s.jsx("span",{children:"Tool"})]})]})]}),me&&ve&&s.jsx("div",{className:"sub-agents",children:ne(Ge,D+1)})]},F.id)})}const ae=new Set(t.agents.flatMap(O=>"sub_agents"in O?O.sub_agents:[])),I=t.agents.filter(O=>!ae.has(O.id));return s.jsxs("div",{className:"agents-panel",children:[s.jsx("style",{children:`
        .agents-panel {
          display: flex;
          gap: 20px;
      ...
      `}),s.jsxs("aside",{className:"agents-sidebar",style:{width:P},children:[s.jsxs("div",{className:"sidebar-header",children:[s.jsxs("h3",{children:["Agents (",t.agents.length,")",y.size>0&&s.jsxs("span",{className:"generating-badge",children:[s.jsx(Hr,{size:12,className:"spin"})," ",y.size]})]}),s.jsxs("div",{className:"header-buttons",children:[Va.map(({type:O,icon:D,color:F})=>s.jsx("button",{className:"quick-add-btn",style:{background:F},onClick:()=>X(O),title:`Add ${O}`,children:s.jsx(D,{size:14})},O)),s.jsx("button",{className:"btn btn-secondary btn-sm",onClick:()=>p(!0),title:"AI-powered agent setup",children:s.jsx(Ea,{size:14})})]})]}),s.jsx("div",{className:"agents-list",ref:N,onDragOver:M,children:t.agents.length===0?s.jsxs("div",{className:"empty-state",children:[s.jsx(nr,{size:32}),s.jsx("p",{children:"No agents yet"})]}):ne(I)})]}),s.jsx("div",{ref:L,className:`sidebar-resizer ${g?"resizing":""}`,onMouseDown:E}),s.jsx("div",{className:"agent-editor-area",children:V?s.jsx(L2,{agent:V}):s.jsxs("div",{className:"empty-state card",children:[s.jsx(nr,{size:48}),s.jsxs("p",{children:["Select an agent to edit",s.jsx("br",{}),"or create a new one"]})]})}),d&&s.jsx("div",{className:"type-selector",onClick:()=>p(!1),children:s.jsxs("div",{className:"quick-setup-content",onClick:O=>O.stopPropagation(),children:[s.jsxs("h2",{children:[s.jsx(Ea,{size:20})," Quick Agent Setup"]}),s.jsx("p",{className:"quick-setup-desc",children:"Describe what you want this agent to do. Runs in the background - you can start multiple!"}),s.jsxs("div",{className:"quick-setup-form",children:[s.jsx("textarea",{value:f,onChange:O=>m(O.target.value),placeholder:"Example: An agent that searches the web for information and summarizes the results. It should be able to search Google and handle multiple queries in parallel.",rows:5,autoFocus:!0,onKeyDown:O=>{O.key==="Enter"&&(O.metaKey||O.ctrlKey)&&f.trim()&&U()}}),s.jsxs("div",{className:"quick-setup-info",children:[s.jsx("strong",{children:"Available resources:"}),s.jsxs("ul",{children:[s.jsxs("li",{children:[t.app.state_keys.length," state keys"]}),s.jsxs("li",{children:[l.length," MCP servers"]}),s.jsxs("li",{children:[t.custom_tools.length," custom tools"]}),s.jsxs("li",{children:[t.agents.length," existing agents"]})]})]}),s.jsxs("div",{className:"quick-setup-actions",children:[s.jsx("button",{className:"btn btn-secondary",onClick:()=>p(!1),children:"Cancel"}),s.jsxs("button",{className:"btn btn-primary",onClick:U,disabled:!f.trim(),children:[s.jsx(Ea,{size:14}),"Generate (⌘↵)"]})]})]})]})})]})}var Su="\x1B[0m",Cu="\x1B[1m",rx=e=>e instanceof Error?e.message:typeof e=="string"?e:"An unknown error occurred",F2=e=>{let t=rx(e),n=`${Cu}[MONACOPILOT ERROR] ${t}${Su}`;return console.error(n),{message:t}},B2=(e,t)=>{console.warn(`${Cu}[MONACOPILOT WARN] ${e}${t?`
...
`;function vS({onSelectTool:e}){var me;const{project:t,updateProject:n,addCustomTool:r,updateCustomTool:i,removeCustomTool:o,selectedToolId:a,setSelectedToolId:l,builtinTools:c,mcpServers:u}=st(),[d,p]=_.useState(""),[f,m]=_.useState(null),[y,b]=_.useState("tools"),[P,x]=_.useState(null),[g,h]=_.useState(""),[L,C]=_.useState(!1),[w,S]=_.useState(null),[k,A]=_.useState(!1),[N,v]=_.useState(!1),[E,U]=_.useState(null),[V,B]=_.useState(null);if(!t)return null;const X=t.mcp_servers||[],T=t.custom_tools.find(W=>W.id===a),$=X.find(W=>W.name===P),M=new Set(X.map(W=>W.name)),j=u.filter(W=>!M.has(W.name));function G(W){l(W),e==null||e(W)}_.useEffect(()=>{T&&(p(T.code),B(null))},[a]),_.useEffect(()=>{$&&(h(JSON.stringify($,null,2)),C(!1))},[P]);function Q(){const W=gS();r({id:W,name:"new_tool",description:"",module_path:"tools.custom",code:yS,state_keys_used:[]}),G(W)}function z(W,ce){ce.stopPropagation(),confirm("Delete this tool?")&&(o(W),a===W&&(e==null||e(null)))}function ue(W){T&&(W.name!==void 0&&(W.name===""||xS(W.name)?B(null):B("Name can only contain letters, numbers, and underscores")),i(T.id,W))}function R(W){W!==void 0&&T&&(p(W),ue({code:W}))}async function ee(){if(T){A(!0);try{const W=await qh(t.id,T.name,T.description,T.state_keys_used);W.success&&W.code?(p(W.code),ue({code:W.code})):(console.error("Failed to generate tool code:",W.error),alert("Failed to generate tool code: "+(W.error||"Unknown error")))}catch(W){console.error("Error generating tool code:",W),alert("Error generating tool code: "+W.message)}finally{A(!1)}}}const H=_.useRef(null),ne=_.useCallback((W,ce)=>{if(H.current&&typeof H.current=="function")try{H.current()}catch{}try{const ve=ax(ce,W,{language:"python",endpoint:"/api/code-completion",trigger:"onTyping"});typeof ve=="function"?H.current=ve:H.current=null}catch{H.current=null}},[]);_.useEffect(()=>()=>{if(H.current&&typeof H.current=="function")try{H.current()}catch{}},[]);function ae(){const W={name:`mcp_server_${Date.now().toString(36)}`,description:"New MCP Server",connection_type:"stdio",command:"npx",args:["-y","@modelcontextprotocol/server-example"],env:{},headers:{},timeout:10};n({mcp_servers:[...X,W]}),x(W.name),S(null)}function I(W){const ce={...W};n({mcp_servers:[...X,ce]}),x(ce.name),S(null)}function O(W,ce){ce.stopPropagation(),confirm("Delete this MCP server?")&&(n({mcp_servers:X.filter(ve=>ve.name!==W)}),P===W&&x(null))}function D(W){W!==void 0&&(h(W),C(W!==JSON.stringify($,null,2)))}function F(){if($)try{const W=JSON.parse(g),ce=$.name,ve=X.map(Je=>Je.name===ce?W:Je);n({mcp_servers:ve}),x(W.name),C(!1)}catch(W){alert("Invalid JSON: "+W.message)}}async function K(){v(!0),U(null);try{const W=JSON.parse(g),ce=await Gh({connection_type:W.connection_type,command:W.command,args:W.args,env:W.env,url:W.url,headers:W.headers,timeout:W.timeout||30});if(U(ce),ce.success&&ce.tools.length>0){const ve={...W,tool_filter:ce.tools.map(Je=>Je.name)};h(JSON.stringify(ve,null,2)),C(!0)}}catch(W){U({success:!1,tools:[],error:W.message})}finally{v(!1)}}const re={};return t.custom_tools.forEach(W=>{const ce=W.module_path||"tools";re[ce]||(re[ce]=[]),re[ce].push(W)}),s.jsxs("div",{className:"tools-panel",children:[s.jsx("style",{children:`
        .tools-panel {
          display: flex;
          gap: 20px;
          height: calc(100vh - 180px);
...
def my_callback(tool: BaseTool, tool_args: Dict[str, Any], tool_context: ToolContext, result: Dict) -> Optional[Dict]:
    ...
    return None
`;default:return lx("before_agent")}}function kS({onSelectCallback:e}){var k,A;const{project:t,updateProject:n,addCustomCallback:r,updateCustomCallback:i,removeCustomCallback:o}=st(),[a,l]=_.useState(""),[c,u]=_.useState(null),[d,p]=_.useState(null),[f,m]=_.useState(!1),y=_.useRef(null);if(!t)return null;const b=t.custom_callbacks||[],P=b.find(N=>N.id===c);function x(N){u(N),e==null||e(N)}_.useEffect(()=>{P?(l(P.code),p(null)):l("")},[c,P]);function g(){const N=bS(),v={id:N,name:"new_callback",description:"",module_path:"callbacks.custom",code:lx("before_agent"),state_keys_used:[]};r(v),x(N)}function h(N,v){v.stopPropagation(),confirm("Delete this callback?")&&(o(N),c===N&&(e==null||e(null),u(null),l("")))}function L(){if(!c)return;const N=b.find(U=>U.id===c);if(!N)return;const v=N.name.trim();if(!v){alert("Please enter a name");return}if(!Zp(v)){p("Name must contain only alphanumeric characters and underscores");return}if(b.find(U=>U.name===v&&U.id!==N.id)){p("A callback with this name already exists");return}i(N.id,{code:a,name:v,description:N.description,module_path:N.module_path,state_keys_used:N.state_keys_used}),p(null)}function C(N,v){y.current=v;try{ax(v,{endpoint:"/api/code-completion",language:"python"})}catch(E){console.warn("Failed to register Monacopilot completion:",E)}}async function w(){if(P){m(!0);try{let N="before_agent";const v=P.name.toLowerCase(),E=P.description.toLowerCase();v.includes("after_agent")||E.includes("after agent")?N="after_agent":v.includes("before_model")||E.includes("before model")?N="before_model":v.includes("after_model")||E.includes("after model")?N="after_model":v.includes("before_tool")||E.includes("before tool")?N="before_tool":v.includes("after_tool")||E.includes("after tool")?N="after_tool":(v.includes("before_agent")||E.includes("before agent"))&&(N="before_agent");const U=await Jh(t.id,P.name,P.description,N,P.state_keys_used);U.success&&U.code?(l(U.code),i(P.id,{code:U.code})):(console.error("Failed to generate callback code:",U.error),alert("Failed to generate callback code: "+(U.error||"Unknown error")))}catch(N){console.error("Error generating callback code:",N),alert("Error generating callback code: "+N.message)}finally{m(!1)}}}const S=((A=(k=t.app)==null?void 0:k.state_keys)==null?void 0:A.map(N=>N.name))||[];return s.jsxs("div",{className:"tools-panel",children:[s.jsx("style",{children:`
        .tools-panel {
          display: flex;
          height: 100%;
          background: var(--bg-primary);
...
`),isError:t.isError===!0}:{text:typeof t=="string"?t:JSON.stringify(t,null,2),isError:!1}}function tf(e,t){if(!t||!t.trim())return e;const n=t.trim();let r=e;try{r=JSON.parse(e)}catch{}if(n.startsWith("js:")){const i=n.slice(3).trim();try{const a=new Function("value","data",`return ${i}`)(e,r);return typeof a=="string"?a:JSON.stringify(a,null,2)}catch(o){return`[JS error: ${o}]`}}if(n.startsWith("."))try{const i=n.slice(1).split(".").filter(Boolean);let o=r;for(const a of i){const l=a.match(/^(\w+)?\[(\d+)\]$/);l?(l[1]&&(o=o[l[1]]),o=o[parseInt(l[2])]):o=o[a]}return o==null?"[No match]":typeof o=="string"?o:JSON.stringify(o,null,2)}catch(i){return`[Path error: ${i.message}]`}try{const o=new Function("value","data",`return ${n}`)(e,r);return typeof o=="string"?o:JSON.stringify(o,null,2)}catch(i){return`[Transform error: ${i.message}]`}}function ES({project:e,selectedEventIndex:t}){var ee;const{watches:n,updateWatch:r,addWatch:i,removeWatch:o,runEvents:a}=st(),[l,c]=_.useState(!1),[u,d]=_.useState(null),[p,f]=_.useState({}),[m,y]=_.useState(new Set),[b,P]=_.useState(""),[x,g]=_.useState(""),[h,L]=_.useState({}),[C,w]=_.useState(""),[S,k]=_.useState([]),[A,N]=_.useState(null),[v,E]=_.useState(null),[U,V]=_.useState(!1);_.useEffect(()=>{ru().then(k).catch(console.error)},[]);const B=_.useMemo(()=>{const H=e.mcp_servers||[],ne=new Set(H.map(I=>I.name)),ae=S.filter(I=>!ne.has(I.name));return[...H,...ae]},[e.mcp_servers,S]),X=_.useCallback(async H=>{if(!(p[H]||m.has(H))){y(ne=>new Set([...ne,H]));try{const ne=await ke(`/projects/${e.id}/mcp-servers/${encodeURIComponent(H)}/test-connection`,{method:"POST"});ne.success&&f(ae=>({...ae,[H]:ne.tools}))}catch(ne){console.error("Failed to load tools:",ne)}finally{y(ne=>{const ae=new Set(ne);return ae.delete(H),ae})}}},[e.id,p,m]);_.useEffect(()=>{var I;if(u)return;if(!b||!x){L({});return}const ne=(p[b]||[]).find(O=>O.name===x);if(!((I=ne==null?void 0:ne.parameters)!=null&&I.properties)){L({});return}const ae={};Object.entries(ne.parameters.properties).forEach(([O,D])=>{D.type==="string"?ae[O]=D.default||"":D.type==="number"||D.type==="integer"?ae[O]=D.default||0:D.type==="boolean"?ae[O]=D.default||!1:ae[O]=D.default||null}),L(ae)},[b,x,p,u]);const T=()=>{d(null),P(""),g(""),L({}),w(""),N(null),E(null),c(!0)},$=H=>{if(d(H.id),P(H.serverName),g(H.toolName),L({...H.args}),w(H.transform||""),H.result){const{text:ne}=Wa(H.result);N(ne),E(null)}else N(null),E(null);p[H.serverName]||X(H.serverName),c(!0)},M=async()=>{if(!(!b||!x)){V(!0),E(null);try{const H=await ke(`/projects/${e.id}/run-mcp-tool`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({server_name:b,tool_name:x,arguments:h})}),{text:ne,isError:ae}=Wa(H);ae?(E(ne),N(null)):(N(ne),E(null))}catch(H){E(String(H)),N(null)}finally{V(!1)}}},j=_.useMemo(()=>A?!C||!C.trim()?A:tf(A,C):null,[A,C]),G=()=>{if(!(!b||!x)){if(u){r(u,{serverName:b,toolName:x,args:{...h},transform:C||void 0});const H=n.find(ne=>ne.id===u);H&&z({...H,serverName:b,toolName:x,args:h,transform:C||void 0,history:H.history||[]})}else{const H={id:`watch-${Date.now()}`,serverName:b,toolName:x,args:{...h},transform:C||void 0,history:[]};i(H),z(H)}c(!1)}},Q=H=>{o(H)},z=_.useCallback(async(H,ne)=>{r(H.id,{isLoading:!0,error:void 0});const ae=ne??a.length-1,I=Date.now();try{const O=await ke(`/projects/${e.id}/run-mcp-tool`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({server_name:H.serverName,tool_name:H.toolName,arguments:H.args})}),D={eventIndex:ae,timestamp:I,result:O},F=[...H.history||[],D];r(H.id,{result:O,isLoading:!1,lastRun:I,history:F})}catch(O){const D={eventIndex:ae,timestamp:I,error:String(O)},F=[...H.history||[],D];r(H.id,{error:String(O),isLoading:!1,lastRun:I,history:F})}},[e.id,r,a.length]),ue=()=>{n.forEach(H=>z(H))},R=_.useMemo(()=>!b||!x?null:(p[b]||[]).find(ne=>ne.name===x),[b,x,p]);return s.jsxs("div",{className:"tool-watch-panel",children:[s.jsxs("div",{className:"watch-header",children:[s.jsx(Gi,{size:14}),s.jsx("span",{children:"Tool Watch"}),s.jsx("span",{className:"watch-auto-badge",title:"Watches auto-refresh on every event",children:"⚡ Auto"}),s.jsxs("div",{className:"watch-actions",children:[s.jsx("button",{className:"watch-btn",onClick:ue,title:"Refresh all",children:s.jsx(En,{size:12})}),s.jsx("button",{className:"watch-btn",onClick:T,title:"Add watch",children:s.jsx(Ue,{size:12})})]})]}),n.length===0?s.jsxs("div",{className:"watch-empty",children:[s.jsx(Gi,{size:20,style:{opacity:.3}}),s.jsx("span",{children:"No watch expressions"}),s.jsxs("button",{className:"add-watch-btn",onClick:T,children:[s.jsx(Ue,{size:12})," Add Tool Watch"]})]}):s.jsx("div",{className:"watch-list",children:n.map(H=>{let ne=H.result,ae=H.error;if(t!==null&&H.history&&H.history.length>0){const K=H.history.filter(re=>re.eventIndex<=t);if(K.length>0){const re=K[K.length-1];ne=re.result,ae=re.error}else ne=void 0,ae=void 0}const{text:I,isError:O}=ne?Wa(ne):{text:"",isError:!1},D=ne?tf(I,H.transform):"",F=ae||O;return s.jsxs("div",{className:`watch-item ${F?"error":""}`,children:[s.jsxs("div",{className:"watch-item-header",children:[s.jsxs("span",{className:"watch-expr",children:[s.jsx("span",{className:"watch-server",children:H.serverName}),s.jsx("span",{className:"watch-tool",children:H.toolName}),Object.keys(H.args).length>0&&s.jsxs("span",{className:"watch-args",children:["(",Object.entries(H.args).map(([K,re])=>`${K}=${JSON.stringify(re)}`).join(", "),")"]}),t!==null&&s.jsxs("span",{className:"watch-time-indicator",children:["@",t]})]}),s.jsxs("div",{className:"watch-item-actions",children:[s.jsx("button",{onClick:()=>$(H),title:"Edit watch",children:s.jsx(Jt,{size:10})}),s.jsx("button",{onClick:()=>z(H),title:"Refresh",children:H.isLoading?s.jsx(En,{size:10,className:"spin"}):s.jsx(En,{size:10})}),s.jsx("button",{onClick:()=>Q(H.id),title:"Remove",children:s.jsx(Ae,{size:10})})]})]}),s.jsx("div",{className:"watch-result",children:H.isLoading?s.jsx("span",{className:"loading",children:"Loading..."}):ae?s.jsx("span",{className:"error",children:ae}):ne?s.jsx("pre",{className:O?"error-text":"",children:D}):s.jsx("span",{className:"no-result",children:t!==null?"No data at this event":"Not yet run"})})]},H.id)})}),l&&s.jsx("div",{className:"watch-dialog-overlay",onClick:()=>c(!1),children:s.jsxs("div",{className:"watch-dialog",onClick:H=>H.stopPropagation(),children:[s.jsxs("div",{className:"dialog-header",children:[s.jsx("span",{children:u?"Edit Watch":"Add Tool Watch"}),s.jsx("button",{onClick:()=>c(!1),children:s.jsx(cg,{size:14})})]}),s.jsxs("div",{className:"dialog-body",children:[s.jsxs("div",{className:"form-row",children:[s.jsx("label",{children:"MCP Server"}),s.jsxs("select",{value:b,onChange:H=>{P(H.target.value),u||g(""),H.target.value&&X(H.target.value)},children:[s.jsx("option",{value:"",children:"Select server..."}),B.map(H=>s.jsx("option",{value:H.name,children:H.name},H.name))]})]}),s.jsxs("div",{className:"form-row",children:[s.jsx("label",{children:"Tool"}),s.jsxs("select",{value:x,onChange:H=>g(H.target.value),disabled:!b||m.has(b),children:[s.jsx("option",{value:"",children:m.has(b)?"Loading tools...":"Select tool..."}),(p[b]||[]).map(H=>s.jsx("option",{value:H.name,children:H.name},H.name))]})]}),(R==null?void 0:R.description)&&s.jsx("div",{className:"tool-desc",children:R.description}),((ee=R==null?void 0:R.parameters)==null?void 0:ee.properties)&&Object.keys(R.parameters.properties).length>0&&s.jsxs("div",{className:"tool-args",children:[s.jsx("label",{children:"Arguments"}),Object.entries(R.parameters.properties).map(([H,ne])=>{var ae,I;return s.jsxs("div",{className:"arg-row",children:[s.jsxs("span",{className:"arg-name",children:[H,((ae=R.parameters.required)==null?void 0:ae.includes(H))&&s.jsx("span",{className:"required",children:"*"})]}),s.jsx("input",{type:ne.type==="number"||ne.type==="integer"?"number":"text",value:typeof h[H]=="object"?JSON.stringify(h[H]):h[H]??"",onChange:O=>L(D=>({...D,[H]:O.target.value})),placeholder:((I=ne.description)==null?void 0:I.slice(0,40))||H})]},H)})]}),b&&x&&s.jsxs("div",{className:"test-section",children:[s.jsxs("div",{className:"test-header",children:[s.jsx("label",{children:"Test & Preview"}),s.jsxs("button",{className:"test-btn",onClick:M,disabled:U,children:[U?s.jsx(En,{size:12,className:"spin"}):s.jsx(Fn,{size:12}),U?"Running...":"Test Run"]})]}),v&&s.jsxs("div",{className:"test-result error",children:[s.jsx("span",{className:"test-label",children:"Error:"}),s.jsx("pre",{children:v})]}),A&&s.jsxs("div",{className:"test-result",children:[s.jsx("span",{className:"test-label",children:"Raw Result:"}),s.jsx("pre",{children:A})]})]}),s.jsxs("div",{className:"form-row transform-row",children:[s.jsx("label",{children:"Transform (optional)"}),s.jsx("input",{type:"text",value:C,onChange:H=>w(H.target.value),placeholder:"e.g., .items[0].name or .content[].text"}),s.jsxs("div",{className:"transform-hints",children:[s.jsx("span",{className:"hint-title",children:"Path:"}),s.jsx("code",{onClick:()=>w(".items[0].name"),children:".items[0].name"}),s.jsx("code",{onClick:()=>w(".content[0].text"),children:".content[0].text"}),s.jsx("code",{onClick:()=>w(".result.data"),children:".result.data"}),s.jsx("span",{className:"hint-title",children:"JS:"}),s.jsx("code",{onClick:()=>w("js:value.split('\\n')[0]"),children:"js:value.split('\\n')[0]"}),s.jsx("code",{onClick:()=>w("js:data.items?.length"),children:"js:data.items?.length"})]})]}),A&&C&&s.jsxs("div",{className:"transform-preview",children:[s.jsx("span",{className:"test-label",children:"Transform Preview:"}),s.jsx("pre",{className:j!=null&&j.startsWith("[Transform error")?"error":"",children:j})]})]}),s.jsxs("div",{className:"dialog-footer",children:[s.jsx("button",{className:"cancel-btn",onClick:()=>c(!1),children:"Cancel"}),s.jsx("button",{className:"add-btn",onClick:G,disabled:!b||!x,children:u?"Save Changes":"Add Watch"})]})]})})]})}function zS(){var zt;const{project:e,isRunning:t,setIsRunning:n,runEvents:r,addRunEvent:i,clearRunEvents:o,clearWatchHistories:a,runAgentId:l,setRunAgentId:c,watches:u,updateWatch:d,currentSessionId:p,setCurrentSessionId:f}=st(),[m,y]=_.useState(""),[b,P]=_.useState(null),[x,g]=_.useState(null),[h,L]=_.useState(null),[C,w]=_.useState(""),[S,k]=_.useState(new Set(["agent_start","agent_end","tool_call","tool_result","model_call","model_response","state_change","callback_start","callback_end"])),[A,N]=_.useState(!0),[v,E]=_.useState(!0),[U,V]=_.useState(!1),[B,X]=_.useState(360),[T,$]=_.useState(!1),[M,j]=_.useState([]),[G,Q]=_.useState(null),[z,ue]=_.useState(!1),R=_.useRef(0),ee=_.useCallback(async(q,se)=>{if(!e)return;d(q.id,{isLoading:!0,error:void 0});const oe=se??r.length-1,de=Date.now();try{const ge=await ke(`/projects/${e.id}/run-mcp-tool`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({server_name:q.serverName,tool_name:q.toolName,arguments:q.args})}),Ke={eventIndex:oe,timestamp:de,result:ge},qn=[...q.history||[],Ke];d(q.id,{result:ge,isLoading:!1,lastRun:de,history:qn})}catch(ge){const Ke={eventIndex:oe,timestamp:de,error:String(ge)},qn=[...q.history||[],Ke];d(q.id,{error:String(ge),isLoading:!1,lastRun:de,history:qn})}},[e==null?void 0:e.id,d,r.length]);_.useEffect(()=>{if(r.length>R.current&&u.length>0){const q=r.length-1;u.forEach(se=>{se.isLoading||ee(se,q)})}R.current=r.length},[r.length,u,ee]),_.useEffect(()=>{l!==null&&(ne(l),c(null))},[l,c]);const[H,ne]=_.useState(null),ae=_.useRef(null),I=_.useRef(null);_.useEffect(()=>{if(!T)return;const q=oe=>{if(!I.current)return;const ge=I.current.getBoundingClientRect().right-oe.clientX;X(Math.min(600,Math.max(200,ge)))},se=()=>{$(!1)};return document.addEventListener("mousemove",q),document.addEventListener("mouseup",se),()=>{document.removeEventListener("mousemove",q),document.removeEventListener("mouseup",se)}},[T]);const O=_.useMemo(()=>r.length===0?{min:0,max:0}:{min:r[0].timestamp,max:r[r.length-1].timestamp},[r]),D=_.useMemo(()=>r.filter((q,se)=>{var oe,de,ge;if(h&&(q.timestamp<h[0]||q.timestamp>h[1])||S.size>0&&!S.has(q.event_type))return!1;if(A&&q.event_type==="model_response"){const Ke=((de=(oe=q.data)==null?void 0:oe.response_content)==null?void 0:de.parts)||((ge=q.data)==null?void 0:ge.parts)||[],qn=Ke.some(Zo=>Zo.type==="function_call"),ux=Ke.some(Zo=>Zo.type==="text");if(!qn&&!ux)return!1}return!(C&&!JSON.stringify(q).toLowerCase().includes(C.toLowerCase()))}),[r,h,S,C,A]),F=_.useMemo(()=>{var de;let q=0,se=0;const oe=x!==null?x+1:r.length;for(let ge=0;ge<oe;ge++){const Ke=r[ge];Ke.event_type==="model_response"&&((de=Ke.data)!=null&&de.token_counts)&&(q+=Ke.data.token_counts.input||0,se+=Ke.data.token_counts.output||0)}return{input:q,output:se,total:q+se}},[r,x]),K=x!==null?r[x]:null;_.useEffect(()=>{if(!e){j([]);return}(async()=>{ue(!0);try{const se=await Ul(e.id);j(se)}catch(se){console.error("Failed to load sessions:",se),j([])}finally{ue(!1)}})()},[e]);const re=_.useCallback(async q=>{if(!e){Q(null);return}if(!q){o(),a(),f(null),Q(null),g(null),L(null);return}try{const se=await Fh(e.id,q);o(),a(),f(se.id),Q(q),g(null),L(null);for(const oe of se.events)i(oe)}catch(se){alert(`Failed to load session: ${se.message||"Unknown error"}`)}},[e,o,a,f,i]);_.useEffect(()=>{if(!e||M.length===0||z)return;const se=new URLSearchParams(window.location.search).get("session");if(se)if(M.some(de=>de.id===se)){re(se);const de=window.location.pathname;window.history.replaceState({},"",de)}else console.warn(`Session ${se} not found in available sessions`)},[e,M,z,re]),_.useEffect(()=>{t&&ae.current&&(ae.current.scrollTop=ae.current.scrollHeight)},[r.length,t]);const me=_.useCallback(()=>{if(!e||!m.trim()||t)return;b&&(b.close(),P(null)),p||(o(),a(),Q(null)),n(!0),g(null),L(null);const q=Wh(e.id);P(q),q.onopen=()=>{q.send(JSON.stringify({message:m,agent_id:H||void 0,session_id:p||void 0}))},q.onmessage=se=>{var de;const oe=JSON.parse(se.data);if(oe.event_type==="agent_start"&&((de=oe.data)!=null&&de.session_id)){const ge=oe.data.session_id;oe.data.session_reused,f(ge),ge&&M.some(Ke=>Ke.id===ge)&&Q(ge)}else oe.type==="session_started"?(f(oe.session_id),oe.session_id&&M.some(ge=>ge.id===oe.session_id)&&Q(oe.session_id)):oe.type==="completed"?(n(!1),q.close()):oe.type==="error"?(n(!1),i({timestamp:Date.now()/1e3,event_type:"agent_end",agent_name:"system",data:{error:oe.error}})):i(oe)},q.onerror=()=>{n(!1),i({timestamp:Date.now()/1e3,event_type:"agent_end",agent_name:"system",data:{error:"WebSocket connection error"}})},q.onclose=()=>{n(!1)}},[e,m,t,b,o,n,i,H,p]),W=_.useCallback(()=>{b==null||b.close(),n(!1)},[b,n]);_.useEffect(()=>{const q=se=>{if((se.metaKey||se.ctrlKey)&&se.key==="Enter"){se.preventDefault(),me();return}if(se.key==="ArrowDown"||se.key==="ArrowUp"){if(se.target instanceof HTMLInputElement||se.target instanceof HTMLTextAreaElement||(se.preventDefault(),D.length===0))return;if(se.key==="ArrowDown")if(x===null){const oe=r.indexOf(D[0]);g(oe)}else{const oe=D.findIndex(de=>r.indexOf(de)===x);if(oe<D.length-1){const de=r.indexOf(D[oe+1]);g(de)}}else if(se.key==="ArrowUp")if(x===null){const oe=r.indexOf(D[D.length-1]);g(oe)}else{const oe=D.findIndex(de=>r.indexOf(de)===x);if(oe>0){const de=r.indexOf(D[oe-1]);g(de)}}}};return window.addEventListener("keydown",q),()=>window.removeEventListener("keydown",q)},[me,D,x,r]);const ce=_.useCallback(()=>{var ge;if(r.length===0)return;const q={version:1,exportedAt:new Date().toISOString(),projectId:e==null?void 0:e.id,projectName:e==null?void 0:e.name,agentId:H||((ge=e==null?void 0:e.app)==null?void 0:ge.root_agent_id),events:r},se=new Blob([JSON.stringify(q,null,2)],{type:"application/json"}),oe=URL.createObjectURL(se),de=document.createElement("a");de.href=oe,de.download=`run-${(e==null?void 0:e.name)||"export"}-${new Date().toISOString().slice(0,19).replace(/:/g,"-")}.json`,document.body.appendChild(de),de.click(),document.body.removeChild(de),URL.revokeObjectURL(oe)},[r,e,H]),ve=_.useCallback(async()=>{if(!p||!e){alert("No active session to save");return}try{const q=await $h(p);if(q.success){alert(q.message||"Session saved to memory successfully");try{const se=await Ul(e.id);j(se)}catch{}}else alert(`Failed to save to memory: ${q.error||"Unknown error"}`)}catch(q){alert(`Error saving to memory: ${q.message||"Unknown error"}`)}},[p,e]),[Je,We]=_.useState(!1),[on,Ge]=_.useState([]),[Ie,we]=_.useState(""),[J,te]=_.useState("Test Case from Session"),[fe,xe]=_.useState(!1),_e=_.useCallback(async()=>{if(!p||!e){alert("No active session to create test case from");return}try{const q=await ke(`/projects/${e.id}/eval-sets`);if(Ge(q.eval_sets||[]),!q.eval_sets||q.eval_sets.length===0){confirm(`No evaluation sets found. Would you like to create one first?

Go to the Evals tab to create an evaluation set.`)&&(window.location.href=`/project/${e.id}/evals`);return}we(q.eval_sets[0].id),We(!0)}catch(q){alert(`Error loading eval sets: ${q.message||"Unknown error"}`)}},[p,e]),vt=_.useCallback(async()=>{if(!p||!e||!Ie){alert("Please select an evaluation set");return}xe(!0);try{const q=await ke(`/projects/${e.id}/session-to-eval-case`,{method:"POST",body:JSON.stringify({session_id:p,eval_set_id:Ie,case_name:J})});We(!1),alert(`Test case "${q.eval_case.name}" created successfully!

Token count: ${q.session_token_count.toLocaleString()} tokens

Go to the Evals tab to view and edit the test case.`)}catch(q){alert(`Error creating test case: ${q.message||"Unknown error"}`)}finally{xe(!1)}},[p,e,Ie,J]),an=_.useCallback(()=>{const q=document.createElement("input");q.type="file",q.accept=".json",q.onchange=async se=>{var de;const oe=(de=se.target.files)==null?void 0:de[0];if(oe)try{const ge=await oe.text(),Ke=JSON.parse(ge);if(!Ke.events||!Array.isArray(Ke.events)){alert("Invalid run file: missing events array");return}o(),a(),g(null),L(null),Ke.events.forEach(qn=>{i(qn)})}catch(ge){alert(`Failed to load run file: ${ge}`)}},q.click()},[o,a,i]);return _.useEffect(()=>{if(x!==null){const q=document.querySelector(".event-row.selected");q==null||q.scrollIntoView({behavior:"smooth",block:"nearest"})}},[x]),e?s.jsxs("div",{className:`run-panel ${T?"resizing":""}`,children:[s.jsx("style",{children:`
        .run-panel {
          display: flex;
          flex-direction: column;
          width: 100%;
      ...
      `}),s.jsxs("div",{className:"input-area",children:[s.jsxs("select",{className:"agent-selector",value:H||"",onChange:q=>ne(q.target.value||null),disabled:t,title:"Select which agent to run",children:[s.jsx("option",{value:"",children:e.app.root_agent_id?`Root: ${((zt=e.agents.find(q=>q.id===e.app.root_agent_id))==null?void 0:zt.name)||e.app.root_agent_id}`:"No root agent"}),e.agents.filter(q=>q.id!==e.app.root_agent_id).map(q=>s.jsxs("option",{value:q.id,children:[q.name," (",q.type.replace("Agent",""),")"]},q.id))]}),s.jsxs("select",{className:"agent-selector",value:G||"",onChange:q=>re(q.target.value||null),disabled:t||z,style:{minWidth:180},title:"Load a saved session",children:[s.jsx("option",{value:"",children:z?"Loading...":"Load Session..."}),M.map(q=>{const se=new Date(q.started_at*1e3),oe=q.duration?`${q.duration.toFixed(1)}s`:"?";return s.jsxs("option",{value:q.id,children:[se.toLocaleString()," (",q.event_count," events, ",oe,")"]},q.id)})]}),s.jsx("input",{type:"text",placeholder:"Enter your query...",value:m,onChange:q=>y(q.target.value),onKeyDown:q=>q.key==="Enter"&&!q.shiftKey&&me(),disabled:t}),t?s.jsxs("button",{className:"stop",onClick:W,children:[s.jsx(j0,{size:14}),"Stop"]}):s.jsxs("button",{onClick:me,disabled:!m.trim(),children:[s.jsx(Fn,{size:14}),"Run"]})]}),s.jsxs("div",{className:"toolbar",children:[s.jsxs("div",{className:"toolbar-section",children:[s.jsx(sg,{size:12,style:{color:"#71717a"}}),s.jsx("input",{type:"text",placeholder:"Filter events...",value:C,onChange:q=>w(q.target.value)})]}),s.jsx("div",{className:"toolbar-divider"}),s.jsxs("div",{className:"toolbar-section",children:[["agent_start","agent_end","tool_call","tool_result","model_call","model_response","state_change"].map(q=>s.jsx("button",{className:`filter-chip ${S.has(q)?"active":""}`,onClick:()=>{const se=new Set(S);se.has(q)?se.delete(q):se.add(q),k(se)},children:q.replace("_"," ")},q)),s.jsx("button",{className:`filter-chip ${S.has("callback_start")&&S.has("callback_end")?"active":""}`,onClick:()=>{const q=new Set(S);q.has("callback_start")&&q.has("callback_end")?(q.delete("callback_start"),q.delete("callback_end")):(q.add("callback_start"),q.add("callback_end")),k(q)},title:"Show/hide callback events",children:"callback"}),s.jsx("button",{className:`filter-chip ${A?"active":""}`,onClick:()=>N(!A),title:"Hide LLM_RESP (complete) events",children:"hide (complete)"})]}),s.jsx("div",{className:"toolbar-divider"}),s.jsxs("div",{className:"toolbar-section",children:[s.jsxs("button",{className:`toolbar-btn ${v?"active":""}`,onClick:()=>E(!v),children:[s.jsx(fn,{size:12}),"State"]}),s.jsxs("button",{className:`toolbar-btn ${U?"active":""}`,onClick:()=>V(!U),children:[s.jsx(Xd,{size:12}),"Tools"]})]}),s.jsxs("div",{style:{marginLeft:"auto",display:"flex",alignItems:"center",gap:8},children:[s.jsxs("span",{style:{fontSize:10,color:"#71717a"},children:[D.length," / ",r.length," events"]}),h&&s.jsx("button",{className:"toolbar-btn",onClick:()=>L(null),children:"Clear Range"})]})]}),s.jsxs("div",{className:"main-content",ref:I,children:[s.jsxs("div",{className:"event-list-container",children:[s.jsxs("div",{className:"event-list-header",children:[s.jsx("div",{children:"#"}),s.jsx("div",{children:"Time"}),s.jsx("div",{children:"Agent"}),s.jsx("div",{children:"Type"}),s.jsx("div",{children:"Info"})]}),s.jsx("div",{className:"event-list",ref:ae,children:D.length===0?s.jsxs("div",{className:"empty-state",children:[s.jsx(ig,{size:24}),s.jsx("span",{children:r.length===0?"No events yet":"No matching events"})]}):D.map((q,se)=>{const oe=r.indexOf(q),de=ef[q.event_type]||ef.error,ge=wS[q.event_type]||ko;return s.jsxs("div",{className:`event-row ${x===oe?"selected":""}`,style:{background:de.bg},onClick:()=>g(oe),onDoubleClick:()=>{E(!1),V(!1)},children:[s.jsx("div",{className:"index",children:oe}),s.jsx("div",{className:"time",style:{color:de.fg},children:_S(q.timestamp,O.min)}),s.jsx("div",{className:"agent",style:{color:de.fg},children:q.agent_name}),s.jsxs("div",{className:"type",style:{color:de.fg},children:[s.jsx(ge,{size:10}),q.event_type.split("_")[0]]}),s.jsx("div",{className:"summary",children:jS(q)})]},oe)})})]}),s.jsxs("div",{className:"side-panel-container",style:{width:B},children:[s.jsx("div",{className:`resize-handle ${T?"active":""}`,onMouseDown:()=>$(!0)}),s.jsxs("div",{className:"side-panel",style:{width:B-4},children:[s.jsxs("div",{className:"side-panel-tabs",children:[s.jsxs("button",{className:`side-panel-tab ${!v&&!U?"active":""}`,onClick:()=>{E(!1),V(!1)},children:[s.jsx(Gi,{size:12,style:{marginRight:4}}),"Details"]}),s.jsxs("button",{className:`side-panel-tab ${v?"active":""}`,onClick:()=>{E(!0),V(!1)},children:[s.jsx(fn,{size:12,style:{marginRight:4}}),"State"]}),s.jsxs("button",{className:`side-panel-tab ${U?"active":""}`,onClick:()=>{V(!0),E(!1)},children:[s.jsx(Xd,{size:12,style:{marginRight:4}}),"Tools"]})]}),s.jsx("div",{className:"side-panel-content",children:U?s.jsx(ES,{project:e,selectedEventIndex:x}):v?s.jsx(NS,{events:r,selectedEventIndex:x,project:e}):K?s.jsx(SS,{event:K}):s.jsxs("div",{className:"empty-state",children:[s.jsx(Gi,{size:24}),s.jsx("span",{children:"Select an event to view details"})]})})]})]})]}),s.jsxs("div",{className:"stats-bar",children:[s.jsxs("div",{className:"stat-item",children:[s.jsx("span",{children:"Events:"}),s.jsx("span",{className:"stat-value",children:r.length})]}),s.jsxs("div",{className:"stat-item",children:[s.jsx("span",{children:"Tool Calls:"}),s.jsx("span",{className:"stat-value",children:r.filter(q=>q.event_type==="tool_call").length})]}),s.jsxs("div",{className:"stat-item",children:[s.jsx("span",{children:"Model Calls:"}),s.jsx("span",{className:"stat-value",children:r.filter(q=>q.event_type==="model_call").length})]}),s.jsxs("div",{className:"stat-item",children:[s.jsx("span",{children:"Callbacks:"}),s.jsx("span",{className:"stat-value",children:r.filter(q=>q.event_type==="callback_start").length})]}),s.jsxs("div",{className:"stat-item",children:[s.jsx("span",{children:"State Changes:"}),s.jsx("span",{className:"stat-value",children:r.filter(q=>q.event_type==="state_change").length})]}),r.length>0&&s.jsxs("div",{className:"stat-item",children:[s.jsx("span",{children:"Duration:"}),s.jsxs("span",{className:"stat-value",children:[((r[r.length-1].timestamp-r[0].timestamp)*1e3).toFixed(0),"ms"]})]}),F.total>0&&s.jsx("div",{className:"stat-item token-stats",children:s.jsxs("span",{className:"stat-value token-value",children:[s.jsxs("span",{className:"token-in",title:"Input tokens",children:[F.input.toLocaleString(),"↑"]}),s.jsxs("span",{className:"token-out",title:"Output tokens",children:[F.output.toLocaleString(),"↓"]}),s.jsx("span",{className:"token-total",title:"Total tokens",children:F.total.toLocaleString()})]})}),s.jsx("div",{className:"stats-bar-spacer"}),s.jsxs("button",{className:"stats-bar-btn",onClick:an,title:"Load a saved run",children:[s.jsx(qo,{size:12}),"Load"]}),s.jsxs("button",{className:"stats-bar-btn",onClick:ce,disabled:r.length===0,title:"Save current run to file",children:[s.jsx(ss,{size:12}),"Save"]}),s.jsxs("button",{className:"stats-bar-btn",onClick:ve,disabled:!p||r.length===0,title:"Save current session to memory",children:[s.jsx(fn,{size:12}),"Save to Memory"]}),s.jsxs("button",{className:"stats-bar-btn",onClick:_e,disabled:!p||r.length===0,title:"Create evaluation test case from this session",style:{background:"rgba(var(--accent-primary-rgb), 0.15)"},children:[s.jsx(ql,{size:12}),"Create Test Case"]})]}),Je&&s.jsx("div",{className:"dialog-overlay",style:{position:"fixed",top:0,left:0,right:0,bottom:0,background:"rgba(0,0,0,0.5)",display:"flex",alignItems:"center",justifyContent:"center",zIndex:1e3},onClick:()=>We(!1),children:s.jsxs("div",{className:"dialog-content",style:{background:"var(--bg-secondary)",borderRadius:"var(--radius-md)",padding:24,width:400,maxWidth:"90vw",border:"1px solid var(--border-color)"},onClick:q=>q.stopPropagation(),children:[s.jsxs("h3",{style:{marginBottom:16,display:"flex",alignItems:"center",gap:8},children:[s.jsx(ql,{size:18}),"Create Test Case from Session"]}),s.jsxs("div",{style:{marginBottom:16},children:[s.jsx("label",{style:{display:"block",marginBottom:4,fontSize:12,color:"var(--text-muted)"},children:"Test Case Name"}),s.jsx("input",{type:"text",value:J,onChange:q=>te(q.target.value),placeholder:"Enter test case name",style:{width:"100%",padding:"8px 12px",background:"var(--bg-tertiary)",border:"1px solid var(--border-color)",borderRadius:"var(--radius-sm)",color:"var(--text-primary)"}})]}),s.jsxs("div",{style:{marginBottom:20},children:[s.jsx("label",{style:{display:"block",marginBottom:4,fontSize:12,color:"var(--text-muted)"},children:"Add to Evaluation Set"}),s.jsx("select",{value:Ie,onChange:q=>we(q.target.value),style:{width:"100%",padding:"8px 12px",background:"var(--bg-tertiary)",border:"1px solid var(--border-color)",borderRadius:"var(--radius-sm)",color:"var(--text-primary)"},children:on.map(q=>s.jsx("option",{value:q.id,children:q.name},q.id))})]}),s.jsx("p",{style:{fontSize:12,color:"var(--text-muted)",marginBottom:16},children:"This will extract user messages and tool calls from the current session to create a replayable test case. You can edit the expected responses and tool calls in the Evals tab after creation."}),s.jsxs("div",{style:{display:"flex",gap:8,justifyContent:"flex-end"},children:[s.jsx("button",{className:"btn btn-secondary",onClick:()=>We(!1),children:"Cancel"}),s.jsx("button",{className:"btn btn-primary",onClick:vt,disabled:fe||!Ie,children:fe?"Creating...":"Create Test Case"})]})]})})]}):s.jsx("div",{className:"run-panel empty",children:"No project loaded"})}const TS=()=>Math.random().toString(36).substring(2,10),PS=()=>({id:TS(),name:"New SkillSet",description:"",embedding_model:void 0,app_model_id:void 0,external_store_type:void 0,external_store_config:{},search_enabled:!0,preload_enabled:!0,preload_top_k:3,preload_min_score:.4,sources:[],entry_count:0});function LS(){const{project:e,setProject:t}=st(),[n,r]=_.useState(null),[i,o]=_.useState(null),[a,l]=_.useState(""),[c,u]=_.useState([]),[d,p]=_.useState(!1),[f,m]=_.useState(!1),[y,b]=_.useState(""),[P,x]=_.useState(!1),[g,h]=_.useState(null),[L,C]=_.useState(null),w=_.useRef(null),S=(e==null?void 0:e.skillsets)||[],k=S.find(M=>M.id===n);_.useEffect(()=>{eg().then(M=>C(M.available)).catch(()=>C(!1))},[]),_.useEffect(()=>{S.length>0&&!n&&r(S[0].id)},[S,n]),_.useEffect(()=>{!e||!n||A()},[e==null?void 0:e.id,n]);const A=_.useCallback(async()=>{if(!(!e||!n))try{const M=await Kh(e.id,n);o(M),v(n,{entry_count:M.entry_count})}catch(M){console.error("Failed to load stats:",M)}},[e==null?void 0:e.id,n]),N=M=>{e&&t({...e,...M})},v=(M,j)=>{e&&t({...e,skillsets:e.skillsets.map(G=>G.id===M?{...G,...j}:G)})},E=()=>{if(!e)return;const M=PS();N({skillsets:[...S,M]}),r(M.id)},U=M=>{e&&confirm("Delete this SkillSet and all its data?")&&(N({skillsets:S.filter(j=>j.id!==M)}),n===M&&r(S.length>1?S[0].id:null),o(null),u([]))},V=async()=>{if(!(!e||!n||!a.trim())){p(!0),h(null);try{const M=await Xh(e.id,n,a.trim(),10,0);u(M.results)}catch(M){h("Search failed"),console.error(M)}finally{p(!1)}}},B=async()=>{if(!(!e||!n||!y.trim())){x(!0),h(null);try{const M=await Qh(e.id,n,y.trim());b(""),await A(),alert(`Added ${M.chunks_added} chunks from ${M.source_name}`)}catch(M){h(M.message||"Failed to fetch URL")}finally{x(!1)}}},X=async M=>{var G;const j=(G=M.target.files)==null?void 0:G[0];if(!(!j||!e||!n)){h(null);try{const Q=await Yh(e.id,n,j);await A(),alert(`Added ${Q.chunks_added} chunks from ${Q.source_name}`)}catch(Q){h(Q.message||"Upload failed")}w.current&&(w.current.value="")}},T=async()=>{if(!(!e||!n)&&confirm("Delete all entries in this SkillSet?"))try{await Zh(e.id,n),await A(),u([])}catch{h("Clear failed")}},$=M=>{const j=Math.round(M*100),G=160,Q=70,z=20+(1-M)*15,ue=.15+M*.25;return`linear-gradient(90deg, hsla(${G}, ${Q}%, ${z}%, ${ue}) 0%, transparent ${j}%)`};return e?s.jsxs("div",{className:"skillsets-panel",children:[s.jsx("style",{children:`
        .skillsets-panel {
          display: flex;
          height: 100%;
          gap: 16px;
      ...
      `}),s.jsxs("div",{className:"skillset-list",children:[s.jsxs("div",{className:"skillset-list-header",children:[s.jsx("h3",{children:"SkillSets"}),s.jsx("button",{className:"btn-icon",onClick:E,title:"Add SkillSet",children:s.jsx(Ue,{size:16})})]}),S.length===0?s.jsxs("div",{className:"empty-state",style:{padding:"40px 0"},children:[s.jsx(fn,{size:32}),s.jsx("span",{children:"No SkillSets"}),s.jsxs("button",{className:"btn-primary",onClick:E,children:[s.jsx(Ue,{size:14})," Create SkillSet"]})]}):S.map(M=>s.jsxs("div",{className:`skillset-item ${n===M.id?"selected":""}`,onClick:()=>r(M.id),children:[s.jsx(fn,{size:16,style:{color:"var(--accent)",flexShrink:0}}),s.jsxs("div",{className:"skillset-item-info",children:[s.jsx("div",{className:"skillset-item-name",children:M.name}),s.jsxs("div",{className:"skillset-item-count",children:[M.entry_count||0," entries"]})]}),s.jsx("button",{className:"skillset-item-delete",onClick:j=>{j.stopPropagation(),U(M.id)},children:s.jsx(Ae,{size:14})})]},M.id))]}),k?s.jsxs("div",{className:"skillset-detail",children:[s.jsxs("div",{className:"skillset-header",children:[s.jsxs("div",{className:"skillset-header-info",children:[s.jsx("input",{className:"skillset-name-input",value:k.name,onChange:M=>v(k.id,{name:M.target.value}),placeholder:"SkillSet Name"}),s.jsx("textarea",{className:"skillset-desc-input",value:k.description,onChange:M=>v(k.id,{description:M.target.value}),placeholder:"Description (optional)",rows:1}),s.jsxs("div",{className:"skillset-model",children:[s.jsx("label",{style:{fontSize:"12px",color:"var(--text-secondary)",marginRight:"8px"},children:"Embedding Model:"}),s.jsxs("select",{style:{flex:1,padding:"4px 8px",fontSize:"12px",background:"var(--bg-secondary)",border:"1px solid var(--border)",borderRadius:"4px",color:"var(--text-primary)"},value:k.embedding_model||"text-embedding-004",onChange:M=>v(k.id,{embedding_model:M.target.value}),children:[s.jsxs("optgroup",{label:"Google Gemini",children:[s.jsx("option",{value:"text-embedding-004",children:"text-embedding-004 (768d)"}),s.jsx("option",{value:"text-embedding-005",children:"text-embedding-005"})]}),s.jsxs("optgroup",{label:"OpenAI",children:[s.jsx("option",{value:"text-embedding-3-small",children:"text-embedding-3-small (1536d)"}),s.jsx("option",{value:"text-embedding-3-large",children:"text-embedding-3-large (3072d)"})]}),s.jsxs("optgroup",{label:"Cohere",children:[s.jsx("option",{value:"embed-english-v3.0",children:"embed-english-v3.0 (1024d)"}),s.jsx("option",{value:"embed-multilingual-v3.0",children:"embed-multilingual-v3.0 (1024d)"})]})]})]}),s.jsxs("div",{className:"skillset-stats",children:[s.jsxs("span",{className:"skillset-stat",children:[s.jsx("strong",{children:(i==null?void 0:i.entry_count)||0})," entries"]}),s.jsxs("span",{className:"skillset-stat",children:[s.jsx("strong",{children:Object.keys((i==null?void 0:i.sources)||{}).length})," sources"]}),L===!1&&s.jsx("span",{className:"skillset-stat",style:{color:"var(--warning)"},children:"⚠ No embeddings"})]})]}),s.jsx("button",{className:"btn-icon",onClick:A,title:"Refresh",children:s.jsx(En,{size:16})})]}),g&&s.jsxs("div",{className:"error-banner",children:[g,s.jsx("button",{onClick:()=>h(null),children:s.jsx(cg,{size:14})})]}),s.jsxs("div",{className:"search-section",children:[s.jsx("div",{className:"search-input-wrapper",children:s.jsx("input",{className:"search-input",value:a,onChange:M=>l(M.target.value),onKeyDown:M=>M.key==="Enter"&&V(),placeholder:"Search this SkillSet..."})}),s.jsxs("button",{className:"btn-primary",onClick:V,disabled:d||!a.trim(),children:[s.jsx(sg,{size:14}),d?"Searching...":"Search"]})]}),s.jsxs("div",{className:"search-results",children:[c.length===0&&!d&&a&&s.jsx("div",{className:"empty-state",children:s.jsx("span",{children:"No results found"})}),c.map(M=>s.jsxs("div",{className:"search-result",style:{background:$(M.score)},children:[s.jsxs("span",{className:"search-result-score",children:[(M.score*100).toFixed(0),"%"]}),s.jsx("div",{className:"search-result-text",children:M.text}),s.jsx("div",{className:"search-result-source",children:M.source_name})]},M.id))]}),s.jsxs("div",{className:"add-sources-section",children:[s.jsxs("div",{className:"add-sources-header",onClick:()=>m(!f),children:[f?s.jsx(Tt,{size:16}):s.jsx(Pt,{size:16}),s.jsx("h4",{children:"Add Sources"})]}),f&&s.jsxs("div",{className:"add-sources-content",children:[s.jsxs("div",{className:"source-row",children:[s.jsx(Wl,{size:16,style:{color:"var(--text-tertiary)"}}),s.jsx("input",{className:"source-input",value:y,onChange:M=>b(M.target.value),onKeyDown:M=>M.key==="Enter"&&B(),placeholder:"Enter URL (e.g., llms.txt file)"}),s.jsxs("button",{className:"btn-primary",onClick:B,disabled:P||!y.trim(),children:[s.jsx(x0,{size:14}),P?"Loading...":"Add"]})]}),s.jsxs("div",{className:"source-row",children:[s.jsx(m0,{size:16,style:{color:"var(--text-tertiary)"}}),s.jsx("input",{ref:w,type:"file",accept:".txt,.md,.json,.csv,.html",onChange:X}),s.jsxs("button",{className:"btn-primary",onClick:()=>{var M;return(M=w.current)==null?void 0:M.click()},children:[s.jsx(qo,{size:14}),"Upload File"]}),s.jsx("span",{style:{fontSize:"12px",color:"var(--text-tertiary)"},children:".txt, .md, .json, .csv"})]}),((i==null?void 0:i.entry_count)||0)>0&&s.jsx("div",{className:"source-row",style:{marginTop:"8px"},children:s.jsxs("button",{className:"clear-button",onClick:T,children:[s.jsx(Ae,{size:12}),"Clear All Entries (",(i==null?void 0:i.entry_count)||0,")"]})})]})]})]}):S.length>0?s.jsx("div",{className:"skillset-detail",children:s.jsxs("div",{className:"empty-state",children:[s.jsx(fn,{size:48}),s.jsx("span",{children:"Select a SkillSet"})]})}):null]}):null}const en={tool_trajectory_avg_score:{name:"Tool Trajectory",description:"Did the agent call the right tools in the expected order?",requiresJudge:!1,scale:[0,1]},response_match_score:{name:"Response Match (ROUGE-1)",description:"Does the response contain expected text? (fuzzy word matching)",requiresJudge:!1,scale:[0,1]},response_evaluation_score:{name:"Response Evaluation (LLM)",description:"LLM-judged semantic match of final response",requiresJudge:!0,scale:[1,5]},final_response_match_v2:{name:"Response Quality v2 (LLM)",description:"Enhanced LLM-judged response quality check",requiresJudge:!0,scale:[0,1]},safety_v1:{name:"Safety",description:"Is the response safe and harmless? (Vertex AI)",requiresJudge:!0,scale:[0,1]},hallucinations_v1:{name:"Hallucination Detection",description:"Are all claims supported by context? No false information?",requiresJudge:!0,scale:[0,1]},rubric_based_final_response_quality_v1:{name:"Rubric: Response Quality",description:"Custom rubric-based quality assessment of responses",requiresJudge:!0,scale:[0,1]},rubric_based_tool_use_quality_v1:{name:"Rubric: Tool Use Quality",description:"Custom rubric-based assessment of tool usage",requiresJudge:!0,scale:[0,1]}},Yi=(e,t,n)=>{if(t==null)return{value:"-",comparison:""};const r=en[e],i=(r==null?void 0:r.scale)||[0,1];if(i[0]===1&&i[1]===5){const o=n??3.5;return{value:t.toFixed(1),comparison:`${o.toFixed(1)} / ${i[1].toFixed(1)}`}}else{const o=n??.7;return{value:`${Math.round(t*100)}%`,comparison:`${Math.round(o*100)}% min`}}},AS={metrics:[{metric:"tool_trajectory_avg_score",enabled:!0,criterion:{threshold:1}},{metric:"response_match_score",enabled:!0,criterion:{threshold:.7}}],default_trajectory_match_type:"in_order",num_runs:1};function cx(){return`${Date.now().toString(36)}_${Math.random().toString(36).slice(2,6)}`}function RS(){const{project:e}=st(),[t,n]=_.useState([]),[r,i]=_.useState(null),[o,a]=_.useState(null),[l,c]=_.useState(new Set),[u,d]=_.useState(new Map),[p,f]=_.useState(new Map),[m,y]=_.useState(new Set),[b,P]=_.useState(!1),[x,g]=_.useState(null),[h,L]=_.useState([]),[C,w]=_.useState(null),S=async()=>{if(e)try{const I=await $e.get(`/projects/${e.id}/eval-history`);L(I.runs||[])}catch(I){console.warn("Failed to load eval history:",I)}},k=async(I,O=!0)=>{if(e)try{const F=(await $e.get(`/projects/${e.id}/eval-history/${I}`)).run;if(w(F),F!=null&&F.case_results){const K=new Map;for(const re of F.case_results)K.set(re.eval_case_id,re);d(K)}if((F==null?void 0:F.eval_set_id)==="batch")c(new Set(t.map(K=>K.id))),i(null);else if(F!=null&&F.eval_set_id){const K=new Map;K.set(F.eval_set_id,F),f(K),i(F.eval_set_id),c(re=>new Set([...re,F.eval_set_id]))}a(null),O&&window.history.pushState({run:I},"",`?run=${I}`)}catch(D){console.warn("Failed to load history run:",D)}},A=(I,O=!0)=>{i(I),a(null),w(null),O&&I?window.history.pushState({set:I},"",`?set=${I}`):O&&window.history.pushState({},"",window.location.pathname)},N=(I,O,D=!0)=>{i(I),a(O),w(null),D&&O?window.history.pushState({set:I,case:O},"",`?set=${I}&case=${O}`):D&&I&&window.history.pushState({set:I},"",`?set=${I}`)},v=()=>{w(null),d(new Map),f(new Map),window.history.pushState({},"",window.location.pathname)},E=async I=>{if(e)try{await $e.delete(`/projects/${e.id}/eval-history/${I}`),L(O=>O.filter(D=>D.id!==I)),(C==null?void 0:C.id)===I&&w(null)}catch(O){console.warn("Failed to delete history run:",O)}};_.useEffect(()=>{e!=null&&e.id&&(U(),S())},[e==null?void 0:e.id]),_.useEffect(()=>{const I=()=>{y(new Set(t.map(D=>D.id)))},O=()=>{y(new Set),S()};return window.addEventListener("eval-tests-started",I),window.addEventListener("eval-tests-completed",O),()=>{window.removeEventListener("eval-tests-started",I),window.removeEventListener("eval-tests-completed",O)}},[t]),_.useEffect(()=>{if(!(e!=null&&e.id)||b)return;const I=()=>{const D=new URLSearchParams(window.location.search),F=D.get("set"),K=D.get("case"),re=D.get("run");if(re){k(re,!1);return}if(F)i(F),a(K),w(null),c(me=>new Set([...me,F]));else{if(!r&&!o&&!C)return;i(null),a(null),w(null)}};I();const O=()=>{I()};return window.addEventListener("popstate",O),()=>window.removeEventListener("popstate",O)},[e==null?void 0:e.id,b,t.length]);const U=async()=>{var I,O;if(e!=null&&e.id){P(!0),g(null);try{const D=await $e.get(`/projects/${e.id}/eval-sets`);if(n(D.eval_sets||[]),((I=D.eval_sets)==null?void 0:I.length)>0){const F=new URLSearchParams(window.location.search),K=F.get("set"),re=F.get("case"),me=K||(re?(O=D.eval_sets.find(W=>W.eval_cases.some(ce=>ce.id===re)))==null?void 0:O.id:null)||D.eval_sets[0].id;c(new Set([me]))}}catch(D){g(D.message||"Failed to load eval sets")}finally{P(!1)}}},V=t.find(I=>I.id===r),B=V==null?void 0:V.eval_cases.find(I=>I.id===o),X=async()=>{if(e!=null&&e.id)try{const I=await $e.post(`/projects/${e.id}/eval-sets`,{name:"New Eval Set",description:"",eval_config:AS});n(O=>[...O,I.eval_set]),i(I.eval_set.id),c(O=>new Set([...O,I.eval_set.id]))}catch(I){g(I.message||"Failed to create eval set")}},T=async I=>{if(e!=null&&e.id)try{const O=await $e.post(`/projects/${e.id}/eval-sets/${I}/cases`,{name:"New Test Case",description:"",invocations:[{id:cx(),user_message:"",expected_response:"",expected_tool_calls:[],tool_trajectory_match_type:"in_order",rubrics:[]}],initial_state:{},rubrics:[],enabled_metrics:[],tags:[]});n(D=>D.map(F=>F.id===I?{...F,eval_cases:[...F.eval_cases,O.eval_case]}:F)),i(I),a(O.eval_case.id)}catch(O){g(O.message||"Failed to create eval case")}},$=async(I,O,D)=>{if(e!=null&&e.id)try{const F=await $e.put(`/projects/${e.id}/eval-sets/${I}/cases/${O}`,D);n(K=>K.map(re=>re.id===I?{...re,eval_cases:re.eval_cases.map(me=>me.id===O?F.eval_case:me)}:re))}catch(F){g(F.message||"Failed to update eval case")}},M=async(I,O)=>{if(e!=null&&e.id)try{await $e.delete(`/projects/${e.id}/eval-sets/${I}/cases/${O}`),n(D=>D.map(F=>F.id===I?{...F,eval_cases:F.eval_cases.filter(K=>K.id!==O)}:F)),o===O&&a(null)}catch(D){g(D.message||"Failed to delete eval case")}},j=async I=>{if(e!=null&&e.id)try{await $e.delete(`/projects/${e.id}/eval-sets/${I}`),n(O=>O.filter(D=>D.id!==I)),r===I&&(i(null),a(null))}catch(O){g(O.message||"Failed to delete eval set")}},G=async I=>{if(e!=null&&e.id)try{const O=await $e.get(`/projects/${e.id}/eval-sets/${I}/export`),D=new Blob([JSON.stringify(O,null,2)],{type:"application/json"}),F=URL.createObjectURL(D),K=document.createElement("a");K.href=F;const re=t.find(me=>me.id===I);K.download=`${(re==null?void 0:re.name)||"eval-set"}.json`,document.body.appendChild(K),K.click(),document.body.removeChild(K),URL.revokeObjectURL(F)}catch(O){g(O.message||"Failed to export eval set")}},Q=async I=>{if(e!=null&&e.id)try{const O=await I.text(),D=JSON.parse(O),F=await $e.post(`/projects/${e.id}/eval-sets/import`,D);n(K=>[...K,F.eval_set]),i(F.eval_set.id),c(K=>new Set([...K,F.eval_set.id]))}catch(O){g(O.message||"Failed to import eval set")}},z=_.useRef(null),ue=async()=>{if(!(!(e!=null&&e.id)||t.length===0))try{const I=await Promise.all(t.map(async K=>{try{return await $e.get(`/projects/${e.id}/eval-sets/${K.id}/export`)}catch{return K}})),O=new Blob([JSON.stringify(I,null,2)],{type:"application/json"}),D=URL.createObjectURL(O),F=document.createElement("a");F.href=D,F.download=`${e.name||"project"}-eval-sets.json`,document.body.appendChild(F),F.click(),document.body.removeChild(F),URL.revokeObjectURL(D)}catch(I){g(I.message||"Failed to export all eval sets")}},R=async(I,O)=>{if(e!=null&&e.id){y(D=>new Set([...D,O]));try{const D=await $e.post(`/projects/${e.id}/eval-sets/${I}/cases/${O}/run`,{});d(F=>new Map(F).set(O,D.result))}catch(D){g(D.message||"Failed to run eval case")}finally{y(D=>{const F=new Set(D);return F.delete(O),F})}}},ee=async I=>{if(!(e!=null&&e.id))return;const O=t.find(F=>F.id===I);if(!O)return;const D=O.eval_cases.map(F=>F.id);y(F=>new Set([...F,I,...D]));try{const F=await $e.post(`/projects/${e.id}/eval-sets/${I}/run`,{});f(K=>new Map(K).set(I,F.result));for(const K of F.result.case_results)d(re=>new Map(re).set(K.eval_case_id,K));try{await $e.post(`/projects/${e.id}/eval-history`,F.result),S()}catch(K){console.warn("Failed to save eval run to history:",K)}}catch(F){g(F.message||"Failed to run eval set")}finally{y(F=>{const K=new Set(F);return K.delete(I),D.forEach(re=>K.delete(re)),K})}},H=I=>{c(O=>{const D=new Set(O);return D.has(I)?D.delete(I):D.add(I),D})},ne=I=>{let O=I.eval_cases.length,D=0,F=0,K=0;for(const re of I.eval_cases){const me=u.get(re.id);me?me.passed?D++:F++:K++}return{total:O,passed:D,failed:F,pending:K}},ae=I=>I==null?"-":`${Math.round(I*100)}%`;return e?s.jsxs("div",{className:"eval-panel",children:[s.jsx("style",{children:`
        .eval-panel {
          display: flex;
          gap: 20px;
          height: calc(100vh - 180px);
      ...
      `}),s.jsxs("aside",{className:"eval-sidebar",children:[s.jsxs("div",{className:"sidebar-header",children:[s.jsx("h3",{children:"Evaluation Tests"}),s.jsxs("div",{className:"header-actions",children:[s.jsx("input",{type:"file",ref:z,accept:".json",style:{display:"none"},onChange:I=>{var D;const O=(D=I.target.files)==null?void 0:D[0];O&&(Q(O),I.target.value="")}}),s.jsx("button",{className:"btn btn-secondary btn-sm",onClick:()=>{var I;return(I=z.current)==null?void 0:I.click()},title:"Import eval set from JSON",children:s.jsx(qo,{size:14})}),t.length>0&&s.jsx("button",{className:"btn btn-secondary btn-sm",onClick:ue,title:"Download all eval sets as JSON",children:s.jsx(ss,{size:14})}),s.jsx("button",{className:"btn btn-secondary btn-sm",onClick:U,title:"Refresh",children:s.jsx(En,{size:14})}),s.jsxs("button",{className:"btn btn-primary btn-sm",onClick:X,title:"New eval set",children:[s.jsx(Ue,{size:14}),"Set"]})]})]}),s.jsxs("div",{className:"eval-tree",children:[b&&s.jsx("p",{style:{color:"var(--text-muted)",padding:"16px"},children:"Loading..."}),x&&s.jsx("div",{style:{color:"var(--error)",padding:"16px",fontSize:"13px"},children:x}),!b&&t.length===0&&s.jsxs("div",{className:"empty-state",style:{padding:"32px"},children:[s.jsx(cu,{size:32}),s.jsxs("p",{children:["No evaluation sets yet.",s.jsx("br",{}),"Create one to get started."]})]}),t.map(I=>{const O=l.has(I.id),D=ne(I),F=m.has(I.id);return s.jsxs("div",{className:"tree-item",children:[s.jsxs("div",{className:`tree-set ${r===I.id&&!o?"selected":""}`,onClick:()=>A(I.id),children:[s.jsx("button",{className:"expand-btn",onClick:K=>{K.stopPropagation(),H(I.id)},children:I.eval_cases.length>0?O?s.jsx(Tt,{size:14}):s.jsx(Pt,{size:14}):s.jsx("span",{style:{width:14}})}),s.jsx(rg,{size:14,style:{color:"var(--accent-secondary)"}}),s.jsx("span",{className:"set-name",children:I.name}),s.jsx("button",{className:"add-case-btn",onClick:K=>{K.stopPropagation(),T(I.id)},title:"Add test case",style:{padding:"2px 4px",marginLeft:4,background:"transparent",border:"none",cursor:"pointer",opacity:.6,display:"flex",alignItems:"center"},children:s.jsx(Ue,{size:12})}),D.total>0&&s.jsxs("span",{className:"set-stats",children:[D.passed>0&&s.jsx("span",{className:"stat-passed",children:D.passed}),D.failed>0&&s.jsx("span",{className:"stat-failed",children:D.failed}),D.pending>0&&s.jsx("span",{className:"stat-pending",children:D.pending})]}),s.jsx("button",{className:"run-btn",onClick:K=>{K.stopPropagation(),ee(I.id)},title:"Run all tests in this set",disabled:F,children:F?s.jsx(vo,{size:12,className:"spinning"}):s.jsx(Fn,{size:12})})]}),O&&s.jsx("div",{className:"tree-children",style:{paddingLeft:16},children:I.eval_cases.map(K=>{var W;const re=u.get(K.id),me=m.has(K.id);return s.jsxs("div",{className:`tree-case ${o===K.id?"selected":""}`,onClick:()=>N(I.id,K.id),children:[me?s.jsx(vo,{size:14,className:"spinning",style:{color:"var(--warning)"}}):re?re.passed?s.jsx(lr,{size:14,style:{color:"var(--success)"}}):s.jsx(qr,{size:14,style:{color:"var(--error)"}}):s.jsx(bo,{size:14,style:{color:"var(--text-muted)"}}),s.jsx("span",{className:"case-name",children:K.name}),re&&re.metric_results.length>0&&s.jsx("span",{style:{fontSize:11,color:re.passed?"var(--success)":"var(--error)"},children:ae((W=re.metric_results[0])==null?void 0:W.score)}),s.jsx("button",{className:"run-btn",onClick:ce=>{ce.stopPropagation(),R(I.id,K.id)},disabled:me,children:s.jsx(Fn,{size:12})})]},K.id)})})]},I.id)})]}),s.jsxs("div",{className:"history-section",children:[s.jsx("div",{className:"history-header",style:{display:"flex",justifyContent:"space-between",alignItems:"center",padding:"10px 12px",borderTop:"1px solid var(--border-color)",background:"var(--bg-secondary)"},children:s.jsxs("span",{style:{fontWeight:500,fontSize:13},children:["Previous Runs (",h.length,")"]})}),s.jsx("div",{className:"history-list",style:{maxHeight:200,overflowY:"auto"},children:h.length===0?s.jsx("div",{style:{padding:"12px",color:"var(--text-secondary)",fontSize:12,textAlign:"center"},children:"No previous runs"}):[...h].sort((I,O)=>(O.started_at||0)-(I.started_at||0)).map(I=>{const O=I.passed_cases===I.total_cases;return s.jsx("div",{className:`history-item ${(C==null?void 0:C.id)===I.id?"selected":""}`,onClick:()=>k(I.id),style:{padding:"8px 12px",borderBottom:"1px solid var(--border-color)",cursor:"pointer",background:(C==null?void 0:C.id)===I.id?"var(--bg-tertiary)":"transparent",fontSize:12},children:s.jsxs("div",{style:{display:"flex",justifyContent:"space-between",alignItems:"center"},children:[s.jsxs("div",{style:{display:"flex",alignItems:"center",gap:8},children:[O?s.jsx(lr,{size:14,style:{color:"var(--success)",flexShrink:0}}):s.jsx(qr,{size:14,style:{color:"var(--error)",flexShrink:0}}),s.jsxs("div",{children:[s.jsx("div",{style:{fontWeight:500},children:I.eval_set_name||"Unnamed"}),s.jsx("div",{style:{color:"var(--text-secondary)",fontSize:11},children:new Date(I.started_at*1e3).toLocaleString()})]})]}),s.jsxs("div",{style:{display:"flex",alignItems:"center",gap:8},children:[s.jsxs("span",{style:{color:O?"var(--success)":"var(--error)",fontWeight:500,fontSize:11},children:[I.passed_cases,"/",I.total_cases]}),s.jsx("button",{className:"btn btn-icon",onClick:D=>{D.stopPropagation(),E(I.id)},title:"Delete run",style:{padding:2},children:s.jsx(Ae,{size:12})})]})]})},I.id)})})]})]}),s.jsx("div",{className:"eval-editor",children:C?s.jsx(OS,{run:C,onClose:v}):B?s.jsx(IS,{evalCase:B,evalSetId:r,projectId:e.id,result:u.get(B.id),isRunning:m.has(B.id),onUpdate:I=>$(r,B.id,I),onDelete:()=>M(r,B.id),onRun:()=>R(r,B.id),onClearResult:()=>d(I=>{const O=new Map(I);return O.delete(B.id),O})}):V?s.jsx(DS,{evalSet:V,projectId:e.id,result:p.get(V.id),isRunning:m.has(V.id),caseResults:u,onUpdate:async I=>{try{const O=await $e.put(`/projects/${e.id}/eval-sets/${V.id}`,I);n(D=>D.map(F=>F.id===V.id?O.eval_set:F))}catch(O){g(O.message)}},onDelete:()=>j(V.id),onRun:()=>ee(V.id),onExport:()=>G(V.id)}):s.jsx("div",{className:"editor-content",children:s.jsxs("div",{className:"empty-state",children:[s.jsx(bo,{size:48}),s.jsxs("p",{children:["Select a test case to edit",s.jsx("br",{}),"or create a new one"]})]})})})]}):null}function MS({value:e,onChange:t}){var a,l;const{project:n}=st(),r=((a=n==null?void 0:n.app)==null?void 0:a.models)||[],i=(l=n==null?void 0:n.app)==null?void 0:l.default_model_id,o=r.find(c=>c.id===i);return s.jsxs("select",{value:e,onChange:c=>t(c.target.value),style:{width:"100%",maxWidth:400},children:[s.jsx("option",{value:"",children:o?`App Default (${o.model_name})`:"App Default"}),r.map(c=>s.jsx("option",{value:c.model_name,children:c.model_name},c.id)),s.jsx("option",{value:"gemini-2.0-flash",children:"gemini-2.0-flash"}),s.jsx("option",{value:"gemini-2.5-flash",children:"gemini-2.5-flash"}),s.jsx("option",{value:"gemini-2.5-pro",children:"gemini-2.5-pro"})]})}function OS({run:e,onClose:t}){var m;const{project:n}=st(),[r,i]=_.useState(!0),[o,a]=_.useState(new Set),l=e.case_results||[],c=l.filter(y=>y.passed).length,u=l.filter(y=>!y.passed).length,d=r?l.filter(y=>!y.passed):l,p=y=>{a(b=>{const P=new Set(b);return P.has(y)?P.delete(y):P.add(y),P})},f=y=>{y&&n&&(window.location.href=`/project/${n.id}/run?session=${y}`)};return s.jsxs("div",{className:"test-result-viewer",children:[s.jsx("style",{children:`
        .test-result-viewer {
          height: 100%;
          display: flex;
          flex-direction: column;
...
`)}function qS(){const{project:e}=st(),[t,n]=_.useState(!1);if(!e)return null;const r=_.useMemo(()=>HS(e),[e]);function i(){navigator.clipboard.writeText(r),n(!0),setTimeout(()=>n(!1),2e3)}function o(){const a=new Blob([r],{type:"text/x-python"}),l=URL.createObjectURL(a),c=document.createElement("a");c.href=l,c.download=`${e.name}_agent.py`,c.click(),URL.revokeObjectURL(l)}return s.jsxs("div",{className:"code-panel",children:[s.jsx("style",{children:`
      ...
      `}),s.jsxs("div",{className:"code-header",children:[s.jsxs("div",{className:"code-title",children:[s.jsx(rn,{size:16}),s.jsx("h3",{children:"Python Code"}),s.jsx("span",{className:"badge",children:"Generated"}),t&&s.jsxs("span",{className:"status-badge success",children:[s.jsx(tg,{size:12}),"Copied!"]})]}),s.jsxs("div",{className:"code-actions",children:[s.jsxs("button",{className:"btn btn-secondary btn-sm",onClick:i,title:"Copy to clipboard",children:[s.jsx(Ho,{size:14}),"Copy"]}),s.jsxs("button",{className:"btn btn-secondary btn-sm",onClick:o,title:"Download Python file",children:[s.jsx(ss,{size:14}),"Download"]})]})]}),s.jsx("div",{className:"code-editor",children:s.jsx(Wt,{height:"100%",language:"python",theme:"vs-dark",value:r,options:{readOnly:!0,minimap:{enabled:!1},fontSize:13,fontFamily:"'JetBrains Mono', monospace",lineNumbers:"on",scrollBeyondLastLine:!1,automaticLayout:!0,tabSize:4,insertSpaces:!0,padding:{top:12},wordWrap:"on"}})}),s.jsxs("div",{className:"code-info",children:[s.jsx("p",{children:"This is the Python code equivalent of your project configuration. You can use this code directly with ADK."}),s.jsxs("p",{children:["Place this in a file named ",s.jsx("code",{children:"agent.py"})," inside your agent directory, then run with ",s.jsx("code",{children:"adk web ."})," or ",s.jsx("code",{children:"adk run your_agent"}),"."]})]})]})}const JS=[{id:"app",label:"App",icon:og},{id:"agents",label:"Agents",icon:nr},{id:"tools",label:"Tools",icon:Jt},{id:"callbacks",label:"Callbacks",icon:rn},{id:"run",label:"Run",icon:ig},{id:"skillsets",label:"SkillSets",icon:d0},{id:"eval",label:"Evaluate",icon:ql},{id:"yaml",label:"YAML",icon:f0},{id:"code",label:"Code",icon:rn}],GS=["app","agents","tools","callbacks","run","skillsets","eval","yaml","code"];function Ha(){var B,X;const{projectId:e,tab:t,itemId:n}=f1(),r=nu(),{project:i,setProject:o,activeTab:a,setActiveTab:l,hasUnsavedChanges:c,setHasUnsavedChanges:u,selectedAgentId:d,setSelectedAgentId:p,selectedToolId:f,setSelectedToolId:m}=st(),[y,b]=_.useState(!0),[P,x]=_.useState(!1),[g,h]=_.useState(!1),[L,C]=_.useState(null),w=_.useRef(!0),S=_.useRef(null);_.useEffect(()=>{t&&GS.includes(t)?l(t):!t&&e&&r(`/project/${e}/${a}`,{replace:!0})},[t,e]),_.useEffect(()=>{t==="agents"&&n?p(n):t==="tools"&&n&&m(n)},[t,n]);function k(T){l(T),T==="agents"&&d?r(`/project/${e}/${T}/${d}`,{replace:!0}):T==="tools"&&f?r(`/project/${e}/${T}/${f}`,{replace:!0}):r(`/project/${e}/${T}`,{replace:!0})}function A(T){T?r(`/project/${e}/${a}/${T}`,{replace:!0}):r(`/project/${e}/${a}`,{replace:!0})}_.useEffect(()=>(e&&N(e),()=>{o(null),u(!1)}),[e]);async function N(T){w.current=!0;try{const $=await Oh(T);o($),S.current=JSON.stringify($),u(!1)}catch($){console.error("Failed to load project:",$),r("/")}finally{b(!1),setTimeout(()=>{w.current=!1},100)}}async function v(){if(i){x(!0);try{const{eval_sets:T,...$}=i;await Bl(i.id,$),S.current=JSON.stringify(i),u(!1)}catch(T){console.error("Failed to save project:",T)}finally{x(!1)}}}async function E(){if(i){h(!0),C(null),window.dispatchEvent(new CustomEvent("eval-tests-started"));try{let T=0,$=0;const M=[],j=[];for(const G of i.eval_sets||[]){if(G.eval_cases.length===0)continue;const Q=await $e.post(`/projects/${i.id}/eval-sets/${G.id}/run`,{});Q.result&&(T+=Q.result.passed_cases||0,$+=Q.result.total_cases||0,Q.result.case_results&&M.push(...Q.result.case_results),j.push(Q.result.eval_set_name||G.name||G.id))}if(M.length>0){const G={id:Date.now().toString(36)+Math.random().toString(36).substr(2,5),eval_set_id:"batch",eval_set_name:j.length>1?`All Tests (${j.length} sets)`:j[0]||"All Tests",started_at:Date.now()/1e3,completed_at:Date.now()/1e3,total_cases:$,passed_cases:T,failed_cases:$-T,case_results:M};try{await $e.post(`/projects/${i.id}/eval-history`,G)}catch(Q){console.warn("Failed to save batch eval run to history:",Q)}}C({passed:T,total:$}),window.dispatchEvent(new CustomEvent("eval-tests-completed")),setTimeout(()=>C(null),5e3)}catch(T){console.error("Failed to run tests:",T),C({passed:0,total:-1}),setTimeout(()=>C(null),5e3)}finally{h(!1)}}}const U=_.useRef(null);_.useEffect(()=>{if(i&&!w.current&&U.current){const T=i.app.models||[],$=U.current||[];if(T.some((j,G)=>{const Q=$.find(z=>z.id===j.id);return Q?Q.provider!==j.provider||Q.model_name!==j.model_name||Q.api_base!==j.api_base||Q.temperature!==j.temperature||Q.max_output_tokens!==j.max_output_tokens||Q.top_p!==j.top_p||Q.top_k!==j.top_k:!1})){const j=i.app.default_model_id,G=i.agents.map(z=>{if(z.type==="LlmAgent"&&z.model){const ue=z.model._appModelId;if(ue){const R=T.find(ee=>ee.id===ue);if(R)return{...z,model:{provider:R.provider,model_name:R.model_name,api_base:R.api_base,temperature:R.temperature,max_output_tokens:R.max_output_tokens,top_p:R.top_p,top_k:R.top_k,fallbacks:[],_appModelId:ue}}}else if(j){const R=T.find(ee=>ee.id===j);if(R&&z.model.provider===R.provider&&z.model.model_name===R.model_name&&z.model.api_base===R.api_base)return{...z,model:{provider:R.provider,model_name:R.model_name,api_base:R.api_base,temperature:R.temperature,max_output_tokens:R.max_output_tokens,top_p:R.top_p,top_k:R.top_k,fallbacks:[],_appModelId:j}}}}return z});G.some((z,ue)=>JSON.stringify(z)!==JSON.stringify(i.agents[ue]))&&o({...i,agents:G})}}i&&(U.current=i.app.models||[])},[i==null?void 0:i.app.models,i,o]);const V=_.useRef(null);return _.useEffect(()=>(i&&!w.current&&S.current&&JSON.stringify(i)!==S.current&&(u(!0),V.current&&clearTimeout(V.current),V.current=setTimeout(async()=>{try{const{eval_sets:$,...M}=i;await Bl(i.id,M),S.current=JSON.stringify(i),u(!1)}catch($){console.error("Auto-save failed:",$)}},500)),()=>{V.current&&clearTimeout(V.current)}),[i]),y?s.jsxs("div",{className:"loading-screen",children:[s.jsx("style",{children:`
          .loading-screen {
            height: 100vh;
            display: flex;
            align-items: center;
