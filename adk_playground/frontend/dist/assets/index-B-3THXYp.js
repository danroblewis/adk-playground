 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */(function(e){function t(O,M){var j=O.length;O.push(M);e:for(;0<j;){var V=j-1>>>1,J=O[V];if(0<i(J,M))O[V]=M,O[j]=J,j=V;else break e}}function n(O){return O.length===0?null:O[0]}function r(O){if(O.length===0)return null;var M=O[0],j=O.pop();if(j!==M){O[0]=j;e:for(var V=0,J=O.length,v=J>>>1;V<v;){var U=2*(V+1)-1,P=O[U],Q=U+1,ue=O[Q];if(0>i(P,j))Q<J&&0>i(ue,P)?(O[V]=ue,O[Q]=j,V=Q):(O[V]=P,O[U]=j,V=U);else if(Q<J&&0>i(ue,j))O[V]=ue,O[Q]=j,V=Q;else break e}}return M}function i(O,M){var j=O.sortIndex-M.sortIndex;return j!==0?j:O.id-M.id}if(typeof performance=="object"&&typeof performance.now=="function"){var s=performance;e.unstable_now=function(){return s.now()}}else{var a=Date,l=a.now();e.unstable_now=function(){return a.now()-l}}var c=[],u=[],d=1,p=null,f=3,h=!1,x=!1,b=!1,k=typeof setTimeout=="function"?setTimeout:null,m=typeof clearTimeout=="function"?clearTimeout:null,g=typeof setImmediate<"u"?setImmediate:null;typeof navigator<"u"&&navigator.scheduling!==void 0&&navigator.scheduling.isInputPending!==void 0&&navigator.scheduling.isInputPending.bind(navigator.scheduling);function y(O){for(var M=n(u);M!==null;){if(M.callback===null)r(u);else if(M.startTime<=O)r(u),M.sortIndex=M.expirationTime,t(c,M);else break;M=n(u)}}function _(O){if(b=!1,y(O),!x)if(n(c)!==null)x=!0,D(z);else{var M=n(u);M!==null&&E(_,M.startTime-O)}}function z(O,M){x=!1,b&&(b=!1,m(C),C=-1),h=!0;var j=f;try{for(y(M),p=n(c);p!==null&&(!(p.expirationTime>M)||O&&!I());){var V=p.callback;if(typeof V=="function"){p.callback=null,f=p.priorityLevel;var J=V(p.expirationTime<=M);M=e.unstable_now(),typeof J=="function"?p.callback=J:p===n(c)&&r(c),y(M)}else r(c);p=n(c)}if(p!==null)var v=!0;else{var U=n(u);U!==null&&E(_,U.startTime-M),v=!1}return v}finally{p=null,f=j,h=!1}}var w=!1,A=null,C=-1,$=5,N=-1;function I(){return!(e.unstable_now()-N<$)}function R(){if(A!==null){var O=e.unstable_now();N=O;var M=!0;try{M=A(!0,O)}finally{M?W():(w=!1,A=null)}}else w=!1}var W;if(typeof g=="function")W=function(){g(R)};else if(typeof MessageChannel<"u"){var T=new MessageChannel,L=T.port2;T.port1.onmessage=R,W=function(){L.postMessage(null)}}else W=function(){k(R,0)};function D(O){A=O,w||(w=!0,W())}function E(O,M){C=k(function(){O(e.unstable_now())},M)}e.unstable_IdlePriority=5,e.unstable_ImmediatePriority=1,e.unstable_LowPriority=4,e.unstable_NormalPriority=3,e.unstable_Profiling=null,e.unstable_UserBlockingPriority=2,e.unstable_cancelCallback=function(O){O.callback=null},e.unstable_continueExecution=function(){x||h||(x=!0,D(z))},e.unstable_forceFrameRate=function(O){0>O||125<O?console.error("forceFrameRate takes a positive int between 0 and 125, forcing frame rates higher than 125 fps is not supported"):$=0<O?Math.floor(1e3/O):5},e.unstable_getCurrentPriorityLevel=function(){return f},e.unstable_getFirstCallbackNode=function(){return n(c)},e.unstable_next=function(O){switch(f){case 1:case 2:case 3:var M=3;break;default:M=f}var j=f;f=M;try{return O()}finally{f=j}},e.unstable_pauseExecution=function(){},e.unstable_requestPaint=function(){},e.unstable_runWithPriority=function(O,M){switch(O){case 1:case 2:case 3:case 4:case 5:break;default:O=3}var j=f;f=O;try{return M()}finally{f=j}},e.unstable_scheduleCallback=function(O,M,j){var V=e.unstable_now();switch(typeof j=="object"&&j!==null?(j=j.delay,j=typeof j=="number"&&0<j?V+j:V):j=V,O){case 1:var J=-1;break;case 2:J=250;break;case 5:J=1073741823;break;case 4:J=1e4;break;default:J=5e3}return J=j+J,O={id:d++,callback:M,priorityLevel:O,startTime:j,expirationTime:J,sortIndex:-1},j>V?(O.sortIndex=j,t(u,O),n(c)===null&&O===n(u)&&(b?(m(C),C=-1):b=!0,E(_,j-V))):(O.sortIndex=J,t(c,O),x||h||(x=!0,D(z))),O},e.unstable_shouldYield=I,e.unstable_wrapCallback=function(O){var M=f;return function(){var j=f;f=M;try{return O.apply(this,arguments)}finally{f=j}}}})(ng);tg.exports=ng;var s0=tg.exports;/**
 * @license React
...
`).length,h=Math.max(r,Math.min(f*20+40,500));l(h)}},[e,r]),S.useEffect(()=>{i&&u.current&&u.current.focus()},[i]);function d(f){u.current=f,f.focus()}function p(f){c.current&&!c.current.contains(f.target)&&s(!1)}return S.useEffect(()=>{if(i)return document.addEventListener("mousedown",p),()=>document.removeEventListener("mousedown",p)},[i]),o.jsxs("div",{ref:c,className:"markdown-editor",children:[o.jsx("style",{children:`
      ...
      `}),i?o.jsx("div",{className:"monaco-wrapper",children:o.jsx(Jt,{height:"100%",language:"markdown",theme:"vs-dark",value:e,onChange:f=>t(f||""),onMount:d,options:{minimap:{enabled:!1},fontSize:14,fontFamily:"'JetBrains Mono', monospace",lineNumbers:"off",scrollBeyondLastLine:!1,automaticLayout:!0,wordWrap:"on",padding:{top:12,bottom:12},lineDecorationsWidth:8,folding:!1,glyphMargin:!1,renderLineHighlight:"none",overviewRulerLanes:0,hideCursorInOverviewRuler:!0,scrollbar:{vertical:"auto",horizontal:"hidden"}}})}):o.jsxs("div",{className:"markdown-preview",onClick:()=>s(!0),children:[o.jsxs("span",{className:"edit-hint",children:[o.jsx(Jk,{size:12}),"Click to edit"]}),e?o.jsx("div",{className:"markdown-content",children:o.jsx(Bv,{children:e})}):o.jsx("div",{className:"markdown-placeholder",children:n})]})]})}function o4(e){return/^[a-zA-Z0-9_]+$/.test(e)}function s4({agent:e}){const{project:t,updateAgent:n,mcpServers:r,builtinTools:i,setActiveTab:s,setRunAgentId:a}=ut(),[l,c]=S.useState(new Set(["basic","model","tools","subagents"])),[u,d]=S.useState(!1),[p,f]=S.useState(!1),[h,x]=S.useState(!1),[b,k]=S.useState(""),[m,g]=S.useState(null);if(!t)return null;function y(E){n(e.id,E)}function _(E){if(E===""){g(null),y({name:E});return}o4(E)?g(null):g("Name can only contain letters, numbers, and underscores"),e.type==="LlmAgent"?y({name:E,output_key:E}):y({name:E})}function z(E){const O=new Set(l);O.has(E)?O.delete(E):O.add(E),c(O)}const w=e.type==="LlmAgent",A=e;function C(E){w&&y({tools:[...A.tools,E]})}function $(E){w&&y({tools:A.tools.filter((O,M)=>M!==E)})}function N(E,O){if(!w)return;const M=[...A.tools];M[E]=O,y({tools:M})}function I(E){"sub_agents"in e&&y({sub_agents:[...e.sub_agents,E]})}function R(E){"sub_agents"in e&&y({sub_agents:e.sub_agents.filter(O=>O!==E)})}const W=t.agents.filter(E=>E.id!==e.id);async function T(){if(!(!t||!w)){d(!0);try{const E=A.instruction||"",O=E?`Current instruction to improve:

${E}

Please improve and expand this instruction while preserving its core intent.`:void 0,j=t.agents.some(J=>J.id===e.id)?void 0:e,V=await Ks(t.id,e.id,O,j);V.success&&V.prompt?y({instruction:V.prompt}):alert("Failed to generate prompt: "+(V.error||"Unknown error"))}catch(E){alert("Error generating prompt: "+E.message)}finally{d(!1)}}}async function L(){if(!(!t||!w||!b.trim())){d(!0);try{const O=`Current instruction:
...
Please apply the requested changes to the instruction above. Output only the updated instruction, nothing else.`,j=t.agents.some(J=>J.id===e.id)?void 0:e,V=await Ks(t.id,e.id,O,j);V.success&&V.prompt?(y({instruction:V.prompt}),x(!1),k("")):alert("Failed to apply changes: "+(V.error||"Unknown error"))}catch(E){alert("Error applying changes: "+E.message)}finally{d(!1)}}}async function D(){if(!t||!w)return;const E=A.instruction;if(!E){alert("Please write an instruction first");return}f(!0);try{const O=`Write a 5-10 word description of what this agent does.
...
Your response (5-10 words only):`,M=await Ks(t.id,e.id,O);if(M.success&&M.prompt){let j=M.prompt.trim();j=j.replace(/^["']|["']$/g,"").trim();const V=j.split(/[.!?\n]/)[0].trim(),J=V.length>80?V.slice(0,77)+"...":V;y({description:J})}else alert("Failed to generate description: "+(M.error||"Unknown error"))}catch(O){alert("Error generating description: "+O.message)}finally{f(!1)}}return o.jsxs("div",{className:"agent-editor",children:[o.jsx("style",{children:`
      ...
      `}),o.jsxs("div",{className:"editor-header",children:[o.jsx(Er,{size:24,style:{color:"var(--accent-primary)"}}),o.jsxs("div",{style:{flex:1,display:"flex",flexDirection:"column",gap:4},children:[o.jsx("input",{type:"text",value:e.name,onChange:E=>_(E.target.value),placeholder:"Agent name",style:{borderColor:m?"var(--error)":void 0}}),m&&o.jsx("span",{style:{fontSize:11,color:"var(--error)",marginTop:-4},children:m})]}),o.jsx("span",{className:"badge badge-info",children:e.type}),o.jsxs("button",{className:"btn btn-primary btn-sm run-agent-btn",onClick:()=>{a(e.id),s("run")},title:"Test this agent",children:[o.jsx(pr,{size:14}),"Run"]})]}),o.jsxs("div",{className:"editor-content",children:[o.jsxs(qi,{id:"basic",title:"Basic Info",icon:o.jsx(Er,{size:16}),expanded:l.has("basic"),onToggle:()=>z("basic"),children:[o.jsx("div",{className:"form-row",children:o.jsxs("div",{className:"form-group full-width",children:[o.jsxs("div",{className:"label-with-action",children:[o.jsx("label",{children:"Description"}),w&&A.instruction&&o.jsx("button",{className:"btn btn-secondary btn-sm generate-btn",onClick:D,disabled:p,title:"Generate description from instruction",children:p?o.jsxs(o.Fragment,{children:[o.jsx(Zn,{size:14,className:"spin"}),"Summarizing..."]}):"Summarize"})]}),o.jsx("input",{type:"text",value:e.description,onChange:E=>y({description:E.target.value}),placeholder:"e.g., Reviews code for bugs and suggests fixes"})]})}),w&&o.jsxs(o.Fragment,{children:[o.jsx("div",{className:"form-row",children:o.jsxs("div",{className:"form-group full-width",children:[o.jsxs("div",{className:"label-with-action",children:[o.jsx("label",{children:"Instruction"}),o.jsxs("div",{className:"action-buttons",children:[o.jsx("button",{className:"btn btn-secondary btn-sm",onClick:()=>x(!h),disabled:u||!A.instruction,title:"Request specific changes to the instruction",children:"Request Changes"}),o.jsx("button",{className:"btn btn-secondary btn-sm",onClick:T,disabled:u,title:"Uses AI to improve and expand the current instruction",children:u?o.jsxs(o.Fragment,{children:[o.jsx(Zn,{size:14,className:"spin"}),"Working..."]}):"Auto-Improve"})]})]}),h&&o.jsxs("div",{className:"request-changes-box",children:[o.jsx("input",{type:"text",value:b,onChange:E=>k(E.target.value),placeholder:"Describe what changes you want...",onKeyDown:E=>{E.key==="Enter"&&b.trim()?L():E.key==="Escape"&&(x(!1),k(""))},autoFocus:!0}),o.jsx("button",{className:"btn btn-primary btn-sm",onClick:L,disabled:u||!b.trim(),children:"Apply"})]}),o.jsx(i4,{value:A.instruction,onChange:E=>y({instruction:E}),placeholder:"Write your agent's instruction here... (Markdown supported)",minHeight:200})]})}),o.jsxs("div",{className:"form-row",children:[o.jsxs("div",{className:"form-group",children:[o.jsx("label",{children:"Output Key"}),o.jsxs("select",{value:A.output_key||"",onChange:E=>y({output_key:E.target.value||void 0}),children:[o.jsx("option",{value:"",children:"None"}),t.app.state_keys.map(E=>o.jsx("option",{value:E.name,children:E.name},E.name))]})]}),o.jsxs("div",{className:"form-group",children:[o.jsx("label",{children:"Include Contents"}),o.jsxs("select",{value:A.include_contents,onChange:E=>y({include_contents:E.target.value}),children:[o.jsx("option",{value:"default",children:"Default"}),o.jsx("option",{value:"none",children:"None"})]})]})]}),o.jsxs("div",{className:"form-row",style:{gap:24},children:[o.jsxs("label",{style:{display:"flex",alignItems:"center",gap:8,fontSize:13},children:[o.jsxs("span",{className:"toggle-switch",children:[o.jsx("input",{type:"checkbox",checked:A.disallow_transfer_to_parent,onChange:E=>y({disallow_transfer_to_parent:E.target.checked})}),o.jsx("span",{className:"toggle-slider"})]}),"Disallow transfer to parent"]}),o.jsxs("label",{style:{display:"flex",alignItems:"center",gap:8,fontSize:13},children:[o.jsxs("span",{className:"toggle-switch",children:[o.jsx("input",{type:"checkbox",checked:A.disallow_transfer_to_peers,onChange:E=>y({disallow_transfer_to_peers:E.target.checked})}),o.jsx("span",{className:"toggle-slider"})]}),"Disallow transfer to peers"]})]})]}),e.type==="LoopAgent"&&o.jsx("div",{className:"form-row",children:o.jsxs("div",{className:"form-group",children:[o.jsx("label",{children:"Max Iterations"}),o.jsx("input",{type:"number",value:e.max_iterations||"",onChange:E=>y({max_iterations:parseInt(E.target.value)||void 0}),placeholder:"No limit"})]})})]}),w&&o.jsx(qi,{id:"model",title:"Model",icon:o.jsx(Od,{size:16}),expanded:l.has("model"),onToggle:()=>z("model"),children:o.jsx(l4,{agent:A,appModels:t.app.models||[],defaultModelId:t.app.default_model_id,projectId:t.id,onUpdate:E=>y({model:E})})}),w&&o.jsx(qi,{id:"tools",title:`Tools (${A.tools.length})`,icon:o.jsx(an,{size:16}),expanded:l.has("tools"),onToggle:()=>z("tools"),children:o.jsx(a4,{tools:A.tools,onAdd:C,onRemove:$,onUpdate:N,builtinTools:i,mcpServers:r,projectMcpServers:t.mcp_servers,customTools:t.custom_tools,agents:W,skillsets:t.skillsets||[]})}),"sub_agents"in e&&o.jsx(qi,{id:"subagents",title:`Sub-Agents (${e.sub_agents.length})`,icon:o.jsx(Ky,{size:16}),expanded:l.has("subagents"),onToggle:()=>z("subagents"),children:o.jsxs("div",{className:"sub-agent-list",children:[e.sub_agents.map(E=>{const O=t.agents.find(M=>M.id===E);return O?o.jsxs("div",{className:"sub-agent-chip",children:[O.name,o.jsx("button",{onClick:()=>R(E),children:o.jsx(Fe,{size:12})})]},E):null}),o.jsxs("select",{value:"",onChange:E=>{E.target.value&&I(E.target.value)},style:{width:150,padding:"6px 10px",fontSize:13},children:[o.jsx("option",{value:"",children:"Add agent..."}),W.filter(E=>!e.sub_agents.includes(E.id)).map(E=>o.jsx("option",{value:E.id,children:E.name},E.id))]})]})}),o.jsx(qi,{id:"callbacks",title:"Callbacks",icon:o.jsx(jn,{size:16}),expanded:l.has("callbacks"),onToggle:()=>z("callbacks"),children:o.jsx(c4,{agent:e,onUpdate:y,customCallbacks:t.custom_callbacks||[],isLlmAgent:w})})]})]})}function qi({id:e,title:t,icon:n,expanded:r,onToggle:i,children:s}){return o.jsxs("div",{className:"section",children:[o.jsxs("div",{className:"section-header",onClick:i,children:[r?o.jsx(Pt,{size:16}):o.jsx(bt,{size:16}),o.jsxs("h4",{children:[n," ",t]})]}),r&&o.jsx("div",{className:"section-content",children:s})]})}function a4({tools:e,onAdd:t,onRemove:n,onUpdate:r,builtinTools:i,mcpServers:s,projectMcpServers:a,customTools:l,agents:c,skillsets:u}){const[d,p]=S.useState(!1),[f,h]=S.useState({}),[x,b]=S.useState(""),k=It.useRef(null),m=It.useRef(null),[g,y]=S.useState(null),[_,z]=S.useState(new Set),w=(P,Q)=>{if(!x.trim())return!0;const ue=x.toLowerCase();return P.toLowerCase().includes(ue)||((Q==null?void 0:Q.toLowerCase().includes(ue))??!1)},A=i.filter(P=>w(P.name,P.description)),C=s.filter(P=>w(P.name,P.description)),$=a.filter(P=>w(P.name,P.description)),N=l.filter(P=>w(P.name,P.description)),I=c.filter(P=>w(P.name,P.description)),R=u.filter(P=>w(P.name,P.description));function W(){if(k.current){const P=k.current.getBoundingClientRect(),Q=window.innerHeight,ue=350,me=Q-P.bottom-16,q=P.top-16;if(me>=200||me>=q){const F=Math.min(ue,me);h({top:P.bottom+4,left:P.left,maxHeight:F})}else{const F=Math.min(ue,q);h({top:P.top-F-4,left:P.left,maxHeight:F})}}p(!0),b(""),setTimeout(()=>{var P;return(P=m.current)==null?void 0:P.focus()},50)}function T(){p(!1),b("")}function L(P){t({type:"builtin",name:P}),T()}async function D(P){T();const Q=P.tool_filter||[];if(y({server:P,enabledTools:new Set(Q),availableTools:Q.map(ue=>({name:ue,description:""})),isLoading:Q.length===0,error:void 0}),Q.length===0)try{const{testMcpServer:ue}=await cj(async()=>{const{testMcpServer:q}=await Promise.resolve().then(()=>Lk);return{testMcpServer:q}},void 0),me=await ue({connection_type:P.connection_type,command:P.command,args:P.args,env:P.env,url:P.url,headers:P.headers,timeout:P.timeout||30});me.success?y(q=>q?{...q,availableTools:me.tools,enabledTools:new Set(me.tools.map(F=>F.name)),isLoading:!1}:null):y(q=>q?{...q,isLoading:!1,error:me.error||"Failed to connect to MCP server"}:null)}catch(ue){y(me=>me?{...me,isLoading:!1,error:ue.message}:null)}}function E(P){if(!g)return;const Q=new Set(g.enabledTools);Q.has(P)?Q.delete(P):Q.add(P),y({...g,enabledTools:Q})}function O(){if(!g)return;const P=Array.from(g.enabledTools);t({type:"mcp",server:{...g.server,tool_filter:P}}),y(null)}function M(P){const Q=new Set(_);Q.has(P)?Q.delete(P):Q.add(P),z(Q)}function j(P,Q){const ue=e[P];if(ue.type!=="mcp"||!ue.server)return;const me=ue.server.tool_filter||[];let q;me.includes(Q)?q=me.filter(F=>F!==Q):q=[...me,Q],r(P,{...ue,server:{...ue.server,tool_filter:q}})}function V(P){t({type:"function",name:P.name,module_path:P.module_path}),T()}function J(P){const Q=c.find(ue=>ue.id===P);t({type:"agent",agent_id:P,name:Q==null?void 0:Q.name}),T()}function v(P){const Q=u.find(ue=>ue.id===P);t({type:"skillset",skillset_id:P,name:Q==null?void 0:Q.name}),T()}function U(P){return s.find(Q=>Q.name===P)}return o.jsxs("div",{children:[o.jsx("style",{children:`
        .mcp-tool-item {
          border: 1px solid var(--border-color);
          border-radius: var(--radius-md);
          overflow: hidden;
...
`;function J4({onSelectTool:e}){const{project:t,updateProject:n,addCustomTool:r,updateCustomTool:i,removeCustomTool:s,selectedToolId:a,setSelectedToolId:l,builtinTools:c,mcpServers:u}=ut(),[d,p]=S.useState(""),[f,h]=S.useState(null),[x,b]=S.useState("tools"),[k,m]=S.useState(null),[g,y]=S.useState(""),[_,z]=S.useState(!1),[w,A]=S.useState(!1),[C,$]=S.useState(!1),[N,I]=S.useState(null),[R,W]=S.useState(null),[T,L]=S.useState({}),[D,E]=S.useState({}),[O,M]=S.useState("");if(!t)return null;const j=t.mcp_servers||[],V=t.custom_tools.find(H=>H.id===a),J=j.find(H=>H.name===k);function v(H){l(H),e==null||e(H)}S.useEffect(()=>{V&&(p(V.code),W(null))},[a]),S.useEffect(()=>{J&&(y(JSON.stringify(J,null,2)),z(!1))},[k]),S.useEffect(()=>{if(!t)return;const H=U(t.mcp_servers||[]);M(JSON.stringify(H,null,2))},[t==null?void 0:t.mcp_servers]),S.useEffect(()=>{if(x==="mcp"&&j.length>0){const H=j.filter(ae=>!T[ae.name]||T[ae.name]==="unknown");H.length>0&&H.forEach(ae=>{me(ae.name)})}},[x,j.length]);function U(H){const ae={};for(const he of H){const ye={};he.connection_type==="stdio"?(ye.command=he.command||"",ye.args=he.args||[],Object.keys(he.env||{}).length>0&&(ye.env=he.env)):he.connection_type==="sse"&&(ye.url=he.url||"",Object.keys(he.headers||{}).length>0&&(ye.headers=he.headers)),he.timeout&&he.timeout!==30&&(ye.timeout=he.timeout),he.tool_filter&&(ye.tool_filter=he.tool_filter),he.tool_name_prefix&&(ye.tool_name_prefix=he.tool_name_prefix),ae[he.name]=ye}return{mcpServers:ae}}function P(H){const ae=[];for(const[he,ye]of Object.entries(H.mcpServers||{})){const G={name:he,description:ye.description||"",connection_type:ye.url?"sse":"stdio",command:ye.command,args:ye.args||[],env:ye.env||{},url:ye.url,headers:ye.headers||{},timeout:ye.timeout||30,tool_filter:ye.tool_filter||null,tool_name_prefix:ye.tool_name_prefix};ae.push(G)}return ae}function Q(H){H!==void 0&&M(H)}function ue(){try{const H=JSON.parse(O),ae=P(H);n({mcp_servers:ae})}catch(H){alert("Invalid JSON: "+H.message)}}async function me(H){const ae=j.find(he=>he.name===H);if(ae){L(he=>({...he,[H]:"testing"})),E(he=>({...he,[H]:""}));try{const he=await fu({connection_type:ae.connection_type,command:ae.command,args:ae.args,env:ae.env,url:ae.url,headers:ae.headers,timeout:ae.timeout});L(ye=>({...ye,[H]:he.success?"connected":"error"})),!he.success&&he.error&&E(ye=>({...ye,[H]:he.error||"Unknown error"}))}catch(he){L(ye=>({...ye,[H]:"error"})),E(ye=>({...ye,[H]:he.message}))}}}function q(H){const ae=u.find(ye=>ye.name===H);if(!ae)return;if(j.some(ye=>ye.name===H)){alert(`Server "${H}" is already configured`);return}const he={name:ae.name,description:ae.description||"",connection_type:ae.connection_type,command:ae.command,args:ae.args||[],env:ae.env||{},url:ae.url,headers:ae.headers||{},timeout:ae.timeout||30,tool_filter:ae.tool_filter||null,tool_name_prefix:ae.tool_name_prefix};n({mcp_servers:[...j,he]})}async function F(){for(const H of j)await me(H.name)}function K(){const H=W4();r({id:H,name:"new_tool",description:"",module_path:"tools.custom",code:q4,state_keys_used:[]}),v(H)}function ee(H,ae){ae.stopPropagation(),confirm("Delete this tool?")&&(s(H),a===H&&(e==null||e(null)))}function X(H){V&&(H.name!==void 0&&(H.name===""||H4(H.name)?W(null):W("Name can only contain letters, numbers, and underscores")),i(V.id,H))}function se(H){H!==void 0&&V&&(p(H),X({code:H}))}async function Y(){if(V){A(!0);try{const H=await Ay(t.id,V.name,V.description,V.state_keys_used);H.success&&H.code?(p(H.code),X({code:H.code})):(console.error("Failed to generate tool code:",H.error),alert("Failed to generate tool code: "+(H.error||"Unknown error")))}catch(H){console.error("Error generating tool code:",H),alert("Error generating tool code: "+H.message)}finally{A(!1)}}}const Z=S.useRef(null),re=S.useCallback((H,ae)=>{if(Z.current&&typeof Z.current=="function")try{Z.current()}catch{}try{const he=qv(ae,H,{language:"python",endpoint:"/api/code-completion",trigger:"onTyping"});typeof he=="function"?Z.current=he:Z.current=null}catch{Z.current=null}},[]);S.useEffect(()=>()=>{if(Z.current&&typeof Z.current=="function")try{Z.current()}catch{}},[]);function ve(H){H!==void 0&&(y(H),z(H!==JSON.stringify(J,null,2)))}function je(){if(J)try{const H=JSON.parse(g),ae=J.name,he=j.map(ye=>ye.name===ae?H:ye);n({mcp_servers:he}),m(H.name),z(!1)}catch(H){alert("Invalid JSON: "+H.message)}}async function ze(){$(!0),I(null);try{const H=JSON.parse(g),ae=await fu({connection_type:H.connection_type,command:H.command,args:H.args,env:H.env,url:H.url,headers:H.headers,timeout:H.timeout||30});if(I(ae),ae.success&&ae.tools.length>0){const he={...H,tool_filter:ae.tools.map(ye=>ye.name)};y(JSON.stringify(he,null,2)),z(!0)}}catch(H){I({success:!1,tools:[],error:H.message})}finally{$(!1)}}const ke={};return t.custom_tools.forEach(H=>{const ae=H.module_path||"tools";ke[ae]||(ke[ae]=[]),ke[ae].push(H)}),o.jsxs("div",{className:"tools-panel",children:[o.jsx("style",{children:`
        .tools-panel {
          display: flex;
          gap: 20px;
          height: calc(100vh - 180px);
...
def my_callback(tool: BaseTool, tool_args: Dict[str, Any], tool_context: ToolContext, result: Dict) -> Optional[Dict]:
    ...
    return None
`;default:return Jv("before_agent")}}function G4({onSelectCallback:e}){var C,$;const{project:t,updateProject:n,addCustomCallback:r,updateCustomCallback:i,removeCustomCallback:s}=ut(),[a,l]=S.useState(""),[c,u]=S.useState(null),[d,p]=S.useState(null),[f,h]=S.useState(!1),x=S.useRef(null);if(!t)return null;const b=t.custom_callbacks||[],k=b.find(N=>N.id===c);function m(N){u(N),e==null||e(N)}S.useEffect(()=>{k?(l(k.code),p(null)):l("")},[c,k]);function g(){const N=K4(),I="new_callback",R={id:N,name:I,description:"",module_path:`callbacks.${I}`,code:Jv("before_agent"),state_keys_used:[]};r(R),m(N)}function y(N,I){I.stopPropagation(),confirm("Delete this callback?")&&(s(N),c===N&&(e==null||e(null),u(null),l("")))}function _(){if(!c)return;const N=b.find(W=>W.id===c);if(!N)return;const I=N.name.trim();if(!I){alert("Please enter a name");return}if(!xm(I)){p("Name must contain only alphanumeric characters and underscores");return}if(b.find(W=>W.name===I&&W.id!==N.id)){p("A callback with this name already exists");return}i(N.id,{code:a,name:I,description:N.description,module_path:`callbacks.${I}`,state_keys_used:N.state_keys_used}),p(null)}function z(N,I){x.current=I;try{qv(I,{endpoint:"/api/code-completion",language:"python"})}catch(R){console.warn("Failed to register Monacopilot completion:",R)}}async function w(){if(k){h(!0);try{let N="before_agent";const I=k.name.toLowerCase(),R=k.description.toLowerCase();I.includes("after_agent")||R.includes("after agent")?N="after_agent":I.includes("before_model")||R.includes("before model")?N="before_model":I.includes("after_model")||R.includes("after model")?N="after_model":I.includes("before_tool")||R.includes("before tool")?N="before_tool":I.includes("after_tool")||R.includes("after tool")?N="after_tool":(I.includes("before_agent")||R.includes("before agent"))&&(N="before_agent");const W=await Py(t.id,k.name,k.description,N,k.state_keys_used);W.success&&W.code?(l(W.code),i(k.id,{code:W.code})):(console.error("Failed to generate callback code:",W.error),alert("Failed to generate callback code: "+(W.error||"Unknown error")))}catch(N){console.error("Error generating callback code:",N),alert("Error generating callback code: "+N.message)}finally{h(!1)}}}const A=(($=(C=t.app)==null?void 0:C.state_keys)==null?void 0:$.map(N=>N.name))||[];return o.jsxs("div",{className:"tools-panel",children:[o.jsx("style",{children:`
        .tools-panel {
          display: flex;
          height: 100%;
          background: var(--bg-primary);
...
`).join("")]})]})]},$)),r.error&&o.jsxs("div",{className:"result-details",children:[o.jsx("h5",{style:{color:"var(--error)"},children:"Error"}),o.jsx("div",{className:"detail-box",style:{color:"var(--error)"},children:r.error})]})]})]})}function E6({evalSet:e,projectId:t,result:n,isRunning:r,caseResults:i,onUpdate:s,onDelete:a,onRun:l,onExport:c}){var b,k,m,g;const[u,d]=S.useState(e.name),[p,f]=S.useState(!1);S.useEffect(()=>{d(e.name)},[e.id]);const h=S.useCallback(()=>{u!==e.name&&s({name:u})},[u,e.name,s]),x=y=>y==null?"-":`${Math.round(y*100)}%`;return o.jsxs(o.Fragment,{children:[o.jsxs("div",{className:"editor-header",children:[o.jsx(Uy,{size:20,style:{color:"var(--accent-secondary)"}}),o.jsx("input",{type:"text",value:u,onChange:y=>d(y.target.value),onBlur:h,placeholder:"Eval set name"}),o.jsx("button",{className:"btn btn-secondary btn-sm",onClick:()=>{const y=`${window.location.origin}/project/${t}/evaluate?set=${e.id}`;navigator.clipboard.writeText(y)},title:"Copy link to this eval set",children:o.jsx(Fd,{size:14})}),o.jsxs("button",{className:`btn btn-sm ${p?"btn-primary":"btn-secondary"}`,onClick:()=>f(!p),title:"View/Hide JSON",children:[o.jsx(jn,{size:14}),"JSON"]}),o.jsx("button",{className:"btn btn-secondary btn-sm",onClick:c,title:"Export as JSON (compatible with adk eval)",children:o.jsx(Zo,{size:14})}),o.jsxs("button",{className:"btn btn-primary btn-sm",onClick:l,disabled:r,children:[r?o.jsx(Io,{size:14,className:"spinning"}):o.jsx(pr,{size:14}),"Run All"]}),o.jsx("button",{className:"btn btn-danger btn-sm",onClick:a,children:o.jsx(Fe,{size:14})})]}),o.jsx("div",{className:"editor-content",children:p?o.jsxs("div",{style:{display:"flex",flexDirection:"column",gap:16,height:"100%"},children:[o.jsx("div",{style:{fontSize:12,color:"var(--text-secondary)",padding:"8px 0"},children:o.jsxs("p",{style:{margin:0},children:["This is the ADK-compatible JSON format for this evaluation set. Save this file and use with ",o.jsx("code",{style:{background:"var(--bg-tertiary)",padding:"2px 6px",borderRadius:4},children:"adk eval <agent_path> <eval_file.json>"})]})}),o.jsx("div",{style:{flex:1,minHeight:400,border:"1px solid var(--border-color)",borderRadius:"var(--radius-md)",overflow:"hidden"},children:o.jsx(Jt,{height:"100%",language:"json",theme:"vs-dark",value:JSON.stringify([{id:e.id,name:e.name,description:e.description||void 0,eval_cases:e.eval_cases.map(y=>{var _,z;return{name:y.name,description:y.description||void 0,tags:(_=y.tags)!=null&&_.length?y.tags:void 0,target_agent:y.target_agent!=="root_agent"?y.target_agent:void 0,invocations:y.invocations.map(w=>{var A;return{user_message:w.user_message,expected_response:w.expected_response||void 0,expected_tool_calls:(A=w.expected_tool_calls)!=null&&A.length?w.expected_tool_calls.map(C=>({tool_name:C.tool_name,args:C.match_type!=="name_only"&&Object.keys(C.args||{}).length?C.args:void 0})):void 0}}),session_input:Object.keys(y.session_input||{}).length?{state:y.session_input}:void 0,final_session_state:Object.keys(y.final_session_state||{}).length?y.final_session_state:void 0,rubrics:(z=y.rubrics)!=null&&z.length?y.rubrics.map(w=>w.rubric):void 0}}),eval_config:e.eval_config?{judge_model:e.eval_config.judge_model||void 0,metrics:((b=e.eval_config.metrics)==null?void 0:b.filter(y=>y.enabled))||void 0}:void 0}],null,2),options:{readOnly:!0,minimap:{enabled:!1},fontSize:12,fontFamily:"'JetBrains Mono', monospace",lineNumbers:"on",scrollBeyondLastLine:!1,automaticLayout:!0,tabSize:2,wordWrap:"on",padding:{top:12}}})}),o.jsx("div",{style:{display:"flex",gap:8},children:o.jsxs("button",{className:"btn btn-secondary btn-sm",onClick:()=>{var _;const y=JSON.stringify([{id:e.id,name:e.name,description:e.description||void 0,eval_cases:e.eval_cases.map(z=>{var w,A;return{name:z.name,description:z.description||void 0,tags:(w=z.tags)!=null&&w.length?z.tags:void 0,target_agent:z.target_agent!=="root_agent"?z.target_agent:void 0,invocations:z.invocations.map(C=>{var $;return{user_message:C.user_message,expected_response:C.expected_response||void 0,expected_tool_calls:($=C.expected_tool_calls)!=null&&$.length?C.expected_tool_calls.map(N=>({tool_name:N.tool_name,args:N.match_type!=="name_only"&&Object.keys(N.args||{}).length?N.args:void 0})):void 0}}),session_input:Object.keys(z.session_input||{}).length?{state:z.session_input}:void 0,final_session_state:Object.keys(z.final_session_state||{}).length?z.final_session_state:void 0,rubrics:(A=z.rubrics)!=null&&A.length?z.rubrics.map(C=>C.rubric):void 0}}),eval_config:e.eval_config?{judge_model:e.eval_config.judge_model||void 0,metrics:((_=e.eval_config.metrics)==null?void 0:_.filter(z=>z.enabled))||void 0}:void 0}],null,2);navigator.clipboard.writeText(y)},children:[o.jsx(Xo,{size:14})," Copy JSON"]})})]}):o.jsxs(o.Fragment,{children:[o.jsxs("div",{className:"form-section",children:[o.jsx("h4",{children:"Description"}),o.jsx("textarea",{value:e.description,onChange:y=>s({description:y.target.value}),placeholder:"Description of this evaluation set...",style:{minHeight:40}})]}),o.jsxs("div",{className:"form-section",children:[o.jsx("h4",{children:"LLM Judge Model"}),o.jsx("p",{style:{fontSize:12,color:"var(--text-muted)",marginBottom:8},children:"Model used for LLM-judged metrics (safety, hallucinations, etc.)."}),o.jsx(S6,{value:((k=e.eval_config)==null?void 0:k.judge_model)||"",onChange:y=>s({eval_config:{...e.eval_config,judge_model:y}})})]}),o.jsxs("div",{className:"form-section",children:[o.jsxs("h4",{children:[o.jsx(Hy,{size:14})," Evaluation Metrics"]}),o.jsx("p",{style:{fontSize:12,color:"var(--text-muted)",marginBottom:8},children:"Configure which metrics to use and their pass thresholds."}),Object.keys(vn).map(y=>{var C,$,N;const _=vn[y],z=($=(C=e.eval_config)==null?void 0:C.metrics)==null?void 0:$.find(I=>I.metric===y),w=(z==null?void 0:z.enabled)??!1,A=((N=z==null?void 0:z.criterion)==null?void 0:N.threshold)??.7;return o.jsxs("div",{style:{display:"flex",alignItems:"center",gap:10,marginBottom:6},children:[o.jsxs("label",{className:"toggle-switch",style:{margin:0},children:[o.jsx("input",{type:"checkbox",checked:w,onChange:I=>{var T;const R=[...((T=e.eval_config)==null?void 0:T.metrics)||[]],W=R.findIndex(L=>L.metric===y);I.target.checked?W===-1?R.push({metric:y,enabled:!0,criterion:{threshold:.7}}):R[W]={...R[W],enabled:!0}:W!==-1&&(R[W]={...R[W],enabled:!1}),s({eval_config:{...e.eval_config,metrics:R}})}}),o.jsx("span",{className:"toggle-slider"})]}),o.jsxs("span",{style:{fontSize:12,opacity:w?1:.5,minWidth:140,fontWeight:w?500:400},children:[_.name,_.requiresJudge&&o.jsx("span",{style:{fontSize:9,marginLeft:4,color:"var(--accent-primary)"},children:"LLM"})]}),o.jsx("span",{style:{fontSize:11,color:"var(--text-muted)",opacity:w?1:.4},children:"≥"}),o.jsx("input",{type:"number",min:0,max:1,step:.1,value:A,disabled:!w,onChange:I=>{var T;const R=[...((T=e.eval_config)==null?void 0:T.metrics)||[]],W=R.findIndex(L=>L.metric===y);W!==-1&&(R[W]={...R[W],criterion:{...R[W].criterion,threshold:parseFloat(I.target.value)||.7}},s({eval_config:{...e.eval_config,metrics:R}}))},style:{width:60,textAlign:"center",opacity:w?1:.3,padding:"2px 4px",fontSize:11}})]},y)}),o.jsxs("div",{className:"form-row",style:{marginTop:16},children:[o.jsxs("div",{className:"form-field",children:[o.jsx("label",{children:"Default Trajectory Match Type"}),o.jsxs("select",{value:((m=e.eval_config)==null?void 0:m.default_trajectory_match_type)||"in_order",onChange:y=>s({eval_config:{...e.eval_config,default_trajectory_match_type:y.target.value}}),children:[o.jsx("option",{value:"exact",children:"Exact (same order, no extras)"}),o.jsx("option",{value:"in_order",children:"In Order (extras allowed between)"}),o.jsx("option",{value:"any_order",children:"Any Order (all present, any order)"})]})]}),o.jsxs("div",{className:"form-field",children:[o.jsx("label",{children:"Number of Runs"}),o.jsx("input",{type:"number",min:1,max:10,value:((g=e.eval_config)==null?void 0:g.num_runs)||1,onChange:y=>s({eval_config:{...e.eval_config,num_runs:parseInt(y.target.value)||1}})}),o.jsx("p",{style:{fontSize:11,color:"var(--text-muted)",marginTop:4},children:"Run each test multiple times for statistical reliability."})]})]})]}),o.jsxs("div",{className:"form-section",children:[o.jsxs("h4",{children:[o.jsx(Kk,{size:14})," Coverage Summary"]}),n?o.jsxs(o.Fragment,{children:[o.jsxs("div",{className:"result-scores",children:[o.jsxs("div",{className:"score-card",children:[o.jsxs("div",{className:"score-value",style:{color:"var(--accent-primary)"},children:[n.passed_cases,"/",n.total_cases]}),o.jsx("div",{className:"score-label",children:"Cases Passed"})]}),o.jsxs("div",{className:"score-card",children:[o.jsx("div",{className:`score-value ${n.overall_pass_rate>=.8?"passed":"failed"}`,children:x(n.overall_pass_rate)}),o.jsx("div",{className:"score-label",children:"Pass Rate"})]}),Object.entries(n.metric_avg_scores||{}).map(([y,_])=>{var w;const z=Wo(y,_);return o.jsxs("div",{className:"score-card",children:[o.jsx("div",{className:"score-value",children:z.value}),o.jsxs("div",{className:"score-label",children:["Avg ",((w=vn[y])==null?void 0:w.name)||y]})]},y)})]}),o.jsxs("div",{style:{marginTop:16},children:[o.jsx("div",{style:{marginBottom:4,fontSize:12,color:"var(--text-muted)"},children:"Overall Pass Rate"}),o.jsx("div",{className:"coverage-bar",children:o.jsx("div",{className:`coverage-fill ${n.overall_pass_rate>=.8?"passed":"failed"}`,style:{width:`${n.overall_pass_rate*100}%`}})})]}),Object.entries(n.metric_pass_rates||{}).length>0&&o.jsxs("div",{style:{marginTop:16},children:[o.jsx("h5",{style:{fontSize:13,marginBottom:8},children:"Metric Pass Rates"}),Object.entries(n.metric_pass_rates).map(([y,_])=>{var z;return o.jsxs("div",{style:{marginBottom:8},children:[o.jsxs("div",{style:{display:"flex",justifyContent:"space-between",fontSize:12,marginBottom:4},children:[o.jsx("span",{children:((z=vn[y])==null?void 0:z.name)||y}),o.jsx("span",{children:x(_)})]}),o.jsx("div",{className:"coverage-bar",children:o.jsx("div",{className:`coverage-fill ${_>=.8?"passed":"failed"}`,style:{width:`${_*100}%`}})})]},y)})]}),o.jsxs("div",{style:{marginTop:16},children:[o.jsx("h5",{style:{fontSize:13,marginBottom:8},children:"Individual Results"}),o.jsxs("table",{style:{width:"100%",fontSize:12,borderCollapse:"collapse"},children:[o.jsx("thead",{children:o.jsxs("tr",{style:{borderBottom:"1px solid var(--border-color)"},children:[o.jsx("th",{style:{textAlign:"left",padding:"8px 4px"},children:"Test Case"}),o.jsx("th",{style:{textAlign:"center",padding:"8px 4px"},children:"Metrics"}),o.jsx("th",{style:{textAlign:"center",padding:"8px 4px"},children:"Status"})]})}),o.jsx("tbody",{children:n.case_results.map(y=>o.jsxs("tr",{style:{borderBottom:"1px solid var(--border-color)"},children:[o.jsx("td",{style:{padding:"8px 4px"},children:y.eval_case_name}),o.jsx("td",{style:{textAlign:"center",padding:"8px 4px"},children:y.metric_results.map((_,z)=>{const w=Wo(_.metric,_.score,_.threshold);return o.jsx("span",{style:{fontSize:10,padding:"2px 4px",marginRight:4,borderRadius:"var(--radius-sm)",background:_.passed?"rgba(var(--success-rgb), 0.15)":"rgba(var(--error-rgb), 0.15)",color:_.passed?"var(--success)":"var(--error)"},children:w.value},z)})}),o.jsx("td",{style:{textAlign:"center",padding:"8px 4px"},children:y.passed?o.jsx(Ir,{size:14,style:{color:"var(--success)"}}):y.error?o.jsx(wi,{size:14,style:{color:"var(--warning)"}}):o.jsx(ji,{size:14,style:{color:"var(--error)"}})})]},y.eval_case_id))})]})]})]}):o.jsxs("div",{style:{textAlign:"center",padding:"32px",color:"var(--text-muted)",background:"var(--bg-tertiary)",borderRadius:"var(--radius-md)"},children:[o.jsx(Ud,{size:32,style:{marginBottom:8,opacity:.3}}),o.jsx("p",{children:"Run the evaluation set to see coverage metrics"})]})]}),o.jsxs("div",{className:"form-section",children:[o.jsxs("h4",{children:["Test Cases (",e.eval_cases.length,")"]}),e.eval_cases.length===0?o.jsx("p",{style:{color:"var(--text-muted)",fontSize:13},children:"No test cases yet. Add cases to this eval set to start testing."}):o.jsx("ul",{style:{listStyle:"none",padding:0},children:e.eval_cases.map(y=>{const _=i.get(y.id);return o.jsxs("li",{style:{display:"flex",alignItems:"center",gap:8,padding:"8px 12px",background:"var(--bg-tertiary)",borderRadius:"var(--radius-sm)",marginBottom:8},children:[_?_.passed?o.jsx(Ir,{size:14,style:{color:"var(--success)"}}):o.jsx(ji,{size:14,style:{color:"var(--error)"}}):o.jsx(Ca,{size:14,style:{color:"var(--text-muted)"}}),o.jsx("span",{style:{flex:1},children:y.name}),o.jsxs("span",{style:{fontSize:11,color:"var(--text-muted)"},children:[y.invocations.length," turn(s)"]})]},y.id)})})]})]})})]})}function z6(){const{project:e,setProject:t}=ut(),[n,r]=S.useState(""),[i,s]=S.useState(!0),[a,l]=S.useState(!1),[c,u]=S.useState(null),[d,p]=S.useState(!1);if(!e)return null;S.useEffect(()=>{f()},[e.id]);async function f(){s(!0),u(null);try{const g=await Cy(e.id);r(g),l(!1)}catch(g){u(g.message)}finally{s(!1)}}function h(g){g!==void 0&&(r(g),l(!0),u(null))}async function x(){s(!0),u(null);try{const g=await Ny(e.id,n);t(g),l(!1)}catch(g){u(g.message)}finally{s(!1)}}function b(){navigator.clipboard.writeText(n),p(!0),setTimeout(()=>p(!1),2e3)}function k(){const g=new Blob([n],{type:"text/yaml"}),y=URL.createObjectURL(g),_=document.createElement("a");_.href=y,_.download=`${e.name}.yaml`,_.click(),URL.revokeObjectURL(y)}function m(){const g=document.createElement("input");g.type="file",g.accept=".yaml,.yml",g.onchange=async y=>{var w;const _=(w=y.target.files)==null?void 0:w[0];if(!_)return;const z=await _.text();r(z),l(!0)},g.click()}return o.jsxs("div",{className:"yaml-panel",children:[o.jsx("style",{children:`
      ...
      `}),o.jsxs("div",{className:"code-header",children:[o.jsxs("div",{className:"code-title",children:[o.jsx(jn,{size:16}),o.jsx("h3",{children:"Python Code"}),o.jsx("span",{className:"badge",children:s?"Loading...":"Generated"}),t&&o.jsxs("span",{className:"status-badge success",children:[o.jsx(Id,{size:12}),"Copied!"]}),l&&o.jsxs("span",{className:"status-badge error",children:[o.jsx(wi,{size:12}),"Error"]})]}),o.jsxs("div",{className:"code-actions",children:[o.jsxs("button",{className:"btn btn-secondary btn-sm",onClick:u,title:"Copy to clipboard",disabled:s||!!l,children:[o.jsx(Xo,{size:14}),"Copy"]}),o.jsxs("button",{className:"btn btn-secondary btn-sm",onClick:d,title:"Download Python file",disabled:s||!!l,children:[o.jsx(Zo,{size:14}),"Download"]})]})]}),o.jsx("div",{className:"code-editor",children:s?o.jsx("div",{className:"code-loading",children:o.jsx("div",{children:"Loading generated code..."})}):l?o.jsxs("div",{className:"code-error",children:[o.jsx(wi,{size:24}),o.jsx("div",{children:l})]}):o.jsx(Jt,{height:"100%",language:"python",theme:"vs-dark",value:r,options:{readOnly:!0,minimap:{enabled:!1},fontSize:13,fontFamily:"'JetBrains Mono', monospace",lineNumbers:"on",scrollBeyondLastLine:!1,automaticLayout:!0,tabSize:4,insertSpaces:!0,padding:{top:12},wordWrap:"on"}})}),o.jsxs("div",{className:"code-info",children:[o.jsx("p",{children:"This is the Python code equivalent of your project configuration. You can use this code directly with ADK."}),o.jsxs("p",{children:["Place this in a file named ",o.jsx("code",{children:"agent.py"})," inside your agent directory, then run with ",o.jsx("code",{children:"adk web ."})," or ",o.jsx("code",{children:"adk run your_agent"}),"."]})]})]})}const A6=[{id:"app",label:"App",icon:Hy},{id:"agents",label:"Agents",icon:Er},{id:"tools",label:"Tools",icon:an},{id:"callbacks",label:"Callbacks",icon:jn},{id:"run",label:"Run",icon:Vy},{id:"skillsets",label:"SkillSets",icon:$k},{id:"eval",label:"Evaluate",icon:gu},{id:"yaml",label:"YAML",icon:Fk},{id:"code",label:"Code",icon:jn}],P6=["app","agents","tools","callbacks","run","skillsets","eval","yaml","code"];function mc(){var L,D;const{projectId:e,tab:t,itemId:n}=Dw(),r=Md(),{project:i,setProject:s,activeTab:a,setActiveTab:l,hasUnsavedChanges:c,setHasUnsavedChanges:u,selectedAgentId:d,setSelectedAgentId:p,selectedToolId:f,setSelectedToolId:h}=ut(),[x,b]=S.useState(!0),[k,m]=S.useState(!1),[g,y]=S.useState(!1),[_,z]=S.useState(null),w=S.useRef(!0),A=S.useRef(null);S.useEffect(()=>{t&&P6.includes(t)?l(t):!t&&e&&r(`/project/${e}/${a}`,{replace:!0})},[t,e]),S.useEffect(()=>{t==="agents"&&n?p(n):t==="tools"&&n&&h(n)},[t,n]);function C(E){l(E),E==="agents"&&d?r(`/project/${e}/${E}/${d}`,{replace:!0}):E==="tools"&&f?r(`/project/${e}/${E}/${f}`,{replace:!0}):r(`/project/${e}/${E}`,{replace:!0})}function $(E){E?r(`/project/${e}/${a}/${E}`,{replace:!0}):r(`/project/${e}/${a}`,{replace:!0})}S.useEffect(()=>(e&&N(e),()=>{s(null),u(!1)}),[e]);async function N(E){w.current=!0;try{const O=await wy(E);s(O),A.current=JSON.stringify(O),u(!1)}catch(O){console.error("Failed to load project:",O),r("/")}finally{b(!1),setTimeout(()=>{w.current=!1},100)}}async function I(){if(i){m(!0);try{const{eval_sets:E,...O}=i;await du(i.id,O),A.current=JSON.stringify(i),u(!1)}catch(E){console.error("Failed to save project:",E)}finally{m(!1)}}}async function R(){if(i){y(!0),z(null),window.dispatchEvent(new CustomEvent("eval-tests-started"));try{let E=0,O=0;const M=[],j=[];for(const V of i.eval_sets||[]){if(V.eval_cases.length===0)continue;const J=await qe.post(`/projects/${i.id}/eval-sets/${V.id}/run`,{});J.result&&(E+=J.result.passed_cases||0,O+=J.result.total_cases||0,J.result.case_results&&M.push(...J.result.case_results),j.push(J.result.eval_set_name||V.name||V.id))}if(M.length>0){const V={id:Date.now().toString(36)+Math.random().toString(36).substr(2,5),eval_set_id:"batch",eval_set_name:j.length>1?`All Tests (${j.length} sets)`:j[0]||"All Tests",started_at:Date.now()/1e3,completed_at:Date.now()/1e3,total_cases:O,passed_cases:E,failed_cases:O-E,case_results:M};try{await qe.post(`/projects/${i.id}/eval-history`,V)}catch(J){console.warn("Failed to save batch eval run to history:",J)}}z({passed:E,total:O}),window.dispatchEvent(new CustomEvent("eval-tests-completed")),setTimeout(()=>z(null),5e3)}catch(E){console.error("Failed to run tests:",E),z({passed:0,total:-1}),setTimeout(()=>z(null),5e3)}finally{y(!1)}}}const W=S.useRef(null);S.useEffect(()=>{if(i&&!w.current&&W.current){const E=i.app.models||[],O=W.current||[];if(E.some((j,V)=>{const J=O.find(v=>v.id===j.id);return J?J.provider!==j.provider||J.model_name!==j.model_name||J.api_base!==j.api_base||J.temperature!==j.temperature||J.max_output_tokens!==j.max_output_tokens||J.top_p!==j.top_p||J.top_k!==j.top_k:!1})){const j=i.app.default_model_id,V=i.agents.map(v=>{if(v.type==="LlmAgent"&&v.model){const U=v.model._appModelId;if(U){const P=E.find(Q=>Q.id===U);if(P)return{...v,model:{provider:P.provider,model_name:P.model_name,api_base:P.api_base,temperature:P.temperature,max_output_tokens:P.max_output_tokens,top_p:P.top_p,top_k:P.top_k,fallbacks:[],_appModelId:U}}}else if(j){const P=E.find(Q=>Q.id===j);if(P&&v.model.provider===P.provider&&v.model.model_name===P.model_name&&v.model.api_base===P.api_base)return{...v,model:{provider:P.provider,model_name:P.model_name,api_base:P.api_base,temperature:P.temperature,max_output_tokens:P.max_output_tokens,top_p:P.top_p,top_k:P.top_k,fallbacks:[],_appModelId:j}}}}return v});V.some((v,U)=>JSON.stringify(v)!==JSON.stringify(i.agents[U]))&&s({...i,agents:V})}}i&&(W.current=i.app.models||[])},[i==null?void 0:i.app.models,i,s]);const T=S.useRef(null);return S.useEffect(()=>(i&&!w.current&&A.current&&JSON.stringify(i)!==A.current&&(u(!0),T.current&&clearTimeout(T.current),T.current=setTimeout(async()=>{try{const{eval_sets:O,...M}=i;await du(i.id,M),A.current=JSON.stringify(i),u(!1)}catch(O){console.error("Auto-save failed:",O)}},500)),()=>{T.current&&clearTimeout(T.current)}),[i]),x?o.jsxs("div",{className:"loading-screen",children:[o.jsx("style",{children:`
          .loading-screen {
            height: 100vh;
            display: flex;
            align-items: center;
