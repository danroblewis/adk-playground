...
`)}function OS(){const{project:e}=dt(),[t,n]=_.useState(!1);if(!e)return null;const r=_.useMemo(()=>MS(e),[e]);function i(){navigator.clipboard.writeText(r),n(!0),setTimeout(()=>n(!1),2e3)}function s(){const l=new Blob([r],{type:"text/x-python"}),a=URL.createObjectURL(l),c=document.createElement("a");c.href=a,c.download=`${e.name}_agent.py`,c.click(),URL.revokeObjectURL(a)}return o.jsxs("div",{className:"code-panel",children:[o.jsx("style",{children:`
      ...
      `}),o.jsxs("header",{className:"top-bar",children:[o.jsxs("div",{className:"top-bar-left",children:[o.jsxs("button",{className:"back-btn",onClick:()=>r("/"),children:[o.jsx(l0,{size:18}),"Project"]}),o.jsx("h1",{className:"project-name",children:i.name})]}),o.jsx("nav",{className:"tabs-bar",children:$S.map(A=>o.jsxs("button",{className:`tab-btn ${l===A.id?"active":""}`,onClick:()=>T(A.id),children:[o.jsx(A.icon,{size:14}),A.label]},A.id))}),o.jsxs("div",{className:"top-bar-right",children:[o.jsxs("button",{className:`btn ${P?P.total===-1?"btn-error":P.passed===P.total?"btn-success":"btn-warning":"btn-secondary"}`,onClick:z,disabled:h||!((B=i==null?void 0:i.eval_sets)!=null&&B.some(A=>A.eval_cases.length>0)),title:(Y=i==null?void 0:i.eval_sets)!=null&&Y.some(A=>A.eval_cases.length>0)?"Run all evaluation tests":"No test cases defined",style:{marginRight:8},children:[h?o.jsx(h0,{size:16,className:"spin"}):o.jsx(Mn,{size:16}),h?"Testing...":P?P.total===-1?"Error":`${P.passed}/${P.total}`:"Test"]}),o.jsxs("button",{className:"btn btn-primary",onClick:k,disabled:N,children:[o.jsx(su,{size:16}),N?"Saving...":"Save"]})]})]}),o.jsxs("main",{className:"main-content",children:[l==="app"&&o.jsx(C0,{}),l==="agents"&&o.jsx(L_,{onSelectAgent:R}),l==="tools"&&o.jsx(pS,{onSelectTool:R}),l==="callbacks"&&o.jsx(mS,{onSelectCallback:R}),l==="run"&&o.jsx(jS,{}),l==="skillsets"&&o.jsx(SS,{}),l==="eval"&&o.jsx(NS,{}),l==="yaml"&&o.jsx(TS,{}),l==="code"&&o.jsx(OS,{})]})]}):null}function FS(){const{setMcpServers:e,setBuiltinTools:t}=dt();return _.useEffect(()=>{ru().then(e).catch(console.error),Fh().then(t).catch(console.error)},[e,t]),o.jsxs(N1,{children:[o.jsx(dr,{path:"/",element:o.jsx(w0,{})}),o.jsx(dr,{path:"/project/:projectId",element:o.jsx(Vl,{})}),o.jsx(dr,{path:"/project/:projectId/:tab",element:o.jsx(Vl,{})}),o.jsx(dr,{path:"/project/:projectId/:tab/:itemId",element:o.jsx(Vl,{})}),o.jsx(dr,{path:"*",element:o.jsx(S1,{to:"/",replace:!0})})]})}Wl.createRoot(document.getElementById("root")).render(o.jsx(Lt.StrictMode,{children:o.jsx(T1,{children:o.jsx(FS,{})})}));export{js as a,BS as g};
