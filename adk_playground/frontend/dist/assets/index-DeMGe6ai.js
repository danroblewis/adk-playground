 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */(function(e){function t(L,M){var w=L.length;L.push(M);e:for(;0<w;){var H=w-1>>>1,G=L[H];if(0<i(G,M))L[H]=M,L[w]=G,w=H;else break e}}function n(L){return L.length===0?null:L[0]}function r(L){if(L.length===0)return null;var M=L[0],w=L.pop();if(w!==M){L[0]=w;e:for(var H=0,G=L.length,b=G>>>1;H<b;){var z=2*(H+1)-1,U=L[z],V=z+1,ee=L[V];if(0>i(U,w))V<G&&0>i(ee,U)?(L[H]=ee,L[V]=w,H=V):(L[H]=U,L[z]=w,H=z);else if(V<G&&0>i(ee,w))L[H]=ee,L[V]=w,H=V;else break e}}return M}function i(L,M){var w=L.sortIndex-M.sortIndex;return w!==0?w:L.id-M.id}if(typeof performance=="object"&&typeof performance.now=="function"){var s=performance;e.unstable_now=function(){return s.now()}}else{var a=Date,l=a.now();e.unstable_now=function(){return a.now()-l}}var c=[],u=[],d=1,p=null,f=3,h=!1,g=!1,v=!1,_=typeof setTimeout=="function"?setTimeout:null,m=typeof clearTimeout=="function"?clearTimeout:null,x=typeof setImmediate<"u"?setImmediate:null;typeof navigator<"u"&&navigator.scheduling!==void 0&&navigator.scheduling.isInputPending!==void 0&&navigator.scheduling.isInputPending.bind(navigator.scheduling);function y(L){for(var M=n(u);M!==null;){if(M.callback===null)r(u);else if(M.startTime<=L)r(u),M.sortIndex=M.expirationTime,t(c,M);else break;M=n(u)}}function j(L){if(v=!1,y(L),!g)if(n(c)!==null)g=!0,F(A);else{var M=n(u);M!==null&&C(j,M.startTime-L)}}function A(L,M){g=!1,v&&(v=!1,m(N),N=-1),h=!0;var w=f;try{for(y(M),p=n(c);p!==null&&(!(p.expirationTime>M)||L&&!I());){var H=p.callback;if(typeof H=="function"){p.callback=null,f=p.priorityLevel;var G=H(p.expirationTime<=M);M=e.unstable_now(),typeof G=="function"?p.callback=G:p===n(c)&&r(c),y(M)}else r(c);p=n(c)}if(p!==null)var b=!0;else{var z=n(u);z!==null&&C(j,z.startTime-M),b=!1}return b}finally{p=null,f=w,h=!1}}var S=!1,P=null,N=-1,B=5,E=-1;function I(){return!(e.unstable_now()-E<B)}function R(){if(P!==null){var L=e.unstable_now();E=L;var M=!0;try{M=P(!0,L)}finally{M?q():(S=!1,P=null)}}else S=!1}var q;if(typeof x=="function")q=function(){x(R)};else if(typeof MessageChannel<"u"){var T=new MessageChannel,O=T.port2;T.port1.onmessage=R,q=function(){O.postMessage(null)}}else q=function(){_(R,0)};function F(L){P=L,S||(S=!0,q())}function C(L,M){N=_(function(){L(e.unstable_now())},M)}e.unstable_IdlePriority=5,e.unstable_ImmediatePriority=1,e.unstable_LowPriority=4,e.unstable_NormalPriority=3,e.unstable_Profiling=null,e.unstable_UserBlockingPriority=2,e.unstable_cancelCallback=function(L){L.callback=null},e.unstable_continueExecution=function(){g||h||(g=!0,F(A))},e.unstable_forceFrameRate=function(L){0>L||125<L?console.error("forceFrameRate takes a positive int between 0 and 125, forcing frame rates higher than 125 fps is not supported"):B=0<L?Math.floor(1e3/L):5},e.unstable_getCurrentPriorityLevel=function(){return f},e.unstable_getFirstCallbackNode=function(){return n(c)},e.unstable_next=function(L){switch(f){case 1:case 2:case 3:var M=3;break;default:M=f}var w=f;f=M;try{return L()}finally{f=w}},e.unstable_pauseExecution=function(){},e.unstable_requestPaint=function(){},e.unstable_runWithPriority=function(L,M){switch(L){case 1:case 2:case 3:case 4:case 5:break;default:L=3}var w=f;f=L;try{return M()}finally{f=w}},e.unstable_scheduleCallback=function(L,M,w){var H=e.unstable_now();switch(typeof w=="object"&&w!==null?(w=w.delay,w=typeof w=="number"&&0<w?H+w:H):w=H,L){case 1:var G=-1;break;case 2:G=250;break;case 5:G=1073741823;break;case 4:G=1e4;break;default:G=5e3}return G=w+G,L={id:d++,callback:M,priorityLevel:L,startTime:w,expirationTime:G,sortIndex:-1},w>H?(L.sortIndex=w,t(u,L),n(c)===null&&L===n(u)&&(v?(m(N),N=-1):v=!0,C(j,w-H))):(L.sortIndex=G,t(c,L),g||h||(g=!0,F(A))),L},e.unstable_shouldYield=I,e.unstable_wrapCallback=function(L){var M=f;return function(){var w=f;f=M;try{return L.apply(this,arguments)}finally{f=w}}}})(Sg);jg.exports=Sg;var A0=jg.exports;/**
 * @license React
...
Your response (5-10 words only):`,M=await Zs(t.id,e.id,L);if(M.success&&M.prompt){let w=M.prompt.trim();w=w.replace(/^["']|["']$/g,"").trim();const H=w.split(/[.!?\n]/)[0].trim(),G=H.length>80?H.slice(0,77)+"...":H;y({description:G})}else alert("Failed to generate description: "+(M.error||"Unknown error"))}catch(L){alert("Error generating description: "+L.message)}finally{f(!1)}}return o.jsxs("div",{className:"agent-editor",children:[o.jsx("style",{children:`
        .agent-editor {
          background: var(--bg-secondary);
          border: 1px solid var(--border-color);
          border-radius: var(--radius-lg);
...
`;function vE({onSelectTool:e}){const{project:t,updateProject:n,addCustomTool:r,updateCustomTool:i,removeCustomTool:s,selectedToolId:a,setSelectedToolId:l,builtinTools:c,mcpServers:u}=ht(),[d,p]=k.useState(""),[f,h]=k.useState(null),[g,v]=k.useState("tools"),[_,m]=k.useState(null),[x,y]=k.useState(""),[j,A]=k.useState(!1),[S,P]=k.useState(!1),[N,B]=k.useState(!1),[E,I]=k.useState(null),[R,q]=k.useState(null),[T,O]=k.useState({}),[F,C]=k.useState({}),[L,M]=k.useState("");if(!t)return null;const w=t.mcp_servers||[],H=t.custom_tools.find(Y=>Y.id===a),G=w.find(Y=>Y.name===_);function b(Y){l(Y),e==null||e(Y)}k.useEffect(()=>{H&&(p(H.code),q(null))},[a]),k.useEffect(()=>{G&&(y(JSON.stringify(G,null,2)),A(!1))},[_]),k.useEffect(()=>{if(!t)return;const Y=z(t.mcp_servers||[]);M(JSON.stringify(Y,null,2))},[t==null?void 0:t.mcp_servers]),k.useEffect(()=>{if(g==="mcp"&&w.length>0){const Y=w.filter(te=>!T[te.name]||T[te.name]==="unknown");Y.length>0&&Y.forEach(te=>{le(te.name)})}},[g,w.length]);function z(Y){const te={};for(const ue of Y){const xe={};ue.connection_type==="stdio"?(xe.command=ue.command||"",xe.args=ue.args||[],Object.keys(ue.env||{}).length>0&&(xe.env=ue.env)):ue.connection_type==="sse"&&(xe.url=ue.url||"",Object.keys(ue.headers||{}).length>0&&(xe.headers=ue.headers)),ue.timeout&&ue.timeout!==30&&(xe.timeout=ue.timeout),ue.tool_filter&&(xe.tool_filter=ue.tool_filter),ue.tool_name_prefix&&(xe.tool_name_prefix=ue.tool_name_prefix),te[ue.name]=xe}return{mcpServers:te}}function U(Y){const te=[];for(const[ue,xe]of Object.entries(Y.mcpServers||{})){const X={name:ue,description:xe.description||"",connection_type:xe.url?"sse":"stdio",command:xe.command,args:xe.args||[],env:xe.env||{},url:xe.url,headers:xe.headers||{},timeout:xe.timeout||30,tool_filter:xe.tool_filter||null,tool_name_prefix:xe.tool_name_prefix};te.push(X)}return te}function V(Y){Y!==void 0&&M(Y)}function ee(){try{const Y=JSON.parse(L),te=U(Y);n({mcp_servers:te})}catch(Y){alert("Invalid JSON: "+Y.message)}}async function le(Y){const te=w.find(ue=>ue.name===Y);if(te){O(ue=>({...ue,[Y]:"testing"})),C(ue=>({...ue,[Y]:""}));try{const ue=await ku({connection_type:te.connection_type,command:te.command,args:te.args,env:te.env,url:te.url,headers:te.headers,timeout:te.timeout});O(xe=>({...xe,[Y]:ue.success?"connected":"error"})),!ue.success&&ue.error&&C(xe=>({...xe,[Y]:ue.error||"Unknown error"}))}catch(ue){O(xe=>({...xe,[Y]:"error"})),C(xe=>({...xe,[Y]:ue.message}))}}}function J(Y){const te=u.find(xe=>xe.name===Y);if(!te)return;if(w.some(xe=>xe.name===Y)){alert(`Server "${Y}" is already configured`);return}const ue={name:te.name,description:te.description||"",connection_type:te.connection_type,command:te.command,args:te.args||[],env:te.env||{},url:te.url,headers:te.headers||{},timeout:te.timeout||30,tool_filter:te.tool_filter||null,tool_name_prefix:te.tool_name_prefix};n({mcp_servers:[...w,ue]})}async function D(){for(const Y of w)await le(Y.name)}function $(){const Y=gE();r({id:Y,name:"new_tool",description:"",module_path:"tools.custom",code:yE,state_keys_used:[]}),b(Y)}function K(Y,te){te.stopPropagation(),confirm("Delete this tool?")&&(s(Y),a===Y&&(e==null||e(null)))}function Q(Y){H&&(Y.name!==void 0&&(Y.name===""||xE(Y.name)?q(null):q("Name can only contain letters, numbers, and underscores")),i(H.id,Y))}function ne(Y){Y!==void 0&&H&&(p(Y),Q({code:Y}))}async function me(){if(H){P(!0);try{const Y=await ev(t.id,H.name,H.description,H.state_keys_used);Y.success&&Y.code?(p(Y.code),Q({code:Y.code})):(console.error("Failed to generate tool code:",Y.error),alert("Failed to generate tool code: "+(Y.error||"Unknown error")))}catch(Y){console.error("Error generating tool code:",Y),alert("Error generating tool code: "+Y.message)}finally{P(!1)}}}const ve=k.useRef(null),Z=k.useCallback((Y,te)=>{if(ve.current&&typeof ve.current=="function")try{ve.current()}catch{}try{const ue=g1(te,Y,{language:"python",endpoint:"/api/code-completion",trigger:"onTyping"});typeof ue=="function"?ve.current=ue:ve.current=null}catch{ve.current=null}},[]);k.useEffect(()=>()=>{if(ve.current&&typeof ve.current=="function")try{ve.current()}catch{}},[]);function ce(Y){Y!==void 0&&(y(Y),A(Y!==JSON.stringify(G,null,2)))}function be(){if(G)try{const Y=JSON.parse(x),te=G.name,ue=w.map(xe=>xe.name===te?Y:xe);n({mcp_servers:ue}),m(Y.name),A(!1)}catch(Y){alert("Invalid JSON: "+Y.message)}}async function ae(){B(!0),I(null);try{const Y=JSON.parse(x),te=await ku({connection_type:Y.connection_type,command:Y.command,args:Y.args,env:Y.env,url:Y.url,headers:Y.headers,timeout:Y.timeout||30});if(I(te),te.success&&te.tools.length>0){const ue={...Y,tool_filter:te.tools.map(xe=>xe.name)};y(JSON.stringify(ue,null,2)),A(!0)}}catch(Y){I({success:!1,tools:[],error:Y.message})}finally{B(!1)}}const _e={};return t.custom_tools.forEach(Y=>{const te=Y.module_path||"tools";_e[te]||(_e[te]=[]),_e[te].push(Y)}),o.jsxs("div",{className:"tools-panel",children:[o.jsx("style",{children:`
        .tools-panel {
          display: flex;
          gap: 20px;
          height: calc(100vh - 180px);
      ...
      `}),o.jsxs("aside",{className:"tools-sidebar",children:[o.jsxs("div",{className:"sidebar-tabs",children:[o.jsxs("button",{className:`sidebar-tab ${g==="tools"?"active":""}`,onClick:()=>{v("tools"),m(null)},children:[o.jsx(dn,{size:14}),"Tools"]}),o.jsxs("button",{className:`sidebar-tab ${g==="mcp"?"active":""}`,onClick:()=>{v("mcp"),l(null),h(null),m(null)},children:[o.jsx(qi,{size:14}),"MCP"]})]}),g==="tools"?o.jsxs(o.Fragment,{children:[o.jsxs("div",{className:"sidebar-header",children:[o.jsxs("h3",{children:["Custom Tools (",t.custom_tools.length,")"]}),o.jsxs("button",{className:"btn btn-primary btn-sm",onClick:$,children:[o.jsx(Xe,{size:14}),"New"]})]}),o.jsxs("div",{className:"tools-tree",children:[c.length>0&&o.jsxs("div",{className:"module-group",children:[o.jsxs("div",{className:"module-header",children:[o.jsx(y_,{size:14}),"Built-in Tools"]}),c.map(Y=>o.jsxs("div",{className:`tool-item builtin ${(f==null?void 0:f.name)===Y.name?"selected":""}`,onClick:()=>{h(Y),b(null),m(null)},children:[o.jsx(ju,{size:14}),o.jsx("span",{className:"tool-name",children:Y.name})]},Y.name))]}),t.custom_tools.length===0&&c.length===0?o.jsxs("div",{className:"empty-state",children:[o.jsx(jn,{size:32}),o.jsx("p",{children:"No tools defined yet"})]}):t.custom_tools.length>0&&Object.entries(_e).map(([Y,te])=>o.jsxs("div",{className:"module-group",children:[o.jsxs("div",{className:"module-header",children:[o.jsx(dv,{size:14}),Y]}),te.map(ue=>o.jsxs("div",{className:`tool-item ${a===ue.id?"selected":""}`,onClick:()=>{b(ue.id),h(null),m(null)},children:[o.jsx(dn,{size:14}),o.jsx("span",{className:"tool-name",children:ue.name}),o.jsx("button",{className:"delete-btn",onClick:xe=>K(ue.id,xe),children:o.jsx(Ue,{size:14})})]},ue.id))]},Y))]})]}):o.jsxs(o.Fragment,{children:[o.jsxs("div",{className:"sidebar-header",children:[o.jsxs("h3",{children:["MCP Servers (",w.length,")"]}),o.jsx("button",{className:"btn btn-secondary btn-sm",onClick:D,title:"Test all server connections",children:o.jsx(Xt,{size:14})})]}),o.jsx("div",{className:"mcp-servers-list",children:w.length===0?o.jsxs("div",{className:"empty-state",children:[o.jsx(qi,{size:32}),o.jsx("p",{children:"No MCP servers configured"}),o.jsx("p",{style:{fontSize:"12px",color:"var(--text-muted)"},children:"Edit the JSON to add servers"})]}):w.map(Y=>{const te=T[Y.name]||"unknown",ue=F[Y.name];return o.jsxs("div",{className:"mcp-server-item-wrapper",children:[o.jsxs("div",{className:"mcp-server-item",children:[o.jsxs("div",{className:"mcp-server-info",children:[o.jsx(qi,{size:14}),o.jsx("span",{className:"mcp-server-name",children:Y.name}),o.jsxs("span",{className:`mcp-status-badge ${te}`,children:[te==="testing"?o.jsx(Zn,{size:10,className:"spin"}):null,te==="unknown"&&"●",te==="connected"&&"●",te==="error"&&"●"]})]}),o.jsxs("div",{className:"mcp-server-actions",children:[o.jsx("span",{className:"mcp-server-type",children:Y.connection_type}),o.jsxs("button",{className:"btn btn-sm",onClick:()=>le(Y.name),disabled:te==="testing",title:"Test server connection",style:{display:"flex",alignItems:"center",gap:4},children:[te==="testing"?o.jsx(Zn,{size:12,className:"spin"}):o.jsx(Xt,{size:12}),o.jsx("span",{style:{fontSize:11},children:"Test"})]})]})]}),te==="error"&&ue&&o.jsxs("div",{className:"mcp-server-error",children:[o.jsx("span",{style:{fontWeight:500,color:"var(--error)"},children:"Error:"})," ",ue]})]},Y.name)})})]})]}),o.jsx("div",{className:"tool-editor",children:f?o.jsxs(o.Fragment,{children:[o.jsxs("div",{className:"editor-header",children:[o.jsx(ju,{size:20,style:{color:"var(--accent-secondary)"}}),o.jsx("span",{style:{fontSize:"1.1rem",fontWeight:600},children:f.name}),o.jsx("span",{className:"badge badge-muted",children:"Built-in"})]}),o.jsxs("div",{className:"builtin-tool-info",children:[o.jsxs("div",{className:"info-section",children:[o.jsx("h4",{children:"Description"}),o.jsx("p",{children:f.description||"No description available."})]}),o.jsxs("div",{className:"info-section",children:[o.jsx("h4",{children:"Usage"}),o.jsx("p",{children:"This is a built-in tool provided by ADK. Add it to any LLM agent's tools list to enable it."}),o.jsxs("code",{children:['tools: ["',f.name,'"]']})]}),o.jsxs("div",{className:"info-section",children:[o.jsx("h4",{children:"Note"}),o.jsx("p",{children:"Built-in tools are read-only and cannot be modified. Create a custom tool if you need different behavior."})]})]})]}):H?o.jsxs(o.Fragment,{children:[o.jsxs("div",{className:"editor-header",children:[o.jsx(dn,{size:20,style:{color:"var(--accent-primary)"}}),o.jsxs("div",{style:{flex:1,display:"flex",flexDirection:"column",gap:4},children:[o.jsx("input",{type:"text",value:H.name,onChange:Y=>Q({name:Y.target.value}),placeholder:"Tool name",style:{borderColor:R?"var(--error)":void 0}}),R&&o.jsx("span",{style:{fontSize:11,color:"var(--error)",marginTop:-4},children:R})]})]}),o.jsxs("div",{className:"editor-meta",children:[o.jsxs("div",{className:"meta-field grow",children:[o.jsx("label",{children:"Description"}),o.jsx("input",{type:"text",value:H.description,onChange:Y=>Q({description:Y.target.value}),placeholder:"What does this tool do?"})]}),o.jsxs("div",{className:"meta-field",children:[o.jsx("label",{children:"Module Path"}),o.jsx("input",{type:"text",value:H.module_path,onChange:Y=>Q({module_path:Y.target.value}),placeholder:"tools.custom",style:{width:180}})]})]}),o.jsxs("div",{className:"code-actions",children:[o.jsx("button",{className:"btn btn-secondary btn-sm",onClick:me,disabled:S||!H.name||!H.description,title:!H.name||!H.description?"Add a name and description first":"Generate code using AI",children:S?o.jsxs(o.Fragment,{children:[o.jsx(Zn,{size:14,className:"spinning"}),"Generating..."]}):o.jsxs(o.Fragment,{children:[o.jsx(Qd,{size:14}),"Write Tool"]})}),o.jsx("span",{className:"action-hint",children:"AI will generate code based on the tool name, description, and selected state keys"})]}),o.jsx("div",{className:"code-editor",children:o.jsx(Zt,{height:"100%",language:"python",theme:"vs-dark",value:d,onChange:ne,onMount:Z,options:{minimap:{enabled:!1},fontSize:13,fontFamily:"'JetBrains Mono', monospace",lineNumbers:"on",scrollBeyondLastLine:!1,automaticLayout:!0,tabSize:4,insertSpaces:!0,padding:{top:12}}})}),o.jsxs("div",{className:"state-keys-panel",children:[o.jsxs("h4",{children:[o.jsx(Gd,{size:14})," State Keys Used"]}),o.jsx("div",{className:"state-key-chips",children:t.app.state_keys.length===0?o.jsx("span",{style:{fontSize:12,color:"var(--text-muted)"},children:"No state keys defined. Add them in App Config."}):t.app.state_keys.map(Y=>{const te=H.state_keys_used.includes(Y.name);return o.jsxs("label",{className:`state-key-chip ${te?"selected":""}`,title:Y.description,children:[o.jsx("input",{type:"checkbox",checked:te,onChange:ue=>{const xe=ue.target.checked?[...H.state_keys_used,Y.name]:H.state_keys_used.filter(X=>X!==Y.name);Q({state_keys_used:xe})}}),Y.name,o.jsxs("span",{style:{color:"var(--text-muted)",fontSize:11},children:["(",Y.type,")"]})]},Y.name)})})]})]}):G?o.jsxs(o.Fragment,{children:[o.jsxs("div",{className:"editor-header",children:[o.jsx(qi,{size:20,style:{color:"var(--accent-primary)"}}),o.jsx("span",{style:{fontSize:"1.1rem",fontWeight:600},children:G.name}),o.jsx("span",{className:"badge badge-info",children:G.connection_type}),j&&o.jsx("span",{className:"unsaved-badge",children:"Unsaved"}),o.jsxs("button",{className:"btn btn-secondary btn-sm",onClick:ae,disabled:N,title:"Test connection and discover available tools",children:[N?o.jsx(Zn,{size:14,className:"spin"}):o.jsx(Kd,{size:14}),N?"Testing...":"Test Connection"]}),o.jsxs("button",{className:"btn btn-primary btn-sm",onClick:be,disabled:!j,children:[o.jsx(La,{size:14}),"Save"]})]}),E&&o.jsx("div",{className:`mcp-test-result ${E.success?"success":"error"}`,children:E.success?o.jsxs(o.Fragment,{children:[o.jsxs("div",{className:"test-result-header",children:["✓ Connected! Found ",E.tools.length," tools"]}),E.tools.length>0&&o.jsxs("div",{className:"test-result-tools",children:[o.jsx("strong",{children:"Available tools:"}),o.jsx("ul",{children:E.tools.map(Y=>o.jsxs("li",{children:[o.jsx("code",{children:Y.name}),Y.description&&o.jsxs("span",{children:[" — ",Y.description]})]},Y.name))}),o.jsx("p",{className:"hint",children:'The tool_filter has been updated with these tools. Click "Save" to apply.'})]})]}):o.jsxs(o.Fragment,{children:[o.jsx("div",{className:"test-result-header",children:"✗ Connection failed"}),o.jsx("div",{className:"test-result-error",children:E.error})]})}),o.jsx("div",{className:"mcp-info",children:o.jsx("p",{children:'Configure your MCP server using JSON. Click "Test Connection" to verify and discover available tools.'})}),o.jsx("div",{className:"code-editor",children:o.jsx(Zt,{height:"100%",language:"json",theme:"vs-dark",value:x,onChange:ce,options:{minimap:{enabled:!1},fontSize:13,fontFamily:"'JetBrains Mono', monospace",lineNumbers:"on",scrollBeyondLastLine:!1,automaticLayout:!0,tabSize:2,insertSpaces:!0,padding:{top:12},formatOnPaste:!0}})}),o.jsxs("div",{className:"mcp-help",children:[o.jsx("h4",{children:"Schema Reference"}),o.jsxs("div",{className:"schema-fields",children:[o.jsxs("div",{className:"schema-field",children:[o.jsx("code",{children:"name"}),o.jsx("span",{children:"Unique identifier for this server"})]}),o.jsxs("div",{className:"schema-field",children:[o.jsx("code",{children:"description"}),o.jsx("span",{children:"Human-readable description"})]}),o.jsxs("div",{className:"schema-field",children:[o.jsx("code",{children:"connection_type"}),o.jsx("span",{children:'"stdio" | "sse" | "http"'})]}),o.jsxs("div",{className:"schema-field",children:[o.jsx("code",{children:"command"}),o.jsx("span",{children:"Command to run (for stdio)"})]}),o.jsxs("div",{className:"schema-field",children:[o.jsx("code",{children:"args"}),o.jsx("span",{children:"Array of command arguments"})]}),o.jsxs("div",{className:"schema-field",children:[o.jsx("code",{children:"env"}),o.jsx("span",{children:"Environment variables object"})]}),o.jsxs("div",{className:"schema-field",children:[o.jsx("code",{children:"url"}),o.jsx("span",{children:"Server URL (for sse/http)"})]}),o.jsxs("div",{className:"schema-field",children:[o.jsx("code",{children:"tool_filter"}),o.jsx("span",{children:"Array of tool names to include (null/omit = all tools, [] = no tools)"})]})]})]})]}):g==="mcp"?o.jsxs("div",{className:"mcp-json-editor",children:[o.jsxs("div",{className:"editor-header",children:[o.jsx(qi,{size:20,style:{color:"var(--accent-primary)"}}),o.jsx("span",{style:{fontSize:"1.1rem",fontWeight:600},children:"mcp.json"}),o.jsx("span",{className:"badge badge-muted",children:"Model Context Protocol"}),o.jsxs("select",{value:"",onChange:Y=>{Y.target.value&&J(Y.target.value)},style:{padding:"6px 10px",fontSize:"12px",borderRadius:"6px",background:"var(--bg-tertiary)",border:"1px solid var(--border-color)",color:"var(--text-primary)"},children:[o.jsx("option",{value:"",children:"+ Add known server..."}),u.filter(Y=>!w.some(te=>te.name===Y.name)).map(Y=>o.jsxs("option",{value:Y.name,children:[Y.name," - ",Y.description||"No description"]},Y.name))]}),o.jsxs("button",{className:"btn btn-primary btn-sm",onClick:ee,children:[o.jsx(La,{size:14}),"Apply Changes"]})]}),o.jsx("div",{className:"mcp-json-info",children:o.jsxs("p",{children:["Configure your MCP servers using the standard ",o.jsx("code",{children:"mcp.json"})," format. Select a known server from the dropdown to add its configuration."]})}),o.jsx("div",{className:"editor-content",style:{flex:1},children:o.jsx(Zt,{height:"100%",defaultLanguage:"json",value:L,onChange:V,theme:"vs-dark",options:{minimap:{enabled:!1},fontSize:14,lineNumbers:"on",scrollBeyondLastLine:!1,wordWrap:"on",tabSize:2,formatOnPaste:!0,formatOnType:!0}})})]}):o.jsxs("div",{className:"empty-state",children:[o.jsx(jn,{size:48}),o.jsxs("p",{children:["Select a tool to view",o.jsx("br",{}),"or create a new custom tool"]})]})})]})}function bE(){return`callback_${Date.now().toString(36)}`}function Am(e){return/^[a-zA-Z0-9_]+$/.test(e)}function x1(e){switch(e){case"before_agent":case"after_agent":return`from google.adk.agents.callback_context import CallbackContext
...
Go to the Evals tab to view and edit the test case.`)}catch(W){alert(`Error creating test case: ${W.message||"Unknown error"}`)}finally{Lp(!1)}},[f,e,Oi,_l]),s0=k.useCallback(()=>{const W=document.createElement("input");W.type="file",W.accept=".json",W.onchange=async re=>{var ge;const pe=(ge=re.target.files)==null?void 0:ge[0];if(pe)try{const de=await pe.text(),Te=JSON.parse(de);if(!Te.events||!Array.isArray(Te.events)){alert("Invalid run file: missing events array");return}a(),l(),y(null),A(null),Te.events.forEach(Me=>{s(Me)})}catch(de){alert(`Failed to load run file: ${de}`)}},W.click()},[a,l,s]);return k.useEffect(()=>{if(x!==null){const W=document.querySelector(".event-row.selected");W==null||W.scrollIntoView({behavior:"smooth",block:"nearest"})}},[x]),e?o.jsxs("div",{className:`run-panel ${me?"resizing":""}`,children:[o.jsx("style",{children:`
      ...
      `}),o.jsxs("aside",{className:"eval-sidebar",children:[o.jsxs("div",{className:"sidebar-header",children:[o.jsx("h3",{children:"Evaluation Tests"}),o.jsxs("div",{className:"header-actions",children:[o.jsx("input",{type:"file",ref:b,accept:".json",style:{display:"none"},onChange:D=>{var K;const $=(K=D.target.files)==null?void 0:K[0];$&&(G($),D.target.value="")}}),o.jsx("button",{className:"btn btn-secondary btn-sm",onClick:()=>{var D;return(D=b.current)==null?void 0:D.click()},title:"Import eval set from JSON",children:o.jsx(dl,{size:14})}),t.length>0&&o.jsx("button",{className:"btn btn-secondary btn-sm",onClick:z,title:"Download all eval sets as JSON",children:o.jsx(Ai,{size:14})}),o.jsx("button",{className:"btn btn-secondary btn-sm",onClick:q,title:"Refresh",children:o.jsx(Xt,{size:14})}),o.jsxs("button",{className:"btn btn-primary btn-sm",onClick:F,title:"New eval set",children:[o.jsx(Xe,{size:14}),"Set"]})]})]}),o.jsxs("div",{className:"eval-tree",children:[v&&o.jsx("p",{style:{color:"var(--text-muted)",padding:"16px"},children:"Loading..."}),m&&o.jsx("div",{style:{color:"var(--error)",padding:"16px",fontSize:"13px"},children:m}),!v&&t.length===0&&o.jsxs("div",{className:"empty-state",style:{padding:"32px"},children:[o.jsx(Xd,{size:32}),o.jsxs("p",{children:["No evaluation sets yet.",o.jsx("br",{}),"Create one to get started."]})]}),t.map(D=>{const $=l.has(D.id),K=le(D),Q=h.has(D.id);return o.jsxs("div",{className:"tree-item",children:[o.jsxs("div",{className:`tree-set ${r===D.id&&!s?"selected":""}`,onClick:()=>B(D.id),children:[o.jsx("button",{className:"expand-btn",onClick:ne=>{ne.stopPropagation(),ee(D.id)},children:D.eval_cases.length>0?$?o.jsx(It,{size:14}):o.jsx(_t,{size:14}):o.jsx("span",{style:{width:14}})}),o.jsx(pv,{size:14,style:{color:"var(--accent-secondary)"}}),o.jsx("span",{className:"set-name",children:D.name}),o.jsx("button",{className:"add-case-btn",onClick:ne=>{ne.stopPropagation(),C(D.id)},title:"Add test case",style:{padding:"2px 4px",marginLeft:4,background:"transparent",border:"none",cursor:"pointer",opacity:.6,display:"flex",alignItems:"center"},children:o.jsx(Xe,{size:12})}),K.total>0&&o.jsxs("span",{className:"set-stats",children:[K.passed>0&&o.jsx("span",{className:"stat-passed",children:K.passed}),K.failed>0&&o.jsx("span",{className:"stat-failed",children:K.failed}),K.pending>0&&o.jsx("span",{className:"stat-pending",children:K.pending})]}),o.jsx("button",{className:"run-btn",onClick:ne=>{ne.stopPropagation(),V(D.id)},title:"Run all tests in this set",disabled:Q,children:Q?o.jsx(Fo,{size:12,className:"spinning"}):o.jsx(fr,{size:12})})]}),$&&o.jsx("div",{className:"tree-children",style:{paddingLeft:16},children:D.eval_cases.map(ne=>{var Z;const me=u.get(ne.id),ve=h.has(ne.id);return o.jsxs("div",{className:`tree-case ${s===ne.id?"selected":""}`,onClick:()=>E(D.id,ne.id),children:[ve?o.jsx(Fo,{size:14,className:"spinning",style:{color:"var(--warning)"}}):me?me.passed?o.jsx(pr,{size:14,style:{color:"var(--success)"}}):o.jsx($r,{size:14,style:{color:"var(--error)"}}):o.jsx(Pa,{size:14,style:{color:"var(--text-muted)"}}),o.jsx("span",{className:"case-name",children:ne.name}),me&&me.metric_results.length>0&&o.jsx("span",{style:{fontSize:11,color:me.passed?"var(--success)":"var(--error)"},children:J((Z=me.metric_results[0])==null?void 0:Z.score)}),o.jsx("button",{className:"run-btn",onClick:ce=>{ce.stopPropagation(),U(D.id,ne.id)},disabled:ve,children:o.jsx(fr,{size:12})})]},ne.id)})})]},D.id)})]}),o.jsxs("div",{className:"history-section",children:[o.jsx("div",{className:"history-header",style:{display:"flex",justifyContent:"space-between",alignItems:"center",padding:"10px 12px",borderTop:"1px solid var(--border-color)",background:"var(--bg-secondary)"},children:o.jsxs("span",{style:{fontWeight:500,fontSize:13},children:["Previous Runs (",y.length,")"]})}),o.jsx("div",{className:"history-list",style:{maxHeight:200,overflowY:"auto"},children:y.length===0?o.jsx("div",{style:{padding:"12px",color:"var(--text-secondary)",fontSize:12,textAlign:"center"},children:"No previous runs"}):[...y].sort((D,$)=>($.started_at||0)-(D.started_at||0)).map(D=>{const $=D.passed_cases===D.total_cases;return o.jsx("div",{className:`history-item ${(A==null?void 0:A.id)===D.id?"selected":""}`,onClick:()=>N(D.id),style:{padding:"8px 12px",borderBottom:"1px solid var(--border-color)",cursor:"pointer",background:(A==null?void 0:A.id)===D.id?"var(--bg-tertiary)":"transparent",fontSize:12},children:o.jsxs("div",{style:{display:"flex",justifyContent:"space-between",alignItems:"center"},children:[o.jsxs("div",{style:{display:"flex",alignItems:"center",gap:8},children:[$?o.jsx(pr,{size:14,style:{color:"var(--success)",flexShrink:0}}):o.jsx($r,{size:14,style:{color:"var(--error)",flexShrink:0}}),o.jsxs("div",{children:[o.jsx("div",{style:{fontWeight:500},children:D.eval_set_name||"Unnamed"}),o.jsx("div",{style:{color:"var(--text-secondary)",fontSize:11},children:new Date(D.started_at*1e3).toLocaleString()})]})]}),o.jsxs("div",{style:{display:"flex",alignItems:"center",gap:8},children:[o.jsxs("span",{style:{color:$?"var(--success)":"var(--error)",fontWeight:500,fontSize:11},children:[D.passed_cases,"/",D.total_cases]}),o.jsx("button",{className:"btn btn-icon",onClick:K=>{K.stopPropagation(),R(D.id)},title:"Delete run",style:{padding:2},children:o.jsx(Ue,{size:12})})]})]})},D.id)})})]})]}),o.jsx("div",{className:"eval-editor",children:A?o.jsx(H8,{run:A,onClose:I}):O?o.jsx(q8,{evalCase:O,evalSetId:r,projectId:e.id,result:u.get(O.id),isRunning:h.has(O.id),onUpdate:D=>L(r,O.id,D),onDelete:()=>M(r,O.id),onRun:()=>U(r,O.id),onClearResult:()=>d(D=>{const $=new Map(D);return $.delete(O.id),$})}):T?o.jsx(J8,{evalSet:T,projectId:e.id,result:p.get(T.id),isRunning:h.has(T.id),caseResults:u,onUpdate:async D=>{try{const $=await Ye.put(`/projects/${e.id}/eval-sets/${T.id}`,D);n(K=>K.map(Q=>Q.id===T.id?$.eval_set:Q))}catch($){x($.message)}},onDelete:()=>w(T.id),onRun:()=>V(T.id),onExport:()=>H(T.id)}):o.jsx("div",{className:"editor-content",children:o.jsxs("div",{className:"empty-state",children:[o.jsx(Pa,{size:48}),o.jsxs("p",{children:["Select a test case to edit",o.jsx("br",{}),"or create a new one"]})]})})})]}):null}function W8({value:e,onChange:t}){var a,l;const{project:n}=ht(),r=((a=n==null?void 0:n.app)==null?void 0:a.models)||[],i=(l=n==null?void 0:n.app)==null?void 0:l.default_model_id,s=r.find(c=>c.id===i);return o.jsxs("select",{value:e,onChange:c=>t(c.target.value),style:{width:"100%",maxWidth:400},children:[o.jsx("option",{value:"",children:s?`App Default (${s.model_name})`:"App Default"}),r.map(c=>o.jsx("option",{value:c.model_name,children:c.model_name},c.id)),o.jsx("option",{value:"gemini-2.0-flash",children:"gemini-2.0-flash"}),o.jsx("option",{value:"gemini-2.5-flash",children:"gemini-2.5-flash"}),o.jsx("option",{value:"gemini-2.5-pro",children:"gemini-2.5-pro"})]})}function H8({run:e,onClose:t}){var h;const{project:n}=ht(),[r,i]=k.useState(!0),[s,a]=k.useState(new Set),l=e.case_results||[],c=l.filter(g=>g.passed).length,u=l.filter(g=>!g.passed).length,d=r?l.filter(g=>!g.passed):l,p=g=>{a(v=>{const _=new Set(v);return _.has(g)?_.delete(g):_.add(g),_})},f=g=>{g&&n&&(window.location.href=`/project/${n.id}/run?session=${g}`)};return o.jsxs("div",{className:"test-result-viewer",children:[o.jsx("style",{children:`
        .test-result-viewer {
          height: 100%;
          display: flex;
          flex-direction: column;
