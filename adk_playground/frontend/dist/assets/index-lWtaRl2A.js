...
`).length,m=Math.max(r,Math.min(f*20+40,500));l(m)}},[e,r]),_.useEffect(()=>{i&&u.current&&u.current.focus()},[i]);function d(f){u.current=f,f.focus()}function p(f){c.current&&!c.current.contains(f.target)&&o(!1)}return _.useEffect(()=>{if(i)return document.addEventListener("mousedown",p),()=>document.removeEventListener("mousedown",p)},[i]),s.jsxs("div",{ref:c,className:"markdown-editor",children:[s.jsx("style",{children:`
      ...
      `}),i?s.jsx("div",{className:"monaco-wrapper",children:s.jsx(an,{height:"100%",language:"markdown",theme:"vs-dark",value:e,onChange:f=>t(f||""),onMount:d,options:{minimap:{enabled:!1},fontSize:14,fontFamily:"'JetBrains Mono', monospace",lineNumbers:"off",scrollBeyondLastLine:!1,automaticLayout:!0,wordWrap:"on",padding:{top:12,bottom:12},lineDecorationsWidth:8,folding:!1,glyphMargin:!1,renderLineHighlight:"none",overviewRulerLanes:0,hideCursorInOverviewRuler:!0,scrollbar:{vertical:"auto",horizontal:"hidden"}}})}):s.jsxs("div",{className:"markdown-preview",onClick:()=>o(!0),children:[s.jsxs("span",{className:"edit-hint",children:[s.jsx(x0,{size:12}),"Click to edit"]}),e?s.jsx("div",{className:"markdown-content",children:s.jsx(ex,{children:e})}):s.jsx("div",{className:"markdown-placeholder",children:n})]})]})}function S_(e){return/^[a-zA-Z0-9_]+$/.test(e)}function C_({agent:e}){const{project:t,updateAgent:n,mcpServers:r,builtinTools:i,setActiveTab:o,setRunAgentId:a}=Ze(),[l,c]=_.useState(new Set(["basic","model","tools","subagents"])),[u,d]=_.useState(!1),[p,f]=_.useState(!1),[m,w]=_.useState(!1),[j,N]=_.useState(""),[g,h]=_.useState(null);if(!t)return null;function y(A){n(e.id,A)}function P(A){if(A===""){h(null),y({name:A});return}S_(A)?h(null):h("Name can only contain letters, numbers, and underscores"),y({name:A})}function C(A){const $=new Set(l);$.has(A)?$.delete(A):$.add(A),c($)}const x=e.type==="LlmAgent",v=e;function T(A){x&&y({tools:[...v.tools,A]})}function R(A){x&&y({tools:v.tools.filter(($,I)=>I!==A)})}function E(A,$){if(!x)return;const I=[...v.tools];I[A]=$,y({tools:I})}function k(A){"sub_agents"in e&&y({sub_agents:[...e.sub_agents,A]})}function z(A){"sub_agents"in e&&y({sub_agents:e.sub_agents.filter($=>$!==A)})}const M=t.agents.filter(A=>A.id!==e.id);async function q(){if(!(!t||!x)){d(!0);try{const A=v.instruction||"",$=A?`Current instruction to improve:

${A}

Please improve and expand this instruction while preserving its core intent.`:void 0,b=t.agents.some(J=>J.id===e.id)?void 0:e,V=await Ds(t.id,e.id,$,b);V.success&&V.prompt?y({instruction:V.prompt}):alert("Failed to generate prompt: "+(V.error||"Unknown error"))}catch(A){alert("Error generating prompt: "+A.message)}finally{d(!1)}}}async function B(){if(!(!t||!x||!j.trim())){d(!0);try{const $=`Current instruction:
...
Please apply the requested changes to the instruction above. Output only the updated instruction, nothing else.`,b=t.agents.some(J=>J.id===e.id)?void 0:e,V=await Ds(t.id,e.id,$,b);V.success&&V.prompt?(y({instruction:V.prompt}),w(!1),N("")):alert("Failed to apply changes: "+(V.error||"Unknown error"))}catch(A){alert("Error applying changes: "+A.message)}finally{d(!1)}}}async function Y(){if(!t||!x)return;const A=v.instruction;if(!A){alert("Please write an instruction first");return}f(!0);try{const $=`Write a 5-10 word description of what this agent does.
...
`;function fS({onSelectTool:e}){var _t;const{project:t,updateProject:n,addCustomTool:r,updateCustomTool:i,removeCustomTool:o,selectedToolId:a,setSelectedToolId:l,builtinTools:c,mcpServers:u}=Ze(),[d,p]=_.useState(""),[f,m]=_.useState(null),[w,j]=_.useState("tools"),[N,g]=_.useState(null),[h,y]=_.useState(""),[P,C]=_.useState(!1),[x,v]=_.useState(null),[T,R]=_.useState(!1),[E,k]=_.useState(!1),[z,M]=_.useState(null),[q,B]=_.useState(null);if(!t)return null;const Y=t.mcp_servers||[],A=t.custom_tools.find(H=>H.id===a),$=Y.find(H=>H.name===N),I=new Set(Y.map(H=>H.name)),b=u.filter(H=>!I.has(H.name));function V(H){l(H),e==null||e(H)}_.useEffect(()=>{A&&(p(A.code),B(null))},[a]),_.useEffect(()=>{$&&(y(JSON.stringify($,null,2)),C(!1))},[N]);function J(){const H=uS();r({id:H,name:"new_tool",description:"",module_path:"tools.custom",code:pS,state_keys_used:[]}),V(H)}function S(H,he){he.stopPropagation(),confirm("Delete this tool?")&&(o(H),a===H&&(e==null||e(null)))}function oe(H){A&&(H.name!==void 0&&(H.name===""||dS(H.name)?B(null):B("Name can only contain letters, numbers, and underscores")),i(A.id,H))}function L(H){H!==void 0&&A&&(p(H),oe({code:H}))}async function X(){if(A){R(!0);try{const H=await Wh(t.id,A.name,A.description,A.state_keys_used);H.success&&H.code?(p(H.code),oe({code:H.code})):(console.error("Failed to generate tool code:",H.error),alert("Failed to generate tool code: "+(H.error||"Unknown error")))}catch(H){console.error("Error generating tool code:",H),alert("Error generating tool code: "+H.message)}finally{R(!1)}}}const F=_.useRef(null),O=_.useCallback((H,he)=>{if(F.current&&typeof F.current=="function")try{F.current()}catch{}try{const Ee=sx(he,H,{language:"python",endpoint:"/api/code-completion",trigger:"onTyping"});typeof Ee=="function"?F.current=Ee:F.current=null}catch{F.current=null}},[]);_.useEffect(()=>()=>{if(F.current&&typeof F.current=="function")try{F.current()}catch{}},[]);function U(){const H={name:`mcp_server_${Date.now().toString(36)}`,description:"New MCP Server",connection_type:"stdio",command:"npx",args:["-y","@modelcontextprotocol/server-example"],env:{},headers:{},timeout:10};n({mcp_servers:[...Y,H]}),g(H.name),v(null)}function K(H){const he={...H};n({mcp_servers:[...Y,he]}),g(he.name),v(null)}function Z(H,he){he.stopPropagation(),confirm("Delete this MCP server?")&&(n({mcp_servers:Y.filter(Ee=>Ee.name!==H)}),N===H&&g(null))}function te(H){H!==void 0&&(y(H),C(H!==JSON.stringify($,null,2)))}function me(){if($)try{const H=JSON.parse(h),he=$.name,Ee=Y.map(ft=>ft.name===he?H:ft);n({mcp_servers:Ee}),g(H.name),C(!1)}catch(H){alert("Invalid JSON: "+H.message)}}async function Ne(){k(!0),M(null);try{const H=JSON.parse(h),he=await qh({connection_type:H.connection_type,command:H.command,args:H.args,env:H.env,url:H.url,headers:H.headers,timeout:H.timeout||30});if(M(he),he.success&&he.tools.length>0){const Ee={...H,tool_filter:he.tools.map(ft=>ft.name)};y(JSON.stringify(Ee,null,2)),C(!0)}}catch(H){M({success:!1,tools:[],error:H.message})}finally{k(!1)}}const Re={};return t.custom_tools.forEach(H=>{const he=H.module_path||"tools";Re[he]||(Re[he]=[]),Re[he].push(H)}),s.jsxs("div",{className:"tools-panel",children:[s.jsx("style",{children:`
        .tools-panel {
          display: flex;
          gap: 20px;
          height: calc(100vh - 180px);
...
Go to the Evals tab to view and edit the test case.`)}catch(D){alert(`Error creating test case: ${D.message||"Unknown error"}`)}finally{pe(!1)}},[p,e,Un,W]),Xt=_.useCallback(()=>{const D=document.createElement("input");D.type="file",D.accept=".json",D.onchange=async re=>{var ae;const ie=(ae=re.target.files)==null?void 0:ae[0];if(ie)try{const de=await ie.text(),Ue=JSON.parse(de);if(!Ue.events||!Array.isArray(Ue.events)){alert("Invalid run file: missing events array");return}o(),a(),h(null),P(null),Ue.events.forEach(Vn=>{i(Vn)})}catch(de){alert(`Failed to load run file: ${de}`)}},D.click()},[o,a,i]);return _.useEffect(()=>{if(g!==null){const D=document.querySelector(".event-row.selected");D==null||D.scrollIntoView({behavior:"smooth",block:"nearest"})}},[g]),e?s.jsxs("div",{className:`run-panel ${A?"resizing":""}`,children:[s.jsx("style",{children:`
        .run-panel {
          display: flex;
          flex-direction: column;
          width: 100%;
      ...
      `}),s.jsxs("div",{className:"skillset-list",children:[s.jsxs("div",{className:"skillset-list-header",children:[s.jsx("h3",{children:"SkillSets"}),s.jsx("button",{className:"btn-icon",onClick:z,title:"Add SkillSet",children:s.jsx(Me,{size:16})})]}),v.length===0?s.jsxs("div",{className:"empty-state",style:{padding:"40px 0"},children:[s.jsx(on,{size:32}),s.jsx("span",{children:"No SkillSets"}),s.jsxs("button",{className:"btn-primary",onClick:z,children:[s.jsx(Me,{size:14})," Create SkillSet"]})]}):v.map(I=>s.jsxs("div",{className:`skillset-item ${n===I.id?"selected":""}`,onClick:()=>r(I.id),children:[s.jsx(on,{size:16,style:{color:"var(--accent)",flexShrink:0}}),s.jsxs("div",{className:"skillset-item-info",children:[s.jsx("div",{className:"skillset-item-name",children:I.name}),s.jsxs("div",{className:"skillset-item-count",children:[I.entry_count||0," entries"]})]}),s.jsx("button",{className:"skillset-item-delete",onClick:b=>{b.stopPropagation(),M(I.id)},children:s.jsx(Te,{size:14})})]},I.id))]}),T?s.jsxs("div",{className:"skillset-detail",children:[s.jsxs("div",{className:"skillset-header",children:[s.jsxs("div",{className:"skillset-header-info",children:[s.jsx("input",{className:"skillset-name-input",value:T.name,onChange:I=>k(T.id,{name:I.target.value}),placeholder:"SkillSet Name"}),s.jsx("textarea",{className:"skillset-desc-input",value:T.description,onChange:I=>k(T.id,{description:I.target.value}),placeholder:"Description (optional)",rows:1}),s.jsxs("div",{className:"skillset-model",children:[s.jsx("label",{style:{fontSize:"12px",color:"var(--text-secondary)",marginRight:"8px"},children:"Embedding Model:"}),s.jsxs("select",{style:{flex:1,padding:"4px 8px",fontSize:"12px",background:"var(--bg-secondary)",border:"1px solid var(--border)",borderRadius:"4px",color:"var(--text-primary)"},value:T.embedding_model||"text-embedding-004",onChange:I=>k(T.id,{embedding_model:I.target.value}),children:[s.jsxs("optgroup",{label:"Google Gemini",children:[s.jsx("option",{value:"text-embedding-004",children:"text-embedding-004 (768d)"}),s.jsx("option",{value:"text-embedding-005",children:"text-embedding-005"})]}),s.jsxs("optgroup",{label:"OpenAI",children:[s.jsx("option",{value:"text-embedding-3-small",children:"text-embedding-3-small (1536d)"}),s.jsx("option",{value:"text-embedding-3-large",children:"text-embedding-3-large (3072d)"})]}),s.jsxs("optgroup",{label:"Cohere",children:[s.jsx("option",{value:"embed-english-v3.0",children:"embed-english-v3.0 (1024d)"}),s.jsx("option",{value:"embed-multilingual-v3.0",children:"embed-multilingual-v3.0 (1024d)"})]})]})]}),s.jsxs("div",{className:"skillset-stats",children:[s.jsxs("span",{className:"skillset-stat",children:[s.jsx("strong",{children:(i==null?void 0:i.entry_count)||0})," entries"]}),s.jsxs("span",{className:"skillset-stat",children:[s.jsx("strong",{children:Object.keys((i==null?void 0:i.sources)||{}).length})," sources"]}),P===!1&&s.jsx("span",{className:"skillset-stat",style:{color:"var(--warning)"},children:"⚠ No embeddings"})]})]}),s.jsx("button",{className:"btn-icon",onClick:R,title:"Refresh",children:s.jsx(wn,{size:16})})]}),h&&s.jsxs("div",{className:"error-banner",children:[h,s.jsx("button",{onClick:()=>y(null),children:s.jsx(ag,{size:14})})]}),s.jsxs("div",{className:"search-section",children:[s.jsx("div",{className:"search-input-wrapper",children:s.jsx("input",{className:"search-input",value:a,onChange:I=>l(I.target.value),onKeyDown:I=>I.key==="Enter"&&q(),placeholder:"Search this SkillSet..."})}),s.jsxs("button",{className:"btn-primary",onClick:q,disabled:d||!a.trim(),children:[s.jsx(ig,{size:14}),d?"Searching...":"Search"]})]}),s.jsxs("div",{className:"search-results",children:[c.length===0&&!d&&a&&s.jsx("div",{className:"empty-state",children:s.jsx("span",{children:"No results found"})}),c.map(I=>s.jsxs("div",{className:"search-result",style:{background:$(I.score)},children:[s.jsxs("span",{className:"search-result-score",children:[(I.score*100).toFixed(0),"%"]}),s.jsx("div",{className:"search-result-text",children:I.text}),s.jsx("div",{className:"search-result-source",children:I.source_name})]},I.id))]}),s.jsxs("div",{className:"add-sources-section",children:[s.jsxs("div",{className:"add-sources-header",onClick:()=>m(!f),children:[f?s.jsx(Ct,{size:16}):s.jsx(Nt,{size:16}),s.jsx("h4",{children:"Add Sources"})]}),f&&s.jsxs("div",{className:"add-sources-content",children:[s.jsxs("div",{className:"source-row",children:[s.jsx(Ul,{size:16,style:{color:"var(--text-tertiary)"}}),s.jsx("input",{className:"source-input",value:w,onChange:I=>j(I.target.value),onKeyDown:I=>I.key==="Enter"&&B(),placeholder:"Enter URL (e.g., llms.txt file)"}),s.jsxs("button",{className:"btn-primary",onClick:B,disabled:N||!w.trim(),children:[s.jsx(h0,{size:14}),N?"Loading...":"Add"]})]}),s.jsxs("div",{className:"source-row",children:[s.jsx(f0,{size:16,style:{color:"var(--text-tertiary)"}}),s.jsx("input",{ref:x,type:"file",accept:".txt,.md,.json,.csv,.html",onChange:Y}),s.jsxs("button",{className:"btn-primary",onClick:()=>{var I;return(I=x.current)==null?void 0:I.click()},children:[s.jsx(Uo,{size:14}),"Upload File"]}),s.jsx("span",{style:{fontSize:"12px",color:"var(--text-tertiary)"},children:".txt, .md, .json, .csv"})]}),((i==null?void 0:i.entry_count)||0)>0&&s.jsx("div",{className:"source-row",style:{marginTop:"8px"},children:s.jsxs("button",{className:"clear-button",onClick:A,children:[s.jsx(Te,{size:12}),"Clear All Entries (",(i==null?void 0:i.entry_count)||0,")"]})})]})]})]}):v.length>0?s.jsx("div",{className:"skillset-detail",children:s.jsxs("div",{className:"empty-state",children:[s.jsx(on,{size:48}),s.jsx("span",{children:"Select a SkillSet"})]})}):null]}):null}const tn={tool_trajectory_avg_score:{name:"Tool Trajectory",description:"Did the agent call the right tools in the expected order?",requiresJudge:!1},response_match_score:{name:"Response Match (ROUGE-1)",description:"Does the response contain expected text? (fuzzy word matching)",requiresJudge:!1},response_evaluation_score:{name:"Response Evaluation (LLM)",description:"LLM-judged semantic match of final response",requiresJudge:!0},final_response_match_v2:{name:"Response Quality v2 (LLM)",description:"Enhanced LLM-judged response quality check",requiresJudge:!0},safety_v1:{name:"Safety",description:"Is the response safe and harmless? (Vertex AI)",requiresJudge:!0},hallucinations_v1:{name:"Hallucination Detection",description:"Are all claims supported by context? No false information?",requiresJudge:!0},rubric_based_final_response_quality_v1:{name:"Rubric: Response Quality",description:"Custom rubric-based quality assessment of responses",requiresJudge:!0},rubric_based_tool_use_quality_v1:{name:"Rubric: Tool Use Quality",description:"Custom rubric-based assessment of tool usage",requiresJudge:!0}},NS={metrics:[{metric:"tool_trajectory_avg_score",enabled:!0,criterion:{threshold:1}},{metric:"response_match_score",enabled:!0,criterion:{threshold:.7}}],default_trajectory_match_type:"in_order",num_runs:1};function ax(){return`${Date.now().toString(36)}_${Math.random().toString(36).slice(2,6)}`}function ES(){const{project:e}=Ze(),[t,n]=_.useState([]),[r,i]=_.useState(null),[o,a]=_.useState(null),[l,c]=_.useState(new Set),[u,d]=_.useState(new Map),[p,f]=_.useState(new Map),[m,w]=_.useState(new Set),[j,N]=_.useState(!1),[g,h]=_.useState(null),[y,P]=_.useState([]),[C,x]=_.useState(!0),[v,T]=_.useState(null),R=async()=>{if(e)try{const O=await Ve.get(`/projects/${e.id}/eval-history`);P(O.runs||[])}catch(O){console.warn("Failed to load eval history:",O)}},E=async O=>{if(e)try{const U=await Ve.get(`/projects/${e.id}/eval-history/${O}`);T(U.run),i(null),a(null)}catch(U){console.warn("Failed to load history run:",U)}},k=async O=>{if(e)try{await Ve.delete(`/projects/${e.id}/eval-history/${O}`),P(U=>U.filter(K=>K.id!==O)),(v==null?void 0:v.id)===O&&T(null)}catch(U){console.warn("Failed to delete history run:",U)}};_.useEffect(()=>{e!=null&&e.id&&(z(),R())},[e==null?void 0:e.id]),_.useEffect(()=>{if(!(e!=null&&e.id)||j)return;const O=new URLSearchParams(window.location.search),U=O.get("set"),K=O.get("case"),Z=O.get("run");if((U||K||Z)&&window.history.replaceState({},"",window.location.pathname),Z){E(Z);return}U&&(i(U),c(te=>new Set([...te,U])),K&&a(K))},[e==null?void 0:e.id,j,t.length]);const z=async()=>{var O;if(e!=null&&e.id){N(!0),h(null);try{const U=await Ve.get(`/projects/${e.id}/eval-sets`);n(U.eval_sets||[]),((O=U.eval_sets)==null?void 0:O.length)>0&&c(new Set([U.eval_sets[0].id]))}catch(U){h(U.message||"Failed to load eval sets")}finally{N(!1)}}},M=t.find(O=>O.id===r),q=M==null?void 0:M.eval_cases.find(O=>O.id===o),B=async()=>{if(e!=null&&e.id)try{const O=await Ve.post(`/projects/${e.id}/eval-sets`,{name:"New Eval Set",description:"",eval_config:NS});n(U=>[...U,O.eval_set]),i(O.eval_set.id),c(U=>new Set([...U,O.eval_set.id]))}catch(O){h(O.message||"Failed to create eval set")}},Y=async O=>{if(e!=null&&e.id)try{const U=await Ve.post(`/projects/${e.id}/eval-sets/${O}/cases`,{name:"New Test Case",description:"",invocations:[{id:ax(),user_message:"",expected_response:"",expected_tool_calls:[],tool_trajectory_match_type:"in_order",rubrics:[]}],initial_state:{},rubrics:[],enabled_metrics:[],tags:[]});n(K=>K.map(Z=>Z.id===O?{...Z,eval_cases:[...Z.eval_cases,U.eval_case]}:Z)),i(O),a(U.eval_case.id)}catch(U){h(U.message||"Failed to create eval case")}},A=async(O,U,K)=>{if(e!=null&&e.id)try{const Z=await Ve.put(`/projects/${e.id}/eval-sets/${O}/cases/${U}`,K);n(te=>te.map(me=>me.id===O?{...me,eval_cases:me.eval_cases.map(Ne=>Ne.id===U?Z.eval_case:Ne)}:me))}catch(Z){h(Z.message||"Failed to update eval case")}},$=async(O,U)=>{if(e!=null&&e.id)try{await Ve.delete(`/projects/${e.id}/eval-sets/${O}/cases/${U}`),n(K=>K.map(Z=>Z.id===O?{...Z,eval_cases:Z.eval_cases.filter(te=>te.id!==U)}:Z)),o===U&&a(null)}catch(K){h(K.message||"Failed to delete eval case")}},I=async O=>{if(e!=null&&e.id)try{await Ve.delete(`/projects/${e.id}/eval-sets/${O}`),n(U=>U.filter(K=>K.id!==O)),r===O&&(i(null),a(null))}catch(U){h(U.message||"Failed to delete eval set")}},b=async O=>{if(e!=null&&e.id)try{const U=await Ve.get(`/projects/${e.id}/eval-sets/${O}/export`),K=new Blob([JSON.stringify(U,null,2)],{type:"application/json"}),Z=URL.createObjectURL(K),te=document.createElement("a");te.href=Z;const me=t.find(Ne=>Ne.id===O);te.download=`${(me==null?void 0:me.name)||"eval-set"}.json`,document.body.appendChild(te),te.click(),document.body.removeChild(te),URL.revokeObjectURL(Z)}catch(U){h(U.message||"Failed to export eval set")}},V=async O=>{if(e!=null&&e.id)try{const U=await O.text(),K=JSON.parse(U),Z=await Ve.post(`/projects/${e.id}/eval-sets/import`,K);n(te=>[...te,Z.eval_set]),i(Z.eval_set.id),c(te=>new Set([...te,Z.eval_set.id]))}catch(U){h(U.message||"Failed to import eval set")}},J=_.useRef(null),S=async(O,U)=>{if(e!=null&&e.id){w(K=>new Set([...K,U]));try{const K=await Ve.post(`/projects/${e.id}/eval-sets/${O}/cases/${U}/run`,{});d(Z=>new Map(Z).set(U,K.result))}catch(K){h(K.message||"Failed to run eval case")}finally{w(K=>{const Z=new Set(K);return Z.delete(U),Z})}}},oe=async O=>{if(!(e!=null&&e.id))return;const U=t.find(Z=>Z.id===O);if(!U)return;const K=U.eval_cases.map(Z=>Z.id);w(Z=>new Set([...Z,O,...K]));try{const Z=await Ve.post(`/projects/${e.id}/eval-sets/${O}/run`,{});f(te=>new Map(te).set(O,Z.result));for(const te of Z.result.case_results)d(me=>new Map(me).set(te.eval_case_id,te));try{await Ve.post(`/projects/${e.id}/eval-history`,Z.result),R()}catch(te){console.warn("Failed to save eval run to history:",te)}}catch(Z){h(Z.message||"Failed to run eval set")}finally{w(Z=>{const te=new Set(Z);return te.delete(O),K.forEach(me=>te.delete(me)),te})}},L=O=>{c(U=>{const K=new Set(U);return K.has(O)?K.delete(O):K.add(O),K})},X=O=>{let U=O.eval_cases.length,K=0,Z=0,te=0;for(const me of O.eval_cases){const Ne=u.get(me.id);Ne?Ne.passed?K++:Z++:te++}return{total:U,passed:K,failed:Z,pending:te}},F=O=>O==null?"-":`${Math.round(O*100)}%`;return e?s.jsxs("div",{className:"eval-panel",children:[s.jsx("style",{children:`
        .eval-panel {
          display: flex;
          gap: 20px;
          height: calc(100vh - 180px);
      ...
      `}),s.jsxs("aside",{className:"eval-sidebar",children:[s.jsxs("div",{className:"sidebar-header",children:[s.jsx("h3",{children:"Evaluation Tests"}),s.jsxs("div",{className:"header-actions",children:[s.jsx("input",{type:"file",ref:J,accept:".json",style:{display:"none"},onChange:O=>{var K;const U=(K=O.target.files)==null?void 0:K[0];U&&(V(U),O.target.value="")}}),s.jsx("button",{className:"btn btn-secondary btn-sm",onClick:()=>{var O;return(O=J.current)==null?void 0:O.click()},title:"Import eval set from JSON",children:s.jsx(Uo,{size:14})}),s.jsx("button",{className:"btn btn-secondary btn-sm",onClick:z,title:"Refresh",children:s.jsx(wn,{size:14})}),s.jsxs("button",{className:"btn btn-primary btn-sm",onClick:B,title:"New eval set",children:[s.jsx(Me,{size:14}),"Set"]})]})]}),s.jsxs("div",{className:"eval-tree",children:[j&&s.jsx("p",{style:{color:"var(--text-muted)",padding:"16px"},children:"Loading..."}),g&&s.jsx("div",{style:{color:"var(--error)",padding:"16px",fontSize:"13px"},children:g}),!j&&t.length===0&&s.jsxs("div",{className:"empty-state",style:{padding:"32px"},children:[s.jsx(cu,{size:32}),s.jsxs("p",{children:["No evaluation sets yet.",s.jsx("br",{}),"Create one to get started."]})]}),t.map(O=>{const U=l.has(O.id),K=X(O),Z=m.has(O.id);return s.jsxs("div",{className:"tree-item",children:[s.jsxs("div",{className:`tree-set ${r===O.id&&!o?"selected":""}`,onClick:()=>{i(O.id),a(null)},children:[s.jsx("button",{className:"expand-btn",onClick:te=>{te.stopPropagation(),L(O.id)},children:O.eval_cases.length>0?U?s.jsx(Ct,{size:14}):s.jsx(Nt,{size:14}):s.jsx("span",{style:{width:14}})}),s.jsx(ng,{size:14,style:{color:"var(--accent-secondary)"}}),s.jsx("span",{className:"set-name",children:O.name}),K.total>0&&s.jsxs("span",{className:"set-stats",children:[K.passed>0&&s.jsx("span",{className:"stat-passed",children:K.passed}),K.failed>0&&s.jsx("span",{className:"stat-failed",children:K.failed}),K.pending>0&&s.jsx("span",{className:"stat-pending",children:K.pending})]}),s.jsx("button",{className:"run-btn",onClick:te=>{te.stopPropagation(),oe(O.id)},title:"Run all tests in this set",disabled:Z,children:Z?s.jsx(ho,{size:12,className:"spinning"}):s.jsx(Mn,{size:12})})]}),U&&s.jsxs("div",{className:"tree-children",style:{paddingLeft:16},children:[O.eval_cases.map(te=>{var Re;const me=u.get(te.id),Ne=m.has(te.id);return s.jsxs("div",{className:`tree-case ${o===te.id?"selected":""}`,onClick:()=>{i(O.id),a(te.id)},children:[Ne?s.jsx(ho,{size:14,className:"spinning",style:{color:"var(--warning)"}}):me?me.passed?s.jsx(sr,{size:14,style:{color:"var(--success)"}}):s.jsx(Vr,{size:14,style:{color:"var(--error)"}}):s.jsx(go,{size:14,style:{color:"var(--text-muted)"}}),s.jsx("span",{className:"case-name",children:te.name}),me&&me.metric_results.length>0&&s.jsx("span",{style:{fontSize:11,color:me.passed?"var(--success)":"var(--error)"},children:F((Re=me.metric_results[0])==null?void 0:Re.score)}),s.jsx("button",{className:"run-btn",onClick:_t=>{_t.stopPropagation(),S(O.id,te.id)},disabled:Ne,children:s.jsx(Mn,{size:12})})]},te.id)}),s.jsxs("button",{className:"btn btn-secondary btn-sm",style:{marginTop:8,marginLeft:20},onClick:()=>Y(O.id),children:[s.jsx(Me,{size:12}),"Add Test Case"]})]})]},O.id)})]}),s.jsxs("div",{className:"history-section",children:[s.jsx("div",{className:"history-header",onClick:()=>x(!C),style:{cursor:"pointer",display:"flex",justifyContent:"space-between",alignItems:"center",padding:"10px 12px",borderTop:"1px solid var(--border-color)",background:"var(--bg-secondary)"},children:s.jsxs("span",{style:{fontWeight:500,fontSize:13},children:[C?"▼":"▶"," Previous Runs (",y.length,")"]})}),C&&s.jsx("div",{className:"history-list",style:{maxHeight:200,overflowY:"auto"},children:y.length===0?s.jsx("div",{style:{padding:"12px",color:"var(--text-secondary)",fontSize:12,textAlign:"center"},children:"No previous runs"}):[...y].sort((O,U)=>(U.started_at||0)-(O.started_at||0)).map(O=>{const U=O.passed_cases===O.total_cases;return s.jsx("div",{className:`history-item ${(v==null?void 0:v.id)===O.id?"selected":""}`,onClick:()=>E(O.id),style:{padding:"8px 12px",borderBottom:"1px solid var(--border-color)",cursor:"pointer",background:(v==null?void 0:v.id)===O.id?"var(--bg-tertiary)":"transparent",fontSize:12},children:s.jsxs("div",{style:{display:"flex",justifyContent:"space-between",alignItems:"center"},children:[s.jsxs("div",{style:{display:"flex",alignItems:"center",gap:8},children:[U?s.jsx(sr,{size:14,style:{color:"var(--success)",flexShrink:0}}):s.jsx(Vr,{size:14,style:{color:"var(--error)",flexShrink:0}}),s.jsxs("div",{children:[s.jsx("div",{style:{fontWeight:500},children:O.eval_set_name||"Unnamed"}),s.jsx("div",{style:{color:"var(--text-secondary)",fontSize:11},children:new Date(O.started_at*1e3).toLocaleString()})]})]}),s.jsxs("div",{style:{display:"flex",alignItems:"center",gap:8},children:[s.jsxs("span",{style:{color:U?"var(--success)":"var(--error)",fontWeight:500,fontSize:11},children:[O.passed_cases,"/",O.total_cases]}),s.jsx("button",{className:"btn btn-icon",onClick:K=>{K.stopPropagation(),k(O.id)},title:"Delete run",style:{padding:2},children:s.jsx(Te,{size:12})})]})]})},O.id)})})]})]}),s.jsx("div",{className:"eval-editor",children:v?s.jsx(TS,{run:v,onClose:()=>T(null)}):q?s.jsx(PS,{evalCase:q,evalSetId:r,projectId:e.id,result:u.get(q.id),isRunning:m.has(q.id),onUpdate:O=>A(r,q.id,O),onDelete:()=>$(r,q.id),onRun:()=>S(r,q.id)}):M?s.jsx(LS,{evalSet:M,projectId:e.id,result:p.get(M.id),isRunning:m.has(M.id),caseResults:u,onUpdate:async O=>{try{const U=await Ve.put(`/projects/${e.id}/eval-sets/${M.id}`,O);n(K=>K.map(Z=>Z.id===M.id?U.eval_set:Z))}catch(U){h(U.message)}},onDelete:()=>I(M.id),onRun:()=>oe(M.id),onExport:()=>b(M.id)}):s.jsx("div",{className:"editor-content",children:s.jsxs("div",{className:"empty-state",children:[s.jsx(go,{size:48}),s.jsxs("p",{children:["Select a test case to edit",s.jsx("br",{}),"or create a new one"]})]})})})]}):null}function zS({value:e,onChange:t}){var a,l;const{project:n}=Ze(),r=((a=n==null?void 0:n.app)==null?void 0:a.models)||[],i=(l=n==null?void 0:n.app)==null?void 0:l.default_model_id,o=r.find(c=>c.id===i);return s.jsxs("select",{value:e,onChange:c=>t(c.target.value),style:{width:"100%",maxWidth:400},children:[s.jsx("option",{value:"",children:o?`App Default (${o.model_name})`:"App Default"}),r.map(c=>s.jsx("option",{value:c.model_name,children:c.model_name},c.id)),s.jsx("option",{value:"gemini-2.0-flash",children:"gemini-2.0-flash"}),s.jsx("option",{value:"gemini-2.5-flash",children:"gemini-2.5-flash"}),s.jsx("option",{value:"gemini-2.5-pro",children:"gemini-2.5-pro"})]})}function TS({run:e,onClose:t}){var l;const{project:n}=Ze(),r=e.case_results||[],i=r.filter(c=>c.passed).length,o=r.filter(c=>!c.passed).length,a=c=>{c&&n&&(window.location.href=`/project/${n.id}/run?session=${c}`)};return s.jsxs("div",{className:"test-result-viewer",children:[s.jsx("style",{children:`
        .test-result-viewer {
          height: 100%;
          display: flex;
          flex-direction: column;
