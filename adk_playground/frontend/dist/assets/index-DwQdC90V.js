 ...
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const l0=e=>e.replace(/([a-z0-9])([A-Z])/g,"$1-$2").toLowerCase().trim(),se=(e,t)=>{const n=_.forwardRef(({color:r="currentColor",size:i=24,strokeWidth:o=2,absoluteStrokeWidth:a,className:l="",children:c,...u},p)=>_.createElement("svg",{ref:p,...a0,width:i,height:i,stroke:r,strokeWidth:a?Number(o)*24/Number(i):o,className:["lucide",`lucide-${l0(e)}`,l].join(" "),...u},[...t.map(([d,f])=>_.createElement(d,f)),...Array.isArray(c)?c:[c]]));return n.displayName=`${e}`,n};/**
 * @license lucide-react v0.294.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
...
`).length,m=Math.max(r,Math.min(f*20+40,500));l(m)}},[e,r]),_.useEffect(()=>{i&&u.current&&u.current.focus()},[i]);function p(f){u.current=f,f.focus()}function d(f){c.current&&!c.current.contains(f.target)&&o(!1)}return _.useEffect(()=>{if(i)return document.addEventListener("mousedown",d),()=>document.removeEventListener("mousedown",d)},[i]),s.jsxs("div",{ref:c,className:"markdown-editor",children:[s.jsx("style",{children:`
      ...
      `}),i?s.jsx("div",{className:"monaco-wrapper",children:s.jsx(an,{height:"100%",language:"markdown",theme:"vs-dark",value:e,onChange:f=>t(f||""),onMount:p,options:{minimap:{enabled:!1},fontSize:14,fontFamily:"'JetBrains Mono', monospace",lineNumbers:"off",scrollBeyondLastLine:!1,automaticLayout:!0,wordWrap:"on",padding:{top:12,bottom:12},lineDecorationsWidth:8,folding:!1,glyphMargin:!1,renderLineHighlight:"none",overviewRulerLanes:0,hideCursorInOverviewRuler:!0,scrollbar:{vertical:"auto",horizontal:"hidden"}}})}):s.jsxs("div",{className:"markdown-preview",onClick:()=>o(!0),children:[s.jsxs("span",{className:"edit-hint",children:[s.jsx(x0,{size:12}),"Click to edit"]}),e?s.jsx("div",{className:"markdown-content",children:s.jsx(ex,{children:e})}):s.jsx("div",{className:"markdown-placeholder",children:n})]})]})}function S_(e){return/^[a-zA-Z0-9_]+$/.test(e)}function C_({agent:e}){const{project:t,updateAgent:n,mcpServers:r,builtinTools:i,setActiveTab:o,setRunAgentId:a}=Ze(),[l,c]=_.useState(new Set(["basic","model","tools","subagents"])),[u,p]=_.useState(!1),[d,f]=_.useState(!1),[m,w]=_.useState(!1),[v,N]=_.useState(""),[x,h]=_.useState(null);if(!t)return null;function y(A){n(e.id,A)}function P(A){if(A===""){h(null),y({name:A});return}S_(A)?h(null):h("Name can only contain letters, numbers, and underscores"),y({name:A})}function S(A){const $=new Set(l);$.has(A)?$.delete(A):$.add(A),c($)}const g=e.type==="LlmAgent",k=e;function T(A){g&&y({tools:[...k.tools,A]})}function R(A){g&&y({tools:k.tools.filter(($,I)=>I!==A)})}function E(A,$){if(!g)return;const I=[...k.tools];I[A]=$,y({tools:I})}function j(A){"sub_agents"in e&&y({sub_agents:[...e.sub_agents,A]})}function z(A){"sub_agents"in e&&y({sub_agents:e.sub_agents.filter($=>$!==A)})}const O=t.agents.filter(A=>A.id!==e.id);async function V(){if(!(!t||!g)){p(!0);try{const A=k.instruction||"",$=A?`Current instruction to improve:
...
def my_callback(tool: BaseTool, tool_args: Dict[str, Any], tool_context: ToolContext, result: Dict) -> Optional[Dict]:
    ...
    return None
`;default:return ox("before_agent")}}function hS({onSelectCallback:e}){var T,R;const{project:t,updateProject:n,addCustomCallback:r,updateCustomCallback:i,removeCustomCallback:o}=Ze(),[a,l]=_.useState(""),[c,u]=_.useState(null),[p,d]=_.useState(null),[f,m]=_.useState(!1),w=_.useRef(null);if(!t)return null;const v=t.custom_callbacks||[],N=v.find(E=>E.id===c);function x(E){u(E),e==null||e(E)}_.useEffect(()=>{N?(l(N.code),d(null)):l("")},[c,N]);function h(){const E=mS(),j={id:E,name:"new_callback",description:"",module_path:"callbacks.custom",code:ox("before_agent"),state_keys_used:[]};r(j),x(E)}function y(E,j){j.stopPropagation(),confirm("Delete this callback?")&&(o(E),c===E&&(e==null||e(null),u(null),l("")))}function P(){if(!c)return;const E=v.find(O=>O.id===c);if(!E)return;const j=E.name.trim();if(!j){alert("Please enter a name");return}if(!Xp(j)){d("Name must contain only alphanumeric characters and underscores");return}if(v.find(O=>O.name===j&&O.id!==E.id)){d("A callback with this name already exists");return}i(E.id,{code:a,name:j,description:E.description,module_path:E.module_path,state_keys_used:E.state_keys_used}),d(null)}function S(E,j){w.current=j;try{sx(j,{endpoint:"/api/code-completion",language:"python"})}catch(z){console.warn("Failed to register Monacopilot completion:",z)}}async function g(){if(N){m(!0);try{let E="before_agent";const j=N.name.toLowerCase(),z=N.description.toLowerCase();j.includes("after_agent")||z.includes("after agent")?E="after_agent":j.includes("before_model")||z.includes("before model")?E="before_model":j.includes("after_model")||z.includes("after model")?E="after_model":j.includes("before_tool")||z.includes("before tool")?E="before_tool":j.includes("after_tool")||z.includes("after tool")?E="after_tool":(j.includes("before_agent")||z.includes("before agent"))&&(E="before_agent");const O=await Hh(t.id,N.name,N.description,E,N.state_keys_used);O.success&&O.code?(l(O.code),i(N.id,{code:O.code})):(console.error("Failed to generate callback code:",O.error),alert("Failed to generate callback code: "+(O.error||"Unknown error")))}catch(E){console.error("Error generating callback code:",E),alert("Error generating callback code: "+E.message)}finally{m(!1)}}}const k=((R=(T=t.app)==null?void 0:T.state_keys)==null?void 0:R.map(E=>E.name))||[];return s.jsxs("div",{className:"tools-panel",children:[s.jsx("style",{children:`
        .tools-panel {
          display: flex;
          height: 100%;
          background: var(--bg-primary);
...
`+T,s.jsx("span",{className:"json-bracket",children:"}"})]})}return String(S)};return s.jsxs("div",{className:"event-detail",children:[s.jsxs("div",{className:"detail-header",children:[s.jsx("span",{className:"detail-type",children:e.event_type}),s.jsx("span",{className:"detail-agent",children:e.agent_name}),s.jsx("span",{className:"detail-time",children:new Date(e.timestamp*1e3).toISOString()})]}),s.jsxs("div",{className:"detail-section",children:[s.jsxs("div",{className:"section-header",onClick:()=>r("data"),children:[t.has("data")?s.jsx(Ct,{size:12}):s.jsx(Nt,{size:12}),s.jsx("span",{children:"Event Data"})]}),t.has("data")&&s.jsx("div",{className:"section-content json-viewer",children:i(e.data)})]}),e.event_type==="agent_start"&&((o=e.data)==null?void 0:o.instruction)&&s.jsxs("div",{className:"detail-section",children:[s.jsxs("div",{className:"section-header",onClick:()=>r("instruction"),children:[t.has("instruction")?s.jsx(Ct,{size:12}):s.jsx(Nt,{size:12}),s.jsx("span",{children:"Instruction"}),s.jsxs("span",{className:"char-count",children:[e.data.instruction.length," chars"]})]}),t.has("instruction")&&s.jsx("div",{className:"section-content",children:s.jsx("pre",{className:"instruction-text",children:e.data.instruction})})]}),e.event_type==="model_call"&&((a=e.data)==null?void 0:a.contents)&&s.jsxs("div",{className:"detail-section",children:[s.jsxs("div",{className:"section-header",onClick:()=>r("messages"),children:[t.has("messages")?s.jsx(Ct,{size:12}):s.jsx(Nt,{size:12}),s.jsxs("span",{children:["Messages (",e.data.contents.length,")"]})]}),t.has("messages")&&s.jsx("div",{className:"section-content",children:e.data.contents.map((S,g)=>{var k;return s.jsxs("div",{className:"message-item",children:[s.jsx("span",{className:`message-role ${S.role}`,children:S.role}),s.jsx("div",{className:"message-parts",children:(k=S.parts)==null?void 0:k.map((T,R)=>s.jsxs("div",{className:"message-part",children:[T.text&&s.jsx("pre",{children:T.text}),T.function_call&&s.jsxs("div",{className:"function-call",children:[s.jsx("strong",{children:T.function_call.name}),s.jsx("pre",{children:JSON.stringify(T.function_call.args,null,2)})]}),T.function_response&&s.jsxs("div",{className:"function-response",children:[s.jsx("strong",{children:T.function_response.name}),s.jsx("pre",{children:JSON.stringify(T.function_response.response,null,2)})]})]},R))})]},g)})})]}),e.event_type==="tool_result"&&s.jsxs("div",{className:"detail-section",children:[s.jsxs("div",{className:"section-header",onClick:()=>r("result"),children:[t.has("result")?s.jsx(Ct,{size:12}):s.jsx(Nt,{size:12}),s.jsx("span",{children:"Tool Result"})]}),t.has("result")&&s.jsx("div",{className:"section-content",children:s.jsx("pre",{className:"result-content",children:((p=(u=(c=(l=e.data)==null?void 0:l.result)==null?void 0:c.content)==null?void 0:u[0])==null?void 0:p.text)||(typeof((d=e.data)==null?void 0:d.result)=="string"?e.data.result:JSON.stringify((f=e.data)==null?void 0:f.result,null,2))})})]}),e.event_type==="model_response"&&((m=e.data)==null?void 0:m.parts)&&s.jsxs("div",{className:"detail-section",children:[s.jsxs("div",{className:"section-header",onClick:()=>r("response"),children:[t.has("response")?s.jsx(Ct,{size:12}):s.jsx(Nt,{size:12}),s.jsxs("span",{children:["Response (",e.data.parts.length," part",e.data.parts.length!==1?"s":"",")"]}),e.data.token_counts&&s.jsxs("span",{className:"token-badge",children:[e.data.token_counts.input,"↑ ",e.data.token_counts.output,"↓"]})]}),t.has("response")&&s.jsx("div",{className:"section-content",children:e.data.parts.map((S,g)=>s.jsxs("div",{className:"response-part",children:[S.type==="text"&&S.text&&s.jsx("pre",{className:"response-text",children:S.text}),S.type==="function_call"&&s.jsxs("div",{className:"function-call",children:[s.jsxs("strong",{children:["→ ",S.name,"()"]}),S.args&&Object.keys(S.args).length>0&&s.jsx("pre",{children:JSON.stringify(S.args,null,2)})]}),S.thought&&s.jsx("div",{className:"thought-indicator",children:"💭 Thinking"})]},g))})]}),(e.event_type==="callback_start"||e.event_type==="callback_end")&&s.jsxs("div",{className:"detail-section",children:[s.jsxs("div",{className:"section-header",onClick:()=>r("callback_info"),children:[t.has("callback_info")?s.jsx(Ct,{size:12}):s.jsx(Nt,{size:12}),s.jsx("span",{children:"Callback Information"})]}),t.has("callback_info")&&s.jsxs("div",{className:"section-content",children:[s.jsxs("div",{children:[s.jsx("strong",{children:"Name:"})," ",((w=e.data)==null?void 0:w.callback_name)||"unknown"]}),s.jsxs("div",{children:[s.jsx("strong",{children:"Type:"})," ",((v=e.data)==null?void 0:v.callback_type)||"unknown"]}),s.jsxs("div",{children:[s.jsx("strong",{children:"Module Path:"})," ",((N=e.data)==null?void 0:N.module_path)||"unknown"]}),((x=e.data)==null?void 0:x.error)&&s.jsxs("div",{style:{color:"#ef4444",marginTop:"8px"},children:[s.jsxs("div",{children:[s.jsx("strong",{children:"Error:"})," ",e.data.error]}),((h=e.data)==null?void 0:h.error_type)&&s.jsxs("div",{style:{marginTop:"4px",fontSize:"0.9em",opacity:.8},children:[s.jsx("strong",{children:"Type:"})," ",e.data.error_type]}),((y=e.data)==null?void 0:y.stack_trace)&&s.jsxs("div",{style:{marginTop:"8px"},children:[s.jsx("strong",{children:"Stack Trace:"}),s.jsx("pre",{style:{marginTop:"4px",padding:"8px",backgroundColor:"#1a1a1a",borderRadius:"4px",fontSize:"0.85em",overflow:"auto",maxHeight:"300px",whiteSpace:"pre-wrap",wordBreak:"break-word"},children:e.data.stack_trace})]})]})]})]}),e.event_type==="state_change"&&((P=e.data)==null?void 0:P.state_delta)&&s.jsxs("div",{className:"detail-section",children:[s.jsxs("div",{className:"section-header",onClick:()=>r("state_delta"),children:[t.has("state_delta")?s.jsx(Ct,{size:12}):s.jsx(Nt,{size:12}),s.jsxs("span",{children:["State Changes (",Object.keys(e.data.state_delta).length,")"]})]}),t.has("state_delta")&&s.jsx("div",{className:"section-content",children:Object.entries(e.data.state_delta).map(([S,g])=>s.jsxs("div",{className:"state-delta-item",children:[s.jsx("div",{className:"state-delta-key",children:S}),s.jsx("pre",{className:"state-delta-value",children:typeof g=="string"?g:JSON.stringify(g,null,2)})]},S))})]})]})}function bS({content:e,title:t,onClose:n}){return s.jsxs("div",{className:"modal-overlay",onClick:n,children:[s.jsxs("div",{className:"modal-content",onClick:r=>r.stopPropagation(),children:[s.jsxs("div",{className:"modal-header",children:[s.jsx("h3",{children:t}),s.jsx("button",{className:"modal-close",onClick:n,children:"×"})]}),s.jsx("div",{className:"modal-body markdown-content",children:s.jsx(ex,{children:e})})]}),s.jsx("style",{children:`
      ...
      `})]})}function kS({events:e,selectedEventIndex:t,project:n}){const[r,i]=_.useState(null),o=_.useMemo(()=>{var u;const l={};return(u=n==null?void 0:n.app)!=null&&u.state_keys&&n.app.state_keys.forEach(p=>{l[p.name]={value:void 0,timestamp:null,defined:!0,description:p.description,type:p.type}}),n!=null&&n.agents&&n.agents.forEach(p=>{if(p.type==="LlmAgent"&&p.output_key){const d=p.output_key;l[d]||(l[d]={value:void 0,timestamp:null,defined:!0,description:`Output from ${p.name}`,type:"string"})}}),(t!==null?e.slice(0,t+1):e).filter(p=>p.event_type==="state_change").forEach(p=>{var d;(d=p.data)!=null&&d.state_delta&&Object.entries(p.data.state_delta).forEach(([f,m])=>{var w;l[f]={...l[f],value:m,timestamp:p.timestamp,defined:((w=l[f])==null?void 0:w.defined)??!1}})}),l},[e,t,n]),a=Object.entries(o);return s.jsxs(s.Fragment,{children:[r&&s.jsx(bS,{content:r.content,title:r.title,onClose:()=>i(null)}),s.jsxs("div",{className:"state-snapshot",children:[s.jsx("style",{children:`
        .state-entry.unset {
          opacity: 0.6;
        }
...
Go to the Evals tab to view and edit the test case.`)}catch(D){alert(`Error creating test case: ${D.message||"Unknown error"}`)}finally{fe(!1)}},[d,e,Un,H]),Xt=_.useCallback(()=>{const D=document.createElement("input");D.type="file",D.accept=".json",D.onchange=async re=>{var le;const ie=(le=re.target.files)==null?void 0:le[0];if(ie)try{const pe=await ie.text(),Ue=JSON.parse(pe);if(!Ue.events||!Array.isArray(Ue.events)){alert("Invalid run file: missing events array");return}o(),a(),h(null),P(null),Ue.events.forEach(Vn=>{i(Vn)})}catch(pe){alert(`Failed to load run file: ${pe}`)}},D.click()},[o,a,i]);return _.useEffect(()=>{if(x!==null){const D=document.querySelector(".event-row.selected");D==null||D.scrollIntoView({behavior:"smooth",block:"nearest"})}},[x]),e?s.jsxs("div",{className:`run-panel ${A?"resizing":""}`,children:[s.jsx("style",{children:`
        .run-panel {
          display: flex;
          flex-direction: column;
          width: 100%;
