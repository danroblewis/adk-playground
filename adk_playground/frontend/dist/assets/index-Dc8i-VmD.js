 ...
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const wn=ne("RefreshCw",[["path",{d:"M3 12a9 9 0 0 1 9-9 9.75 9.75 0 0 1 6.74 2.74L21 8",key:"v9h5vc"}],["path",{d:"M21 3v5h-5",key:"1q7to0"}],["path",{d:"M21 12a9 9 0 0 1-9 9 9.75 9.75 0 0 1-6.74-2.74L3 16",key:"3uifl3"}],["path",{d:"M8 16H3v5",key:"1cv678"}]]);/**
 * @license lucide-react v0.294.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 ...
 */const sg=ne("Zap",[["polygon",{points:"13 2 3 14 12 14 11 22 21 10 12 10 13 2",key:"45s27k"}]]);function j0(){const e=nu(),[t,n]=S.useState([]),[r,i]=S.useState(!0),[s,l]=S.useState(!1),[a,c]=S.useState("");S.useEffect(()=>{u()},[]);async function u(){try{const f=await Lh();n(f)}catch(f){console.error("Failed to load projects:",f)}finally{i(!1)}}async function d(){if(a.trim())try{const f=await Rh(a.trim());e(`/project/${f.id}`)}catch(f){console.error("Failed to create project:",f)}}async function p(f,m){if(m.stopPropagation(),!!confirm("Delete this project?"))try{await Ih(f),n(t.filter(w=>w.id!==f))}catch(w){console.error("Failed to delete project:",w)}}return o.jsxs("div",{className:"project-list",children:[o.jsx("style",{children:`
      ...
      `}),o.jsxs("section",{className:"section",children:[o.jsx("div",{className:"section-header",children:o.jsxs("h2",{className:"section-title",children:[o.jsx(y0,{size:20}),"Basic Information"]})}),o.jsxs("div",{className:"form-grid",children:[o.jsxs("div",{className:"form-group",children:[o.jsx("label",{children:"App Name"}),o.jsx("input",{type:"text",value:i.name,onChange:j=>l(j.target.value),style:{borderColor:n?"var(--error)":void 0}}),n&&o.jsx("span",{style:{fontSize:11,color:"var(--error)",marginTop:4},children:n})]}),o.jsxs("div",{className:"form-group",children:[o.jsx("label",{children:"Root Agent"}),o.jsxs("select",{value:i.root_agent_id||"",onChange:j=>s({root_agent_id:j.target.value||void 0}),children:[o.jsx("option",{value:"",children:"Select an agent..."}),e.agents.map(j=>o.jsx("option",{value:j.id,children:j.name},j.id))]})]}),o.jsxs("div",{className:"form-group full-width",children:[o.jsx("label",{children:"Description"}),o.jsx("textarea",{value:i.description,onChange:j=>s({description:j.target.value}),rows:2})]})]})]}),o.jsxs("section",{className:"section",children:[o.jsxs("div",{className:"section-header",children:[o.jsxs("h2",{className:"section-title",children:[o.jsx(sn,{size:20}),"Services"]}),o.jsx("span",{className:"section-hint",children:"Configure session, memory, and artifact storage backends"})]}),o.jsxs("div",{className:"form-grid",children:[o.jsxs("div",{className:"form-group",children:[o.jsx("label",{children:"Session Service"}),o.jsxs("select",{value:i.session_service_uri.split("://")[0],onChange:j=>{const T=j.target.value;s({session_service_uri:{memory:"memory://",sqlite:"sqlite://./sessions.db",postgresql:"postgresql://user:pass@localhost:5432/adk_sessions",mysql:"mysql://user:pass@localhost:3306/adk_sessions",agentengine:"agentengine://project/us-central1/engine-id"}[T]||T+"://"})},children:[o.jsx("option",{value:"memory",children:"In-Memory (dev only)"}),o.jsx("option",{value:"sqlite",children:"SQLite (local)"}),o.jsx("option",{value:"postgresql",children:"PostgreSQL"}),o.jsx("option",{value:"mysql",children:"MySQL"}),o.jsx("option",{value:"agentengine",children:"Vertex AI Agent Engine"})]}),i.session_service_uri.startsWith("sqlite://")&&o.jsx("input",{type:"text",value:i.session_service_uri.replace("sqlite://",""),onChange:j=>s({session_service_uri:"sqlite://"+j.target.value}),placeholder:"./sessions.db",style:{marginTop:8}}),(i.session_service_uri.startsWith("postgresql://")||i.session_service_uri.startsWith("mysql://"))&&o.jsx("input",{type:"text",value:i.session_service_uri,onChange:j=>s({session_service_uri:j.target.value}),placeholder:"postgresql://user:pass@localhost:5432/db",style:{marginTop:8}}),i.session_service_uri.startsWith("agentengine://")&&o.jsxs("div",{style:{marginTop:8,display:"flex",flexDirection:"column",gap:8},children:[o.jsx("input",{type:"text",value:i.session_service_uri.split("/")[2]||"",onChange:j=>{const T=i.session_service_uri.split("/");T[2]=j.target.value,s({session_service_uri:T.join("/")})},placeholder:"project-id"}),o.jsx("input",{type:"text",value:i.session_service_uri.split("/")[3]||"",onChange:j=>{const T=i.session_service_uri.split("/");T[3]=j.target.value,s({session_service_uri:T.join("/")})},placeholder:"location (e.g., us-central1)"}),o.jsx("input",{type:"text",value:i.session_service_uri.split("/")[4]||"",onChange:j=>{const T=i.session_service_uri.split("/");T[4]=j.target.value,s({session_service_uri:T.join("/")})},placeholder:"agent-engine-id"})]}),o.jsxs("span",{className:"help-text",style:{marginTop:4,fontSize:11,color:"var(--text-dim)"},children:[i.session_service_uri.startsWith("memory://")&&"Sessions stored in memory, lost on restart",i.session_service_uri.startsWith("sqlite://")&&"Persists to local SQLite file",i.session_service_uri.startsWith("postgresql://")&&"Production-ready PostgreSQL backend",i.session_service_uri.startsWith("mysql://")&&"Production-ready MySQL backend",i.session_service_uri.startsWith("agentengine://")&&"Vertex AI Agent Engine managed sessions"]})]}),o.jsxs("div",{className:"form-group",children:[o.jsx("label",{children:"Memory Service"}),o.jsxs("select",{value:i.memory_service_uri.split("://")[0],onChange:j=>{const T=j.target.value;s({memory_service_uri:{memory:"memory://",rag:"rag://rag-corpus-id",agentengine:"agentengine://project/us-central1/engine-id"}[T]||T+"://"})},children:[o.jsx("option",{value:"memory",children:"In-Memory (keyword matching)"}),o.jsx("option",{value:"rag",children:"Vertex AI RAG"}),o.jsx("option",{value:"agentengine",children:"Vertex AI Memory Bank"})]}),i.memory_service_uri.startsWith("rag://")&&o.jsxs("div",{style:{marginTop:8,display:"flex",flexDirection:"column",gap:8},children:[o.jsx("input",{type:"text",value:i.memory_service_uri.replace("rag://",""),onChange:j=>s({memory_service_uri:"rag://"+j.target.value}),placeholder:"rag-corpus-id or full resource path"}),o.jsx("span",{className:"help-text",style:{fontSize:11,color:"var(--text-dim)"},children:"Format: projects/PROJECT/locations/LOCATION/ragCorpora/CORPUS_ID"})]}),i.memory_service_uri.startsWith("agentengine://")&&o.jsxs("div",{style:{marginTop:8,display:"flex",flexDirection:"column",gap:8},children:[o.jsx("input",{type:"text",value:i.memory_service_uri.split("/")[2]||"",onChange:j=>{const T=i.memory_service_uri.split("/");T[2]=j.target.value,s({memory_service_uri:T.join("/")})},placeholder:"project-id"}),o.jsx("input",{type:"text",value:i.memory_service_uri.split("/")[3]||"",onChange:j=>{const T=i.memory_service_uri.split("/");T[3]=j.target.value,s({memory_service_uri:T.join("/")})},placeholder:"location (e.g., us-central1)"}),o.jsx("input",{type:"text",value:i.memory_service_uri.split("/")[4]||"",onChange:j=>{const T=i.memory_service_uri.split("/");T[4]=j.target.value,s({memory_service_uri:T.join("/")})},placeholder:"agent-engine-id"})]}),o.jsxs("span",{className:"help-text",style:{marginTop:4,fontSize:11,color:"var(--text-dim)"},children:[i.memory_service_uri.startsWith("memory://")&&"Simple keyword matching, good for prototyping",i.memory_service_uri.startsWith("rag://")&&"Semantic search using Vertex AI RAG corpus",i.memory_service_uri.startsWith("agentengine://")&&"Managed memory via Agent Engine Memory Bank"]})]}),o.jsxs("div",{className:"form-group",children:[o.jsx("label",{children:"Artifact Service"}),o.jsxs("select",{value:i.artifact_service_uri.split("://")[0]==="gs"?"gs":i.artifact_service_uri.split("://")[0],onChange:j=>{const T=j.target.value;s({artifact_service_uri:{memory:"memory://",file:"file://./artifacts",gs:"gs://your-bucket-name"}[T]||T+"://"})},children:[o.jsx("option",{value:"memory",children:"In-Memory (dev only)"}),o.jsx("option",{value:"file",children:"File System"}),o.jsx("option",{value:"gs",children:"Google Cloud Storage"})]}),i.artifact_service_uri.startsWith("file://")&&o.jsx("input",{type:"text",value:i.artifact_service_uri.replace("file://",""),onChange:j=>s({artifact_service_uri:"file://"+j.target.value}),placeholder:"./artifacts",style:{marginTop:8}}),i.artifact_service_uri.startsWith("gs://")&&o.jsx("input",{type:"text",value:i.artifact_service_uri.replace("gs://",""),onChange:j=>s({artifact_service_uri:"gs://"+j.target.value}),placeholder:"bucket-name/optional-prefix",style:{marginTop:8}}),o.jsxs("span",{className:"help-text",style:{marginTop:4,fontSize:11,color:"var(--text-dim)"},children:[i.artifact_service_uri.startsWith("memory://")&&"Artifacts stored in memory, lost on restart",i.artifact_service_uri.startsWith("file://")&&"Persists to local filesystem",i.artifact_service_uri.startsWith("gs://")&&"Production-ready Google Cloud Storage backend"]})]})]})]}),o.jsxs("section",{className:"section",children:[o.jsx("div",{className:"section-header",children:o.jsxs("h2",{className:"section-title",children:[o.jsx(Va,{size:20}),"Environment Variables"]})}),o.jsx("p",{style:{fontSize:13,color:"var(--text-muted)",marginBottom:16},children:"Set API keys and other environment variables. These are passed to the agent runtime."}),o.jsx("div",{style:{display:"flex",flexWrap:"wrap",gap:8,marginBottom:16},children:w0.filter(j=>h[j.key]===void 0).map(j=>o.jsxs("button",{className:"btn btn-secondary btn-sm",onClick:()=>k(j.key),title:j.description,children:[o.jsx(Ae,{size:12}),j.key]},j.key))}),Object.keys(h).length===0?o.jsx("p",{className:"empty-message",children:"No environment variables set. Click a button above to add common variables, or add a custom one below."}):Object.entries(h).map(([j,T])=>o.jsxs("div",{className:"list-item",style:{alignItems:"center"},children:[o.jsxs("div",{style:{flex:1,display:"flex",gap:12,alignItems:"center"},children:[o.jsx("span",{style:{fontFamily:"var(--font-mono)",fontSize:13,minWidth:200},children:j}),o.jsxs("div",{style:{flex:1,display:"flex",gap:8,alignItems:"center"},children:[o.jsx("input",{type:v[j]?"text":"password",value:T,onChange:I=>z(j,I.target.value),placeholder:"Enter value...",style:{flex:1}}),o.jsx("button",{className:"delete-item",onClick:()=>N(j),title:v[j]?"Hide value":"Show value",children:v[j]?o.jsx(u0,{size:16}):o.jsx(Wi,{size:16})})]})]}),o.jsx("button",{className:"delete-item",onClick:()=>A(j),children:o.jsx(Pe,{size:16})})]},j)),o.jsxs("div",{style:{display:"flex",gap:8,marginTop:12},children:[o.jsx("input",{type:"text",value:C,onChange:j=>x(j.target.value.toUpperCase().replace(/[^A-Z0-9_]/g,"")),placeholder:"CUSTOM_VAR_NAME",style:{flex:1,fontFamily:"var(--font-mono)"},onKeyDown:j=>j.key==="Enter"&&k()}),o.jsxs("button",{className:"btn btn-secondary btn-sm",onClick:()=>k(),disabled:!C.trim(),children:[o.jsx(Ae,{size:14}),"Add Variable"]})]})]}),o.jsxs("section",{className:"section",children:[o.jsxs("div",{className:"section-header",children:[o.jsxs("h2",{className:"section-title",children:[o.jsx(iu,{size:20}),"Models"]}),o.jsxs("button",{className:"btn btn-secondary btn-sm",onClick:w,children:[o.jsx(Ae,{size:14}),"Add Model"]})]}),m.length===0?o.jsx("p",{className:"empty-message",children:"No models configured. Add models that agents can use."}):m.map(j=>o.jsxs("div",{className:"model-card",children:[o.jsxs("div",{className:"model-card-header",children:[o.jsx("input",{type:"text",value:j.name,onChange:T=>b(j.id,{name:T.target.value}),placeholder:"Model name",className:"model-name-input"}),o.jsx("button",{className:`default-model-btn ${i.default_model_id===j.id?"is-default":""}`,onClick:()=>g(j.id),title:i.default_model_id===j.id?"Default model":"Set as default",children:o.jsx(ig,{size:14,fill:i.default_model_id===j.id?"currentColor":"none"})}),o.jsx("button",{className:"delete-item",onClick:()=>P(j.id),children:o.jsx(Pe,{size:16})})]}),o.jsxs("div",{className:"model-card-body",children:[o.jsxs("div",{className:"model-row",children:[o.jsxs("div",{className:"form-group",children:[o.jsx("label",{children:"Provider"}),o.jsxs("select",{value:j.provider,onChange:T=>b(j.id,{provider:T.target.value}),children:[o.jsx("option",{value:"gemini",children:"Gemini"}),o.jsx("option",{value:"litellm",children:"LiteLLM"}),o.jsx("option",{value:"anthropic",children:"Anthropic"})]})]}),o.jsxs("div",{className:"form-group",style:{flex:2},children:[o.jsx("label",{children:"Model Name"}),o.jsx("input",{type:"text",value:j.model_name,onChange:T=>b(j.id,{model_name:T.target.value}),placeholder:"e.g., gemini-2.0-flash"})]}),j.provider==="litellm"&&o.jsxs("div",{className:"form-group",style:{flex:2},children:[o.jsx("label",{children:"API Base URL"}),o.jsx("input",{type:"text",value:j.api_base||"",onChange:T=>b(j.id,{api_base:T.target.value||void 0}),placeholder:"http://localhost:11434"})]})]}),o.jsxs("div",{className:"model-row",children:[o.jsxs("div",{className:"form-group",children:[o.jsx("label",{children:"Temperature"}),o.jsx("input",{type:"number",step:"0.1",min:"0",max:"2",value:j.temperature??"",onChange:T=>b(j.id,{temperature:T.target.value?parseFloat(T.target.value):void 0}),placeholder:"Default"})]}),o.jsxs("div",{className:"form-group",children:[o.jsx("label",{children:"Max Tokens"}),o.jsx("input",{type:"number",min:"1",value:j.max_output_tokens??"",onChange:T=>b(j.id,{max_output_tokens:T.target.value?parseInt(T.target.value):void 0}),placeholder:"Default"})]}),o.jsxs("div",{className:"form-group",children:[o.jsx("label",{children:"Top P"}),o.jsx("input",{type:"number",step:"0.1",min:"0",max:"1",value:j.top_p??"",onChange:T=>b(j.id,{top_p:T.target.value?parseFloat(T.target.value):void 0}),placeholder:"Default"})]}),o.jsxs("div",{className:"form-group",children:[o.jsx("label",{children:"Top K"}),o.jsx("input",{type:"number",min:"1",value:j.top_k??"",onChange:T=>b(j.id,{top_k:T.target.value?parseInt(T.target.value):void 0}),placeholder:"Default"})]})]})]})]},j.id))]}),o.jsxs("section",{className:"section",children:[o.jsx("div",{className:"section-header",children:o.jsxs("h2",{className:"section-title",children:[o.jsx(sg,{size:20}),"Advanced Options"]})}),o.jsxs("div",{className:"toggle-group",children:[o.jsx("div",{className:`toggle ${i.compaction.enabled?"active":""}`,onClick:()=>s({compaction:{...i.compaction,enabled:!i.compaction.enabled}})}),o.jsxs("div",{className:"toggle-label",children:[o.jsx("strong",{children:"Event Compaction"}),o.jsx("span",{children:"Automatically summarize old events to reduce context size"})]}),i.compaction.enabled&&o.jsx("input",{type:"number",value:i.compaction.max_events,onChange:j=>s({compaction:{...i.compaction,max_events:parseInt(j.target.value)||100}}),style:{width:80},placeholder:"Max events"})]}),o.jsxs("div",{className:"toggle-group",style:{marginTop:12},children:[o.jsx("div",{className:`toggle ${i.context_cache.enabled?"active":""}`,onClick:()=>s({context_cache:{...i.context_cache,enabled:!i.context_cache.enabled}})}),o.jsxs("div",{className:"toggle-label",children:[o.jsx("strong",{children:"Context Caching"}),o.jsx("span",{children:"Cache static instructions for better performance"})]}),i.context_cache.enabled&&o.jsx("input",{type:"number",value:i.context_cache.ttl_seconds,onChange:j=>s({context_cache:{...i.context_cache,ttl_seconds:parseInt(j.target.value)||3600}}),style:{width:100},placeholder:"TTL (seconds)"})]}),o.jsxs("div",{className:"toggle-group",style:{marginTop:12},children:[o.jsx("div",{className:`toggle ${i.resumability.enabled?"active":""}`,onClick:()=>s({resumability:{...i.resumability,enabled:!i.resumability.enabled}})}),o.jsxs("div",{className:"toggle-label",children:[o.jsx("strong",{children:"Resumability"}),o.jsx("span",{children:"Allow pausing and resuming agent execution"})]})]})]}),o.jsxs("section",{className:"section",children:[o.jsxs("div",{className:"section-header",children:[o.jsxs("h2",{className:"section-title",children:[o.jsx(ou,{size:20}),"Session State Keys"]}),o.jsxs("button",{className:"btn btn-secondary btn-sm",onClick:a,children:[o.jsx(Ae,{size:14}),"Add Key"]})]}),i.state_keys.length===0?o.jsx("p",{className:"empty-message",children:"No state keys defined. Add keys to declare what data agents can share."}):i.state_keys.map((j,T)=>o.jsxs("div",{className:"list-item",children:[o.jsxs("div",{className:"list-item-content",children:[o.jsx("input",{type:"text",value:j.name,onChange:I=>c(T,{name:I.target.value}),placeholder:"Key name"}),o.jsxs("select",{value:j.type,onChange:I=>c(T,{type:I.target.value}),children:[o.jsx("option",{value:"string",children:"String"}),o.jsx("option",{value:"number",children:"Number"}),o.jsx("option",{value:"boolean",children:"Boolean"}),o.jsx("option",{value:"object",children:"Object"}),o.jsx("option",{value:"array",children:"Array"})]}),o.jsxs("select",{value:j.scope,onChange:I=>c(T,{scope:I.target.value}),children:[o.jsx("option",{value:"session",children:"Session"}),o.jsx("option",{value:"user",children:"User"}),o.jsx("option",{value:"app",children:"App"}),o.jsx("option",{value:"temp",children:"Temporary"})]}),o.jsx("input",{type:"text",value:j.description,onChange:I=>c(T,{description:I.target.value}),placeholder:"Description",style:{gridColumn:"span 2"}})]}),o.jsx("button",{className:"delete-item",onClick:()=>u(T),children:o.jsx(Pe,{size:16})})]},T))]}),o.jsxs("section",{className:"section",children:[o.jsxs("div",{className:"section-header",children:[o.jsxs("h2",{className:"section-title",children:[o.jsx(wn,{size:20}),"Plugins"]}),o.jsx("div",{className:"plugin-add-dropdown",children:o.jsxs("select",{className:"btn btn-secondary btn-sm",value:"",onChange:j=>{j.target.value&&(d(j.target.value),j.target.value="")},style:{paddingRight:8},children:[o.jsx("option",{value:"",children:"+ Add Plugin..."}),o.jsx("option",{value:"ReflectAndRetryToolPlugin",children:"Reflect & Retry Tool"}),o.jsx("option",{value:"ContextFilterPlugin",children:"Context Filter"}),o.jsx("option",{value:"LoggingPlugin",children:"Logging"}),o.jsx("option",{value:"GlobalInstructionPlugin",children:"Global Instruction"}),o.jsx("option",{value:"SaveFilesAsArtifactsPlugin",children:"Save Files as Artifacts"}),o.jsx("option",{value:"MultimodalToolResultsPlugin",children:"Multimodal Tool Results"})]})})]}),i.plugins.length===0?o.jsx("p",{className:"empty-message",children:"No plugins configured. Add plugins to extend agent functionality."}):i.plugins.map((j,T)=>o.jsxs("div",{className:"list-item",style:{flexDirection:"column",gap:12},children:[o.jsxs("div",{style:{display:"flex",alignItems:"center",width:"100%",gap:12},children:[o.jsxs("select",{value:j.type,onChange:I=>p(T,{type:I.target.value}),style:{flex:1},children:[o.jsx("option",{value:"ReflectAndRetryToolPlugin",children:"Reflect & Retry Tool"}),o.jsx("option",{value:"ContextFilterPlugin",children:"Context Filter"}),o.jsx("option",{value:"LoggingPlugin",children:"Logging"}),o.jsx("option",{value:"GlobalInstructionPlugin",children:"Global Instruction"}),o.jsx("option",{value:"SaveFilesAsArtifactsPlugin",children:"Save Files as Artifacts"}),o.jsx("option",{value:"MultimodalToolResultsPlugin",children:"Multimodal Tool Results"})]}),o.jsx("button",{className:"delete-item",onClick:()=>f(T),children:o.jsx(Pe,{size:16})})]}),j.type==="ReflectAndRetryToolPlugin"&&o.jsxs("div",{style:{display:"flex",gap:12,alignItems:"center",paddingLeft:8},children:[o.jsxs("div",{className:"form-group",style:{flex:0},children:[o.jsx("label",{style:{fontSize:12},children:"Max Retries"}),o.jsx("input",{type:"number",min:"0",max:"10",value:j.max_retries??3,onChange:I=>p(T,{max_retries:parseInt(I.target.value)||0}),style:{width:70}})]}),o.jsxs("label",{style:{display:"flex",alignItems:"center",gap:8,fontSize:13},children:[o.jsx("input",{type:"checkbox",checked:j.throw_exception_if_retry_exceeded??!1,onChange:I=>p(T,{throw_exception_if_retry_exceeded:I.target.checked})}),"Throw exception if retry exceeded"]})]}),j.type==="ContextFilterPlugin"&&o.jsxs("div",{style:{display:"flex",gap:12,alignItems:"center",paddingLeft:8},children:[o.jsxs("div",{className:"form-group",style:{flex:0},children:[o.jsx("label",{style:{fontSize:12},children:"Invocations to Keep"}),o.jsx("input",{type:"number",min:"1",max:"100",value:j.num_invocations_to_keep??5,onChange:I=>p(T,{num_invocations_to_keep:parseInt(I.target.value)||1}),style:{width:70}})]}),o.jsx("span",{style:{fontSize:12,color:"var(--text-muted)"},children:"Keeps only the last N conversation turns to reduce context size"})]}),j.type==="LoggingPlugin"&&o.jsx("div",{style:{paddingLeft:8},children:o.jsx("span",{style:{fontSize:12,color:"var(--text-muted)"},children:"Logs all agent events (messages, tool calls, responses) to the console"})}),j.type==="GlobalInstructionPlugin"&&o.jsxs("div",{style:{width:"100%",paddingLeft:8},children:[o.jsxs("div",{className:"form-group",children:[o.jsx("label",{style:{fontSize:12},children:"Global Instruction"}),o.jsx("textarea",{value:j.global_instruction??"",onChange:I=>p(T,{global_instruction:I.target.value}),placeholder:"Instructions that apply to all agents in the app...",rows:3,style:{width:"100%"}})]}),o.jsx("span",{style:{fontSize:12,color:"var(--text-muted)"},children:"This instruction is prepended to every agent's system prompt"})]}),j.type==="SaveFilesAsArtifactsPlugin"&&o.jsx("div",{style:{paddingLeft:8},children:o.jsx("span",{style:{fontSize:12,color:"var(--text-muted)"},children:"Automatically saves files uploaded in user messages as artifacts for later retrieval"})}),j.type==="MultimodalToolResultsPlugin"&&o.jsx("div",{style:{paddingLeft:8},children:o.jsx("span",{style:{fontSize:12,color:"var(--text-muted)"},children:"Allows tools to return multimodal content (images, files) directly to the LLM"})})]},T))]})]})}const C0="modulepreload",N0=function(e){return"/"+e},Xd={},lg=function(t,n,r){let i=Promise.resolve();if(n&&n.length>0){document.getElementsByTagName("link");const l=document.querySelector("meta[property=csp-nonce]"),a=(l==null?void 0:l.nonce)||(l==null?void 0:l.getAttribute("nonce"));i=Promise.allSettled(n.map(c=>{if(c=N0(c),c in Xd)return;Xd[c]=!0;const u=c.endsWith(".css"),d=u?'[rel="stylesheet"]':"";if(document.querySelector(`link[href="${c}"]${d}`))return;const p=document.createElement("link");if(p.rel=u?"stylesheet":C0,u||(p.as="script"),p.crossOrigin="",p.href=c,a&&p.setAttribute("nonce",a),document.head.appendChild(p),u)return new Promise((f,m)=>{p.addEventListener("load",f),p.addEventListener("error",()=>m(new Error(`Unable to preload CSS for ${c}`)))})}))}function s(l){const a=new Event("vite:preloadError",{cancelable:!0});if(a.payload=l,window.dispatchEvent(a),!a.defaultPrevented)throw l}return i.then(l=>{for(const a of l||[])a.status==="rejected"&&s(a.reason);return t().catch(s)})};function Zd(e,t){(t==null||t>e.length)&&(t=e.length);for(var n=0,r=Array(t);n<t;n++)r[n]=e[n];return r}function E0(e){if(Array.isArray(e))return e}function z0(e,t,n){return(t=M0(t))in e?Object.defineProperty(e,t,{value:n,enumerable:!0,configurable:!0,writable:!0}):e[t]=n,e}function T0(e,t){var n=e==null?null:typeof Symbol<"u"&&e[Symbol.iterator]||e["@@iterator"];if(n!=null){var r,i,s,l,a=[],c=!0,u=!1;try{if(s=(n=n.call(e)).next,t!==0)for(;!(c=(r=s.call(n)).done)&&(a.push(r.value),a.length!==t);c=!0);}catch(d){u=!0,i=d}finally{try{if(!c&&n.return!=null&&(l=n.return(),Object(l)!==l))return}finally{if(u)throw i}}return a}}function P0(){throw new TypeError(`Invalid attempt to destructure non-iterable instance.
...
`).length,m=Math.max(r,Math.min(f*20+40,500));a(m)}},[e,r]),S.useEffect(()=>{i&&u.current&&u.current.focus()},[i]);function d(f){u.current=f,f.focus()}function p(f){c.current&&!c.current.contains(f.target)&&s(!1)}return S.useEffect(()=>{if(i)return document.addEventListener("mousedown",p),()=>document.removeEventListener("mousedown",p)},[i]),o.jsxs("div",{ref:c,className:"markdown-editor",children:[o.jsx("style",{children:`
      ...
      `}),i?o.jsx("div",{className:"monaco-wrapper",children:o.jsx(ln,{height:"100%",language:"markdown",theme:"vs-dark",value:e,onChange:f=>t(f||""),onMount:d,options:{minimap:{enabled:!1},fontSize:14,fontFamily:"'JetBrains Mono', monospace",lineNumbers:"off",scrollBeyondLastLine:!1,automaticLayout:!0,wordWrap:"on",padding:{top:12,bottom:12},lineDecorationsWidth:8,folding:!1,glyphMargin:!1,renderLineHighlight:"none",overviewRulerLanes:0,hideCursorInOverviewRuler:!0,scrollbar:{vertical:"auto",horizontal:"hidden"}}})}):o.jsxs("div",{className:"markdown-preview",onClick:()=>s(!0),children:[o.jsxs("span",{className:"edit-hint",children:[o.jsx(h0,{size:12}),"Click to edit"]}),e?o.jsx("div",{className:"markdown-content",children:o.jsx(Xg,{children:e})}):o.jsx("div",{className:"markdown-placeholder",children:n})]})]})}function w_(e){return/^[a-zA-Z0-9_]+$/.test(e)}function __({agent:e}){const{project:t,updateAgent:n,mcpServers:r,builtinTools:i,setActiveTab:s,setRunAgentId:l}=ct(),[a,c]=S.useState(new Set(["basic","model","tools","subagents"])),[u,d]=S.useState(!1),[p,f]=S.useState(!1),[m,w]=S.useState(!1),[b,P]=S.useState(""),[g,h]=S.useState(null);if(!t)return null;function v($){n(e.id,$)}function L($){if($===""){h(null),v({name:$});return}w_($)?h(null):h("Name can only contain letters, numbers, and underscores"),v({name:$})}function C($){const M=new Set(a);M.has($)?M.delete($):M.add($),c(M)}const x=e.type==="LlmAgent",k=e;function z($){x&&v({tools:[...k.tools,$]})}function A($){x&&v({tools:k.tools.filter((M,E)=>E!==$)})}function N($,M){if(!x)return;const E=[...k.tools];E[$]=M,v({tools:E})}function j($){"sub_agents"in e&&v({sub_agents:[...e.sub_agents,$]})}function T($){"sub_agents"in e&&v({sub_agents:e.sub_agents.filter(M=>M!==$)})}const I=t.agents.filter($=>$.id!==e.id);async function H(){if(!(!t||!x)){d(!0);try{const $=k.instruction||"",M=$?`Current instruction to improve:
...
def my_callback(tool: BaseTool, tool_args: Dict[str, Any], tool_context: ToolContext, result: Dict) -> Optional[Dict]:
    ...
    return None
`;default:return ix("before_agent")}}function fS({onSelectCallback:e}){var z,A;const{project:t,updateProject:n,addCustomCallback:r,updateCustomCallback:i,removeCustomCallback:s}=ct(),[l,a]=S.useState(""),[c,u]=S.useState(null),[d,p]=S.useState(null),[f,m]=S.useState(!1),w=S.useRef(null);if(!t)return null;const b=t.custom_callbacks||[],P=b.find(N=>N.id===c);function g(N){u(N),e==null||e(N)}S.useEffect(()=>{P?(a(P.code),p(null)):a("")},[c,P]);function h(){const N=pS(),j={id:N,name:"new_callback",description:"",module_path:"callbacks.custom",code:ix("before_agent"),state_keys_used:[]};r(j),g(N)}function v(N,j){j.stopPropagation(),confirm("Delete this callback?")&&(s(N),c===N&&(e==null||e(null),u(null),a("")))}function L(){if(!c)return;const N=b.find(I=>I.id===c);if(!N)return;const j=N.name.trim();if(!j){alert("Please enter a name");return}if(!Yp(j)){p("Name must contain only alphanumeric characters and underscores");return}if(b.find(I=>I.name===j&&I.id!==N.id)){p("A callback with this name already exists");return}i(N.id,{code:l,name:j,description:N.description,module_path:N.module_path,state_keys_used:N.state_keys_used}),p(null)}function C(N,j){w.current=j;try{rx(j,{endpoint:"/api/code-completion",language:"python"})}catch(T){console.warn("Failed to register Monacopilot completion:",T)}}async function x(){if(P){m(!0);try{let N="before_agent";const j=P.name.toLowerCase(),T=P.description.toLowerCase();j.includes("after_agent")||T.includes("after agent")?N="after_agent":j.includes("before_model")||T.includes("before model")?N="before_model":j.includes("after_model")||T.includes("after model")?N="after_model":j.includes("before_tool")||T.includes("before tool")?N="before_tool":j.includes("after_tool")||T.includes("after tool")?N="after_tool":(j.includes("before_agent")||T.includes("before agent"))&&(N="before_agent");const I=await Wh(t.id,P.name,P.description,N,P.state_keys_used);I.success&&I.code?(a(I.code),i(P.id,{code:I.code})):(console.error("Failed to generate callback code:",I.error),alert("Failed to generate callback code: "+(I.error||"Unknown error")))}catch(N){console.error("Error generating callback code:",N),alert("Error generating callback code: "+N.message)}finally{m(!1)}}}const k=((A=(z=t.app)==null?void 0:z.state_keys)==null?void 0:A.map(N=>N.name))||[];return o.jsxs("div",{className:"tools-panel",children:[o.jsx("style",{children:`
        .tools-panel {
          display: flex;
          height: 100%;
          background: var(--bg-primary);
...
Go to the Evals tab to view and edit the test case.`)}catch(D){alert(`Error creating test case: ${D.message||"Unknown error"}`)}finally{ue(!1)}},[p,e,Bn,V]),Xt=S.useCallback(()=>{const D=document.createElement("input");D.type="file",D.accept=".json",D.onchange=async te=>{var se;const ee=(se=te.target.files)==null?void 0:se[0];if(ee)try{const ce=await ee.text(),De=JSON.parse(ce);if(!De.events||!Array.isArray(De.events)){alert("Invalid run file: missing events array");return}s(),l(),h(null),L(null),De.events.forEach(Un=>{i(Un)})}catch(ce){alert(`Failed to load run file: ${ce}`)}},D.click()},[s,l,i]);return S.useEffect(()=>{if(g!==null){const D=document.querySelector(".event-row.selected");D==null||D.scrollIntoView({behavior:"smooth",block:"nearest"})}},[g]),e?o.jsxs("div",{className:`run-panel ${$?"resizing":""}`,children:[o.jsx("style",{children:`
        .run-panel {
          display: flex;
          flex-direction: column;
          width: 100%;
